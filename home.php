...
<head>
    ...
    <title>DCS ENGINEERS & CONSULTANT PVT. LTD. | Log in</title>
...
<body class="login-page" style="background-image: url('images/bg-img.png'); background-repeat: no-repeat; background-size: cover;background-attachment: fixed;background-size:100% 100%;background-color:#208381;">
    <div class="login-calendar-container">
        <div class="login-box-wrapper">
            <div class="login-box">
                <div class="login-logo" >
                    <img src="nabl/images/stern_logo2.png" style="margin-bottom: 10px;width:250px;">
                </div>
                <div class="login-box-body">
                    ...
                    <form action="#" method="post" style="margin-bottom: 0px;">
                        <div class="form-group has-feedback form-margin-first">
                            ...
                            <input type="text" id="staff_email" name="staff_email" class="form-control" placeholder="Email" required>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
							<?php if($thater==""){?>
                                <button type="submit" name="btnsubmit" id="btnsubmit" class="btn btn-primary btn-block btn-flat" style="border-color: unset !important;border-radius: 8px;">Login</button>
								<?php }else{?>
                                <button type="button" name="btnsubmit" id="btnsubmit" class="btn btn-primary btn-block btn-flat" style="border-color: unset !important;border-radius: 8px;">Login</button>
								<?php }?>
                            </div>
                        </div>
                    </form>
