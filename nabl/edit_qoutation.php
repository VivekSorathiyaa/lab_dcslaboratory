...
if($_SESSION['name']=="")
{
	...
	$sel_qat="select * from quotations where `quotations_id`=".$quotations_id;
	 ...
	 if($rowes["mate_name"] !="")
	 {
		 ...
		 $txt_discount_class_array=explode(",",$rowes["txt_discount_percentage"]);
...
<div class="row">
				<div class="col-md-12">
										  ...
										  <div class="col-sm-2">
											<select class="form-control  select2 col-sm-12" data-placeholder="Select Agency" tabindex="9"  id="select_agency" name="select_agency" required >
														...
														<?php 
															...
															?>
							<option value="<?php echo $cat_row['agency_id']; ?>" <?php if($rowes["agency_id"] == $cat_row['agency_id']){ echo "selected"; }?>>
										  ...
										  <!-- <div class="col-sm-1">
											...
											<input type="text" class="form-control" id="adress" name="adress" value="<?php echo $agency_row['agency_address']?>" disabled>
											</div>
										
										  
											<div class="col-sm-2">
												
													<input type="text" class="form-control" value="<?php echo $agency_row['agency_mobile']?>" id="mobile" name="mobile" disabled>
											</div>
								...
								<div class="row">
											...
											<div class="col-md-3">
													<input type="text" class="form-control" value="<?php echo $agency_row['agency_pincode']?>" id="pincode" name="pincode" disabled>
													
											
											</div>
											
											<div class="col-md-3">
												<input type="text"  class="form-control" name="email" id="email" disabled value="<?php echo $agency_row['agency_email']?>">
										  </div>
										  
										  <div class="col-md-3">
												<input type="text"  class="form-control" name="gst_no" id="gst_no" disabled value="<?php echo $agency_row['agency_gstno']?>">
										  </div>
										  ...
										  <div class="col-md-3">
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="text"  class="form-control" name="invoice_date" id="invoice_date" value="<?php echo date('d/m/Y',strtotime($rowes['quatation_date']))?>">
												</div>
											</div>
										  </div>
								...
								<div class="row">
									...
									<div class="col-md-3">
												<input type="text"  class="form-control" name="perfoma_no" id="perfoma_no" value="<?php echo $rowes['quatation_no'];?>" disabled>
									  ...
									  <div class="table-responsive" id="display_data">
										<table class="table no-margin class_tr_put" >
										  ...
										  <tr>
											...
											if($mat_ids!="")
											{ 
												foreach($mat_ids as $ones => $one_ids)
												{ ?>
												<tr>	
												<td>
												<input type="hidden" name="mt_id[]" class="class_mate_id" id="mateid_<?php echo $ones; ?>" value="<?php echo $mat_ids[$ones];?>">
												
												<input type="text" name="mat_name[]" class="form-control class_mate_name" id="matename_<?php echo $ones; ?>" value="<?php echo $mate_name[$ones];?>">
												</td>	
												
												<td>
												<input type="hidden" name="test_id[]" class="class_test_id" id="testid_<?php echo $ones; ?>" value="<?php echo $test_ids[$ones];?>">
												
												<input type="text" name="test_name[]" class="form-control class_test" id="test_<?php echo $ones; ?>" value="<?php echo $test_name[$ones];?>">
												</td>	
												
												<td>
												<input type="text" name="qty[]" class="form-control class_qty" id="qty_<?php echo $ones; ?>" value="<?php echo $test_qty[$ones];?>">
												</td>	
												
												<td>
												<input type="text" name="rate[]" class="form-control txt_rate_class" id="rate_<?php echo $ones; ?>" value="<?php echo $test_rates[$ones];?>">
												</td>
												
												<td>
												<input type="text" name="txtdiscount[]" class="form-control txt_discount_class" id="discount_<?php echo $ones; ?>" value="<?php echo $txt_discount_class_array[$ones];?>">
												</td>	
												
												<td>
												<input type="text" name="amt[]" class="form-control class_amnt" id="amt_<?php echo $ones; ?>" value="<?php echo $test_totals[$ones];?>">
												</td>	
					...
					<div class="row">
									...
									<div class="col-sm-1">
									<input type="hidden" name="txt_discount_percent" class="form-control" id="txt_discount_percent" value="<?php echo $rowes['discount_percent'];?>">
									</div>
									<div class="col-sm-2"><label for="inputEmail3" class="control-label">&nbsp;</label></div>
									<div class="col-sm-2">
									<input type="hidden" name="txt_discount_amount" class="form-control" id="txt_discount_amount" value="<?php echo $rowes['discount_amount'];?>">
									</div>
								</div>
						<br>
							<div class="box box-info">
							<input type="hidden" name="hidden_gst_type" id="hidden_gst_type" value="<?php echo $rowes['gst_type'];?>"> 
							<input type="hidden" name="hidden_gst_in_ex" id="hidden_gst_in_ex" value="<?php echo $rowes['gst_in_or_ex'];?>"> 
								<div class="row">
									<div class="col-sm-2">
									...
									<div class="col-sm-9">
										<input type="radio" style="width:33px;height:25px;" name="gst_type" value="with_gst" <?php if($rowes['gst_type']=="with_gst"){ echo "checked";} ?>><span style="font-size:20px;" ><b>With GST</b></span>
										<input type="radio" style="width:33px;height:25px;"name="gst_type" value="without_gst" <?php if($rowes['gst_type']=="" || $rowes['gst_type']=="without_gst"){ echo "checked";} ?>><span style="font-size:20px;"><b>Without GST<b></span>
										<input type="radio" style="width:33px;height:25px;"name="gst_type" value="with_igst" <?php if($rowes['gst_type']!="" && $rowes['gst_type']=="with_igst"){ echo "checked";} ?>><span style="font-size:20px;"><b>With IGST<b></span>
									</div>
								</div>
								<br>
								<div class="row" id="gst_hide_show" style="<?php if($rowes['gst_type']=="" || $rowes['gst_type']=="without_gst"){ echo "display:none";}else{ echo "display:block";} ?>">
									...
									<div class="row">
										...
										<div class="col-sm-9">
											<input type="radio" style="width:33px;height:25px;" name="in_or_ex" value="include" <?php if($rowes["gst_in_or_ex"]=="include"){ echo "checked";} ?>><span style="font-size:20px;" ><b>Include</b></span>
											<input type="radio" style="width:33px;height:25px;"name="in_or_ex" value="exclude" <?php if($rowes["gst_in_or_ex"]=="exclude"){ echo "checked";} ?>><span style="font-size:20px;"><b>Exclude<b></span>
										</div>
									</div>
									<br>
									<div class="col-md-1">
									...
									<div class="col-md-2">
									<input type="text" name="txt_cgst" class="form-control" id="txt_cgst" value="<?php echo $rowes["c_gst_amt"];?>" >
									</div>
									...
									<div class="col-md-2">
									<input type="text" name="txt_sgst" class="form-control" id="txt_sgst" value="<?php echo $rowes["s_gst_amt"];?>" >
									</div>
									...
									<div class="col-md-2">
									<input type="text" name="txt_igst" class="form-control" id="txt_igst" value="<?php echo $rowes["i_gst_amt"];?>" >
									</div>
									...
									<div class="col-md-2">
									<input type="text" name="txt_grand" class="form-control" id="txt_grand" value="<?php echo $rowes["grand_total"];?>" >
									</div>
								</div>
							...
							<br>
								<div class="row">
									...
									<div class="col-md-4">
									<input type="text" name="txt_amt_in_word" class="form-control" id="txt_amt_in_word" value="<?php echo $rowes["total_amt_in_word"];?>" >
									</div>
									...
									<div class="col-md-3">
									<input type="text" name="total_amt" class="form-control" id="total_amt" value="<?php echo $rowes["total_amt"];?>" >
									</div>
								</div>
								<br>
							<input type="hidden" name="quotations_id" id="quotations_id" value="<?php echo $rowes["quotations_id"];?>">
								<div class="row" id="submit_button_only_for_bill" style="">
									<div class="col-md-3">&nbsp;</div>
									<div class="col-md-6">
									
									 <button type="button" class="btn btn-info"  onclick="addData('edit_qoutation')" name="btn_add_data" id="btn_add_data" style="width:150px;font-size:20px;" >Edit</button>
									</div>
									<div class="col-md-3">&nbsp;</div>
    ...
    if (type == 'edit_qoutation') {
		...
		if(hidden_gst_type !="without_gst")
		{
			...
			else
			{
				...
				data: billData,
				success:function(msg){
					alert("Qoutation Successfully Updated..");
