...
if (mysqli_num_rows($result_select4) > 0) {
	...
	// $s_des = $row_select4['s_des'];
	// $r_sam = $row_select4['r_sam'];
	// $s_ret = $row_select4['s_ret'];
			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">CC CUBE TEST</h2>
					</div>
								...
								<div class="col-lg-6">
										<div class="form-group">
										 <div class="col-sm-2">
										  ...
										  <div class="col-sm-3">
											<input type="hidden" class="form-control amend_date" tabindex="4" id="amend_date" name="amend_date" value="--">
										  </div>
										</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group">
										...
										<?php
										/*$querys_job1 = "SELECT * FROM span_c_c_cube WHERE `is_deleted`='0' and lab_no='$lab_no'";
										...
										?>
										<div class="col-sm-2">
											<a target='_blank' href="<?php echo $base_url; ?>print_report/print_c_c_cube.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

										</div>
									<!--	<div class="col-sm-2">
 													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report_blank/print_c_c_cube.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&ulr=<?php echo $ulr; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Calculation Blank</b></a>
												...
												<div class="panel-body">
													...
													<div class="row">
														...
														<div class="col-md-5">
															...
															<div class="col-md-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Cross Sectional Area</label>
																</div>
															</div> 
															<div class="col-md-2">
																<div class="form-group">
									...
									<div class="row">
										<div class="col-lg-12">
											<table border="1px solid black" align="center" width="100%" id="aaaa">
												...
												<?php
												$query = "select * from span_c_c_cube WHERE lab_no='$aa'  and `is_deleted`='0' ORDER BY `id`";
...
<script>
	...
	function com_auto() {
		...
		if (top_days == "7") {
			...
			if (top_grade == "M-5") {
				...
				var mass_1 = randomNumberFromRange(8.10, 8.15);
				var mass_2 = randomNumberFromRange(8.10, 8.15);
				var mass_3 = randomNumberFromRange(8.10, 8.15);
			...
			if (top_grade == "M-10") {
				var avg_com_s_1 = randomNumberFromRange(7.70, 9.00);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				var comp_1 = (+avg_com_s1) + randomNumberFromRange(-0.10, 0.30);
				var comp_2 = (+avg_com_s1) + randomNumberFromRange(-0.10, 0.30);
				...
				var mass_1 = randomNumberFromRange(8.26, 8.32);
				var mass_2 = randomNumberFromRange(8.26, 8.32);
				var mass_3 = randomNumberFromRange(8.26, 8.32);
				...
				var mass_1 = randomNumberFromRange(8.37, 8.42);
				var mass_2 = randomNumberFromRange(8.37, 8.42);
				var mass_3 = randomNumberFromRange(8.37, 8.42);


			} else if (top_grade == "M-20") {
				var avg_com_s_1 = randomNumberFromRange(16.80, 18.00);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				var comp_1 = (+avg_com_s1) + randomNumberFromRange(-0.30, 0.50);
				var comp_2 = (+avg_com_s1) + randomNumberFromRange(-0.30, 0.50);
				$('#comp_1').val(comp_1.toFixed(2));
				$('#comp_2').val(comp_2.toFixed(2));
				var com1 = $('#comp_1').val();
				var com2 = $('#comp_2').val();
				...
				var mass_1 = randomNumberFromRange(8.40, 8.46);
				var mass_2 = randomNumberFromRange(8.40, 8.46);
				var mass_3 = randomNumberFromRange(8.40, 8.46);

			} else if (top_grade == "M-25") {
				var avg_com_s_1 = randomNumberFromRange(20.30, 22.00);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				...
				var mass_1 = randomNumberFromRange(8.50, 8.56);
				var mass_2 = randomNumberFromRange(8.50, 8.56);
				var mass_3 = randomNumberFromRange(8.50, 8.56);

			} else if (top_grade == "M-30") {
				var avg_com_s_1 = randomNumberFromRange(23.80, 26.50);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				var comp_1 = (+avg_com_s1) + randomNumberFromRange(-0.50, 0.50);
				var comp_2 = (+avg_com_s1) + randomNumberFromRange(-0.50, 0.50);
				...
				var mass_1 = randomNumberFromRange(8.64, 8.70);
				var mass_2 = randomNumberFromRange(8.64, 8.70);
				var mass_3 = randomNumberFromRange(8.64, 8.70);

			} else if (top_grade == "M-35") {
				var avg_com_s_1 = randomNumberFromRange(27.30, 30.50);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				var comp_1 = (+avg_com_s1) + randomNumberFromRange(-0.90, 0.90);
				var comp_2 = (+avg_com_s1) + randomNumberFromRange(-0.90, 0.90);
				$('#comp_1').val(comp_1.toFixed(2));
				$('#comp_2').val(comp_2.toFixed(2));
				var com1 = $('#comp_1').val();
				var com2 = $('#comp_2').val();
				...
				var mass_1 = randomNumberFromRange(8.77, 8.82);
				var mass_2 = randomNumberFromRange(8.77, 8.82);
				var mass_3 = randomNumberFromRange(8.77, 8.82);
				


			} else if (top_grade == "M-40") {
				var avg_com_s_1 = randomNumberFromRange(30.80, 33.50);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				...
				var mass_1 = randomNumberFromRange(8.89, 8.94);
				var mass_2 = randomNumberFromRange(8.89, 8.94);
				var mass_3 = randomNumberFromRange(8.89, 8.94);

			} else if (top_grade == "M-45") {
				var avg_com_s_1 = randomNumberFromRange(34.30, 37.50);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				var comp_1 = (+avg_com_s1) + randomNumberFromRange(-1.00, 1.00);
				var comp_2 = (+avg_com_s1) + randomNumberFromRange(-1.00, 1.00);
				...
				var mass_1 = randomNumberFromRange(9.01, 9.06);
				var mass_2 = randomNumberFromRange(9.01, 9.06);
				var mass_3 = randomNumberFromRange(9.01, 9.06);
				...
				var mass_1 = randomNumberFromRange(9.10, 9.15);
				var mass_2 = randomNumberFromRange(9.10, 9.15);
				var mass_3 = randomNumberFromRange(9.10, 9.15);
			...
			if (top_grade == "M-10") {
				...
				var mass_1 = randomNumberFromRange(8.33, 8.38);
				var mass_2 = randomNumberFromRange(8.33, 8.38);
				var mass_3 = randomNumberFromRange(8.33, 8.38);



			} else if (top_grade == "M-15") {
				var avg_com_s_1 = randomNumberFromRange(19.00, 21.00);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				var comp_1 = (+avg_com_s1) + randomNumberFromRange(-0.30, 0.80);
				var comp_2 = (+avg_com_s1) + randomNumberFromRange(-0.30, 0.80);
				...
				var mass_1 = randomNumberFromRange(8.43, 8.48);
				var mass_2 = randomNumberFromRange(8.43, 8.48);
				var mass_3 = randomNumberFromRange(8.43, 8.48);


			} else if (top_grade == "M-20") {
				var avg_com_s_1 = randomNumberFromRange(24.00, 25.00);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				var comp_1 = (+avg_com_s1) + randomNumberFromRange(-0.90, 1.00);
				var comp_2 = (+avg_com_s1) + randomNumberFromRange(-0.90, 1.00);
				$('#comp_1').val(comp_1.toFixed(2));
				$('#comp_2').val(comp_2.toFixed(2));
				var com1 = $('#comp_1').val();
				var com2 = $('#comp_2').val();
				...
				var mass_1 = randomNumberFromRange(8.47, 8.52);
				var mass_2 = randomNumberFromRange(8.47, 8.52);
				var mass_3 = randomNumberFromRange(8.47, 8.52);


			} else if (top_grade == "M-25") {
				var avg_com_s_1 = randomNumberFromRange(29.00, 31.00);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				var comp_2 = (+avg_com_s1) + randomNumberFromRange(-0.50, 0.50);
				var comp_1 = (+avg_com_s1) + randomNumberFromRange(-0.50, 0.50);
				...
				var mass_1 = randomNumberFromRange(8.57, 8.64);
				var mass_2 = randomNumberFromRange(8.57, 8.64);
				var mass_3 = randomNumberFromRange(8.57, 8.64);


			} else if (top_grade == "M-30") {
				var avg_com_s_1 = randomNumberFromRange(34.00, 36.50);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				var comp_1 = (+avg_com_s1) + randomNumberFromRange(-0.50, 0.50);
				var comp_2 = (+avg_com_s1) + randomNumberFromRange(-0.50, 0.50);
				...
				var mass_1 = randomNumberFromRange(8.71, 8.76);
				var mass_2 = randomNumberFromRange(8.71, 8.76);
				var mass_3 = randomNumberFromRange(8.71, 8.76);

			} else if (top_grade == "M-35") {
				var avg_com_s_1 = randomNumberFromRange(39.00, 41.00);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				var comp_1 = (+avg_com_s1) + randomNumberFromRange(-0.50, 0.50);
				var comp_2 = (+avg_com_s1) + randomNumberFromRange(-0.50, 0.50);
				...
				var mass_1 = randomNumberFromRange(8.82, 8.88);
				var mass_2 = randomNumberFromRange(8.82, 8.88);
				var mass_3 = randomNumberFromRange(8.82, 8.88);


			} else if (top_grade == "M-40") {
				var avg_com_s_1 = randomNumberFromRange(44.00, 47.00);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				var comp_1 = (+avg_com_s1) + randomNumberFromRange(-0.50, 0.50);
				var comp_2 = (+avg_com_s1) + randomNumberFromRange(-0.50, 0.50);
				...
				var mass_1 = randomNumberFromRange(8.95, 9.00);
				var mass_2 = randomNumberFromRange(8.95, 9.00);
				var mass_3 = randomNumberFromRange(8.95, 9.00);


			} else if (top_grade == "M-45") {
				var avg_com_s_1 = randomNumberFromRange(49.00, 50.50);
				$('#avg_com_s_1').val(avg_com_s_1.toFixed(2));
				var avg_com_s1 = $('#avg_com_s_1').val();
				var comp_1 = (+avg_com_s1) + randomNumberFromRange(-0.50, 0.50);
				var comp_2 = (+avg_com_s1) + randomNumberFromRange(-0.50, 0.50);
				...
				var mass_1 = randomNumberFromRange(9.07, 9.12);
				var mass_2 = randomNumberFromRange(9.07, 9.12);
				var mass_3 = randomNumberFromRange(9.07, 9.12);
				...
				var mass_1 = randomNumberFromRange(9.18, 9.23);
				var mass_2 = randomNumberFromRange(9.18, 9.23);
				var mass_3 = randomNumberFromRange(9.18, 9.23);
			...
			var mass_1 = randomNumberFromRange(8.30, 8.80);
			var mass_2 = randomNumberFromRange(8.30, 8.80);
			var mass_3 = randomNumberFromRange(8.30, 8.80);
		...
		var grade1 = grade;
		$('#grade1').val(grade1);
		var l1 = randomNumberFromRange(149.8, 150.2).toFixed(1);
		var l2 = randomNumberFromRange(149.8, 150.2).toFixed(1);
		var l3 = randomNumberFromRange(149.8, 150.2).toFixed(1);

		$('#l1').val(l1);
		$('#l2').val(l2);
		$('#l3').val(l3);
		var b1 = randomNumberFromRange(149.8, 150.2).toFixed(1);
		var b2 = randomNumberFromRange(149.8, 150.2).toFixed(1);
		var b3 = randomNumberFromRange(149.8, 150.2).toFixed(1);
		$('#b1').val(b1);
		$('#b2').val(b2);
		$('#b3').val(b3);
		var h1 = randomNumberFromRange(149.8, 150.2).toFixed(1);
		var h2 = randomNumberFromRange(149.8, 150.2).toFixed(1);
		var h3 = randomNumberFromRange(149.8, 150.2).toFixed(1);
		$('#h1').val(h1);
		$('#h2').val(h2);
		$('#h3').val(h3);
		var l_1 = $('#l1').val();
		...
		var cro_f1 = (+l_1) * (+h_1) * (+b_1);
		var cro_f2 = (+l_2) * (+h_2) * (+b_2);
		var cro_f3 = (+l_3) * (+h_3) * (+b_3);
		
		var ca1 = (+mas1) / (+cro_f1);
		var ca2 = (+mas2) / (+cro_f2);
		var ca3 = (+mas3) / (+cro_f3);
		
		var fail_pat_1 = (+ca1) * (+1000000000);
		var fail_pat_2 = (+ca2) * (+1000000000);
		var fail_pat_3 = (+ca3) * (+1000000000);
		
		$('#fail_pat_1').val(fail_pat_1.toFixed());
		$('#fail_pat_2').val(fail_pat_2.toFixed());
		$('#fail_pat_3').val(fail_pat_3.toFixed());
	...
	$(document).ready(function() {
        ...
        */ 
			...
			var cro_f1 = $('#cro_f1').val();
			var cro_f2 = $('#cro_f2').val();
			var cro_f3 = $('#cro_f3').val();
			
			var cro_f1 = (+l_1) * (+h_1) * (+b_1);
			var cro_f2 = (+l_2) * (+h_2) * (+b_2);
			var cro_f3 = (+l_3) * (+h_3) * (+b_3);
			/* 
			$('#cro_f1').val(cro_f1.toFixed(2));
			$('#cro_f2').val(cro_f2.toFixed(2));
			$('#cro_f3').val(cro_f3.toFixed(2));
			
			var cros1 = $('#cro_f1').val();
			var cros2 = $('#cro_f2').val();
			var cros3 = $('#cro_f3').val(); */
			...
			if (isNaN(fail_pat_1)){fail_pat_1=0;}
			if (isNaN(fail_pat_2)){fail_pat_2=0;}
			if (isNaN(fail_pat_3)){fail_pat_3=0;}
		...
		$('#mass_1,#mass_2,#mass_3').change(function() {
			func_set_1_l_b();
		});
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>savecc_cube_span.php',
