			...
			<div class="nav-tabs-custom">
				<div class="tab-content">
					...
					<div class="row">									
							...
							<div class="col-md-2">
										<label for="inputEmail3" class="control-label">Doc. Upload
							...
							<div class="col-md-12" style="text-align:center;">
										...
										<button type="button" class="btn btn-primary btn-lg btn3d " id="btn_save_client" name="sub_client" tabindex="25" onclick="saveclient('edit_only_trf')" style="margin-bottom:25px;    border-radius: 20px;"> Edit Job</button>
							</div>
							</div>
							<br>
