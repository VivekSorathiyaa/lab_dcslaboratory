					...
					<div class="box box-info">
										...
										?>
										  ...
										  <?php
											array_push($now_array,$name_of_works);
												...
												foreach($mate_name as $one_key => $one_mate_name)
												{
													...
													<tr>
														<td>
														<input type="hidden" name="mt_id[]" class="class_trf_id" id="trfid_<?php echo $one_key;?>" value="<?php echo $one_chk_array;?>">
														<input type="hidden" name="material_ids[]" class="form-control class_material_id" id="" value="<?php echo $mate_ids[$one_key]; ?>" disabled>
														<input type="text" name="material_names[]" class="form-control class_material_name" id="material_names" value="<?php echo $mate_name[$one_key]; ?>" disabled>
														</td>
														<td>
														<input type="text" name="material_qty[]" class="form-control class_material_qty" id="materialqty_<?php echo $one_key; ?>" value="<?php echo $material_qty[$one_key]; ?>" >
														</td>
														<td>
														<input type="text" name="material_rating[]" class="form-control class_material_rates" id="materialrating_<?php echo $one_key; ?>" value="<?php echo $material_rates[$one_key]; ?>" >
														</td>
														<td>

														<?php
														// multification of qty and material_rate
															$multi_of_qty_and_mate_rate= intval($material_qty[$one_key]) * intval($material_rates[$one_key]);
														?>
														<input type="text" name="material_totals[]" class="form-control class_amnt" id="materialtotals_<?php echo $one_key;?>" value="<?php echo $multi_of_qty_and_mate_rate;?>" >
														</td>
														</tr>
													<?php
													}
							...
							<input type="hidden" name="hidden_agency" id="hidden_agency" value="<?php echo $get_agency_id;?>">
								<div class="row">
									...
									<button type="button" class="btn btn-info"  onclick="addData('update_by_material')" name="btn_add_data" id="btn_add_data" style="width:150px;font-size:14px;" >Update</button>
