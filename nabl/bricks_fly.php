 			...
 			<div class="col-md-12">
 				<div class="box box-info">
 					<div class="box-header with-border">
 						<h2 style="text-align:center;">Fly Ash Bricks </h2>
 												...
 												<div id="collapse3" class="panel-collapse collapse">
 													<div class="panel-body">
 														...
 														<div class="row">
 															...
 															<!-- </div> -->
 															<div class="col-sm-3">
 																<label for="inputEmail3" class="control-label label-right">Dry Weight Kg (M1)</label>
 															</div>
 															<div class="col-sm-3">
 																<label for="inputEmail3" class="control-label label-right">Wet Weight Kg (M2)</label>
 															</div>
 															<div class="col-sm-3">
 																<label for="inputEmail3" class="control-label label-right">Water absorption (%) = W2–W1 x 100 / W1</label>
 															</div>
 														</div>
 														<br>
 														<div class="row">
 													...
 													<div class="panel-body">
 														...
 														<div class="row">
 															<div class="col-md-6">
 																...
 																<div class="col-sm-3">
 																	<label for="inputEmail3" class="control-label label-right"> (B) (mm)</label>
 																</div>
 																<div class="col-sm-3">
 															...
 															<div class="col-md-6">
 																<div class="col-sm-4">
 																	<label for="inputEmail3" class="control-label label-right">Area = L x B (mm<sup>2</sup>)</label>

 																</div>
 																<div class="col-sm-4">
 																	<label for="inputEmail3" class="control-label label-right">Load (KN)</label>
 																</div>
 																<div class="col-sm-4">
 																	<label for="inputEmail3" class="control-label label-right">Compressive strength (N/mm<sup>2</sup>)</label>
 																</div>
 															</div>
 														</div>
 														<br>
 										...
 										<div class="col-lg-12">
 											<div class="form-group">
 												...
 												<div class="col-sm-2">
 													...
 													<?php
														$querys_job1 = "SELECT * FROM span_brick_fly WHERE `is_deleted`='0' and lab_no='$lab_no'";
 												...
 												<?php
													...
													?>
 												<div class="col-sm-2">
 													<a target='_blank' href="<?php echo $base_url; ?>print_report/print_brick_fly.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&temporary_trf_no=<?php echo $_GET['temporary_trf_no']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
 										...
 										<div class="row">
 											<div class="col-lg-12">
 												<table border="1px solid black" align="center" width="100%" id="aaaa">
 													...
 													<?php
														$query = "select * from span_brick_fly WHERE lab_no='$aa'  and `is_deleted`='0'";
 ...
 <script>
	...
	$('dim_length,dim_length1,dim_width,dim_width1,dim_height,#dim_height1').change(function() {
		...
		// Vivek : Change
 		$('#com_l_1,#com_l_2,#com_l_3,#com_l_4,#com_l_5,#com_b_1,#com_b_2,#com_b_3,#com_b_4,#com_b_5,#com_load_1,#com_load_2,#com_load_3,#com_load_4,#com_load_5').change(function() {
 			...
 			var avg_com = (((+com_1) + (+com_2) + (+com_3) + (+com_4) + (+com_5)) / (+5));
 		...
 		// Vivek : Change
 		$('wtr_w1_1,wtr_w1_2,wtr_w1_3,wtr_w1_4,wtr_w1_5,#wtr_w2_1,#wtr_w2_2,#wtr_w2_3,#wtr_w2_4,#wtr_w2_5').change(function() {
 			...
 			var avg_wtr = (((+wtr_1) + (+wtr_2) + (+wtr_3) + (+wtr_4) + (+wtr_5)) / (+5));
 		...
 		function wtr_auto() {
 			...
 			avg_wtr = ((+w_tr1) + (+w_tr2) + (+w_tr3) + (+w_tr4) + (+w_tr5)) / 5;
 		...
 		function com_auto() {
 			...
 			com_b_1 = randomNumberFromRange(109, 112).toFixed();
 			com_b_2 = randomNumberFromRange(109, 112).toFixed();
 			com_b_3 = randomNumberFromRange(109, 112).toFixed();
 			com_b_4 = randomNumberFromRange(109, 112).toFixed();
 			com_b_5 = randomNumberFromRange(109, 112).toFixed();
 			...
 			com_h_1 = randomNumberFromRange(67, 71).toFixed();
 			com_h_3 = randomNumberFromRange(67, 71).toFixed();
 			com_h_2 = randomNumberFromRange(67, 71).toFixed();
 			com_h_4 = randomNumberFromRange(67, 71).toFixed();
 			com_h_5 = randomNumberFromRange(67, 71).toFixed();
 			...
 			var avgs = ((+comp_001) + (+comp_002) + (+comp_003) + (+comp_004) + (+comp_005)) / 5;
 	...
 	function getGlazedTiles() {
 		...
 		$.ajax({
 			type: 'POST',
 			url: '<?php echo $base_url; ?>saveBricksfly.php',
 	...
 	function saveMetal(type, id) {
 		...
 		if (type == 'add') {
			...
			var s_ret = $('#s_ret').val();
 			...
 			billData = '&action_type=' + type + '&report_no=' + report_no + '&job_no=' + job_no + '&lab_no=' + lab_no + '&chk_dim=' + chk_dim + '&dim_height=' + dim_height + '&dim_length=' + dim_length + '&dim_width=' + dim_width + '&dim_height1=' + dim_height1 + '&dim_length1=' + dim_length1 + '&dim_width1=' + dim_width1 + '&avg_height=' + avg_height + '&avg_length=' + avg_length + '&avg_width=' + avg_width + '&no_of_brick=' + no_of_brick + '&id_mark=' + id_mark + '&temp1=' + temp1 + '&chk_wtr=' + chk_wtr + '&wtr_lab_1=' + wtr_lab_1 + '&wtr_lab_2=' + wtr_lab_2 + '&wtr_lab_3=' + wtr_lab_3 + '&wtr_lab_4=' + wtr_lab_4 + '&wtr_lab_5=' + wtr_lab_5 + '&wtr_w1_1=' + wtr_w1_1 + '&wtr_w1_2=' + wtr_w1_2 + '&wtr_w1_3=' + wtr_w1_3 + '&wtr_w1_4=' + wtr_w1_4 + '&wtr_w1_5=' + wtr_w1_5 + '&wtr_w2_1=' + wtr_w2_1 + '&wtr_w2_2=' + wtr_w2_2 + '&wtr_w2_3=' + wtr_w2_3 + '&wtr_w2_4=' + wtr_w2_4 + '&wtr_w2_5=' + wtr_w2_5 + '&wtr_1=' + wtr_1 + '&wtr_2=' + wtr_2 + '&wtr_3=' + wtr_3 + '&wtr_4=' + wtr_4 + '&wtr_5=' + wtr_5 + '&avg_wtr=' + avg_wtr + '&chk_com=' + chk_com + '&avg_com=' + avg_com + '&con_grade=' + con_grade + '&com_lab_1=' + com_lab_1 + '&com_lab_2=' + com_lab_2 + '&com_lab_3=' + com_lab_3 + '&com_lab_4=' + com_lab_4 + '&com_lab_5=' + com_lab_5 + '&com_l_1=' + com_l_1 + '&com_l_2=' + com_l_2 + '&com_l_3=' + com_l_3 + '&com_l_4=' + com_l_4 + '&com_l_5=' + com_l_5 + '&com_b_1=' + com_b_1 + '&com_b_2=' + com_b_2 + '&com_b_3=' + com_b_3 + '&com_b_4=' + com_b_4 + '&com_b_5=' + com_b_5 + '&com_h_1=' + com_h_1 + '&com_h_2=' + com_h_2 + '&com_h_3=' + com_h_3 + '&com_h_4=' + com_h_4 + '&com_h_5=' + com_h_5 + '&com_area_1=' + com_area_1 + '&com_area_2=' + com_area_2 + '&com_area_3=' + com_area_3 + '&com_area_4=' + com_area_4 + '&com_area_5=' + com_area_5 + '&com_load_1=' + com_load_1 + '&com_load_2=' + com_load_2 + '&com_load_3=' + com_load_3 + '&com_load_4=' + com_load_4 + '&com_load_5=' + com_load_5 + '&com_1=' + com_1 + '&com_2=' + com_2 + '&com_3=' + com_3 + '&com_4=' + com_4 + '&com_5=' + com_5 + '&chk_efflo=' + chk_efflo + '&rbt_efflo1=' + rbt_efflo1 + '&rbt_efflo2=' + rbt_efflo2 + '&rbt_efflo3=' + rbt_efflo3 + '&rbt_efflo4=' + rbt_efflo4 + '&rbt_efflo5=' + rbt_efflo5 + '&ulr=' + ulr + '&remarks=' + remarks +'&amend_date='+amend_date+  '&s_des=' + s_des +  '&r_sam=' + r_sam +  '&s_ret=' + s_ret;
