								...
								<tbody>
									<?php
										...
										while($row=mysqli_fetch_array($result))
										{
											...
											$explode_reported_by=explode(",",$row["reported_by_review"]);
									...
									?>
											...
											<a href="view_job_by_qlty_manager.php?trf_no=<?php echo $row['trf_no'];?>&&job_no=<?php echo $row['job_number'];?>&&temporary_trf_no=<?php echo $row['temporary_trf_no'];?>" class="btn btn-primary" title="View Job"><span class="fa fa-eye"></span></a>
