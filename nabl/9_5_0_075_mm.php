			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">BC - 2 MIX MATERIAL</h2>
					</div>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-sm-1">
												...
												<?php   
													$querys_job1 = "SELECT * FROM bc_2_mix_material WHERE `is_deleted`='0' and lab_no='$lab_no'";
											...
											?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_gsb_1_mix_m5.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&ulr=<?php echo $_GET['ulr'];?>&&tbl_name=bc_2_mix_material" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
 
											</div>
											<!--<div class="col-sm-2">
 													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report_blank/print_gsb_1_mix_m5.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=bc_2_mix_material" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Calculation Blank</b></a>

 												</div>-->
											
											<?php //} ?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_gsb_1_mix_m5.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&tbl_name=bc_2_mix_material" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
...
<th style="text-align:center;"><label>Job No.</label></th>
								...
								<?php
							 $query = "select * from bc_2_mix_material WHERE lab_no='$aa'  and `is_deleted`='0'";
...
//SOUNDNESS	
	...
	function general_flk_elo1()
	{
		...
		var a4 = 0;//randomNumberFromRange(7500.0,8500.0).toFixed(2);
		var a5 = 0;//randomNumberFromRange(400.0,509.0).toFixed(2);
		...
		var b4 = 0;//randomNumberFromRange(1000.0,1200.0).toFixed(2);		
		var b5 = 0;//randomNumberFromRange(80.0,120.0).toFixed(2);		
		...
		var flk_y4 = 0;//((+a_4) / (+sum_a)) * (+100);
		var flk_y5 = 0;//((+a_5) / (+sum_a)) * (+100);
		...
		var flk_x4 = 0;//((+b_4) / (+a_4)) * (+100);
		var flk_x5 = 0;//((+b_5) / (+a_5)) * (+100);
		...
		var flkxy4 = 0;//((+flkx4) * (+flky4)) / (+100);
		var flkxy5 = 0;//((+flkx5) * (+flky5)) / (+100);
		...
		var dd4 = 0;//randomNumberFromRange(1000.0,1200.0).toFixed(2);			
		var dd5 = 0;//randomNumberFromRange(100.0,150.0).toFixed(2);			
		...
		var elo_y4 = 0;//((+aa_4) / (+sum_aa)) * (+100);
		var elo_y5 = 0;//((+aa_5) / (+sum_aa)) * (+100);
		...
		var eloxy4 = 0;//((+elox4) * (+eloy4)) / (+100);
		var eloxy5 = 0;//((+elox5) * (+eloy5)) / (+100);
		...
		var fle_4 = 0;//randomNumberFromRange(100.0,100.0);
		var fle_5 = 0;//randomNumberFromRange(100.0,100.0);
		...
		var fle_13 = 0;//randomNumberFromRange(100.0,100.0);
		var fle_14 = 0;//randomNumberFromRange(100.0,100.0);
	...
	function grd_auto() {
			...
			var pass_sample_10 = randomNumberFromRange(5.00, 9.00).toFixed(2);
			...
			//(SUM OF CUM. WAIGHT)
			var blank_extra = (+cum_wt_gm1) + (+cum_wt_gm2) + (+cum_wt_gm3) + (+cum_wt_gm4) + (+cum_wt_gm5) + (+cum_wt_gm6) + (+cum_wt_gm7) + (+cum_wt_gm8) + (+cum_wt_gm9) + (+cum_wt_gm10);
...
$('#pass_range_1').val("100");
		...
		$('#sample_taken,#pass_sample_1,#pass_sample_2,#pass_sample_3,#pass_sample_4,#pass_sample_5,#pass_sample_6,#pass_sample_7,#pass_sample_8,#pass_sample_9,#pass_sample_10').change(function() {
			$('#txtgrd').css("background-color", "var(--success)");
...
function getGlazedTiles(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo $base_url; ?>save9_5_0_075.php',
