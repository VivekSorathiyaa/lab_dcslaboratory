					...
					<div class="box box-info">
							...
							<br>
								...
								<div class="row">
										  ...
										  <div class="col-sm-3">
											...
											<div class="col-sm-3">
												<?php
												$set_explode=explode("/",$_GET['txt_trf_no']);
												//$get_invoice_no= $set_explode[2].$set_explode[3];
												?>
													<input type="text" class="form-control" value="<?php echo $set_explode;?>" id="txt_invoice_no" name="txt_invoice_no" disabled>
											</div>
							...
							<input type="hidden" name="hidden_agency" id="hidden_agency" value="<?php echo $get_agency_id;?>">
								<div class="row">
									...
									<button type="button" class="btn btn-info"  onclick="addData('save_next_estimate')" name="btn_add_data" id="btn_add_data" style="width:150px;font-size:20px;" >Save</button>
									</div>
									<div class="col-md-3">&nbsp;</div>
		...
		if(hidden_gst_type !="without_gst")
		{
			...
			else
			{
				...
				success:function(msg){
					...
					// window.location.href="<?php echo $base_url; ?>rec_bill_list.php?a=rec1";
