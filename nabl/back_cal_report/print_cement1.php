	...
	<br>
		...
		<table align="center" style="width: 95%;text-align: center;border:1px solid black;font-family: 'calibri';font-size: 12px"  cellspacing="0" cellpadding="2px" bordercolor ="black" >
			...
			<tr>
                ...
                <td class="report-cell"   style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;Test:&nbsp;Consistency of cement,Setting Time (Min.),) Soundness By Le-Chatelier's&nbsp;</td>
            </tr>
			<tr>
...
<br><br><br>
	...
	<table  align="center" style="width: 95%;text-align: center;border-bottom:1px solid;" cellspacing="0" cellpadding="5px">
        <tr>
            ...
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">Wt. of Water (gm)</td>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">Penetration (mm)</td> 
		...
		<tr>
            ...
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['reading_1'];?></td>
		...
		<tr>
            ...
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['reading_2'];?></td>
		...
		<tr>
            ...
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['reading_3'];?></td>
		...
		<tr>
            ...
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['reading_4'];?></td>
		...
		<tr>
            ...
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['reading_5'];?></td>
...
<br><br><br>
	...
	<table  align="center" style="width: 95%;text-align: left;border-bottom:1px solid;" cellspacing="0" cellpadding="5px">
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">Starting Time:-&nbsp;&nbsp;&nbsp;&nbsp; <?php echo $row_select_pipe['hr_a'];?></td>
            <td style="border-top: 1px solid;border-left: 0px solid;border-right: 1px solid;"></td>
        </tr>
		<tr>
            <td style="border-top: 0px solid;border-left: 1px solid;">Initial:-&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_select_pipe['hr_b'];?></td>
            <td style="border-top:0px solid;border-left:0px solid;border-right:1px solid;"></td>
        </tr>
		<tr>
            <td style="border-top:0px solid;border-left: 1px solid;">Final:-&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_select_pipe['hr_c'];?></td>
            <td style="border-top:0px solid;border-left:0px solid;border-right:1px solid;"></td>
        </tr>
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">Initial Setting Time:-&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_select_pipe['initial_time'];?></td>
            <td style="border-top:1px solid;border-left:0px solid;border-right:1px solid;"></td>
        </tr>
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">Final Setting Time:-&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_select_pipe['final_time'];?></td>
            <td style="border-top:1px solid;border-left:0px solid;border-right:1px solid;"></td>
        </tr>
	...
	<table  align="center" style="width: 95%;text-align: left;border-bottom:1px solid;" cellspacing="0" cellpadding="5px">
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">1</td>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">Distance <sub>Before</sub> Heating (A) mm</td>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold"><?php echo $row_select_pipe['dis_1_1'];?></td> 
            <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['dis_1_2'];?></td>
        </tr>
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">2</td>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">Distance After Heating (B) mm</td>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold"><?php echo $row_select_pipe['dis_2_1'];?></td> 
            <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['dis_2_2'];?></td>
        </tr>
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">3</td>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">Expansion (B-A)</td>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold"><?php echo $row_select_pipe['diff_1'];?></td> 
            <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['diff_2'];?></td>
        </tr>
		<tr>
            <td colspan="2" style="border-top: 1px solid;border-left: 1px solid;font-weight: bold">Average</td>
            <td colspan="2" style="border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['soundness'];?></td>
        </tr>
	</table>	
	...
	<table align="center" style="width: 95%;text-align: center;border:1px solid black;font-family: 'calibri';font-size: 12px"  cellspacing="0" cellpadding="2px" bordercolor ="black" >
			...
			<tr>
                <td class="report-cell"   style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card No:&nbsp;<?php echo $job_no;?></td>
                <td class="report-cell"   style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;Test:&nbsp;Compressive Strength&nbsp;</td>
            </tr>
			<tr>
                <td class="report-cell"   style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample Description:&nbsp;<?php echo $sample_de;?></td>
                <td class="report-cell"   style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;Method:&nbsp;As per MORTH
...
<br><br><br>
	...
	<table  align="center" style="width: 95%;text-align: center;border-bottom:1px solid;" cellspacing="0" cellpadding="5px">
        <tr>
            ...
            <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">Compressive Strength (N/mm<sup>2</sup>)</td>
        </tr>
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">1</td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo number_format($row_select_pipe['l1'] * $row_select_pipe['b1'],2) ;?></td>
		...
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">2</td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo number_format($row_select_pipe['l2'] * $row_select_pipe['b2'],2) ;?></td>
		...
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">3</td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo number_format($row_select_pipe['l3'] * $row_select_pipe['b3'],2) ;?></td>
		...
		<tr>
            ...
            <td style="border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['avg_com_1'];?></td>
        </tr>
...
<br><br><br>
	...
	<table  align="center" style="width: 95%;text-align: center;border-bottom:1px solid;" cellspacing="0" cellpadding="5px">
		...
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">1</td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo number_format($row_select_pipe['l4'] * $row_select_pipe['b4'],2) ;?></td>
		...
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">2</td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo number_format($row_select_pipe['l5'] * $row_select_pipe['b5'],2) ;?></td>
		...
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">3</td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo number_format($row_select_pipe['l6'] * $row_select_pipe['b6'],2) ;?></td>
		...
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;" colspan="3">Average</td>
            <td style="border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['avg_com_2'];?></td>
        </tr>
	...
	<table  align="center" style="width: 95%;text-align: center;border-bottom:1px solid;" cellspacing="0" cellpadding="5px">
		...
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">1</td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo number_format($row_select_pipe['l7'] * $row_select_pipe['b7'],2) ;?></td>
		...
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">2</td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo number_format($row_select_pipe['l8'] * $row_select_pipe['b8'],2) ;?></td>
		...
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">3</td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo number_format($row_select_pipe['l9'] * $row_select_pipe['b9'],2) ;?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['load_9'];?></td>
            <td style="border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['com_9'];?></td>
        </tr>
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;" colspan="3">Average</td>
            <td style="border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['avg_com_3'];?></td>
        </tr>
	...
	<table align="center" style="width: 95%;text-align: center;border:1px solid black;font-family: 'calibri';font-size: 12px"  cellspacing="0" cellpadding="2px" bordercolor ="black" >
			...
			<tr>
                <td class="report-cell"   style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card No:&nbsp;<?php echo $job_no;?></td>
                <td class="report-cell"   style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;Test:&nbsp;DETERMINATION OF DENSITY&nbsp;</td>
            </tr>
			<tr>
                <td class="report-cell"   style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample Description:&nbsp;<?php echo $sample_de;?></td>
                <td class="report-cell"   style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;Method:&nbsp;As per MORTH
...
<br><br><br>
    <table align="center" style="width: 95%;text-align: center;border:0px solid;"  cellspacing="5px" cellpadding="5px" bordercolor ="black">
        <tr>
            <td style="font-family: 'Calibri';font-size: 25px;font-weight: bold;" colspan="7">DETERMINATION OF DENSITY</td>
        </tr>
		<tr>
    ...
    <table  align="center" style="width: 95%;text-align: center;border-bottom:1px solid;" cellspacing="0" cellpadding="5px">
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">S. No.</td>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">DETERMINATION</td>
            <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">Trial-1</td> 
		...
		<tr>
            ...
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['den_temp'];?></td>
            <td style="border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['den_temp'];?></td>
        </tr>
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">2</td>
		...
		<tr>
            ...
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['den_intial'];?></td>
            <td style="border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['den_intial1'];?></td>
        </tr>
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">4</td>
            <td style="border-top: 1px solid;border-left: 1px solid;">Final Reading ml</td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['den_final'];?></td>
            <td style="border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['den_final1'];?></td>
        </tr>
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">5</td>
            <td style="border-top: 1px solid;border-left: 1px solid;">Volume ml</td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['den_displaced'];?></td>
            <td style="border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['den_displaced1'];?></td>
        </tr>
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;">6</td>
            <td style="border-top: 1px solid;border-left: 1px solid;">Cement Density = <u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mass of Cement,g &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; P<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Displaced Volume,ml</td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['density'];?></td>
            <td style="border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['density1'];?></td>
        </tr>
	...
	<table align="center" style="width: 95%;text-align: center;border:1px solid black;font-family: 'calibri';font-size: 12px"  cellspacing="0" cellpadding="2px" bordercolor ="black" >
			...
			<tr>
                <td class="report-cell"  style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card No:&nbsp;<?php echo $job_no;?></td>
                <td class="report-cell"  style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;Test:&nbsp;FINENESS BY DRY SIEVING&nbsp;</td>
            </tr>
			<tr>
                <td class="report-cell"  style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample Description:&nbsp;<?php echo $sample_de;?></td>
                <td class="report-cell"  style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;Method:&nbsp;As per MORTH
...
<br><br><br>
    <table align="center" style="width: 95%;text-align: center;border:0px solid;"  cellspacing="5px" cellpadding="5px" bordercolor ="black">
        <tr>
            <td style="font-family: 'Calibri';font-size: 25px;font-weight: bold;" colspan="7">FINENESS BY DRY SIEVING</td>
        </tr>
		<tr>
    ...
    <table  align="center" style="width: 95%;text-align:left;border-bottom:1px solid;" cellspacing="0" cellpadding="5px">
        <tr>
            <td style="text-align: center;border-top: 1px solid;border-left: 1px solid;font-family:calibri;font-size: 15px;font-weight: bold">S. No.</td>
            <td style="text-align: center;border-top: 1px solid;border-left: 1px solid;font-family:calibri;font-size: 15px;font-weight: bold">DETERMINATION</td>
            <td style="text-align: center;border-top: 1px solid;border-left: 1px solid;font-family:calibri;font-size: 15px;font-weight: bold">Trial-1</td> 
            <td style="text-align: center;border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">Trial-2</td>
        </tr>
		<tr>
            ...
            <td style="text-align: center;border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['d_t_1'];?></td>
            <td style="text-align: center;border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['d_t_2'];?></td>
        </tr>
		<tr>
            ...
            <td style="text-align: center;border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['w_t_1'];?></td>
            <td style="text-align: center;border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['w_t_2'];?></td>
        </tr>
		<tr>
            ...
            <td style="text-align: center;border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['c_t_1'];?></td>
            <td style="text-align: center;border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['c_t_2'];?></td>
        </tr>
		<tr>
            ...
            <td colspan="2" style="text-align: center;border-top:1px solid;border-left:1px solid;border-right:1px solid;"><?php echo $row_select_pipe['ss_area_1'];?></td>
        </tr>
