...
<html>
	...
	<br>
		...
		<table align="center" style="width: 95%;text-align: center;border:1px solid;font-family: 'calibri';font-size: 12px;"  cellspacing="0" cellpadding="2px">
            ...
            <tr>
                ...
                <td  class="report-cell"  style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;Test:&nbsp;Dimension,Compressive,Water Absorption,Efflorescence</td>
            </tr>
            <tr>
                ...
                <td class="report-cell"   style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;&nbsp;Method:&nbsp;IS 13757,
            &nbsp;IS 3495 (P-1)
            ...
            <tr>
                <td class="report-cell"   style=" text-align: left;border-top: 1px solid;" colspan="3">&nbsp;Sample Qty:&nbsp;<?php echo $row_select_pipe['no_of_brick'];?></td>
    ...
    <table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0" >
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;text-align: left;font-family: 'calibri';font-size: 17px;font-weight: bold;" colspan="5">Compressive Strength N/mm2 As per IS:3495(1)1992/R2019</td>   
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_area_1'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_load_1'];?></td>
        ...
        <tr>
            ...
            <td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;border-right: 1px solid;font-weight: bold;"><?php echo $row_select_pipe['avg_com'];?></td></td>
        </tr>
    </table>
    <br>
    <table  align="center" style="width: 95%;">
    ...
    <table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0" >
        ...
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w1_1'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_1'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_1'] - $row_select_pipe['wtr_w1_1'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['wtr_1'];?></td>
        </tr>
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w1_2'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_2'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_2'] - $row_select_pipe['wtr_w1_2'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['wtr_2'];?></td>
        </tr>
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w1_3'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_3'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_3'] - $row_select_pipe['wtr_w1_3'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['wtr_3'];?></td>
        </tr>
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w1_4'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_4'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_4'] - $row_select_pipe['wtr_w1_4'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['wtr_4'];?></td>
        </tr>
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w1_5'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_5'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_5'] - $row_select_pipe['wtr_w1_5'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['wtr_5'];?></td>
        </tr>
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;padding: 9px"><?php echo $row_select_pipe[''];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe[''];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe[''];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe[''];?></td>
        </tr>
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;font-weight: bold;">Avg.</td>
            <td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;"><?php echo $row_select_pipe['avg_wtr'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;"></td>
            <td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;border-right: 1px solid;font-weight: bold;"></td>
        </tr>
    </table>
    <table  align="center" style="width: 95%;">
        <tr>
