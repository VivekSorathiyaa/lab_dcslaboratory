...
<body>
	...
	<page size="A4">
		<table align="center"
			...
			<tr>
				<td
					style="text-align: center;border-top: 1px solid;font-weight: bold;border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
					Brick</td>
			...
			<tr>
				...
				<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
					colspan="4">&nbsp;Test:&nbsp;Dimension,Compressive,Water Absorption,Efflorescence</td>
			</tr>
			<tr>
				...
				<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
					colspan="4">&nbsp;&nbsp;Method:&nbsp;IS 13757,
					&nbsp;IS 3495 (P-1)
					,&nbsp;IS 3495 (P-2),&nbsp;IS 3495 (P-3)</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="report-cell" style=" text-align: left;border-top: 1px solid;" colspan="3">&nbsp;Sample
					Qty:&nbsp;<?php echo $row_select_pipe['no_of_brick']; ?></td>
				<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left : 1px solid;"
		...
		<table align="center" style="width: 95%;">
			<tr>
				<td style="font-family: 'calibri';font-size: 17px;font-weight: bold;padding: 0 30px;" colspan="10">1.0
					Dimension Test of Brick</td>
			</tr>
		</table>
		<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0">
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;text-align: left;font-family: 'calibri';font-size: 17px;font-weight: bold;"
					colspan="4">Dimension Test Of Brick As Per IS:1077:1992/R2016</td>

			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;"></td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;">&nbsp;(i)
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;">&nbsp;(ii)
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;border-right: 1px solid;">Avg
				</td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;">
					&nbsp;Length (mm)</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;">
					&nbsp;<?php echo $row_select_pipe['dim_length']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;">
					&nbsp;<?php echo $row_select_pipe['dim_length1']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;border-right: 1px solid;">
					&nbsp;<?php echo $row_select_pipe['avg_length']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;">&nbsp;Width
					(mm)</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;">
					&nbsp;<?php echo $row_select_pipe['dim_width']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;">
					&nbsp;<?php echo $row_select_pipe['dim_width1']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;border-right: 1px solid;">
					&nbsp;<?php echo $row_select_pipe['avg_width']; ?></td>
			</tr>
			<tr>
				<td
					style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;border-bottom: 1px solid;">
					&nbsp;Height (mm)</td>
				<td
					style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;border-bottom: 1px solid;">
					&nbsp;<?php echo $row_select_pipe['dim_height']; ?></td>
				<td
					style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;border-bottom: 1px solid;">
					&nbsp;<?php echo $row_select_pipe['dim_height1']; ?></td>
				<td
					style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;border-right: 1px solid;border-bottom: 1px solid;">
					&nbsp;<?php echo $row_select_pipe['avg_height']; ?></td>
			</tr>
		</table>
		<br>
		<table align="center" style="width: 95%;">
			<tr>
				<td style="font-family: 'calibri';font-size: 17px;font-weight: bold;padding: 0 30px;" colspan="10">2.0
					Compressive Test of Bricks</td>
			</tr>
		</table>
		<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0">
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;text-align: left;font-family: 'calibri';font-size: 17px;font-weight: bold;"
					colspan="5">Compressive Strength N/mm2 As per IS:3495(1)1992/R2019</td>
			</tr>
			<tr>
				<td
					style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;height: 30px;vertical-align: top;">
					Length mm</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;vertical-align: top;">Width mm
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;vertical-align: top;">Area mm2
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;vertical-align: top;">Load KN
				</td>
				<td
					style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;vertical-align: top;border-right: 1px solid;">
					C/S N/mm2</td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_l_1']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_b_1']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_area_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_load_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					<?php echo $row_select_pipe['com_1']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_l_2']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_b_2']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_area_2']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_load_2']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					<?php echo $row_select_pipe['com_2']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_l_3']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_b_3']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_area_3']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_load_3']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					<?php echo $row_select_pipe['com_3']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_l_4']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_b_4']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_area_4']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_load_4']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					<?php echo $row_select_pipe['com_4']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_l_5']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_b_5']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_area_5']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_load_5']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					<?php echo $row_select_pipe['com_5']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;padding: 9px"></td>
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;"></td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;"></td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;font-weight: bold;">
					Avg.</td>
				<td
					style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;border-right: 1px solid;font-weight: bold;">
					<?php echo $row_select_pipe['avg_com']; ?></td>
				</td>
			</tr>
		</table>
		<br>
		<table align="center" style="width: 95%;">
			<tr>
				<td style="font-family: 'calibri';font-size: 17px;font-weight: bold;padding: 0 30px;" colspan="10">3.0
					Water Absorption </td>
			</tr>
		</table>
		<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0">
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 17px;font-weight: bold;"
					colspan="4">Water Absorption % As per IS:3495(2)1992/R2019</td>
			</tr>
			<tr>
				<td
					style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;height: 30px;vertical-align: top;">
					Oven Dry wt. <br>gm</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;vertical-align: top;">SDD wt.
					gm</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;vertical-align: top;">water wt
					(SSD-oven dry) gm</td>
				<td
					style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;vertical-align: top;border-right: 1px solid;">
					water <br>Absorption %</td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w1_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<?php echo $row_select_pipe['wtr_w2_1'] - $row_select_pipe['wtr_w1_1']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					<?php echo $row_select_pipe['wtr_1']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w1_2']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_2']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<?php echo $row_select_pipe['wtr_w2_2'] - $row_select_pipe['wtr_w1_2']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					<?php echo $row_select_pipe['wtr_2']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w1_3']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_3']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<?php echo $row_select_pipe['wtr_w2_3'] - $row_select_pipe['wtr_w1_3']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					<?php echo $row_select_pipe['wtr_3']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w1_4']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_4']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<?php echo $row_select_pipe['wtr_w2_4'] - $row_select_pipe['wtr_w1_4']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					<?php echo $row_select_pipe['wtr_4']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w1_5']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_5']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<?php echo $row_select_pipe['wtr_w2_5'] - $row_select_pipe['wtr_w1_5']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					<?php echo $row_select_pipe['wtr_5']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;padding: 9px"><?php echo $row_select_pipe['']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;">
					<?php echo $row_select_pipe['avg_wtr']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;"></td>
				<td
					style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;border-right: 1px solid;font-weight: bold;">
				</td>
		...
		<table align="center" style="width: 95%;">
			<tr>
				<td style="font-family: 'calibri';font-size: 17px;font-weight: bold;padding: 0 30px;" colspan="10">4.0
					Efflorescence =&nbsp;<?php echo $row_select_pipe['rbt_efflo1']; ?></td>
			</tr>
		</table>
		<br>
		<br>
				...
				<td style="text-align:center;">
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-family : Calibri;font-size: 12px;">
						...
						<tr style="">
							...
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo1'] == "NIL") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo2'] == "NIL") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo3'] == "NIL") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo4'] == "NIL") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo5'] == "NIL") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
						...
						<tr style="">
							...
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo1'] == "SLIGHT") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo2'] == "SLIGHT") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo3'] == "SLIGHT") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo4'] == "SLIGHT") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo5'] == "SLIGHT") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
						...
						<tr style="">
							...
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo1'] == "MODERATE") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo2'] == "MODERATE") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo3'] == "MODERATE") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo4'] == "MODERATE") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo5'] == "MODERATE") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
						...
						<tr style="">
							...
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo1'] == "HEAVY") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo2'] == "HEAVY") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo3'] == "HEAVY") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo4'] == "HEAVY") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo5'] == "HEAVY") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
						...
						<tr style="">
							...
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo1'] == "SERIOUS") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo2'] == "SERIOUS") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo3'] == "SERIOUS") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo4'] == "SERIOUS") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
							<td style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center; "><?php if ($row_select_pipe['rbt_efflo5'] == "SERIOUS") {
								echo '&#10004;';
							} else {
								echo " <br>";
							} ?></td>
