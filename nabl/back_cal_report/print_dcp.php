...
<body>
	...
	<page size="A4">
				<tr>
					<td>
						<table align="center" width="100%"  style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse; ">
							<tr>
								<td style="font-size: 15px;font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">DCPT</td>
							</tr>
							<tr>
				...
				<tr>
					<td>
						<table align="center" width="100%"  style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
							...
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 5px 5px 10px;border: 0;">Layer of Material :-</td>
								<td style="font-weight: bold;padding: 5px 5px 10px;"><?php echo $row_select_pipe['layer_mt']; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 5px 5px 10px;border: 0;">Field Moisture :-</td>
								<td style="font-weight: bold;padding: 5px 5px 10px;"><?php echo $row_select_pipe['field_mos']; ?></td>
							</tr>
							<tr>
		...
		<table align="center" width="100%" class="test1" style="border: 0px solid black;" height="Auto">
			<tr style="border: 1px solid black;">
		...
		<table align="center" width="100%" class="test1" style="border: 0px solid black;" height="Auto">
			...
			<tr><td class="test1" style="width:100%;text-align:center;border:1px solid black;padding:7px 7px;" colspan=8>Field CBR = 10^(2.465-1.12*(Log<sub>10</sub>(Pentration/Blow))) (%) = <?php echo $row_select_pipe['cbr']; ?></td></tr>										
			<br>
		</table>
		<br>
