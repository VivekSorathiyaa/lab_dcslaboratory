...
<body>
	...
	<page size="A4">
		...
		<table align="center" width="100%" cellpadding="0" style="font-size:11px;height:auto;font-family : Calibri;border: 1px solid;padding: 0;border-collapse: collapse; ">
			<!-- header design -->
			 <?php 
	         if (($row_select_pipe['suma'] != "" && $row_select_pipe['suma'] != "0" && $row_select_pipe['suma'] != null) || ($row_select_pipe['sumb'] != "" && $row_select_pipe['sumb'] != "0" && $row_select_pipe['sumb'] != null) || ($row_select_pipe['sumaa'] != "" && $row_select_pipe['sumaa'] != "0" && $row_select_pipe['sumaa'] != null) || ($row_select_pipe['sumdd'] != "" && $row_select_pipe['sumdd'] != "0" && $row_select_pipe['sumdd'] != null)) {
	         ?>
			<tr>
				<td>
					<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse; ">
						<tr>
							<td style="font-size: 14px;font-weight: bold;text-align: center;padding: 5px;text-transform: uppercase;border: 1px solid;">COARSE AGGREGATE</td>
						</tr>
						<tr>
							<td style="padding: 1px;border: 1px solid;"></td>
						</tr>
						<tr>
							<td style="font-size: 14px;font-weight: bold;text-align: center;padding: 5px;text-transform: uppercase;border: 1px solid;">SIEVE ANALYSIS TEST</td>
						</tr>
						<tr>
							<td style="padding: 1px;border: 1px solid;"></td>
						</tr>
				...
				<td>
					<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
						<tr>	
							...
							<td style="text-align:left;">FMT-OBS-13</td>
							<td></td>
							<td></td>
						</tr>
						<tr>
							...
							<td style="font-weight: bold;text-align: right;padding: 5px;border: 0;">Testing Date :-</td>
							<td style="padding: 1px;"><?php echo date('d/m/Y', strtotime($start_date)); ?>&nbsp; To &nbsp;<?php echo date('d/m/Y', strtotime($end_date)); ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: left;padding: 5px;border: 0;">Material Description :-</td>
							<td style="padding: 1px;"><?php echo $mt_name; ?></td>
						</tr>
						<tr>
			...
			<tr>
				<td>
					<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
						<tr>
							<td style="font-weight: bold;text-align: left;padding: 5px;border-top: 0;width: 12%;">Test Method :-</td>
							<td style="padding: 5px;border-left: 1px solid;">As Per IS : 2386 (Part-1) : 1963 , Reaffirmed : 2021,Clause No :- 2</td>
						</tr>
						<tr>
			...
			<tr>
				<td>
					...
					<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
						<tr>
							...
							<td style="padding: 5px;"><span><u><?php echo $row_select_pipe['sample_taken']; ?></u></span> gm</td>
						</tr>
						<tr>
						...
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['sieve_1']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_1']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_1']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_1']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_1']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['sieve_2']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_2']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_2']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_2']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_2']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['sieve_3']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_3']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_3']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_3']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_3']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['sieve_4']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_4']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_4']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_4']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_4']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['sieve_4']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_5']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_5']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_5']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_5']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; ">4.75</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_6']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_6']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_6']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_6']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; ">4.75</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_7']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_7']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_7']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_7']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; ">4.75</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_8']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_8']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_8']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_8']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; ">4.75</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_9']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_9']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_9']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_9']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; ">4.75</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_10']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_10']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_10']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_10']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; ">4.75</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_11']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_11']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_11']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_11']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; ">4.75</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_12']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_12']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_12']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_12']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; ">4.75</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_wt_gm_13']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['ret_wt_gm_13']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['cum_ret_13']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['pass_sample_13']; ?></td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; ">Total</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['blank_extra']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['blank_extra1']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['blank_extra2']; ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; "><?php echo $row_select_pipe['blank_extra3']; ?></td>
						</tr>
					</table>
				</td>
			</tr>
			 ...
			 <?php 
	         } if (($row_select_pipe['bdl'] != "" && $row_select_pipe['bdl'] != "0" && $row_select_pipe['bdl'] != null)) {
	         ?>
			...
			<tr>
				<td>
					<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
						...
						<tr>
							<td style="font-size: 12px;font-weight: bold;text-align: center; padding: 5px;border-top: 0;width: 8%;" colspan="6">DENSITY TEST</td>
						</tr>
						<tr>
							<td style="padding: 1px;border: 1px solid;" colspan="6"></td>
						</tr>
						<tr>
							<td style="text-align: left;padding: 5px;border-top: 1px solid; border-right:0px; width: 60%;" colspan="2"><b>Test Method :-</b> As Per IS : 2386 (Part-3) : 1963, Reaffirmed : 2021, Clause No :- 3 <span></span></td>
						</tr>
						<tr>
							<td style="padding: 1px;border: 1px solid;" colspan="6"></td>
						</tr>
						...
						<tr>
							<td style="text-align: left;padding: 5px;border: 0;"><b>Amount of Sample taken :-</b>&nbsp; gm <span></span> </td>
							<td style="text-align: left;padding: 5px;border: 0;"><b>Method :-</b> <span>Loose Density / Compacted Density</span> </td>
						</tr>
					</table>
				</td>
			</tr>
				...
				<td>
					...
					<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;border-top:2px solid;">
						<tr>
							...
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Volume of <br> Container</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Container Weight <br> with Sample</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Container Empty <br> Weight</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Weight of Sample</td>
						...
						<tr>
							...
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; ">M<sub>3</sub></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; ">M<sub>1</sub> = M<sub>2</sub> - M<sub>3</sub></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; ">g = M<sub>1</sub>/M<sub>2</sub></td>
						</tr>
						<tr>
							<td style="text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;">litre</td>
							<td style="text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;">kg</td>
							<td style="text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;">kg</td>
							<td style="text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;">kg</td>
							<td style="text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;">kg/litre</td>
						</tr>
						<tr>
							<td style="text-align: center;padding: 2px;border: 1px solid;">1</td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m11']; ?></td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m21']; ?></td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m31']; ?></td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m11']; ?></td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m11']; ?></td>
						</tr>
						<tr>
							<td style="text-align: center;padding: 2px;border: 1px solid;">2</td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m12']; ?></td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m22']; ?></td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m32']; ?></td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m42']; ?></td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m52']; ?></td>
						</tr>
						<tr>
							<td style="text-align: center;padding: 2px;border: 1px solid;">3</td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m13']; ?></td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m23']; ?></td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m33']; ?></td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m43']; ?></td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m53']; ?></td>
						</tr>
						<tr>
							<td style="text-align: right;padding: 2px;border: 1px solid;" colspan="5">Average Bulk Density =</td>
							<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['avg_wom']; ?></td>
						</tr>
					</table>
				</td>
			</tr>
            ...
            <?php 
	         } if (($row_select_pipe['suma'] != "" && $row_select_pipe['suma'] != "0" && $row_select_pipe['suma'] != null) || ($row_select_pipe['sumb'] != "" && $row_select_pipe['sumb'] != "0" && $row_select_pipe['sumb'] != null) || ($row_select_pipe['sumaa'] != "" && $row_select_pipe['sumaa'] != "0" && $row_select_pipe['sumaa'] != null) || ($row_select_pipe['sumdd'] != "" && $row_select_pipe['sumdd'] != "0" && $row_select_pipe['sumdd'] != null) || ($row_select_pipe['bdl'] != "" && $row_select_pipe['bdl'] != "0" && $row_select_pipe['bdl'] != null)) {
	         ?>
			...
			<tr>
				<td>
					<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border: 1px solid; border-left:1px solid;border-right:1px solid; ">
						...
						<!-- <tr>
							<td colspan="" style="font-weight: bold;text-align: left;padding: 5px;border-left: 1px solid; border-right:1px solid; width:%">Remarks :-</td>
						...
						<tr>
							<td style="height: 40px;border: 1px solid;font-weight: bold;border-right: 1px solid; padding: 5px; border-bottom:0px; border-top:0px solid; " colspan="4"></td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				<td>
					<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 0px solid;border-right: 0px solid;border-bottom: 1px solid; border-top:0px;">
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid; ;width: 20%;">Issue No :- </td>
						...
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">Amend No :- </td>
						...
						<tr>
							<td colspan="5" style="font-weight: bold;border-top: 1px solid;text-align: right;border-left:1px solid; border-right:1px solid;">Page 1 of 6</td>
						</tr>
		...
		<page size="A4">
		    ...
		    <?php 
	         if (($row_select_pipe['fi_index'] != "" && $row_select_pipe['fi_index'] != "0" && $row_select_pipe['fi_index'] != null) || ($row_select_pipe['ei_index'] != "" && $row_select_pipe['ei_index'] != "0" && $row_select_pipe['ei_index'] != null) || ($row_select_pipe['combined_index'] != "" && $row_select_pipe['combined_index'] != "0" && $row_select_pipe['combined_index'] != null)) {
	         ?>
			...
			<table align="center" width="100%" cellpadding="0" style="font-size:11px;height:auto;font-family : Calibri;border: 1px solid;padding: 0;border-collapse: collapse; ">
				...
				<tr>
					<td>
						<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse; ">
							...
							<tr>
								<td style="font-size: 14px;font-weight: bold;text-align: center;padding: 5px;text-transform: uppercase;border: 1px solid;">FLAKINESS INDEX TEST</td>
							</tr>
							<tr>
								<td style="padding: 1px;border: 1px solid;"></td>
							</tr>
				...
				<tr>
					<td>
						<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 5px;border-top: 1px solid;width: 20%;">Test Method :-</td>
								<td style="padding: 5px;border-left: 1px solid;border-top: 1px solid;"></td>
							</tr>
							<tr>
								<td style="padding: 1px;border: 1px solid; " colspan="6"></td>
							</tr>
				...
				<tr>
					<td>
						...
						<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" colspan="2">Aggregate Size</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Weight of Fraction <br> Retained on Each <br> Sieve</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Mass of Pieces Passing through Appropriate Gauge</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Percentage of the Mass <br>of Total Number of <br> Pieces Pass in Each <br> Fraction</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Percentage of Each <br>Fraction of Pieces to <br> the Total Mass of Sample</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Weighted <br> Percentage of the <br>Mass of Pieces <br> Passing</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;" rowspan="2">Passing through <br> IS Sieve</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;" rowspan="2">Retained <br>on IS Sieve</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">A</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">B</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">X = b/ax 100</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Y = a/Ax 100</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">F = X x Y/100</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;">mm</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;">mm</td>
							...
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">63</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">50</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['a1']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['b1']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['aa1']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['dd1']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['x1']; ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">50</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">40</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['a2']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['b2']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['aa2']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['dd2']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['x2']; ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">40</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">31.5</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['a3']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['b3']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['aa3']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['dd3']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['x3']; ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">31.5</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">25</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['a4']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['b4']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['aa4']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['dd4']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['x4']; ?></td>
							</tr>

							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">25</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">20</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['a5']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['b5']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['aa5']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['dd5']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['x5']; ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">20</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">16</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['a6']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['b6']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['aa6']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['dd6']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['x6']; ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">16</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">12.5</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['a7']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['b7']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['aa7']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['dd7']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['x7']; ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">12.5</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">10</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['a8']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['b8']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['aa8']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['dd8']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['x8']; ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">10</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">6.3</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['a9']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['b9']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['aa9']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['dd9']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['x9']; ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" colspan="2"><b>Total</b></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid; border-bottom:2px solid;">A= <span></span><?php echo $row_select_pipe['suma']; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid; border-bottom:2px solid;">B= <span><?php echo $row_select_pipe['suma']; ?></span></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;"></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;"></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid; border-bottom:2px solid;">F= <span></span><?php echo $row_select_pipe['sumdd1']; ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 20px;border: 0px solid;" colspan="3">Flakiness Index, F =</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 2px solid; border-bottom:1px solid;"><?php echo $row_select_pipe['fi_index']; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;">%</td>
							</tr>
	         ...
	         if (($row_select_pipe['suma1'] != "" && $row_select_pipe['suma1'] != "0" && $row_select_pipe['suma1'] != null) || ($row_select_pipe['suma2'] != "" && $row_select_pipe['suma2'] != "0" && $row_select_pipe['suma2'] != null) || ($row_select_pipe['sumdd1'] != "" && $row_select_pipe['sumdd1'] != "0" && $row_select_pipe['sumdd1'] != null) || ($row_select_pipe['fi_index1'] != "" && $row_select_pipe['fi_index1'] != "0" && $row_select_pipe['fi_index1'] != null)) {
	         ?>
					...
					<tr>
						<td>
							<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse; ">
								...
								<tr>
									<td style="font-size: 14px;font-weight: bold;text-align: center;padding: 5px;text-transform: uppercase;border: 1px solid;">ELONGATION INDEX TEST</td>
								</tr>
								<tr>
									<td style="padding: 1px;border: 1px solid;"></td>
								</tr>
					...
					<tr>
						<td>
							...
							<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
								<tr>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" colspan="2">Aggregate Size</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Sample Retained on <br> Each Sieve Fraction</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Mass of Pieces Passing through Appropriate Gauge</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Percentage of the Mass <br>of Total Number of <br> Pieces Pass in Each <br> Fraction</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Percentage of Each <br>Fraction of Pieces to <br> the Total Mass of Sample</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Weighted <br> Percentage of the <br>Mass of Pieces <br> Passing</td>
								...
								<tr>
									...
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m1']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['p1']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['pp1']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['w1']; ?></td>
								</tr>
								<tr>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">40</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">25</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['s2']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m2']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['p2']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['pp2']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['w2']; ?></td>
								</tr>
								...
								<tr>
									...
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m3']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['p3']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['pp3']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['w3']; ?></td>
								</tr>
								<tr>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">20</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">16</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['s4']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m4']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['p4']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['pp4']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['w4']; ?></td>
								</tr>

								<tr>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">16</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">12.5</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['s5']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m6']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['p6']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['pp6']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['w6']; ?></td>
								</tr>
								<tr>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">12.5</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">10</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['s7']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m7']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['p7']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['pp7']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['w7']; ?></td>
								</tr>
								<tr>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">10</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">6.3</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['s8']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['m8']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['p8']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['pp8']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['w8	']; ?></td>
								</tr>
								<tr>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" colspan="2"><b>Total</b></td>
									<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid; border-bottom:2px solid;">A= <span></span><?php echo $row_select_pipe['suma1']; ?></td>
									<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid; border-bottom:2px solid;">B= <span></span><?php echo $row_select_pipe['suma2']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;"></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;"></td>
									<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid; border-bottom:2px solid;">F= <span></span><?php echo $row_select_pipe['sumdd1']; ?></td>
								</tr>
								<tr>
									<td style="font-weight: bold;text-align: center;padding: 20px;border: 0px solid;" colspan="3">Flakiness Index, F =</td>
									<td style="font-weight: bold;text-align: center;padding: 2px;border: 2px solid; border-bottom:1px solid;"><?php echo $row_select_pipe['fi_index1']; ?></td>
									<td style="font-weight: bold;text-align: center;padding: 2px;">%</td>
								</tr>
					...
					<tr>
						...
						<tr>
							...
							<td style="border-top:1px solid; border-bottom:1px solid;"></td>
								...
								<tr>
									<td style="height: 50px;border: 1px solid;font-weight: bold;border-right: 1px solid; padding: 5px; border-bottom:0px; border-top:0px solid; " colspan="4"></td>
								</tr>
							</table>
						</td>
					</tr>
	         ...
	         if (($row_select_pipe['sp_specific_gravity_a'] != "" && $row_select_pipe['sp_specific_gravity_a'] != "0" && $row_select_pipe['sp_specific_gravity_a'] != null) || ($row_select_pipe['sp_specific_gravity_b'] != "" && $row_select_pipe['sp_specific_gravity_b'] != "0" && $row_select_pipe['sp_specific_gravity_b'] != null) || ($row_select_pipe['sp_specific_gravity'] != "" && $row_select_pipe['sp_specific_gravity'] != "0" && $row_select_pipe['sp_specific_gravity'] != null) || ($row_select_pipe['sp_water_abr'] != "" && $row_select_pipe['sp_water_abr'] != "0" && $row_select_pipe['sp_water_abr'] != null) || ($row_select_pipe['sp_specific_gravity_a1'] != "" && $row_select_pipe['sp_specific_gravity_a1'] != "0" && $row_select_pipe['sp_specific_gravity_a1'] != null) || ($row_select_pipe['sp_specific_gravity_b1'] != "" && $row_select_pipe['sp_specific_gravity_b1'] != "0" && $row_select_pipe['sp_specific_gravity_b1'] != null) || ($row_select_pipe['sp_specific_gravity1'] != "" && $row_select_pipe['sp_specific_gravity1'] != "0" && $row_select_pipe['sp_specific_gravity1'] != null) || ($row_select_pipe['sp_water_abr1'] != "" && $row_select_pipe['sp_water_abr1'] != "0" && $row_select_pipe['sp_water_abr1'] != null) || ($row_select_pipe['sp_specific_gravity_a2'] != "" && $row_select_pipe['sp_specific_gravity_a2'] != "0" && $row_select_pipe['sp_specific_gravity_a2'] != null) || ($row_select_pipe['sp_specific_gravity_b2'] != "" && $row_select_pipe['sp_specific_gravity_b2'] != "0" && $row_select_pipe['sp_specific_gravity_b2'] != null) || ($row_select_pipe['sp_specific_gravity2'] != "" && $row_select_pipe['sp_specific_gravity2'] != "0" && $row_select_pipe['sp_specific_gravity2'] != null) || ($row_select_pipe['sp_water_abr2'] != "" && $row_select_pipe['sp_water_abr2'] != "0" && $row_select_pipe['sp_water_abr2'] != null)) {
	         ?>
						...
						<table align="center" width="100%" cellpadding="0" style="font-size:11px;height:auto;font-family : Calibri;border: 1px solid;padding: 0;border-collapse: collapse; ">
							...
							<tr>
								<td>
									<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse; ">
										...
										<tr>
											<td style="font-size: 14px;font-weight: bold;text-align: center;padding: 5px;text-transform: uppercase;border: 1px solid;">SPECIFIC GRAVITY & WATER ABSORPTION TEST</td>
										</tr>
										<tr>
											<td style="padding: 1px;border: 1px solid;"></td>
										</tr>
							...
							<tr>
								<td>
									<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
										<tr>
											<td style="text-align: left;padding: 5px;border-top: 0;width: 10%;"><b>Test Method :- </b> As Per IS: 2386 (Part-3): 1963 Reaffirmed: 2021, Clause No:- 2.4 (Method III - Aggregate Smaller Than 10mm)</td>
											<td style="padding: 5px;border-left: 0px solid;"></td>
										</tr>
										<tr>
											<td style="padding: 1px;border: 1px solid;" colspan="6"></td>
										</tr>
										...
										<tr>
											<td style="text-align: left;padding: 5px;border: 0; width:80%;"><b>Amount of Sample taken :-</b> <span></span> gm (1000 gm for Size 10 mm to 4.75 mm & 500 gm for Size Smaller than 4.75mm)</td>
											<td style="text-align: right;padding: 5px;border: 0; padding-right:10%;"><b>Temperature :-</b> <span></span> °C</td>
										</tr>
									</table>
								</td>
							</tr>
							...
							<tr>
								<td>
									...
									<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
										<tr>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Sr. No.</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Sample ID</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Wt. of Saturated <br>Surface Dry <br> Sample, A (g)</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Wt. of Pycnometerbr <br> Containing Sample <br> & Filled With <br> Distilled Water, B, <br> (g)</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Wt. of Pycnometer <br> Filled With distilled <br> Water only, C (g)</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;" rowspan="2">Wt. of Oven Dry <br> Sample, D (g)</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Specific Gravity Based <br> on Dry Aggregate</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Specific Gravity Based <br> on Saturated Surface <br> Dry Aggregate</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Apparent Specific <br> Gravity</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Water <br> Absorption</td>
										</tr>
										<tr>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;">G = (D) <br>______________<br>(A - (B - C))</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;">G = (A) <br>______________<br>(A - (B - C))</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;">G = (D) <br>______________<br>(D - (B - C))</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom:2px solid;">100 x (A - D)<br>______________<br>(D)</td>
										</tr>
										<tr>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">1</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_wt_st_1']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_w_s_1']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_w_sur_1']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_agg1']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_wat1']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_a_1']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_b_1']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_1']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_water_abr_1']; ?></td>
										</tr>
										<tr>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">2</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_wt_st_2']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_w_s_2']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_w_sur_2']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_agg2']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_wat2']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_a_2']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_b_2']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_2']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_water_abr_2']; ?></td>
										</tr>
										<tr>
											<td style="font-weight: bold;text-align: right;padding: 2px;border: 1px solid;" colspan="6">Average =</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_a']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_b']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_water_abr']; ?></td>
										</tr>
										<tr>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">1</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_wt_st_3']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_w_s_3']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_w_sur_3']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_agg3']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_wat3']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_a_3']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_b_3']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_3']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_water_abr_3']; ?></td>
										</tr>
										<tr>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">2</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_wt_st_4']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_w_s_4']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_w_sur_4']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_agg4']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_wat4']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_a_4']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_b_4']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_4']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_water_abr_4']; ?></td>
										</tr>
										<tr>
											<td style="font-weight: bold;text-align: right;padding: 2px;border: 1px solid;" colspan="6">Average =</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_a1']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_b1']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity1']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_water_abr1']; ?></td>
										</tr>
										<tr>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">1</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_wt_st_5']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_w_s_5']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_w_sur_5']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_agg5']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_wat5']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_a_5']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_b_5']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_5']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_water_abr_5']; ?></td>
										</tr>
										<tr>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">2</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_wt_st_6']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_w_s_6']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_w_sur_6']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_agg6']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_wat6']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_a_6']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_b_6']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_6']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_water_abr_6']; ?></td>
										</tr>
										<tr>
											<td style="font-weight: bold;text-align: right;padding: 2px;border: 1px solid;" colspan="6">Average =</td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_a2']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity_b2']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_specific_gravity2']; ?></td>
											<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"><?php echo $row_select_pipe['sp_water_abr2']; ?></td>
										</tr>
									</table>
								</td>
							</tr>
							...
							<tr>
								<td>
									<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 0px solid;border-right: 0px solid;border-bottom: 1px solid; border-top:0px;">
										...
										<tr>
											<td colspan="5" style="font-weight: bold;border-top: 1px solid;text-align: right;border-left:1px solid; border-right:1px solid;">Page 4 of 6</td>
										</tr>
			 ...
			 <?php } if(($row_select_pipe['cru_value_1'] != "" && $row_select_pipe['cru_value_1'] != "0" && $row_select_pipe['cru_value_1'] != null) || ($row_select_pipe['cru_value_2'] != "" && $row_select_pipe['cru_value_2'] != "0" && $row_select_pipe['cru_value_2'] != null) || ($row_select_pipe['cru_value'] != "" && $row_select_pipe['cru_value'] != "0" && $row_select_pipe['cru_value'] != null)) { ?>
						<div class="pagebreak"></div>
						<br><br><br><br>
						<page size="A4">
							...
							<table align="center" width="100%" cellpadding="0" style="font-size:11px;height:auto;font-family : Calibri;border: 1px solid;padding: 0;border-collapse: collapse;">
								...
								<tr>
									<td>
										<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;">
											<tr>
												<td style="font-size: 15px;font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">COURSE AGGRAGATE</td>
											</tr>
											<tr>
												<td style="padding: 1px;border: 1px solid;"></td>
											</tr>
											<tr>
												<td style="font-size: 14px;font-weight: bold;text-align: center;padding: 2px;text-transform: uppercase;border: 1px solid;">CRUSHING VALUE TEST</td>
											</tr>
											<tr>
												<td style="padding: 1px;border: 1px solid;"></td>
											</tr>
								...
								<tr>
									<td>
										<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
											<tr>
												<td style="font-weight: bold;text-align: right;padding-right: 100px;padding-top:5px; padding-bottom:5px;">Testing Date :-</td>
											</tr>
											<tr>
												<td style="padding: 1px;border: 1px solid;" colspan="4"></td>
											</tr>
								...
								<tr>
									<td>
										<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
											<tr>
												<td style="font-weight: bold;text-align: left;padding: 3px;">Test Method :-</td>
												<td>As Per IS: 2386 (Part-4) : 1963, Reaffirmed : 2021 , Clause No : - 2</td>
											</tr>
											<tr>
								...
								<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse; border-left: 2px solid;border-right: 2px solid;">
									<tr>
										<td style="border-left: 0; border-right: 0; padding-top:5px; padding-bottom: 5px"><b>I.S. Sieves :- </b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span> 12.5 mm, 10 mm and 2.36 mm </span> </td>
										<td style="text-align: right; padding-right:20px; border-right: 0;border-left: 0; padding-top:5px; padding-bottom: 5px"><b>Diameter of mould used :-</b> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span> 75 mm / 150 mm </span> </td>
									</tr>
									<td style="text-align: left; padding-right:20px; border-right: 0;border-left: 0; padding-top:5px; padding-bottom: 10px"><b>Amount of sample taken :- &nbsp; &nbsp; &nbsp; &nbsp; <span> _______ </span></b> &nbsp; &nbsp; gm </td>
									<tr>
									</tr>
								</table>
								<tr>
										...
										<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 2px solid;border-right: 2px solid;border-bottom: 1px solid; border-top:2px solid;">
											...
											<table align="center" width="100%" style="font-size:11px;height:auto; font-family : Calibri;border-collapse: collapse;border-left: 2px solid;border-right: 2px solid;border-bottom: 1px solid; border-top:2px solid;">
												<tr>
													...
													<td style="text-align: center; font-weight:bold; border:1px solid; border-bottom:2px solid;" rowspan="3">Sample ID</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">Weight of Fraction Passing on 12.5<br> mm and Retained on 10 mm IS Sieve </td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">Weight of Fraction Passing<br> on 2.36 mm IS Sieve</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">Weight of Fraction Retained<br> on 2.36 mm IS Sieve</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">Aggregate Crushing<br> Value</td>
												</tr>
												<tr>
													<!-- <td style="text-align: center; font-weight:bold; border:1px solid;">t<sub>1</sub></td> -->
													<td style="text-align: center; font-weight:bold; border:1px;">A</td>
													...
													<td style="text-align: center; font-weight:bold; border:1px solid;">B/A X 100</td>
												</tr>
												<tr>
												...
												<tr>
													<td style="font-weight:bold; border:1px solid; text-align: center;">1</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">2</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['cr_a_1']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['cr_b_1']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['cr_c_1']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['cru_value_1']; ?></td>
												</tr>
												<tr>
													<td style="font-weight:bold; border:1px solid; text-align: center;">2</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">2</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['cr_a_2']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['cr_b_2']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['cr_a_2']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['cru_value_2']; ?></td>
												</tr>
												<tr>
													<td style="text-align: center; font-weight:bold; border:1px solid; text-align: end; border-top:2px solid;" colspan="5">Average Crushing Value :-</td>
													<td style="text-align: center; font-weight:bold; border:1px solid; border-top:2px solid;"><?php echo $row_select_pipe['cru_value']; ?></td>
												</tr>
											</table>
										</table>
									</td>
								...
								<tr>
									<td>
										<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse; border-left:2px solid; border-right:2px solid;">
											...
											<tr>
												<td style="font-size: 14px;font-weight: bold;text-align: center;padding: 2px;text-transform: uppercase;border: 1px solid;">IMPACT VALUE TEST</td>
											</tr>
											<tr>
												<td style="padding: 1px;border: 1px solid;"></td>
											</tr>
								...
								<tr>
									<td>
										<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
											<tr>
												<td style="font-weight: bold;text-align: right;padding-right: 100px;padding-top:5px; padding-bottom:5px;  border-right:2px solid; border-left:2px solid;">Testing Date :-</td>
											</tr>
											<tr>
												<td style="padding: 1px;border: 1px solid;  border-right:2px solid; border-left:2px solid;" colspan="4"></td>
											</tr>
										</table>
									</td>
								</tr>
								<tr>
									<td>
										<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 2px solid;border-right: 2px solid; ">
											<tr>
												<td style="font-weight: bold;text-align: left;padding: 3px;">Test Method :-</td>
												<td> As Per IS: 2386 (Part-4) : 1963, Reaffirmed : 2021 , Clause No : - 4</td>
											</tr>
											<tr>
												<td style="padding: 1px;border: 1px solid;" colspan="2"></td>
											</tr>
								...
								<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse; border-left: 2px solid;border-right: 2px solid;">
									<tr>
										<td style="border-left: 0; font-weight:bold;border-right: 0; padding-top:5px; padding-bottom:5px">I.S Sieves :-<span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 12.5 mm, 10 mm and 2.36 mm</span></td>
									</tr>
									<tr>
										<td style="border-left: 0; font-weight:bold;border-right: 0;padding-bottom: 10px">Amount of Sample taken :- &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span style="font-weight: bolder;">________</span> <span>&nbsp; &nbsp; gm</span></td>
									</tr>
								</table>
								<tr>
									<td>
										<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 2px solid;border-right: 2px solid;border-bottom: 1px solid; border-top:2px solid;">
											...
											<table align="center" width="100%" style="font-size:11px;height:auto; font-family : Calibri;border-collapse: collapse;border-left: 2px solid;border-right: 2px solid;border-bottom: 1px solid; border-top:2px solid; ">
												...
												<tr>
													<td style="text-align: center; font-weight:bold; border:1px solid; border-bottom:2px solid;" rowspan="3">Sr. No.</td>
													<td style="text-align: center; font-weight:bold; border:1px solid; border-bottom:2px solid;" rowspan="3">Sample ID</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">Weight of Fraction Passing<br> on 12.5 mm and Retained<br> on 10 mm IS Sieve </td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">Weight of Fraction<br> Passing on 2.36<br> mm IS Sieve</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">Weight of Fraction<br> Retained on 2.36<br> mm IS Sieve</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">Total Weight of Fraction<br> Passing and Retained<br> on 2.36 mm IS Sieve </td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">Aggregate Impact<br> Value</td>
												</tr>
												<tr>
													<!-- <td style="text-align: center; font-weight:bold; border:1px solid;">t<sub>1</sub></td> -->
													<td style="text-align: center; font-weight:bold; border:1px;">A</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">B</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">C</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">B + C</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">B/A X 100</td>
												</tr>
												<tr>
													<!-- <td style="text-align: center; font-weight:bold; border:1px solid; border-bottom:2px solid;">Sec</td> -->
												...
												<tr>
													...
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['imp_w_m_a_1']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['imp_w_m_b_1']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['imp_w_m_c_1']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['imp_w_m_d_1']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['imp_value_1']; ?></td>
												</tr>
												<tr>
													<td style="font-weight:bold; border:1px solid; text-align: center;">2</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;">2</td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['imp_w_m_a_2']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['imp_w_m_b_1']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['imp_w_m_c_2']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['imp_w_m_d_2']; ?></td>
													<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['imp_value_2']; ?></td>
												</tr>
												<tr>
													<td style="text-align: center; font-weight:bold; border:1px solid; text-align: end; border-top:2px solid;" colspan="6">Average Impact Value :-</td>
													<td style="text-align: center; font-weight:bold; border:1px solid; border-top:2px solid;"><?php echo $row_select_pipe['imp_value']; ?></td>
												</tr>
												<tr>
													<td style="border:2px solid; border-bottom:0px solid; FONT-WEIGHT:BOLD; padding:3px;" colspan="7"> Note*:- If The Total Weight (B + C)
														Is less than the initial Weight (Weight A)by more than one gram, the result shall be Discarded and a Fresh test made.</td>
												</tr>
											</table>
								</tr>
							</table>
			 ...
			 <?php } if(($row_select_pipe['abr_1'] != "" && $row_select_pipe['abr_1'] != "0" && $row_select_pipe['abr_1'] != null) || ($row_select_pipe['abr_2'] != "" && $row_select_pipe['abr_2'] != "0" && $row_select_pipe['abr_2'] != null) || ($row_select_pipe['abr_index'] != "" && $row_select_pipe['abr_index'] != "0" && $row_select_pipe['abr_index'] != null)) { ?>
			...
			<tr>
				<td>
					<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse; border-left:2px solid; border-right:2px solid;">
						...
						<tr>
							<td style="font-size: 14px;font-weight: bold;text-align: center;padding: 2px;text-transform: uppercase;border: 1px solid;">ABRASION VALUE TEST</td>
						</tr>
						<tr>
							<td style="padding: 1px;border: 1px solid;"></td>
						</tr>
			...
			<tr>
				<td>
					<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 2px solid;border-right: 2px solid; ">
						<tr>
							<td style="font-weight: bold;text-align: left;padding: 3px;">Test Method :-</td>
							<td> As Per IS: 2386 (Part-4) : 1963, Reaffirmed : 2021 , Clause No : - 5.3</td>
						</tr>
						<tr>
							<td style="padding: 1px;border: 1px solid;" colspan="2"></td>
						</tr>
			...
			<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse; border-left: 2px solid;border-right: 2px solid;">
				<tr>
					<td style="border-left: 0; font-weight:bold;border-right: 0; padding-top:5px; padding-bottom:5px">I.S Sieves :-<span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 1.70 mm</span></td>
				</tr>
				<tr>
					<td style="border-left: 0; font-weight:bold;border-right: 0;padding-bottom: 10px">Amount of Sample taken :- &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <span style="font-weight: bolder;">________</span> <span>&nbsp; &nbsp; gm</span></td>
				</tr>
					...
					<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 2px solid;border-right: 2px solid;border-bottom: 1px solid; border-top:2px solid;">
						...
						<table align="center" width="100%" style="font-size:11px;height:auto; font-family : Calibri;border-collapse: collapse;border-left: 2px solid;border-right: 2px solid;border-bottom: 1px solid; border-top:2px solid; ">
							...
							<tr>
								<td style="text-align: center; font-weight:bold; border:1px solid; border-bottom:2px solid;" rowspan="3">Sr. No.</td>
								<td style="text-align: center; font-weight:bold; border:1px solid; border-bottom:2px solid;" rowspan="3">Sample ID</td>
								<td style="text-align: center; font-weight:bold; border:1px solid;">Initial Weight </td>
								<td style="text-align: center; font-weight:bold; border:1px solid;">Weight of Fraction Retained<br> on 1.70 mm IS Sieve</td>
								<td style="text-align: center; font-weight:bold; border:1px solid;">Weight of Fraction Passing<br> on 1.70 mm IS Sieve</td>
								<!-- <td style="text-align: center; font-weight:bold; border:1px solid;">Total Weight of Fraction<br> Passing and Retained<br> on 2.36 mm IS Sieve </td> -->
								<td style="text-align: center; font-weight:bold; border:1px solid;">Aggregate Impact<br> Value</td>
							</tr>
							<tr>
								...
								<td style="text-align: center; font-weight:bold; border:1px;">A</td>
								<td style="text-align: center; font-weight:bold; border:1px solid;">B</td>
								<td style="text-align: center; font-weight:bold; border:1px solid;">C = A - B </td>
								<!-- <td style="text-align: center; font-weight:bold; border:1px solid;">B + C</td> -->
								<td style="text-align: center; font-weight:bold; border:1px solid;">C/A X 100</td>
							</tr>
							<tr>
								<!-- <td style="text-align: center; font-weight:bold; border:1px solid; border-bottom:2px solid;">Sec</td> -->
								<td style="text-align: center; font-weight:bold; border:1px solid; border-bottom:2px solid;">gm</td>
							...
							<tr>
								<td style="font-weight:bold; border:1px solid; text-align: center;">1</td>
								<td style="text-align: center; font-weight:bold; border:1px solid;">1</td>
								<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['abr_wt_t_a_1']; ?></td>
								<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['abr_wt_t_b_1']; ?></td>
								<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['abr_1']; ?></td>
								<!-- <td style="text-align: center; font-weight:bold; border:1px solid;"></td> -->
								<td style="text-align: center; font-weight:bold; border:1px solid;"></td>
							</tr>
							<tr>
								<td style="font-weight:bold; border:1px solid; text-align: center;">2</td>
								<td style="text-align: center; font-weight:bold; border:1px solid;">2</td>
								<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['abr_wt_t_a_2']; ?></td>
								<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['abr_wt_t_b_2']; ?></td>
								<td style="text-align: center; font-weight:bold; border:1px solid;"><?php echo $row_select_pipe['abr_2']; ?></td>
								<!-- <td style="text-align: center; font-weight:bold; border:1px solid;"></td> -->
								<td style="text-align: center; font-weight:bold; border:1px solid;"></td>
							</tr>
							<tr>
								<td style="text-align: center; font-weight:bold; border:1px solid; text-align: end; border-top:2px solid;" colspan="5">Average Abrasion Value :-</td>
								<td style="text-align: center; font-weight:bold; border:1px solid; border-top:2px solid;"><?php echo $row_select_pipe['abr_index']; ?></td>
							</tr>
						</table>
			</tr>
			</table>
			...
			<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 2px solid;border-right: 2px solid;border-bottom: 1px solid;">
				<tr>
					<td style="height: 40px;border: 1px solid;border-bottom: 2px solid;" colspan="4"></td>
				</tr>
			...
			<tr>
				<td>
					<table align="center" width="100%" style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 2px solid;border-right: 2px solid;border-bottom: 2px solid;">
						<tr>
							<td style="font-weight: bold;text-align: left;padding: 2px;border-top: 0;width: 20%;border-right:1px solid;">Issue No :- </td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border-top: 0;width: 20%; border-right:1px solid;"> Issue Date :- <?php echo date('d/m/Y', strtotime($issue_date)); ?></td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border-top: 0;width: 23% ;border-right:1px solid;">Prepared & Issued By</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border-top: 0;width: 23%;">Reviewed & Approved By</td>
						</tr>
						<tr>
							<td style="font-weight: bold;text-align: left;padding: 2px;border-top: 1px solid; border-right:1px solid;">Amend No :- </td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border-top: 1px solid; border-right:1px solid;">Amend Date :- <?php echo date('d/m/Y', strtotime($row_select_pipe["amend_date"])); ?> </td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border-top: 1px solid; border-right:1px solid;">(Quality Manager)</td>
							<td style="font-weight: bold;text-align: center;padding: 2px;border-top: 1px solid;">(Chief Executive Officer)</td>
						</tr>
						<tr>
							<td colspan="5" style="font-weight: bold;border-top: 1px solid;text-align: right;">Page 5 of 6</td>
						</tr>
	...
	<?php if (($row_select_pipe['sp_specific_gravity'] != "" && $row_select_pipe['sp_specific_gravity'] != "0" && $row_select_pipe['sp_specific_gravity'] != null) || ($row_select_pipe['sp_water_abr'] != "" && $row_select_pipe['sp_water_abr'] != "0" && $row_select_pipe['sp_water_abr'] != null) || ($row_select_pipe['bdl'] != "" && $row_select_pipe['bdl'] != "0" && $row_select_pipe['bdl'] != null) || ($row_select_pipe['avg_wom'] != "" && $row_select_pipe['avg_wom'] != "0" && $row_select_pipe['avg_wom'] != null)) { ?>
		...
		<!-- <?php $cnt = 1; ?>
		<table align="center" width="94%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;">
			<tr>
				<td style="text-align:center;font-size:16px;">
					<table align="left" width="100%" cellspacing="0" cellpadding="0" style="font-size:12px;font-family : Calibri;border: 0;">
						<tr>
					...
					<table align="left" width="100%" cellspacing="0" cellpadding="0" style="font-size:12px;font-family : Calibri;border:1px solid;">
						<tr>
						...
						<tr>
							...
							<td style="border-left:1px solid;text-align:center;padding: 6px 0;border-bottom:1px solid;"><?php if ($row_select_pipe['sp_wt_st_1'] != "" && $row_select_pipe['sp_wt_st_1'] != "0" && $row_select_pipe['sp_wt_st_1'] != null) {
																															echo $row_select_pipe['sp_wt_st_1'];
																														} else {
																															echo " <br>";
																														} ?></td>
							<td style="border-left:1px solid;text-align:center;padding: 6px 0;border-bottom:1px solid;"><?php if ($row_select_pipe['sp_w_s_1'] != "" && $row_select_pipe['sp_w_s_1'] != "0" && $row_select_pipe['sp_w_s_1'] != null) {
																															echo $row_select_pipe['sp_w_s_1'];
																														} else {
																															echo " <br>";
																														} ?></td>
							<td style="border-left:1px solid;text-align:center;padding: 6px 0;border-bottom:1px solid;"><?php if ($row_select_pipe['sp_w_sur_1'] != "" && $row_select_pipe['sp_w_sur_1'] != "0" && $row_select_pipe['sp_w_sur_1'] != null) {
																															echo $row_select_pipe['sp_w_sur_1'];
																														} else {
																															echo " <br>";
																														} ?></td>
							<td style="border-left:1px solid;text-align:center;padding: 6px 0;border-bottom:1px solid;"><?php if ($row_select_pipe['sp_specific_gravity_1'] != "" && $row_select_pipe['sp_specific_gravity_1'] != "0" && $row_select_pipe['sp_specific_gravity_1'] != null) {
																															echo $row_select_pipe['sp_specific_gravity_1'];
																														} else {
																															echo " <br>";
																														} ?></td>
							<td style="border-left:1px solid;text-align:center;padding: 6px 0;border-bottom:1px solid;"><?php if ($row_select_pipe['sp_water_abr_1'] != "" && $row_select_pipe['sp_water_abr_1'] != "0" && $row_select_pipe['sp_water_abr_1'] != null) {
						...
						<tr>
							...
							<td style="border-left:1px solid;text-align:center;padding: 6px 0;"><?php if ($row_select_pipe['sp_wt_st_2'] != "" && $row_select_pipe['sp_wt_st_2'] != "0" && $row_select_pipe['sp_wt_st_2'] != null) {
																									echo $row_select_pipe['sp_wt_st_2'];
																								} else {
																									echo " <br>";
																								} ?></td>
							<td style="border-left:1px solid;text-align:center;padding: 6px 0;"><?php if ($row_select_pipe['sp_w_s_2'] != "" && $row_select_pipe['sp_w_s_2'] != "0" && $row_select_pipe['sp_w_s_2'] != null) {
																									echo $row_select_pipe['sp_w_s_2'];
																								} else {
																									echo " <br>";
																								} ?></td>
							<td style="border-left:1px solid;text-align:center;padding: 6px 0;"><?php if ($row_select_pipe['sp_w_sur_2'] != "" && $row_select_pipe['sp_w_sur_2'] != "0" && $row_select_pipe['sp_w_sur_2'] != null) {
																									echo $row_select_pipe['sp_w_sur_2'];
																								} else {
																									echo " <br>";
																								} ?></td>
							<td style="border-left:1px solid;text-align:center;padding: 6px 0;"><?php if ($row_select_pipe['sp_specific_gravity_2'] != "" && $row_select_pipe['sp_specific_gravity_2'] != "0" && $row_select_pipe['sp_specific_gravity_2'] != null) {
																									echo $row_select_pipe['sp_specific_gravity_2'];
																								} else {
																									echo " <br>";
																								} ?></td>
							<td style="border-left:1px solid;text-align:center;padding: 6px 0;"><?php if ($row_select_pipe['sp_water_abr_2'] != "" && $row_select_pipe['sp_water_abr_2'] != "0" && $row_select_pipe['sp_water_abr_2'] != null) {
			...
			<tr>
				<td style="text-align:center;font-size:16px;">
					...
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family : Calibri;" height="Auto">
						...
						<td style="border: 1px solid black;padding: 5px;"><center><?php if ($row_select_pipe['m11'] != "" && $row_select_pipe['m11'] != "0" && $row_select_pipe['m11'] != null) {
																						echo $row_select_pipe['m11'];
																					} else {
																						echo " <br>";
																					} ?></center></td>
						<td style="border: 1px solid black;padding: 5px;"><center><?php if ($row_select_pipe['m12'] != "" && $row_select_pipe['m12'] != "0" && $row_select_pipe['m12'] != null) {
																						echo $row_select_pipe['m12'];
																					} else {
																						echo " <br>";
																					} ?></center></td>
						<td style="border: 1px solid black;padding: 5px;"><center><?php if ($row_select_pipe['m13'] != "" && $row_select_pipe['m13'] != "0" && $row_select_pipe['m13'] != null) {
						...
						<td style="border: 1px solid black;padding: 5px;"><center><?php if ($row_select_pipe['m21'] != "" && $row_select_pipe['m21'] != "0" && $row_select_pipe['m21'] != null) {
																						echo $row_select_pipe['m21'];
																					} else {
																						echo " <br>";
																					} ?></center></td>
						<td style="border: 1px solid black;padding: 5px;"><center><?php if ($row_select_pipe['m22'] != "" && $row_select_pipe['m22'] != "0" && $row_select_pipe['m22'] != null) {
																						echo $row_select_pipe['m22'];
																					} else {
																						echo " <br>";
																					} ?></center></td>
						<td style="border: 1px solid black;padding: 5px;"><center><?php if ($row_select_pipe['m23'] != "" && $row_select_pipe['m23'] != "0" && $row_select_pipe['m23'] != null) {
						...
						<td style="border: 1px solid black;padding: 5px;"><center><?php if ($row_select_pipe['m31'] != "" && $row_select_pipe['m31'] != "0" && $row_select_pipe['m31'] != null) {
																						echo $row_select_pipe['m31'];
																					} else {
																						echo " <br>";
																					} ?></center></td>
						<td style="border: 1px solid black;padding: 5px;"><center><?php if ($row_select_pipe['m32'] != "" && $row_select_pipe['m32'] != "0" && $row_select_pipe['m32'] != null) {
																						echo $row_select_pipe['m32'];
																					} else {
																						echo " <br>";
																					} ?></center></td>
						<td style="border: 1px solid black;padding: 5px;"><center><?php if ($row_select_pipe['m33'] != "" && $row_select_pipe['m33'] != "0" && $row_select_pipe['m33'] != null) {
						...
						<tr>
						<td colspan="2" style="border: 1px solid black;text-align:right;padding: 5px;"><b>Average</b></td>
					
						<td colspan="3" style="border: 1px solid black;padding: 5px;"><center><?php if ($row_select_pipe['avg_wom'] != "" && $row_select_pipe['avg_wom'] != "0" && $row_select_pipe['avg_wom'] != null) {
					...
					<table align="center" width="100%" class="test1" style="border: 0;" height="Auto">
						<tr>
							...
							<td style="border: 0px solid black;text-align:left;width:20%;"><span style="border-bottom: 1px solid;"><?php if ($row_select_pipe['avg_wom'] != "" && $row_select_pipe['avg_wom'] != "0" && $row_select_pipe['avg_wom'] != null) {
																																		echo $row_select_pipe['avg_wom'];
																																	} else {
																																		echo "&nbsp;&nbsp;&nbsp;&nbsp;";
																																	} ?></span><b> Kg</b></td>
							...
							<td style="border: 0px solid black;text-align:left;width:20%;"><span style="border-bottom: 1px solid;"><?php if ($row_select_pipe['vol'] != "" && $row_select_pipe['vol'] != "0" && $row_select_pipe['vol'] != null) {
																																		echo $row_select_pipe['vol'];
																																	} else {
																																		echo "&nbsp;&nbsp;&nbsp;&nbsp;";
																																	} ?></span><b>m<sup>3</sup></b></td>
					...
					<table align="center" width="100%" class="test1" style="border: 0;" height="Auto">
						<tr>
							...
							<td  style="border: 0px solid black;text-align:center;width:15%;"><?php if ($row_select_pipe['bdl'] != "" && $row_select_pipe['bdl'] != "0" && $row_select_pipe['bdl'] != null) {
					...
					<br> -->
		<!--<table align="center" width="100%" class="test1" style="border: 0;font-family : Calibri;margin-top: 12px;" height="Auto">
						<tr>
		...
		<table align="center" width="94%" style="" Height="5%">
			<tr style="font-size:15px;" >
				<td style="text-align:center;"><b>Page <?php echo $pagecnt++; ?> of <?php echo $totalcnt; ?></b></td>
			</tr>		
		</table>	
		<br>
		<div class="pagebreak"></div>
	...
	if (($row_select_pipe['blank_extra'] != "" && $row_select_pipe['blank_extra'] != "0" && $row_select_pipe['blank_extra'] != null) || ($row_select_pipe['cru_value'] != "" && $row_select_pipe['cru_value'] != "0" && $row_select_pipe['cru_value'] != null) || ($row_select_pipe['imp_value'] != "" && $row_select_pipe['imp_value'] != "0" && $row_select_pipe['imp_value'] != null) || ($row_select_pipe['abr_index'] != "" && $row_select_pipe['abr_index'] != "0" && $row_select_pipe['abr_index'] != null)) { ?>
			...
			<tr>
				<td>
					...
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family : Calibri;" height="Auto">
							...
							<?php if ($row_select_pipe['pass_sample_1'] != "" && $row_select_pipe['pass_sample_1'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_1'] != "") {
																														echo $row_select_pipe['sieve_1'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_1'] != "" && $row_select_pipe['cum_wt_gm_1'] != "0" && $row_select_pipe['cum_wt_gm_1'] != null) {
																														echo $row_select_pipe['cum_wt_gm_1'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_1'] != "" && $row_select_pipe['ret_wt_gm_1'] != "0" && $row_select_pipe['ret_wt_gm_1'] != null) {
																														echo $row_select_pipe['ret_wt_gm_1'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_1'] != "" && $row_select_pipe['cum_ret_1'] != "0" && $row_select_pipe['cum_ret_1'] != null) {
																														echo $row_select_pipe['cum_ret_1'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_1'] != "" && $row_select_pipe['pass_sample_1'] != "0" && $row_select_pipe['pass_sample_1'] != null) {
							...
							<?php }
								if ($row_select_pipe['pass_sample_2'] != "" && $row_select_pipe['pass_sample_2'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_2'] != ""  && $row_select_pipe['sieve_2'] != "0"  && $row_select_pipe['sieve_2'] != null) {
																														echo $row_select_pipe['sieve_2'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_2'] != "" && $row_select_pipe['cum_wt_gm_2'] != "0" && $row_select_pipe['cum_wt_gm_2'] != null) {
																														echo $row_select_pipe['cum_wt_gm_2'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_2'] != "" && $row_select_pipe['ret_wt_gm_2'] != "0" && $row_select_pipe['ret_wt_gm_2'] != null) {
																														echo $row_select_pipe['ret_wt_gm_2'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_2'] != "" && $row_select_pipe['cum_ret_2'] != "0" && $row_select_pipe['cum_ret_2'] != null) {
																														echo $row_select_pipe['cum_ret_2'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_2'] != "" && $row_select_pipe['pass_sample_2'] != "0" && $row_select_pipe['pass_sample_2'] != null) {
							...
							<?php }
								if ($row_select_pipe['pass_sample_3'] != "" && $row_select_pipe['pass_sample_3'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_3'] != "" && $row_select_pipe['sieve_3'] != "0" && $row_select_pipe['sieve_3'] != null) {
																														echo $row_select_pipe['sieve_3'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_3'] != "" && $row_select_pipe['cum_wt_gm_3'] != "0" && $row_select_pipe['cum_wt_gm_3'] != null) {
																														echo $row_select_pipe['cum_wt_gm_3'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_3'] != "" && $row_select_pipe['ret_wt_gm_3'] != "0" && $row_select_pipe['ret_wt_gm_3'] != null) {
																														echo $row_select_pipe['ret_wt_gm_3'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_3'] != "" && $row_select_pipe['cum_ret_3'] != "0" && $row_select_pipe['cum_ret_3'] != null) {
																														echo $row_select_pipe['cum_ret_3'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_3'] != "" && $row_select_pipe['pass_sample_3'] != "0" && $row_select_pipe['pass_sample_3'] != null) {
							...
							<?php }
								if ($row_select_pipe['pass_sample_4'] != "" && $row_select_pipe['pass_sample_4'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_4'] != "" && $row_select_pipe['sieve_4'] != "0" && $row_select_pipe['sieve_4'] != null) {
																														echo $row_select_pipe['sieve_4'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_4'] != "" && $row_select_pipe['cum_wt_gm_4'] != "0" && $row_select_pipe['cum_wt_gm_4'] != null) {
																														echo $row_select_pipe['cum_wt_gm_4'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_4'] != "" && $row_select_pipe['ret_wt_gm_4'] != "0" && $row_select_pipe['ret_wt_gm_4'] != null) {
																														echo $row_select_pipe['ret_wt_gm_4'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_4'] != "" && $row_select_pipe['cum_ret_4'] != "0" && $row_select_pipe['cum_ret_4'] != null) {
																														echo $row_select_pipe['cum_ret_4'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_4'] != "" && $row_select_pipe['pass_sample_4'] != "0" && $row_select_pipe['pass_sample_4'] != null) {
							...
							<?php }
								if ($row_select_pipe['pass_sample_5'] != "" && $row_select_pipe['pass_sample_5'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_5'] != "" && $row_select_pipe['sieve_5'] != "0" && $row_select_pipe['sieve_5'] != null) {
																														echo $row_select_pipe['sieve_5'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_5'] != "" && $row_select_pipe['cum_wt_gm_5'] != "0" && $row_select_pipe['cum_wt_gm_5'] != null) {
																														echo $row_select_pipe['cum_wt_gm_5'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_5'] != "" && $row_select_pipe['ret_wt_gm_5'] != "0" && $row_select_pipe['ret_wt_gm_5'] != null) {
																														echo $row_select_pipe['ret_wt_gm_5'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_5'] != "" && $row_select_pipe['cum_ret_5'] != "0" && $row_select_pipe['cum_ret_5'] != null) {
																														echo $row_select_pipe['cum_ret_5'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_5'] != "" && $row_select_pipe['pass_sample_5'] != "0" && $row_select_pipe['pass_sample_5'] != null) {
							...
							<?php }
								if ($row_select_pipe['pass_sample_6'] != "" && $row_select_pipe['pass_sample_6'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_6'] != "" && $row_select_pipe['sieve_6'] != "0" && $row_select_pipe['sieve_6'] != null) {
																														echo $row_select_pipe['sieve_6'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_6'] != "" && $row_select_pipe['cum_wt_gm_6'] != "0" && $row_select_pipe['cum_wt_gm_6'] != null) {
																														echo $row_select_pipe['cum_wt_gm_6'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_6'] != "" && $row_select_pipe['ret_wt_gm_6'] != "0" && $row_select_pipe['ret_wt_gm_6'] != null) {
																														echo $row_select_pipe['ret_wt_gm_6'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_6'] != "" && $row_select_pipe['cum_ret_6'] != "0" && $row_select_pipe['cum_ret_6'] != null) {
																														echo $row_select_pipe['cum_ret_6'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_6'] != "" && $row_select_pipe['pass_sample_6'] != "0" && $row_select_pipe['pass_sample_6'] != null) {
							...
							<?php }
								if ($row_select_pipe['pass_sample_7'] != "" && $row_select_pipe['pass_sample_7'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_7'] != "" && $row_select_pipe['sieve_7'] != "0" && $row_select_pipe['sieve_7'] != null) {
																														echo $row_select_pipe['sieve_7'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_7'] != "" && $row_select_pipe['cum_wt_gm_7'] != "0" && $row_select_pipe['cum_wt_gm_7'] != null) {
																														echo $row_select_pipe['cum_wt_gm_7'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_7'] != "" && $row_select_pipe['ret_wt_gm_7'] != "0" && $row_select_pipe['ret_wt_gm_7'] != null) {
																														echo $row_select_pipe['ret_wt_gm_7'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_7'] != "" && $row_select_pipe['cum_ret_7'] != "0" && $row_select_pipe['cum_ret_7'] != null) {
																														echo $row_select_pipe['cum_ret_7'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_7'] != "" && $row_select_pipe['pass_sample_7'] != "0" && $row_select_pipe['pass_sample_7'] != null) {
							...
							<?php }
								if ($row_select_pipe['pass_sample_8'] != "" && $row_select_pipe['pass_sample_8'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_8'] != "" && $row_select_pipe['sieve_8'] != "0" && $row_select_pipe['sieve_8'] != null) {
																														echo $row_select_pipe['sieve_8'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_8'] != "" && $row_select_pipe['cum_wt_gm_8'] != "0" && $row_select_pipe['cum_wt_gm_8'] != null) {
																														echo $row_select_pipe['cum_wt_gm_8'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_8'] != "" && $row_select_pipe['ret_wt_gm_8'] != "0" && $row_select_pipe['ret_wt_gm_8'] != null) {
																														echo $row_select_pipe['ret_wt_gm_8'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_8'] != "" && $row_select_pipe['cum_ret_8'] != "0" && $row_select_pipe['cum_ret_8'] != null) {
																														echo $row_select_pipe['cum_ret_8'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_8'] != "" && $row_select_pipe['pass_sample_8'] != "0" && $row_select_pipe['pass_sample_8'] != null) {
							...
							<?php }
								if ($row_select_pipe['pass_sample_9'] != "" && $row_select_pipe['pass_sample_9'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_9'] != "" && $row_select_pipe['sieve_9'] != "0" && $row_select_pipe['sieve_9'] != null) {
																														echo $row_select_pipe['sieve_9'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_9'] != "" && $row_select_pipe['cum_wt_gm_9'] != "0" && $row_select_pipe['cum_wt_gm_9'] != null) {
																														echo $row_select_pipe['cum_wt_gm_9'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_9'] != "" && $row_select_pipe['ret_wt_gm_9'] != "0" && $row_select_pipe['ret_wt_gm_9'] != null) {
																														echo $row_select_pipe['ret_wt_gm_9'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_9'] != "" && $row_select_pipe['cum_ret_9'] != "0" && $row_select_pipe['cum_ret_9'] != null) {
																														echo $row_select_pipe['cum_ret_9'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_9'] != "" && $row_select_pipe['pass_sample_9'] != "0" && $row_select_pipe['pass_sample_9'] != null) {
							...
							<?php }
								if ($row_select_pipe['pass_sample_10'] != "" && $row_select_pipe['pass_sample_10'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_10'] != "" && $row_select_pipe['sieve_10'] != "0" && $row_select_pipe['sieve_10'] != null) {
																														echo $row_select_pipe['sieve_10'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_10'] != "" && $row_select_pipe['cum_wt_gm_10'] != "0" && $row_select_pipe['cum_wt_gm_10'] != null) {
																														echo $row_select_pipe['cum_wt_gm_10'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_10'] != "" && $row_select_pipe['ret_wt_gm_10'] != "0" && $row_select_pipe['ret_wt_gm_10'] != null) {
																														echo $row_select_pipe['ret_wt_gm_10'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_10'] != "" && $row_select_pipe['cum_ret_10'] != "0" && $row_select_pipe['cum_ret_10'] != null) {
																														echo $row_select_pipe['cum_ret_10'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_10'] != "" && $row_select_pipe['pass_sample_10'] != "0" && $row_select_pipe['pass_sample_10'] != null) {
							...
							<?php }
								if ($row_select_pipe['pass_sample_11'] != "" && $row_select_pipe['pass_sample_11'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_11'] != "" && $row_select_pipe['sieve_11'] != "0" && $row_select_pipe['sieve_11'] != null) {
																														echo $row_select_pipe['sieve_11'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_11'] != "" && $row_select_pipe['cum_wt_gm_11'] != "0" && $row_select_pipe['cum_wt_gm_11'] != null) {
																														echo $row_select_pipe['cum_wt_gm_11'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_11'] != "" && $row_select_pipe['ret_wt_gm_11'] != "0" && $row_select_pipe['ret_wt_gm_11'] != null) {
																														echo $row_select_pipe['ret_wt_gm_11'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_11'] != "" && $row_select_pipe['cum_ret_11'] != "0" && $row_select_pipe['cum_ret_11'] != null) {
																														echo $row_select_pipe['cum_ret_11'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_11'] != "" && $row_select_pipe['pass_sample_11'] != "0" && $row_select_pipe['pass_sample_11'] != null) {
							...
							<?php }
								if ($row_select_pipe['pass_sample_12'] != "" && $row_select_pipe['pass_sample_12'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_12'] != "" && $row_select_pipe['sieve_12'] != "0" && $row_select_pipe['sieve_12'] != null) {
																														echo $row_select_pipe['sieve_12'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_12'] != "" && $row_select_pipe['cum_wt_gm_12'] != "0" && $row_select_pipe['cum_wt_gm_12'] != null) {
																														echo $row_select_pipe['cum_wt_gm_12'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_12'] != "" && $row_select_pipe['ret_wt_gm_12'] != "0" && $row_select_pipe['ret_wt_gm_12'] != null) {
																														echo $row_select_pipe['ret_wt_gm_12'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_12'] != "" && $row_select_pipe['cum_ret_12'] != "0" && $row_select_pipe['cum_ret_12'] != null) {
																														echo $row_select_pipe['cum_ret_12'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_12'] != "" && $row_select_pipe['pass_sample_12'] != "0" && $row_select_pipe['pass_sample_12'] != null) {
							...
							<?php }
								if ($row_select_pipe['pass_sample_13'] != "" && $row_select_pipe['pass_sample_13'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_13'] != "" && $row_select_pipe['sieve_13'] != "0" && $row_select_pipe['sieve_13'] != null) {
																														echo $row_select_pipe['sieve_13'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_13'] != "" && $row_select_pipe['cum_wt_gm_13'] != "0" && $row_select_pipe['cum_wt_gm_13'] != null) {
																														echo $row_select_pipe['cum_wt_gm_13'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_13'] != "" && $row_select_pipe['ret_wt_gm_13'] != "0" && $row_select_pipe['ret_wt_gm_13'] != null) {
																														echo $row_select_pipe['ret_wt_gm_13'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_13'] != "" && $row_select_pipe['cum_ret_13'] != "0" && $row_select_pipe['cum_ret_13'] != null) {
																														echo $row_select_pipe['cum_ret_13'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_13'] != "" && $row_select_pipe['pass_sample_13'] != "0" && $row_select_pipe['pass_sample_13'] != null) {
																														echo $row_select_pipe['pass_sample_13'];
																													} else {
																														echo " <br>";
																													} ?></td>						
							</tr>
							<?php }
								if ($row_select_pipe['pass_sample_14'] != "" && $row_select_pipe['pass_sample_14'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_14'] != "" && $row_select_pipe['sieve_14'] != "0" && $row_select_pipe['sieve_14'] != null) {
																														echo $row_select_pipe['sieve_14'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_14'] != "" && $row_select_pipe['cum_wt_gm_14'] != "0" && $row_select_pipe['cum_wt_gm_14'] != null) {
																														echo $row_select_pipe['cum_wt_gm_14'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_14'] != "" && $row_select_pipe['ret_wt_gm_14'] != "0" && $row_select_pipe['ret_wt_gm_14'] != null) {
																														echo $row_select_pipe['ret_wt_gm_14'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_14'] != "" && $row_select_pipe['cum_ret_14'] != "0" && $row_select_pipe['cum_ret_14'] != null) {
																														echo $row_select_pipe['cum_ret_14'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_14'] != "" && $row_select_pipe['pass_sample_14'] != "0" && $row_select_pipe['pass_sample_14'] != null) {
																														echo $row_select_pipe['pass_sample_14'];
																													} else {
																														echo " <br>";
																													} ?></td>				
							</tr>
							<?php }
								if ($row_select_pipe['pass_sample_15'] != "" && $row_select_pipe['pass_sample_15'] != null) { ?>
							<tr>
								<td style="border: 1px solid black;width:10%;padding:  2px 4px;text-align:center;" ><?php if ($row_select_pipe['sieve_15'] != "" && $row_select_pipe['sieve_15'] != "0" && $row_select_pipe['sieve_15'] != null) {
																														echo $row_select_pipe['sieve_15'] . ' mm';
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_wt_gm_15'] != "" && $row_select_pipe['cum_wt_gm_15'] != "0" && $row_select_pipe['cum_wt_gm_15'] != null) {
																														echo $row_select_pipe['cum_wt_gm_15'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['ret_wt_gm_15'] != "" && $row_select_pipe['ret_wt_gm_15'] != "0" && $row_select_pipe['ret_wt_gm_15'] != null) {
																														echo $row_select_pipe['ret_wt_gm_15'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['cum_ret_15'] != "" && $row_select_pipe['cum_ret_15'] != "0" && $row_select_pipe['cum_ret_15'] != null) {
																														echo $row_select_pipe['cum_ret_15'];
																													} else {
																														echo " <br>";
																													} ?></td>
								<td style="border: 1px solid black;width:15%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['pass_sample_15'] != "" && $row_select_pipe['pass_sample_15'] != "0" && $row_select_pipe['pass_sample_15'] != null) {
																														echo $row_select_pipe['pass_sample_15'];
																													} else {
																														echo " <br>";
																													} ?></td>						
							</tr>
							...
							<tr>
								...
								<td style="border: 1px solid black;width:50%;padding: 2px 4px;text-align:center;"><?php if ($row_select_pipe['blank_extra'] != "" && $row_select_pipe['blank_extra'] != "0" && $row_select_pipe['blank_extra'] != null) {
		...
		<!-- Crushing Value -->
		<!-- <table align="center" width="94%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top: 10px;">
			<tr>
				<td style="text-align:center;font-size:16px;">
					<table align="left" width="100%" cellspacing="0" cellpadding="0" style="font-size:12px;font-family : Calibri;border: 0;">
						<tr>
					...
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family : Calibri;" height="Auto">
						...
						<tr>
							...
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['cr_a_2'] != "" && $row_select_pipe['cr_a_2'] != "0" && $row_select_pipe['cr_a_2'] != null) {
						...
						<tr>
							...
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['cr_b_2'] != "" && $row_select_pipe['cr_b_2'] != "0" && $row_select_pipe['cr_b_2'] != null) {
						...
						<tr>
							...
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['cru_value_2'] != "" && $row_select_pipe['cru_value_2'] != "0" && $row_select_pipe['cru_value_2'] != null) {
						...
						<tr>
						    ...
						    <td colspan="2" style="border: 1px solid black;"><center><?php if ($row_select_pipe['cru_value'] != "" && $row_select_pipe['cru_value'] != "0" && $row_select_pipe['cru_value'] != null) {
				...
				<td style="text-align:center;font-size:16px;">
					...
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family : Calibri;" height="Auto">
						...
						<tr>
							...
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['imp_w_m_a_2'] != "" && $row_select_pipe['imp_w_m_a_2'] != "0" && $row_select_pipe['imp_w_m_a_2'] != null) {
						...
						<tr>
							...
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['imp_w_m_c_2'] != "" && $row_select_pipe['imp_w_m_c_2'] != "0" && $row_select_pipe['imp_w_m_c_2'] != null) {
						...
						<tr>
							...
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['imp_w_m_b_2'] != "" && $row_select_pipe['imp_w_m_b_2'] != "0" && $row_select_pipe['imp_w_m_b_2'] != null) {
						...
						<tr>
							...
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['imp_value_2'] != "" && $row_select_pipe['imp_value_2'] != "0" && $row_select_pipe['imp_value_2'] != null) {
						...
						<tr>
						    ...
						    <td colspan="2" style="border: 1px solid black;"><center><?php if ($row_select_pipe['imp_value'] != "" && $row_select_pipe['imp_value'] != "0" && $row_select_pipe['imp_value'] != null) {
				...
				<td style="text-align:center;font-size:16px;">
					...
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family : Calibri;" height="Auto">
						<tr>
							...
							<td style="border: 1px solid black;width:15%;"><center><?php if ($row_select_pipe['abr_wt_t_a_1'] != "" && $row_select_pipe['abr_wt_t_a_1'] != "0" && $row_select_pipe['abr_wt_t_a_1'] != null) {
																						echo $row_select_pipe['abr_wt_t_a_1'];
																					} else {
																						echo " <br>";
																					} ?></center></td>
							<td style="border: 1px solid black;width:15%;"><center><?php if ($row_select_pipe['abr_wt_t_a_2'] != "" && $row_select_pipe['abr_wt_t_a_2'] != "0" && $row_select_pipe['abr_wt_t_a_2'] != null) {
						...
						<tr>
							...
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['abr_wt_t_b_1'] != "" && $row_select_pipe['abr_wt_t_b_1'] != "0" && $row_select_pipe['abr_wt_t_b_1'] != null) {
																				echo $row_select_pipe['abr_wt_t_b_1'];
																			} else {
																				echo " <br>";
																			} ?></center></td>
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['abr_wt_t_b_2'] != "" && $row_select_pipe['abr_wt_t_b_2'] != "0" && $row_select_pipe['abr_wt_t_b_2'] != null) {
						...
						<tr>
						    ...
						    <td style="border: 1px solid black;"><center><?php if ($row_select_pipe['abr_wt_t_c_1'] != "" && $row_select_pipe['abr_wt_t_c_1'] != "0" && $row_select_pipe['abr_wt_t_c_1'] != null) {
																				echo $row_select_pipe['abr_wt_t_c_1'];
																			} else {
																				echo " <br>";
																			} ?></center></td>
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['abr_wt_t_c_2'] != "" && $row_select_pipe['abr_wt_t_c_2'] != "0" && $row_select_pipe['abr_wt_t_c_2'] != null) {
						...
						<tr>
							...
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['abr_2'] != "" && $row_select_pipe['abr_2'] != "0" && $row_select_pipe['abr_2'] != null) {
						...
						<tr>
						    ...
						    <td colspan="2" style="border: 1px solid black;height:15px;"><center><?php if ($row_select_pipe['abr_index'] != "" && $row_select_pipe['abr_index'] != "0" && $row_select_pipe['abr_index'] != null) {
		...
		<!-- <table align="center" width="94%"  cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;">
				<tr>
					<td style="text-align:center;font-size:16px;">
						<table align="left" width="100%" height="70px;"  cellspacing="0" cellpadding="0" style="font-size:12px;font-family : Calibri;border: 0;">
							<tr>
						...
						<br>
						<table align="center" width="100%" height="450px;"  class="test1" style="border: 1px solid black;font-family : Calibri;" height="Auto">
							<tr>
							...
							<tr>
								...
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['b1'] != ""  && $row_select_pipe['b1'] != "0" && $row_select_pipe['b1'] != null) {
																							echo $row_select_pipe['b1'];
																						} else {
																							echo " <br>";
																						} ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['aa1'] != ""  && $row_select_pipe['aa1'] != "0" && $row_select_pipe['aa1'] != null) {
																							echo $row_select_pipe['aa1'];
																						} else {
																							echo " <br>";
																						}  ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['dd1'] != ""  && $row_select_pipe['dd1'] != "0" && $row_select_pipe['dd1'] != null) {
							...
							<tr>
								...
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['b2'] != ""  && $row_select_pipe['b2'] != "0" && $row_select_pipe['b2'] != null) {
																							echo $row_select_pipe['b2'];
																						} else {
																							echo " <br>";
																						} ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['aa2'] != ""  && $row_select_pipe['aa2'] != "0" && $row_select_pipe['aa2'] != null) {
																							echo $row_select_pipe['aa2'];
																						} else {
																							echo " <br>";
																						}  ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['dd2'] != ""  && $row_select_pipe['dd2'] != "0" && $row_select_pipe['dd2'] != null) {
							...
							<tr>
								...
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['b3'] != ""  && $row_select_pipe['b3'] != "0" && $row_select_pipe['b3'] != null) {
																							echo $row_select_pipe['b3'];
																						} else {
																							echo " <br>";
																						} ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['aa3'] != ""  && $row_select_pipe['aa3'] != "0" && $row_select_pipe['aa3'] != null) {
																							echo $row_select_pipe['aa3'];
																						} else {
																							echo " <br>";
																						}  ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['dd3'] != ""  && $row_select_pipe['dd3'] != "0" && $row_select_pipe['dd3'] != null) {
							...
							<tr>
								...
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['b4'] != ""  && $row_select_pipe['b4'] != "0" && $row_select_pipe['b4'] != null) {
																							echo $row_select_pipe['b4'];
																						} else {
																							echo " <br>";
																						} ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['aa4'] != ""  && $row_select_pipe['aa4'] != "0" && $row_select_pipe['aa4'] != null) {
																							echo $row_select_pipe['aa4'];
																						} else {
																							echo " <br>";
																						}  ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['dd4'] != ""  && $row_select_pipe['dd4'] != "0" && $row_select_pipe['dd4'] != null) {
							...
							<tr>
								...
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['b5'] != ""  && $row_select_pipe['b5'] != "0" && $row_select_pipe['b5'] != null) {
																							echo $row_select_pipe['b5'];
																						} else {
																							echo " <br>";
																						} ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['aa5'] != ""  && $row_select_pipe['aa5'] != "0" && $row_select_pipe['aa5'] != null) {
																							echo $row_select_pipe['aa5'];
																						} else {
																							echo " <br>";
																						}  ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['dd5'] != ""  && $row_select_pipe['dd5'] != "0" && $row_select_pipe['dd5'] != null) {
							...
							<tr>
								...
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['b6'] != ""  && $row_select_pipe['b6'] != "0" && $row_select_pipe['b6'] != null) {
																							echo $row_select_pipe['b6'];
																						} else {
																							echo " <br>";
																						} ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['aa6'] != ""  && $row_select_pipe['aa6'] != "0" && $row_select_pipe['aa6'] != null) {
																							echo $row_select_pipe['aa6'];
																						} else {
																							echo " <br>";
																						}  ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['dd6'] != ""  && $row_select_pipe['dd6'] != "0" && $row_select_pipe['dd6'] != null) {
							...
							<tr>
								...
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['b7'] != ""  && $row_select_pipe['b7'] != "0" && $row_select_pipe['b7'] != null) {
																							echo $row_select_pipe['b7'];
																						} else {
																							echo " <br>";
																						} ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['aa7'] != ""  && $row_select_pipe['aa7'] != "0" && $row_select_pipe['aa7'] != null) {
																							echo $row_select_pipe['aa7'];
																						} else {
																							echo " <br>";
																						}  ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['dd7'] != ""  && $row_select_pipe['dd7'] != "0" && $row_select_pipe['dd7'] != null) {
							...
							<tr>
								...
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['b8'] != ""  && $row_select_pipe['b8'] != "0" && $row_select_pipe['b8'] != null) {
																							echo $row_select_pipe['b8'];
																						} else {
																							echo " <br>";
																						} ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['aa8'] != ""  && $row_select_pipe['aa8'] != "0" && $row_select_pipe['aa8'] != null) {
																							echo $row_select_pipe['aa8'];
																						} else {
																							echo " <br>";
																						}  ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['dd8'] != ""  && $row_select_pipe['dd8'] != "0" && $row_select_pipe['dd8'] != null) {
							...
							<tr>
								...
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['b9'] != ""  && $row_select_pipe['b9'] != "0" && $row_select_pipe['b9'] != null) {
																							echo $row_select_pipe['b9'];
																						} else {
																							echo " <br>";
																						} ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['aa9'] != ""  && $row_select_pipe['aa9'] != "0" && $row_select_pipe['aa9'] != null) {
																							echo $row_select_pipe['aa9'];
																						} else {
																							echo " <br>";
																						}  ?></td>
								<td style="border: 1px solid black;text-align: center;"><?php if ($row_select_pipe['dd9'] != ""  && $row_select_pipe['dd9'] != "0" && $row_select_pipe['dd9'] != null) {
							...
							<tr>
								...
								<td style="border: 1px solid black;padding: 5px;text-align: left;">&nbsp;&nbsp; W1 = <?php if ($row_select_pipe['suma'] != ""  && $row_select_pipe['suma'] != "0" && $row_select_pipe['suma'] != null) {
																															echo $row_select_pipe['suma'];
																														} else {
																															echo " <br>";
																														} ?></td>
								<td style="border: 1px solid black;padding: 5px;text-align: left;">&nbsp;&nbsp; W2 = <?php if ($row_select_pipe['sumb'] != ""  && $row_select_pipe['sumb'] != "0" && $row_select_pipe['sumb'] != null) {
																															echo $row_select_pipe['sumb'];
																														} else {
																															echo " <br>";
																														} ?></td>
								<td style="border: 1px solid black;padding: 5px;text-align: left;">&nbsp;&nbsp; W3 = <?php if ($row_select_pipe['sumaa'] != ""  && $row_select_pipe['sumaa'] != "0" && $row_select_pipe['sumaa'] != null) {
																															echo $row_select_pipe['sumaa'];
																														} else {
																															echo " <br>";
																														}  ?></td>
								<td style="border: 1px solid black;padding: 5px;text-align: left;">&nbsp;&nbsp; W4 = <?php if ($row_select_pipe['sumdd'] != ""  && $row_select_pipe['sumdd'] != "0" && $row_select_pipe['sumdd'] != null) {
						...
						<table align="center" width="100%" height="150px;" class="test1" style="border: 1px solid; border-top: 0;">
							<tr style="border: 0px solid black;">
								...
								<td style="width: 10%;border-left: 1px solid;border-bottom: 1px solid;text-align: center;padding: 3px;" ><span style="border-bottom: 1px solid;"><?php if ($row_select_pipe['fi_index'] != ""  && $row_select_pipe['fi_index'] != "0" && $row_select_pipe['fi_index'] != null) {
							...
							<tr style="border: 0px solid black;">
								...
								<td style="width: 5%;text-align: center;border-left: 1px solid;border-bottom: 1px solid;padding: 3px;" >100</td>
								<td style="width: 6%;border-left: 1px solid;border-bottom: 1px solid;text-align: center;padding: 3px;" >&nbsp;&nbsp;=</td>
								<td style="width: 10%;border-left: 1px solid;border-bottom: 1px solid;text-align: center;padding: 3px;" ><span style="border-bottom: 1px solid;"><?php if ($row_select_pipe['ei_index'] != ""  && $row_select_pipe['ei_index'] != "0" && $row_select_pipe['ei_index'] != null) {
							...
							<tr style="border: 0px solid black;">
								...
								<td colspan="5"  style="border-left: 1px solid;text-align: center;padding: 3px;">&nbsp;&nbsp; = &nbsp;&nbsp; <?php if ($row_select_pipe['combined_index'] != ""  && $row_select_pipe['combined_index'] != "0" && $row_select_pipe['combined_index'] != null) {
			...
			<br>
			<br><br><br>
			<table align="center" width="94%" class="test1" height="Auto" style="border-top:2px solid #ccc;vertical-align: text-bottom;">
				<tr style="padding-top:4px;">
					<td style="width:25%;"><center>Amendment No.: 01</center></td>
					<td style="width:25%;"><center>Amendment Date: 01.04.2023</center></td>
					<td style="width:16.67%;"><center>Prepared by:</center></td>
		...
		<!-- <table align="center" width="94%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;">
					...
					<td style="text-align:center;font-size:16px;">
						...
						<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family : Calibri;" height="Auto">
							...
							<tr>
								...
								<td style="border: 1px solid black;padding: 2px 3px;text-align: center;"><?php if ($row_select_pipe['s71'] != "" && $row_select_pipe['s71'] != "0" && $row_select_pipe['s71'] != null) {
																												echo $row_select_pipe['s71'];
																											} else {
																												echo " <br>";
																											} ?></td>
								<td style="border: 1px solid black;">
							...
							<tr>
								...
								<td style="border: 1px solid black;padding: 5px;text-align: center;"><?php if ($row_select_pipe['s74'] != "" && $row_select_pipe['s74'] != "0" && $row_select_pipe['s74'] != null) {
																											echo $row_select_pipe['s74'];
																										} else {
																											echo " <br>";
																										} ?></td>
								<td style="border: 1px solid black;">
							...
							<tr>
								...
								<td style="border: 1px solid black;padding: 5px;text-align: center;"><?php if ($row_select_pipe['s77'] != "" && $row_select_pipe['s77'] != "0" && $row_select_pipe['s77'] != null) {
																											echo $row_select_pipe['s77'];
																										} else {
																											echo " <br>";
																										} ?></td>
								<td style="border: 1px solid black;">
							...
							<tr>
								...
								<td style="border: 1px solid black;padding: 5px;text-align: center;"><?php if ($row_select_pipe['s70'] != "" && $row_select_pipe['s70'] != "0" && $row_select_pipe['s70'] != null) {
																											echo $row_select_pipe['s70'];
																										} else {
																											echo " <br>";
																										} ?></td>
								<td style="border: 1px solid black;">
			...
			<table align="center" width="90%" Height="90px;" class="test1" style="border: 1px solid black;">
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_1'] != "" && $row_select_pipe['dele_1_1'] != "0" && $row_select_pipe['dele_1_1'] != null) {
				...
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_2'] != "" && $row_select_pipe['dele_1_2'] != "0" && $row_select_pipe['dele_1_2'] != null) {
				...
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_3'] != "" && $row_select_pipe['dele_1_3'] != "0" && $row_select_pipe['dele_1_3'] != null) {
				...
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_4'] != "" && $row_select_pipe['dele_1_4'] != "0" && $row_select_pipe['dele_1_4'] != null) {
			...
			<table align="center" width="90%" Height="90px;" class="test1" style="border: 1px solid black;">
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_1'] != "" && $row_select_pipe['dele_2_1'] != "0" && $row_select_pipe['dele_2_1'] != null) {
				...
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_2_2'] != "" && $row_select_pipe['dele_2_2'] != "0" && $row_select_pipe['dele_2_2'] != null) {
				...
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_2_3'] != "" && $row_select_pipe['dele_2_3'] != "0" && $row_select_pipe['dele_2_3'] != null) {
			...
			<table align="center" width="90%" Height="90px;" class="test1" style="border: 1px solid black;">
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_1'] != "" && $row_select_pipe['dele_3_1'] != "0" && $row_select_pipe['dele_3_1'] != null) {
				...
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_3_2'] != "" && $row_select_pipe['dele_3_2'] != "0" && $row_select_pipe['dele_3_2'] != null) {
				...
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_3_3'] != "") {
			...
			<table align="center" width="90%" Height="90px;" class="test1" style="border: 1px solid black;">
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_1'] != "" && $row_select_pipe['dele_4_1'] != "0" && $row_select_pipe['dele_4_1'] != null) {
				...
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_4_2'] != "" && $row_select_pipe['dele_4_2'] != "0" && $row_select_pipe['dele_4_2'] != null) {
				...
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_4_3'] != "" && $row_select_pipe['dele_4_3'] != "0" && $row_select_pipe['dele_4_3'] != null) {
		...
		<?php } ?>
		<p style="margin-left:30px;font-weight:bold;"><b><?php echo $count++; ?>. ORGANIC IMPURITIES (IS 2686 - 2) - 1963</b></p>
			<table align="center" width="90%" Height="100px;" class="test1" style="border: 1px solid black;">
				<tr>
					<td width="60%" style="border: 1px solid black;">&nbsp; <b>Fill Solutions upto Mark</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['aoi_1'] != "" && $row_select_pipe['aoi_1'] != "0" && $row_select_pipe['aoi_1'] != null) {
				...
				<tr>
					<td style="border: 1px solid black;">&nbsp; Fill Sand upto mark</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['aoi_2'] != "" && $row_select_pipe['aoi_2'] != "0" && $row_select_pipe['aoi_2'] != null) {
				...
				<tr>
					<td style="border: 1px solid black;">&nbsp; Further fill solution upto mark</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['aoi_3'] != "" && $row_select_pipe['aoi_3'] != "0" && $row_select_pipe['aoi_3'] != null) {
				...
				<tr>
					<td style="border: 1px solid black;">&nbsp; Observation</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['aoi_4'] != "" && $row_select_pipe['aoi_4'] != "0" && $row_select_pipe['aoi_4'] != null) {
		...
		<table align="center" width="90%" Height="23%" class="test1" style="border: 1px solid black;" height="Auto" cellpadding="3px">
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s1_1'] != "" && $row_select_pipe['clr_s1_1'] != "0" && $row_select_pipe['clr_s1_1'] != null) {
																			echo $row_select_pipe['clr_s1_1'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s2_1'] != "" && $row_select_pipe['clr_s2_1'] != "0" && $row_select_pipe['clr_s2_1'] != null) {
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s1_2'] != "" && $row_select_pipe['clr_s1_2'] != "0" && $row_select_pipe['clr_s1_2'] != null) {
																			echo $row_select_pipe['clr_s1_2'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s2_2'] != "" && $row_select_pipe['clr_s2_2'] != "0" && $row_select_pipe['clr_s2_2'] != null) {
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s1_3'] != "" && $row_select_pipe['clr_s1_3'] != "0" && $row_select_pipe['clr_s1_3'] != null) {
																			echo $row_select_pipe['clr_s1_3'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s2_3'] != "" && $row_select_pipe['clr_s2_3'] != "0" && $row_select_pipe['clr_s2_3'] != null) {
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s1_4'] != "" && $row_select_pipe['clr_s1_4'] != "0" && $row_select_pipe['clr_s1_4'] != null) {
																			echo $row_select_pipe['clr_s1_4'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s2_4'] != "" && $row_select_pipe['clr_s2_4'] != "0" && $row_select_pipe['clr_s2_4'] != null) {
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s1_5'] != "" && $row_select_pipe['clr_s1_5'] != "0" && $row_select_pipe['clr_s1_5'] != null) {
																			echo $row_select_pipe['clr_s1_5'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s2_5'] != "" && $row_select_pipe['clr_s2_5'] != "0" && $row_select_pipe['clr_s2_5'] != null) {
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s1_6'] != "" && $row_select_pipe['clr_s1_6'] != "0" && $row_select_pipe['clr_s1_6'] != null) {
																			echo $row_select_pipe['clr_s1_6'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s2_6'] != "" && $row_select_pipe['clr_s2_6'] != "0" && $row_select_pipe['clr_s2_6'] != null) {
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s1_7'] != "" && $row_select_pipe['clr_s1_7'] != "0" && $row_select_pipe['clr_s1_7'] != null) {
																			echo $row_select_pipe['clr_s1_7'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['clr_s2_7'] != "" && $row_select_pipe['clr_s2_7'] != "0" && $row_select_pipe['clr_s2_7'] != null) {
			...
			<tr>
				...
				<td colspan="2" style="border: 1px solid black;text-align:center;"><b><?php if ($row_select_pipe['avg_clr'] != "" && $row_select_pipe['avg_clr'] != "0" && $row_select_pipe['avg_clr'] != null) {
		...
		<table align="center" width="90%" Height="10%" class="test1" style="border: 1px solid black;" cellpadding="5px">
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['ph_s1_1'] != "" && $row_select_pipe['ph_s1_1'] != "0" && $row_select_pipe['ph_s1_1'] != null) {
																			echo $row_select_pipe['ph_s1_1'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['ph_s2_1'] != "" && $row_select_pipe['ph_s2_1'] != "0" && $row_select_pipe['ph_s2_1'] != null) {
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['ph_s1_2'] != "" && $row_select_pipe['ph_s1_2'] != "0" && $row_select_pipe['ph_s1_2'] != null) {
																			echo $row_select_pipe['ph_s1_2'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['ph_s2_2'] != "" && $row_select_pipe['ph_s2_2'] != "0" && $row_select_pipe['ph_s2_2'] != null) {
			...
			<tr>
				<td style="border: 1px solid black;"><b>&nbsp; % Average</b></td>
				<td colspan="2" style="border: 1px solid black;text-align:center;"><b><?php if ($row_select_pipe['avg_ph'] != "" && $row_select_pipe['avg_ph'] != "0" && $row_select_pipe['avg_ph'] != null) {
		...
		<table align="center" width="90%" Height="18%" class="test1" style="border: 1px solid black;">
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['slp_s1_1'] != "" && $row_select_pipe['slp_s1_1'] != "0" && $row_select_pipe['slp_s1_1'] != null) {
																			echo $row_select_pipe['slp_s1_1'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['slp_s2_1'] != "" && $row_select_pipe['slp_s2_1'] != "0" && $row_select_pipe['slp_s2_1'] != null) {
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['slp_s1_2'] != "" && $row_select_pipe['slp_s1_2'] != "0" && $row_select_pipe['slp_s1_2'] != null) {
																			echo $row_select_pipe['slp_s1_2'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['slp_s2_2'] != "" && $row_select_pipe['slp_s2_2'] != "0" && $row_select_pipe['slp_s2_2'] != null) {
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['slp_s1_3'] != "" && $row_select_pipe['slp_s1_3'] != "0" && $row_select_pipe['slp_s1_3'] != null) {
																			echo $row_select_pipe['slp_s1_3'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['slp_s2_3'] != "" && $row_select_pipe['slp_s2_3'] != "0" && $row_select_pipe['slp_s2_3'] != null) {
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['slp_s1_4'] != "" && $row_select_pipe['slp_s1_4'] != "0" && $row_select_pipe['slp_s1_4'] != null) {
																			echo $row_select_pipe['slp_s1_4'];
																		} else {
																			echo " <br>";
																		} ?></td>
				<td style="border: 1px solid black;text-align:center;"><?php if ($row_select_pipe['slp_s2_4'] != "" && $row_select_pipe['slp_s2_4'] != "0" && $row_select_pipe['slp_s2_4'] != null) {
			...
			<tr>
				<td style="border: 1px solid black;"><b>&nbsp; % Average</b></td>
				<td colspan="2" style="border: 1px solid black;text-align:center;"><b><?php if ($row_select_pipe['avg_sul'] != "" && $row_select_pipe['avg_sul'] != "0" && $row_select_pipe['avg_sul'] != null) {
		...
		<table align="center" width="94%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				...
				<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR <br> TEST ON COARSE AGGREGATE </b></center>
				</td>
			</tr>
		</table>
		<br>
		...
		<table align="center" width="94%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;">
			<tr>
				<td style="text-align:center;font-size:16px;">
					...
					<table align="center" width="100%" class="test1" style="font-family : Calibri;">
						<tr>
		...
		<table align="center" width="94%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;">
			<tr>
				<td style="text-align:center;font-size:16px;">
					...
					<br><br>
					<table align="center" width="100%" class="test1" style="font-family : Calibri; margin-top: 14px;">
						<tr>
		...
		<!--br>
				...
				<table align="center" width="90%" class="test1" style="border: 2px solid black;border-top: 0px solid black;" height="Auto">
						<tr>
							<td colspan="8" style="border: 0px solid black;text-align:left;font-size:11px;"><b>Note :- A repeat test shall be run if the load does not produce % of fines within tha range 7.5 to 12.5.</b></td>
