...
<body>
	...
	<page size="A4">
		...
		<table align="center"
			...
			<tr>
				<td
					style="text-align: center;border-top: 1px solid;font-weight: bold;border-right: 1px solid;font-size: 15px;">
					Fine Aggregate</td>
			...
			<tr>
				...
				<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
					colspan="4"><b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Sieve Analysis)</td>
			</tr>
			<tr>
				...
				<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
					colspan="4"><b>&nbsp;Method:&nbsp;</b>IS 2386 (P-1)</td>
			</tr>
			<tr>
			...
			<tr>
				<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="3"><b>&nbsp;Sample
						Qty:&nbsp;</b><?php echo $row_select_pipe['txt_qty']; ?></td>
				<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left : 1px solid;"
		...
		<br><br>
		<table align="center" style="width: 95%;text-align: center;border: 1px solid black;" cellspacing="5px"
			cellpadding="5px">
			<tr>
				<td style="font-family: 'Calibri';font-size: 20px;font-weight: bold;" colspan="7"> AGGREGATE DATA ENTRY
					SHEET FINE AGGREGATE (SIEVE ANALYSIS)</td>
			</tr>
		</table>
		<br>
		...
		<table align="center" style="width: 95%;padding: 0 20px;">
			<tr>
				<td>Wt. of Sample for
					Test&nbsp;&nbsp;<u><?php echo $row_select_pipe['sample_taken']; ?></u>&nbsp;&nbsp;gm</td>
			</tr>
		</table>
		</table>
		<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="5px">
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold"
					rowspan="2">IS Sieve <br>(mm)</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold"
					rowspan="2">Wt. Retained</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold"
					rowspan="2"> % age Wt. <br>Retained <br>(gm)</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold"
					rowspan="2">Cum. Wt. <br>Retained%</td>
				<td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold"
					rowspan="2">% Passing</td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold"
					colspan="4">Limits (IS 383: 2016)</td>
			</tr>
			<tr>
				...
				<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;border-right: 1px solid;">Zone
					IV</td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;">10</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_wt_gm_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['ret_wt_gm_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_ret_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<?php echo $row_select_pipe['pass_sample_1']; ?></td>
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_wt_gm_2']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['ret_wt_gm_2']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_ret_2']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<?php echo $row_select_pipe['pass_sample_2']; ?></td>
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_wt_gm_3']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['ret_wt_gm_3']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_ret_3']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<?php echo $row_select_pipe['pass_sample_3']; ?></td>
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_wt_gm_4']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['ret_wt_gm_4']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_ret_4']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<?php echo $row_select_pipe['pass_sample_4']; ?></td>
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_wt_gm_5']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['ret_wt_gm_5']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_ret_5']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<?php echo $row_select_pipe['pass_sample_5']; ?></td>
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_wt_gm_6']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['ret_wt_gm_6']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_ret_6']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<?php echo $row_select_pipe['pass_sample_6']; ?></td>
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_wt_gm_7']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['ret_wt_gm_7']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_ret_7']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<?php echo $row_select_pipe['pass_sample_7']; ?></td>
		...
		<table align="center" style="width: 95%;" cellpadding="10px">
			<tr>
				<td style="font-family: 'calibri';font-size: 16px;font-weight: bold;">
					Sand Sample Passing
					through&nbsp;&nbsp;<u><?php echo $row_select_pipe['grd_zone']; ?></u>&nbsp;&nbsp;Zone</td>
			</tr>
			<tr>
				<td style="font-family: 'calibri';font-size: 16px;font-weight: bold;">Fineness Modulus of Sand =
					Cumulative % weight retained /
					100&nbsp;&nbsp;=&nbsp;&nbsp;<u><?php echo $row_select_pipe['grd_fm']; ?></u>&nbsp;&nbsp; </td>
			</tr>
		</table>
		<br>
		<br>
		...
		<table align="center"
			...
			<table align="center"
				...
				<tr>
					...
					<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
						colspan="4"><b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Water Absorption)</td>
				</tr>
				<tr>
					<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Sample
							Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?></td>
			...
			<br>
			<table align="center" style="width: 95%;text-align: center;border: 1px solid black;" cellspacing="3px"
				cellpadding="3px">
				<tr>
					<td style="font-family: 'Calibri';font-size: 20px;font-weight: bold;" colspan="7"> Water Absorption
						of Fine Aggregate As Per (IS(2386:Part-3))</td>
				</tr>
			</table>
			<br>
			<table align="center" style="width: 95%;text-align: center;font-family: 'calibri';border: 1px solid;"
				...
				<tr>
					...
					<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Wt.of saturated surface
						dry aggregate in air (W1)gm</td>
					<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['finer_a']; ?>
					</td>
				...
				<tr>
					...
					<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Wt.of oven dried
						aggregate in air (w2)gm</td>
					<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['finer_b']; ?>
					</td>
				...
				<tr>
					...
					<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Water absorption =
						(W1-W2)*100/W2(%)</td>
					<td style="border-top: 1px solid;border-right: 1px solid;">
						<?php echo $row_select_pipe['avg_finer']; ?></td>
			...
			<table align="center"
				...
				<table align="center"
					...
					cellspacing="0" cellpadding="2px">
					<tr>
						<td style="width: 20%;text-align: center;font-weight: bolder;border-right: 1px solid;"
							rowspan="5"><img src="../images/mat_logo.png"
								style="height: 100px;width:120px;background-blend-mode: multiply;"></td>
					...
					<tr>
						<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 14px;"
							colspan="7"><b>Regd. Office : </b>VPO Taragarh (Rani Di K) Near Taragarh Palace Tehsil
							Baijnath</td>
					</tr>
					<tr>
						<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 14px;"
							colspan="7">District Kangra Himachal Pradesh (176081)</td>
					</tr>
					<tr>
						<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 13px;"
							colspan="7">Mobile : +91-7018819894, +91-7833853738,e-mail : officialdcspvtltd@gmail.com
						</td>
					</tr>
					<tr>
						<td
							style="text-align: center;border-top: 1px solid;font-weight: bold;border-right: 1px solid;font-size: 15px;">
							Fine Aggregate</td>
						<td style="text-align: center;border-top: 1px solid;font-weight: bold;font-size: 20px;"
					...
					<tr>
						<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Job
								Card No:&nbsp;</b><?php echo $_GET['job_no']; ?></td>
						<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
							colspan="4"><b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Bulk Density Compacted)</td>
					</tr>
					<tr>
						<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">
							<b>&nbsp;Sample Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?></td>
						<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
							colspan="4"><b>&nbsp;Method:&nbsp;</b>IS 2386 (P-1)</td>
					</tr>
					<tr>
						...
						<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
							...
							<b>&nbsp;DOC:&nbsp;</b><?php echo date('d-m-y', strtotime($row_select2['end_date'])); ?></td>
						<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left:1px solid;"
							colspan="2"><b>&nbsp;Page No:&nbsp;</b>3</td>
					</tr>
					<tr>
						<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="3">
							<b>&nbsp;Sample Qty:&nbsp;</b><?php echo $row_select_pipe['txt_qty']; ?></td>
						<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left : 1px solid;"
							colspan="2"><b> &nbsp;Residual Sample:&nbsp;</b><?php echo $row_select_pipe['r_sam']; ?></td>
						<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left : 1px solid;"
							colspan="3"><b>&nbsp;Sample Retention:&nbsp;</b><?php echo $row_select_pipe['s_ret']; ?></td>
				...
				<br><br><br>
				<table align="center" style="width: 95%;text-align: center;border: 1px solid;" cellspacing="5px"
					cellpadding="5px" bordercolor="black">
					<tr>
						<td style="font-family: 'Calibri';font-size: 20px;font-weight: bold;" colspan="7">BULK DENSITY
							(COMPACTED)</td>
					</tr>
				</table>
				<br><br><br>
				<table align="center" style="width: 95%;text-align: center;font-family: 'calibri';border: 1px solid;"
					...
					<tr>
						...
						<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">Volume of Container
							(Ltr)</td>
						<td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['m11']; ?>
						</td>
						<td style="border-top: 1px solid;"><?php echo $row_select_pipe['m12']; ?></td>
					</tr>
					<tr>
						<td style="border-right: 1px solid;border-top: 1px solid;">2</td>
						<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">Wt. of Empty
							Container (Kg)</td>
						<td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['m21']; ?>
						</td>
					...
					<tr>
						...
						<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">Wt.of Empty
							Container + Agg.(kg)</td>
						<td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['m31']; ?>
						</td>
					...
					<tr>
						...
						<td style="border-right: 1px solid;border-top: 1px solid;">
							<?php echo $row_select_pipe['den_mo_vol1']; ?></td>
					...
					<tr>
						...
						<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">Bulk Density
							(Kg/Ltr)</td>
						<td style="border-right: 1px solid;border-top: 1px solid;">
							<?php echo $row_select_pipe['den_mo_vol2']; ?></td>
				...
				<table align="center"
					...
					<table align="center"
						...
						<tr>
							<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">
								<b>&nbsp;Job Card No:&nbsp;</b><?php echo $_GET['job_no']; ?></td>
							<td class="report-cell"
								style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
								<b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Clay And Lumps)</td>
						</tr>
						<tr>
							<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">
								<b>&nbsp;Sample Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?></td>
						...
						<tr>
							...
							<td class="report-cell"
								style="text-align: left;border-top: 1px solid;border-left:1px solid;" colspan="2">
								<b>&nbsp;DOS:&nbsp;</b><?php echo date('d-m-y', strtotime($row_select2['start_date'])); ?>
							</td>
							<td class="report-cell"
								style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="2">
								<b>&nbsp;DOC:&nbsp;</b><?php echo date('d-m-y', strtotime($row_select2['end_date'])); ?>
							</td>
							<td class="report-cell"
								style="text-align: left;border-top: 1px solid;border-left:1px solid;" colspan="2">
								<b>&nbsp;Page No:&nbsp;</b>4</td>
						...
						<tr>
							<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="3">
								<b>&nbsp;Sample Qty:&nbsp;</b><?php echo $row_select_pipe['txt_qty']; ?></td>
							<td class="report-cell"
								style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="2"><b>
									&nbsp;Residual Sample:&nbsp;</b><?php echo $row_select_pipe['r_sam']; ?></td>
							<td class="report-cell"
								style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="3">
					...
					<table align="center" style="width: 95%;text-align: center;border:1px solid;" cellspacing="5px"
						cellpadding="5px">
						<tr>
							<td style="font-family: 'Calibri';font-size: 20px;font-weight: bold;" colspan="7">Clay and
								Lumps IS 2386 Part-2 1963/R2016</td>
						</tr>
					</table>
					<br>
					<table align="center"
						style="width: 95%;text-align: center;font-family: 'calibri';border: 1px solid;" cellspacing="0"
						cellpadding="5px">
						<tr>
							<td style="font-weight: bold;border-right: 1px solid;">S.No</td>
							<td style="font-weight: bold;border-right: 1px solid;">Description</td>
						...
						<tr>
							<td style="border-top: 1px solid;border-right: 1px solid;">1</td>
							<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Wt.of Oven dry
								Sample in gms (A)</td>
							<td style="border-top: 1px solid;border-right: 1px solid;">
								<?php echo $row_select_pipe['dele_2_1']; ?></td>
							<td style="border-top: 1px solid;"><?php echo $row_select_pipe['dele_4_1']; ?></td>
						</tr>
						<tr>
							<td style="border-top: 1px solid;border-right: 1px solid;">2</td>
							<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Wt.of Sample
								after removal of clay lump in gm (b)
							<td style="border-top: 1px solid;border-right: 1px solid;">
								<?php echo $row_select_pipe['dele_2_2']; ?></td>
							<td style="border-top: 1px solid;"><?php echo $row_select_pipe['dele_4_2']; ?></td>
						</tr>
						<tr>
							<td style="border-top: 1px solid;border-right: 1px solid;">3</td>
							<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">% of Clay & Lump
								(A-B)/Ax100</td>
							<td style="border-top: 1px solid;border-right: 1px solid;">
								<?php echo $row_select_pipe['dele_2_3']; ?></td>
						...
						<tr>
							...
							<td style="border-top: 1px solid;" colspan="2">
								...
								if (is_numeric($row_select_pipe['dele_2_3'])) {
									$values[] = $row_select_pipe['dele_2_3'];
								}
								if (is_numeric($row_select_pipe['dele_4_3'])) {
									$values[] = $row_select_pipe['dele_4_3'];
								}

								// Calculate average if at least one value is present
								if (count($values) > 0) {
									$average = array_sum($values) / count($values);
									echo number_format($average, 2);
								} else {
									echo "0.00"; // Or leave empty: echo "";
								}
								?>
							</td>
						</tr>
					...
					<table align="center" style="width: 92%;">
						<tr>
							<td style="border: 0;text-align: left;font-size: 15px;font-family: 'calibri'"><b>Tested by :
									<u><?php echo $u_name; ?> </u></td></b>
							<td style="border: 0;text-align: right;font-size: 15px;font-family: 'calibri'"><b>Checked
									By: <u><?php echo $v_name; ?> </u></td></b>
						</tr>
					</table>
					<!-- =============================material================================ -->
					<div class="pagebreak"></div>
					...
					<table align="center"
						...
						<table align="center"
							...
							<tr>
								<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 14px;"
									colspan="7"><b>Regd. Office : </b>VPO Taragarh (Rani Di K) Near Taragarh Palace
									Tehsil Baijnath</td>
							</tr>
							<tr>
								<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 14px;"
							...
							<tr>
								<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 13px;"
									colspan="7">Mobile : +91-7018819894, +91-7833853738,e-mail :
									officialdcspvtltd@gmail.com</td>
							</tr>
							<tr>
								<td
									style="text-align: center;border-top: 1px solid;font-weight: bold;border-right: 1px solid;font-size: 15px;">
							...
							<tr>
								...
								<td class="report-cell"
									style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
									<b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Finer Than 75 Micron)</td>
							</tr>
							<tr>
								<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">
									<b>&nbsp;Sample Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?></td>
							...
							<tr>
								...
								<td class="report-cell"
									style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="2">
									<b> &nbsp;Residual Sample:&nbsp;</b><?php echo $row_select_pipe['r_sam']; ?></td>
								<td class="report-cell"
									style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="3">
									<b>&nbsp;Sample Retention:&nbsp;</b><?php echo $row_select_pipe['s_ret']; ?></td>
							</tr>
						...
						<table align="center" style="width: 95%;text-align: center;border:1px solid;" cellspacing="5px"
							cellpadding="5px">
							<tr>
								<td style="font-family: 'Calibri';font-size: 20px;font-weight: bold;" colspan="7">
									Material Finer Than 75 Micron IS 2386 Part-1 1963/R2016</td>
							</tr>
						</table>
						<br>
						<table align="center"
							style="width: 95%;text-align: center;font-family: 'calibri';border: 1px solid;"
							cellspacing="0" cellpadding="5px">
							<tr>
								<td style="font-weight: bold;border-right: 1px solid;">S.No</td>
							...
							<tr>
								...
								<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Wt.of Sample
									in gms (A)</td>
								<td style="border-top: 1px solid;border-right: 1px solid;">
									<?php echo $row_select_pipe['dele_1_1']; ?></td>
								<td style="border-top: 1px solid;"><?php echo $row_select_pipe['dele_3_1']; ?></td>
							</tr>
							<tr>
								<td style="border-top: 1px solid;border-right: 1px solid;">2</td>
								<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Wt.of Washed
									Retained Sample on 75 Micron IS Sieve (after the Oven dried) in gms</td>
								<td style="border-top: 1px solid;border-right: 1px solid;">
									<?php echo $row_select_pipe['dele_1_2']; ?></td>
								<td style="border-top: 1px solid;"><?php echo $row_select_pipe['dele_3_2']; ?></td>
							</tr>
							<tr>
								<td style="border-top: 1px solid;border-right: 1px solid;">3</td>
								<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">% 75 micron
									IS Sieve (A-B)/Ax100</td>
								<td style="border-top: 1px solid;border-right: 1px solid;">
									<?php echo $row_select_pipe['dele_1_4']; ?></td>
								<td style="border-top: 1px solid;"><?php echo $row_select_pipe['dele_3_4']; ?></td>
							</tr>
							<tr>
								<td style="border-top: 1px solid;border-right: 1px solid;">4</td>
								<td style="border-top: 1px solid;border-right: 1px solid; text-align: left;">Average
								</td>
								<td style="border-top: 1px solid;" colspan="2">
									<?php
									$values = [];
									...
									// Add values only if they are numeric
									if (is_numeric($row_select_pipe['dele_1_4'])) {
										$values[] = $row_select_pipe['dele_1_4'];
									}
									if (is_numeric($row_select_pipe['dele_3_4'])) {
										$values[] = $row_select_pipe['dele_3_4'];
									}
						...
						<table align="center" style="width: 92%;">
							<tr>
								<td style="border: 0;text-align: left;font-size: 15px;font-family: 'calibri'"><b>Tested
										by : <u><?php echo $u_name; ?> </u></td></b>
								<td style="border: 0;text-align: right;font-size: 15px;font-family: 'calibri'">
									<b>Checked By: <u><?php echo $v_name; ?> </u></td></b>
							</tr>
						</table>
						<!-- =====================================silt=================================== -->
						<div class="pagebreak"></div>
							...
							<table align="center"
								...
								<tr>
									...
									<td style="text-align: center;border-top: 1px solid;font-weight: bold;font-size: 20px;"
										colspan="6"> ANALYSIS DATA SHEET </td>
									<td
										style="text-align: center;border-top: 1px solid;font-weight: bold;font-size: 20px;">
										QSF-1001</td>
								</tr>
								<tr>
									<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">
										<b>&nbsp;Job Card No:&nbsp;</b><?php echo $_GET['job_no']; ?></td>
									<td class="report-cell"
										style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
										colspan="4"><b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Silt Content)</td>
								</tr>
								<tr>
									<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">
										<b>&nbsp;Sample Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?>
									</td>
									<td class="report-cell"
										style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
										colspan="4"><b>&nbsp;Method:&nbsp;</b>IS 2386 (P-1)</td>
								...
								<tr>
									...
									<td class="report-cell"
										style="text-align: left;border-top: 1px solid;border-left : 1px solid;"
										colspan="2"><b> &nbsp;Residual
											Sample:&nbsp;</b><?php echo $row_select_pipe['r_sam']; ?></td>
									<td class="report-cell"
										style="text-align: left;border-top: 1px solid;border-left : 1px solid;"
										colspan="3"><b>&nbsp;Sample
											Retention:&nbsp;</b><?php echo $row_select_pipe['s_ret']; ?></td>
								</tr>
							</table>
							<br><br><br>
							<table align="center" style="width: 95%;text-align: center;border: 1px solid;"
								cellspacing="0" cellpadding="5px">
								<tr>
				...
				px;font-weight: bolder;" colspan="7">SILT CONTENT (As per CPWD)</td>
							...
							<br><br><br>
							<table align="center" style="width: 95%;text-align: center;" cellspacing="0"
								cellpadding="10px">
								<tr>
									<td
										style="border-top: 1px solid;border-left: 1px solid;text-align: center;border-right: 1px solid;font-family: 'calibri';font-size: 17px;font-weight: bold;">
										SNo.</td>
									<td
										style="border-top: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 17px;font-weight: bold;">
										DESCRIPTION</td>
									<td
										style="border-top: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 17px;font-weight: bold;">
										1</td>
								...
								<tr>
									<td
										style="border-top: 1px solid;border-left: 1px solid;text-align: center;border-right: 1px solid;">
										1</td>
									<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Volume
										of Sample (V1), ml</td>
									<td style="border-top: 1px solid;border-right: 1px solid;">
										<?php echo $row_select_pipe['slp_s1_1']; ?></td>
									<td style="border-top: 1px solid;border-right: 1px solid;">
										<?php echo $row_select_pipe['slp_s2_1']; ?></td>
								</tr>
								<tr>
									<td
										style="border-top: 1px solid;border-left: 1px solid;text-align: center;border-right: 1px solid;">
										2</td>
									<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Volume
										of Silt after three hours (V2), ml </td>
									<td style="border-top: 1px solid;border-right: 1px solid;">
										<?php echo $row_select_pipe['slp_s1_2']; ?></td>
									<td style="border-top: 1px solid;border-right: 1px solid;">
										<?php echo $row_select_pipe['slp_s2_2']; ?></td>
								<tr>
									<td
										style="border-top: 1px solid;border-left: 1px solid;text-align: center;border-right: 1px solid;">
										3 </td>
									<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">
										Percentage Silt by Volume V2/V1X100 %</td>
									<td style="border-top: 1px solid;border-right: 1px solid;">
										<?php echo $row_select_pipe['slp_s1_3']; ?></td>
									<td style="border-top: 1px solid;border-right: 1px solid;">
										<?php echo $row_select_pipe['slp_s2_3']; ?></td>
								</tr>
								<tr>
									<td
										style="border-top: 1px solid;border-bottom: 1px solid;border-left: 1px solid;text-align: center;border-right: 1px solid;width: 80px;">
										4</td>
									<td
										style="border-top: 1px solid;border-bottom: 1px solid; border-right: 1px solid;text-align: left;">
										Average</td>
									<td style="border-top: 1px solid;border-bottom: 1px solid;border-right: 1px solid;width: 80px; "
										colspan="2"><?php echo $row_select_pipe['avg_sul']; ?></td>
								</tr>
							</table>
							<br>
							<br>
							...
							<br>
							<table align="center"
								style="width: 92%;text-align: center;height: auto;font-size: 14px;;margin-bottom: -15px;">
								<tr>
									<td style="border: 0;text-align: left;font-size: 15px;font-family: 'calibri'">
										<b>Tested by : <u><?php echo $u_name; ?> </u></td></b>
									<td style="border: 0;text-align: right;font-size: 15px;font-family: 'calibri'">
										<b>Checked By: <u><?php echo $v_name; ?> </u></td></b>
								</tr>
							</table>
							...
							<table align="center"
								...
								<table align="center"
									...
									<tr>
										<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 14px;"
											colspan="7"><b>Regd. Office : </b>VPO Taragarh (Rani Di K) Near Taragarh
											Palace Tehsil Baijnath</td>
									</tr>
									<tr>
										<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 14px;"
											colspan="7">District Kangra Himachal Pradesh (176081)</td>
									...
									<tr>
										<td class="report-cell" style="text-align: left;border-top: 1px solid;"
											colspan="4"><b>&nbsp;Job Card No:&nbsp;</b><?php echo $_GET['job_no']; ?>
										</td>
										<td class="report-cell"
											style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
											colspan="4"><b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Bulk Density Losse)
										</td>
									</tr>
									<tr>
										<td class="report-cell" style="text-align: left;border-top: 1px solid;"
								...
								<br><br><br>
								<table align="center" style="width: 95%;text-align: center;border: 1px solid;"
									cellspacing="5px" cellpadding="5px" bordercolor="black">
									<tr>
										<td style="font-family: 'Calibri';font-size: 20px;font-weight: bold;"
											colspan="7">BULK DENSITY (LOOSE)</td>
									</tr>
								</table>
								<br><br><br>
								<table align="center"
									...
									<tr>
										<td style="border-right: 1px solid;border-top: 1px solid;">1</td>
										<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">
											Volume of Container (Ltr)</td>
										<td style="border-right: 1px solid;border-top: 1px solid;">
											<?php echo $row_select_pipe['m13']; ?></td>
										<td style="border-top: 1px solid;"><?php echo $row_select_pipe['m23']; ?></td>
									</tr>
									<tr>
										<td style="border-right: 1px solid;border-top: 1px solid;">2</td>
										<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">Wt.
											of Empty Container (Kg)</td>
										<td style="border-right: 1px solid;border-top: 1px solid;">
											<?php echo $row_select_pipe['m33']; ?></td>
										<td style="border-top: 1px solid;"><?php echo $row_select_pipe['den_voids_1']; ?>
										</td>
									</tr>
									<tr>
										<td style="border-right: 1px solid;border-top: 1px solid;">3</td>
										<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">
											Wt.of Empty Container + Agg.(kg)</td>
										<td style="border-right: 1px solid;border-top: 1px solid;">
											<?php echo $row_select_pipe['weight_1']; ?></td>
										<td style="border-top: 1px solid;"><?php echo $row_select_pipe['weight_2']; ?>
										</td>
									</tr>
									<tr>
										<td style="border-right: 1px solid;border-top: 1px solid;">4</td>
										<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">
											Wt.of Agg.(Kg)</td>
										<td style="border-right: 1px solid;border-top: 1px solid;">
											<?php echo $row_select_pipe['asd_1']; ?></td>
										<td style="border-top: 1px solid;"><?php echo $row_select_pipe['asd_2']; ?></td>
									</tr>
									<tr>
										<td style="border-right: 1px solid;border-top: 1px solid;">5</td>
										<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">Bulk
											Density (Kg/Ltr)</td>
										<td style="border-right: 1px solid;border-top: 1px solid;">
											<?php echo $row_select_pipe['den_voids']; ?></td>
										<td style="border-top: 1px solid;"><?php echo $row_select_pipe['den_voids1']; ?>
										</td>
									</tr>
									<tr>
										<td style="border-right: 1px solid;border-top: 1px solid;">6</td>
										<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">
											Average</td>
										<td style="border-top: 1px solid;" colspan="2">
											<?php echo $row_select_pipe['avg_wom1']; ?></td>
									</tr>
								</table>
								<br><br><br><br><br><br>
								<br>
								...
								<table align="center"
									...
									<table align="center"
										...
										<tr>
											<td style="width: 20%;text-align: center;font-weight: bolder;border-right: 1px solid;"
												rowspan="5"><img src="../images/mat_logo.png"
													style="height: 100px;width:120px;background-blend-mode: multiply;">
											</td>
										...
										<tr>
											...
											<td class="report-cell"
												style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
												colspan="4"><b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Specific
												Gravity & water Absorption)</td>
										</tr>
										<tr>
											<td class="report-cell" style="text-align: left;border-top: 1px solid;"
												colspan="4"><b>&nbsp;Sample
									...
									<table align="center" style="width: 95%;text-align: center;border: 1px solid;"
										...
										<tr>
											<td style="font-family: 'Calibri', 'Trebuchet MS', sans-serif;font-size: 35px
			px;font-weight: bolder;" colspan="7"> SPECIFIC GRAVITY/WATER ABSORPTION (FA) <br>As Per IS : 2386 PART-3
											</td>
										</tr>
									</table>
									<br>
									<table align="center" style="width: 95%;">
										<tr>
											<td style="font-family: 'calibri';font-size: 16px;font-weight: bold;">
												Specific Gravity/Water Absorption of Coarse Aggregates As Per IS 2386
												Part-3</td>
										</tr>
									</table>
									<table align="center" style="width: 95%;text-align: center;" cellspacing="0"
										...
										<tr>
											<td
												style="border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;">
											</td>
										...
										<tr>
											<td
												style="border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;">
												Mass of Saturated Surface Dry Aggregate</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">A</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">gm</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_wt_st_1']; ?></td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_wt_st_2']; ?></td>
											<td style="border-top: 1px solid;border-right: 1px solid;"></td>
										</tr>
										<tr>
											<td
												style="border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;">
												Mass of Pycnometer contaning Aggregate and <br>Filled with Distilled
												Water </td>
											<td style="border-top: 1px solid;border-right: 1px solid;">B</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">gm</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_wt_bas1']; ?></td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_wt_bas2']; ?></td>
											<td style="border-top: 1px solid;border-right: 1px solid;"></td>
										...
										<tr>
											<td
												style="border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;">
												Mass of Pycnometer Filled with Distilled Water </td>
											<td style="border-top: 1px solid;border-right: 1px solid;">C</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">gm</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_w_s_1']; ?></td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_w_s_2']; ?></td>
											<td style="border-top: 1px solid;border-right: 1px solid;"></td>
										</tr>
										<tr>
											<td
												style="border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;">
												Mass of Oven Dry Aggregate</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">D</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">gm</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_w_sur_1']; ?></td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_w_sur_2']; ?></td>
											<td style="border-top: 1px solid;border-right: 1px solid;"></td>
										</tr>
										<tr>
											<td
												style="border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;">
												Specific Gravity based on dry aggregate</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">D/A-(B-C)</td>
											<td style="border-top: 1px solid;border-right: 1px solid;"></td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_specific_gravity_1']; ?></td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_specific_gravity_2']; ?></td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_specific_gravity']; ?></td>
										</tr>
										<tr>
											<td
												style="border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;">
												Specific Gravity based on SSD weight</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">A/A-(B-C)</td>
											<td style="border-top: 1px solid;border-right: 1px solid;"></td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo number_format(($row_select_pipe['sp_wt_st_1'] / ($row_select_pipe['sp_wt_st_1'] - ($row_select_pipe['sp_wt_bas1'] - $row_select_pipe['sp_w_s_1']))), 2); ?>
											</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo number_format(($row_select_pipe['sp_wt_st_2'] / ($row_select_pipe['sp_wt_st_2'] - ($row_select_pipe['sp_wt_bas2'] - $row_select_pipe['sp_w_s_2']))), 2); ?>
											</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php //echo $row_select_pipe['sp_specific_gravity_2']; ?></td>
										</tr>
										<tr>
											<td
												style="border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;">
												Apparent Specific Gravity</td>
											<td style="border-top: 1px solid;border-right: 1px solid;">D/D-(B-C)</td>
											<td style="border-top: 1px solid;border-right: 1px solid;"></td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_apr1']; ?></td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_apr2']; ?></td>
											<td style="border-top: 1px solid;border-right: 1px solid;">
												<?php echo $row_select_pipe['sp_avg_apr']; ?></td>
										</tr>
										<tr>
											<td
												style="border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;border-bottom: 1px solid;width: 500px;">
												Water Absorption</td>
											<td
												style="border-top: 1px solid;border-right: 1px solid;border-bottom: 1px solid;width: 600px;">
												(A-D)/DX100</td>
											<td
												style="border-top: 1px solid;border-right: 1px solid;border-bottom: 1px solid;">
											</td>
											<td
												style="border-top: 1px solid;border-right: 1px solid;border-bottom: 1px solid;width: 200px;">
												<?php echo $row_select_pipe['sp_water_abr_1']; ?></td>
											<td
												style="border-top: 1px solid;border-right: 1px solid;border-bottom: 1px solid;width: 200px;">
												<?php echo $row_select_pipe['sp_water_abr_2']; ?></td>
											<td
												style="border-top: 1px solid;border-right: 1px solid;border-bottom: 1px solid;width: 100px;">
												<?php echo $row_select_pipe['sp_water_abr']; ?></td>
										</tr>
									</table>
									<br>
									<br>
									...
									<table align="center" style="width: 92%;">
										<tr>
											<td
												style="border: 0;text-align: left;font-size: 15px;font-family: 'calibri'">
												<b>Tested by : <u><?php echo $u_name; ?> </u></td></b>
											<td
												style="border: 0;text-align: right;font-size: 15px;font-family: 'calibri'">
												<b>Checked By: <u><?php echo $v_name; ?> </u></td></b>
										</tr>
									</table>
...
<br><br><br><br><br>		<br><br><br><br><br>		<br><br><br><br><br> <br><br><br>
		...
		<table align="center" width="100%"  style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;border-bottom:1px solid;">
			...
			<table align="center" width="100%" class="test1"  style="border: 1px solid black; font-family : Calibri; margin-top:-1px;">
				...
				<tr>
					...
					<td colspan="3" style=""><b>volume of mould = </b> <?php if ($row_select_pipe['vol'] != "" && $row_select_pipe['vol'] != "0" && $row_select_pipe['vol'] != null) {
						echo $row_select_pipe['vol'] . " m<sup>3</sup>";
					} else {
						echo "<br>";
					} ?></td>
				</tr>
			...
			<table align="center" width="100%" class="test1"  style="border: 1px solid black; font-family : Calibri; margin-top:-1px;">
				...
				<tr>
					<td colspan="7" style="border: 1px solid black;">&nbsp;&nbsp; Weight of Pycnometer Bottle in Water A2= <?php if ($row_select_pipe['sp_bask_water'] != "" && $row_select_pipe['sp_bask_water'] != "0" && $row_select_pipe['sp_bask_water'] != null) {
			...
			<table align="center" width="100%" class="test1" style="border: 1px solid black;" height="Auto">
				...
				<tr>
					...
					<td  style="border: 1px solid black; "><center><?php if ($row_select_pipe['sp_apr1'] != "" && $row_select_pipe['sp_apr1'] != "0" && $row_select_pipe['sp_apr1'] != null) {
						echo $row_select_pipe['sp_apr1'];
					} else {
						echo " <br>";
					} ?></center></td>						
				...
				<tr>
					...
					<td  style="border: 1px solid black; "><center><?php if ($row_select_pipe['sp_apr2'] != "" && $row_select_pipe['sp_apr2'] != "0" && $row_select_pipe['sp_apr2'] != null) {
						echo $row_select_pipe['sp_apr2'];
					} else {
						echo " <br>";
					} ?></center></td>
				...
				<tr>
					...
					<td  style="border: 1px solid black; font-weight:bold;"><center><?php if ($row_select_pipe['sp_avg_apr'] != "" && $row_select_pipe['sp_avg_apr'] != "0" && $row_select_pipe['sp_avg_apr'] != null) {
						echo $row_select_pipe['sp_avg_apr'];
					} else {
						echo " <br>";
					} ?></center></td>						
	...
	<?php //}if (($row_select_pipe['soundness'] != "" && $row_select_pipe['soundness'] != "0" && $row_select_pipe['soundness'] != null)) { ?>
		...
		<table align="center" width="100%" class="test1"  style="border: 1px solid black; font-family : Calibri; margin-top:-1px;">
				...
				<tr>
					...
					<td width="50%" colspan="2" style="border: 1px solid black;">&nbsp;&nbsp; <?php if ($row_select_pipe['sou_con'] == "con2") {
						echo "MgSO<sub>4</sub>";
					} else {
						echo "Na<sub>2</sub>SO<sub>4</sub>";
					} ?></td>
			...
			<table align="center" width="100%" class="test1"  style="border: 1px solid black; font-family : Calibri; margin-top:-1px;">
				...
				<tr style="text-align:center;font-weight:bold;">
					...
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['go1'] != "" && $row_select_pipe['go1'] != "0" && $row_select_pipe['go1'] != null) {
						echo $row_select_pipe['go1'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wt1'] != "" && $row_select_pipe['wt1'] != "0" && $row_select_pipe['wt1'] != null) {
						echo $row_select_pipe['wt1'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['pp1'] != "" && $row_select_pipe['pp1'] != "0" && $row_select_pipe['pp1'] != null) {
						echo $row_select_pipe['pp1'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wa1'] != "" && $row_select_pipe['wa1'] != "0" && $row_select_pipe['wa1'] != null) {
				...
				<tr style="border: 1px solid black;">
					...
					<td  style="border: 1px solid black;"><center><b>150 mic</b></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['go2'] != "" && $row_select_pipe['go2'] != "0" && $row_select_pipe['go2'] != null) {
						echo $row_select_pipe['go2'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wt2'] != "" && $row_select_pipe['wt2'] != "0" && $row_select_pipe['wt2'] != null) {
						echo $row_select_pipe['wt2'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['pp2'] != "" && $row_select_pipe['pp2'] != "0" && $row_select_pipe['pp2'] != null) {
						echo $row_select_pipe['pp2'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wa2'] != "" && $row_select_pipe['wa2'] != "0" && $row_select_pipe['wa2'] != null) {
				...
				<tr style="border: 1px solid black;">
					...
					<td  style="border: 1px solid black;"><center><b>300 mic</b></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['go3'] != "" && $row_select_pipe['go3'] != "0" && $row_select_pipe['go3'] != null) {
						echo $row_select_pipe['go3'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wt3'] != "" && $row_select_pipe['wt3'] != "0" && $row_select_pipe['wt3'] != null) {
						echo $row_select_pipe['wt3'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['pp3'] != "" && $row_select_pipe['pp3'] != "0" && $row_select_pipe['pp3'] != null) {
						echo $row_select_pipe['pp3'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wa3'] != "" && $row_select_pipe['wa3'] != "0" && $row_select_pipe['wa3'] != null) {
				...
				<tr style="border: 1px solid black;">
					...
					<td  style="border: 1px solid black;"><center><b>600 mic</b></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['go4'] != "" && $row_select_pipe['go4'] != "0" && $row_select_pipe['go4'] != null) {
						echo $row_select_pipe['go4'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wt4'] != "" && $row_select_pipe['wt4'] != "0" && $row_select_pipe['wt4'] != null) {
						echo $row_select_pipe['wt4'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['pp4'] != "" && $row_select_pipe['pp4'] != "0" && $row_select_pipe['pp4'] != null) {
						echo $row_select_pipe['pp4'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wa4'] != "" && $row_select_pipe['wa4'] != "0" && $row_select_pipe['wa4'] != null) {
				...
				<tr style="border: 1px solid black;">
					...
					<td  style="border: 1px solid black;"><center><b>1.18 MM</b></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['go5'] != "" && $row_select_pipe['go5'] != "0" && $row_select_pipe['go5'] != null) {
						echo $row_select_pipe['go5'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wt5'] != "" && $row_select_pipe['wt5'] != "0" && $row_select_pipe['wt5'] != null) {
						echo $row_select_pipe['wt5'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['pp5'] != "" && $row_select_pipe['pp5'] != "0" && $row_select_pipe['pp5'] != null) {
						echo $row_select_pipe['pp5'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wa5'] != "" && $row_select_pipe['wa5'] != "0" && $row_select_pipe['wa5'] != null) {
				...
				<tr style="border: 1px solid black;">
					...
					<td  style="border: 1px solid black;"><center><b>2.36 MM</b></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['go6'] != "" && $row_select_pipe['go6'] != "0" && $row_select_pipe['go6'] != null) {
						echo $row_select_pipe['go6'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wt6'] != "" && $row_select_pipe['wt6'] != "0" && $row_select_pipe['wt6'] != null) {
						echo $row_select_pipe['wt6'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['pp6'] != "" && $row_select_pipe['pp6'] != "0" && $row_select_pipe['pp6'] != null) {
						echo $row_select_pipe['pp6'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wa6'] != "" && $row_select_pipe['wa6'] != "0" && $row_select_pipe['wa6'] != null) {
				...
				<tr style="border: 1px solid black;">
					...
					<td  style="border: 1px solid black;"><center><b>4.75 MM</b></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['go7'] != "" && $row_select_pipe['go7'] != "0" && $row_select_pipe['go7'] != null) {
						echo $row_select_pipe['go7'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wt7'] != "" && $row_select_pipe['wt7'] != "0" && $row_select_pipe['wt7'] != null) {
						echo $row_select_pipe['wt7'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['pp7'] != "" && $row_select_pipe['pp7'] != "0" && $row_select_pipe['pp7'] != null) {
						echo $row_select_pipe['pp7'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['wa7'] != "" && $row_select_pipe['wa7'] != "0" && $row_select_pipe['wa7'] != null) {
				...
				<tr style="border: 1px solid black;">
					...
					<td  style="border: 1px solid black;"><center></center></td>
					<td  style="border: 1px solid black;"><center></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['soundness'] != "" && $row_select_pipe['soundness'] != "0" && $row_select_pipe['soundness'] != null) {
		...
		<tr>
			...
			<table align="center" width="41%" class="test1"  style="border: 1px solid black; font-family : Calibri; margin-top:-1px;">
				<tr style="border: 1px solid black;">
					...
					<td style="border: 1px solid black;"><?php if ($row_select_pipe['lbd_1'] != "" && $row_select_pipe['lbd_1'] != "0" && $row_select_pipe['lbd_1'] != null) {
						echo $row_select_pipe['lbd_1'];
					} else {
						echo " <br>";
					} ?></td>
				...
				<tr style="text-align:center;font-weight:bold;">
					...
					<td  style="border: 1px solid black;"><?php if ($row_select_pipe['ans_lbd'] != "" && $row_select_pipe['ans_lbd'] != "0" && $row_select_pipe['ans_lbd'] != null) {
						echo $row_select_pipe['ans_lbd'];
					} else {
						echo " <br>";
					} ?></td>
			...
			<table align="center" width="100%" class="test1"  height="10%" style="border: 1px solid black; font-family : Calibri;">
				...
				<tr>
				<td colspan="4" style="">
				<b>Specific Gravity:</b><?php if ($row_select_pipe['fmc_sp'] != "" && $row_select_pipe['fmc_sp'] != "0" && $row_select_pipe['fmc_sp'] != null) {
					echo $row_select_pipe['fmc_sp'];
				} else {
					echo " <br>";
				} ?>
				</td>
			...
			<table align="center" width="50%" class="test1"  style="border: 1px solid black; font-family : Calibri; margin-top:-1px;">
				...
				<tr style="border: 1px solid black;">
					...
					<td style="border: 1px solid black;text-align:center"><?php if ($row_select_pipe['fmc_1'] != "" && $row_select_pipe['fmc_1'] != "0" && $row_select_pipe['fmc_1'] != null) {
						echo $row_select_pipe['fmc_1'];
					} else {
						echo " <br>";
					} ?></td>
				...
				<tr style="border: 1px solid black;">
					...
					<td style="border: 1px solid black;text-align:center"><?php if ($row_select_pipe['fmc_2'] != "" && $row_select_pipe['fmc_2'] != "0" && $row_select_pipe['fmc_2'] != null) {
						echo $row_select_pipe['fmc_2'];
					} else {
						echo " <br>";
					} ?></td>
				...
				<tr style="border: 1px solid black;">
					...
					<td style="border: 1px solid black;text-align:center"><?php if ($row_select_pipe['fmc_3'] != "" && $row_select_pipe['fmc_3'] != "0" && $row_select_pipe['fmc_3'] != null) {
						echo $row_select_pipe['fmc_3'];
					} else {
						echo " <br>";
					} ?></td>
				...
				<tr style="border: 1px solid black;">
					...
					<td style="border: 1px solid black;text-align:center"><?php if ($row_select_pipe['fmc_4'] != "" && $row_select_pipe['fmc_4'] != "0" && $row_select_pipe['fmc_4'] != null) {
						echo $row_select_pipe['fmc_4'];
					} else {
						echo " <br>";
					} ?></td>
				...
				<tr style="border: 1px solid black;">
					...
					<td style="border: 1px solid black;text-align:center"><?php if ($row_select_pipe['fmc_5'] != "" && $row_select_pipe['fmc_5'] != "0" && $row_select_pipe['fmc_5'] != null) {
						echo $row_select_pipe['fmc_5'];
					} else {
						echo " <br>";
					} ?></td>
				...
				<tr style="border: 1px solid black;">
					...
					<td style="border: 1px solid black;text-align:center"><?php if ($row_select_pipe['fmc_6'] != "" && $row_select_pipe['fmc_6'] != "0" && $row_select_pipe['fmc_6'] != null) {
						echo $row_select_pipe['fmc_6'];
					} else {
						echo " <br>";
					} ?></td>
				...
				<tr style="border: 1px solid black;">
					...
					<td style="border: 1px solid black;text-align:center"><?php if ($row_select_pipe['fmc_7'] != "" && $row_select_pipe['fmc_7'] != "0" && $row_select_pipe['fmc_7'] != null) {
						echo $row_select_pipe['fmc_7'];
					} else {
						echo " <br>";
					} ?></td>
		...
		<tr>
			...
			<table align="center" width="100%" class="test1"  style="border: 1px solid black; font-family : Calibri; margin-top:-1px;">
				...
				<tr style="text-align:center;font-weight:bold;">
					...
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['finer_a'] != "" && $row_select_pipe['finer_a'] != "0" && $row_select_pipe['finer_a'] != null) {
						echo $row_select_pipe['finer_a'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['finer_b'] != "" && $row_select_pipe['finer_b'] != "0" && $row_select_pipe['finer_b'] != null) {
						echo $row_select_pipe['finer_b'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['avg_finer'] != "" && $row_select_pipe['avg_finer'] != "0" && $row_select_pipe['avg_finer'] != null) {
		...
		<table align="center" width="100%" class="test1"  style="border-left: 1px solid black;border-right: 1px solid black; font-family : Calibri; ">
			...
			<table align="center" width="100%" class="test1"  style="border: 1px solid black; font-family : Calibri; margin-top:-1px;">
				...
				<tr style="text-align:center;font-weight:bold;">
					...
					<td  style="border: 1px solid black;"><center>1</center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['dele_4_1'] != "" && $row_select_pipe['dele_4_1'] != "0" && $row_select_pipe['dele_4_1'] != null) {
						echo $row_select_pipe['dele_4_1'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['dele_4_2'] != "" && $row_select_pipe['dele_4_2'] != "0" && $row_select_pipe['dele_4_2'] != null) {
						echo $row_select_pipe['dele_4_2'];
					} else {
						echo "<br>";
					} ?></center></td>
					<td  style="border: 1px solid black;"><center><?php if ($row_select_pipe['dele_4_3'] != "" && $row_select_pipe['dele_4_3'] != "0" && $row_select_pipe['dele_4_3'] != null) {
