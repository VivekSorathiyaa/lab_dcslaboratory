...
<body>
	...
	<page size="A4" layout="landscape">
		<table align="center" width="90%" class="test" height="12%" border="1px">
			<tr>
				<td colspan="12" style="font-size:13px"><b>ShSTC Soil Material Testing Lab</b></td>
			</tr>
			<tr>
		...
		<table align="center" width="90%" border="1px" height="13%" class="test">
			<tr>
				<td colspan="12">
					<center><b>ShSTC Soil Material Testing Lab</b></center>
				</td>
			</tr>
			<tr>
		...
		<table align="center" border="1px" height="13%" width="90%" class="test">
			<tr>
				<td colspan="12"><b>
						<center>SShSTC Soil Material Testing Lab</center>
					</b></td>
			</tr>
			<tr>
