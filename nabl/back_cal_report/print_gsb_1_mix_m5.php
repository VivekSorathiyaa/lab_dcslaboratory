    ...
    <page size="A4">
        <?php if ($row_select_pipe['pass_sample_1'] != "" && $row_select_pipe['pass_sample_1'] != null) { ?>
            ...
            <table align="center"
                ...
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card
                        No:&nbsp;<?php echo $_GET['job_no']; ?></td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
                        colspan="4">&nbsp;Test:&nbsp;<?php echo $detail_sample; ?>&nbsp;(SIEVE ANALYSIS)</td>
                </tr>
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample
                        Description:&nbsp;<?php echo $row_select_pipe['s_des']; ?></td>
                    <td class="report-cell"
                        style="text-align: left;border-top: 1px solid;border-left: 1px solid;font-size:12px" colspan="4">
                        &nbsp;Method:&nbsp;As per MORTH
                        specification</td>
                </tr>
                <tr>
                    ...
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left:1px solid;"
                        colspan="2">&nbsp;DOS:&nbsp;<?php echo date('d-m-y', strtotime($row_select2['start_date'])); ?> </td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
                        colspan="2">&nbsp;DOC:&nbsp;<?php echo date('d-m-y', strtotime($row_select2['end_date'])); ?></td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left:1px solid;"
                        colspan="2">&nbsp;Page No:&nbsp;1</td>
                </tr>
                <tr>
            ...
            <table align="center" style="width: 95%;text-align: center;border: 1px solid;" cellspacing="5px"
                ...
                <tr>
                    <td style="font-family: 'Calibri';font-size: 25px;font-weight: bold;" colspan="7">
                        <?php echo $detail_sample; ?> (SIEVE ANALYSIS)</td>
                </tr>
            </table>
            <br>
            <table align="center" style="width: 95%;">
                <tr>
                    <td style="font-family: 'calibri';font-size: 16px;font-weight: bold;">
                        Sieve Analysis <?php echo $detail_sample; ?> GRADE <u>&nbsp;&nbsp;I&nbsp;&nbsp;</u> [As Per MORTH
                        Specification]</td>
                </tr>
            </table>
            <br>
            <table align="center" style="width: 95%;">
                <tr>
                    <td>Wt. of Sample for Test<u>&nbsp;&nbsp;<?php echo $row_select_pipe['sample_taken']; ?>&nbsp;&nbsp;</u>
                        gm</td>
                </tr>
            </table>
            </table>
            <table align="center" style="width: 95%;text-align: center;border-bottom:1px solid;" cellspacing="0"
                ...
                <tr>
                    ...
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        % age Weight <br>Retained
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        Cumulative Wt. <br>Retained%</td>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        % Passing</td>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        Limits</td>
                </tr>
                <?php if ($row_select_pipe['sieve_1'] != "" && $row_select_pipe['sieve_1'] != null) { ?>
                    <tr>
                        ...
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['pass_range_1']; ?></td>
                    </tr>
                <?php }
                if ($row_select_pipe['sieve_2'] != "" && $row_select_pipe['sieve_2'] != null) { ?>
                    <tr>
                        ...
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['pass_range_2']; ?></td>
                    </tr>
                <?php }
                if ($row_select_pipe['sieve_3'] != "" && $row_select_pipe['sieve_3'] != null) { ?>
                    <tr>
                        ...
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['pass_range_3']; ?></td>
                    </tr>
                <?php }
                if ($row_select_pipe['sieve_4'] != "" && $row_select_pipe['sieve_4'] != null) { ?>
                    <tr>
                        ...
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['pass_range_4']; ?></td>
                    </tr>
                <?php }
                if ($row_select_pipe['sieve_5'] != "" && $row_select_pipe['sieve_5'] != null) { ?>
                    <tr>
                        ...
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['pass_range_5']; ?></td>
                    </tr>
                <?php }
                if ($row_select_pipe['sieve_6'] != "" && $row_select_pipe['sieve_6'] != null) { ?>
                    <tr>
                        ...
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['pass_range_6']; ?></td>
                    </tr>
                <?php }
                if ($row_select_pipe['sieve_7'] != "" && $row_select_pipe['sieve_7'] != null) { ?>
                    <tr>
                        ...
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['pass_range_7']; ?></td>
                    </tr>
                <?php }
                if ($row_select_pipe['sieve_8'] != "" && $row_select_pipe['sieve_8'] != null) { ?>
                    <tr>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['sieve_8']; ?></td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_wt_gm_8']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['ret_wt_gm_8']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_ret_8']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;">
                            <?php echo $row_select_pipe['pass_sample_8']; ?></td>
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['pass_range_8']; ?></td>
                    </tr>
                <?php }
                if ($row_select_pipe['sieve_9'] != "" && $row_select_pipe['sieve_9'] != null) { ?>
                    <tr>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['sieve_9']; ?></td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_wt_gm_9']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['ret_wt_gm_9']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_ret_9']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;">
                            <?php echo $row_select_pipe['pass_sample_9']; ?></td>
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['pass_range_9']; ?></td>
                    </tr>
                <?php }
                if ($row_select_pipe['sieve_10'] != "" && $row_select_pipe['sieve_10'] != null) { ?>
                    <tr>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['sieve_10']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_wt_gm_10']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['ret_wt_gm_10']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_ret_10']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;">
                            <?php echo $row_select_pipe['pass_sample_10']; ?></td>
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['pass_range_10']; ?></td>
                    </tr>
                <?php }
                if ($row_select_pipe['sieve_11'] != "" && $row_select_pipe['sieve_11'] != null) { ?>
                    <tr>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['sieve_11']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_wt_gm_11']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['ret_wt_gm_11']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['cum_ret_11']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;">
                            <?php echo $row_select_pipe['pass_sample_11']; ?></td>
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['pass_range_11']; ?></td>
                    </tr>
                <?php } ?>
                <tr>
                    <td style="border-top: 1px solid;border-left: 1px solid;">Pan</td>
                    <td style="border-top: 1px solid;border-left: 1px solid;">
                        <?php //echo $row_select_pipe['cum_wt_gm_5']; ?></td>
                    <td style="border-top: 1px solid;border-left: 1px solid;">
                        <?php //echo $row_select_pipe['ret_wt_gm_5']; ?></td>
                    <td style="border-top: 1px solid;border-left: 1px solid;"><?php //echo $row_select_pipe['cum_ret_5']; ?>
                    </td>
                    <td style="border-top: 1px solid;border-left: 1px solid;">
                        <?php //echo $row_select_pipe['pass_sample_5']; ?></td>
        ...
        if ($row_select_pipe['cru_value'] != "" && $row_select_pipe['cru_value'] != null && $row_select_pipe['cru_value'] != "0") { ?>
            ...
            <table align="center"
                ...
                <tr>
                    ...
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
                        colspan="4">&nbsp;Test:&nbsp;(CRUSHING VALUE)</td>
                </tr>
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample
                        Description:&nbsp;<?php echo $sample_de; ?></td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
                        colspan="4">&nbsp;Method:&nbsp;As per MORTH
                        specification</td>
                </tr>
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="2">
                    ...
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
                        colspan="2">&nbsp;DOC:&nbsp;<?php echo date('d-m-y', strtotime($row_select2['end_date'])); ?></td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left:1px solid;"
                        colspan="2">&nbsp;Page No:&nbsp;2</td>
                </tr>
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="3">&nbsp;Sample
                        Qty:&nbsp;<?php echo $row_select_pipe['qty_1']; ?></td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left : 1px solid;"
                        colspan="2"> &nbsp;Residual Sample:&nbsp;<?php echo $row_select_pipe['r_sam']; ?></td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left : 1px solid;"
                        colspan="3">&nbsp;Sample Retention:&nbsp;<?php echo $row_select_pipe['s_ret']; ?> </td>
                </tr>
            </table>
            ...
            <table align="center" style="width: 95%;text-align: center;border: 1px solid;" cellspacing="5px"
                cellpadding="5px" bordercolor="black">
                <tr>
                    <td style="font-family: 'Calibri';font-size: 25px;font-weight: bold;" colspan="7"> (AGGREGATE CRUSHING
                        VALUE)</td>
                </tr>
            </table>
            <br>
            <table align="center" style="width: 95%;" cellpadding="10px">
                <tr>
                    <td style="font-family: 'calibri';font-size: 16px;font-weight: bold;text-align:center;"> Aggregate
                        Crushing Value [IS 2386 (Part-4)-1963 RA 2016]</td>
                </tr>
            ...
            <table align="center" style="width: 95%;text-align: center;border-bottom:1px solid;" cellspacing="0"
                ...
                <tr>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        Aggregate Size (mm)</td>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        Wt. of Container (gm)</td>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        Wt. Of Container + Aggregate (gm)</td>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        Wt. Of Aggregate before Crushing (gm)</td>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        Wt. of Aggregate retained on 2.36 mm Sieve (gm)</td>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        Wt. of Aggregate Passing from 2.36 mm Sieve (gm)</td>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        Aggregate Crushing Value %</td>
                </tr>
                <tr>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                    </td>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        1</td>
                    ...
                    <td
                        ...
                        5</td>
                    <td
                        style="width:16%;border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        6=(5/3)x100</td>
                </tr>
                ...
                <?php if ($row_select_pipe['cru_value_1'] != "" && $row_select_pipe['cru_value_1'] != null) { ?>
                    <tr>
                        ...
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['cru_value_1']; ?></td>
                    </tr>
                <?php }
                if ($row_select_pipe['cru_value_2'] != "" && $row_select_pipe['cru_value_2'] != null) { ?>
                    <tr>
                        ...
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['cru_value_2']; ?></td>
                    </tr>
                <?php } ?>
                ...
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                        <?php echo $row_select_pipe['cru_value']; ?></td>
                </tr>
        ...
        if ($row_select_pipe['imp_value'] != "" && $row_select_pipe['imp_value'] != null && $row_select_pipe['imp_value'] != "0") { ?>
            ...
            <table align="center"
                ...
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card
                        No:&nbsp;<?php echo $job_no; ?></td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
                        colspan="4">&nbsp;Test:&nbsp;IMPACT VALUE</td>
                </tr>
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample
                        Description:&nbsp;<?php echo $sample_de; ?></td>
            ...
            <table align="center" style="width: 95%;text-align: center;border: 1px solid;" cellspacing="5px"
                cellpadding="5px" bordercolor="black">
                <tr>
                    <td style="font-family: 'Calibri';font-size: 25px;font-weight: bold;" colspan="7"> (AGGREGATE IMPACT
                        VALUE)</td>
                </tr>
            </table>
            <br>
            <table align="center" style="width: 95%;" cellpadding="10px">
                <tr>
                    <td style="font-family: 'calibri';font-size: 16px;font-weight: bold;text-align:center;"> Aggregate
                        Impact Value [IS 2386 (Part-4)-1963 RA 2016]</td>
                </tr>
            ...
            <table align="center" style="width: 95%;text-align: center;border-bottom:1px solid;" cellspacing="0"
                ...
                <tr>
                    ...
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        Wt. Of Aggregate before Impact (gm)</td>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        Wt. of Aggregate retained on 2.36 mm Sieve (gm)</td>
                    <td
                ...
                <?php if ($row_select_pipe['imp_value_1'] != "" && $row_select_pipe['imp_value_1'] != null) { ?>
                    <tr>
                        ...
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['imp_w_m_a_1']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['imp_w_m_b_1']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['imp_w_m_c_1']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['imp_value_1']; ?></td>
                    </tr>
                <?php }
                if ($row_select_pipe['imp_value_2'] != "" && $row_select_pipe['imp_value_2'] != null) { ?>
                    <tr>
                        ...
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['imp_w_m_a_2']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['imp_w_m_b_2']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['imp_w_m_c_2']; ?>
                        </td>
                        <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                            <?php echo $row_select_pipe['imp_value_2']; ?></td>
                    </tr>
                <?php } ?>
                <?php //} if ($row_select_pipe['cum_wt_gm_5'] != "" && $row_select_pipe['cum_wt_gm_5'] != null && $row_select_pipe['cum_wt_gm_5'] != "0") { ?>
                <tr>
                    <td style="border-top: 1px solid;border-left: 1px solid;" colspan="6">AVERAGE</td>
                    <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
                        <?php echo $row_select_pipe['imp_value']; ?></td>
                </tr>
        ...
        <?php }
        if ($row_select_pipe['fines_value'] != "" && $row_select_pipe['fines_value'] != null && $row_select_pipe['fines_value'] != "0") { ?>
            <div class="pagebreak"></div>
            <br>
            <br>
            <br>
            ...
            <table align="center"
                ...
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card
                        No:&nbsp;<?php echo $job_no; ?></td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
                        colspan="4">&nbsp;Test:&nbsp;(10% Fine Value)</td>
                </tr>
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample
                        Description:&nbsp;<?php echo $sample_de; ?></td>
            ...
            <table align="center" style="width: 95%;text-align: center;border: 1px solid;" cellspacing="5px"
                cellpadding="5px" bordercolor="black">
                <tr>
                    <td style="font-family: 'Calibri';font-size: 25px;font-weight: bold;" colspan="7">(TEN PERCENT FINES
                        VALUE) IS: 2386 (Part-4)</td>
                </tr>
            </table>
            <br>
            ...
            <table align="center" style="width: 95%;text-align: center;border-bottom:1px solid;" cellspacing="0"
                ...
                <tr>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">
                        Weight of surface Dry Sample passing 12.5 mm and retained on 10.0mm IS Sieve A(gm)</td>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['f_a_1']; ?></td>
                    <td
                        style="width:16%;border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['f_a_2']; ?></td>
                </tr>
                <tr>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">
                        Penetration of plunger 10 min. of about 15 mm for rounder/Partial rounder aggregate 20 mm for normal
                        crushed agg. 24 mm for honey agg.</td>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['fine_1']; ?></td>
                    <td
                        style="width:16%;border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['fine_4']; ?></td>
                </tr>
                <tr>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">
                        Load at required Penetration (X) Tonnes</td>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['fine_2']; ?></td>
                    <td
                        style="width:16%;border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['fine_5']; ?></td>
                </tr>
                <tr>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">
                        Wt. of fraction passing by IS Sieve, After the test B gm</td>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['f_c_1']; ?></td>
                    <td
                        style="width:16%;border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['f_c_2']; ?></td>
                </tr>
                <tr>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">
                        % of fraction passing by IS Sieve 2.36= )B/A*100</td>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['f_d_1']; ?></td>
                    <td
                        style="width:16%;border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['f_d_2']; ?></td>
                </tr>
                <tr>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">
                        Mean % of fine from two test (Y)</td>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['fine_3']; ?></td>
                    <td
                        style="width:16%;border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['fine_6']; ?></td>
                </tr>
                <tr>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">
                        Load required foe 10 Percent fines in tones</td>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['f_b_1']; ?></td>
                    <td
                        style="width:16%;border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['f_b_2']; ?></td>
                </tr>
                <tr>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold;text-align:left;">
                        Average</td>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        <?php echo $row_select_pipe['avg_f_d']; ?></td>
                    <td
                        style="width:16%;border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold">
                        <?php echo $row_select_pipe['avg_f_c']; ?></td>
                </tr>
                <tr>
                    <td
                        style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold;text-align:left;">
                        10 % Fine Value = 14 x X / Y + 4</td>
                    <td style="width:14%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold; border-right:1px solid;"
                        colspan="2"><?php echo $row_select_pipe['fines_value']; ?></td>
                </tr>
            </table>
            <br>
            <br>
        ...
        <?php }
        if ($row_select_pipe['avg_wom'] != "" && $row_select_pipe['avg_wom'] != null && $row_select_pipe['avg_wom'] != "0") { ?>
            <div class="pagebreak"></div>
            <br>
            <br>
            <br>
            ...
            <table align="center"
                ...
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card
                        No:&nbsp;<?php echo $job_no; ?></td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
                        colspan="4">&nbsp;Test:&nbsp;Bulk Density (Compacted)</td>
                </tr>
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample
                        Description:&nbsp;<?php echo $sample_de; ?></td>
            ...
            <table align="center" style="width: 95%;text-align: center;border: 1px solid;" cellspacing="5px"
                cellpadding="5px" bordercolor="black">
                <tr>
                    <td style="font-family: 'Calibri';font-size: 25px;font-weight: bold;" colspan="7">BULK DENSITY
                        (COMPACTED)</td>
                </tr>
            </table>
            <br>
        ...
        <?php }
        if ($row_select_pipe['avg_wom1'] != "" && $row_select_pipe['avg_wom1'] != null && $row_select_pipe['avg_wom1'] != "0") { ?>
            <div class="pagebreak"></div>
            <br>
            <br>
            <br>
            ...
            <table align="center"
                ...
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card
                        No:&nbsp;<?php echo $job_no; ?></td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
                        colspan="4">&nbsp;Test:&nbsp;Bulk Density (Loose)</td>
                </tr>
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample
                        Description:&nbsp;<?php echo $sample_de; ?></td>
            ...
            <table align="center" style="width: 95%;text-align: center;border: 1px solid;" cellspacing="5px"
                cellpadding="5px" bordercolor="black">
                <tr>
                    <td style="font-family: 'Calibri';font-size: 25px;font-weight: bold;" colspan="7">BULK DENSITY (LOOSE)
                    </td>
                </tr>
            </table>
            <br>
        ...
        if ($row_select_pipe['fi_index'] != "" && $row_select_pipe['fi_index'] != null && $row_select_pipe['fi_index'] != "0") { ?>
            ...
            <table align="center" style="width: 95%;text-align: center;border: 1px solid;" cellspacing="5px"
                cellpadding="5px" bordercolor="black">
                <tr>
                    <td style="font-family: 'Calibri';font-size: 25px;font-weight: bold;" colspan="7">FLAKINESS & ELONGATION
                        INDEX</td>
                </tr>
            </table>
            <table align="center" style="width: 95%;" cellpadding="5px">
                <tr>
                    <td style="font-family: 'calibri';font-size: 14px;font-weight: bold;text-align:left;"> Flakiness Index
                        (IS 2386 (Part-1)-RA 2016</td>
                </tr>

            </table>

            <table align="center"
                style="width: 95%;text-align: center;font-family: 'calibri';border: 1px solid;font-size: 12px;"
                cellspacing="0" cellpadding="5px">
                <tr>
                ...
                <tr>
                    ...
                    <td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['flk_xy1']; ?>
                    </td>
                ...
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['flk_xy2']; ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['flk_xy3']; ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['flk_xy4']; ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['flk_xy5']; ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['flk_xy6']; ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['flk_xy7']; ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['flk_xy8']; ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['flk_xy9']; ?>
                    </td>
                </tr>
            ...
            <table align="center" style="width: 95%;" cellpadding="5px">
                <tr>
                    <td style="font-family: 'calibri';font-size: 14px;font-weight: bold;font-size: 12px;text-align:left;">
                        Elongation Index (IS 2386 (Part-1)-RA 2016</td>
                </tr>
            ...
            <table align="center"
                ...
                <tr>
                    ...
                    <td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['elo_xy1']; ?>
                    </td>
                ...
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['elo_xy2']; ?>
                    </td>
                </tr>
                <tr>
                    <td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['s13']; ?></td>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['elo_xy3']; ?>
                    </td>
                </tr>
                <tr>
                    <td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['s14']; ?></td>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['elo_xy4']; ?>
                    </td>
                </tr>
                <tr>
                    <td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['s15']; ?></td>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['elo_xy5']; ?>
                    </td>
                </tr>
                <tr>
                    <td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['s16']; ?></td>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['elo_xy6']; ?>
                    </td>
                </tr>
                <tr>
                    <td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['s17']; ?></td>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['elo_xy7']; ?>
                    </td>
                </tr>
                <tr>
                    <td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['s18']; ?></td>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['elo_xy8']; ?>
                    </td>
                </tr>
                <tr>
                    <td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['s19']; ?></td>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['elo_xy9']; ?>
                    </td>
                </tr>
        ...
        <?php }
        if ($row_select_pipe['dele_1_1'] != "" && $row_select_pipe['dele_1_1'] != null && $row_select_pipe['dele_1_1'] != "0") { ?>
            <div class="pagebreak"></div>
            <br>
            <br>
            <br>
            ...
            <table align="center"
                ...
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card
                        No:&nbsp;<?php echo $job_no; ?></td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
                        colspan="4">&nbsp;Test:&nbsp;Deleterious Material</td>
                </tr>
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample
                        Description:&nbsp;<?php echo $sample_de; ?></td>
            ...
            <table align="center" style="width: 95%;text-align: center;border-bottom:1px solid;" cellspacing="0"
                ...
                <tr>
                    <td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold"
                        colspan="2"> DELETERIOUS MATERIAL AS PER IS: 2386 P-1&2 </td>
                </tr>
                <tr>
                    <td
                        style="width:80%;border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">
                        (I) Weight of Sample in gm (A)=</td>
                    <td
                        style="width:20%;border-top: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['dele_1_1']; ?></td>
                </tr>
                <tr>
                    <td style="border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">Weight of
                        Washed Retained Sample on 75 micron IS Sieve (after Oven dried) in gm (B)=</td>
                    <td style="border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['dele_1_2']; ?></td>
                </tr>
                <tr>
                    <td style="border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">% of Material
                        finer than 75 micron IS Sieve (A-B)x100/A=</td>
                    <td style="border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['dele_1_4']; ?></td>
                </tr>
                <tr>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">
                        (II) Weight of Oven Sample in gm (A)=</td>
                    <td style="border-top: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['dele_2_1']; ?></td>
                </tr>
                <tr>
                    <td style="border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">Weight of
                        Sample after removed of clay lump in gm (B)=</td>
                    <td style="border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['dele_2_2']; ?></td>
                </tr>
                <tr>
                    <td style="border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">% of clay &
                        Lump (A-B) X 100 / A=</td>
                    <td style="border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                ...
                <tr>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">
                        (III) Weight of Sample in gm (A)=</td>
                    <td style="border-top: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['dele_3_1']; ?></td>
                </tr>
                <tr>
                    <td style="border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">Weight of
                        decanted pieces in gm (B)=</td>
                    <td style="border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['dele_3_2']; ?></td>
                </tr>
                <tr>
                    <td style="border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">% of coal &
                        lignite (B/A)X100=</td>
                    <td style="border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo $row_select_pipe['dele_3_3']; ?></td>
                </tr>
                <tr>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;text-align:left;">
                        (IV) Total Deleterious material</td>
                    <td style="border-top: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 15px;">
                        <?php echo number_format(($row_select_pipe['dele_1_4'] + $row_select_pipe['dele_2_3'] + $row_select_pipe['dele_3_3']), 2); ?>
                    </td>
                </tr>
            </table>
            <br>
        ...
        if ($row_select_pipe['sp_specific_gravity'] != "" && $row_select_pipe['sp_specific_gravity'] != null && $row_select_pipe['sp_specific_gravity'] != "0") { ?>
            ...
            <table align="center"
                ...
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card
                        No:&nbsp;<?php echo $job_no; ?></td>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
                        colspan="4">&nbsp;Test:&nbsp;Specific Gravity & Water Absorption</td>
                </tr>
                <tr>
                    <td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample
                        Description:&nbsp;<?php echo $sample_de; ?></td>
            ...
            <table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="5px">
                <tr>
                    <td style="width:30%;border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;"
                        colspan="2"></td>
                    <td
                        style="width:10%;border-top: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 17px;font-weight: bold;">
                        Unit</td>
                    <td
                        style="width:15%;border-top: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 17px;font-weight: bold;">
                        1</td>
                    <td
                        style="width:15%;border-top: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 17px;font-weight: bold;">
                        2</td>
                ...
                <tr>
                    <td
                        ...
                        Mass of Oven Dry Aggregate in Air</td>
                ...
                <tr>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;">
                        Mass of SSD Aggregate in Air</td>
                ...
                <tr>
                    <td
                        style="border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;">
                        Mass of Saturated Aggregate in Water</td>
                ...
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;">
                        <?php echo $row_select_pipe['sp_wt_st_1'] - $row_select_pipe['sp_w_sur_1']; ?></td>
                    <td style="border-top: 1px solid;border-right: 1px solid;">
                        <?php echo $row_select_pipe['sp_wt_st_2'] - $row_select_pipe['sp_w_sur_2']; ?></td>
                    <td style="border-top: 1px solid;border-right: 1px solid;"></td>
                </tr>
                <tr>
                    <td
                ...
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"></td>
                    <td style="border-top: 1px solid;border-right: 1px solid;">
                        <?php echo number_format(($row_select_pipe['sp_wt_st_1'] / ($row_select_pipe['sp_wt_st_1'] - $row_select_pipe['sp_w_sur_1'])), 2); ?>
                    </td>
                    <td style="border-top: 1px solid;border-right: 1px solid;">
                        <?php echo number_format(($row_select_pipe['sp_wt_st_2'] / ($row_select_pipe['sp_wt_st_2'] - $row_select_pipe['sp_w_sur_2'])), 2); ?>
                    </td>
                    <td style="border-top: 1px solid;border-right: 1px solid;">
                        <?php //echo $row_select_pipe['sp_specific_gravity']; ?></td>
                </tr>
                <tr>
                    ...
                    <td style="border-top: 1px solid;border-right: 1px solid;"></td>
                    <td style="border-top: 1px solid;border-right: 1px solid;">
                        <?php echo number_format(($row_select_pipe['sp_w_s_1'] / ($row_select_pipe['sp_w_s_1'] - $row_select_pipe['sp_w_sur_1'])), 2); ?>
                    </td>
                    <td style="border-top: 1px solid;border-right: 1px solid;">
                        <?php echo number_format(($row_select_pipe['sp_w_s_2'] / ($row_select_pipe['sp_w_s_2'] - $row_select_pipe['sp_w_sur_2'])), 2); ?>
                    </td>
                    <td style="border-top: 1px solid;border-right: 1px solid;"><?php //echo $row_select_pipe['r_sam']; ?>
                    </td>
                </tr>
                <tr>
                    <td
