			...
			<body>
				...
				$select_tiles_query = "select * from stone_dust_below_2_36_mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
					...
					?>
						...
						<table align="center" width="90%" class="test" border="1px" height="40%">
							...
							<tr>
								...
								<td colspan="3">
									<center><b>Observation I</b></center>
								</td>
								<td colspan="3">
									<center><b>Observation II</b></center>
								</td>
								<td colspan="3">
									<center><b>Observation III</b></center>
								</td>
								<td colspan="3">
							...
							<tr>
								...
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_1']; ?></center>
								</td>
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_21']; ?></center>
								</td>
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_31']; ?></center>
								</td>
								<td colspan="3">
									<center></center>
								</td>
							...
							<tr>
								...
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_2']; ?></center>
								</td>
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_22']; ?></center>
								</td>
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_32']; ?></center>
								</td>
								<td colspan="3">
									<center></center>
								</td>
							...
							<tr>
								...
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_3']; ?></center>
								</td>
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_23']; ?></center>
								</td>
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_33']; ?></center>
								</td>
								<td colspan="3">
									<center></center>
								</td>
							...
							<tr>
								...
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_4']; ?></center>
								</td>
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_24']; ?></center>
								</td>
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_34']; ?></center>
								</td>
								<td colspan="3">
									<center></center>
								</td>
							...
							<tr>
								...
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_5']; ?></center>
								</td>
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_25']; ?></center>
								</td>
								<td colspan="3">
									<center><?php echo $row_select_pipe['strip_35']; ?></center>
								</td>
								<td colspan="3">
									<center></center>
								</td>
							...
							<tr>
								...
								<td colspan="9">
									<center><?php echo $row_select_pipe['stripping_value']; ?></center>
								</td>
								<td colspan="3">
									<center></center>
								</td>
					...
					?>
						...
						<table align="center" width="90%" class="test" border="1px" height="40%">
							...
							<tr>
								...
								<td>
									<center>Condition of aggregate at the time of test (Oven dry/Saturated/ Given moisture content )</center>
								</td>
								<td>
									<center>Volume of mould (Lit.) “V”</center>
								</td>
								<td>
									<center>Weight of empty mould (Kg) W1</center>
								</td>
								<td>
									<center>Weight of mould + Sample (loose) Kg W2</center>
								</td>
								<td>
									<center>Weight of mould +Sample(Compacted) 25 strokes in each of 3 layer (Kg) W3</center>
								</td>
								<td>
									<center>Bulk Density (Loose)</center>
								</td>
								<td>
									<center>Bulk Density (Compacted) Kg/l</center>
								</td>
							...
							<tr>
								...
								<td>
									<center><?php echo $row_select_pipe['den_lab_1']; ?></center>
								</td>
								<td>
									<center><?php echo $row_select_pipe['ov_1']; ?></center>
								</td>
								<td>
							...
							<tr>
								...
								<td>
									<center><?php echo $row_select_pipe['den_lab_2']; ?></center>
								</td>
								<td>
									<center><?php echo $row_select_pipe['ov_2']; ?></center>
								</td>
								<td>
