...
<body>
	...
	<page size="A4">
		...
		<table align="center" style="width: 92%;text-align: left;" cellspacing="0" cellpadding="10px">
			...
			<tr>
				<td style="font-weight: bold;"> Area Calculation: A<sub>sw</sub> = <u> 20000 M<sub>sp</sub></u>
					mm<sup>2</sup> <br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;M<sub>std</sub>
				</td>
			</tr>
		...
		<table align="center" style="width: 92%;text-align: center;" cellspacing="0" cellpadding="5px">
			<tr>
				...
				<td
					...
					LOAD (kN)</td>
				<td
					style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold;border-right: 1px solid;">
					COMPRESSIVE STRENGTH (N/mm<sup>2</sup>)</td>
			</tr>
			<tr>
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-weight: bold;"
					colspan="3">AVERAGE VALUE </td>
				<td
					style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;border-right: 1px solid;"><?php
					$com_values = [
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;font-family: 'calibri';font-size: 15px;font-weight: bold;border-right: 1px solid;"
					colspan="4">As Per IS 15658 : 2006 from Table No. 5 Correction factor
					for&nbsp;&nbsp;<u><?php echo $row_select_pipe['factor']; ?></u>&nbsp;&nbsp;mm <br>
					thick&nbsp;&nbsp;<u> <?php echo $row_select_pipe['thick']; ?></u>&nbsp;&nbsp;Block is&nbsp;&nbsp;<u>
						<?php echo $paver_shape; ?></u>&nbsp;&nbsp;</td>

			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid; font-family: 'calibri';font-size: 15px;font-weight: bold;"
					colspan="3"> CORRECTED VALUE(Average Value × C.F)</td>
				<td
					style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;border-right: 1px solid;border-right: 1px solid;">
					<?php echo $row_select_pipe['avg_corr']; ?></td>
			</tr>
		</table>
		<br>
		<br>
		...
		<table align="center"
			...
			<tr>
				<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Job Card
						No:&nbsp;</b><?php echo $_GET['job_no']; ?></td>
				<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
					colspan="4"><b>&nbsp;Test:&nbsp;</b>DIMENSION HEIGHT-LENGHT-WIDTH</td>
			</tr>
			<tr>
				<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Sample
						Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?></td>
		...
		<table align="center"
			...
			<tr>
				<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Job Card
						No:&nbsp;</b><?php echo $_GET['job_no']; ?></td>
				<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
					colspan="4"><b>&nbsp;Test:&nbsp;</b>WATER ABSORPTION</td>
			</tr>
			<tr>
				<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Sample
						Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?></td>
