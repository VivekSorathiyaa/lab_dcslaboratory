			...
			<body>
				...
				$select_tiles_query = "select * from dbm_26_5_0_075_mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
				...
				<page size="A4" layout="landscape">
					...
					?>
						<table align="center" width="90%" class="test" border="1px" height="30%">
							...
							<tr>
								<td colspan="4">
									<center><?php echo $row_select_pipe['sieve_9']; ?></center>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['cum_wt_gm_9']; ?></center>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['ret_wt_gm_9']; ?></center>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['cum_ret_9']; ?>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['pass_sample_9']; ?>
								</td>
							</tr>
