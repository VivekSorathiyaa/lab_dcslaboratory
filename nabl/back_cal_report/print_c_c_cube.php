					...
					<td>
						...
						<table align="center"
							...
							<tbody>
								...
								<tr>
									<td
										style="text-align: center;border-top: 1px solid;font-weight: bold;border-right: 1px solid;font-family: 'calibri';font-size: 17px;">
										Concrete Cubes</td>
				...
				<tr>
					<td>
						...
						<table align="center" style="width: 100%;">
							...
							<tr>
								<td style="font-family: 'calibri';font-size: 18px;font-weight: bold;text-align: center;">
									<u><?php echo $row_select_pipe['day1']; ?></u>&nbsp;&nbsp;Days Testing Compressive
									Strength of Concrete Cubes of
									Grade/Ratio&nbsp;&nbsp;<u><?php echo $row_select_pipe['grade1']; ?></u>&nbsp;&nbsp;</td>
							</tr>
						...
						<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="5px">
							<tr>
								...
								<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">Date of
									<br>Casting</td>
								<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">Date of
									<br>Testing</td>
								<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">X – Section
									<br>Area (mm<sup>2</sup>)</td>
								<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">Weight <br>of
									Cube <br>(Kg)</td>
								<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">Failure <br>Load
									(kN)</td>
								<td
									style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;border-right: 1px solid;">
									Compressive <br>Strength <br>(N/mm<sup>2</sup>)</td>
							</tr>
							<?php $count = 1;
							$cnt = 1;
							...
							while ($row_select_pipe1 = mysqli_fetch_array($result_tiles_select15)) {
								...
								<tr>
									...
									<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;" rowspan="3">
										<?php echo date('d-m-Y', strtotime($row_select_pipe1['caste_date1'])); ?></td>
									<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;" rowspan="3">
										<?php echo date('d-m-Y', strtotime($row_select_pipe1['test_date1'])); ?></td>
									<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">
										<?php echo $row_select_pipe1['cross_1']; ?></td>
									<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">
										<?php echo $row_select_pipe1['mass_1']; ?></td>
									<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">
										<?php echo $row_select_pipe1['load_1']; ?></td>
									<td
										style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;border-right: 1px solid;">
										<?php echo $row_select_pipe1['comp_1']; ?></td>
								</tr>
								<tr>
									<td style="border-top: 1px solid;border-left: 1px solid;">2.</td>
									<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">
										<?php echo $row_select_pipe1['cross_2']; ?></td>
									<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">
										<?php echo $row_select_pipe1['mass_2']; ?></td>
									<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">
										<?php echo $row_select_pipe1['load_2']; ?></td>
									<td
										style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;border-right: 1px solid;">
										<?php echo $row_select_pipe1['comp_2']; ?></td>
								</tr>
								<tr>
									<td style="border-top: 1px solid;border-left: 1px solid;">3.</td>
									<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">
										<?php echo $row_select_pipe1['cross_3']; ?></td>
									<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">
										<?php echo $row_select_pipe1['mass_3']; ?></td>
									<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">
										<?php echo $row_select_pipe1['load_3']; ?></td>
									<td
										style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;border-right: 1px solid;">
										<?php echo $row_select_pipe1['comp_3']; ?></td>
								</tr>
								<tr>
									<td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid; font-weight: bold;"
										colspan="6">Average Compressive Strength (N/mm<sup>2</sup>)</td>
									<td
										style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;border-bottom: 1px solid; font-weight: bold;">
										<?php echo $row_select_pipe1['avg_com_s_1']; ?></td>
								</tr>
								<?php
