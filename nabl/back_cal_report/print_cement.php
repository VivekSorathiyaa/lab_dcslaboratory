...
<body>
    ...
    <table width="92%" cellspacing="0"
        ...
        <tr>
            ...
            <td style="border: 1px solid black;" colspan="2">
                ...
                <b>Regd. Office : VPO Taragarh , Near Taragarh Palace, Tehsil Baijnath, Distt. Kangra (H.P) (176081)</b><br>
    ...
    <br>
    <table width="92%" cellspacing="0"
    style="margin-left: auto; margin-right: auto; border:none; text-align:left;">
    <tr>
    ...
    style="margin-left: auto; margin-right: auto; border:none; text-align:left;">
    <tr>
        <td>2) Setting Time (Min.) :- IS 4031 (Part-5)&nbsp; &nbsp; &nbsp; &nbsp;  Water = 0.85 x P = (0.85 * 4 * <?php echo $row_select_pipe['final_consistency'];?>)&nbsp; &nbsp; <?php echo $row_select_pipe['set_wtr'];?> &nbsp; gm</td>
    </tr>
    </table>
    <table width="92%"  cellspacing="0"
    style="margin-left: auto; margin-right: auto; border:1px solid black; text-align:left;">
    <tr>
        <td style="border: 1px solid black;">Starting Time:- <?php echo $row_select_pipe['hr_a'];?> <br>Initial:- <?php echo $row_select_pipe['hr_b'];?> - <?php echo $row_select_pipe['initial_time'];?> min<br>Final:- <?php echo $row_select_pipe['hr_c'];?> - <?php echo $row_select_pipe['final_time'];?> min</td>
    </tr>
    <tr>
        <td style="border: 1px solid black;">Initial Setting Time:- <?php echo $row_select_pipe['initial_time'];?> min</td>
    </tr>
    <tr>
        <td style="border: 1px solid black;">Final Setting Time:- <?php echo $row_select_pipe['final_time'];?> min</td>
    </tr>
    </table>
    <br>
    <table width="92%" cellspacing="0"
    ...
    <br>
	 ...
	 <table align="center" width="100%"  style="font-size:16px;height:auto;font-family : Calibri;border-collapse: collapse;">
						<!--<tr>
						...
						<tr>
							<td style="font-weight: bold;text-align: center;padding: 20px 5px 5px;border: 0;width:7%;">Finess (m<sup>2</sup>/Kg) = Factor x K x √to / P = (521.08 * <?php echo $row_select_pipe['constant_k_1'];?> * <?php echo $row_select_pipe['fines_val1'];?>) / (<?php echo $row_select_pipe['fines_val2'];?>) = <u style="text-underline-offset:4px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row_select_pipe['ss_area']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u>&nbsp;&nbsp; m<sup>2</sup>/Kg</td>
						</tr>
				...
				<tr>
					<td>
						...
						<table align="center" width="100%"  style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 2px solid;border-right: 2px solid;">
							...
							<?php }  if ($row_select_pipe['com_2'] != "" && $row_select_pipe['com_2'] != "0" && $row_select_pipe['com_2'] != null) {?>
							<tr>
							...
							<?php }  if ($row_select_pipe['com_3'] != "" && $row_select_pipe['com_3'] != "0" && $row_select_pipe['com_3'] != null) {?>
							<tr>
							...
							<?php }  if ($row_select_pipe['com_4'] != "" && $row_select_pipe['com_4'] != "0" && $row_select_pipe['com_4'] != null) {?>
							<tr>
							...
							<?php }  if ($row_select_pipe['com_5'] != "" && $row_select_pipe['com_5'] != "0" && $row_select_pipe['com_5'] != null) {?>
							<tr>
							...
							<?php }  if ($row_select_pipe['com_6'] != "" && $row_select_pipe['com_6'] != "0" && $row_select_pipe['com_6'] != null) {?>
							<tr>
							...
							<?php }  if ($row_select_pipe['com_7'] != "" && $row_select_pipe['com_7'] != "0" && $row_select_pipe['com_7'] != null) {?>
							<tr>
							...
							<?php }  if ($row_select_pipe['com_8'] != "" && $row_select_pipe['com_8'] != "0" && $row_select_pipe['com_8'] != null) {?>
							<tr>
							...
							<?php }  if ($row_select_pipe['com_9'] != "" && $row_select_pipe['com_9'] != "0" && $row_select_pipe['com_9'] != null) {?>
							<tr>
	...
	<?php } ?>
		...
		<tr>
			...
			<tr style="text-align:center;height:25px;">
				...
				echo "-";}else{echo number_format(($row_select_pipe['alo1']/$row_select_pipe['feo3']),2);}?></td>										
