					...
					<table align="center"
						...
						<tr>
							<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">
								&nbsp;Job Card No:&nbsp;<?php echo $_GET['job_no']; ?></td>
							<td class="report-cell"
								style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
								&nbsp;Test:&nbsp;Dimension,Compressive,Water Absorption,Efflorescence</td>
						</tr>
						<tr>
							<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4">
								&nbsp;Sample Description:&nbsp;<?php echo $row_select_pipe['s_des']; ?></td>
							<td class="report-cell"
								style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
								&nbsp;&nbsp;Method:&nbsp;IS 13757,
								&nbsp;IS 3495 (P-1)
						...
						<tr>
							<td class="report-cell" style=" text-align: left;border-top: 1px solid;" colspan="3">
								&nbsp;Sample Qty:&nbsp;<?php echo $row_select_pipe['no_of_brick']; ?></td>
							<td class="report-cell"
								style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="2">
								&nbsp;Residual Sample:&nbsp;<?php echo $row_select_pipe['r_sam']; ?></td>
							<td class="report-cell"
								style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="3">
								&nbsp;Sample Retention:&nbsp;<?php echo $row_select_pipe['s_ret']; ?> </td>
						</tr>
					</table>
					<br>
				</td>
			...
			<tr>
				<td>
					...
					<table align="center" style="width: 95%;">
						<tr>
							<td style="font-family: 'calibri';font-size: 17px;font-weight: bold;padding: 0 30px;"
								colspan="10">1.0 Dimension Test of Brick</td>
						</tr>
					</table>
					<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td
								style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;">
								&nbsp;(i)</td>
							<td
								style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;text-align: left;">
								&nbsp;(ii)</td>
							<td
								style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;border-right: 1px solid;">
								Avg</td>
						</tr>
						<tr>
							<td
					...
					<table align="center" style="width: 95%;">
						<tr>
							<td style="font-family: 'calibri';font-size: 17px;font-weight: bold;padding: 0 30px;"
								colspan="10">2.0 Compressive Test of Bricks</td>
						</tr>
					</table>
					<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0">
						<tr>
						...
						<tr>
							<td
								...
								Length mm</td>
							<td
								style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;vertical-align: top;">
								Width mm</td>
							<td
								style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;vertical-align: top;">
								Area mm2</td>
						...
						<tr>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_l_1']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_b_1']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_area_1']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_load_1']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
								<?php echo $row_select_pipe['com_1']; ?></td>
						</tr>
						<tr>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_l_2']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_b_2']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_area_2']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_load_2']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
								<?php echo $row_select_pipe['com_2']; ?></td>
						</tr>
						<tr>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_l_3']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_b_3']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_area_3']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_load_3']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
								<?php echo $row_select_pipe['com_3']; ?></td>
						</tr>
						<tr>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_l_4']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_b_4']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_area_4']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_load_4']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
								<?php echo $row_select_pipe['com_4']; ?></td>
						</tr>
						<tr>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_l_5']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_b_5']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_area_5']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_load_5']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
								<?php echo $row_select_pipe['com_5']; ?></td>
						</tr>
						<tr>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_l_6']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_b_6']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_area_6']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['com_load_6']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
						...
						<tr>
							...
							<td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;"></td>
							<td
								style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;font-weight: bold;">
								Avg.</td>
							<td
					...
					<table align="center" style="width: 95%;">
						<tr>
							<td style="font-family: 'calibri';font-size: 17px;font-weight: bold;padding: 0 30px;"
								colspan="10">3.0 Water Absorption </td>
						</tr>
					</table>
					<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0">
						<tr>
						...
						<tr>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w1_1']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w2_1']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
						...
						<tr>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w1_2']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w2_2']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
						...
						<tr>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w1_3']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w2_3']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
						...
						<tr>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w1_4']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w2_4']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
						...
						<tr>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w1_5']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w2_5']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
						...
						<tr>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w1_6']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w2_6']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;">
								<?php echo $row_select_pipe['wtr_w2_6'] - $row_select_pipe['wtr_w1_6']; ?></td>
							<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					...
					<table align="center" style="width: 95%;">
						<tr>
							<td style="font-family: 'calibri';font-size: 17px;font-weight: bold;padding: 0 30px;"
								colspan="10">4.0 Efflorescence =&nbsp;<?php echo $row_select_pipe['rbt_efflo1']; ?></td>
						</tr>
					</table>
					<br>
					<br>
