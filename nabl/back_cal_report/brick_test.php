...
$user_name = "select * from `multi_login` WHERE `id`='$tested_by'";
    ...
    <table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0" >
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;text-align: center;font-family: 'calibri';font-size: 17px;font-weight: bold;" colspan="4">Dimension Test Of Brick As Per IS:1077:1992/R2016</td>
    ...
    <table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0" >
		...
		<tr>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_l_6'];?></td>
    ...
    <table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0" >
        ...
        <tr>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w1_6'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_6'];?></td>
            <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_6'] - $row_select_pipe['wtr_w1_6'];?></td>
