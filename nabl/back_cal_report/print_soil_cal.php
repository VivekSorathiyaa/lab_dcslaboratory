...
<body>
	...
	for ($a = 0; $a < $page_cont; $a++) {
		...
		<page size="A4">
			...
			<br>
			<table align="center"
				style="width: 94%;text-align: center;border:1px solid black;font-family: 'calibri';font-size: 12px"
				...
				<tr>
					...
					<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
						colspan="4">&nbsp;Test:&nbsp;FIELD DRY DENSITY TEST</td>
				</tr>
				<tr>
			...
			<table align="center" width="100%" class="test" style="font-family:book-Antiqua;font-size:12px;">
				<tr>
					<td width="100%">
						<table align="center" width="92%" class="test"
							style="height:auto;width:94%;border:1px solid black;">
							<tr style="text-align:center;height:20px;">
								...
								<td style="border:1px solid black;width:13%;border-right:0px solid black;align:center;">
									<b>Test Result</b></td>
								<?php
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td
										style="border: 1px solid black;width:10%;border-bottom: 1px solid black;border-left: 1px solid black;">
										<?php echo $count; ?></td>
								<?php } ?>
							...
							<tr style="text-align:center;">
								...
								<td style="border:1px solid black;text-align:left">Mean Weight of Sand in Cone(of pouring
									cyclinder) W2 in gram </td>
								<?php
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo $row_select_pipe21['c1']; ?></b></td>
								<?php } ?>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;"><b>2</b></td>
								<td style="border:1px solid black;text-align:left">Volume of Callibrating Cyclinder (V) Cm3
								</td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo $row_select_pipe21['c2']; ?></b></td>
								<?php } ?>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;"><b>3</b></td>
								<td style="border:1px solid black;text-align:left">Weight of Sand + Cyclinder before pouring
									into callibrating Container (W1) in gm</td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								// $coming_row = mysqli_num_rows($result_tiles_select1);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo $row_select_pipe21['c3']; ?></b></td>
								<?php } ?>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;"><b>4</b></td>
								<td style="border:1px solid black;text-align:left">Mean Weight of Sand = Cyclinder after
									pouring into calibrating container (W3) in gm </td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								// $coming_row = mysqli_num_rows($result_tiles_select1);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo $row_select_pipe21['c4']; ?></b></td>
								<?php } ?>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;"><b>5</b></td>
								<td style="border:1px solid black;text-align:left">Weight of sand to fill calibrating
									cylinder. (Wa = W1 - W2 - W3) in gm.</td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								// $coming_row = mysqli_num_rows($result_tiles_select1);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo $row_select_pipe21['c5']; ?></b></td>
								<?php } ?>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;"><b>6</b></td>
								<td style="border:1px solid black;text-align:left">Bulk density of sand Ys = (Wa /V) gm/cm3
								</td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo number_format($row_select_pipe21['c6'], 2); ?></b></td>
								<?php } ?>
							</tr>
				...
				<tr>
					...
					<td style="font-size:14px;padding-top:1px;padding-top:1%;padding-bottom:1.5%">
						<center><b><u>Determination of Density</u></b></center>
					</td>
				...
				<tr>
					...
					<td>
						...
						<table align="center" width="94%" class="test"
							style="height:auto;width:94%;border:1px solid black;">
							<tr style="text-align:center;height:20px;">
							...
							<tr style="text-align:center;">
								...
								while ($row_select_pipe211 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td
										style="border: 1px solid black;width:13%;border-bottom: 1px solid black;border-left: 1px solid black;">
										<B><?php echo $cnt; ?></b></td>
								<?php } ?>
							</tr>
							<tr style="text-align:center">
								<td style="border: 1px solid black;">7</td>
								<td style="border: 1px solid black;text-align:left;border-left: 1px solid black;">
									Determination number</td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								// $coming_row = mysqli_num_rows($result_tiles_select1);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border: 1px solid black;border-left: 1px solid black;">
										<?php if ($row_select_pipe21['layer_mt'] != "" && $row_select_pipe21['layer_mt'] != "0" && $row_select_pipe21['layer_mt'] != null) {
											echo $row_select_pipe21['layer_mt'];
										} else {
											echo " <br>";
										} ?>
									</td>
							...
							<tr style="text-align:center;">
								...
								<td style="border:1px solid black;text-align:left">Weight of wet material from hole (Ww)
								</td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo $row_select_pipe21['d1']; ?></b></td>
								<?php } ?>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;"><b>9</b></td>
								<td style="border:1px solid black;text-align:left">Weight of sand (+ cylinder) before
									pouring into hole (W1) in gm.</td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								// $coming_row = mysqli_num_rows($result_tiles_select1);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo $row_select_pipe21['d2']; ?></b></td>
								<?php } ?>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;"><b>10</b></td>
								<td style="border:1px solid black;text-align:left">Weight of sand (+ cylinder) after pouring
									into hole and cone (W4) in gm.</td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								// $coming_row = mysqli_num_rows($result_tiles_select1);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo $row_select_pipe21['d3']; ?></b></td>
								<?php } ?>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;"><b>11</b></td>
								<td style="border:1px solid black;text-align:left">Weight of sand in hole, in gm Wb = (W1 -
									W4- W2)</td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo $row_select_pipe21['d4']; ?></b></td>
								<?php } ?>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;"><b>12</b></td>
								<td style="border:1px solid black;text-align:left">Bulk density Yb = (Ww /Wb) x Ys gm/cm3
								</td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo number_format($row_select_pipe21['d5'], 2); ?></b></td>
								<?php } ?>
							</tr>
							<tr style="text-align:center;">
							...
							<tr style="text-align:center;">
								...
								<td style="border:1px solid black;text-align:left">Percentage of Moisture Content % (w)
									(m/100-m)*100</td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo number_format($row_select_pipe21['d7'], 2);
										$total += $row_select_pipe21['d7']; ?></b>
									</td>
								<?php } ?>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;"><b>15</b></td>
								<td style="border:1px solid black;text-align:left">Weight of dry soil from the hole in gm
									(Wd) = (Ww/100+w)*100</td>
								<?php
								$select_tilesy = "select * from soil_calibration WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
								$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
								...
								while ($row_select_pipe21 = mysqli_fetch_array($result_tiles_select1)) {
									...
									?>
									<td style="border:1px solid black;border-right:0px solid black;">
										<b><?php echo $row_select_pipe21['d8']; ?></b></td>
								<?php } ?>
							</tr>

							<tr style="text-align:center">
								<td style="border: 1px solid black;">16</td>
								<td style="border: 1px solid black;border-left: 1px solid black;text-align:left;">Dry
									density Yd = (Wd/ Wb ) x Ys gm/cm3</td>
								<?php //echo $cnt	; ?>
								<td colspan="<?php echo $cnt; ?>"
									style="border: 1px solid black;border-left: 1px solid black;	">
									<b><?php $ans = $total / $cnt;
