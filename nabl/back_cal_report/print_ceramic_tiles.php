...
<br><br><br>
	<page size="A4">
		...
		<tr>
				<td  style="text-align:center;font-size:20px; ">
					...
					<table align="center" width="100%"  cellspacing="0" cellpadding="0" style="font-size:20px;font-family : Calibri;">
						...
						<tr style=""> 
							...
							<td  style="width:100%;padding-bottom:10px;padding-top:10px; text-align:center;font-weight:bold;border-right:1px solid;border-left:1px solid; " colspan="3"><span style=""> OBSERVATION AND CALCULATION SHEET FOR TEST ON CERAMIC TILE</td>
						</tr>
						<?php 
				...
				<tr>
					<td>
						<table align="center" width="100%"  style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;border-bottom:1px solid;margin-bottom:10px;">
							...
							<tr>
								<td style="padding: 1px;border: 1px solid;border-LEFT:0PX;" colspan="6"></td>
							</tr>
							<tr>
				...
				<br>
            <?php if (($row_select_pipe['avg_str'] != "" && $row_select_pipe['avg_str'] != "0" && $row_select_pipe['avg_str'] != null) || ($row_select_pipe['avg_rstr'] != "" && $row_select_pipe['avg_rstr'] != "0" && $row_select_pipe['avg_rstr'] != null)) { ?>		
			<p style="font-size:16px; font-weight:700; ">&bull; Moulus of Rupture and Breaking Strength:(IS 13630, P-6)</p>
			<p style="font-size:14px; font-weight:500; ">Dimention of Tile in mm (1) > 48: 77 specimen (2) < 48> 18:10 speciment</p>
			...
			<p style="font-size:16px; font-weight:700; ">&bull; Scratch Hardness of Surface of Surface(Mkhs' Scale):(IS 13630, P-13)</p>
			<p style="font-size:14px; font-weight:500; ">Minimum of thSTC tie shall be tested.</p>
			<table align="center" width="100%" class="test" style="border: 1px solid black;" cellpadding="5px">
				<tr>
		...
		<tr>
			...
			<p style="font-size:16px; font-weight:700;margin:5px 0px;">&bull; Dimention and Surface Quality(IS 13630, P-1)</p>
			<table align="center" width="100%" class="test" style="border: 1px solid black;" cellpadding="5px">
				<tr>
			...
			<p style="font-size:16px; font-weight:700;margin:5px 0px;">&bull; Water Absorption:(IS 13630, P-2)</p>
			<table align="center" width="100%" class="test" style="border: 1px solid black;" cellpadding="5px">
				<tr>
					<td style="border: 1px solid black; text-align:center;"><b>SR No.</b></td>
			...
			<!--<table align="center" width="100%" class="test1" height="Auto" style="border-top:2px solid;">
				<tbody>
					...
					<tr style="font-size:11px;">
						<td style="text-align:center;"><b>Page 2 of 4</b></td>
					</tr>
				</tbody>
			</table>-->
				...
				<tbody>
					...
					<tr>
						...
						<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
							<center><b>OBSERVATION &amp; CALCULATION SHEET FOR ceramic/Glazed Tiles</b></center>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<p style="font-size:16px; font-weight:700; ">&bull; Density:</p>
			...
			<table align="center" width="100%" class="test1" height="Auto" style="border-top:2px solid;">
				<tbody>
					...
					<tr style="font-size:11px;">
						<td style="text-align:center;"><b>Page 3 of 4</b></td>
					</tr>
				</tbody>
			</table>
			...
			<p style="font-size:15px; font-weight:700;padding:7px 0; margin:0;">&bull; Dimention and Surface Quality(IS 13630, P-1)</p>
			<table align="center" width="100%" class="test" style="border: 1px solid black;" cellpadding="5px">
				<tr>
					<td style="border: 1px solid black; text-align:center;"><b>SR No.</b></td>
					<td style="border: 1px solid black; text-align:center;"><b>Length</b></td>
			...
			<p style="font-size:16px; font-weight:700;padding:7px 0; margin:0;">&bull; Water Absorption:(IS 13630, P-2)</p>
			<table align="center" width="100%" class="test" style="border: 1px solid black;" cellpadding="5px">
				<tr>
					<td style="border: 1px solid black; text-align:center;"><b>SR No.</b></td>
					<td style="border: 1px solid black; text-align:center;"><b>Weight of Oven Dry Sample in g <br>(A)</b></td>
