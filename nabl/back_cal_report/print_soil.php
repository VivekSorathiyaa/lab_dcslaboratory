...
<body>
	...
	<page size="A4">
		...
		<page size="A4">
			...
			<table align="center"
				...
				<tr>
					<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Job
							Card No:&nbsp;</b><?php echo $_GET['job_no']; ?></td>
					<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
						colspan="4"><b>&nbsp;Test:Water Content&nbsp;</b></td>
				</tr>
				<tr>
			...
			<table style="border:1px solid black;width: 95%;text-transform: capitalize;font-family:book antiqua;"
				...
				<tr align="left">
					...
					<td align="center" style="font-size:18px;border:1px solid black;border-top:0px;border-left:0px;">
						<?php echo $row_select_pipe['shr_wm1']; ?></td>
					<td align="center" style="font-size:18px;border:1px solid black;border-top:0px;border-left:0px;">
						<?php echo $row_select_pipe['shr_wm2']; ?></td>
					<td align="center"
						style="font-size:18px;border:1px solid black;border-top:0px;border-left:0px;border-right:0px;">
						<?php echo $row_select_pipe['shr_wm3']; ?></td>
				</tr>
				<tr align="left">
					<td style="font-size:18px;border:1px solid black;border-top:0px;border-left:0px;font-Weight:bold;">
						Weight of container with sample (m2)</td>
					<td align="center"
						style="font-size:18px;border:1px solid black;border-top:0px;border-left:0px;0px;">
						<?php echo $row_select_pipe['shr_v1']; ?></td>
					<td align="center"
						style="font-size:18px;border:1px solid black;border-top:0px;border-left:0px;0px;">
						<?php echo $row_select_pipe['shr_v2']; ?></td>
					<td align="center"
						style="font-size:18px;border:1px solid black;border-top:0px;border-left:0px;border-right:0px;">
						<?php echo $row_select_pipe['shr_v3']; ?></td>
				</tr>
				<tr align="left">
					<td style="font-size:18px;border:1px solid black;border-top:0px;border-left:0px;font-Weight:bold;">
					...
					<td align="center"
						style="font-size:18px;border:1px solid black;border-top:0px;border-left:0px;0px;">
						<?php echo $row_select_pipe['shr_w2_1']; ?></td>
					<td align="center"
						style="font-size:18px;border:1px solid black;border-top:0px;border-left:0px;0px;">
						<?php echo $row_select_pipe['shr_w2_2']; ?></td>
					<td align="center"
						style="font-size:18px;border:1px solid black;border-top:0px;border-left:0px;border-right:0px;">
						<?php echo $row_select_pipe['shr_w2_3']; ?></td>
				</tr>
				<tr align="left">
					<td
			...
			<table align="center"
				...
				<tr>
					<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Job
							Card No:&nbsp;</b><?php echo $_GET['job_no']; ?></td>
					<td class="report-cell" style="text-align: left;border-top: 1px solid;border-left: 1px solid;"
						colspan="4"><b>&nbsp;Test:S.G. of Soil.&nbsp;</b></td>
				</tr>
				<tr>
					<td class="report-cell" style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Sample
							Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?></td>
			...
			<table align="center"
				...
				<tr>
					...
					<td colspan="2" style="border:1px solid;">
						<?php echo ($row_select_pipe['sgrt2'] + $row_select_pipe['sgrt2']) / 2; ?></td>
				</tr>
			</table>
			<br>
			<br>
			...
			<table align="center"
				...
				<tr>
					<td style="border: 0px solid;width:15%; text-align: left;" colspan="5">Gravel Content =
						<?php echo $row_select_pipe['']; ?> %</td>
				</tr>
				<tr>
					<td style="border: 0px solid;width:15%; text-align: left;" colspan="5">Sand Content =
						<?php echo $row_select_pipe['']; ?> %</td>
				</tr>
				<tr>
					<td style="border: 0px solid;width:15%; text-align: left;" colspan="5">Sit & Clay Content =
						<?php echo $row_select_pipe['']; ?> %</td>
				</tr>
			...
			<table align="center"
				...
				<tr>
					<td style=" text-align: left;border-top: 1px solid;" colspan="3"><b>&nbsp;MDD/OMC
							&nbsp;</b><?php echo $row_select_pipe['qty_1']; ?></td>
					<td style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="2"><b>
							&nbsp;Method of Compaction&nbsp;</b><?php echo $row_select_pipe['r_sam']; ?></td>
					<td style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="3">
						<b>&nbsp;Period of Soaking&nbsp;</b><?php echo $row_select_pipe['s_ret']; ?></td>
				</tr>
			</table>
			...
			<table align="center"
				...
				<tr>
					<td style="border: 0px solid;width:15%;text-align: left; " colspan="6"><SPAN
						...
						= <?php echo $row_select_pipe['']; ?> Kg)</td>
				</tr>
		...
		<?php if ($row_select_pipe['l1'] != "" && $row_select_pipe['l1'] != "0" && $row_select_pipe['l1'] != null) { ?>
			<table align="center" width="100%" cellpadding="0"
				style="font-size:11px;height:auto;font-family : Calibri;border: 1px solid;padding: 0;border-collapse: collapse;">
				<!-- header design -->
				<tr>
					<td style="text-align:center;font-size:16px; ">

						<table align="center" width="100%" cellspacing="0" cellpadding="0"
							style="font-size:16px;font-family : Calibri;border-bottom:1px solid;border-top:1px solid;border-right:1px solid;border-left:1px solid;">

							<tr style="">

								<td style="width:30%;font-weight:bold;padding-bottom:2px;padding-top:2px; ">&nbsp;&nbsp;
									DOC: STC/N/OS/001</td>
				...
				<tr>
					<td style="text-align:center;font-size:16px; ">
						...
						<table align="center" width="100%" cellspacing="0" cellpadding="0"
							style="font-size:16px;font-family : Calibri;border-bottom:1px solid;border-right:1px solid;border-left:1px solid;">

							<tr style="">

								<td style="width:60%;font-weight:bold;padding-bottom:2px;padding-top:2px; ">&nbsp;&nbsp;
									Prepared by: Technical Manager</td>
					...
					<td style="text-align:center;font-size:16px; ">
						...
						<table align="center" width="100%" cellspacing="0" cellpadding="0"
							...
							<tr style="">
								...
								<td
									style="width:80%;padding-left:150px; text-align:center;font-weight:bold;padding-bottom:3px;padding-top:3px; ">
									STERN TESTING & CONSULTANCY PVT. LTD.</td>
								<td style="width:20%;text-align:center;font-weight:bold; " rowspan=5><img
										src="../images/mat_logo.png"
										style="height:40px;width:120px;background-blend-mode:multiply;"></td>
							</tr>
							<tr style="">
								<td
									style="width:80%; text-align:center;padding-left:150px;padding-bottom:3px;padding-top:3px; ">
									PLOT NO. G-2049, KADVANI FORGE,KISHAN GATE</td>
							</tr>
							<tr style="">
								<td
									style="width:80%; text-align:center;padding-left:150px;padding-bottom:3px;padding-top:3px; ">
									G.I.D.C.,KALAWAD ROAD,METODA,360021,RAJKOT</td>
							</tr>
					...
					<td style="text-align:center;font-size:20px; ">
						...
						<table align="center" width="100%" cellspacing="0" cellpadding="0"
							...
							<tr style="">
								...
								<td style="width:100%;padding-bottom:10px;padding-top:10px; text-align:center;font-weight:bold;border-right:1px solid;border-left:1px solid; "
									colspan="3"><span style=""> OBSERVATION AND CALCULATION SHEET FOR TEST ON SOIL</td>
							</tr>
							<?php
							if ($row_select_pipe['lab_no'] != "") {
								...
								<tr style="font-size:10px;">
									...
									<td
										style="width:10%;font-weight:bold;text-align:center;border-top:1px solid; border-left:1px solid;">
										<?php echo $cnt++; ?></td>
									<td
										style="border-left:1px solid;width:40%;text-align:left;padding-bottom:3px;padding-top:3px;border-top:1px solid; ">
										&nbsp;&nbsp; Job No.</td>
									<td style="border-left:1px solid;width:50%;border-top:1px solid;border-right:1px solid; ">
										&nbsp;&nbsp; <?php echo $row_select_pipe['lab_no']; ?></td>
								</tr>
							<?php }
							if ($job_no != "") {
								?>
								<tr style="font-size:10px;">
									...
									<td
										style="border-top:1px solid;width:10%;font-weight:bold;text-align:center;border-left:1px solid; ">
										<?php echo $cnt++; ?></td>
									<td
										style="border-top:1px solid;border-left:1px solid;width:40%;text-align:left;padding-bottom:3px;padding-top:3px; ">
										&nbsp;&nbsp; Laboratory No</td>
									<td style="border-top:1px solid;border-left:1px solid;width:50%;border-right:1px solid; ">
										&nbsp;&nbsp; <?php echo $job_no; ?></td>
								</tr>
							<?php }
							//if($job_no!=""){
							...
							<tr style="font-size:10px;">
								...
								<td
									style="border-top:1px solid;border-left:1px solid;width:40%;text-align:left;padding-bottom:3px;padding-top:3px; ">
									&nbsp;&nbsp; Date of receipt of sample</td>
								<td style="border-top:1px solid;border-left:1px solid;width:50%;border-right:1px solid; ">
									&nbsp;&nbsp; <?php echo date('d-m-Y', strtotime($rec_sample_date)); ?></td>
							</tr>
							<tr style="font-size:10px;">
								...
								<td
									style="border-top:1px solid;border-left:1px solid;width:40%;text-align:left;padding-bottom:3px;padding-top:3px; ">
									&nbsp;&nbsp; Date of starting test</td>
								<td style="border-top:1px solid;border-left:1px solid;width:50%;border-right:1px solid; ">
									&nbsp;&nbsp; <?php echo date('d-m-Y', strtotime($start_date)); ?></td>
							</tr>
							<tr style="font-size:10px;">
								...
								<td
									style="border-top:1px solid;border-left:1px solid;width:40%;text-align:left;padding-bottom:3px;padding-top:3px; ">
									&nbsp;&nbsp; Probable date of completion</td>
								<td style="border-top:1px solid;border-left:1px solid;width:50%;border-right:1px solid; ">
									&nbsp;&nbsp; <?php echo date('d-m-Y', strtotime($end_date)); ?></td>
							</tr>
						</table>
				...
				<tr>
					<td>
						<table align="center" width="100%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;">

							<tr>
								<td
									style="font-size: 14px;font-weight: bold;text-align: center;padding: 2px;text-transform: uppercase;border: 1px solid;">
									LIGHT COMPACTION (PROCTOR) TEST As Per IS: 2720 (Part-7): 1980 Reaffirmed: 2021, Clause
									No :-5-Light Compaction</td>
							</tr>
							<tr>
				...
				<tr>
					<td>
						<table align="center" width="100%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid; border-bottom:0px solid;">
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Amount of Sample
									Taken :-</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;width: 10%;">
									<?php echo $row_select_pipe["amts1"] ?>gm</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Type Of Test:-</td>
								<td style="padding: 2px; font-weight: bold; text-align: left;">&nbsp;&nbsp; Light Compation
								</td>
								<td style="width: 5%;"></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Diameter of Mould :-
								</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["amts2"] ?>cm</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Volume of mould (Vm)
									:-</td>
								<td style="padding: 2px; font-weight: bold; text-align: left;">&nbsp;&nbsp;
									<?php echo $row_select_pipe["amts3"] ?>cm</td>
								<td style="width: 5%;"></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0; padding-bottom:15px;">
									Height of Mould :-</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0; padding-bottom:15px;">
									<?php echo $row_select_pipe["amts4"] ?> cm</td>
								<td></td>
								<td></td>
								<td style="width: 5%;"></td>
							</tr>
				...
				<tr>
					...
					<td style="border: 2px solid; border-top:0px solid; border-bottom:0px solid;">
						<table align="center" width="60%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 2px solid;border-right: 2px solid; border-top:2px solid; border-bottom:2px solid;">
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="3">Sr.No.</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"> Full
									Weight of Mould </td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"> Empty
									Weight of Mould </td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"> Bulk
									Density </td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									m<sub>1</sub> </td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"> Xm =
									(m<sub>2</sub>-m<sub>1</sub>) / Vm<sub>2</sub></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"> gm </td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"> gm </td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"> g /
									cm<sup>3</sup> </td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou1"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou2"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou3"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"><?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou1_1"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou2_1"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou3_1"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou1_2"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou2_2"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou3_2"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"><?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou1_3"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou2_3"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou3_3"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou1_4"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou2_4"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou3_4"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"><?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou1_5"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou2_5"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou3_5"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou1_6"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou2_6"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou3_6"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou1_7"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou2_7"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou3_7"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou1_8"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou2_8"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou3_8"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou1_9"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou2_9"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["mou3_9"] ?></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td style="border: 2px solid; border-top:0px solid; border-bottom:0px solid;">
						...
						border-right: 2px solid; border-top:1px solid; margin-top: 10px; border-bottom: 2px solid; margin-bottom: 5px;">
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid; border-bottom: 2px solid;"
									rowspan="5">Sr.No.</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid; border-bottom: 2px solid;"
									rowspan="5" colspan="">Container No.</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid;"
									rowspan="3">Container Weight</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid;"
									rowspan="2"> Container Weight<br>+ Wet Sample<br> Weight </td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid;"
									rowspan="2">Container Weight<br>+ Dry Sample<br>Weight </td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid;"
									rowspan="2">Moisture Content </td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid; width: 15%;"
									rowspan="2"> Dry Density </td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2"> m<sub>2</sub> </td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2px;"> m<sub>3</sub> </td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2"> W = (m<sub>2</sub>-m<sub>3</sub>) / (m<sub>2</sub>-m<sub>3</sub>)</u> X 100
								</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2"> γ<sup>d</sup> = <u>100γm</u> <br> &nbsp; &nbsp; &nbsp; &nbsp; 10 + w </td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									m<sub>1</sub> </td>
							...
							<tr>
								<td
									style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid; border-bottom: 2px solid; padding: 2px;">
									gm</td>
								<td
									style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid; border-bottom: 2px solid; padding: 2px;">
									gm</td>
								<td
									...
									gm</td>
								<td
									style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid; border-bottom: 2px solid; border-top: 2px solid; padding: 2px;">
									%</td>
								<td
									style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid; border-bottom: 2px solid; border-top: 2px solid; padding: 2px;">
									g / cm<sup>3</sup></td>
							...
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou9"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou4_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou5_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou6_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou7_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou8_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou9_1"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou4_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou5_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou6_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou7_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou8_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou9_2"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou4_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou5_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou6_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou7_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou8_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou9_3"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou4_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou5_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou6_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou7_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou8_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou9_4"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou4_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou5_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou6_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou7_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou8_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou9_5"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou4_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou5_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou6_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou7_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou8_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou9_6"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou4_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou5_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou6_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou7_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou8_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou9_7"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou4_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou5_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou6_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou7_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou8_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou9_8"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou4_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou5_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou6_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou7_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou8_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["mou9_9"] ?></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td>
						<table align="center" width="100%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border: 1px solid; ">
							<!-- <tr>
				...
				<td style="padding: 5px;border-left: 1px solid;border: 1px solid;border: 1px solid;" colspan="3"><?php echo $row_select_pipe['sl_2']; ?></td>
							...
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 5px;width: 15%;border: 0px solid;">
									Checked By :-</td>
								<td style="padding: 5px;border: 0px solid;"></td>
								<td style="font-weight: bold;text-align: center;padding:5px;width: 12%;border: 0px solid;">
									Tested By :-</td>
								<td style="padding: 5px;border: 0px solid;"></td>
							</tr>
							<tr>
								<td style="height: 35px;border: 1px solid;border-right: 1px solid; border-bottom:0px; border-top:1px solid;"
									colspan="4"></td>
							</tr>
					...
					<td>
						<table align="center" width="100%"
							...
							<tr>
								<td
									style="font-size: 14px;font-weight: bold;text-align: center;padding: 2px;text-transform: uppercase;border: 1px solid;">
									HEAVY COMPACTION (PROCTOR) TEST As Per IS: 2720 (Part-8): 1983 Reaffirmed: 2020, Clause
									No:-5-Heavy Compaction</td>
							</tr>
							<tr>
								<td style="padding: 1px;border: 1px solid;"></td>
							</tr>
						...
						<table align="center" width="100%"
							...
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Amount of Sample
									Taken :-</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;width: 10%;">
									<?php echo $row_select_pipe["typs1"] ?>gm</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Type Of Test:-</td>
								<td style="padding: 2px; font-weight: bold; text-align: left;">&nbsp;&nbsp; Heavy Compaction
								</td>
								<td style="width: 5%;"></td>
							</tr>
							<tr>
								...
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["typs2"] ?>cm</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Volume of mould (Vm)
									:-</td>
								<td style="padding: 2px; font-weight: bold; text-align: left;">&nbsp;&nbsp;
									<?php echo $row_select_pipe["typs3"] ?>cm</td>
								<td style="width: 5%;"></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0; padding-bottom:15px;">
									Height of Mould :-</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0; padding-bottom:15px;">
									<?php echo $row_select_pipe["typs4"] ?> cm</td>
								<td></td>
								<td></td>
								<td style="width: 5%;"></td>
							</tr>
					...
					<td style="border: 2px solid; border-top:0px solid; border-bottom:0px solid;">
						<table align="center" width="60%"
							...
							<tr>
								...
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy1"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy2"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy3"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"><?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy1_1"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy2_1"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy3_1"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy1_2"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy2_2"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy3_2"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"><?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy1_3"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy2_3"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy3_3"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy1_4"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy2_4"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy3_4"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"><?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy1_5"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy2_5"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy3_5"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy1_6"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy2_6"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy3_6"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy1_7"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy2_7"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy3_7"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy1_8"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy2_8"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy3_8"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;border: 1px solid;"> <?php echo $cnt++; ?>
								</td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy1_9"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy2_9"] ?></td>
								<td style="font-weight: bold;text-align: center;border: 1px solid;">
									<?php echo $row_select_pipe["heavy3_9"] ?></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					border-right: 2px solid; border-top:1px solid; margin-top: 10px; border-bottom: 2px solid; margin-bottom: 5px;">
							...
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy9"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy4_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy5_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy6_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy7_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy8_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy9_1"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy4_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy5_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy6_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy7_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy8_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy9_2"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy4_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy5_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy6_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy7_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy8_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy9_3"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy4_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy5_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy6_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy7_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy8_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy9_4"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy4_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy5_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy6_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy7_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy8_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy9_5"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy4_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy5_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy6_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy7_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy8_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy9_6"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy4_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy5_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy6_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy7_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy8_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy9_7"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy4_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy5_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy6_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy7_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy8_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy9_8"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy4_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy5_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy6_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy7_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy8_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["heavy9_9"] ?></td>
							</tr>
						</table>
					</td>
				</tr>
		...
		if ($row_select_pipe['corre67'] != "" && $row_select_pipe['corre67'] != "0" && $row_select_pipe['corre67'] != null) { ?>
			<table align="center" width="100%" cellpadding="0"
					...
					<td>
						<table align="center" width="100%"
							...
							<tr>
								<td
									style="font-size: 14px;font-weight: bold;text-align: center;padding: 2px;text-transform: uppercase;border: 1px solid;">
									UNCONFINED COMPRESSIVE STRENGTH TEST As Per IS: 2720 (Part-10): 1991 Reaffirmed: 2020,
									Clause No:- 1.1</td>
							</tr>
							<tr>
								<td style="padding: 1px;border: 1px solid;"></td>
				...
				<tr>
					<td>
						<table align="center" width="100%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Load cell Capacity:-
								</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["str1"] ?> KN</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Load cell Least
									Count:-</td>
								<td style="padding: 2px; font-weight: bold;"><?php echo $row_select_pipe["str2"] ?> KN</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Length of Specimen -
									L<sub>o</sub> :-</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["str3"] ?> mm</td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Diameter of Specimen
									- Do :-</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["str4"] ?> mm</td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Original Cross
									Sectional Area - Ao :-</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["str5"] ?> cm<sup>2</sup></td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Initial Volume - Vo
									:-</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["str6"] ?> cm<sup>3</sup></td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Initial Mass of
									Specimen :-</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["str7"] ?> gm</td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Initial Density :-
								</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["str8"] ?> gm/cm³</td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Initial Water Content
									:-</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["str9"] ?> %</td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Weight of Specimen
									after Test :-</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["str10"] ?> gm</td>
								<td></td>
								<td></td>
							</tr>
							<tr>
								<td
									style="font-weight: bold;text-align: left;padding: 2px;border: 0; padding-bottom: 20px;">
									Rate of Strain :-</td>
								<td
									style="font-weight: bold;text-align: left;padding: 2px;border: 0; padding-bottom: 20px;">
									<?php echo $row_select_pipe["str11"] ?> mm/min</td>
								<td></td>
								<td></td>
							</tr>
						</table>
				...
				<tr>
					<td>
						<?php $cnt = 1; ?>
						<table align="center" width="100%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid; border-top:1px solid;">
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid; border-bottom: 2px solid;"
									rowspan="4">Time</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid; border-bottom: 2px solid;"
									rowspan="4" colspan="2">Load</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid; height:40px;"
									rowspan="3">Displacement</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid;"
									rowspan="2">Axial Strain</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid;"
									rowspan="2">Corrected Area</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top: 2px solid;"
									rowspan="2">Unconfined Compressive<br> Strength</td>
							</tr>
							<tr>
							...
							<tr>
								<!-- <td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Load</td> -->
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2"> E = ΔL / Lo </td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2px;"> A = Ao / (1 - E) </td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2"> σ<sub>c</sub> = P / A</td>
								<!-- <td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Load</td> -->
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre67"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">0.25</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre68"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">0.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre69"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">0.75</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc10"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc12"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre70"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">1.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc14"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc15"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre10"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre71"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">1.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc16"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc17"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc18"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre12"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre72"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">2.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc19"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc20"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc21"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre14"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre73"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">2.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc22"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc23"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc24"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre15"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre16"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre74"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">3.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc25"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc26"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc27"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre17"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre18"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre75"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">3.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc28"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc29"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc30"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre19"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre20"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre76"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">4.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc31"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc32"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc33"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre21"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre22"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre77"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">4.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc34"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc35"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc36"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre23"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre24"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre78"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">5.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc37"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc38"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc39"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre25"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre26"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre79"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">5.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc40"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc41"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc42"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre27"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre28"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre80"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">6.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc43"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc44"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc45"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre29"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre30"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre81"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">6.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc46"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc47"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc48"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre31"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre32"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre82"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">7.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc50"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc51"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc52"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre33"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre34"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre83"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">7.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc53"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc54"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc55"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre35"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre36"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre84"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">8.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc56"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc57"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc58"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre37"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre38"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre85"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">8.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc59"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc60"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc61"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre39"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre40"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre86"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">9.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc62"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc63"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc64"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre41"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre42"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre87"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">9.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc65"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc66"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc67"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre43"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre44"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre88"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">10.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc68"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc69"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc70"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre45"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre46"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre89"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">10.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc71"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc72"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc73"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre47"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre48"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre90"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">11.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc74"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc75"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc76"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre49"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre50"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre91"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">11.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc77"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc78"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc79"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre51"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre52"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre92"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">12.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc80"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc81"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc82"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre53"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre54"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre93"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">12.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc83"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc84"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc85"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre55"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre56"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre94"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">13.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc86"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc87"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc88"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre57"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre58"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre95"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">13.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc89"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc90"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc91"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre59"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre60"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre96"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">14.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc92"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc93"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc94"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre61"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre62"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre97"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">14.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc95"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc96"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc97"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre63"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre64"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre98"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">15.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc98"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc99"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["unc100"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre65"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre66"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["corre99"] ?></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table align="center" width="100%"
							...
							<tr>
								<td
									style="font-size: 14px;font-weight: bold;text-align: center;padding: 2px;text-transform: uppercase;border: 1px solid;">
									Field Dry Density & Field Moisture Content (I.S.: 2720-Part 29-1995, I.S.: 2720-Part
									2-1997)</td>
							</tr>
							<tr>
								<td style="padding: 1px;border: 1px solid;"></td>
				...
				<tr>
					<td>
						...
						<table align="center" width="100%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;border-bottom: 2px solid;"
									rowspan="3">Sr. <br>No.</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">BH <br> No.</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">BH <br> Sample <br> Depth</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">Height <br> of Sellby</td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">Diameter</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">Volume of <br> Soil Sample</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">Empty <br> Weight of <br> Shelby</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">Weight of <br> Shelby + <br> Wet Soil</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Bulk
									Density,</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;border-bottom: 2px solid;"
									rowspan="3">Cont. <br> No</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Cont.</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">Cont.+ Wet <br> Sample Wt</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">Cont.+ Dry <br> Sample Wt</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Moisture
									<br> Content</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">Field Dry Density, <br> gm/cc</td>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Sample ID
								</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">of Sample
								</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">gb, gm/cc
								</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Weight</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-bottom: 2px solid;"
									rowspan="2">(M2-M3)/(M3- <br> M1)</td>
							</tr>
							<tr>
								<td
									style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;border-bottom: 2px solid;">
								</td>
								<td
									style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;border-bottom: 2px solid;">
									mtr.</td>
							...
							<tr>
								...
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_no1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_d1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["hs_1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_id1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["height_sam_1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["diam_1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["vol_1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["emp_1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["wet_s_1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bulk_1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_w_1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_wet1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_dry1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["moi_1"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["fdry1"] ?></td>
							</tr>
							<tr>
								<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $cnt++; ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_no2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_d2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["hs_2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_id2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["height_sam_2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["diam_2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["vol_2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["emp_2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["wet_s_2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bulk_2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_w_2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_wet2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_dry2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["moi_2"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["fdry2"] ?></td>
							</tr>
							<tr>
								<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $cnt++; ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_no3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_d3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["hs_3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_id3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["height_sam_3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["diam_3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["vol_3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["emp_3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["wet_s_3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bulk_3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_w_3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_wet3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_dry3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["moi_3"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["fdry3"] ?></td>
							</tr>
							<tr>
								<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $cnt++; ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_no4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_d4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["hs_4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_id4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["height_sam_4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["diam_4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["vol_4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["emp_4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["wet_s_4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bulk_4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_w_4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_wet4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_dry4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["moi_4"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["fdry4"] ?></td>
							</tr>
							<tr>
								<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $cnt++; ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_no5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_d5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["hs_5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_id5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["height_sam_5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["diam_5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["vol_5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["emp_5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["wet_s_5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bulk_5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_w_5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_wet5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_dry5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["moi_5"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["fdry5"] ?></td>
							</tr>
							<tr>
								<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $cnt++; ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_no6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_d6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["hs_6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_id6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["height_sam_6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["diam_6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["vol_6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["emp_6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["wet_s_6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bulk_6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_w_6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_wet6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_dry6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["moi_6"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["fdry6"] ?></td>
							</tr>
							<tr>
								<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $cnt++; ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_no7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_d7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["hs_7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_id7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["height_sam_7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["diam_7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["vol_7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["emp_7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["wet_s_7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bulk_7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_w_7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_wet7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_dry7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["moi_7"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["fdry7"] ?></td>
							</tr>
							<tr>
								<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $cnt++; ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_no8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_d8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["hs_8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_id8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["height_sam_8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["diam_8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["vol_8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["emp_8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["wet_s_8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bulk_8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_w_8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_wet8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_dry8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["moi_8"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["fdry8"] ?></td>
							</tr>
							<tr>
								<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $cnt++; ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_no9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_d9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["hs_9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_id9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["height_sam_9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["diam_9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["vol_9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["emp_9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["wet_s_9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bulk_9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_w_9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_wet9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_dry9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["moi_9"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["fdry9"] ?></td>
							</tr>
							<tr>
								<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $cnt++; ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_no10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_d10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["hs_10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_id10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["height_sam_10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["diam_10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["vol_10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["emp_10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["wet_s_10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bulk_10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_w_10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_wet10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_dry10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["moi_10"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["fdry10"] ?></td>
							</tr>
							<tr>
								<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $cnt++; ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_no11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_d11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["hs_11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_id11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["height_sam_11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["diam_11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["vol_11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["emp_11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["wet_s_11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bulk_11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_w_11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_wet11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_dry11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["moi_11"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["fdry11"] ?></td>
							</tr>
							<tr>
								<td style="text-align: center;padding: 2px;border: 1px solid;"><?php echo $cnt++; ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_no12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bh_d12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["hs_12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_id12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["height_sam_12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["diam_12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["vol_12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["emp_12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["wet_s_12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["bulk_12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_w_12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_wet12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["cont_dry12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["moi_12"] ?></td>
								<td style="text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["fdry12"] ?></td>
							</tr>
							<tr>
					...
					<td>
						<table align="center" width="100%"
							...
							<tr>
								<td
									style="font-size: 14px;font-weight: bold;text-align: center;padding: 2px;text-transform: uppercase;border: 1px solid;">
									SHRINKAGE LIMIT TEST As Per IS: 2720 (Part-6): 1972 Reaffirmed: 2021, Clause No.5</td>
							</tr>
							<tr>
								<td style="padding: 1px;border: 1px solid;"></td>
							</tr>
				...
				<tr>
					<td>
						...
						<table align="center" width="100%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;border-bottom: 2px solid;"
									rowspan="2">Sr. <br>No.</td>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;border-bottom: 2px solid;"
									rowspan="2">Description</td>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;border-bottom: 2px solid;"
									rowspan="2">Unit</td>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">Results
								</td>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">Soil</td>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">Height
								</td>
							</tr>
							<tr>
								<td
							...
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Weight of
									Shrinkage Dish - W₁</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">gm</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr3"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Weight of
									Shrinkage Dish with Wet Soil Pat - W₂</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">gm</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr6"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Weight of
									Shrinkage Dish with Dry Soil Pat - W3</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">gm</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr9"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Weight of
									Oven Dry Soil Pat - W = (W3-W₁)</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">gm</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr10"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr12"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">gm</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr14"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr15"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Moisture
									Content of Wet Soil Pat-W(W₂-W3)/(W3-W₁) x 100</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">%</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr16"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr17"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr18"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Weight of
									Mercury Filling in Shrinkage Dish</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">gm</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr19"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr20"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr21"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Density of
									Mercury</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">g/cm³</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr22"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr23"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr24"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Volume of
									Shrinkage Dish - V</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">cm³</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr25"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr26"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr27"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Weight of
									Mercury displaced by Dry Soil Pat</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">gm</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr28"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr29"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr30"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Volume of Dry
									Soil Pat - V<sub>0</sub></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">cm³</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr31"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr32"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr33"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Shrinkage
									Limit-W [W-{(V-V)/W}] X 100</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">%</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s3"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Shrinkage
									Ratio - R = W<sub>0</sub>/V<sub>0</sub></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">--</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr34"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr35"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["shr36"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Average
									Shrinkage Limit</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">%</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									colspan="3"><?php echo $row_select_pipe["avg_shr1"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 10px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">--</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									colspan="3"><?php echo $row_select_pipe["avg_shr2"] ?></td>
							</tr>
			...
			<table align="center" width="100%" cellpadding="0"
					...
					<td>
						<table align="center" width="100%"
							...
							<tr>
								<td
									style="font-size: 14px;font-weight: bold;text-align: center;padding: 2px;text-transform: uppercase;border: 1px solid;">
									CONSOLIDATION TEST As Per IS: 2720 (Part-15): 1965 Reaffirmed: 2021</td>
							</tr>
							<tr>
								<td style="padding: 1px;border: 1px solid;"></td>
							</tr>
					...
					<td>
						<table align="center" width="100%"
							...
							<tr>
								...
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["c1"] ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Consolidometer No.
								</td>
				...
				<tr>
					<td>
						<table align="center" width="100%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Density of Soil :-
								</td>
								<td style="text-align: left;padding: 2px;border: 0;"> <?php echo $row_select_pipe["c3"] ?>
									gm/cc</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Moisture Content :-
								</td>
								<td style="padding: 2px;"><?php echo $row_select_pipe["c4"] ?> %</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Mass of Soil taken :-
								</td>
								<td style="text-align: left;padding: 2px;border: 0;"><?php echo $row_select_pipe["c5"] ?> gm
								</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Amount of water taken
									:-</td>
								<td style="padding: 2px;"><?php echo $row_select_pipe["c6"] ?> gm</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Specific Gravity of
									Soil :-</td>
								<td style="text-align: left;padding: 2px;border: 0;"><?php echo $row_select_pipe["c7"] ?>
								</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Volume of
									Consolidometer :-</td>
								<td style="padding: 2px;"><?php echo $row_select_pipe["c8"] ?> cm³</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Area of Specimen :-
								</td>
								<td style="text-align: left;padding: 2px;border: 0;"><?php echo $row_select_pipe["c9"] ?>
									cm²</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Weight of Wet
									Specimen After Test :-</td>
								<td style="padding: 2px;"><?php echo $row_select_pipe["c10"] ?> gm</td>
							</tr>
							<tr>
								<td></td>
								<td></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Weight of Dry
									Specimen After Test :-</td>
				...
				<tr>
					<td>
						<?php $cnt = 1; ?>
						<table align="center" width="100%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid; border-top:2px solid;">
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;"
									rowspan="6">Sr. <br>No.</td>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;"
									colspan="9">Description</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 5px;border: 1px solid;" colspan="2">
									Starting Date :-</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo date('d/m/Y', strtotime($row_select_pipe["s_date1"])); ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo date('d/m/Y', strtotime($row_select_pipe["s_date2"])); ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo date('d/m/Y', strtotime($row_select_pipe["s_date3"])); ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo date('d/m/Y', strtotime($row_select_pipe["s_date4"])); ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo date('d/m/Y', strtotime($row_select_pipe["s_date5"])); ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo date('d/m/Y', strtotime($row_select_pipe["s_date6"])); ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo date('d/m/Y', strtotime($row_select_pipe["s_date7"])); ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 5px;border: 1px solid;" colspan="2">
									Starting Time :-</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_time1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_time2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_time3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_time4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_time5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_time6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["s_time7"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 5px;border: 1px solid;" colspan="2">
									Pressure Increment kg/cm²</td>
							...
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 5px;border: 1px solid;">Elapsed Time
								</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">vt</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["e_time1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["e_time2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["e_time3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["e_time4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["e_time5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["e_time6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["e_time7"] ?></td>
							</tr>

							<tr>
								<td style="font-weight: bold;text-align: left;padding: 5px;border: 1px solid;">minute</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["mini1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["mini2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["mini3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["mini4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["mini5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["mini6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["mini7"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">0.00</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_1"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_2"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">1.00</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_3"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_4"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">2.00</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_5"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_6"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_6"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_7"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_8"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_9"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_10"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_10"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_10"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_10"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_10"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_10"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_10"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_11"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_12"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_12"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_12"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_12"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_12"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_12"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_12"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">1440.00
								</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">37.95</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol1_13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol2_13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol3_13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol4_13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol5_13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol6_13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sol7_13"] ?></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table align="center" width="100%"
							...
							<tr>
								<td
									style="font-size: 14px;font-weight: bold;text-align: center;padding: 2px;text-transform: uppercase;border: 1px solid;">
									TRIAXIAL TEST As Per IS: 2720 (Part-15): 1965 Reaffirmed: 2021</td>
							</tr>
							<tr>
								<td style="padding: 1px;border: 1px solid;"></td>
							</tr>
					...
					<td>
						<table align="center" width="100%"
							...
							<tr>
								...
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["t1"] ?></td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Load cell Least Count
									:-</td>
								<td style="padding: 2px;"><?php echo $row_select_pipe["t2"] ?> KN</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Type of Sample :-
								</td>
							...
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Method of test :-
								</td>
								<td style="padding: 2px;">Unconsolidated Undrained / Consolidated Undrained / Consolidated
									Drained</td>
								<td></td>
								<td></td>
							</tr>
				...
				<tr>
					<td>
						...
						<table align="center" width="100%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid; border-top:2px solid;">
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;" colspan="3">
									Specimen Details</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Trial-1
								</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Trial-2
								</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Trial-3
								</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;">Initial
									Length of Specimen</td>
								<td
									style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; padding-left: 30px;">
								</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">cm</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp6"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;" colspan="2">
									Area of Specimen</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">cm²</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp9"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;" colspan="2">
									Volume of Specimen</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">cm²</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp10"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp12"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;" colspan="2">
									Density of Soil</td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp14"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp15"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;" colspan="2">
									Moisture Content</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">%</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp16"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp17"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp18"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;" colspan="2">
									Amount of Soil taken</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">gm</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp19"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp20"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp21"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 1px solid;" colspan="2">
									Amount of Water taken</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">gm</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp22"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp23"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["sp24"] ?></td>
							</tr>
						</table>
					</td>
				</tr>
						...
						<table align="center" width="100%"
							...
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid; border-top:2px solid;"
									rowspan="4">Sr. No.</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;border-top:2px solid;"
									colspan="4">Description</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;"
									rowspan="2">Time</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">Pressure -
									<?php echo $row_select_pipe["pres1"] ?> Kg/cm²</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">Pressure -
									<?php echo $row_select_pipe["pres2"] ?> Kg/cm²</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">Pressure -
									<?php echo $row_select_pipe["pres3"] ?> Kg/cm²</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">Load Cell
									Reading</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">Load Cell
									Reading</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">Load Cell
							...
							<tr>
								...
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">0.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri3"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">0.25</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri6"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">0.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri9"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">0.75</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri10"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri12"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">1.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri14"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri15"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">1.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri16"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri17"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri18"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">2.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri19"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri20"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri21"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">2.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri22"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri23"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri24"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">3.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri25"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri26"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri27"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">3.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri28"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri29"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri30"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">4.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri31"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri32"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri33"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">4.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri34"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri35"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri36"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">5.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri37"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri38"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri39"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">5.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri40"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri41"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri42"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">6.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri43"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri44"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri45"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">6.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri46"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri47"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri48"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">7.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri50"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri51"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri52"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">7.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri53"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri54"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri55"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">8.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri56"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri57"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri58"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">8.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri59"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri60"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri61"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">9.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri62"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri63"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri64"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">9.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri65"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri66"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri67"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">10.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri68"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri69"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri70"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">10.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri71"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri72"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri73"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">11.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri74"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri75"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri76"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">11.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri77"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri78"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri79"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">12.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri80"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri81"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri82"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">12.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri83"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri84"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri85"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">13.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri86"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri87"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri88"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">13.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri89"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri90"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri91"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">14.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri92"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri93"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri94"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">14.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri95"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri96"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri97"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">15.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri98"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri99"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["tri100"] ?></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table align="center" width="100%"
							...
							<tr>
								<td
									style="font-size: 14px;font-weight: bold;text-align: center;padding: 2px;text-transform: uppercase;border: 1px solid;">
									DIRECT SHEAR TEST As Per IS: 2720 (Part-13): 1986 Reaffirmed: 2021</td>
							</tr>
							<tr>
								<td style="padding: 1px;border: 1px solid;"></td>
							</tr>
					...
					<td>
						<table align="center" width="100%"
							...
							<tr>
								...
								<td style="text-align: left;padding: 2px;border: 0;"><?php echo $row_select_pipe["di1"] ?>
								</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Load cell Least
									Count:-</td>
							...
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Rate of Strain :-
								</td>
								<td style="text-align: left;padding: 2px;border: 0;"><?php echo $row_select_pipe["rate1"] ?>
									mm/min</td>
								<td></td>
								<td></td>
							</tr>
							...
							<tr>
								...
								<td style="text-align: left;padding: 2px;border: 0;">Unconsolidated Undrained / Consolidated
									Undrained / Consolidated Drained</td>
								<td></td>
								<td></td>
							</tr>
						</table>
				...
				<tr>
					<td>
						<table align="center" width="100%"
							...
							<tr>
								<td style="font-size: 12px;font-weight: bold;text-align: center;padding: 2px;border-top: 0;width: 8%;"
									colspan="2">Soil Specimen Measurements</td>
							</tr>
							<tr>
								<td style="padding: 1px;border: 1px solid;" colspan="2"></td>
							</tr>
					...
					<td>
						<table align="center" width="100%"
							...
							<tr>
								...
								<td style="text-align: left;padding: 2px;border: 0;"><?php echo $row_select_pipe["dens1"] ?>
									gm/cc</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Moisture Content:-
								</td>
							...
							<tr>
								...
								<td style="text-align: left;padding: 2px;border: 0;">
									<?php echo $row_select_pipe["mass_1"] ?> gm</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Amount of water taken
									:-</td>
							...
							<tr>
								...
								<td style="text-align: left;padding: 2px;border: 0;"><?php echo $row_select_pipe["amt_2"] ?>
									cm²</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Volume of Specimen :-
								</td>
					...
					<td>
						...
						<table align="center" width="100%"
							...
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">Time</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Pressure -
									<?php echo $row_select_pipe["d_pres1"] ?> Kg/cm²</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Pressure -
									<?php echo $row_select_pipe["d_pres2"] ?> Kg/cm²</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Pressure -
									<?php echo $row_select_pipe["d_pres3"] ?> Kg/cm²</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Load Cell
									Reading</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Load Cell
									Reading</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Load Cell
							...
							<tr>
								...
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">0.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear3"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">0.25</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear6"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">0.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear8"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear9"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">0.75</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear10"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear12"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">1.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear14"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear15"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">1.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear16"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear17"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear18"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">2.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear19"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear20"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear21"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">2.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear22"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear23"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear24"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">3.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear25"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear26"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear27"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">3.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear28"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear29"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear30"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">4.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear31"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear32"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear33"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">4.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear34"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear35"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear36"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">5.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear37"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear38"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear39"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">5.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear40"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear41"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear42"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">6.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear43"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear44"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear45"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">6.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear46"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear47"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear48"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">7.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear50"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear51"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear52"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">7.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear53"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear54"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear55"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">8.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear56"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear57"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear58"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">8.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear59"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear60"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear61"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">9.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear62"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear63"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear64"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">9.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear65"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear66"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear67"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">10.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear68"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear69"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear70"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">10.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear71"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear72"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear73"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">11.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear74"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear75"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear76"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">11.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear77"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear78"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear79"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">12.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear80"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear81"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear82"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">12.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear83"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear84"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear85"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">13.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear86"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear87"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear88"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">13.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear89"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear90"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear91"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">14.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear92"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear93"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear94"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">14.50</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear95"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear96"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear97"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">15.00</td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear98"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear99"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 0px;border: 1px solid;">
									<?php echo $row_select_pipe["shear100"] ?></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table align="center" width="100%"
							...
							<tr>
								<td
									style="font-size: 14px;font-weight: bold;text-align: center;padding: 2px;text-transform: uppercase;border: 1px solid;">
									CALIFORNIA BEARING RATlO TEST As Per IS : 2720 (Part-16) : 1987 Reaffirmed : 2021 ,
									Clause No :- 5</td>
							</tr>
							<tr>
								<td style="padding: 1px;border: 1px solid;"></td>
				...
				<tr>
					<td>
						<table align="center" width="100%"
							...
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Proving Ring Constant
									:-</td>
								<td style="text-align: left;padding: 2px;border: 0;"><?php echo $row_select_pipe["rin1"] ?>
								</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Proving Ring Capacity
									:-</td>
								<td style="padding: 2px;"><?php echo $row_select_pipe["rin2"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Dial Guage Least
									Count :-</td>
								<td style="text-align: left;padding: 2px;border: 0;"><?php echo $row_select_pipe["rin3"] ?>
								</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Dial Guage Capacity
									:-</td>
								<td style="padding: 2px;"><?php echo $row_select_pipe["rin4"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Type of Compaction :-
								</td>
								<td style="text-align: left;padding: 2px;border: 0;">Static Compaction / Dynamic Compaction
									<br> Light Compaction / Heavy Compaction</td>
								<td></td>
								<td></td>
							</tr>
						</table>
				...
				<tr>
					<td>
						<table align="center" width="100%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Maximum Dry density
									of Soil :-</td>
								<td style="text-align: left;padding: 2px;border: 0;"><?php echo $row_select_pipe["rin5"] ?>
									gm/cc</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Optimum Moisture
									Content :-</td>
							...
							<tr>
								...
								<td style="text-align: left;padding: 2px;border: 0;"><?php echo $row_select_pipe["rin7"] ?>
									gm</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Amount of water taken
									:-</td>
							...
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Surcharge Weight used
									:-</td>
								<td style="text-align: left;padding: 2px;border: 0;"><?php echo $row_select_pipe["rin9"] ?>
									Kg</td>
								<td style="font-weight: bold;text-align: left;padding: 2px;border: 0;">Volume of Specimen :-
								</td>
					...
					<td>
						...
						<table align="center" width="100%"
							...
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;"
									rowspan="2">Sr. No.</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Penetration
									Depth</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Proving
									Ring Dial Guage Reading <br>(PRGDR)</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Load (PT)
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove2"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove3"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove4"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove6"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove7"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove8"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove9"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove10"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove11"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove12"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove13"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove14"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove15"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove16"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove17"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove18"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove19"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove20"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove21"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove22"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove23"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["prove24"] ?></td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						...
						<table align="left" width="70%"
							...
							<tr>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">Total
									Standard <br>Load (PS)</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">CBR Value
									<br>PT/PS x 100</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">mm</td>
							...
							<tr>
								...
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">2.5</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["loadpt1"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["loadpt2"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["loadpt3"] ?></td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 3px;border: 1px solid;">
									<?php echo $cnt++; ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">5.0</td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["loadpt4"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["loadpt5"] ?></td>
								<td style="font-weight: bold;text-align: center;padding: 2px;border: 1px solid;">
									<?php echo $row_select_pipe["loadpt6"] ?></td>
							</tr>
						</table>
						<table align="right" width="20%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid; border-top:1px solid;">
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 6px;border: 1px solid;">Conversion
									Factors</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 6px;border: 1px solid;">1Kg/cm² =
									100 KPa</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 6px;border: 1px solid;">1KPa = 100
									KN/m²</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 7px;border: 1px solid;">1MPa =
									1N/mm²</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td>
						<table align="right" width="100%"
							style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid; border-top:1px solid;">
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px; border-right:0px; " colspan="3">
									Notes : (i) Air drying soil sample passing 19 mm sieve. If larger portion of sample is
									retained on 19 mm, replace it by an equal amount which passes 19 mm and is retained on
									4.75mm.</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px; border-right:0px;">(ii) Table -
									1 for Total Standard Load (PS)</td>
							</tr>
							<tr>
								<td style="font-weight: bold;text-align: center;padding: 6px;border: 1px solid;">Penetration
								</td>
								<td style="font-weight: bold;text-align: center;padding: 6px;border: 1px solid;">Unit
									Standard</td>
								<td style="font-weight: bold;text-align: center;padding: 6px;border: 1px solid;">Total
									Standard Load</td>
							</tr>
							<tr>
							...
							<tr>
								<td style="font-weight: bold;text-align: left;padding: 2px;" colspan="3">(iii) CBR Value at
									2.5 mm Penetration will be greater than 5.0 mm for design Purpose. If CBR Value exceed
									at 5.0 mm penetration then test shall be repeated. If Identical result follow the CBR
									Value at 5.0 mm Penetration shall be take for design./td>
							</tr>
						</table>
					</td>
				</tr>
	...
	<!--<table align="center" style="width: 95%;text-align: center;border:1px solid;font-family: 'calibri';font-size: 12px" cellspacing="0" cellpadding="2px">
				...
				<tr>
					<td style="text-align: center;font-weight: bold;font-size: 25px;" colspan="7">NextGenLIMS Technologies</td>
				</tr>
				<tr>
