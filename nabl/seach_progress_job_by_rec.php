...
<table id="example2" class="table table-bordered table-striped" style="width:100%;">
	...
	<tbody>
		...
		$query = "select * from job WHERE `jobisdeleted`=0 AND `any_report_done_by_any_qm`='0'AND `jobcreatedby_id`='$_SESSION[u_id]' " . $where . " ORDER BY job_id DESC";
		...
		?>
			<tr>
				<td style="text-align:center;">
					<!--<a href="edit_trf_by_rec.php?temporary_trf_no=<?php //echo $row['temporary_trf_no'];
																		?>" class="" title=""><span class="fa fa-edit"></span></a>-->
					<a href="edit_client_form.php?trf_no=<?php echo $row['job_id']; ?>" class="" title=""><span class="fa fa-edit"></span></a>
					&nbsp;&nbsp;
					<a href="update_span_material_assigning.php?temporary_trf_no=<?php echo $row['temporary_trf_no']; ?>" class="" title=""><span class="fa fa-list"></span></a>
					&nbsp;&nbsp;<a href="javascript:void(0);" class="delete_job_all" data-id="<?php echo $row['trf_no']; ?>" title=""><span class="fa fa-trash"></span></a>
