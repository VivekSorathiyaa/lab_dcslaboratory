...
<head>
    ...
    <title>NextGenLIMS Technologies tax invoice</title>
</head>
                ...
                if ($one_chk_array == $trf_no_array[$one_key]) {
                    ...
                    <tr align="center">
                        ...
                        <td
                            ...
                            <b>Inspection of <?php echo substr($one_mat, 0, 56); ?></b></td>
                        ...
                        <td
                            ...
                            <b><?php echo $material_qty_array[$one_key]; ?> No.</b></td>
                        <td
                            style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;text-align: right;  border-bottom: 0;">
                            <?php echo number_format(($material_rates_array[$one_key] + $material_rates_array[$one_key] * 0.18), 2); ?>
                        </td>
                        <td
                            style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;text-align: right;  border-bottom: 0;">
                            <?php echo $material_rates_array[$one_key]; ?></td>
                        ...
                        <td
                            ...
                            <b><?php echo $material_amnt_array[$one_key] . ".00"; ?></b></td>
                    </tr>
                    <tr>
