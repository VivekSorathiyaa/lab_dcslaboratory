...
<?php
    ...
    <table width="92%" cellspacing="0" style="margin-left: auto;margin-right: auto; border:1px solid black;">
            <tr>
                ...
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-right:0px;border-top:0px;width:20%;"><small>Proforma No</small></td>
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-top:0px;border-right:0px;width:20%;"><small>Dated</small></td>
            </tr>      
            <tr>
                <td style="font-size:13px;"colspan="2" rowspan="2"><?php echo $company_address ;?></td>
                <td style="font-size:12px;border:1px solid black;border-top:0px;border-bottom:0px;border-right:0px;"><b>A000092</b></td>
                <td style="font-size:12px;border:1px solid black;border-top:0px;border-bottom:0px;border-right:0px;"><b>23-Jan-25</b></td>
            </tr>       
            <tr>
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-right:0px;width:20%;"><small>Delivery Note</small></td>
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-right:0px;width:20%;"><small>Mode/Terms of Payment</small></td>
            </tr>      
            <tr>
                <td style="font-size:13px;"colspan="2">GSTIN/UIN: <?php echo $gst_no;?></td>
                <td style="font-size:12px;border:1px solid black;border-top:0px;border-bottom:0px;border-right:0px;"><b></b></td>
                <td style="font-size:12px;border:1px solid black;border-top:0px;border-bottom:0px;border-right:0px;"><b></b></td>
            </tr> 
            <tr>
                <td style="font-size:13px;"colspan="2">State Name :  Himachal Pradesh , Code : 02</td>
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-right:0px;width:20%;"><small>Reference No. & Date.</small></td>
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-right:0px;width:20%;"><small>Other References</small></td>
            </tr> 
            <tr>
            ...
            <tr>
                <td style="border-top: 1px solid black; vertical-align: top; " colspan="2"><small>Consignee (Ship to)</small></td>
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-right:0px;width:20%;"><small>Buyer's Order No.</small></td>
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-right:0px;width:20%;"><small>Dated</small></td>
            </tr> 
            <tr>
            ...
            <tr>
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-right:0px;width:20%;"><small>Dispatch Doc No.</small></td>
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-right:0px;width:20%;"><small>Delivery Note Date</small></td>
            </tr> 
            <tr>
            ...
            <tr>
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-right:0px;width:20%;"><small>Dispatched through</small></td>
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-right:0px;width:20%;"><small>Destination</small></td>
            </tr> 
            <tr>
                <td style="font-size:12px;border:1px solid black;border-top:0px;border-bottom:0px;border-right:0px;"><b></b></td>
                <td style="font-size:12px;border:1px solid black;border-top:0px;border-bottom:0px;border-right:0px;"><b></b></td>
            ...
            <tr>
                <td style="font-size:13px;"colspan="2">GSTIN/UIN :<?php echo $gst_no;?></td>
                <td style="font-size:12px;vertical-align:top;border:1px solid black;border-bottom:0px;border-right:0px;width:20%;" colspan="2"><small>Terms of Delivery</small></td>
                
            </tr> 
            <tr>
                <td style="font-size:13px;"colspan="2"> State Name :Himachal Pradesh, Code : 02</td>
                <td style="font-size:12px;border:1px solid black;border-top:0px;border-bottom:0px;border-right:0px;" rowspan="9"><b></b></td>
            </tr>
            <tr>
                <td style="border-top: 1px solid black; vertical-align: top;" colspan="2"><small>Buyer (Bill to)</small></td>
            </tr>
            <tr>
        ...
        <table width="92%" cellspacing="0" style="margin-left: auto; margin-right: auto;border: 1px solid; border-top:0px;">
            <tr align="center">
                <td style="font-size: 13px; vertical-align: top; border: 1px solid; border-top: 0px; border-left: 0px;">SI <br>no.</td>
                <td style="font-size: 13px; vertical-align: top; border: 1px solid; border-top: 0px; border-left: 0px;">Description of Services</td>
                <td style="font-size: 13px; vertical-align: top; border: 1px solid; border-top: 0px; border-left: 0px;">HSN/SAC</td>
                <td style="font-size: 13px; vertical-align: top; border: 1px solid; border-top: 0px; border-left: 0px;">Quantity</td>
                <td style="font-size: 13px; vertical-align: top; border: 1px solid; border-top: 0px; border-left: 0px;">Rate<br><small>(Incl. of Tax)</small></td>
                <td style="font-size: 13px; vertical-align: top; border: 1px solid; border-top: 0px; border-left: 0px;">Rate</td>
                <td style="font-size: 13px; vertical-align: top; border: 1px solid; border-top: 0px; border-left: 0px;">per</td>
                <td style="font-size: 13px; vertical-align: top; border: 1px solid; border-top: 0px; border-left: 0px; border-right: 0px;">Amount</td>
            </tr>
			<?php
			$now_array=array();
				 $contings=0;
				...
				foreach($explode_trf_no as $one_chk_array)
				{
					...
					?>
            <tr align="center">
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px; border-bottom: 0px;"><b><?php echo $one_key + 1; ?></b></td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;text-align: left; border-bottom: 0; "><b>Inspection of <?php echo substr($one_mat,0,56); ?></b></td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;  border-bottom: 0;">998346</td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;text-align: right;  border-bottom: 0;"><b><?php echo $material_qty_array[$one_key]; ?> No.</b></td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;text-align: right;  border-bottom: 0;"><?php echo number_format(($material_rates_array[$one_key] + $material_rates_array[$one_key] * 0.18),2); ?></td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;text-align: right;  border-bottom: 0;"><?php echo $material_rates_array[$one_key]; ?></td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;  border-bottom: 0;">No.</td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;text-align: right;  border-bottom: 0; border-right: 0px;"><b><?php echo $material_amnt_array[$one_key].".00"; ?></b></td>
            </tr>
            <tr>
                <td style="font-size: 13px; border-right: 1px solid; border-top: 0;"></td>
                <td style="font-size: 13px; border-top: 0px; border-right: 1px solid;"><small><i> <?php echo strip_tags($name_of_works);?></i></small></td>
			...
			<?php
				 ...
				 <tr>
                <td style="font-size: 13px; border-right: 1px solid; border-top: 0;"></td>
                <td style="font-size: 13px; border-top: 0px; border-right: 1px solid; text-align: right;"><b>Round off</b></td>
                <td style="border-right: 1px solid; border-top: 0;"></td>
                <td style="border-right: 1px solid; border-top: 0;"></td>
                <td style="border-right: 1px solid; border-top: 0;"></td>
                <td style="border-right: 1px solid; border-top: 0;"></td>
            ...
            <tr align="center">
                ...
                <td style="font-size: 13px; border: 1px solid;  border-left: 0px;text-align: right; border-bottom: 0; ">Total</td>
                <td style="font-size: 13px; border: 1px solid;  border-left: 0px;  border-bottom: 0;"></td>
                <td style="font-size: 13px; border: 1px solid;  border-left: 0px;text-align: right;  border-bottom: 0;"><b>1 No.</b></td>
                <td style="font-size: 13px; border: 1px solid;  border-left: 0px;text-align: right;  border-bottom: 0;"></td>
                <td style="font-size: 13px; border: 1px solid;  border-left: 0px;text-align: right;  border-bottom: 0;"></td>
                <td style="font-size: 13px; border: 1px solid;  border-left: 0px;  border-bottom: 0;"></td>
                <td style="font-size: 13px; border: 1px solid;  border-left: 0px;text-align: right;  border-bottom: 0; border-right: 0px;"><b>₹ <?php echo number_format($total_amt,2);?></b></td>
            </tr>
        </table>
        <table  width="92%" cellspacing="0" style="margin-left: auto; margin-right: auto;border: 1px solid; border-top:0px;">
            <tr>
            ...
            <tr>
                <td colspan="8" style="font-size: 13px;text-transform: uppercase;" ><b>INR <?php echo getIndianCurrency($total_amt);?></b></td>
                <td></td>
            </tr>
            <tr align="center">
                <td rowspan="2" style="border: 1px solid; border-left: 0px; border-bottom:0px; width: 41%;"><small>HSN/SAC</small></td>
                <td rowspan="2" style="border: 1px solid; border-left: 0px;  border-bottom:0px;"><small>Taxable <br>Value</small></td>
                <td colspan="2" style="border: 1px solid; border-left: 0px;  border-bottom:0px;"><small>CGST</small></td>
                <td colspan="2" style="border: 1px solid; border-left: 0px;  border-bottom:0px;"><small>SGST/UTGST</small></td>
                <td colspan="2" style="border: 1px solid; border-left: 0px;  border-bottom:0px;"><small>IGST</small></td>
                <td rowspan="2" style="border: 1px solid; border-left: 0px;  border-bottom:0px; border-right: 0px;"><small>Total<br>Tax Amount</small></td>
            </tr>
            <tr align="center">
            ...
            <tr align="center">
                ...
                <td style="border: 1px solid; border-left: 0px;  border-bottom:0px;"><small><?php echo $taxable_amnt;?></small></td>
                <td style="border: 1px solid; border-left: 0px;  border-bottom:0px;"><small>9%</small></td>
                <td style="border: 1px solid; border-left: 0px;  border-bottom:0px;"><small><?php echo $c_gst_amt;?></small></td>
                <td style="border: 1px solid; border-left: 0px;  border-bottom:0px;"><small>9%</small></td>
                <td style="border: 1px solid; border-left: 0px;  border-bottom:0px;"><small><?php echo $s_gst_amt;?></small></td>
				<td style="border: 1px solid; border-left: 0px;  border-bottom:0px;"><small>18%</small></td>
                <td style="border: 1px solid; border-left: 0px;  border-bottom:0px;"><small><?php echo $i_gst_amt;?></small></td>
            ...
            <tr align="center">
                <td  style="border: 1px solid; border-left: 0px;  width: 41%; text-align: right;"><small><b>Total</b></small></td>
            ...
            <tr>
                <td colspan="8" style="text-transform: uppercase;"><small>Tax Amount (in words)  : <b> INR <?php echo getIndianCurrency($gst_totals);?></b></small></td>
           </tr>
            <tr>
            ...
            <tr>
                <td><small>We declare that this invoice shows the actual price of the <br>Goods described and that all particulars are true and correct.</small></td>
            ...
            <tr>
                <td style="border: 1px solid; border-bottom: 0px; border-right: 0px; vertical-align:top;"><small>Customer's Seal and Signature</small></td>
                <td style="border: 1px solid; text-align: right; border-bottom: 0px; border-right: 0px;" colspan="8"><b><small>for DCS ENGINEERS AND CONSULTANT PVT LTD</small></b><br><bR><br><br><bR><br></td>
            </tr>
            <tr>
