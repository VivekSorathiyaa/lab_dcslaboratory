...
if(isset($_POST['action_type']) && !empty($_POST['action_type'])){
	...
	}else if($_POST['action_type'] == 'add_estimate_only_for_material')
	{
		...
		}else
		{
			...
			$todays=date("Y-m-d");
			$insert_sequence="insert into estimate_total_span_bill_sequence(`temporary_trf_no`,`trf_no`,`job_no`,`bill_no`,`estimate_type`,`estimate_date`,`created_date`,`created_by`,`created_name`) values('$txt_temporary_trf_no','$txt_trf_no','$txt_job_no','$set_bill_no','for_material','$invoice_date','$todays','$_SESSION[u_id]','$_SESSION[name]')";
