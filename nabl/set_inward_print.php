...
?>
<table align="center"
	style="width: 99%;text-align: center;border:1px solid black;font-family: 'calibri';font-size: 12px" cellspacing="0"
	cellpadding="2px" bordercolor="black">
	<tr>
		<td style="width: 20%;text-align: center;font-weight: bolder;border-right: 1px solid;" rowspan="5"><img
				src="../images/mat_logo.png" style="height: 100px;width:120px;background-blend-mode: multiply;"></td>

	</tr>
	<tr>
		<td style="text-align: center;font-weight: bold;font-family: 'calibri';font-size: 25px;" colspan="13">
			NextGenLIMS Technologies</td>
	</tr>

	<tr>
		<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 14px;" colspan="13"><b>Regd.
				Office : </b>VPO Taragarh (Rani Di K) Near Taragarh Palace Tehsil Baijnath</td>
	</tr>
	<tr>
		<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 14px;" colspan="13">District
			Kangra Himachal Pradesh (176081)</td>
	</tr>
	<tr>
		<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 13px;" colspan="13">Mobile :
			+91-7018819894, +91-7833853738,e-mail : officialdcspvtltd@gmail.com
			<br>
			<br>
			<span style="text-align: center;font-weight: bold;font-family: 'calibri';font-size: 25px;">SAMPLE ENTRY
				REGISTER (C.S.C.)</span>
		</td>
	</tr>
	...
	<tbody>
		...
		while ($row = mysqli_fetch_array($result)) {
			...
			<tr>
				...
				<td>
					<a href="print_receipt.php?trf_no=<?php echo $row['trf_no']; ?>&&job_no=<?php echo $row['job_number']; ?>&&temporary_trf_no=<?php echo $row['temporary_trf_no']; ?>"
				...
				<td style="white-space:nowrap;"><?php echo $get_agency['agency_name'] . " , " . $get_agency['agency_address']; ?>
				</td>
