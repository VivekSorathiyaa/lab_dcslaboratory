...
if (isset($_POST['action_type']) && !empty($_POST['action_type'])) {
	if ($_POST['action_type'] == 'data') {
		$get_query = "select * from sdbc_4_75_2_36_mm WHERE id='$_POST[id]' AND `is_deleted`='0'";
			...
			<div class="row">
				<div class="col-lg-12">
					<table border="1px solid black" align="center" width="100%" id="aaaa">
						...
						<?php
						$query = "select * from sdbc_4_75_2_36_mm WHERE lab_no='$lab_no' and `is_deleted`='0'";
...
<?php
		...
		$update = "update `sdbc_4_75_2_36_mm` SET `job_no`='$_POST[job_no]',`lab_no`='$_POST[lab_no]',`report_no`='$_POST[report_no]',
		`ulr`='$_POST[ulr]',
		`chk_grd`='$_POST[chk_grd]',
      `sieve_1`='$_POST[sieve_1]',
      `sieve_2`='$_POST[sieve_2]',
	  ...
	  `checked_by`=NULL WHERE `id`='$_POST[idEdit]'";
		...
		$delete = "update sdbc_4_75_2_36_mm SET `is_deleted`='1',`deleted_by`='$_SESSION[name]' WHERE `report_no`='$_POST[report_no]' and `lab_no`='$_POST[lab_no]' and `job_no`='$_POST[job_no]'";
		...
		$qry = "SELECT * FROM sdbc_4_75_2_36_mm WHERE `id`='$_POST[id]'";
		$arr = mysqli_query($conn, $qry);
		$rows1 = mysqli_num_rows($arr);
		while ($r2 = mysqli_fetch_array($arr)) {
			if ($r2['checked_by'] != "") {
				$c1c = "update sdbc_4_75_2_36_mm SET `checked_by`='' WHERE `id`='$_POST[id]'";
				$result_of_delete1 = mysqli_query($conn, $cc);
			} else {
				$cc = "update sdbc_4_75_2_36_mm SET `checked_by`='$_SESSION[name]' WHERE `id`='$_POST[id]'";
