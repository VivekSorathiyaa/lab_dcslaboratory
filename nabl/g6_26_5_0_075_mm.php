			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">GSB - VI MIX (M5)</h2>
					</div>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-sm-1">
												...
												<?php   
													$querys_job1 = "SELECT * FROM gsb_mix_6_m5 WHERE `is_deleted`='0' and lab_no='$lab_no'";
											...
											<?php //} ?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_gsb_1_mix_m5.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&tbl_name=gsb_mix_6_m5" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
					...
					<div class="col-lg-12">
						<table border="1px solid black" align="center" width="100%" id="aaaa">
							<tr>
								...
								<?php
							 $query = "select * from gsb_mix_6_m5 WHERE lab_no='$aa'  and `is_deleted`='0'";
...
function getGlazedTiles(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo $base_url; ?>saveg6_26_5_0_075_mm.php',
