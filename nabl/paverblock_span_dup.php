							...
							<div class="row">
								...
								<div class="col-lg-3">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" class="form-control inputs" tabindex="4" id="lab_no" value="" name="lab_no">
										</div>
									</div>
								</div>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group">
										...
										?>
											<div class="col-sm-2">
												<a target='_blank' href="<?php echo $base_url; ?>print_report/span_paver_block.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

											</div>

										<?php } ?>
										<div class="col-sm-2">
											<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_paverblock_span.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
												...
												<div id="collapse5" class="panel-collapse collapse">
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Weight of Standard Card Board (100 mm X 200 mm) (gm)</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Weight of Sample Card Board (gm)</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Length of Sample Card Board (mm)</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Width of Sample Card Board (mm)</label>
																</div>
															</div>

															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Weight of Paverblock (gm)</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Thickness (mm) thick</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Area (mm 2 )</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Compressive Strength (load/Area) (N/mm 1 )</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Correction factor for thickness &amp; block type (table 5)</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Corrected Compressive Strength (N/mm 2)</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Sample Mark</label>
																</div>
															</div>
														</div>
														...
														<div class="row">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="clen1" name="clen1">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cwid1" name="cwid1">
																</div>
															</div>

															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="grade_1" name="grade_1">
																</div>
															</div>
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="factor_1" name="factor_1">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" id="sm1" name="sm1">
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="clen2" name="clen2">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cwid2" name="cwid2">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="grade_2" name="grade_2">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="thick_2" name="thick_2">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="factor_2" name="factor_2">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" id="sm2" name="sm2">
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="clen3" name="clen3">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cwid3" name="cwid3">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="grade_3" name="grade_3">
																</div>
															</div>

															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="thick_3" name="thick_3">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="factor_3" name="factor_3">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" id="sm3" name="sm3">
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="clen4" name="clen4">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cwid4" name="cwid4">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="grade_4" name="grade_4">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="thick_4" name="thick_4">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="factor_4" name="factor_4">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" id="sm4" name="sm4">
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="clen5" name="clen5">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cwid5" name="cwid5">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="grade_5" name="grade_5">
																</div>
															</div>

															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="thick_5" name="thick_5">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="factor_5" name="factor_5">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" id="sm5" name="sm5">
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="clen6" name="clen6">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cwid6" name="cwid6">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="grade_6" name="grade_6">
																</div>
															</div>

															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="thick_6" name="thick_6">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="factor_6" name="factor_6">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" id="sm6" name="sm6">
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="clen7" name="clen7">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cwid7" name="cwid7">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="grade_7" name="grade_7">
																</div>
															</div>

															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="thick_7" name="thick_7">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="factor_7" name="factor_7">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" id="sm7" name="sm7">
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="clen8" name="clen8">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cwid8" name="cwid8">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="grade_8" name="grade_8">
																</div>
															</div>

															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="thick_8" name="thick_8">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="factor_8" name="factor_8">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	...
																	<input type="text" class="form-control" id="sm8" name="sm8">
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-1">
																<input type="text" class="form-control" id="avg_corr" name="avg_corr">
															</div>
															<div class="col-md-1">
												...
												<div id="collapse2" class="panel-collapse collapse">
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Weight of sample after saturation(gm) (W1)</label>
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Weight of Oven dry sample (gm) (W2)</label>
																</div>
															</div>

															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Water Absorption (%) (W1 – W2) x 100/W2</label>
																</div>
															</div>
															<div class="col-md-2">
													...
													<div class="panel-body">
														<div class="row">
															...
															<div class="col-lg-8">
																<div class="form-group">
																	<div class="col-sm-1">
																		<label for="chk_abr">3.</label>
																		<input type="checkbox" class="visually-hidden" name="chk_abr" id="chk_abr" value="chk_abr"><br>
																	</div>
																	<label for="inputEmail3" class="col-sm-4 control-label label-right">ABRASION TEST</label>
																</div>
															</div>
														...
														<div class="row">
															<div class="col-md-12">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Dry Abrasion Resistance, mm<sup>3</sup></label>
																</div>
															</div>
														</div>
														...
														<div class="row">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">W</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Input Weight, gm</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Output Weight, gm</label>
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">&#8710;m = Loss in mass after 16 cycle, in g</label>
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">PR = Density of the specimen or in the case of two-layer specimens, the density of the wearing layer, in g/mm<sup>3</sup></label>
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">&#8710;V = Loss in volume after 16 cycle, in mm<sup>3</sup></label>
																</div>
															</div>
														...
														<div class="row">
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="sm9" name="sm9">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="im1" name="im1">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="om1" name="om1">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="lm1" name="lm1">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="pr1" name="pr1">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
														...
														<div class="row">
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="sm10" name="sm10">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="im2" name="im2">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="om2" name="om2">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="lm2" name="lm2">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="pr2" name="pr2">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
														...
														<div class="row">
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="sm11" name="sm11">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="im3" name="im3">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="om3" name="om3">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="lm3" name="lm3">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="pr3" name="pr3">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
														...
														<div class="row">
															...
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="avgv" name="avgv">
																</div>
															</div>
														...
														<div class="row">
															<div class="col-md-12">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Wet Abrasion Resistance, mm<sup>3</sup></label>
																</div>
															</div>
														</div>
														...
														<div class="row">
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="sm12" name="sm12">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="im4" name="im4">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="om4" name="om4">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="lm4" name="lm4">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="pr4" name="pr4">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
														...
														<div class="row">
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="sm13" name="sm13">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="im5" name="im5">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="om5" name="om5">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="lm5" name="lm5">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="pr5" name="pr5">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
														...
														<div class="row">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="im6" name="im6">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="om6" name="om6">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="lm6" name="lm6">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="pr6" name="pr6">
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="v6" name="v6">
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-md-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="avgv2" name="avgv2">
																</div>
															</div>
												...
												<div id="collapse51" class="panel-collapse collapse">
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Thickness Measure 1</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Thickness Measure 2</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Thickness Measure 3</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Thickness of Paver block</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Failure Length Measure 1</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Failure Length Measure 2</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Failure Length, mm</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Area of Failure, mm<sup>2</sup></label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Load, kN</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Tensile Splitting Strength(T), Mpa</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Failure Load(F), N/mm</label>
																</div>
															</div>
												...
												<div id="collapse512" class="panel-collapse collapse">
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-md-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Distance between Roller, mm</label>
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
															...
															<div class="col-md-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Flexural Strength Mpa</label>
																</div>
															</div>
	...
	$(document).ready(function() {
		...
		$('#ar1,#ar2').change(function() {
			...
			if (we1 == "" || we1 == null || we1 == "0") {
				var ans = (+arr1) * (+thickness) * (+0.00250);
				$('#wt1').val(ans.toFixed());
				$('#ar2').val((+arr1) + (+100));

				var arr21 = $('#ar2').val();
				var ans21 = (+arr21) * (+thickness) * (+0.00250);
				$('#wt2').val(ans21.toFixed());
			}

			/*if(we2=="" ||we2==null ||we2=="0")
	   {
		   var ans2 = (+arr2) * (+thickness) * (+0.00250);
		...
		function check_wtr() {
			...
			if (thickness == "60") {
				...
				if (rnad % 2 == 0) {
					...
					wtr_w2_4 = (+wtr_w2_3) + (+randomNumberFromRange(-70, 70).toFixed());
				} else {
					var wt1 = $('#wt1').val();
					var wt2 = $('#wt2').val();
				...
				if (rnad % 2 == 0) {
					...
					wtr_w2_4 = (+wtr_w2_1) + (+randomNumberFromRange(-70, 70).toFixed());
				} else {
					var wt1 = $('#wt1').val();
					var wt2 = $('#wt2').val();
					wtr_w2_3 = randomNumberFromRange((+wt1), (+wt2)).toFixed();
		...
		function wtr_func() {
			...
			if ($("#chk_wtr").is(':checked')) {
				...
				wtr_w1_4 = ((((+wtr_4) / 100) * (+wtr_w2_4)) + (+wtr_w2_4));

				$('#wtr_w1_1').val(wtr_w1_1.toFixed());
				$('#wtr_w1_2').val(wtr_w1_2.toFixed());
				$('#wtr_w1_3').val(wtr_w1_3.toFixed());
				$('#wtr_w1_4').val(wtr_w1_4.toFixed());
			...
			if ($("#chk_wtr").is(':checked')) {
				...
				if (thickness == "60") {
					...
					if (rnad % 2 == 0) {
						...
						wtr_w2_1 = (+wtr_w2_3) + (+randomNumberFromRange(-70, 70).toFixed());
						wtr_w2_2 = (+wtr_w2_3) + (+randomNumberFromRange(-70, 70).toFixed());
						wtr_w2_4 = (+wtr_w2_4) + (+randomNumberFromRange(-70, 70).toFixed());
					}
		...
		var clen1, clen2, clen3, clen4, clen5, clen6, clen7, clen8;
		var cwid1, cwid2, cwid3, cwid4, cwid5, cwid6, cwid7, cwid8;
		...
		$('#thick_1').val((+thickness) + (+randomNumberFromRange(-2, 2).toFixed()));
		$('#thick_2').val((+thickness) + (+randomNumberFromRange(-2, 2).toFixed()));
		$('#thick_3').val((+thickness) + (+randomNumberFromRange(-2, 2).toFixed()));
		$('#thick_4').val((+thickness) + (+randomNumberFromRange(-2, 2).toFixed()));
		$('#thick_5').val((+thickness) + (+randomNumberFromRange(-2, 2).toFixed()));
		$('#thick_6').val((+thickness) + (+randomNumberFromRange(-2, 2).toFixed()));
		$('#thick_7').val((+thickness) + (+randomNumberFromRange(-2, 2).toFixed()));
		$('#thick_8').val((+thickness) + (+randomNumberFromRange(-2, 2).toFixed()));

		var wt1 = $('#wt1').val();
		var wt2 = $('#wt2').val();
		var grade_1 = randomNumberFromRange((+wt1), (+wt2)).toFixed();
		var grade_2 = randomNumberFromRange((+wt1), (+wt2)).toFixed();
		var grade_3 = randomNumberFromRange((+wt1), (+wt2)).toFixed();
		var grade_4 = randomNumberFromRange((+wt1), (+wt2)).toFixed();
		var grade_5 = randomNumberFromRange((+wt1), (+wt2)).toFixed();
		var grade_6 = randomNumberFromRange((+wt1), (+wt2)).toFixed();
		var grade_7 = randomNumberFromRange((+wt1), (+wt2)).toFixed();
		var grade_8 = randomNumberFromRange((+wt1), (+wt2)).toFixed();
		$('#grade_1').val(grade_1);
		$('#grade_2').val(grade_2);
		$('#grade_3').val(grade_3);
		$('#grade_4').val(grade_4);
		...
		$('#lab_1,#m1').change(function() {
			...
			$('#m7').val(m1);
			$('#m8').val(m1);
			$('#area_2').val(area_1.toFixed());
			$('#area_3').val(area_1.toFixed());
			$('#area_4').val(area_1.toFixed());
			$('#area_5').val(area_1.toFixed());
			$('#area_6').val(area_1.toFixed());
			$('#area_7').val(area_1.toFixed());
			$('#area_8').val(area_1.toFixed());
			area_load();


		});

		$('#lab_2,#m2').change(function() {
			$('#txtcom').css("background-color", "var(--success)");
		...
		if (type == 'add') {
			...
			for (var i = 0; i < aa.length; i++) {
				if (aa[i] == "com") {
					...
					var grade_2 = $('#grade_2').val();
					var grade_3 = $('#grade_3').val();
					var grade_4 = $('#grade_4').val();
					var grade_5 = $('#grade_5').val();
					var grade_6 = $('#grade_6').val();
					var grade_7 = $('#grade_7').val();
					var grade_8 = $('#grade_8').val();
			...
			billData = $("#Glazed").find('.form').serialize() + '&action_type=' + type + '&idEdit=' + idEdit + '&report_no=' + report_no + '&job_no=' + job_no + '&lab_no=' + lab_no + '&chk_com=' + chk_com + '&wtr_w1_1=' + wtr_w1_1 + '&wtr_w1_2=' + wtr_w1_2 + '&wtr_w1_3=' + wtr_w1_3 + '&wtr_w1_4=' + wtr_w1_4 + '&wtr_w2_1=' + wtr_w2_1 + '&wtr_w2_2=' + wtr_w2_2 + '&wtr_w2_3=' + wtr_w2_3 + '&wtr_w2_4=' + wtr_w2_4 + '&wtr_1=' + wtr_1 + '&wtr_2=' + wtr_2 + '&wtr_3=' + wtr_3 + '&wtr_4=' + wtr_4 + '&avg_wtr=' + avg_wtr + '&paver_shape=' + paver_shape + '&paver_age=' + paver_age + '&paver_color=' + paver_color + '&paver_thickness=' + paver_thickness + '&paver_grade=' + paver_grade + '&lab_1=' + lab_1 + '&lab_2=' + lab_2 + '&lab_3=' + lab_3 + '&lab_4=' + lab_4 + '&lab_5=' + lab_5 + '&lab_6=' + lab_6 + '&lab_7=' + lab_7 + '&lab_8=' + lab_8 + '&m1=' + m1 + '&m2=' + m2 + '&m3=' + m3 + '&m4=' + m4 + '&m5=' + m5 + '&m6=' + m6 + '&m7=' + m7 + '&m8=' + m8 + '&clen1=' + clen1 + '&clen2=' + clen2 + '&clen3=' + clen3 + '&clen4=' + clen4 + '&clen5=' + clen5 + '&clen6=' + clen6 + '&clen7=' + clen7 + '&clen8=' + clen8 + '&cwid1=' + cwid1 + '&cwid2=' + cwid2 + '&cwid3=' + cwid3 + '&cwid4=' + cwid4 + '&cwid5=' + cwid5 + '&cwid6=' + cwid6 + '&cwid7=' + cwid7 + '&cwid8=' + cwid8 + '&grade=' + grade + '&thick=' + thick + '&area_1=' + area_1 + '&area_2=' + area_2 + '&area_3=' + area_3 + '&area_4=' + area_4 + '&area_5=' + area_5 + '&area_6=' + area_6 + '&area_7=' + area_7 + '&area_8=' + area_8 + '&load_1=' + load_1 + '&load_2=' + load_2 + '&load_3=' + load_3 + '&load_4=' + load_4 + '&load_5=' + load_5 + '&load_6=' + load_6 + '&load_7=' + load_7 + '&load_8=' + load_8 + '&com_1=' + com_1 + '&com_2=' + com_2 + '&com_3=' + com_3 + '&com_4=' + com_4 + '&com_5=' + com_5 + '&com_6=' + com_6 + '&com_7=' + com_7 + '&com_8=' + com_8 + '&factor=' + factor + '&corr_1=' + corr_1 + '&corr_2=' + corr_2 + '&corr_3=' + corr_3 + '&corr_4=' + corr_4 + '&corr_5=' + corr_5 + '&corr_6=' + corr_6 + '&corr_7=' + corr_7 + '&corr_8=' + corr_8 + '&avg_corr=' + avg_corr + '&den_1=' + den_1 + '&den_2=' + den_2 + '&den_3=' + den_3 + '&den_4=' + den_4 + '&den_5=' + den_5 + '&den_6=' + den_6 + '&den_7=' + den_7 + '&den_8=' + den_8 + '&avg_den=' + avg_den + '&chk_wtr=' + chk_wtr + '&ulr=' + ulr + '&sm1=' + sm1 + '&sm2=' + sm2 + '&sm3=' + sm3 + '&sm4=' + sm4 + '&sm5=' + sm5 + '&sm6=' + sm6 + '&sm7=' + sm7 + '&sm8=' + sm8 + '&sm9=' + sm9 + '&sm10=' + sm10 + '&sm11=' + sm11 + '&sm12=' + sm12 + '&sm13=' + sm13 + '&sm14=' + sm14 + '&sm15=' + sm15 + '&sm16=' + sm16 + '&sm17=' + sm17 + '&sm18=' + sm18 + '&sm19=' + sm19 + '&sm20=' + sm20 + '&sm21=' + sm21 + '&sm22=' + sm22 + '&sm23=' + sm23 + '&sm24=' + sm24 + '&sm25=' + sm25 + '&sm26=' + sm26 + '&sm27=' + sm27 + '&sm28=' + sm28 + '&sm29=' + sm29 + '&sm30=' + sm30 + '&chk_abr=' + chk_abr + '&l1=' + l1 + '&l2=' + l2 + '&l3=' + l3 + '&l4=' + l4 + '&l5=' + l5 + '&l6=' + l6 + '&w1=' + w1 + '&w2=' + w2 + '&w3=' + w3 + '&w4=' + w4 + '&w5=' + w5 + '&w6=' + w6 + '&im1=' + im1 + '&im2=' + im2 + '&im3=' + im3 + '&im4=' + im4 + '&im5=' + im5 + '&im6=' + im6 + '&om1=' + om1 + '&om2=' + om2 + '&om3=' + om3 + '&om4=' + om4 + '&om5=' + om5 + '&om6=' + om6 + '&lm1=' + lm1 + '&lm2=' + lm2 + '&lm3=' + lm3 + '&lm4=' + lm4 + '&lm5=' + lm5 + '&lm6=' + lm6 + '&pr1=' + pr1 + '&pr2=' + pr2 + '&pr3=' + pr3 + '&pr4=' + pr4 + '&pr5=' + pr5 + '&pr6=' + pr6 + '&v1=' + v1 + '&v2=' + v2 + '&v3=' + v3 + '&v4=' + v4 + '&v5=' + v5 + '&v6=' + v6 + '&avgv=' + avgv + '&avgv2=' + avgv2 + '&chk_ten=' + chk_ten + '&t11=' + t11 + '&t12=' + t12 + '&t13=' + t13 + '&t14=' + t14 + '&t15=' + t15 + '&t16=' + t16 + '&t17=' + t17 + '&t18=' + t18 + '&t21=' + t21 + '&t22=' + t22 + '&t23=' + t23 + '&t24=' + t24 + '&t25=' + t25 + '&t26=' + t26 + '&t27=' + t27 + '&t28=' + t28 + '&t31=' + t31 + '&t32=' + t32 + '&t33=' + t33 + '&t34=' + t34 + '&t35=' + t35 + '&t36=' + t36 + '&t37=' + t37 + '&t38=' + t38 + '&avgt1=' + avgt1 + '&avgt2=' + avgt2 + '&avgt3=' + avgt3 + '&avgt4=' + avgt4 + '&avgt5=' + avgt5 + '&avgt6=' + avgt6 + '&avgt7=' + avgt7 + '&avgt8=' + avgt8 + '&f11=' + f11 + '&f12=' + f12 + '&f13=' + f13 + '&f14=' + f14 + '&f15=' + f15 + '&f16=' + f16 + '&f17=' + f17 + '&f18=' + f18 + '&f21=' + f21 + '&f22=' + f22 + '&f23=' + f23 + '&f24=' + f24 + '&f25=' + f25 + '&f26=' + f26 + '&f27=' + f27 + '&f28=' + f28 + '&avgf1=' + avgf1 + '&avgf2=' + avgf2 + '&avgf3=' + avgf3 + '&avgf4=' + avgf4 + '&avgf5=' + avgf5 + '&avgf6=' + avgf6 + '&avgf7=' + avgf7 + '&avgf8=' + avgf8 + '&farea1=' + farea1 + '&farea2=' + farea2 + '&farea3=' + farea3 + '&farea4=' + farea4 + '&farea5=' + farea5 + '&farea6=' + farea6 + '&farea7=' + farea7 + '&farea8=' + farea8 + '&spload1=' + spload1 + '&spload2=' + spload2 + '&spload3=' + spload3 + '&spload4=' + spload4 + '&spload5=' + spload5 + '&spload6=' + spload6 + '&spload7=' + spload7 + '&spload8=' + spload8 + '&sten1=' + sten1 + '&sten2=' + sten2 + '&sten3=' + sten3 + '&sten4=' + sten4 + '&sten5=' + sten5 + '&sten6=' + sten6 + '&sten7=' + sten7 + '&sten8=' + sten8 + '&fload1=' + fload1 + '&fload2=' + fload2 + '&fload3=' + fload3 + '&fload4=' + fload4 + '&fload5=' + fload5 + '&fload6=' + fload6 + '&fload7=' + fload7 + '&fload8=' + fload8 + '&avg_tensile=' + avg_tensile + '&avg_load=' + avg_load + '&chk_fle=' + chk_fle + '&flen1=' + flen1 + '&flen2=' + flen2 + '&flen3=' + flen3 + '&flen4=' + flen4 + '&flen5=' + flen5 + '&flen6=' + flen6 + '&flen7=' + flen7 + '&flen8=' + flen8 + '&fwid1=' + fwid1 + '&fwid2=' + fwid2 + '&fwid3=' + fwid3 + '&fwid4=' + fwid4 + '&fwid5=' + fwid5 + '&fwid6=' + fwid6 + '&fwid7=' + fwid7 + '&fwid8=' + fwid8 + '&fthk1=' + fthk1 + '&fthk2=' + fthk2 + '&fthk3=' + fthk3 + '&fthk4=' + fthk4 + '&fthk5=' + fthk5 + '&fthk6=' + fthk6 + '&fthk7=' + fthk7 + '&fthk8=' + fthk8 + '&fdis1=' + fdis1 + '&fdis2=' + fdis2 + '&fdis3=' + fdis3 + '&fdis4=' + fdis4 + '&fdis5=' + fdis5 + '&fdis6=' + fdis6 + '&fdis7=' + fdis7 + '&fdis8=' + fdis8 + '&floa1=' + floa1 + '&floa2=' + floa2 + '&floa3=' + floa3 + '&floa4=' + floa4 + '&floa5=' + floa5 + '&floa6=' + floa6 + '&floa7=' + floa7 + '&floa8=' + floa8 + '&fle1=' + fle1 + '&fle2=' + fle2 + '&fle3=' + fle3 + '&fle4=' + fle4 + '&fle5=' + fle5 + '&fle6=' + fle6 + '&fle7=' + fle7 + '&fle8=' + fle8 + '&avg_fle=' + avg_fle + '&grade_1=' + grade_1 + '&grade_2=' + grade_2 + '&grade_3=' + grade_3 + '&grade_4=' + grade_4 + '&grade_5=' + grade_5 + '&grade_6=' + grade_6 + '&grade_7=' + grade_7 + '&grade_8=' + grade_8 + '&thick_1=' + thick_1 + '&thick_2=' + thick_2 + '&thick_3=' + thick_3 + '&thick_4=' + thick_4 + '&thick_5=' + thick_5 + '&thick_6=' + thick_6 + '&thick_7=' + thick_7 + '&thick_8=' + thick_8;
			...
			success: function(data) {
				...
				for (var i = 0; i < aa.length; i++) {
					if (aa[i] == "com") {
						...
						$('#clen1').val(data.clen1);
						$('#clen2').val(data.clen2);
						$('#clen3').val(data.clen3);
						$('#clen4').val(data.clen4);
						$('#clen5').val(data.clen5);
						$('#clen6').val(data.clen6);
						$('#clen7').val(data.clen7);
						$('#clen8').val(data.clen8);

						$('#cwid1').val(data.cwid1);
						$('#cwid2').val(data.cwid2);
						$('#cwid3').val(data.cwid3);
						$('#cwid4').val(data.cwid4);
						$('#cwid5').val(data.cwid5);
						$('#cwid6').val(data.cwid6);
						$('#cwid7').val(data.cwid7);
						$('#cwid8').val(data.cwid8);



						$('#grade_1').val(data.grade_1);
						$('#grade_2').val(data.grade_2);
						$('#grade_3').val(data.grade_3);
						$('#grade_4').val(data.grade_4);
						$('#grade_5').val(data.grade_5);
						$('#grade_6').val(data.grade_6);
						$('#grade_7').val(data.grade_7);
						$('#grade_8').val(data.grade_8);

						$('#thick_1').val(data.thick_1);
						$('#thick_2').val(data.thick_2);
						$('#thick_3').val(data.thick_3);
						$('#thick_4').val(data.thick_4);
						$('#thick_5').val(data.thick_5);
						$('#thick_6').val(data.thick_6);
						$('#thick_7').val(data.thick_7);
						$('#thick_8').val(data.thick_8);
