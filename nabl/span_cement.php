								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										?>
                                           ...
                                           <div class="col-sm-2">
 													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report_blank/print_span_cement_physics.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&ulr=<?php echo $ulr; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Calculation Blank</b></a>

 												</div>-->
                                     <!--<div class="col-sm-2">
												<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_cement1.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info" id="btn_report" name="btn_report"><b>obs working progres</b></a>
										...
										<?php// } ?>
										<div class="col-sm-2">
											<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_cement1.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
											<!--<a target = '_blank' href="<? php // echo $base_url; 
														...
														<div class="panel-body">
															...
															<div class="row">
																...
																<div class="col-lg-3">
																	<div class="form-group">
																		<div class="col-sm-12">
																			<label for="inputEmail3" class="col-sm-2 control-label">Weight of water (cc)</label>
																		</div>
																	</div>
																</div>
																<div class="col-lg-3">
																	<div class="form-group">
																		<div class="col-sm-12">
																			<label for="inputEmail3" class="col-sm-2 control-label">% of Water</label>
																		</div>
																	</div>
																</div>
																<div class="col-lg-3">
																	<div class="form-group">
																		<div class="col-sm-12">
																			<label for="inputEmail3" class="col-sm-2 control-label">Reading on Vicat (mm)</label>
																		</div>
																	</div>
																</div>
																<div class="col-lg-3">
														...
														<div class="panel-body">
															...
															<div class="row">
																<div class="col-lg-8">
																	<div class="form-group">
																		<div class="col-sm-12">
																			<label for="inputEmail3" class="control-label">Weight of Cement : - 64 gm</label>
																		</div>
																	</div>
																</div>
																<div class="col-lg-2">
															...
															<div class="row">
																...
																<div class="col-lg-3">
																	<div class="form-group">
																		<div class="col-sm-12">
																			<label for="inputEmail3" class="control-label">Mass of Cement in Gram</label>
																		</div>
																	</div>
																</div>
															</div>
															...
															<div class="row">
																...
																<div class="col-lg-3">
																	<div class="form-group">
																		<div class="col-sm-12">
																			<label for="inputEmail3" class="control-label">Displaced Volume in cm 3</label>
																		</div>
																	</div>
																</div>
																<div class="col-lg-2">
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div class="col-lg-4">
											<div class="form-group">
												<div class="col-sm-12">
													<input type="hidden" class="form-control" id="d_t_3" name="d_t_3" >
												</div>
											</div>
										</div>																	
									</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div class="col-lg-4">
											<div class="form-group">
												<div class="col-sm-12">
													<input type="hidden" class="form-control" id="w_t_3" name="w_t_3" >
												</div>
											</div>
										</div>																	
									</div>
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div class="col-lg-4">
											<div class="form-group">
												<div class="col-sm-12">
													<input type="hidden" class="form-control" id="c_t_3" name="c_t_3" >
												</div>
											</div>
										</div>																	
									</div>
...
<script>
	...
	$(document).ready(function() {
		...
		function fines_auto() {
			...
			/* var ss_area_1 = randomNumberFromRange(3.400,3.600).toFixed(3);
		$('#ss_area_1').val(ss_area_1);
		var ss_area_1  = $('#ss_area_1').val();
		
		var aa = randomNumberFromRange(1,3).toFixed(1);
		
		var c_t_1 = (+ss_area_1) - (+aa); 
		var c_t_2 = (+ss_area_1) + (+aa);
		...
		var d_t_1 = randomNumberFromRange(100,100).toFixed(0);
		$('#d_t_1').val(d_t_1);            
		var d_t1 = $('#d_t_1').val(); 
		
		var d_t_2 = randomNumberFromRange(100,100).toFixed(0);
		$('#d_t_2').val(d_t_2);
		var d_t2 = $('#d_t_2').val();
		
		var slp_s1_2 = ((+c_t_1) * (+d_t1)) / (+100);
		var slp_s2_2 =((+c_t_2) * (+d_t2)) / (+100);
		...
		var c_t_1 = ((+slp_s1_2) / (+slp_s1_1)) * (+100);
		var c_t_2 =((+slp_s2_2) / (+d_t_2)) * (+100);
		$('#c_t_1').val(c_t_1.toFixed(2));
		$('#c_t_2').val(c_t_2.toFixed(2));
		
		var c_t_1 = $('#c_t_1').val();
		var c_t_2 = $('#c_t_2').val();
		
		var ss_area_1 =((+c_t_1) + (+c_t_2)) / (+2);
		$('#ss_area_1').val(ss_area_1.toFixed(2)); */
	 ...
	 function  slp_auto()
	{
		...
		var c_t_1 = ((+slp_s1_2) / (+slp_s1_1)) * (+100);
		var c_t_2 =((+slp_s2_2) / (+d_t_2)) * (+100);
		$('#c_t_1').val(c_t_1.toFixed(1));
		$('#c_t_2').val(c_t_2.toFixed(1));
		
		var c_t_1 = $('#c_t_1').val();	
		var c_t_2 = $('#c_t_2').val();
		
		var ss_area_1 =((+c_t_1) + (+c_t_2)) / (+2);
		$('#ss_area_1').val(ss_area_1.toFixed(3));
	...
	$('#d_t_1,#d_t_2,#w_t_1,#w_t_2').change(function(){
		...
		var c_t_1 = ((+w_t_1) / (+d_t_1)) * (+100);
		var c_t_2 =((+w_t_2) / (+d_t_2)) * (+100);
		$('#c_t_1').val(c_t_1.toFixed(1));
		$('#c_t_2').val(c_t_2.toFixed(1));
