...
$sel_estiamte = "select * from estimate_total_span_only_for_material where `trf_no`='$txt_trf_no' AND `job_no`='$txt_jobs'";
					...
					<div class="box-body" style="border:1px groove #ddd;">
						...
						<div class="row">
							...
							<div class="col-sm-3">
								...
								<input type="text" class="form-control" value="<?php echo $txt_trf_no; ?>" id="txt_invoice_no" name="txt_invoice_no" disabled>
							</div>
						...
						<div class="box box-info">
							...
							<div class="row">
								...
								<div class="col-md-3">
									...
									<a href="matt_invoice_bill_by_material_print.php?trf_no=<?php echo $txt_trf_no; ?>&&job_no=<?php echo $txt_jobs; ?>" class="btn btn-info" title="" target="_blank" style="width:150px;font-size:20px;"><span class="glyphicon glyphicon-question-list"></span> Print</a>
									<br>
								</div>
								<div class="col-md-3">&nbsp;</div>
...
<script>
	...
	function addData(type, id) {
		...
		$.ajax({
			...
			data: billData,
			success: function(msg) {
				window.location.href = "<?php echo $base_url; ?>span_set_rate_only_by_material.php?trf_no=" + txt_trf_no + "&&job_no=" + txt_job_no;
