		...
		<table align="center" width="95%" cellspacing="0" cellpadding="0" style="height:77%;font-size:13px;font-family: Book Antiqua;border:2px solid black;margin-left:35px;">
			...
			<tr>
				...
				<td style="font-size:15px;padding-top:5px;">
					<center><b><u>Burnt Clay Brick Test Result</u></b></center>
				</td>
				...
				<td>
					...
					<table align="left" width="100%" class="test" style="height:auto;width:100%;">
						...
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['rbt_efflo1']; ?></td>
						</tr>
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['rbt_efflo2']; ?></td>
						</tr>
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['rbt_efflo3']; ?></td>
						</tr>
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['rbt_efflo4']; ?></td>
						</tr>
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['rbt_efflo5']; ?></td>
						</tr>
						<tr style="text-align:center;">
						...
						<tr style="text-align:center;">
							<td style="border:1px solid black;border-left:0px solid black;">Req.<br>IS. 1077-<br>1992</td>
			...
			<tr>
				<td>
					<table align="left" class="test" style="height:Auto;width:100%;">
						...
						<tr style="text-align:center;">
							<td style="border:1px solid black;border-left:0px solid black;">Requirement as per IS. 1077-(1992)</td>
