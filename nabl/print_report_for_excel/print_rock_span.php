...
<body>
	...
	if (mysqli_num_rows($result_select4) > 0) {
		...
		$bs_location = $row_select4['ro_location'];
		$bs_depth = $row_select4['ro_depth'];
		$bs_bhno = $row_select4['ro_bhno'];
	}
		...
		<table align="center" width="95%" style="height:auto;font-size:11px;font-family: arial;border:solid black;border-width:2;">
			<tr>
				...
				<td style="font-size:13px;border:1px solid black;">
					<center><b>Test Results of Rock</b></center>
				</td>
					...
					<table align="center" width="100%" class="test" border="1px" style="height:auto;">
						...
						?>
							<tr>
								...
								<td>
									<center>IS : 9143: 1979 (RA 2016)</center>
								</td>
								<td>
									<center><?php echo number_format($row_select_pipe['avg_com'], 2); ?></center>
								</td>
								<td>
									<center>N/mm<sup>2</sup></center>
								</td>
						...
						?>
							<tr>
								<td>
									<center>Water Content</center>
								</td>
								<td>
									<center>IS : 13030 : 1991 (RA 2010)</center>
								</td>
								<td>
									<center><?php echo number_format($row_select_pipe['avg_wtr'], 2); ?></center>
								</td>
								<td>
									<center>%</center>
								</td>
