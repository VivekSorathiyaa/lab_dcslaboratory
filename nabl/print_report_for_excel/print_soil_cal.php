		...
		<table align="center" width="95%" cellspacing="0" cellpadding="0" style="height:70%;font-size:13px;font-family: Book Antiqua;border:2px solid black;margin-left:35px;">
					...
					<table align="left" width="100%" border="0px" cellspacing="0" cellpadding="0" class="test" style="border-top:1px solid black;">
						...
						<tr>
							...
							<td style="width:77%">&nbsp;&nbsp;<?php $select_queryc = "select * from city WHERE `id`='$row_select[client_city]'";
																...
																echo $clientname . " " . $client_address . " " . $ct_nm; ?>
							</td>
				...
				<td>
					<table align="center" width="100%" border="0px" class="test" style="border-top:1px solid black;border-bottom:1px solid black;">
						...
						<tr>
							...
							<td style="width:3%;font-family:Book Antiqua;font-weight:bold;font-size:20px;"><b>»</b></td>
							<td style="width:40%">&nbsp;&nbsp;IS : 2720 P-28 (Sand Replacement Method)</td>
							<td style="width:20%">&nbsp;&nbsp;</td>
							<td style="width:3%;font-family:Book Antiqua;font-weight:bold;"></td>
							<td style="width:14%">&nbsp;&nbsp;</td>
						</tr>
						<tr>
							<td style="width:20%">&nbsp;&nbsp;<b>Lab Density of Material</b></td>
							<td style="width:3%;font-family:Book Antiqua;font-size:20px;"><b>»</b></td>
							<td style="width:40%">&nbsp;&nbsp;<?php echo $row_select_pipe['cal_mdd']; ?> gm/cc</td>
							<td style="width:20%">&nbsp;&nbsp;</td>
							<td style="width:3%;font-family:Book Antiqua;font-weight:bold;"></td>
							<td style="width:14%">&nbsp;&nbsp;</td>
						</tr>
			...
			<tr>
				...
				<td style="font-size:15px;padding-top:5px;">
					<center><b><u>Density of Sand</u></b></center>
				</td>
			...
			<tr>
				...
				<td>
					...
					<table align="center" width="100%" class="test" style="height:auto;width:100%;border:1px solid black;">
						<tr style="text-align:center;height:20px;">
							<td style="border:1px solid black;width:15%;"><b>Sr. No.</b></td>
							<td style="border:1px solid black;width:60%;"><b>Description</b></td>
							<td style="border:1px solid black;width:25%;border-right:0px solid black;"><b>Test Result</b></td>
						...
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo $row_select_pipe['c1']; ?></b></td>
						</tr>
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo $row_select_pipe['c2']; ?></b></td>
						</tr>
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo $row_select_pipe['c3']; ?></b></td>
						</tr>
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo $row_select_pipe['c4']; ?></b></td>
						</tr>
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo $row_select_pipe['c5']; ?></b></td>
						</tr>
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo number_format($row_select_pipe['c6'], 2);; ?></b></td>
						</tr>
			...
			<tr>
				...
				<td style="font-size:15px;padding-top:5px;">
					<center><b><u>Field Dry Density Test by Sand Replacement</u></b></center>
				</td>
				...
				<td>
					...
					<table align="center" width="100%" class="test" style="height:auto;width:100%;border:1px solid black;">
						...
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo $row_select_pipe['d1']; ?></b></td>
						</tr>
						<tr style="text-align:center;">
							<td style="border:1px solid black;"><b>2</b></td>
							<td style="border:1px solid black;text-align:left">Wt. of Sand + Cylinder before Pouring (W1), gm</td>
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo $row_select_pipe['d2']; ?></b></td>
						</tr>
						<tr style="text-align:center;">
							<td style="border:1px solid black;"><b>3</b></td>
							<td style="border:1px solid black;text-align:left">Wt. of Sand + Cylinder after Pouring (W4), gm</td>
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo $row_select_pipe['d3']; ?></b></td>
						</tr>
						<tr style="text-align:center;">
							<td style="border:1px solid black;"><b>4</b></td>
							<td style="border:1px solid black;text-align:left">Wt. of Sand to Fill Hole Wb</td>
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo $row_select_pipe['d4']; ?></b></td>
						</tr>
						<tr style="text-align:center;">
							<td style="border:1px solid black;"><b>5</b></td>
							<td style="border:1px solid black;text-align:left">Bulk Density of Sample, D<sub>wet</sub></td>
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo number_format($row_select_pipe['d5'], 2); ?></b></td>
						</tr>
						<tr style="text-align:center;">
							<td style="border:1px solid black;"><b>6</b></td>
						...
						<tr style="text-align:center;">
							...
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo number_format($row_select_pipe['d7'], 2); ?></b></td>
						</tr>
						<tr style="text-align:center;">
							<td style="border:1px solid black;"><b>8</b></td>
							<td style="border:1px solid black;text-align:left">Compaction %</td>
							<td style="border:1px solid black;border-right:0px solid black;"><b><?php echo $row_select_pipe['d8']; ?></b></td>
						</tr>
