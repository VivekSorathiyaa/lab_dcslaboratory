		...
		<table align="center" width="95%" style="height:auto;font-size:11px;font-family: arial;border:solid black;border-width:2;">
			<tr>
				...
				<td style="font-size:13px;border:1px solid black;">
					<center><b>Test Results of Natural Building Stone</b></center>
				</td>
				...
				<td>
					<table align="center" width="100%" class="test" border="1px" style="height:auto;">
						...
						<tr>
							...
							<td>
								<center><b>Test Method</b></center>
							</td>
							<td>
								<center><b>Results Obtained</b></center>
							</td>
							<td>
						...
						?>
							<tr>
								...
								<td>
									<center>Compressive Strength</center>
								</td>
								<td>
									<center>IS : 1121 (P-1 ) : 1974 (RA 2017)</center>
								</td>
								<td>
									<center><?php echo number_format($row_select_pipe['avg_comp'], 2); ?></center>
								</td>
								<td>
									<center>kg/cm<sup>2</sup></center>
								</td>
						...
						?>
							<tr>
								<td>
									<center>Water Absorption</center>
								</td>
								<td>
									<center>IS : 1124 : 1974 (RA 2013)</center>
								</td>
								<td>
						...
						?>
							<tr>
								<td>
									<center>True Specific Gravity</center>
								</td>
								<td>
									<center>IS : 1122 : 1974 (RA 2017)</center>
								</td>
								<td>
									<center><?php echo number_format($row_select_pipe['avg_true_sp'], 2); ?></center>
								</td>
								<td>
									<center>-</center>
								</td>
						...
						?>
							<tr>
								<td>
									<center>Apparent Specific Gravity</center>
								</td>
								<td>
									<center>IS : 1124 : 1974 (RA 2013)</center>
								</td>
								<td>
									<center><?php echo number_format($row_select_pipe['avg_app_sp'], 2); ?></center>
								</td>
								<td>
									<center>-</center>
								</td>
