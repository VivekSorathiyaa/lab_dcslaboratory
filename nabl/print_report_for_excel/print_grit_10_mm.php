...
<body> <?php $job_no = $_GET['job_no'];
    ...
    <page size="A4">
        <table align="center" width="95%" cellspacing="0" cellpadding="0" style="height:60%;font-size:13px;font-family: Book Antiqua;border:2px solid black;">
            <tr>
                ...
                <td>
                    <table align="left" width="100%" border="0px" cellspacing="0" cellpadding="0" class="test" style="border-top:1px solid black;">
                        ...
                        <tr>
                            ...
                            <td style="width:3%;font-family:Book Antiqua;font-weight:bold;font-size:20px;"><b>»</b></td>
                            <td style="width:77%">&nbsp;&nbsp;<?php echo $name_of_work; ?> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="width:3%;font-family:Book Antiqua;font-weight:bold;font-size:20px;"><b>»</b></td>
                            <td style="width:77%">&nbsp;&nbsp;<?php echo $r_name; ?> </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="width:49%;vertical-align:top">
                                <table align="top" width="100%" class="test" style="height:100%;width:100%;">
                                    <tr>
                                    ...
                                    </tr> <?php if ($row_select_pipe['fi_index'] != "" && $row_select_pipe['ei_index'] != "") {                                    ?> <tr>
                                        ...
                                        <tr>
                                            ...
                                            if ($row_select_pipe['imp_value'] != "") {                                    ?> <tr>
                                            ...
                                            if ($row_select_pipe['sp_specific_gravity'] != "") {                                    ?> <tr>
                                            ...
                                            if ($row_select_pipe['sp_water_abr'] != "") {                                    ?> <tr>
                                            ...
                                            if ($row_select_pipe['cru_value'] != "") {                                    ?> <tr>
                                            ...
                                            if ($row_select_pipe['abr_index'] != "") {                                    ?> <tr>
                ...
                <td>
                    <table align="center" width="100%" style="border-top:1px solid black;font-size:9;" class="test">
                        <tr>
                            ...
                            <td style="width:97%;"> 1. The Result relate only to the items tested.<br> 2. Test Report Shall not be reproduced except in full without apporval of the Mattest Engineering Serivces can Provide assurance that parts of a report are not taken of context.<br> 3. The information is Supplied by the customer and can effect the validity of Result.<br> 4. The result applied to the Sample as received. </td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                <td>
                    <table align="center" width="100%" style="font-size:12;" class="test">
                        <tr>
                            <td style="width:50%;text-align:center;padding-top:70px;border-top:1px solid black;border-right:1px solid black;"><br><b><i>Authorized By</i> <br> Vishal D. Raiyani (QM)</b></td>
        ...
        <table align="center" width="95%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family: Book Antiqua;">
            <tr>
                <td style="text-align:left">Doc. No. F-7.8-06</td>
                <td style="text-align:right">Page No. 1/1</td>
            </tr>
        </table> <input style="margin-top: 25px;margin-left: 600;height: 50px;font-size: 20px;color: white;background-color: green;border-radius:20px;" type="button" name="print_button" id="print_button" value="PRINT">
    </page>
</body>
