...
if(isset($_POST['action_type']) && !empty($_POST['action_type'])){
	...
	}else if($_POST['action_type'] == 'save_rate_by_test_direct_perfoma')
	{
		...
		}else
		{
			...
			$todays=date("Y-m-d");
			$insert_sequence="insert into estimate_total_span_bill_sequence(`trf_no`,`job_no`,`bill_no`,`estimate_type`,`estimate_date`,`created_date`,`created_by`,`created_name`,`perfoma_no`) values('$txt_trf_no','$txt_job_no','$set_bill_no','for_test_direct_perfoma','$invoice_date','$todays','$_SESSION[u_id]','$_SESSION[name]','$hidden_perfoma_nos')";
