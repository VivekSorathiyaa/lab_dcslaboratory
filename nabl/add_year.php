					...
					<div class="box box-primary">
						...
						<div class="panel panel-default citys-content">
							...
							<div class="row">
							 ...
							 <input type="text" name="txt_year" id="txt_year" placeholder="Enter Year Name">
							 </div>
							 <div class="col-md-4">
							 ...
							 <div class="col-md-4">
							 <button type="button" class="btn btn-info"  onclick="savedata('add_year')" name="btn_add_data_save" id="btn_add_data_save" style="width:20%;font-size:20px;" >Add</button>
							 </div>
							</div>
						</div>
					</div>
...
function savedata(type,id){
    ...
    if (type == 'add_year') {
				...
				else
				{
					...
					billData = '&action_type='+type+'&txt_year='+txt_year+'&start_date='+start_date+'&end_date='+end_date;
						$.ajax({
							type: 'POST',
