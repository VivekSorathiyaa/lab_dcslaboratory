    ...
    <table width="92%" cellspacing="0" style="margin-left: auto;margin-right: auto; border:1px solid black;">
        ...
        <table width="92%" cellspacing="0" style="margin-left: auto; margin-right: auto;border: 1px solid; border-top:0px;">
            <tr align="center">
                ...
                <td style="font-size: 13px; vertical-align: top; border: 1px solid; border-top: 0px; border-left: 0px;">Description of<br>Services</td>
            ...
            <tr align="center">
                ...
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;text-align: left; border-bottom: 0; "><b>Inspection of <?php echo $mat_name_array[$one_key];?></b></td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;  border-bottom: 0;">998346</td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;text-align: right;  border-bottom: 0;"><b><?php echo $test_qty_array[$one_key]; ?> No.</b></td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;text-align: right;  border-bottom: 0;"><?php echo number_format(($test_rates_array[$one_key] + $test_rates_array[$one_key] * 0.18),2); ?></td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;text-align: right;  border-bottom: 0;"><?php echo $test_rates_array[$one_key]; ?></td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;  border-bottom: 0;">No.</td>
                <td style="font-size: 13px; border: 1px solid; border-top: 0px; border-left: 0px;text-align: right;  border-bottom: 0; border-right: 0px;"><b><?php echo $test_totals_array[$one_key].".00"; ?></b></td>
            </tr>
            <tr>
