...
<section class="content" style="padding: 0px;
     ...
     padding-right: 0px; ">
			...
			<div class="row" style="margin: 0px 0px 0px 0px;">
				...
				<div class="col-md-3">
					<input type="text" name="billdate" id="billdate" class="form-control" placeholder="Bill Date" value="<?php echo date('d/m/Y');?>">
				</div>
				...
				<div class="col-md-3">
					<input type="text" name="billmonth" id="billmonth" class="form-control" placeholder="Bill Month" disabled>
				</div>
	  ...
	  <div class="row" style="margin: 0px 0px 0px 0px;">
		...
		<div class="col-md-5">
			<select id="division" id="division" class="form-control">
		...
		<div class="col-md-5">
		<select id="subdivision" id="subdivision" class="form-control">
		<option value="">Select Sub Division</option>
			<?php
			$sel_sub="select * from sub_division";
			$querys_sub=mysqli_query($conn,$sel_sub);
			if(mysqli_num_rows($querys_sub)> 0){
			while($gets_sub=mysqli_fetch_array($querys_sub)){
			?>
			<option value="<?php echo $gets_sub['sub_div_id'];?>"><?php echo $gets_sub['sub_div_name'];?></option>
			<?php
			}}
			?>
			</select>
	  ...
	  <div class="row" style="margin: 0px 0px 0px 0px;">
		...
		<div class="col-md-5">
			<input type="text" name="billamt" id="billamt" class="form-control" placeholder="Bill Amount">
		</div>
	  ...
	  <div class="row" style="margin: 0px 0px 0px 0px;">
		...
		<div class="col-md-2">
			<input type="text" name="cgst" id="cgst" class="form-control" placeholder="Cgst Amout" value="0">
		</div>
		...
		<div class="col-md-2">
			<input type="text" name="sgst" id="sgst" class="form-control" placeholder="Sgst Amout" value="0">
		</div>
		...
		<div class="col-md-2">
			<input type="text" name="igst" id="igst" class="form-control" placeholder="Igst Amout" value="0">
		</div>
		...
		<div class="col-md-2">
			<input type="text" name="total_amt" id="total_amt" class="form-control" placeholder="Total Amout" value="0">
		</div>
