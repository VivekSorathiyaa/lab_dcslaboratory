				...
				<!-- /.box-header -->
						...
						<div id="display_data_report">
								...
								<tbody>
									<?php
										$count=0;
										$query="select * from job WHERE `jobisdeleted`=0 AND `rec_to_tm`='1' AND `tm_to_eng_blank`='0' AND `flow_status`=3 ORDER BY job_id DESC";
										...
										$count++;
											...
											$explode_reported_by=explode(",",$row["reported_by"]);
									...
									?>
											...
											{
											?>
											<a href="view_job_by_tm_to_send_for_blank.php?trf_no=<?php echo $row['trf_no'];?>&&job_no=<?php echo $row['job_number'];?>&&temporary_trf_no=<?php echo $row['temporary_trf_no'];?>" class="btn btn-primary" title="View Job"><span class="fa fa-eye"></span></a>
