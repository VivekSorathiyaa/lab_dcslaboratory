...
$arraying=array(
array($_POST["sel_agency_ids"]," AND `agency`='".$_POST['sel_agency_ids']."'"),
array($_POST["search_sel_client_code"]," AND `client_code`='".$_POST['search_sel_client_code']."'"),
array($_POST["search_ref_no"]," AND `refno` LIKE '%".$_POST['search_ref_no']."%'"),
array($_POST["search_n_o_w"]," AND `nameofwork` LIKE '%".$_POST['search_n_o_w']."%'"),
array($_POST["search_agree_no"]," AND `agreement_no` LIKE '%".$_POST['search_agree_no']."%'")
);
...
?>
							 <table id="example2" class="table table-bordered table-striped" style="width:100%;">
									...
									<tr>
										...
										<th style="text-align:left;width:1%;">Bill To</th>
