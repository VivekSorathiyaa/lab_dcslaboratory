...
<?php
		...
		$sel_estiamte="select * from estimate_total_span_only_bill where `report_no`='$get_report_no' AND `job_no`='$get_job_no'";
		...
		$sel_job="select * from job where `report_no`='$get_report_no'";
...
?>
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
		...
		<tr>
				<td colspan="8"><b>TAX INVOICE</b></td>
		</tr>
		<tr>
				<td colspan="4" width="20%"><b>Billed To :</b>&nbsp;&nbsp;<?php echo $set_report_sent_to; ?></td>
				<td colspan="2" width="20%" style="text-align:right;"><b>Tax Invoice No </b></td>
...
<table align="center" width="80%" class="test" border="1px" style="font-family: arial;">
				...
				<tr>
						...
						<td colspan="3" width="28%"><b>ITEM</b></td>
						<td width="11%"><b>HSN CODE</b></td>
						<td width="11%"><b>QUANTITY</b></td>
						<td width="11%"><b>RATE</b></td>
						<td width="7%"><b>PER</b></td>
						<td width="11%"><b>AMOUNT RS.</b></td>
				</tr>

				<?php
				$sel_test_wise_material_rate="SELECT  material_category.material_cat_id,COUNT(*)as cnt FROM material_category, test_master, test_wise_material_rate WHERE test_wise_material_rate.test_id = test_master.test_id AND test_master.mat_category_id = material_category.material_cat_id AND test_wise_material_rate.report_no ='$get_report_no' AND test_wise_material_rate.job_no = '$get_job_no' GROUP BY  material_category.material_cat_id";
				...
				if(mysqli_num_rows($query_wise) > 0){
					...
					<tr>
						...
						<td width="11%"><?php echo $test_rows["hsn_code"];?> </td>
						<td width="11%"><?php echo $test_rows["qty"];?></td>
				...
				<tr>
						<td colspan="6" rowspan="2"  width="44%"><b>Rs.&nbsp;<?php echo $row_estiamte["total_amt_in_word"];?></b></td>
						<td  colspan="2" width="22%">Grand Total</td>
						<td width="11%" style="text-align:right;"><?php echo number_format($row_estiamte["grand_total"],2);?></td>
				</tr>
				<tr>

						<td  colspan="2" width="22%"><b>TOTAL</b></td>
	...
	<table align="center" width="80%" class="test" border="1px" style="font-family: arial;">
				...
				<tr>
						...
						<td width="7%">GST <?php echo $get_tax["tax_sgst"] +$get_tax["tax_cgst"];?>%</td>
						<td width="11%">Tax Amount</td>
				</tr>
				<tr>

						<td width="11%" style="text-align:right;"><?php echo number_format($row_estiamte["grand_total"],2);?></td>
						<td width="11%" style="text-align:right;">CGST</td>
						<td width="7%"><?php echo $get_tax["tax_cgst"];?>%</td>
				...
				<tr>
						...
						<td width="7%"><?php echo $get_tax["tax_sgst"];?>%</td>
				...
				<tr>
						...
						<td width="7%"><?php echo $get_tax["tax_igst"];?>%</td>
				...
				<tr>
						...
						<td width="7%"><?php echo $get_tax["tax_sgst"] +$get_tax["tax_cgst"];?>%</td>
				...
				<tr>
						<td colspan="3" width="40%">For Shree Soil Material Testing Lab </td>
				...
				<tr>
						...
						<span id="span_notes">
						<input type="text" name="txt_notes" id="txt_notes" style="width:100%;height:40px;" value="Testing Charge must be paid to only Shree Soil Material Testing Lab.">
						</textarea>
						</span>
						 <br>
