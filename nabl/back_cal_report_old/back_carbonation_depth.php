				...
				<td style="text-align:center;font-size:16px; ">
					...
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:16px;font-family: Cambria;border-bottom:1px solid;border-top:1px solid;">
						...
						<tr style="">
							...
							<td style="border-left:1px solid;width:42%;text-align:left; ">&nbsp;&nbsp;<?php echo $source; ?><?php if ($material_location == "0") {
																																echo "In Laboratory";
																															} else {
																																echo "In Field";
						...
						<tr style="">
							...
							<td style="border-top:1px solid;border-left:1px solid;width:20%;text-align:left; ">&nbsp;&nbsp; <?php echo $con_sample; ?></td>
						</tr>
					</table><br>
