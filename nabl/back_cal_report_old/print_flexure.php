				...
				<td style="text-align:center;font-size:14px; ">
					...
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px;font-family: Cambria;border:1px solid;border-width:1px 0px 1px 1px;">
						...
						<tr style="">
							...
							<td style="width:25%;font-weight:bold;padding-bottom:2px;padding-top:2px; ">&nbsp;&nbsp; DOC : GOMAEC/I/OS/003</td>
				...
				<td style="text-align:center;font-size:14px; ">
					...
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px;font-family: Cambria;border:1px solid;border-width:0px 1px 1px 1px;">
						...
						<tr style="">
							...
							<td style="width:60%;font-weight:bold;padding-bottom:2px;padding-top:2px;padding-left:50px;  ">&nbsp;&nbsp; Prepared by : Technical Manager</td>
				...
				<td style="text-align:center;font-size:15px; ">
					...
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:15px;font-family: Cambria;">
						...
						<tr style="">
							...
							<td style="width:100%;padding-bottom:2px;padding-top:2px; text-align:center;font-weight:bold; "><span style=""><u>OBSERVATION & CALCULATION SHEET FOR FLEXURE STRENGTH TEST ON C.C.BEAM<br>IS : 516 - 1959 (Reaff. 2013</u></td>
						</tr>
