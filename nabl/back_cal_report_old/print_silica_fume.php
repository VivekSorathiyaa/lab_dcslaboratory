...
<body>
    ...
    $trf_no = $_GET['trf_no'];
    $select_tiles_query = "select * from silica_fume WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
    ...
    <page size="A4">
        ...
        <table align="center" width="90%" class="test" style="border: 1px solid black;">
            <tr>
                <td colspan="5" style="font-size:14px;border: 1px solid black;">
                    <center><b>Tec Material Testing Lab</b></center>
                </td>
            </tr>
            <tr>
                <td colspan="4" style="font-size:14px;border: 1px solid black;">
                    <center><b>Worksheet for Moisture Content of Silica Fume(IS 1727)</b></center>
                </td>
                <td colspan="2" style="font-size:14px;border: 1px solid black;">
                    <center><b>F-Fly Ash-02, Issue No.01, Page No 1 of 1</b></center>
                </td>
            </tr>
            <tr>
        ...
        <table align="center" width="90%" class="test" style="border: 1px solid black;" cellpadding="5px">
            ...
            <tr>
                ...
                <td rowspan="3" style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['caste_date1'] != "" && $row_select_pipe['caste_date1'] != "0" && $row_select_pipe['caste_date1'] != null) {
                ...
                <td rowspan="3" style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['age1'] != "" && $row_select_pipe['age1'] != "0" && $row_select_pipe['age1'] != null) {
                                                                                            echo $row_select_pipe['age1'];
                                                                                        } else {
                                                                                            echo "&nbsp;";
                                                                                        } ?></b></td>
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['id1'] != "" && $row_select_pipe['id1'] != "0" && $row_select_pipe['id1'] != null) {
                                                                                echo $row_select_pipe['id1'];
                                                                            } else {
                                                                                echo "&nbsp;";
                                                                            } ?></b></td>
                ...
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['wi1'] != "" && $row_select_pipe['wi1'] != "0" && $row_select_pipe['wi1'] != null) {
                ...
                <td rowspan="3" style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['avg_lime'] != "" && $row_select_pipe['avg_lime'] != "0" && $row_select_pipe['avg_lime'] != null) {
                                                                                            echo $row_select_pipe['avg_lime'];
                                                                                        } else {
                                                                                            echo "&nbsp;";
                                                                                        } ?></b></td>
            </tr>
            <tr>
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['id2'] != "" && $row_select_pipe['id2'] != "0" && $row_select_pipe['id2'] != null) {
                                                                                echo $row_select_pipe['id2'];
                                                                            } else {
                                                                                echo "&nbsp;";
                                                                            } ?></b></td>
                ...
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['wi2'] != "" && $row_select_pipe['wi2'] != "0" && $row_select_pipe['wi2'] != null) {
            ...
            <tr>
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['id3'] != "" && $row_select_pipe['id3'] != "0" && $row_select_pipe['id3'] != null) {
                                                                                echo $row_select_pipe['id3'];
                                                                            } else {
                                                                                echo "&nbsp;";
                                                                            } ?></b></td>
                ...
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['wi3'] != "" && $row_select_pipe['wi3'] != "0" && $row_select_pipe['wi3'] != null) {
            ...
            <tr>
                ...
                <td rowspan="3" style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['caste_date2'] != "" && $row_select_pipe['caste_date2'] != "0" && $row_select_pipe['caste_date2'] != null) {
                ...
                <td rowspan="3" style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['age2'] != "" && $row_select_pipe['age2'] != "0" && $row_select_pipe['age2'] != null) {
                                                                                            echo $row_select_pipe['age2'];
                                                                                        } else {
                                                                                            echo "&nbsp;";
                                                                                        } ?></b></td>
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['id4'] != "" && $row_select_pipe['id4'] != "0" && $row_select_pipe['id4'] != null) {
                                                                                echo $row_select_pipe['id4'];
                                                                            } else {
                                                                                echo "&nbsp;";
                                                                            } ?></b></td>
                ...
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['wi4'] != "" && $row_select_pipe['wi4'] != "0" && $row_select_pipe['wi4'] != null) {
                ...
                <td rowspan="3" style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['avg_cem'] != "" && $row_select_pipe['avg_cem'] != "0" && $row_select_pipe['avg_cem'] != null) {
                                                                                            echo $row_select_pipe['avg_cem'];
                                                                                        } else {
                                                                                            echo "&nbsp;";
                                                                                        } ?></b></td>
            </tr>
            <tr>
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['id5'] != "" && $row_select_pipe['id5'] != "0" && $row_select_pipe['id5'] != null) {
                                                                                echo $row_select_pipe['id5'];
                                                                            } else {
                                                                                echo "&nbsp;";
                                                                            } ?></b></td>
                ...
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['wi5'] != "" && $row_select_pipe['wi5'] != "0" && $row_select_pipe['wi5'] != null) {
            ...
            <tr>
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['id6'] != "" && $row_select_pipe['id6'] != "0" && $row_select_pipe['id6'] != null) {
                                                                                echo $row_select_pipe['id6'];
                                                                            } else {
                                                                                echo "&nbsp;";
                                                                            } ?></b></td>
                ...
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['wi6'] != "" && $row_select_pipe['wi6'] != "0" && $row_select_pipe['wi6'] != null) {
            ...
            <tr>
                ...
                <td rowspan="3" style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['caste_date3'] != "" && $row_select_pipe['caste_date3'] != "0" && $row_select_pipe['caste_date3'] != null) {
                ...
                <td rowspan="3" style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['age3'] != "" && $row_select_pipe['age3'] != "0" && $row_select_pipe['age3'] != null) {
                                                                                            echo $row_select_pipe['age3'];
                                                                                        } else {
                                                                                            echo "&nbsp;";
                                                                                        } ?></b></td>
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['id7'] != "" && $row_select_pipe['id7'] != "0" && $row_select_pipe['id7'] != null) {
                                                                                echo $row_select_pipe['id7'];
                                                                            } else {
                                                                                echo "&nbsp;";
                                                                            } ?></b></td>
                ...
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['wi7'] != "" && $row_select_pipe['wi7'] != "0" && $row_select_pipe['wi7'] != null) {
                ...
                <td rowspan="3" style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['avg_fly'] != "" && $row_select_pipe['avg_fly'] != "0" && $row_select_pipe['avg_fly'] != null) {
                                                                                            echo $row_select_pipe['avg_fly'];
                                                                                        } else {
                                                                                            echo "&nbsp;";
                                                                                        } ?></b></td>
            </tr>
            <tr>
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['id8'] != "" && $row_select_pipe['id8'] != "0" && $row_select_pipe['id8'] != null) {
                                                                                echo $row_select_pipe['id8'];
                                                                            } else {
                                                                                echo "&nbsp;";
                                                                            } ?></b></td>
                ...
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['wi8'] != "" && $row_select_pipe['wi8'] != "0" && $row_select_pipe['wi8'] != null) {
            ...
            <tr>
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['id9'] != "" && $row_select_pipe['id9'] != "0" && $row_select_pipe['id9'] != null) {
                                                                                echo $row_select_pipe['id9'];
                                                                            } else {
                                                                                echo "&nbsp;";
                                                                            } ?></b></td>
                ...
                <td style="border: 1px solid black; text-align:center;"><b><?php if ($row_select_pipe['wi9'] != "" && $row_select_pipe['wi9'] != "0" && $row_select_pipe['wi9'] != null) {
