			...
			<body>
				...
				$select_tiles_query = "select * from wmm_2_36_11_20_mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
				...
				<page size="A4" layout="landscape">
					...
					?>
						...
						<table align="center" width="90%" class="test" border="1px" height="40%">
							...
							<tr>
								<td colspan="6"><b>Work sheet for Bulk Density of Coarse Aggregate </b></td>
								<td colspan="6"><b>(IS :2386 - Part I)-1963 (RA 2016)</b></td>
							</tr>
							<tr>
								<td colspan="6"><b>Report No. :</b> &nbsp;&nbsp;<?php echo $row_select_pipe['report_no']; ?></td>
