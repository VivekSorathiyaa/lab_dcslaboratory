            ...
            <tr>
                <td style="text-align:center;font-size:12px; ">
                    ...
                    <table align="left" width="100%" cellspacing="0" cellpadding="0" style="font-size:12px;font-family: Cambria;border:1px solid;border-width:1px 0px 1px 0px;margin-bottom:20px;">
                        ...
                        <tr style="">
                            <td style="width:4%;text-align:center;font-weight:bold;border-right:1px solid; ">Sr.<br>No.</td>
                            <td style="width:51%;text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;  "><u>Particular</u></td>
                        ...
                        <tr style="">
                            <td style="border-top:1px solid;width:4%;text-align:center;font-weight:bold;border-right:1px solid; "><?php echo $cnt++; ?></td>
                            <td style="border-top:1px solid;width:51%;text-align:left;padding-bottom:5px;padding-top:5px;  ">&nbsp; Mass of saturated aggregate in water, A&nbsp;&nbsp;&nbsp; (g)</td>
                        ...
                        <tr style="">
                            <td style="border-top:1px solid;width:4%;text-align:center;font-weight:bold;border-right:1px solid; "><?php echo $cnt++; ?></td>
                            <td style="border-top:1px solid;width:51%;text-align:left;padding-bottom:5px;padding-top:5px;  ">&nbsp; Mass of the saturated surface dry aggregate in air, B&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (g)</td>
                        ...
                        <tr style="">
                            <td style="border-top:1px solid;width:4%;text-align:center;font-weight:bold;border-right:1px solid; "><?php echo $cnt++; ?></td>
                            <td style="border-top:1px solid;width:51%;text-align:left;padding-bottom:5px;padding-top:5px;  ">&nbsp; Mass of oven dried aggregate in air, C &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; (g)</td>
                        ...
                        <tr style="">
                            <td style="border-top:1px solid;width:4%;text-align:center;font-weight:bold;border-right:1px solid; "><?php echo $cnt++; ?></td>
                            <td style="border-top:1px solid;width:51%;text-align:left;padding-bottom:5px;padding-top:5px;  ">&nbsp; Specific gravity = &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; C<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="border-top:1px solid">B - A</span></td>
                        ...
                        <tr style="">
                            <td style="border-top:1px solid;width:4%;text-align:center;font-weight:bold;border-right:1px solid; "><?php echo $cnt++; ?></td>
                            <td style="border-top:1px solid;width:51%;text-align:left;padding-bottom:5px;padding-top:5px;  ">&nbsp; Average Specific gravity</td>
                            <td style="border-top:1px solid;border-left:1px solid;width:15%; text-align:center; " colspan=3><?php if ($row_select_pipe['sp_specific_gravity'] != "" && $row_select_pipe['sp_specific_gravity'] != "0" && $row_select_pipe['sp_specific_gravity'] != null) {
                        ...
                        <tr style="">
                            <td style="border-top:1px solid;width:4%;text-align:center;font-weight:bold;border-right:1px solid; "><?php echo $cnt++; ?></td>
                            <td style="border-top:1px solid;width:51%;text-align:left;padding-bottom:5px;padding-top:5px;  ">&nbsp; Water absorption (% of dry weight) = &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="border-bottom:1px solid;">100(B - C)</span><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; C</td>
                        ...
                        <tr style="">
                            <td style="border-top:1px solid;width:4%;text-align:center;font-weight:bold;border-right:1px solid; "><?php echo $cnt++; ?></td>
                            <td style="border-top:1px solid;width:51%;text-align:left;padding-bottom:5px;padding-top:5px;  ">&nbsp; Average Water absorption (%)</td>
                            <td style="border-top:1px solid;border-left:1px solid;width:15%; text-align:center; " colspan=3>&nbsp; <?php if ($row_select_pipe['sp_water_abr'] != "" && $row_select_pipe['sp_water_abr'] != "0" && $row_select_pipe['sp_water_abr'] != null) {
                ...
                <td style="text-align:center;font-size:14px; ">
                    ...
                    <table align="left" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px;font-family: Cambria;border:1px solid;border-width:1px 0px 0px 0px;margin-bottom:30px;">
                        ...
                        <tr style="">
                            ...
                            <td style="border-top:1px solid;border-left:1px solid;width:15%; text-align:center; "><?php if ($row_select_pipe['sumx'] != ""  &&  $row_select_pipe['sumx'] != null) {
                                                                                                                        echo $row_select_pipe['sumx'];
                                                                                                                    } else {
                                                                                                                        echo " <br>";
                                                                                                                    }  ?></td>
                            <td style="border-top:1px solid;border-left:1px solid;width:15%; text-align:center; "><?php if ($row_select_pipe['sumy'] != ""  &&  $row_select_pipe['sumy'] != null) {
                                                                                                                        echo $row_select_pipe['sumy'];
                                                                                                                    } else {
                                                                                                                        echo " <br>";
                                                                                                                    }  ?></td>
                            <td style="border-top:1px solid;border-left:1px solid;width:15%; text-align:center; "><?php //echo (($row_select_pipe['y1'] * $row_select_pipe['x1']) + ($row_select_pipe['x2'] * $row_select_pipe['y2']) + ($row_select_pipe['x3'] * $row_select_pipe['y3']) + ($row_select_pipe['x4'] * $row_select_pipe['y4']) + ($row_select_pipe['x5'] * $row_select_pipe['y5']) + ($row_select_pipe['x6'] * $row_select_pipe['y6']) + ($row_select_pipe['x7'] * $row_select_pipe['y7']) + ($row_select_pipe['x8'] * $row_select_pipe['y8']) + ($row_select_pipe['x9'] * $row_select_pipe['y9'])); 
                                                                                                                    ?></td>
                        </tr>
                        <tr style="">
