...
<body>
	...
	<page size="A4">
		...
		<table align="center" width="90%" cellspacing="0" cellpadding="0" style="font-size:14px;font-family: Cambria;border-bottom:1px solid;border-left:1px solid; border-right:1px solid; ">
		...
		<br>
		<table align="center" width="90%" class="test" style="border: 1px solid black;font-size:10px;" cellpadding="3px">
			<tr>
		...
		<center>
			<table align="center" class="test" style="border: 1px solid black; position: fixed;left: 30px;right: auto;bottom: 20px;width: 92%;" cellpadding="10px">
				<tr>
