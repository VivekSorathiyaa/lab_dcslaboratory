	...
	<page size="A4">
		...
		<table align="center" width="90%" class="test" height="10%" style="border: 1px solid black;">
			...
			<tr style="border: 2px solid black;">
				...
				<td colspan="16" style="border: 2px solid black;text-align:center;"><b>Dynamic Cone Pentrometer (DCP) Test-ASTM-D6951/IRC-37</b></td>
		...
		<table align="center" width="90%" class="test1" height="5%">
			...
			<tr>
				...
				<td style="width:20%;"><b>Layer of Material</b></td>
				<td style="width:5%;"><b>:-</b></td>
				<td style="width:20%;"><?php if ($row_select_pipe['layer_mt'] != "" && $row_select_pipe['layer_mt'] != "0" && $row_select_pipe['layer_mt'] != null) {
											echo $row_select_pipe['layer_mt'];
										} else {
											echo " <br>";
										} ?></td>
				<td style="text-align:center;width:5%;"><b>6</b></td>
				<td style="width:20%;"><b>Field Moisture</b></td>
				<td style="width:5%;"><b>:-</b></td>
				<td style="width:20%;"><?php if ($row_select_pipe['field_mos'] != "" && $row_select_pipe['field_mos'] != "0" && $row_select_pipe['field_mos'] != null) {
		...
		<table align="center" width="90%" class="test1" style="border: 2px solid black;" height="Auto">
			...
			<tr style="border: 2px solid black;">
				<td colspan="2" style="border: 2px solid black;font-weight:bold;width:50%;">
			...
			<tr style="border: 2px solid black;">
				<td style="border: 2px solid black;font-weight:bold;width:25%;">Wt. of Hammer (kg)</td>
				<td style="border: 2px solid black;font-weight:bold;width:25%;">
					<center>8.0 &plusmn; 0.01</center>
				</td>
				<td style="border: 2px solid black;font-weight:bold;width:25%;">Tip Angle Measurement (&#176;)</td>
				<td style="border: 2px solid black;font-weight:bold;width:25%;">
			...
			<tr style="border: 2px solid black;">
				<td style="border: 2px solid black;font-weight:bold;width:25%;">Fall of Hammer (mm)</td>
				<td style="border: 2px solid black;font-weight:bold;width:25%;">
					<center>575 &plusmn; 1.0</center>
				</td>
				<td style="border: 2px solid black;font-weight:bold;width:25%;">Tip Base Dia. (mm)</td>
				<td style="border: 2px solid black;font-weight:bold;width:25%;">
		...
		<table align="center" width="90%" class="test1" style="border: 2px solid black;" height="Auto">
			<tr style="text-align:left">
				<td colspan="8" style="border: 2px solid black;"><b>Chainage No. -</b> <?php echo $chainage_no; ?></td>

			</tr>
			<tr style="text-align:center">
				<td colspan="8" style="border: 2px solid black;font-weight:bold;">Test - 1</td>


			</tr>
			<tr style="text-align:center">
				<td style="border: 1px solid black;">DCP<br>Blows</td>
				<td style="border: 1px solid black;">Scale Reading<Br>(mm)</td>
				<td style="border: 1px solid black;">DCP<br>Blows</td>
				<td style="border: 1px solid black;">Scale Reading<Br>(mm)</td>
				<td style="border: 1px solid black;border-left: 2px solid black;">DCP<br>Blows</td>
				<td style="border: 1px solid black;">Scale Reading<Br>(mm)</td>
				<td style="border: 1px solid black;">DCP<br>Blows</td>
				<td style="border: 1px solid black;">Scale Reading<Br>(mm)</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">26</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">27</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">28</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">29</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">30</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">31</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">32</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">33</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">34</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">35</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">36</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">37</td>
			...
			<tr style="text-align:center">
				...
				<td style="border: 1px solid black;border-left: 2px solid black;">38</td>
		...
		<br>
		<p class="test1" style="margin-left:5%;text-align:center;">Field CBR = 10^(2.465-1.12*(Log<sub>10</sub>(Pentration/Blow))) (%) = <?php echo $row_select_pipe['cbr']; ?></p>
