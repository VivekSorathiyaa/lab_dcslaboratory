			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">DBM - 2(MIX MATERIAL)</h2>
					</div>
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">37.5</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM dbm_2_mix_material WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_dbm_26_5_0_075_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>

												<?php } ?>
												<div class="col-sm-2">
													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=dbm_2_mix_material" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from dbm_2_mix_material WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		function abr_auto() {
			...
			if (abr_grading == "A") {
				...
				var abr_index = randomNumberFromRange(18.0, 22.0);
				$('#abr_index').val(abr_index.toFixed(1));
				var abrindex = $('#abr_index').val();
				var tt = randomNumberFromRange(-0.99, 0.99).toFixed(2);
				var r = randomNumberFromRange(0, 9).toFixed();
		...
		function sp_auto() {
			...
			var sp_waterabr = randomNumberFromRange(0.98, 1.10).toFixed(2); // (sp_water_abr)_1
		...
		function general_flk_elo1() {
			...
			$('#dd5').val(dd5.toFixed());
			var dd_5 = $('#dd5').val();
			var dd6 = (+sum_dd) * 0.165;
			$('#dd6').val(dd6.toFixed());
			var dd_6 = $('#dd6').val();
			var dd7 = (+sum_dd) * 0.105;
			$('#dd7').val(dd7.toFixed());
			var dd_7 = $('#dd7').val();
			var dd8 = (+sum_dd) * 0.04;
			$('#dd8').val(dd8.toFixed());
		...
		$('#combined_index').change(function() {
			...
			if ($("#chk_flk").is(':checked')) {
				...
				var suma = randomNumberFromRange(21000, 24000).toFixed();
				$('#suma').val(suma);
				var sum_a = $('#suma').val();
		...
		function grd_auto() {
			...
			var pass_sample_3 = randomNumberFromRange(72.00, 90.00).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(57.00, 71.00).toFixed(2);
			var pass_sample_5 = randomNumberFromRange(39.00, 53.00).toFixed(2);
			var pass_sample_6 = randomNumberFromRange(29.00, 38.00).toFixed(2);
			var pass_sample_7 = randomNumberFromRange(12.00, 20.00).toFixed(2);
			var pass_sample_8 = randomNumberFromRange(3.00, 7.00).toFixed(2);
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>savedbm_26_5_0_075_mm.php',
