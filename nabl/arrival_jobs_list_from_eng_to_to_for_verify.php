	...
	<div class="row m-0">		
		<div class="col-md-12">
			<div class="row m-0">
				...
				ARRIVAL JOB LIST FROM ENG TO VERIFY
				</h1>
			</div>
           <div class="row m-0">
				...
				<!-- /.box-header -->
						...
						<div id="display_data_report">
								...
								<tbody>
									<?php
										$count=0;
										$query="select * from job WHERE `jobisdeleted`=0 AND `rec_to_tm`='1' AND `tm_to_eng_blank`='1' AND `any_upload_come`='1' AND `all_verify`='0'  ORDER BY job_id DESC";
									...
									?>
											...
											{
											?>
											<a href="view_job_by_tm_for_verify.php?trf_no=<?php echo $row['trf_no'];?>&&job_no=<?php echo $row['job_number'];?>&&temporary_trf_no=<?php echo $row['temporary_trf_no'];?>" class="btn btn-primary" title="View Job"><span class="fa fa-eye"></span></a>
