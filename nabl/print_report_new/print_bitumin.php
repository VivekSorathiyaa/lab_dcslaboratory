...
?>
	...
	<page size="A4">
		...
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family:Cambria;margin-top:80px;border-bottom:0px solid black;">
			...
			<tr>
				<td style="text-align:center; font-size:15px;padding-bottom:15px; text-decoration: underline; text-underline-offset: 3px;"><b>Properties of Paving Bitumen</b></td>
			</tr>
				...
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 4px 0;margin-bottom:4px;    border-collapse: inherit;">
						...
						<td style="width:12%;padding-bottom: 4px;">Material Received</td>
							<td style="width:6%;text-align: center;padding-bottom: 4px;"> &raquo; </td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">Bitumen</td>
		...
		<tr>
            <td>
                <table cellpadding="0" cellpadding="0" align="center" width="100%" style="" class="test">
                    <tr>
					     <td style="padding:15px 0 4px;font-weight:bold;font-size:11px;">A) Paving Bitumen Test Results :</td>
                     </tr>
                </table>
            </td>
        </tr>
		...
		<tr>
		    <td style="text-align:left;font-size:12px; ">
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;border-right:1px solid;">
					...
					<tr style="">
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Name of Test</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Penetration Test at 25&deg;C  1/10 mm</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Softening Point Test at 5&deg;C (<sup>o</sup>C)</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Ductility Test at 25&deg;C, (cm)</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Absolute Viscosity at 60&deg;C (poise)</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Kinematic Viscosity at 135&deg;C (Cst)</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Specific Gravity at 27&deg;C</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Flash Point (cleveland open cup) &deg;C</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Solubility in Trichloroethylene, percent</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Viscosity Ratio at 60&deg;C</td>
					</tr>
					...
					<tr style="">
						...
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;"><?php if ($row_select_pipe['avg_pen'] != "" && $row_select_pipe['avg_pen'] != null && $row_select_pipe['avg_pen'] != "0") {
																														echo number_format($row_select_pipe['avg_pen'], 0);
																													} else {
																														echo "-";
																													} ?>
						</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;"><?php if ($row_select_pipe['avg_sof'] != "" && $row_select_pipe['avg_sof'] != null && $row_select_pipe['avg_sof'] != "0") {
																														echo number_format($row_select_pipe['avg_sof'], 1);
																													} else {
																														echo "-";
																													} ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;"><?php if ($row_select_pipe['avg_duc'] != "" && $row_select_pipe['avg_duc'] != null && $row_select_pipe['avg_duc'] != "0") {
																														echo number_format($row_select_pipe['avg_duc'], 1);
																													} else {
																														echo "-";
																													} ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;"><?php if ($row_select_pipe['avg_abs'] != "" && $row_select_pipe['avg_abs'] != null && $row_select_pipe['avg_abs'] != "0") {
																														echo number_format($row_select_pipe['avg_abs'], 1);
																													} else {
																														echo "-";
																													} ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;"><?php if ($row_select_pipe['avg_kin'] != "" && $row_select_pipe['avg_kin'] != null && $row_select_pipe['avg_kin'] != "0") {
																														echo number_format($row_select_pipe['avg_kin'], 1);
																													} else {
																														echo "-";
																													} ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;"><?php if ($row_select_pipe['avg_sp'] != "" && $row_select_pipe['avg_sp'] != null && $row_select_pipe['avg_sp'] != "0") {
																														echo number_format($row_select_pipe['avg_sp'], 2);
																													} else {
																														echo "-";
																													} ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;"><?php if ($row_select_pipe['fla_1'] != "" && $row_select_pipe['fla_1'] != null && $row_select_pipe['fla_1'] != "0") {
																														echo number_format($row_select_pipe['fla_1'], 2);
																													} else {
																														echo "-";
																													} ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;"><?php echo $row_select_pipe['sol_1']; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;"><?php echo $row_select_pipe['vis_1']; ?></td>
					</tr>


					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;">Test Method</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;">IS: 1203-2022</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;">IS: 1205-2022</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;">IS: 1208-P1-2023</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;">IS: 1206-P2-2022</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;">IS: 1206-P3-2021</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;">IS: 1202-2021</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;">IS: 1209-2021</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;">IS: 1216-1978</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:10px 4px;">IS: 1206-2022</td>
					</tr>
				
					<tr>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:8px 4px;" colspan=10>Requirement as per IS 73-2013, Table 1 (clause 6.2)</td>
					</tr>

					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">VG 10</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 80</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 40&deg;C</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 75</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">800-1200</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 250</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;" rowspan=4>Minimum 0.99</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;" rowspan=4>Minimum 220 &deg;C</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;" rowspan=4>Minimum 99.0 Percent</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;" rowspan=4>Max 4.0</td>
					</tr>

					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">VG 20</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 60</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 45&deg;C</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 50</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">1600-2400</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 300</td>
					</tr>

					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">VG 30</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 45</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 47&deg;C</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 40</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">2400-3600</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 350</td>
					</tr>


					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">VG 40</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 35</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 50&deg;C</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 24</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">3200-1800</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Min 400</td>
					</tr>
				</table>
			</td>
