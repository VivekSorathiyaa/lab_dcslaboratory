...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from rcc_63_mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
	...
	<page size="A4">
		<table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family:Cambria;margin-left:35px;margin-top:20px;border-bottom:0px solid black;">
		        <tr>
				...
				<tr>
					<td style="text-align:center; font-size:15px;padding-bottom:15px; text-decoration: underline; text-underline-offset: 3px;"><b>Mechanical Properties of Coarse Aggregate (Metal)</b></td>
				</tr>
				...
				<td>
					<table align="center" width="92%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 14px 0;">
						...
						<tr>
							...
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">Metal - Coarse Aggregate</td>
				...
				<td>
					<table align="left" width="100%" border="0px" cellspacing="0" cellpadding="0" class="test" style="">
						...
						<tr>
							...
							<td colspan="2" style="width:100%;display:flex;margin-top:20px;">
								<table align="top"  class="test" style="width:82%;max-width:450px;margin-left:30px;margin-bottom:20px;font-family: Cambria;">
								    <tr>
									...
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">80 mm</td>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">100</td>
										<!--<td style="text-align:center;border:1px solid black;border-left:0px solid black;"><? php // echo $row_select_pipe['cum_ret_1'];
																																?></td>-->
									</tr>
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">63 mm</td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;"><?php echo $row_select_pipe['pass_sample_2']; ?></td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">85-100</td>
										<!--<td style="text-align:center;border:1px solid black;border-left:0px solid black;"><? php // echo $row_select_pipe['cum_ret_2'];
																																?></td>-->
									</tr>
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">40 mm</td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;"><?php echo $row_select_pipe['pass_sample_3']; ?></td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">0-20</td>
										<!--<td style="text-align:center;border:1px solid black;border-left:0px solid black;"><? php // echo $row_select_pipe['cum_ret_3'];
																																?></td>-->
									</tr>
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">20 mm</td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;"><?php echo $row_select_pipe['pass_sample_4']; ?></td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">0-5</td>
							...
							<td colspan="4" style="width:100%;">
									<table align="center" width="92%" class="test" style="height:80%;font-size:10px;font-family: Cambria;border-bottom:1px solid;margin-right:30px;margin-bottom:20px;margin-top:10px;">
									<tr>
											<td>
												<table width="100%"  class="test" style="font-size:11px;font-family:Cambria;">
													<tr>
										...
										?>
											<tr>
												...
												<td style="font-size:11px;border-left: 1px solid black;border-top:1px solid black;border-right:1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Test Results</td>
											</tr>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;"><?php echo $row_select_pipe['combined_index']; ?></td>
												</tr>
									   ...
									   <td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center; ">I.S 2386-4</td>
													<td style="border-left: 1px solid black;border-right: 1px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;"><?php echo $row_select_pipe['imp_value']; ?></td>
												</tr>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['sp_specific_gravity']; ?></td>
												</tr>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">IS 2386-3</td>
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['sp_water_abr']; ?></td>
												</tr>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">--</td>
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">IS 2386-3</td>
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['bdl']; ?></td>
												</tr>
									   ...
									   <table style="border-collapse: collapse;width:100%;">
										 ...
										 <tr>
											<td style="border-right: 1px solid black;font-size:10px;text-align:center;width:50%;padding:5px 4px;">For other than <br> Wearing Surface</td>
													...
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['cru_value']; ?></td>
												</tr>
									   ...
									   <table style="border-collapse: collapse;width:100%;">
										 ...
										 <tr>
											...
											<td style="font-size:10px;text-align:center;width:50%;padding:5px 0;">Max 50%</td>
													...
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">IS 2386-4</td>
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['abr_index']; ?></td>
												</tr>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">--</td>
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">IS 2386-4</td>
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['fines_value']; ?></td>
												</tr>
						...
						<tr>
							...
							?>
								<td colspan="6" style="width:98%">
									<table align="center" width="98%" class="test" style="height:100%;width:98%;">
										<tr>
										...
										<tr>
											<td colspan="3" style="text-align:center;border:1px solid black;border-right:0px solid black;padding:5px 4px;"><b>III) Alkali Reactivity Test (Gravimetric Method)</b></td>
											...
											<td style="text-align:center;border:1px solid black;border-right:1px solid black;fonr-weight:bold;"><?php echo $row_select_pipe['alk_10']; ?></td>
										</tr>
									</table>
								</td>
							<?php
	...
	<!--<page size="A4">
		<center style="font-size:16px;font-family: Arial;margin-left:45px;padding-bottom:3px;font-weight:bold;"><b>TEST REPORT OF COARSE AGGREGATE</b></center>
						...
						<tr>
							...
							<td colspan="2" style="width:49%;vertical-align:top">
								<table align="top" width="100%" class="test" style="height:100%;width:100%;">
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">80 mm</td>
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">63 mm</td>
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">40 mm</td>
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;"><?php echo $row_select_pipe['pass_sample_3']; ?></td>
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">0-30</td>
										<!--<td style="text-align:center;border:1px solid black;border-left:0px solid black;"><? php // echo $row_select_pipe['cum_ret_3'];
																																?></td>
									</tr>
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">20 mm</td>
