...
<html>
	<body>
			...
			$trf_no = $_GET['trf_no'];
			 $select_tiles_query = "select * from rcc_26_5mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
		...
		<table align="center" width="90%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family:Cambria;margin-top:80px;border-bottom:0px solid black;">
		    <tr>
			...
			<tr>
				<table align="center" width="90%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;">
					<tr style="">
			...
			<tr>
				<td>
					<table align="center" width="90%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;">
			...
			<tr>
				<td>
					<table align="center" width="90%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 4px 0;margin-bottom:4px;    border-collapse: inherit;">
					    <tr>
			...
			<tr>
			    <td>
                    <table align="left" width="90%" border="0px" cellspacing="0" cellpadding="0" class="test" style="font-family: Cambria;margin-left:40px;margin-top:10px;">
                        <tr>
                        ...
                        <tr style="display:flex;">
                            <td colspan="2" style="width:90%;vertical-align:top;margin-bottom:10px;">
                                <table align="top" width="90%" class="test" style="max-width:400px;font-size:10px;font-family: Cambria;">
                                     <tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left: 1px solid black;font-weight:bold;padding:5px 4px;" colspan="2"><b>Particle Size Distribution Test</b></td>
									</tr>
									<tr>
										<td colspan="2" style="font-size:11px;text-align:center;border:1px solid black;border-left: 1px solid black;font-weight:bold;padding:5px 4px;" ><b>IS 2386 Part-1</b></td>
									</tr>
									...
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">19 mm</td>
									...
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">300 mic</td>
                            ...
                            ?>
                                <td colspan="6" style="width:90%">
                                    <table align="center" width="90%" class="test" style="margin-left:15px;max-width:350px;font-size:10px;font-family: Cambria;">
                                        <tr>
                        ...
                        <tr>
                          <td colspan="3" style="width:49%;vertical-align:top">
                                <table align="top" width="70%" class="test" style="height:90%;width:70%;">
                                    <?php
                                    if (($row_select_pipe['combined_index'] != "" && $row_select_pipe['combined_index'] != "0") || ($row_select_pipe['imp_value'] != "" && $row_select_pipe['imp_value'] != "0") || ($row_select_pipe['imp_value'] != "" && $row_select_pipe['imp_value'] != "0") || ($row_select_pipe['sp_specific_gravity'] != "" && $row_select_pipe['sp_specific_gravity'] != "0") || ($row_select_pipe['sp_water_abr'] != "" && $row_select_pipe['sp_water_abr'] != "0") || ($row_select_pipe['cru_value'] != "" && $row_select_pipe['cru_value'] != "0") || ($row_select_pipe['abr_index'] != "" && $row_select_pipe['abr_index'] != "0") || ($row_select_pipe['bdl'] != "" && $row_select_pipe['bdl'] != "0") || ($row_select_pipe['fines_value'] != "" && $row_select_pipe['fines_value'] != "0") || ($row_select_pipe['liquide_limit'] != "" && $row_select_pipe['liquide_limit'] != "0") || ($row_select_pipe['soundness'] != "" && $row_select_pipe['soundness'] != "0") || ($row_select_pipe['cbr'] != "" && $row_select_pipe['cbr'] != "0") || ($row_select_pipe['mdd'] != "" && $row_select_pipe['mdd'] != "0") || ($row_select_pipe['omc'] != "" && $row_select_pipe['omc'] != "0")) {
									...
									<?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">2.1 - 3.70</td>
                                            </tr>
                                        <?php
                                        }
		...
		<table cellpadding="0" cellpadding="0" align="center" width="90%" style="font-size:11px;font-family: Cambria;" class="test">
						<tr>
	    ...
	    <table align="center" width="95%" class="test">
		        <tr>
					<td style="text-align:center;font-size:10px;">
						<table align="center" width="95%" class="test" style="height:auto;font-family: Cambria;border-top:1px solid black;border-bottom:1px solid black;">
							<tr>
								<td><b>Note :-</b></td>
								<td></td>
							</tr>
		...
		<table width="90%" align="center" style="font-family:Cambria;font-size:10px;">
						<tr>
		...
		<table align="center" width="92%" class="test" style="margin-left:35px; ">
			...
			<tr>
				...
				<td rowspan="3" style="border: 1px solid black;text-align:center;"> IS 2386 : 1963 <br> Part-3 <br> (RA 2016)</td>	
			...
			<tr>
				...
				<td rowspan="6" style="border: 1px solid black;text-align:center;"> IS 2386:1963 <br> Part-1 <br> (RA 2016)</td>	
				<td style="border: 1px solid black;text-align:center; font-weight:bold;"> % passing </td>	
				<td style="border: 1px solid black;text-align:center;"> </td>	
			</tr>
			<tr>
				<td style="border: 1px solid black;text-align:center;"></td>	
				<td style="border: 1px solid black;">&nbsp;&nbsp; 75 mm </td>	
			...
			<tr>
				<td style="border: 1px solid black;text-align:center;"></td>	
				<td style="border: 1px solid black;">&nbsp;&nbsp; 63 mm</td>	
			...
			<tr>
				<td style="border: 1px solid black;text-align:center;"></td>	
				<td style="border: 1px solid black;">&nbsp;&nbsp; 50 mm</td>	
				...
				<td style="border: 1px solid black;text-align:center;"> 60-80 </td>	
			</tr>
			<tr>
				<td style="border: 1px solid black;text-align:center;"></td>	
				<td style="border: 1px solid black;">&nbsp;&nbsp; 50 mm </td>	
			...
			<tr>
				<td style="border: 1px solid black;text-align:center;"></td>	
				<td style="border: 1px solid black;">&nbsp;&nbsp; 25 mm </td>	
				<td style="border: 1px solid black;text-align:center; font-weight:bold;"> <?php if($row_select_pipe['pass_sample_5'] != "" && $row_select_pipe['pass_sample_5'] != null){ echo $row_select_pipe['pass_sample_5']; } else{ echo "-";}?></td>	
			...
			<tr>
				...
				<td rowspan="3" style="border: 1px solid black;text-align:center;">IS 2386:1963 <br> Part-4 <br> (RA 2016)</td>
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"> For concrete 30% </td>	
			</tr>
			<tr>
				<td style="border: 1px solid black;text-align:center;">7</td>	
				<td style="border: 1px solid black;">&nbsp;&nbsp; Loss Angles Abrasion Value (%)</td>		
				...
				<td style="border: 1px solid black;text-align:center;"> For concrete 40% </td>	
			</tr>
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;">IS 2386:1963 <br> Part-5 <br> (RA 2016)</td>	
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"> IS 2386: 1963 <br> Part-1 <br> (RA 2016)</td>	
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"> IS 2386: 1963 <br> Part-4 <br> (RA 2016)</td>	
				...
				<td style="border: 1px solid black;text-align:center;"> Min. 50kN Load</td>	
			</tr>
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"> IS 2386: 1963 <br> Part-2 <br> (RA 2016)</td>	
				<td style="border: 1px solid black;text-align:center; font-weight:bold;"> <?php if($row_select_pipe['fines_value'] != "" && $row_select_pipe['fines_value'] != "0" && $row_select_pipe['fines_value'] != null){ echo $row_select_pipe['fines_value']; } else{ echo "-";}?></td>	
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"> IS 2386: 1963 <br> Part-7 <br> (RA 2016)</td>	
				...
				<tr>
					<td >
						<div style="margin-top:20px;">
							<b style="font-size:10px;font-weight:100;">F/AGG/01, Issue No.01</b><br>
							<font style="font-size:10px;font-weight:100;">W.e.f. 01.12.2012</font><br>
						</div>
					</td>
					<td>
						<div style="margin-top:20px;float:right;">
							<b style="font-size:10px;font-weight:100;">Page: 1<br>
						</div>
					</td>
				</tr>
			</table>
