...
<html>
	<body>
		...
		<table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family:Cambria;margin-top:80px;border-bottom:0px solid black;">
			...
			<tr>
				<td style="text-align:center; font-size:15px;padding-bottom:15px; text-decoration: underline; text-underline-offset: 3px;"><b>Admixture</b></td>
			</tr>
			...
			<table align="center" width="100%" class="test" style="font-size:10px;font-family: Cambria;border-top:1px solid;border-bottom:1px solid;border-right:1px solid;margin-top:15px;">
				<tr>
					...
					<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Test Result </td>								
					<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;width:50%;">Specification Requirement<br> <?php if($row_select_pipe['phv_test_req']!=""  && $row_select_pipe['phv_test_req']!=null  && $row_select_pipe['phv_test_req']!="0"  && $row_select_pipe['phv_test_req']!="undefined"){ echo $row_select_pipe['phv_test_req'];} else {?>(IS 9103 Annex-E) <?php }?></td>								
				...
				<tr>
					...
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">pH</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php  echo $row_select_pipe['phv_avg_before']; ?></td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php if($row_select_pipe['phv_test_limit']!=""  && $row_select_pipe['phv_test_limit']!=null  && $row_select_pipe['phv_test_limit']!="0"  && $row_select_pipe['phv_test_limit']!="undefined"){ echo $row_select_pipe['phv_test_limit'];} else {?>Min 6.00<?php }?></td>
					<td rowspan="4" style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php if($row_select_pipe['phv_test_method']!=""  && $row_select_pipe['phv_test_method']!=null  && $row_select_pipe['phv_test_method']!="0"  && $row_select_pipe['phv_test_method']!="undefined"){ echo str_replace(" (","<br />(",$row_select_pipe['phv_test_method']);} else {?>IS 9103 : 1999 <br> (RA 2018) <br> Annex - E<?php }?></td>
				</tr>
				<tr>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">2</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"> Relative Density (%)</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php  echo $row_select_pipe['avg_rdv']; ?> %</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php if($row_select_pipe['rdv_test_limit']!=""  && $row_select_pipe['rdv_test_limit']!=null  && $row_select_pipe['rdv_test_limit']!="0"  && $row_select_pipe['rdv_test_limit']!="undefined"){ echo $row_select_pipe['rdv_test_limit'];} else {?>Within 0.02 of the value stated by the manufacturer<?php }?></td>
				</tr>
				<tr>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">3</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Dry Material Content (%)</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php  echo $row_select_pipe['dmc_content']; ?> %</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php if($row_select_pipe['dmc_test_limit']!=""  && $row_select_pipe['dmc_test_limit']!=null  && $row_select_pipe['dmc_test_limit']!="0"  && $row_select_pipe['dmc_test_limit']!="undefined"){ echo $row_select_pipe['dmc_test_limit'];} else {?>Within 5%  of the value stated by the manufacturer<?php }?></td>
				</tr>
				<tr >
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">4</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Ash Content (%)</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php  echo $row_select_pipe['ash_content']; ?> %</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php if($row_select_pipe['ash_test_limit']!=""  && $row_select_pipe['ash_test_limit']!=null  && $row_select_pipe['ash_test_limit']!="0"  && $row_select_pipe['ash_test_limit']!="undefined"){ echo $row_select_pipe['ash_test_limit'];} else {?>Within 5% of the value stated by the manufacturer<?php }?></td>
				</tr>
				<tr>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">5</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Chloride Content (%)</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php  echo $row_select_pipe['chloride_content']; ?> %</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;;"><?php if($row_select_pipe['clr_test_limit']!=""  && $row_select_pipe['clr_test_limit']!=null  && $row_select_pipe['clr_test_limit']!="0"  && $row_select_pipe['clr_test_limit']!="undefined"){ echo $row_select_pipe['clr_test_limit'];} else {?>Within 10 % of the value or Within 0.2 % of whichever is greater as the value stated by the manufacturer<?php }?></td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"> IS 6925 : 1973 <br> (RA 2018)</td>
				</tr>
