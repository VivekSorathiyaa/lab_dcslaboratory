...
<body>
	...
	<page size="A4">
		...
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Cambria;margin-top:50px;">
		    <tr>
			...
			<tr>
				<td style="text-align:center; font-size:15px;padding-bottom:15px; text-decoration: underline; text-underline-offset: 3px;"><b>RCPT of Concrete</b></td>
			</tr>
				...
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;border-collapse: inherit;padding:4px 0;margin-bottom:6px;">
					    <tr>
							...
							<td style="width:6%;padding-bottom: 4px;text-align: center;"> &raquo;</td>
							<td style="width:40%;padding-bottom: 4px;"><?php echo $row_select_pipe['location1'];?></td>
						</tr>
						...
						<tr>
						    <td style="width:12%;padding-bottom: 4px;">Spicemen Size</td>
							<td style="width:6%;text-align: center;padding-bottom: 4px;">&raquo;</td>
						...
						<tr>
						    <td style="width:12%;padding-bottom: 4px;">Material of Tet</td>
							<td style="width:6%;text-align: center;padding-bottom: 4px;"> &raquo; </td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">ASTM C 1202.19</td>
							<!-- <td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;"><?php echo $mt_name; ?></td> -->
							<td style="width:21%;padding-bottom: 4px;text-align:right;">Grade of Concrete</td>
							<td style="width:6%;text-align: center;padding-bottom: 4px;">&raquo;</td>
							<td style="width:40%;padding-bottom: 4px;"><?php echo $row_select_pipe['cube_grade'];?></td>
						</tr>	
					</table>
				</td>
			</tr>
		...
		<?php $cnt = 1; ?>
				...
				<td style="text-align:center;font-size:11px;">
				    <table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;border-right:1px solid;margin-top:20px;">
						...
						<tr style="">
							...
							<td rowspan=2 style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Date of Testing</td>
							<td colspan="2" style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Size of Core in mm</td>
							<td rowspan=2 style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Chloride Ion Penetrability <br>(Charged Passed) coulombs (Qx)</td>
							<td rowspan=2 style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Corrected Penetrability <br>(Charged Passed) As per Clause <br> 11.2 ASTM C1202-12* (Qs)</td>
						</tr>
			...
			<tr>
				<td style="text-align:center;font-size:11px;">
				    <table align="left" width="100%" Height="20%" cellspacing="0" cellpadding="0" style="font-size:12px;font-family: Cambria;border-bottom:1px solid;margin-top:20px;">
						<tr style="">
							<td colspan="2"><b>Specification Rcquirements as per ASTM C l202 - l9 , Table X1.l</b></td>
						</tr>
						<tr style="">
	...
	<!--<page size="A4">
		...
		<table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:13px;font-family: Arial;border:1px solid black;margin-left:35px; ">
			...
			<tr>
				<!--OTHER START>
				<td>
					<table align="center" width="95%" class="test" style="border: 1px solid black;font-size:10px;" cellpadding="3px">
						<tr>
