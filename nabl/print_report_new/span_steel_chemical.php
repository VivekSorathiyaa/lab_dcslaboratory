		...
		<table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Cambria;margin-left:35px;">
			...
			<tr>
				<td style="text-align:left;font-size:12px; ">
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:12px;font-family: Cambria;border-bottom:1px solid;border-right:1px solid;margin-top:20px;margin-bottom:20px;">
						...
						<tr style="">
							...
							<td style="border-left: 1px solid black;border-right: 1px solid black;width:14%;border-top:1px solid;text-align:center;"><?php if ($row_select_pipe2['c3'] != "" && $row_select_pipe2['c3'] != null && $row_select_pipe2['c3'] != "0") {
							...
							<td style="width:28%;border-top:1px solid;text-align:center;"><?php if ($row_select_pipe2['c3'] != "" && $row_select_pipe2['c3'] != null && $row_select_pipe2['c3'] != "0" && $row_select_pipe2['c2'] != "" && $row_select_pipe2['c2'] != null && $row_select_pipe2['c2'] != "0") {
																									$a2 = number_format($row_select_pipe2['c3'], 3) + number_format($row_select_pipe2['c2'], 3);
						...
						<tr style="">
							...
							<td style="font-weight:bold;border-left: 1px solid black;width:70%; text-align:center;border-top:1px solid;" colspan=4>IS 8811 : l998</td>
						</tr>
			...
			<tr>
                    <td>
                        <table cellpadding="0" cellpadding="0" align="center" width="100%" style="" class="test">
                            <tr>
                            <td style="font-size:10px;text-align:left;font-weight:bold;padding:15px 0 5px;font-family:Cambria;"> Requirement as per IS l786 - 2008</td>
                            </tr>
                        </table>
                    </td>
            </tr>
                ...
                <td colspan="3" style="width:100%;vertical-align:top">
								<table align="top" width="100%" class="test" style="font-family: Cambria;font-size:10px;">             
										<tr>
											...
											<td colspan="7" style="font-size:11px;text-align:center;border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;font-weight:bold;padding:5px 4px;"><b>Stel Grade</b></td>
										</tr>
										<tr>
										...
										<tr>
												<td style="font-size:10px;text-align:center;border:1px solid black;">1</td>
												<td style="font-size:10px;text-align:left;border:1px solid black;border-left:1px solid black;padding:5px 0;">&nbsp; Sulphar & Phosphourus in % (max)</td>
										...
										<tr>
												<td style="font-size:10px;text-align:center;border:1px solid black;">2</td>
												<td style="font-size:10px;text-align:left;border:1px solid black;border-left:1px solid black;padding:5px 0;">&nbsp; Sulphar in % (max)</td>
										...
										<tr>
												<td style="font-size:10px;text-align:center;border:1px solid black;">3</td>
												<td style="font-size:10px;text-align:left;border:1px solid black;border-left:1px solid black;padding:5px 0;">&nbsp; Phosphourus in % (max)</td>
												<td style="text-align:center;border:1px solid black;border-right:0px solid black;">0.060</td>
												<td style="text-align:center;border:1px solid black;border-right:0px solid black;">0.045</td>
												<td style="text-align:center;border:1px solid black;border-right:1px solid black;">0.055</td>
                                                <td style="text-align:center;border:1px solid black;border-right:1px solid black;">0.040</td>
										...
										<tr>
												<td style="font-size:10px;text-align:center;border:1px solid black;">4</td>
												<td style="font-size:10px;text-align:left;border:1px solid black;border-left:1px solid black;padding:5px 0;">&nbsp; Carbon in % (max)</td>
