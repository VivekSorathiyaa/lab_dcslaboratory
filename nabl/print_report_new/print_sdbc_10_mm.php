...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from sdbc_2_mix_material WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
                            ...
                            <td colspan="2" style="width:100%;vertical-align:top">
                                <table align="top" width="100%" class="test" style="max-width:400px;font-size:10px;font-family: Cambria;">
									...
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">90-100</td>
									</tr>
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">35-51</td>
									</tr>
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">24-39</td>
									</tr>
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">1.18 mm</td>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">15-30</td>
									</tr>
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">9-19</td>
									</tr>
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">3-8</td>
									</tr>
                                    <tr>
									...
									<?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td rowspan="3" style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Max 25%</td>
                                            </tr>
                                            <tr>
							...
							<td colspan="2" style="width:49%;vertical-align:top">
								<table align="top" width="100%" class="test" style="height:100%;width:100%;">
									...
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">35-51</td>
									</tr>
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">24-39</td>
									</tr>
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">15-30</td>
									</tr>
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">9-19</td>
									</tr>
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">3-8</td>
									</tr>
									...
									?>
										...
										?>
											<tr>
												...
												<td rowspan="2" style="text-align:center;border:1px solid black;border-right:0px solid black;">Max. 30%</td>
