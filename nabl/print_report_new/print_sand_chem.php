...
<body>
	...
	?>
	<page size="A4">
		<center style="font-size:16px;font-family: Arial;padding-bottom:3px;font-weight:bold;"><b>TEST REPORT OF FINE AGGREGATE</b></center>


		<table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:12.7px;font-family: Arial;margin-left:45px;margin-right:15px;border:1px solid black;border-bottom:0px solid black;">
			<tr>
				<td>
		...
		<table width="95%" cellspacing="0" cellpadding="0" style="font-size:12.7px;font-family: Arial;//position:fixed;bottom:50px;">
			<tr>
