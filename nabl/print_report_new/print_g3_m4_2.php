...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from gsb_mix_3_m4_2 WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
				...
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 4px 0;margin-bottom:4px;    border-collapse: inherit;">
						...
						<tr>
							...
							<td style="width:6%;text-align: center;padding-bottom: 4px;"> &raquo; </td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">Natural / Crushed GSB-III Mix (M4-2)</td>
							...
							<td colspan="2" style="width:49%;vertical-align:top">
								<table align="top" width="100%" class="test" style="height:100%;width:100%;">
									...
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">25-45</td>
									</tr>
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">&lt; 10</td>
									</tr>
									...
									?>
										...
										?>
											<tr>
												...
												<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Min. 20</td>
								...
								<td colspan="2" style="width:100%;vertical-align:top">
									<table align="top" width="100%" class="test" style="max-width:400px;font-size:10px;font-family: Cambria;">
										...
										<tr>
											...
											<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">25-45</td>
										</tr>
										<tr>
											...
											<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">&lt; 10
										    </td>
										</tr>
										<tr>
