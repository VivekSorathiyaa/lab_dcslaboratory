...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from bc_2_36_0_075_mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
				...
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 4px 0;margin-bottom:4px;    border-collapse: inherit;">
						...
						<tr>
							...
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">BC Stone-Dust <?php echo $mt_name; ?></td>
                        ...
                        <tr style="display:flex;">
                            <td colspan="2" style="width:100%;vertical-align:top">
                                <table align="top" width="100%" class="test" style="max-width:400px;font-size:10px;font-family: Cambria;">
										...
										<tr>
											<td style="text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 4px;"> Sieve Size</td>
												...
												<td style="border-right:1px solid black;">
													<table style="width:100%;border-collapse: collapse;">
														<tr>
															<td style="font-size:10px;text-align:center;border-bottom:0px solid black;padding:5px 4px;">% of Passing</td>
														</tr>
													</table>
											    </td>
										</tr>
									...
									<tr>
                                        <td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">0.6 mm</td>
									...
									<tr>
                                        <td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">0.15 mm</td>
