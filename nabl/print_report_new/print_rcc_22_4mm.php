...
<html>
	<body>
			...
			$trf_no = $_GET['trf_no'];
			 $select_tiles_query = "select * from rcc_22_4mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
                            ...
                            <td colspan="2" style="width:90%;vertical-align:top">
                                <table align="top" width="90%" class="test" style="max-width:400px;font-size:10px;font-family: Cambria;">
									...
									<tr>
										...
										<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">22.4 mm</td>
									...
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">13.2 mm</td>
									...
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">11.2 mm</td>
									...
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">5.6 mm</td>
