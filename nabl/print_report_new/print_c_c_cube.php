...
*/
	...
	<page size="A4">
		...
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Cambria;margin-top:80px;">
			...
			<tr>
				<td style="text-align:center; font-size:15px;padding-bottom:15px; text-decoration: underline; text-underline-offset: 3px;"><b>Compressive Strength of Concrete Cubes</b></td>
			</tr>
					...
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family: Cambria;border-bottom:0px solid;border-right:0px solid;">
						...
						?>
							...
							<tr style="">
								...
								<td style="border-right:1px solid;border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo substr((($row_select_pipe['mass_1']) / ($row_select_pipe['cross_1'] / 1000000)),0,6); ?></td>
							</tr>
							...
							<tr style="">
								...
								<td style="border-right:1px solid;border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo substr((($row_select_pipe['mass_2']) / ($row_select_pipe['cross_2'] / 1000000)),0,6); ?></td>
							</tr>
							...
							<tr style="">
								...
								<td style="border-right:1px solid;border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo substr((($row_select_pipe['mass_3']) / ($row_select_pipe['cross_3'] / 1000000)),0,6); ?></td>
							</tr>
							...
							<tr style="">
								...
								<td style="border-bottom:1px solid black;border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;font-weight:bold;"><?php echo $row_select_pipe['avg_com_s_1']; ?></td>
								<td style="border-right:1px solid;border-bottom:1px solid black;border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;font-weight:bold;"><?php echo substr(((((($row_select_pipe['mass_1']) / (($row_select_pipe['cross_1']) / 1000000))) + (($row_select_pipe['mass_2']) / (($row_select_pipe['cross_2']) / 1000000)) + (($row_select_pipe['mass_3']) / (($row_select_pipe['cross_3']) / 1000000))) / 3),0,6); ?></td>
							</tr>
