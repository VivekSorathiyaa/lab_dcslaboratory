			...
			<tr>
				<td style="text-align:center;font-size:11px; ">
					...
					<table align="left" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;border-right:1px solid;margin-top:8px;">
						...
						<tr style="">
							...
							<td style="font-size:10px;text-align:center;border-left:1px solid black;border-top:1px solid black;">
							            <table style="width:100%;border-collapse: collapse;">
							  			    <tr>
												<td style="border-right:1px solid black;font-size:10px;text-align:center;padding:4px 4px;width:20%;"><?php if ($row_select_pipe['rstr1'] != "" && $row_select_pipe['rstr1'] != null && $row_select_pipe['rstr1'] != "0") { echo $row_select_pipe['rstr1']; } else { echo "-"; } ?></td>
												<td style="border-right:1px solid black;font-size:10px;text-align:center;padding:4px 4px;width:20%;"><?php if ($row_select_pipe['rstr2'] != "" && $row_select_pipe['rstr2'] != null && $row_select_pipe['rstr2'] != "0") { echo $row_select_pipe['rstr2']; } else { echo "-"; } ?></td>
												<td style="border-right:1px solid black;font-size:10px;text-align:center;padding:4px 4px;width:20%;"><?php if ($row_select_pipe['rstr3'] != "" && $row_select_pipe['rstr3'] != null && $row_select_pipe['rstr3'] != "0") { echo $row_select_pipe['rstr3']; } else { echo "-"; } ?></td>
												<td style="border-right:1px solid black;font-size:10px;text-align:center;padding:4px 4px;width:20%;"><?php if ($row_select_pipe['rstr4'] != "" && $row_select_pipe['rstr4'] != null && $row_select_pipe['rstr4'] != "0") { echo $row_select_pipe['rstr4']; } else { echo "-"; } ?></td>
												<td style="font-size:10px;text-align:center;padding:4px 4px;width:20%;"><?php if ($row_select_pipe['rstr5'] != "" && $row_select_pipe['rstr5'] != null && $row_select_pipe['rstr5'] != "0") { echo $row_select_pipe['rstr5']; } else { echo "-"; } ?></td>
											</tr>
										</table>	
							</td>
						...
						<tr style="">
							<td style="font-size:10px;text-align:center;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;"><?php echo $cnt++; ?></td>
							<td style="font-size:10px;text-align:left;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;" colspan=2><b>Average (N/mm<sup>2</sup>)</b></td>
							<td style="font-size:10px;text-align:center;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;"><?php if ($row_select_pipe['rstr5'] != "" && $row_select_pipe['rstr5'] != null && $row_select_pipe['rstr5'] != "0") { echo ($row_select_pipe['rstr1'] + $row_select_pipe['rstr2'] + $row_select_pipe['rstr3'] + $row_select_pipe['rstr4'] + $row_select_pipe['rstr5']) / 5; } else { echo "-"; } ?></td>
						...
						<tr style="">
							<td style="font-size:10px;text-align:center;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;"></td>
							<td style="font-size:10px;text-align:left;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;" colspan=2><b>Average (%)</b></td>
							<td style="font-size:10px;text-align:center;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;"><?php if ($row_select_pipe['wtr5'] != "" && $row_select_pipe['wtr5'] != null && $row_select_pipe['wtr5'] != "0") { echo ($row_select_pipe['wtr1'] + $row_select_pipe['wtr2'] + $row_select_pipe['wtr3'] + $row_select_pipe['wtr4'] + $row_select_pipe['wtr5']) / 5; } else { echo "-"; } ?></td>
						...
						<tr style="">
							<td style="font-size:10px;text-align:center;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;"><?php echo $cnt++; ?></td>
							<td style="font-size:10px;text-align:left;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;" colspan=2><b>Breaking Strength (N)</b></td>
							<td style="font-size:10px;text-align:center;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;"></td>
							<td style="font-size:10px;text-align:center;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;"></td>
						...
						<tr style="">
							...
							<td style="font-size:10px;text-align:center;border-left:1px solid black;border-top:1px solid black;">
							            <table style="width:100%;border-collapse: collapse;">
										    <tr>
												<td style="border-right:1px solid black;font-size:10px;text-align:center;padding:4px 4px;width:20%;"><?php if ($row_select_pipe['str1'] != "" && $row_select_pipe['str1'] != null && $row_select_pipe['str1'] != "0") { echo $row_select_pipe['str1']; } else { echo "-"; } ?></td>
												<td style="border-right:1px solid black;font-size:10px;text-align:center;padding:4px 4px;width:20%;"><?php if ($row_select_pipe['str2'] != "" && $row_select_pipe['str2'] != null && $row_select_pipe['str2'] != "0") { echo $row_select_pipe['str2']; } else { echo "-"; } ?></td>
												<td style="border-right:1px solid black;font-size:10px;text-align:center;padding:4px 4px;width:20%;"><?php if ($row_select_pipe['str3'] != "" && $row_select_pipe['str3'] != null && $row_select_pipe['str3'] != "0") { echo $row_select_pipe['str3']; } else { echo "-"; } ?></td>
												<td style="border-right:1px solid black;font-size:10px;text-align:center;padding:4px 4px;width:20%;"><?php if ($row_select_pipe['str4'] != "" && $row_select_pipe['str4'] != null && $row_select_pipe['str4'] != "0") { echo $row_select_pipe['str4']; } else { echo "-"; } ?></td>
												<td style="font-size:10px;text-align:center;padding:4px 4px;width:20%;"><?php if ($row_select_pipe['str5'] != "" && $row_select_pipe['str5'] != null && $row_select_pipe['str5'] != "0") { echo $row_select_pipe['str5']; } else { echo "-"; } ?></td>
											</tr>
										</table>																												</td>
							<!-- <td style="border-left: 1px solid black;border-top: 1px solid black;width:10%;text-align:center;font-weight:bold; ">Min, lOOO N</td> -->
							<td style="font-size:10px;text-align:center;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;"></td>
						...
						<tr style="">
							<td style="font-size:10px;text-align:center;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;"></td>
							<td style="font-size:10px;text-align:left;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;" colspan=2 rowspan=2><b>Average (N)</b></td>
							<td style="font-size:10px;text-align:center;border-left:1px solid black;border-top:1px solid black;padding:4px 4px;" rowspan=2><?php if ($row_select_pipe['str5'] != "" && $row_select_pipe['str5'] != null && $row_select_pipe['str5'] != "0") { echo ($row_select_pipe['str1'] + $row_select_pipe['str2'] + $row_select_pipe['str3'] + $row_select_pipe['str4'] + $row_select_pipe['str5']) / 5; } else { echo "-"; } ?></td>
