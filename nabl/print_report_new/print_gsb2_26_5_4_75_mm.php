...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from gsb_26_5_4_75_mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
				...
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 4px 0;margin-bottom:4px;    border-collapse: inherit;">
						...
						<tr>
							...
							<td style="width:6%;text-align: center;padding-bottom: 4px;"> &raquo; </td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">GSB-II ( 26.5 - 4.75 MM )</td>
					...
					<table align="left" width="100%" border="0px" cellspacing="0" cellpadding="0" class="test" style="font-family: Cambria;">
						...
						<tr style="display:flex;">
								<td colspan="2" style="width:100%;vertical-align:top">
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;"><b>Sieve Size</b></td>
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;">53 mm</td>
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;">26.5 mm</td>
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;">9.5 mm</td>
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;">4.75 mm</td>
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;">2.36 mm</td>
									...
									<table align="top" width="80%" class="test" style="font-size:10px;font-family: Cambria;">
										...
										?>
											...
											<tr>
													...
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">IS 2720 Part 8</td>
