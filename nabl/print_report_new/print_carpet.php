...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from carpet WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
			    ...
			    <td>
                    <table align="left" width="100%" border="0px" cellspacing="0" cellpadding="0" class="test" style="font-family: Cambria;">
                        ...
                        <tr style="display:flex;">
                            <td colspan="2" style="width:97%;vertical-align:top">
                                <table align="top" width="97%" class="test" style="max-width:400px;font-size:10px;font-family: Cambria;">
                                     <tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 4px;"> Sieve Size</td>
												...
												<td style="border-right:1px solid black;">
													<table style="width:100%;border-collapse: collapse;">
														<tr>
															<td style="font-size:10px;text-align:center;padding:5px 4px;">Test Result</td>
														</tr>
														<tr style="">
									...
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">3.6 mm</td>
						...
						<tr>
							...
							<td colspan="2" style="width:49%;vertical-align:top">
								<table align="top" width="100%" class="test" style="height:100%;width:100%;">
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">3.6 mm</td>
