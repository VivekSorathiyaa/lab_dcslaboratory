...
<html>
	...
	<page size="A4">
		<table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family:Cambria;margin-top:80px;border-bottom:0px solid black;">
				<tr>
					<td style="text-align:center; font-size:20px;padding-bottom:8px; text-decoration: underline; text-underline-offset: 3px;"><b>TEST REPORT OF ROCK SAMPLES</b></td>
				</tr>
		</table>
	        ...
	        <tr>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;">
					<tr style="">
						<td style="width:12%;padding-bottom: 4px;"><?php if($row_select_pipe1['ulr'] != "" && $row_select_pipe1['ulr'] != "0" && $row_select_pipe1['ulr'] != null){
		    ...
		    <table align="center" width="100%"  cellspacing="0" cellpadding="0" style="">
				<td>
					<table align="left" width="100%"  class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;border-right:1px solid;margin-top:20px" >
						<tr>
							<td width="17%" style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Lab No.</td>
							<td width="11%" style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Particulars</td>
							<td width="11%" style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Specific gravity</td>
							<td width="11%" style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Water Content (%)</td>
							<td width="11%" style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Water Absorption (%)</td>
							<td width="11%" style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Porosity (%)</td>
							<td width="11%" style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Density(Kg/m<sup>3</sup>)</td>
							<td width="17%" style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Compressive Strength (N/mm<sup>2</sup>) </td>
						</tr>
						<tr>
							<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:10px 4px;"><?php echo $lab_no; ?></td>
							<td style="font-size:14pxpx;text-align:center;border:1px solid black;border-left:1px solid black;padding:10px 4px;"><b>Test Result</b></td>
							<td  style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:10px 4px;"><?php if($row_select_pipe1['sp_specific_gravity']!="" && $row_select_pipe1['sp_specific_gravity']!="0" && $row_select_pipe1['sp_specific_gravity']!=null){echo $row_select_pipe1['sp_specific_gravity']; }else{echo " <br>";}  ?></td>
							<td  style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:10px 4px;"><?php if($row_select_pipe1['avg_wtr']!="" && $row_select_pipe1['avg_wtr']!="0" && $row_select_pipe1['avg_wtr']!=null){echo $row_select_pipe1['avg_wtr']; }else{echo " <br>";}  ?></td>
							<td  style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:10px 4px;"><?php if($row_select_pipe1['sp_water_abr']!="" && $row_select_pipe1['sp_water_abr']!="0" && $row_select_pipe1['sp_water_abr']!=null){echo $row_select_pipe1['sp_water_abr']; }else{echo " <br>";}  ?></td>
							<td  style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:10px 4px;"><?php if($row_select_pipe1['avg_por']!="" && $row_select_pipe1['avg_por']!="0" && $row_select_pipe1['avg_por']!=null){echo $row_select_pipe1['avg_por']; }else{echo " <br>";}  ?></td>
							<td  style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:10px 4px;"><?php echo $row_select_pipe1['avg_den']; ?></td>
							<td  style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:10px 4px;"><?php if($row_select_pipe1['avg_ucs']!="" && $row_select_pipe1['avg_ucs']!="0" && $row_select_pipe1['avg_ucs']!=null){echo $row_select_pipe1['avg_ucs']; }else{echo " <br>";}  ?></td>
						</tr>
						...
						<!--<tr>
							...
							<?php// }  if($row_select_pipe1['avg_spg']!="" && $row_select_pipe1['avg_spg']!="0" && $row_select_pipe1['avg_spg']!=null){?>
									<td  style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:10px 4px;"><?php if($row_select_pipe1['avg_spg']!="" && $row_select_pipe1['avg_spg']!="0" && $row_select_pipe1['avg_spg']!=null){echo $row_select_pipe1['avg_spg']; }else{echo " <br>";}  ?></td>


							<?php// }  if($row_select_pipe1['chk_wtr']!="" && $row_select_pipe1['chk_wtr']!="0" && $row_select_pipe1['chk_wtr']!=null){?>
									<td  style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:10px 4px;"><?php if($row_select_pipe1['chk_wtr']!="" && $row_select_pipe1['chk_wtr']!="0" && $row_select_pipe1['chk_wtr']!=null){echo $row_select_pipe1['chk_wtr']; }else{echo " <br>";}  ?></td>
							...
							<?php //}  if($row_select_pipe1['avg_por']!="" && $row_select_pipe1['avg_por']!="0" && $row_select_pipe1['avg_por']!=null){?>
									<td  style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:10px 4px;"><?php if($row_select_pipe1['avg_por']!="" && $row_select_pipe1['avg_den']!="0" && $row_select_pipe1['avg_den']!=null){echo $row_select_pipe1['avg_den']; }else{echo " <br>";}  ?></td>
						   ...
						   <?php// }  if($row_select_pipe1['avg_ucs']!="" && $row_select_pipe1['avg_ucs']!="0" && $row_select_pipe1['avg_ucs']!=null){?>
							...
							<?php// }  if($row_select_pipe1['avg_tes']!="" && $row_select_pipe1['avg_tes']!="0" && $row_select_pipe1['avg_tes']!=null){ ?>
									<td  style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:10px 4px;"><?php if($row_select_pipe1['avg_tes']!="" && $row_select_pipe1['avg_tes']!="0" && $row_select_pipe1['avg_tes']!=null){echo $row_select_pipe1['avg_tes']; }else{echo " <br>";}  ?></td>	
