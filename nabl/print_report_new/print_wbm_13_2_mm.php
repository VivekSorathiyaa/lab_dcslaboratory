...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from wbm_13_2_mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
                            ...
                            <td colspan="2" style="width:100%;vertical-align:top">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">15-35</td>
                                    </tr>
                                    <tr>
                                        <td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">180 mic</td>
