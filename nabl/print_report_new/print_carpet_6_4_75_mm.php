...
$rec_sample_date= $row_select2['receive_date'];					
                            ...
                            <td colspan="2" style="width:100%;vertical-align:top">
                                <table align="top" width="100%" class="test" style="max-width:400px;font-size:10px;font-family: Cambria;">
									...
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['cum_ret_1']; ?></td>
									</tr>
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">6.3 mm</td>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['cum_ret_2']; ?></td>
									</tr>
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['cum_ret_3']; ?></td>
									</tr>
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['cum_ret_4']; ?></td>
									</tr>
                                    <tr>
		...
		<table align="center" width="92%" class="test" style="margin-left:35px; ">
			...
			<tr>
				...
				<td rowspan="3" style="border: 1px solid black;text-align:center;"> IS 2386 : 1963 <br> Part-3 <br> (RA 2021)</td>	
			...
			<tr>
				...
				<td rowspan="5" style="border: 1px solid black;text-align:center;"> IS 2386:1963 <br> Part-1 <br> (RA 2021)</td>	
			...
			<tr>
				...
				<td rowspan="3" style="border: 1px solid black;text-align:center;">IS 2386:1963 <br> Part-4 <br> (RA 2021)</td>
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;">IS 2386:1963 <br> Part-5 <br> (RA 2021)</td>	
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"> IS 2386: 1963 <br> Part-1 <br> (RA 2021)</td>	
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"> IS 2386: 1963 <br> Part-4 <br> (RA 2021)</td>	
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"> IS 2386: 1963 <br> Part-2 <br> (RA 2021)</td>	
				<td style="border: 1px solid black;text-align:center; font-weight:bold;"> <?php if($row_select_pipe['fines_value'] != "" && $row_select_pipe['fines_value'] != "0" && $row_select_pipe['fines_value'] != null){ echo $row_select_pipe['fines_value']; } else{ echo "-";}?></td>	
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"> IS 2386: 1963 <br> Part-7 <br> (RA 2021)</td>	
		...
		<br>
		<table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:13px;font-family: Arial;margin-left:35px; border:1px solid black;">
			<tr>
		...
		<table align="center" style="font-family:arial;position: fixed;left: 20px;right: auto;bottom: 20px;width: 92%;">
