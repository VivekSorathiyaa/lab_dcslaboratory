...
<html>
	<body>
		...
		<div id="header">
			...
			<table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:13px;font-family: Arial;margin-bottom:6px; ">
		<tr >
				<td  style="text-align:center; font-size:18px; "><b>TEST REPORT</b></td>
			</tr>
     	</table>
		<table align="center" width="92%" cellspacing="0" cellpadding="0" style=" border: 1px solid black;font-size:11px;font-family: Arial;padding-top:2px;padding-bottom:2px;margin-bottom:6px; ">
		      <tr style="border: 1px solid black;height:18px;width:10%">
				<td style="width: 20%;" >&nbsp;<b> REF No.</b></td>
				<td>:</td>
				<td>&nbsp;<?php if($report_no != "" && $report_no != "0" && $report_no != null){
					echo " ".$report_no;}?> </td>
			  </tr>
			<tr style="border: 1px solid black;height:18px;">
				<td style="width:20px" >&nbsp;<b> ULR No.</b></td>
				<td>:</td>
				<td width="32%" >&nbsp;&nbsp;<?php if($row_select_pipe['ulr'] != "" && $row_select_pipe['ulr'] != "0" && $row_select_pipe['ulr'] != null){
					echo "".$row_select_pipe['ulr'];}?></td>
            <td style="width:20%" >&nbsp;&nbsp;<b>  Date of Issue.</b></td>
			<td>:</td>
			<td><?php echo date('d-m-Y', strtotime($issue_date));?>	</td></tr>
	   </table>
	   
	 
	   
	    <table align="center" width="92%";cellspacing="0" cellpadding="0" style="  margin-bottom:6px;border: 1px solid black;font-size:11px;font-family: Arial;padding-top:3px;padding-bottom:3px ">
			<tr style="border: 1px solid black;height:18px;width:10%">
			...
			<tr style="border: 1px solid black;height:18px;width:10%">
				<td style="width: 20%;" >&nbsp;<b>Client Ref.No</b></td>
				<td>:</td>
				<td>&nbsp;&nbsp;<?php echo $reference_name ?></td>
			</tr> 
			<tr style="border: 1px solid black;height:18px;width:10%">
				<td style="width: 20%;" >&nbsp;<b>Contractor</b></td>
				<td>:</td>
				<td>&nbsp;&nbsp;<?php echo $clientname?></td>
			</tr> 			
			  <tr style="border: 1px solid black;height:18px;width:10%">
				<td style="width: 20%;" >&nbsp;<b>Site Address</b></td>
				<td>:</td>
		...
		<table align="center" width="92%" class="test" cellspacing="0" cellpadding="0" style="font-size:13px;font-family: Calibri; margin-bottom: 4px; border: 1px solid black; ">
			<tr>
				<td style="width: 20%;padding-top: 2px;" >&nbsp;<b>Discipline</b></td>
				<td style="padding-top: 2px;">: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mechanical </td>
			</tr>
			<tr>
				<td style="width: 20%;padding-bottom: 2px;" >&nbsp;<b>Group</b></td>
        ...
        <table align="center" width="92%" class="test" cellspacing="0" cellpadding="0" style="font-size:13px;font-family: Calibri; margin-bottom: 6px; border: 1px solid black; ">
			<tr>
				<td style="width: 20%;padding-top: 3px;padding-bottom: 2px;" >&nbsp;<b>Sample Description</b></td>
				<td>:</td>
			...
			<tr>
				<td style="width: 20%;padding-bottom: 2px;" >&nbsp;<b>Test Method</b></td>
				<td>:</td>
				<td>&nbsp;&nbsp;IS 15658 : 2021 </td>
			...
			<tr>
				<td style="width: 20%;padding-bottom: 3px;" >&nbsp;<b>Thickness</b></td>
				<td>:</td>
				<td>&nbsp;&nbsp;<?php echo $paver_thickness;?>mm</td>
				<td style="width: 20%;padding-bottom: 3px;" >&nbsp;<b>Source</b></td>
				<td>:</td>
				<td>&nbsp;&nbsp; </td>
			</tr>
			<tr>
				<td style="width: 20%;padding-bottom: 3px;" >&nbsp;<b>Size</b></td>
				<td>:</td>
				<td>&nbsp;&nbsp; </td>
			</tr>
			<tr>
				<td style="width: 20%;padding-bottom: 2px;" >&nbsp;<b>Grade</b></td>
				<td>:</td>
				<td>&nbsp;&nbsp;<?php echo $paver_grade;?> </td>
			</tr>
		</table>
		<br>
			<br>
			...
			<table align="center" width="92%" class="test" cellspacing="0" cellpadding="0" style="font-size:13px;font-family: Arial;margin-left:35px;margin-top: 14px; margin-bottom: 4px;">
			<tr>
				<td style="font-size: 11px; text-align: center;width: 8%;">Note:</td>
				<td style="font-size: 11px;">1.Material retention period shall be 30 days after testing, after which it shall be disposed.</td>
			</tr>

			<tr>
				<td></td>
				<td style="font-size: 11px;padding-top: 2px;">2.Total liability of the laboratory is limited to invoiced amount & the test charges received by laboratory against the specific material tested.</td>
			</tr>

			<tr>
				<td></td>
				<td style="font-size: 11px;padding-top: 2px;">3.This certificate refers only to the sample submitted for testing.</td>
			</tr>

			<tr>
				<td></td>
				<td style="font-size: 11px;padding-top: 2px;">4.This certificate is valid at the time of and under the conditions specified theirin.</td>
			</tr>

			<tr>
				<td></td>
				<td style="font-size: 11px;padding-top: 2px;">5.This certificate may not be reproduced in part, without the permission of this Laboratory.</td>
			</tr>

			<tr>
				<td></td>
				<td style="font-size: 11px;padding-top: 2px;">6. Any correction invalidates this certificate.</td>
			</tr>
		</table>
		<br>
		<br>
		...
		<table align="center" width="92%" class="test" cellspacing="0" cellpadding="0" style="font-size:13px;font-family: Arial;margin-left:35px;margin-top: 14px; margin-bottom: 4px;">
			<tr>
				<td style="text-align: center; font-size: 12px">Nimit Shah</td>
			</tr>

			<tr>
				<td style="text-align: center; font-size: 11px; padding-top: 2px;">Authorised Signatory (Mechanical)</td>
			</tr>

			<tr>
				<td style="text-align: center; font-size: 12px; padding-top: 2px;">Page 1 of 1</td>
			</tr>

			<tr>
				<td style="text-align: center;  font-size: 12px; padding-top: 2px;">---------End of Report---------</td>
			</tr>
		</table>
		<br>
		<br>
		...
		<td>
			<table align="left" width="100%"  class="test" style="height:Auto;width:100%;" >
				...
				<tr style="text-align:center;">
					...
					<td style="border:1px solid black;"><?php if($row_select_pipe1['avg_wet']!="" && $row_select_pipe1['avg_wet']!="0" && $row_select_pipe1['avg_wet']!=null){echo $row_select_pipe1['avg_wet']; }else{echo " <br>";}?></td>
				...
				<tr style="text-align:center;">
					...
					<td style="border:1px solid black;"><?php if($row_select_pipe1['avg_fly']!="" && $row_select_pipe1['avg_fly']!="0" && $row_select_pipe1['avg_fly']!=null){echo $row_select_pipe1['avg_fly']; }else{echo " <br>";}?></td>
					<td style="border:1px solid black;">-</td>
				</tr>
				<tr style="text-align:center;">
					...
					<td style="border:1px solid black;"><?php if($row_select_pipe1['avg_cem']!="" && $row_select_pipe1['avg_cem']!="0" && $row_select_pipe1['avg_cem']!=null){echo $row_select_pipe1['avg_cem']; }else{echo " <br>";}?></td>
					<td style="border:1px solid black;">-</td>
				</tr>
				<?php
					}
