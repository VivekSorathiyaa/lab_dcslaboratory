...
<body>
	...
	<page size="A4">
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family:Cambria;margin-top:80px;border-bottom:0px solid black;">
			...
			<tr>
				<td style="text-align:center; font-size:15px;padding-bottom:15px; text-decoration: underline; text-underline-offset: 3px;"><b>Properties of Quarry Spall</b></td>
			</tr>
				...
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 4px 0;margin-bottom:4px;    border-collapse: inherit;">
						...
						<tr>
							...
							<td style="width:6%;text-align: center;padding-bottom: 4px;"> &raquo; </td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">Quarry Spall</td>
                        ...
                        <tr style="display:flex;">
                            <td colspan="2" style="width:100%;vertical-align:top">
                                ...
                                <tr>
										...
										<tr>
											<td rowspan="2" style="text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 4px;"> Sieve Size</td>
											<td colspan="2" style="font-size:10px;text-align:center;border-bottom:0px solid black;padding:5px 4px;">Test Result</td>
										</tr>
										<tr style="">
											<td style="border-right:1px solid;font-size:10px;text-align:center;border-top:1px solid black;padding:5px 4px;">% Retained</td>
											<td style="border-right:1px solid;font-size:10px;text-align:center;border-top:1px solid black;padding:5px 4px;">% Passing</td>
										</tr>
                                    <tr>
                                        <td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">75 mm</td>
									...
									<tr>
                                        ...
                                        <td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;"><?php echo $row_select_pipe['cum_ret_6']; ?></td>
									...
									<tr>
                                        <td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">0.425 mm</td>
                                        <td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;"><?php echo $row_select_pipe['cum_ret_7']; ?></td>
									...
									<tr>
                                        ...
                                        <td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;"><?php echo $row_select_pipe['cum_ret_8']; ?></td>
									...
									<?php
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="font-size:10px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">CBR %</td>
