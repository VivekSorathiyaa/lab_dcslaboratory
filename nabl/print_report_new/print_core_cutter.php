...
<body>
	...
	<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family:Cambria;margin-top:80px;border-bottom:0px solid black;">
		<tr>
				<td style="text-align:center; font-size:20px;padding-bottom:8px"><b>TESTING REPORT FOR SOIL CORE CUTTER</b></td>
		</tr>
					...
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;">
						...
						?>
							...
							<tr>
								...
								<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 14px;"></td>
	    ...
	    <tr>
				<!--OTHER START-->
			    <td>
					<table align="left" width="100%" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;border-right:1px solid;">

						<tr>
							<td style="width:14.28%;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Lab No.</td>
							<td style="width:14.28%;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Particulars</td>
							<td style="width:14.28%;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;writing-mode: tb-rl;transform: rotate(-180deg);">MDD gm/cc</td>
							<td style="width:14.28%;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;writing-mode: tb-rl;transform: rotate(-180deg);">OMC %</td>
							<td style="width:14.28%;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;writing-mode: tb-rl;transform: rotate(-180deg);">FDD gm/cc</td>
							<td style="width:14.28%;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" >FMC %</td>
							<td style="width:14.28%;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;writing-mode: tb-rl;transform: rotate(-180deg);">Compaction %</td>
						</tr>
						...
						<tr>
							...
							<td style="font-size:10px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['field_mdd']; ?></td>
							<td style="font-size:10px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['fdd_2']; ?></td>
							<td style="font-size:10px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['fdd_3']; ?></td>
							<td style="font-size:10px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['fdd_2']; ?></td>
							<td style="font-size:10px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['fdd_4']; ?></td>
						</tr>
						...
						<tr>
							...
							<td style="font-size:10px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=2>IS 2720 part-7 / 8</td>
							<td style="font-size:10px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=2>Is 2720 Part-29</td>
							<td style="font-size:10px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=1>-</td>
						</tr>
					</table>
				</td>
		</tr>
