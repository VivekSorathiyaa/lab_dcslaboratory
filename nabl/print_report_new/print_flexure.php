...
*/
	...
	<page size="A4">
		...
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Cambria;margin-top:80px;">
			...
			<tr>
				<td style="text-align:center; font-size:15px;padding-bottom:15px; text-decoration: underline; text-underline-offset: 3px;"><b>Flexural Strength of Concrete Cubes</b></td>
			</tr>
				...
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 4px 0;margin-bottom:4px;    border-collapse: inherit;">
						...
						<tr>
							...
							<td style="width:6%;text-align: center;padding-bottom: 4px;"> &raquo; </td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">Flexural Beams</td>
							<td style="width:21%;padding-bottom: 4px;text-align:right;"></td>
						...
						<tr>
							...
							<td style="width:6%;text-align: center;padding-bottom: 4px;"> &raquo; </td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">IS 516(Part l / Sec 1) : 202l Clause 4.0</td>
			...
			<tr style="">
                <td>
                    <table cellpadding="0" cellpadding="0" align="center" width="100%" style="" class="test">
                        <tr>
                        	<td style="font-size:13px;font-weight:bold;text-align:left;padding:15px 0 5px;font-family:Cambria;">1. Flexural strength of concrete cubes</td>
                        </tr>
                    </table>
                </td>
            </tr>
			...
			<tr>
			    <td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family: Cambria;border-bottom:0px solid;border-right:1px solid;">

						<tr style="">
							<td style="width:2%;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"> Sr.<br>No.</td>
							...
							<td style="width:10%;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Date Of Casting *</td>
							<td style="width:11%;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Date Of Testing</td>
							<td style="width:6%;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Age Of Test <br> (days)</td>
							<td style="width:6%;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Grade of Concrete *</td>
							<td style="width:6%;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Span (mm)</td>
							<td style="width:6%;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Width (mm)</td>
							<td style="width:6%;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Depth (mm)</td>
							<td style="width:10%;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Max. Load at Failure (KN)</td>
							<td style="width:10%;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Position of <br>fracture<br> (a) (cm)</td>
							<td style="width:20%;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Flexural Strength (N / mm<sup>2</sup>)</td>
						</tr>
						...
						?>
							...
							<tr>
								<td style="font-size:12px;text-align:left;padding-top:4px;border:1px solid;border-top:0;border-right:0;padding-left:10px;" colspan=13>&raquo; &nbsp; <span style="font-weight:bold;font-size:11px;">Remark</span> :-  If position of fracture (a) is less than 17.0 cm for a 15.0 cm Specimen or lass than 11.0 cm for 10.0 cm Specimen the Results of test shall be Discarded.</td>
						    </tr>
							<tr>
								<td style="font-size:12px;text-align:left;padding-top:4px;font-weight:bold;" colspan=13>&raquo; &nbsp; Rcquirements as per IS 456 : 2000 RA 2016 Clause No.6.2.2</td>
						    </tr>
            ...
            <tr>
                <td colspan="3" style="width:100%;vertical-align:top">
								<table align="top" width="100%" class="test" style="font-family: Cambria;font-size:10px;">             
										...
										<tr>
												<td style="width:32.5%;font-size:10px;text-align:left;border:1px solid black;border-left:1px solid black;padding:5px 0;">Accepted Strength on 28 days of curing, N/mm<sup>2</sup></td>
