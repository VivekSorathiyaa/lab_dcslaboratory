...
<?php $cnts = 1; ?>
				<tr>
					<td colspan="2">
						<table align="center" width="100%" class="test" style="font-size:10px;">
							<!-- <tr>
							...
							?>
								<tr>
									...
									<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['alk_10']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php
							...
							?>
								<tr>
									...
									<!-- <td style="text-align:center;border:1px solid black;border-right:0px solid black;">Max. 1%</td> -->
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2386-2</td>
									<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['dele_2_3']; ?></td>
								</tr>
							...
							?>
								...
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:6%;text-align:center;padding-bottom:10px;padding-top:10px; "><?php echo $cnt++; ?></td>
									...
									<!-- <td style="text-align:center;border:1px solid black;border-right:0px solid black;">-</td> -->
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2386-2</td>
									<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['dele_4_3']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								...
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:6%;text-align:center;padding-bottom:10px;padding-top:10px; "><?php echo $cnt++; ?></td>
									...
									<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['dele_1_4']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								...
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:6%;text-align:center;padding-bottom:10px;padding-top:10px; "><?php echo $cnt++; ?></td>
									...
									<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['avg_ph']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['avg_sul']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								...
								<td style="border-left: 1px solid black;border-bottom: 1px solid black;border-top: 1px solid black;width:15%;text-align:center;padding-bottom:10px;padding-top:10px; "><?php echo $cnt++; ?></td>
									...
									<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['avg_clr']; ?></td>
								</tr>
								...
								<!--<tr>
									<td style="border-left: 1px solid black;border-bottom: 1px solid black;border-top: 1px solid black;width:15%;text-align:center;padding-bottom:10px;padding-top:10px; "><?php echo $cnt++; ?></td>
										<td colspan="3" style="text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Water Soluble Chloride (CL) (%)</td>
										<td style="text-align:center;border:1px solid black;border-right:0px solid black;">-</td>
										<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 1459 (P-11) : 2001</td>
										<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;"></td>
								</tr-->
							<?php } ?>
						</table>
					</td>
