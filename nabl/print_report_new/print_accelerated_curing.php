	...
	?>
		...
		<page size="A4">
			...
			<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Cambria;margin-top:80px;">
				...
				<tr>
					<td style="text-align:center; font-size:15px;padding-bottom:15px; text-decoration: underline; text-underline-offset: 3px;"><b>Compressive Strength of Accelerated Concrete Cubes</b></td>
				</tr>
					...
					<td>
						<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 4px 0;margin-bottom:4px;    border-collapse: inherit;">
							...
							<tr>
								...
								<td style="width:6%;text-align: center;"> &raquo; </td>
								<td style="width:40%;font-size: 10px;text-align:left;"><?php echo number_format($row_select_pipe['acc_l1']) ." mm &nbsp;<span style='font-weight:bold;'> X </span> &nbsp;". number_format($row_select_pipe['acc_width1']) ." mm &nbsp; <span style='font-weight:bold;'> X </span> &nbsp;". number_format($row_select_pipe['acc_height1'])." mm";?></td>
			...
			<tr>
				<td style="text-align:center;font-size:11px; ">
					...
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Cambria;border-bottom:1px solid;border-top:1px solid;">
						...
						<?php
						$select_tilesy = "select * from hard_concrete WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
				...
				<tr style="">
					<td>
						<table cellpadding="0" cellpadding="0" align="center" width="100%" style="" class="test">
							<tr>
								<td style="font-size:13px;font-weight:bold;text-align:left;padding:15px 0 5px;font-family:Cambria;">1. Compressive strength of concrete cubes</td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td>
						<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Cambria;border-bottom:0px solid;border-right:0px solid;">

							<tr style="">
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"> Sr.<br>No.</td>
								<td style="width:10%;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Sample ID</td>
								<td style="width:12%;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Date Of Casting *</td>
								<td style="width:12%;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Date Of Testing</td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Age Of Test <br> (days)</td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Grade of Concrete *</td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Weight <br> Spee. <br> (kg)</td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Max.Load <br> at Failure. <br> (kN)</td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Comp <br> Strength <br> R <sub>a</sub> <br> (N/mm<sup>2</sup>)</td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Estimated <br> Compressive <br> strength R <sub>29</sub> <br> (N/mm<sup>2</sup>)</td>
								<td style="border-right:1px solid;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Sample <br> Density <br> (Kg/m<sup>2</sup>)</td>
							</tr>
							<?php
							$select_tilesy = "select * from hard_concrete WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
							$result_tiles_select1 = mysqli_query($conn, $select_tilesy);
							$coming_row = mysqli_num_rows($result_tiles_select1);
							...
							?>
							<tr>
								<td style="border-right:0px solid;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">1</td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;">Sample-1</td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;" rowspan="3"><?php echo date('d - m - Y', strtotime($row_select_pipe['cast_date'])); ?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"rowspan="3"><?php echo date('d - m - Y', strtotime($end_date)); ?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;" rowspan="3">Accelerated <br> Curing as per <br> IS 9013- <br> 1978 </td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;" rowspan="3"><?php echo $row_select_pipe['cube_grade']; ?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['acc_w1']; ?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['acc_load1']; ?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['acc_com1']; ?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['acc_com1'];?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px; border-right:1px solid black;"><?php echo substr((($row_select_pipe['fwet1']) / (($row_select_pipe['dl1'] * $row_select_pipe['dw1']) / 1000000)),0,7); ?></td>
							</tr>

							<tr>
								<td style="border-right:0px solid;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">2</td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;">Sample-2</td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['acc_w2']; ?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['acc_load2']; ?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['acc_com2']; ?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['acc_com2'];?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px; border-right:1px solid black;"><?php echo substr((($row_select_pipe['fwet2']) / (($row_select_pipe['dl2'] * $row_select_pipe['dw2']) / 1000000)),0,7); ?></td>
							</tr>

							<tr>
								<td style="border-right:0px solid;border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">3</td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;">Sample-3</td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['acc_w3']; ?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['acc_load3']; ?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['acc_com3']; ?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['acc_com3'];?></td>
								<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;padding:5px 4px; border-right:1px solid black;"><?php echo substr((($row_select_pipe['fwet3']) / (($row_select_pipe['dl3'] * $row_select_pipe['dw3']) / 1000000)),0,7); ?></td>
							</tr>

							<tr>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:right;font-weight:bold;padding:5px 4px; border-bottom: 1px solid black; " colspan="8">Average=</td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px; border-bottom: 1px solid black;"><?php echo $row_select_pipe['acc_avg1']; ?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px; border-bottom: 1px solid black;"><?php echo $row_select_pipe['acc_r28'];?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px; border-right:1px solid black; border-bottom: 1px solid black;"><?php echo substr(((((($row_select_pipe['fwet1']) / (($row_select_pipe['dl1'] * $row_select_pipe['dw1']) / 1000000))) + (($row_select_pipe['fwet2']) / (($row_select_pipe['dl2'] * $row_select_pipe['dw2']) / 1000000)) + (($row_select_pipe['fwet3']) / (($row_select_pipe['dl3'] * $row_select_pipe['dw3']) / 1000000))) / 3),0,7); ?></td>
							</tr>
