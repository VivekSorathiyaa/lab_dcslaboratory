...
<?php include("connection.php");
		...
		if (mysqli_num_rows($result) > 0) {
			...
			if (mysqli_num_rows($result_billmaster) > 0) {
				...
				$name_of_work= strip_tags(html_entity_decode($row_billmaster['name_of_work']),"<strong><em><br>");
...
<table align="center" width="90%" class="test">
	<tr>
		<td colspan="6" class="tdclass" style="height:5px;padding:5px;text-align:center;padding-left:100px;"><b>ESTIMATE 		</b></td>
	</tr>
	<tr>
...
<td class="tdclass" style="width:80px;">Estimate Chalan No:</td>
...
<td class="tdclass" style="padding:5px;" width="40%"><?php echo $auth_gstno;?></td>
<td class="tdclass" style="padding:5px;width:200px" width="20%">
<b>Tax Is Payable on</b>
<br>
<b>Reverse Charge</b>
</td>
<td class="tdclass" style="text-align:left;" width="30%">&nbsp;</td>
</tr>
...
<table class="test" align="center" width="90%">
	<tr>
		...
		<th width="10%" class="tdclass"><label>Rate<br><?php if($gst_type!="exclude"){echo "(including Tax)";}?></label></th>	
