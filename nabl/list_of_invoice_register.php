					...
					<a data-toggle="collapse" href="#collapse1" class="btn btn-primary" style="margin-left:45%;width:3%;;" id="add_material_button"><i class="fa fa-search" aria-hidden="true"></i></a>
						...
						<div id="collapse1" class="panel-collapse collapse">
							...
							<div class="row">
								 ...
								 <div class="col-md-3">
									<input type="text" name="old_bill_no" id="old_bill_no" placeholder="Enter Old Bill No" class="form-control">
								 </div>

								 <div class="col-md-3">
									<input type="text" name="bill_no" id="bill_no" placeholder="Enter Bill No" class="form-control">
								 </div>
						...
						<div id="display_data_report">
								...
								<tbody>
									<?php
										...
										$query="select * from estimate_total_span_bill_sequence WHERE `is_deleted`=0 ORDER BY bill_id DESC LIMIT 0,200";
...
$(".search_job_by_agency").click(function()
{
	...
	if(sel_agency_ids =="" && old_bill_no =="" && bill_no =="" && bill_amnt_id =="" && cheque_no =="" && bank_name =="" && tds_amt =="" && paid_amt =="" && cheque_amt =="" && remarks =="" && customer_name =="")
	{
		...
		$.ajax({
			url : "<?php echo $base_url; ?>search_invoice_register.php",
			type: "POST",
			data : postData,
			beforeSend: function(){
