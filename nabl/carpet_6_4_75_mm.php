			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">GRIT 6 MM</h2>
					</div>
        ...
        <div class="panel-body"><div class="row">									
								...
								<div class="row">
										...
										<div class="col-lg-1">
											<div class="form-group">
												<div class="col-sm-12">
													<label for="inputEmail3" class="col-sm-2 control-label">5.6</label>
												</div>
											</div>
										</div>
										<div class="col-lg-2">
						...
						<div class="panel-body">
							<div class="row">									
									...
									<div class="col-lg-4">
										<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" id="sp_bask_water" name="sp_bask_water" >
												</div>
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-lg-2">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label">"Weight of sample oven dry (g)</label>
									</div>
									</div>
									
									<div class="col-lg-2">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label">Weight of sample in water (g)</label>
									</div>
									</div>
									...
									<div class="col-lg-1">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label">Specific Gravity = C/(B-A)</label>
									</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-lg-2">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label text-center">A = A1-A2</label>
									</div>
									</div>
									...
									<div class="col-lg-1">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label text-center">C/(B-A)</label>
									</div>
									</div>
									
									<div class="col-lg-1">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label">(B-C)/C x 100</label>
									</div>
									</div>
									<div class="col-lg-1">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label">Retainer</label>
									</div>
									</div>
								...
								<div class="col-lg-1">
									<div class="form-group">
									<div class="col-sm-12">	
										<input type="text" class="form-control" id="sp_apr1" name="sp_apr1" disabled>
									</div>
								    </div>
								</div>
							</div>
							...
							<!--SPECIFIC GRAVITY & WATER ABSORPTION VALUE SR 2-->
								...
								<div class="col-lg-1">
									<div class="form-group">
									<div class="col-sm-12">	
										<input type="text" class="form-control" id="sp_apr2" name="sp_apr2" disabled>
									</div>
								    </div>
								</div>
							</div>
								...
								<div class="row">
									...
									<div class="form-group">
									 <div class="col-sm-12">
										<input type="text" class="form-control" id="sp_avg_apr" name="sp_avg_apr" disabled>
									  </div>
									</div>
									</div>																										
								</div>
					  ...
					  <div id="collapse5" class="panel-collapse collapse">
						<div class="panel-body">
								...
								<div class="row">
									<div class="col-lg-3">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label">Total Weight taken into Crushing mould in g (A)</label>
									</div>
									</div>
									
									<div class="col-lg-3">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label">Weight of material passing thhrough IS sieve 2.36mm after crushing load applied in g(B)</label>
									</div>
									</div>
									...
									<div class="col-lg-3">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label">Crushing Value % = B/A X 100</label>
									</div>
									</div>
								...
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="col-md-3">
												<div class="form-group">
													<div class="col-sm-12">
														<label for="inputEmail3" class="col-sm-12 control-label">Volume of mould (M<sup>3</sup>)</label>
													</div>
												</div>
											</div>
											<div class="col-md-3">
											...
											<div class="col-md-3">
												<div class="form-group">
													<div class="col-sm-12">
														<label for="inputEmail3" class="col-sm-12 control-label text-center">LITER</label>
													</div>
												</div>
											</div>				
											<div class="col-md-3">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="col-md-3">
												<div class="form-group">
													<div class="col-sm-12">
														<label for="inputEmail3" class="col-sm-12 control-label">Bulk loose Density = Av. Wt. of material/Volume of mould</label>
													</div>
												</div>
											</div>
											<div class="col-md-3">
											...
											<div class="col-md-3">
												<div class="form-group">
													<div class="col-sm-12">
														<label for="inputEmail3" class="col-sm-12 control-label text-center">kg/lit</label>
													</div>
												</div>
											</div>				
											<div class="col-md-3">
									...
									<div class="row">
										...
										<div class="row">
											...
											<div class="col-lg-2">
											<div class="form-group">
											  <input type="text" class="form-control" id="avg_wom1" name="avg_wom1" readonly> 
											</div>
											</div>
											<div class="col-lg-1">
											<div class="form-group">
      ...
      <div id="collapse7" class="panel-collapse collapse">
		...
		<!--Impact VALUE Start-->
								...
								<div class="row">
									<div class="col-lg-2">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label">Weight of sample taken in Mould in gm(A)</label>
									</div>
									</div>
									
									<div class="col-lg-2">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label">Weight of Sample after Penetration, passing through 2.36mm IS sieve in gm (B) </label>
									</div>
									</div>
									...
									<div class="col-lg-2">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label">percentage fines y = (B/A) * 100</label>
									</div>
									</div>
									
									<div class="col-lg-2">
									<div class="form-group">
									  <label for="inputEmail3" class="col-sm-12 control-label">Load applied for 20mm penetration of plunger for normal crushed aggregates, in Tonnes, (X)</label>
									</div>
									</div>
		...
		<div id="collapse12" class="panel-collapse collapse">
			...
			<!--Impact VALUE Start-->
				...
				<div class="row">
					...
					<div class="col-lg-2">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label">Weight of material Passing on IS sieve 2.36 mm in g (B) :</label>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label">Weight of material Retaubed on through IS sieve 2.36mm in g (C) :</label>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-lg-2">
						<div class="form-group">
							<div class="col-sm-12">
								<input type="text" class="form-control" id="imp_w_m_a_3" name="imp_w_m_a_3" >
							</div>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
							<div class="col-sm-12">
								<input type="text" class="form-control" id="imp_w_m_b_3" name="imp_w_m_b_3" >
							</div>
						</div>
					</div>																
					<div class="col-lg-2">
						<div class="form-group">
							<div class="col-sm-12">
								<input type="text" class="form-control" id="imp_w_m_c_3" name="imp_w_m_c_3" >
							</div>
						</div>
					</div>
		...
		<div id="collapse_dtm" class="panel-collapse collapse">
			...
			<!--Impact VALUE Start-->
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label">(1) Determination of light weight pices (Coal & Lignite)  </label>
						</div>
					</div>
				</div>
				<br>
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label text-right">Percentage of light weight pieces = 1+(W1/W3)*100 </label>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label text-right">Where W1 = Dry weight in g of decanted pices </label>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label text-right">W3 = Dry weight in g of portion of sample coarser than 4.75mm IS Sieve</label>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
							<input type="text" class="form-control" id="dele_1_3" name="dele_1_3" >
						</div>
					</div>
				</div>
				<br>
				<div class="row">
					<div class="col-lg-6">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label"> (2) Determination of Clay lumps: </label>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label text-right">L =( W-R)/W*100</label>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label text-right">Where L = Percentage of clay lumps</label>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label text-right">W = Weight of sample</label>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
							<input type="text" class="form-control" id="dele_2_3" name="dele_2_3" >
						</div>
					</div>
				</div>
				<br>
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label text-right">R = Weight of sample after removal of clay lumps </label>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
							<input type="text" class="form-control" id="dele_2_4" name="dele_2_4" >
						</div>
					</div>
				</div>
				<br>
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label">(3) Material finer than 75 micron sieve:</label>
						</div>
					</div>
				</div>
				<br>
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label text-right">Original dry weight B g </label>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label text-right">Dry weight after washing C g</label>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label text-right">% of material finer than 75 micron</label>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
							<input type="text" class="form-control" id="dele_3_3" name="dele_3_3" >
						</div>
					</div>
				</div>
			</div>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-sm-2">
												...
												<?php   
													$querys_job1 = "SELECT * FROM carpet_6_4_75_mm WHERE `is_deleted`='0' and lab_no='$lab_no'";
											...
											?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_carpet_6_4_75_mm.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
 
											</div>
											
											<?php //} ?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&tbl_name=carpet_6_4_75_mm" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
					...
					<div class="col-lg-12">
						<table border="1px solid black" align="center" width="100%" id="aaaa">
							<tr>
								...
								<?php
							 $query = "select * from carpet_6_4_75_mm WHERE lab_no='$aa'  and `is_deleted`='0'";
	...
	function abr_auto()
	{
		$('#txtabr').css("background-color","var(--success)");
			...
			else if(abr_grading=="B")
			{
				...
				var abr_index = randomNumberFromRange(18.0,24.0);	
				$('#abr_index').val(abr_index.toFixed(1));
				var abrindex = $('#abr_index').val();							
				 var tt = randomNumberFromRange(-0.99,0.99).toFixed(2);
				 var r = randomNumberFromRange(0,9).toFixed();
...
//SIDHU
	...
	$("#abr_index").change(function(){
		...
		function sp_auto()
		{
			...
			var sp_specificgravity = randomNumberFromRange(2.670,2.700).toFixed(2);  //(sp_specific_gravity)
			var sp_waterabr = randomNumberFromRange(0.82,0.88).toFixed(2);
			var sp_bask_water = randomNumberFromRange(701,710).toFixed(1);
			...
			/*$('#sp_wt_st_1').val(sp_wt_st_1.toFixed());
			$('#sp_wt_st_2').val(sp_wt_st_2.toFixed());*/
			...
			var sp_w_s_1 = randomNumberFromRange(2000, 2190);
			var sp_w_s_2 = randomNumberFromRange(2000, 2190);
...
//SOUNDNESS	
	...
	function general_flk_elo1()
	{
			...
			var a5 = randomNumberFromRange(3100.0,3500.0).toFixed(2);
			var a6 = randomNumberFromRange(1910.0,2080.0).toFixed(2);
			var a7 = randomNumberFromRange(1000.0,1200.0).toFixed(2);
			var a8 = randomNumberFromRange(550.0,680.0).toFixed(2);
			var a9 = randomNumberFromRange(150.0,200.0).toFixed(2);
			...
			var sum_a = $('#total_a').val();
			 ...
			 var b1 = (+a_1) * (+randomNumberFromRange(0.76,0.92).toFixed(2));
			 var b2 = (+a_2) * (+randomNumberFromRange(0.76,0.92).toFixed(2));		
			 var b3 = (+a_3) * (+randomNumberFromRange(0.76,0.92).toFixed(2));		
			 var b4 = (+a_4) * (+randomNumberFromRange(0.76,0.92).toFixed(2));		
			 var b5 = (+a_5) * (+randomNumberFromRange(0.76,0.92).toFixed(2));		
			 var b6 = (+a_6) * (+randomNumberFromRange(0.76,0.92).toFixed(2));		
			 var b7 = (+a_7) * (+randomNumberFromRange(0.76,0.92).toFixed(2));		
			 var b8 = (+a_8) * (+randomNumberFromRange(0.76,0.92).toFixed(2));		
			 var b9 = (+a_9) * (+randomNumberFromRange(0.76,0.92).toFixed(2));
			...
			var fi_index = ((+fxy1) + (+fxy2) + (+fxy3) + (+fxy4) + (+fxy5) + (+fxy6) + (+fxy7) + (+fxy8) + (+fxy9)) / (+9);
			...
			//ELO
			var aa1 = randomNumberFromRange(29950.0,32000.0).toFixed(2);
			var aa2 = randomNumberFromRange(15000.0,16000.0).toFixed(2);
			var aa3 = randomNumberFromRange(11500.0,13500.0).toFixed(2);
			var aa4 = randomNumberFromRange(7500.0,8500.0).toFixed(2);
			var aa5 = randomNumberFromRange(3100.0,3500.0).toFixed(2);
			var aa6 = randomNumberFromRange(1910.0,2080.0).toFixed(2);
			var aa7 = randomNumberFromRange(1000.0,1200.0).toFixed(2);
			var aa8 = randomNumberFromRange(550.0,680.0).toFixed(2);
			var aa9 = randomNumberFromRange(150.0,200.0).toFixed(2);
			...
			var sum_aa = $('#total_aa').val();
			 ...
			 var dd1 = (+aa_1) * (+randomNumberFromRange(0.76,0.90).toFixed(2));
			 var dd2 = (+aa_2) * (+randomNumberFromRange(0.76,0.90).toFixed(2));		
			 var dd3 = (+aa_3) * (+randomNumberFromRange(0.76,0.90).toFixed(2));		
			 var dd4 = (+aa_4) * (+randomNumberFromRange(0.76,0.90).toFixed(2));		
			 var dd5 = (+aa_5) * (+randomNumberFromRange(0.76,0.90).toFixed(2));		
			 var dd6 = (+aa_6) * (+randomNumberFromRange(0.76,0.90).toFixed(2));		
			 var dd7 = (+aa_7) * (+randomNumberFromRange(0.76,0.90).toFixed(2));		
			 var dd8 = (+aa_8) * (+randomNumberFromRange(0.76,0.90).toFixed(2));		
			 var dd9 = (+aa_9) * (+randomNumberFromRange(0.76,0.90).toFixed(2));
			...
			var ei_index = ((+exy1) + (+exy2) + (+exy3) + (+exy4) + (+exy5) + (+exy6) + (+exy7) + (+exy8) + (+exy9)) / (+9);
	...
	function imp_auto()
	{
		$('#txtimp').css("background-color","var(--success)");
			var imp_value4 = randomNumberFromRange(11.00,17.00);
			...
			var imp_w_m_a_3 = ((+imp_wma1) + (+imp_wma2) ) / 2;
			
			$('#imp_w_m_a_3').val(imp_w_m_a_3.toFixed(1));
			var imp_wma3 = $('#imp_w_m_a_3').val();
			var imp_w_m_b_3 = ((+imp_value) * (+imp_wma3)) / 100;
			$('#imp_w_m_b_3').val(imp_w_m_b_3.toFixed(1));
			var imp_wmb3 = $('#imp_w_m_b_3').val();
			
			var r =  randomNumberFromRange(-3.0,5.0).toFixed(1);
			var imp_w_m_b_1 = (+imp_wmb3) - (+r);
			var imp_w_m_b_2 = (+imp_wmb3) + (+r);
			...
			//sidhu
			var impa1 = $('#imp_w_m_a_1').val();
			var impa2 = $('#imp_w_m_a_2').val();
			var impa3 = ((+impa1) + (+impa2) ) / 2;
			$('#imp_w_m_a_3').val(impa3.toFixed(1));
			var impa_3 = $('#imp_w_m_a_3').val();
			
			var impb1 = $('#imp_w_m_b_1').val();
			var impb2 = $('#imp_w_m_b_2').val();
			var impb3 = ((+impb1) + (+impb2) ) / 2;
			$('#imp_w_m_b_3').val(impb3.toFixed(1));
			var impb_3 = $('#imp_w_m_b_3').val();
			
			var imp_w_m_c1 = ((+impa1) -  (+impb1));		
			var imp_w_m_c2 = ((+impa2) -  (+impb2));
			$('#imp_w_m_c_1').val(imp_w_m_c1.toFixed(1));
			$('#imp_w_m_c_2').val(imp_w_m_c2.toFixed(1));
			
			var final_imp = ((+impb_3) / (+impa_3)) * 100;
			$('#imp_value').val(final_imp.toFixed(1));
	...
	$("#imp_w_m_a_1,#imp_w_m_a_2,#imp_w_m_b_1,#imp_w_m_b_2").change(function(){
			var impa1 = $('#imp_w_m_a_1').val();
			var impa2 = $('#imp_w_m_a_2').val();
			var impa3 = ((+impa1) + (+impa2) ) / 2;
			$('#imp_w_m_a_3').val(impa3.toFixed(1));
	...
	$("#imp_w_m_a_3").change(function(){
		...
		/*var r =  randomNumberFromRange(-3.0,5.0).toFixed(1);
		var imp_w_m_b_1 = (+impb_3) - (+r);
		var imp_w_m_b_2 = (+impb_3) + (+r);
		$('#imp_w_m_b_1').val(imp_w_m_b_1.toFixed(1));
		$('#imp_w_m_b_2').val(imp_w_m_b_2.toFixed(1));*/
		
		var r1 =  randomNumberFromRange(-5.0,5.0).toFixed(1);
		var imp_w_m_a_1 = (+impa_3) - (+r1);
		var imp_w_m_a_2 = (+impa_3) + (+r1);
		$('#imp_w_m_a_1').val(imp_w_m_a_1.toFixed(1));
		$('#imp_w_m_a_2').val(imp_w_m_a_2.toFixed(1));
		var impa1 = $('#imp_w_m_a_1').val();
		var impa2 = $('#imp_w_m_a_2').val();
	...
	function crush_auto()
	{
		$('#txtcru').css("background-color","var(--success)");	
			var cru_value = randomNumberFromRange(20.0,25.0).toFixed(1);			
	...
	function grd_auto()
	{
		$('#txtgrd').css("background-color","var(--success)");	
					...
					$('#pass_range_3').val("0-35");
					$('#pass_range_4').val("0-10");
					$('#pass_range_5').val("0-10");
					$('#pass_range_6').val("0-10");
					$('#pass_range_7').val("0-10");
					...
					var pass_sample_3 = randomNumberFromRange(75.00,89.00).toFixed(2);
					var pass_sample_4 = randomNumberFromRange(35.00,55.00).toFixed(2);
					var pass_sample_5 = randomNumberFromRange(20.00,34.00).toFixed(2);
					var pass_sample_6 = randomNumberFromRange(11.00,19.00).toFixed(2);
					var pass_sample_7 = randomNumberFromRange(0.00,10.00).toFixed(2);
		...
		//(SUM OF CUM. WAIGHT)
		var blank_extra = (+cum_wt_gm1)+(+cum_wt_gm2)+(+cum_wt_gm3)+(+cum_wt_gm4)+(+cum_wt_gm5)+(+cum_wt_gm6)+(+cum_wt_gm7);
	...
	$('#sample_taken,#pass_sample_1,#pass_sample_2,#pass_sample_3,#pass_sample_4,#pass_sample_5,#pass_sample_6,#pass_sample_7').change(function(){			
		$('#txtgrd').css("background-color","var(--success)");
	...
	$('#cum_wt_gm_1,#cum_wt_gm_2,#cum_wt_gm_3,#cum_wt_gm_4,#cum_wt_gm_5,#cum_wt_gm_6,#cum_wt_gm_7').change(function(){
	  weight_cum_gm();
	});
...
function getGlazedTiles(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo $base_url; ?>save_carpet_6_4_75_mm.php',
