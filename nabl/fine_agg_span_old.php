							...
							<div class="row">									
								...
								<div class="row">
									...
									<div class="col-lg-2">
										<div class="form-group">
											<div class="col-sm-12">
												<label for="inputEmail3" class="col-sm-2 control-label">Wt.retained(gm)</label>
											</div>
										</div>
									</div>
										<div class="col-lg-2">
										<div class="form-group">
											<div class="col-sm-12">
												<label for="inputEmail3" class="col-sm-2 control-label">%age Wt.Retained</label>
											</div>
										</div>
									</div>
									<div class="col-lg-2">
										<div class="form-group">
											<div class="col-sm-12">
												<label for="inputEmail3" class="col-sm-2 control-label">Cum.Wt Retained</label>
											</div>
										</div>
									</div>
									<div class="col-lg-2">
							...
							<div class="row">									
								...
								<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Wt.of saturated surface dry aggregate in air (W.I.)gm.</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
														...
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="sp_temp" name="sp_temp">
																</div>
															</div>
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="sp_wt_st_1" name="wsp_wt_st_1">
																</div>
															</div>
														</div>
														<div class="col-lg-4">
													...
													<div class="row">
														...
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="sp_specific_gravity_1" name="sp_specific_gravity_1">
																</div>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="sp_specific_gravity_2" name="sp_specific_gravity_2">
																</div>
															</div>
														</div>
													</div>
		...
		<div id="collapse_slp" class="panel-collapse collapse">
			...
			<!--Impact VALUE Start-->
				...
				<div class="row">
					...
					<div class="col-lg-2">
						<div class="form-group">
							<input type="text" class="form-control" id="slp_s1_4" name="slp_s1_4" readonly>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
							<input type="text" class="form-control" id="slp_s2_4" name="slp_s2_4" readonly>
						</div>
					</div>
				</div>
				<br>
				<div class="row">
					...
					<div class="col-lg-2">
						<div class="form-group">
							<input type="text" class="form-control" id="slp_s1_5" name="slp_s1_5" readonly>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
							<input type="text" class="form-control" id="slp_s2_5" name="slp_s2_5" readonly>
						</div>
					</div>
				</div>
				<br>
		...
		<div id="collapse_dtm" class="panel-collapse collapse">
			...
			<!--Impact VALUE Start-->
				...
				<div class="row">
					<div class="col-lg-4">
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-12 control-label">% Coal & Ligntie = (W1-W2)/W1*100</label>
						</div>
					</div>
					<div class="col-lg-2">
						<div class="form-group">
												...
												<div class="panel-body">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Wt.of Sample in gms(A)</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Wt.of Washed Retained Sample on <br>75 Micron IS Sieve (after the Oven dried)in gms(B)</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">p% 75 micron IS Sieve (A-B)/Ax100</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
									...
									<br>
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">volume of Container (Ltr)</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Wt. of Empty Container (Kg)</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Wt.of Empty Container + Agg.(kg)</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Wt.of Agg.(Kg)</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Bulk Density(Kg/Ltr)</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
														...
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="sp_apr2" name="sp_apr2">
																</div>
															</div>
														</div>
													</div>
												...
												<div class="panel-body">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">volume of sample v1</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
														...
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="silt_11" name="silt_11">
																</div>
															</div>
														</div>
													</div>
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">volume of silt after three hours v2</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
														...
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="silt_21" name="silt_21">
																</div>
															</div>
														</div>
													</div>
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">percentage silt by volume<br>v2/v1x100%</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="silt_3" name="silt_3">
																</div>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="silt_31" name="silt_31">
																</div>
															</div>
														</div>
													</div>
													...
													<div class="row">
														...
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="silt_avg" name="silt_avg" disabled>
																</div>
															</div>
														</div>
												</div>
												...
												<div class="panel-body">
													<div class="row">
														...
														<div class="col-lg-8">
															<div class="form-group">
																<div class="col-sm-1">
																	<label for="chk_cal">1.</label>
																	<input type="checkbox" class="visually-hidden" name="chk_cal" id="chk_cal" value="chk_cal"><br>
																</div>
																<label for="inputEmail3" class="col-sm-4 control-label label-right">CLAY AND LUMPS</label>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Wt. of Oven dry Sample in gms(A)</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Wt. of Sample after removal of clay lump in gm (B)</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
													...
													<div class="row">
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">% of Clay & Lump (A-B)/Ax100</label>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
													...
													<div class="row">
														...
														<div class="col-lg-4">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="sp_w_s_1" name="sp_w_s_1" disabled>
																</div>
															</div>
														</div>
												</div>
...
//sidhu
	...
	*/
	 ...
	 */
			$('#sp_water_abr,#sp_specific_gravity').change(function(){
				var sp_water_abr = $('#sp_water_abr').val();
				var sp_specific_gravity = $('#sp_specific_gravity').val();

				var sp_w_sur_1 = (((+sp_water_abr) - (+sp_specific_gravity)) / (+sp_water_abr)) * 100;
				$('#sp_w_sur_1').val(sp_w_sur_1.toFixed(2));
				
				clay_auto();
			});
			
			$('#sp_bask_water,#sp_w_s_2').change(function(){
				var sp_bask_water = $('#sp_bask_water').val();
				var sp_w_s_2 = $('#sp_w_s_2').val();

				var sp_w_sur_2 = (((+sp_bask_water) - (+sp_w_s_2)) / (+sp_bask_water)) * 100;
			...
			function clay_auto (){
				...
				var avg_finer = ((+sp_w_sur_1) + (+sp_w_sur_2))/(count);
				$('#avg_finer').val(avg_finer.toFixed(2));
			...
			$('#finer_a,#sp_water_abr_1').change(function(){
				var finer_a = $('#finer_a').val();
				var sp_water_abr_1 = $('#sp_water_abr_1').val();

				var sp_wt_bas1 = (((+finer_a) - (+sp_water_abr_1)) / (+finer_a)) * 100;
				$('#sp_wt_bas1').val(sp_wt_bas1.toFixed(2));
				
				fine_auto();
			});
			
			
			$('#finer_b,#sp_water_abr_2').change(function(){
				var finer_b = $('#finer_b').val();
				var sp_water_abr_2 = $('#sp_water_abr_2').val();

				var sp_wt_bas2 = (((+finer_b) - (+sp_water_abr_2)) / (+finer_b)) * 100;
				$('#sp_wt_bas2').val(sp_wt_bas2.toFixed(2));
			...
			function fine_auto (){
				...
				var avg_finer = ((+sp_wt_bas1) + (+sp_wt_bas2))/(count);
				$('#avg_finer').val(avg_finer.toFixed(2));
    ...
    if (type == 'add') {
				...
				for(var i=0;i<aa.length;i++)
				{
					...
					{	
						...
						var chk_sil = $('#chk_sil').val();
                        var silt_11 = $('#silt_11').val();
                        var silt_21 = $('#silt_21').val();
                        var silt_3 = $('#silt_3').val();
                        var silt_31 = $('#silt_31').val();
                        var silt_avg = $('#silt_avg').val();
        ...
        success:function(data){
            ...
            var temp = $('#test_list').val();
				...
				for(var i=0;i<aa.length;i++)
				{
					if(aa[i]=="sil")
					{
							$('#chk_sil').val(data.chk_sil);
							$('#chk_cal').val(data.chk_cal);
							$('#silt_11').val(data.silt_11);
							$('#silt_21').val(data.silt_21);
							$('#silt_3').val(data.silt_3);
							$('#silt_31').val(data.silt_31);
							$('#silt_avg').val(data.silt_avg);
