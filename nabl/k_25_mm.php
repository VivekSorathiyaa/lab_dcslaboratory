			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">25 MM</h2>
					</div>
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">25</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="soundness" name="soundness" readonly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM k_25_mm WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_k_25_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=k_25_mm" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from k_25_mm WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		function abr_auto() {
			...
			if (abr_grading == "A") {
				...
				var abr_index = randomNumberFromRange(19.0, 23.0);
				$('#abr_index').val(abr_index.toFixed(1));
				var abrindex = $('#abr_index').val();
				var tt = randomNumberFromRange(-0.99, 0.99).toFixed(2);
				var r = randomNumberFromRange(0, 9).toFixed();
		...
		function sp_auto() {
			...
			var sp_specificgravity = randomNumberFromRange(2.821, 2.835).toFixed(3); //(sp_specific_gravity)
			...
			var sp_waterabr = randomNumberFromRange(0.95, 1.05).toFixed(2); // (sp_water_abr)_1
		...
		function sou_auto() {
			...
			var soundness = randomNumberFromRange(0.70, 1.30);
		...
		function general_flk_elo1() {
			$('#txtflk').css("background-color", "var(--success)");
			var combined_index = randomNumberFromRange(21.0, 27.0).toFixed(1);
		...
		function imp_auto() {
			...
			var imp_value4 = randomNumberFromRange(15.00, 18.00);
		...
		function crush_auto() {
			...
			var cru_value = randomNumberFromRange(18.0, 20.0).toFixed(1);
		...
		function grd_auto() {
			...
			var pass_sample_2 = randomNumberFromRange(91.00, 97.50).toFixed(2);
			var pass_sample_3 = randomNumberFromRange(42.00, 70.00).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(16.00, 34.00).toFixed(2);
			var pass_sample_5 = randomNumberFromRange(5.00, 10.00).toFixed(2);
			var pass_sample_6 = randomNumberFromRange(0.01, 3.00).toFixed(2);
			...
			//(SUM OF CUM. WAIGHT)
			var blank_extra = (+cum_wt_gm1) + (+cum_wt_gm2) + (+cum_wt_gm3) + (+cum_wt_gm4) + (+cum_wt_gm5) + (+cum_wt_gm6);
			...
			var blank_extra = (+cum_wt_gm_1) + (+cum_wt_gm_2) + (+cum_wt_gm_3) + (+cum_wt_gm_4) + (+cum_wt_gm_5) + (+cum_wt_gm_6);
			$('#blank_extra').val(blank_extra.toFixed(0));
		...
		$('#sample_taken,#pass_sample_1,#pass_sample_2,#pass_sample_3,#pass_sample_4,#pass_sample_5,#pass_sample_6').change(function() {
			$('#txtgrd').css("background-color", "var(--success)");
		...
		$('#cum_wt_gm_1,#cum_wt_gm_2,#cum_wt_gm_3,#cum_wt_gm_4,#cum_wt_gm_5,#cum_wt_gm_6').change(function() {
			weight_cum_gm();
		});
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_k_25_mm.php',
