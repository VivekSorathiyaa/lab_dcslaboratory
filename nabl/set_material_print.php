...
$sel_material = $_GET["sel_material"];
$todate = $_GET["todate"];
...
if ($fromdate != "") {
	...
	$from_msgs = " FROM " . date("d-m-Y", strtotime($fromdate));
} else {
	$fromdate_new = "";
	$from_msgs = "";
}
...
if ($todate != "") {
	...
	$to_msgs = " TO " . date("d-m-Y", strtotime($todate));
} else {
	$fromdate_new = "";
	$to_msgs = "";
}
...
$set_merged_mgs = $sel_material . $from_msgs . $to_msgs
?>
...
?>
	<table id="example2" class="table table-bordered table-striped" border="1" style="width:100%;margin:0px auto;padding:0px;font-size:10px;font-family: Book Antiqua;border-collapse: collapse;">
		<thead>
			<tr>
				<th style="text-align:center;" colspan="15"><?php echo $set_merged_mgs; ?></th>
		...
		<tbody>
			...
			?>
								...
								<tr>
									...
									<td style="text-align:center"><?php echo $row_select_pipe["created_by"]; ?></td>
...
?>
	<table id="example2" class="table table-bordered table-striped" border="1" style="width:100%;margin:0px auto;padding:0px;font-size:10px;font-family: Book Antiqua;border-collapse: collapse;">
		<thead>
			<tr>
				<th style="text-align:center;" colspan="16"><?php echo $set_merged_mgs; ?></th>
		...
		<tbody>
			...
			?>
								...
								<tr>
									...
									<td style="text-align:center"><?php echo $row_select_pipe1["created_by"]; ?></td>
									<td style="text-align:center"></td>
...
?>
	<table id="example2" class="table table-bordered table-striped" border="1" style="width:100%;margin:0px auto;padding:0px;font-size:10px;font-family: Book Antiqua;border-collapse: collapse;">
		<thead>
			<tr>
				<th style="text-align:center;" colspan="17"><?php echo $set_merged_mgs; ?></th>
...
?>
	<table id="example2" class="table table-bordered table-striped" border="1" style="width:100%;margin:0px auto;padding:0px;font-size:10px;font-family: Book Antiqua;border-collapse: collapse;">
		<thead>
			<tr>
				<th style="text-align:center;" colspan="20"><?php echo $set_merged_mgs; ?></th>
...
?>
	<table id="example2" class="table table-bordered table-striped" border="1" style="width:100%;margin:0px auto;padding:0px;font-size:10px;font-family: Book Antiqua;border-collapse: collapse;">
		<thead>
			<tr>
				<th style="text-align:center;" colspan="13"><?php echo $set_merged_mgs; ?></th>
...
?>
	<table id="example2" class="table table-bordered table-striped" border="1" style="width:100%;margin:0px auto;padding:0px;font-size:10px;font-family: Book Antiqua;border-collapse: collapse;">
		<thead>
			<tr>
				<th style="text-align:center;" colspan="12"><?php echo $set_merged_mgs; ?></th>
...
?>
	<table id="example2" class="table table-bordered table-striped" border="1" style="width:100%;margin:0px auto;padding:0px;font-size:10px;font-family: Book Antiqua;border-collapse: collapse;">
		<thead>
			<tr>
				<th style="text-align:center;" colspan="18"><?php echo $set_merged_mgs; ?></th>
...
?>
	<table id="example2" class="table table-bordered table-striped" border="1" style="width:100%;margin:0px auto;padding:0px;font-size:10px;font-family: Book Antiqua;border-collapse: collapse;">
		<thead>
			<tr>
				<th style="text-align:center;" colspan="14"><?php echo $set_merged_mgs; ?></th>
...
?>
	<table id="example2" class="table table-bordered table-striped" border="1" style="width:100%;margin:0px auto;padding:0px;font-size:10px;font-family: Book Antiqua;border-collapse: collapse;">
		<thead>
			<tr>
				<th style="text-align:center;" colspan="32"><?php echo $set_merged_mgs; ?></th>
...
?>
	<table id="example2" class="table table-bordered table-striped" border="1" style="width:100%;margin:0px auto;padding:0px;font-size:10px;font-family: Book Antiqua;border-collapse: collapse;">
		<thead>
			<tr>
				<th style="text-align:center;" colspan="53"><?php echo $set_merged_mgs; ?></th>
