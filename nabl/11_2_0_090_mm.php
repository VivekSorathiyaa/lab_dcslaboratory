			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">MSS - B (MIX MATERIAL)</h2>
					</div>
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">0.09</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM mss_mix_b WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_mss_11_2_0_090_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>

												<?php// } ?>
												<div class="col-sm-2">
													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=mss_mix_b" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from mss_mix_b WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		function sp_auto() {
			...
			var sp_waterabr = randomNumberFromRange(1.10, 1.22).toFixed(2); // (sp_water_abr)_1
		...
		$('#sp_specific_gravity').change(function() {
			...
			if ($("#chk_sp").is(':checked')) {
				...
				$('#sp_specific_gravity_2').val(sp_specific_gravity2.toFixed(3));
				var sp_specific_gravity_2 = $('#sp_specific_gravity_2').val();
				var sp_waterabr = randomNumberFromRange(1.00, 1.22).toFixed(2); // (sp_water_abr)_1
				$('#sp_water_abr').val(sp_waterabr);
				var sp_water_abr = $('#sp_water_abr').val();
				var ttt = randomNumberFromRange(-0.02, 0.02).toFixed(2);
				var sp_water_abr1 = (+sp_water_abr) + (+ttt); ////(sp_water_abr_1)_1
		...
		function grd_auto() {
			...
			var pass_sample_2 = randomNumberFromRange(89.00, 95.00).toFixed(2);
			var pass_sample_3 = randomNumberFromRange(35.00, 45.00).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(10.00, 20.00).toFixed(2);
			var pass_sample_5 = randomNumberFromRange(1.00, 4.00).toFixed(2);
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save11_2_0_090_mm.php',
