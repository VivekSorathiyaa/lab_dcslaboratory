                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row  m-0">
                            ...
                            <div class="col-sm-12">
                                <input type="hidden" class="form-control" value="<?php echo $_GET['trf_no']; ?>"
                                    id="txt_trf_no" name="txt_trf_no">
                                <input type="hidden" class="form-control"
                                    value="<?php echo $_GET['temporary_trf_no']; ?>" id="temporary_trf_no"
                                    name="temporary_trf_no">
                                <input type="text" class="form-control" value="<?php echo $_GET['job_no']; ?>"
                                    id="txt_job_no" name="txt_job_no" disabled>
                            </div>
                        </div>
                        <br>
                                    ...
                                    <div class="table-responsive" id="display_data">
                                        <table class="table table-bordered no-margin">
                                            ...
                                            <tbody>
                                                ...
                                                $sel_span_tested_by = "select * from span_material_assign where `trf_no`='$_GET[trf_no]' AND `job_number`='$_GET[job_no]' AND `temporary_trf_no`='$_GET[temporary_trf_no]'";
                                                ...
                                                foreach ($array_labs_nos as $one_labs_nos) {
                                                    ...
                                                    while ($row = mysqli_fetch_array($result)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            ?></b>
                                                                <input type="hidden" value="<?php echo $row['material_id']; ?>"
                                                                    name="material_id_hidden"
                                                                    id="material_<?php echo $material_count; ?>">
                                                            </td>
                                                            <td>
                                                                ...
                                                                <input type="hidden" name="labno" class="form-control"
                                                                    id="labno_<?php echo $material_count; ?>"
                                                                    value="<?php echo $row['lab_no']; ?>" disabled
                                                                    style="width: 160px;">
                                                            </td>
                                                            <td style="width:250px;">
                                                                ...
                                                                ?>
                                                                <input type="hidden" name="testlist" class="form-control"
                                                                    id="testlist_<?php echo $material_count; ?>"
                                                                    value="<?php echo $print_test; ?>">

                                                            </td>
                                                            <td>
                                                                <input type="text" name="startdate"
                                                                    class="form-control startdate_class"
                                                                    id="startdate_<?php echo $material_count; ?>"
                                                                    value="<?php if ($is_est == 1) {
                                                            ...
                                                            <input type="hidden" name="expdate"
                                                                class="form-control expdate_class"
                                                                id="expdate_<?php echo $material_count; ?>"
                                                                value="<?php if ($is_est == 1) {
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                <input type="text" name="day" class="form-control day"
                                                                    id="day_<?php echo $material_count; ?>"
                                                                    value="<?php if ($is_est == 1) {
                                                                        echo $get_eng['days'];
                                                                    } else {
                                                                        echo $days_to_put;
                                                            ...
                                                            <td>
                                                                <input type="text" name="enddate"
                                                                    class="form-control enddate_class"
                                                                    id="enddate_<?php echo $material_count; ?>"
                                                                    value="<?php if ($is_est == 1) {
                                                                ...
                                                                <span
                                                                    style="color:<?php echo $colored; ?>;font-weight:bold;font-size:17px;"><?php echo date('l', strtotime($var_na_name)); ?></span>
                                                            </td>

                                                            <td>
                                                                <select name="sel_eng_ids" class="form-control sel_eng_ids"
                                                                    style="width:50%;" id="eng_<?php echo $material_count; ?>">
                                                                    <option value="">Select Analyst</option>
                                                                    <?php
                                                                    $sel_mul = "select * from multi_login where `staff_isadmin`='4' ORDER BY id DESC";
                                                                    $query_mul = mysqli_query($conn, $sel_mul);
                                                                    if (mysqli_num_rows($query_mul) > 0) {
                                                                        while ($row_mul = mysqli_fetch_array($query_mul)) {
                                                                            ?>
                                                                            <option
                                                                                value="<?php echo $row_mul['id'] . '|' . $row['lab_no'] . '|' . $row['trf_no'] . '|' . $row['final_material_id']; ?>"
                                                                                <?php if ($row["tested_by"] == $row_mul['id']) {
                                                                                    echo "selected";
                                                                                } ?>><?php echo $row_mul['staff_fullname']; ?>
                                                                            </option>
                                                                            <?php
                                                                        }
                                                                    }
                                                                 ...
                                                                 <?php if ($row["sent_tm_to_eng_blank"] == "0") { ?>
                                                                    <a href="javascript:void(0);"
                                                                        class="btn btn-success btn-lg btn3d send_tm_to_eng_blank  <?php if ($row['assigned_by_tm'] == '0') {
                                                                            echo 'disabled';
                                                                        } ?>"
                                                                        data-id="<?php echo $row['lab_no'] . '|' . $row['trf_no'] . '|' . $row['final_material_id']; ?>"
                                                                        title="Report Send To Quality Managetr"><span
                                                                            class="glyphicon glyphicon-question-list"></span>
                                                                        Submit</a>
                                                                <?php } else {
                                                                    echo '<span style="color:green;font-weight:bold;">Assigned To Analyst</span>';
                                                                } ?> 
                                                ...
                                                $select_job_for_eng = "select * from job_for_engineer where `sent_tm_to_eng_blank`=0 AND `trf_no` = '$get_trf_no'";
...
<script>
    ...
    $(document).on("click", ".send_tm_to_eng_blank", function () {
        var clicked_id = $(this).attr("data-id");
        $.confirm({
            title: "warning",
            content: "Are You Sure To Send This Report To Analyst?",
            buttons: {
                confirm: function () {
                    $.ajax({
                        type: 'POST',
                        url: '<?php $base_url; ?>save_span_engineer.php',
                        data: 'action_type=send_tm_to_eng_blank&clicked_id=' + clicked_id,
    ...
    $(document).on("change", ".sel_eng_ids", function () {
        ...
        $.confirm({
            title: "warning",
            content: "Are You Sure To Assign This Material To Analyst?",
            buttons: {
                confirm: function () {
                    $.ajax({
                        type: 'POST',
                        url: '<?php $base_url; ?>save_span_engineer.php',
                        data: 'action_type=aasign_eng_to_material&clicked_id=' + clicked_id,
                        success: function (html) {
                            location.reload();
                        }
                    });
