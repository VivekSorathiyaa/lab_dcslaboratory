				...
				<div class="panel-body">
								...
								<div class="row">
									...
									<div class="col-lg-3">
										<div class="form-group">
											<div class="col-sm-12">
												<label for="inputEmail3" class="col-sm-12 control-label">Volume of water (ml)</label>
											</div>
										</div>
									</div>
									<div class="col-lg-3">
...
$(document).ready(function(){ 
	...
	function set_auto(){
		...
		var it_ft_1 = (+it_1) - (+ft_1);
		var it_ft_2 = (+it_2) - (+ft_2);
		
		$('#it_ft_1').val(it_ft_1);
		$('#it_ft_2').val(it_ft_2);
		
	}
	$('#it_1').change(function(){
        var it_1 = $('#it_1').val();
		var it_2 = $('#it_2').val();
		var ft_1 = $('#ft_1').val();
		var ft_2 = $('#ft_2').val();
	...
	function consistency_auto()
	{
		$('#consis').css("background-color","var(--success)");	
			...
			{	
				...
				reading_2 = reading_3;
				reading_4 = randomNumberFromRange(7.00, 9.00);
				reading_5 = reading_1;
	...
	function fines_auto()
	{
			$('#fines').css("background-color","var(--success)");	
