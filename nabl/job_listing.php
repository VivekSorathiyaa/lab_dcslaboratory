				...
				<div class="box box-info">
					...
					<!-- /.box-header -->
							...
							<div class="box-body">
								...
								<a data-toggle="collapse" href="#collapse1" class="btn btn-primary" style="margin-left:40%;width:20%;font-size: 20px;" id="add_material_button"><i class="fa fa-search" aria-hidden="true"></i>Search</a>
							<br>
							...
							<br>
								<div class="row">
									...
									<div class="col-md-3">
									<label>Clients:</label>
									<select name="sel_clients_ids" id="sel_clients_ids" class="form-control select2" style="height: 55px;background-color: aquamarine;" multiple="multiple">
									<?php
									...
									<div class="col-md-3">
									<label>Agency:</label>
									<select name="sel_agency_ids" id="sel_agency_ids" class="form-control select2" style="height: 55px;background-color: aquamarine;background-color: aquamarine;height: 55px;font-size: 20px;width: 230px;" multiple="multiple">
									<?php
									...
									<select name="sel_auth_names" id="sel_auth_names" class="form-control select2" style="height: 55px;background-color: aquamarine;" multiple="multiple">
									<?php
									...
									<select name="agree_nos" id="agree_nos" class="form-control select2" style="height: 55px;background-color: aquamarine;" multiple="multiple">
									<?php
								...
								<div class="row">
									<div class="col-md-5">
										...
										<input type="text" name="name_of_work" id="name_of_work" class="form-control" placeholder="Enter Name Of Work..">
									</div>
								</div>
								<div class="row">
								<div class="col-md-5">
								...
								<div class="col-md-3">
									...
									<a href="job_listing.php?a=rec1" class="btn btn-primary btn3d"><span class="glyphicon glyphicon-question-ok"></span> View All</a>
									</div>
								</div>
							</div>
								<br>
								<div id="display_data">
									...
									?>
											...
											$urls="span_material_assigning.php?a=rec2&&report_no=$reports_no";
...
<script>
	...
	//$('#agree_nos').multiselect();
	 ...
	 $("#sel_clients_ids").selectr({});
	 $("#sel_agency_ids").selectr({});
	 $("#sel_auth_names").selectr({});
	 $("#agree_nos").selectr({});
...
<script>
	...
	$(".search_job_by_agency").click(function(){
					...
					if(sel_agency_ids =="" && sel_clients_ids =="" && sel_auth_names =="" && agree_nos =="" && name_of_work =="")
					{
						alert("Please Atlist One select");
						return false;
					}
					var postData = '&type=search_all_job_for_admin&sel_agency_ids='+sel_agency_ids+'&sel_clients_ids='+sel_clients_ids+'&sel_auth_names='+sel_auth_names+'&agree_nos='+agree_nos+'&name_of_work='+name_of_work;

					$.ajax({
						url : "<?php echo $base_url; ?>search_all_job_for_users.php",
						type: "POST",
						data : postData,
						success: function(data,status,  xhr)
						 {
