...
if(isset($_POST['action_type']) && !empty($_POST['action_type']))
	{
		...
		else if($_POST['action_type'] == 'add')
		{
		 ...
		 $insert="INSERT INTO `rebound_hammer` (`report_no`, `ulr`, `job_no`, `lab_no`, `status`, `created_by`, `created_date`, `modified_by`, `modified_date`, `is_deleted`, `deleted_by`,  `checked_by`,  `chk_rha`, `rh_location`, `rh_cast_date`, `rh_r1`, `rh_r2`, `rh_r3`, `rh_r4`, `rh_r5`, `rh_r6`, `rh_r7`, `rh_r8`, `rh_r9`, `rh_r10`, `avg_r_num`, `std_dev`, `rh_max`, `rh_min`, `rh_range`, `rh_rs`, `rh_level`, `rh_out`, `rh_relation`, `rh_verticle`, `rh_age`, `rh_rcc`, `rh_direction`, `temp`, `grade1`, `amend_date`) values(
				'$report_no','$ulr','$job_no','$lab_no','0','$_SESSION[name]','$curr_date','','0000-00-00','0','','',
				'$chk_rha', '$rh_location', '$rh_cast_date', '$rh_r1', '$rh_r2', '$rh_r3', '$rh_r4', '$rh_r5', '$rh_r6', '$rh_r7', '$rh_r8', '$rh_r9', '$rh_r10', '$avg_r_num', '$std_dev', '$rh_max', '$rh_min', '$rh_range', '$rh_rs', '$rh_level', '$rh_out', '$rh_relation', '$rh_verticle', '$rh_age', '$rh_rcc', '$rh_direction', '$temp', '$grade1', '$amend_date')"; 
	...
	if($_POST['action_type'] == 'set_sample_qty'){
		...
		$upd_final="update final_material_assign_master SET `rebound_qty`='$rebound_qty' WHERE `job_no`='$job_no' AND `lab_no`='$lab_no'";
