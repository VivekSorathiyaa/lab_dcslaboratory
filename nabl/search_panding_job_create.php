					...
					<table id="example1" class="table table-bordered table-striped">
								...
								<tbody>
									<?php
										...
										$count=0;
										$query="select * from job where   `jobisdeleted`='0' and `send_to_second_reception` = '1' and `material_assign` = '0' ".$where;
									...
									?>
											...
											<td style="white-space:nowrap;">
												...
												?>
												<a href="javascript:void(0);" class="btn btn-danger btn-lg btn3d send_to_second" data-id="<?php echo $row['report_no'];?>"title="SEND QUERIES TO RECEPTION 2"><span class="glyphicon glyphicon-question-ok"></span>EDIT FOR RECEPTION 2</a>
												<?php
												}
												?>
											</td>
