			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">WBM GRADING-1</h2>
					</div>
													...
													<div class="panel-body">
														...
														<div class="row">
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">125.0</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">90.0</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">45.0</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="hidden" class="form-control" id="cum_wt_gm_6" name="cum_wt_gm_6">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="hidden" class="form-control" id="ret_wt_gm_6" name="ret_wt_gm_6">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="hidden" class="form-control" id="cum_ret_6" name="cum_ret_6">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="hidden" class="form-control" id="pass_sample_6" name="pass_sample_6">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="hidden" class="form-control" id="pass_range_6" name="pass_range_6" >
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="hidden" class="form-control" id="cum_wt_gm_7" name="cum_wt_gm_7">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="hidden" class="form-control" id="ret_wt_gm_7" name="ret_wt_gm_7">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="hidden" class="form-control" id="cum_ret_7" name="cum_ret_7">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="hidden" class="form-control" id="pass_sample_7" name="pass_sample_7">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="hidden" class="form-control" id="pass_range_7" name="pass_range_7" >
																	</div>
																</div>
															</div>
														</div>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-sm-1">
												...
												<?php   
													$querys_job1 = "SELECT * FROM wbm_90_45_mm WHERE `is_deleted`='0' and lab_no='$lab_no'";
											...
											?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_wbm_45_90_mm.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&ulr=<?php echo $_GET['ulr'];?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
											...
											<?php //} ?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&tbl_name=wbm_90_45_mm" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
					...
					<div class="col-lg-12">
						<table border="1px solid black" align="center" width="100%" id="aaaa">
							<tr>
								...
								<?php
							 $query = "select * from wbm_90_45_mm WHERE lab_no='$aa'  and `is_deleted`='0'";
...
//SOUNDNESS	
	...
	function grd_auto() {
			...
			$('#pass_range_2').val("95-100");
			$('#pass_range_3').val("60-80");
			$('#pass_range_4').val("40-60");
			$('#pass_range_5').val("25-40");

			var sample_taken = 5000;
			//PASSING RANGE
			var pass_sample_1 = randomNumberFromRange(100, 100).toFixed(2);
			var pass_sample_2 = randomNumberFromRange(96.00, 99.00).toFixed(2);
			var pass_sample_3 = randomNumberFromRange(61.01, 79.00).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(41.25, 58.00).toFixed(2);
			var pass_sample_5 = randomNumberFromRange(26.00, 39.00).toFixed(2);
			...
			//(SUM OF CUM. WAIGHT)
			var blank_extra = (+cum_wt_gm1) + (+cum_wt_gm2) + (+cum_wt_gm3) + (+cum_wt_gm4) + (+cum_wt_gm5);
			...
			var blank_extra = (+cum_wt_gm_1) + (+cum_wt_gm_2) + (+cum_wt_gm_3) + (+cum_wt_gm_4) + (+cum_wt_gm_5);
			$('#blank_extra').val(blank_extra.toFixed(0));
		...
		$('#sample_taken,#pass_sample_1,#pass_sample_2,#pass_sample_3,#pass_sample_4,#pass_sample_5').change(function() {
			$('#txtgrd').css("background-color", "var(--success)");
		...
		$('#cum_wt_gm_1,#cum_wt_gm_2,#cum_wt_gm_3,#cum_wt_gm_4,#cum_wt_gm_5').change(function() {
			weight_cum_gm();
		});
...
function getGlazedTiles(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo $base_url; ?>savewbm_45_90_mm.php',
