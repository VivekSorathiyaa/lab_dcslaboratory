...
//$sel_estiamte="select * from estimate_total_span where `trf_no`='$_GET[chk_array]' AND `job_no`='$_GET[chk_array]' AND `nabl_type`='nabl'";
$sel_estiamte="select * from estimate_total_span where `trf_no`='$_GET[chk_array]' AND `job_no`='$_GET[chk_array]'";
					...
					<div class="box box-info">
							...
							<div class="col-md-2">
										...
										foreach($get_chk_array as $one_chk_array)
									{
											...
											$select_final_mat="select * from final_material_assign_master where `trf_no`='$one_chk_array' AND `job_no`='$one_chk_array'";
		...
		if(hidden_gst_type !="without_gst")
		{
			...
			else
			{
				...
				success:function(msg){
					...
					window.location.href="<?php echo $base_url; ?>span_set_rate_merging_perfoma.php?chk_array="+txt_trf_no;
