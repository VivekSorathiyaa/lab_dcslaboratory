			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">GSB - II MIX (M5)</h2>
					</div>
					...
					<div class="panel panel-default" id="grd">
								...
								<div class="row">
									...
									<div class="col-lg-2">
										<div class="form-group">
											<div class="col-sm-12">
												<input type="hidden" class="form-control" id="cum_wt_gm_8" name="cum_wt_gm_8">
											</div>
										</div>
									</div>
									<div class="col-lg-2">
										<div class="form-group">
											<div class="col-sm-12">
												<input type="hidden" class="form-control" id="ret_wt_gm_8" name="ret_wt_gm_8">
											</div>
										</div>
									</div>
									<div class="col-lg-2">
										<div class="form-group">
											<div class="col-sm-12">
												<input type="hidden" class="form-control" id="cum_ret_8" name="cum_ret_8">
											</div>
										</div>
									</div>
									<div class="col-lg-2">
										<div class="form-group">
											<div class="col-sm-12">
												<input type="hidden" class="form-control" id="pass_sample_8" name="pass_sample_8">
											</div>
										</div>
									</div>
									<div class="col-lg-2">
										<div class="form-group">
											<div class="col-sm-12">
												<input type="hidden" class="form-control" id="pass_range_8" name="pass_range_8">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-sm-1">
												...
												<?php   
													$querys_job1 = "SELECT * FROM gsb_mix_2_m5 WHERE `is_deleted`='0' and lab_no='$lab_no'";
											...
											?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_gsb_1_mix_m5.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&ulr=<?php echo $_GET['ulr'];?>&&tbl_name=gsb_mix_2_m5" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
 
											</div>
											<div class="col-sm-2">
 													<!--<a target='_blank' href="<?php echo $base_url; ?>back_cal_report_blank/print_gsb_1_mix_m5.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=gsb_mix_2_m5" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Calculation Blank</b></a>-->

 												</div>
											
											<?php //} ?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_gsb_1_mix_m5.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&tbl_name=gsb_mix_2_m5" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
					...
					<div class="col-lg-12">
						<table border="1px solid black" align="center" width="100%" id="aaaa">
							<tr>
								...
								<?php
							 $query = "select * from gsb_mix_2_m5 WHERE lab_no='$aa'  and `is_deleted`='0'";
...
//SOUNDNESS	
	...
	function grd_auto()
	{
		$('#txtgrd').css("background-color","var(--primary)");	
					var sieve_1 = "53";
					var sieve_2 = "26.5";
					var sieve_3 = "9.5";
					var sieve_4 = "4.75";
					...
					$('#pass_range_2').val("70-100");
					$('#pass_range_3').val("50-80");
					$('#pass_range_4').val("40-65");
					$('#pass_range_5').val("30-50");
					$('#pass_range_6').val("10-15");
					$('#pass_range_7').val("0-5");
					
					// sahil
					var sample_taken = randomNumberFromRange(50, 55);
					//PASSING RANGE
					var pass_sample_1 = randomNumberFromRange(100, 100).toFixed(2);
					var pass_sample_2 = randomNumberFromRange(91.00,99.00).toFixed(2);
					var pass_sample_3 = randomNumberFromRange(60.00,90.00).toFixed(2);
					var pass_sample_4 = randomNumberFromRange(36.00,59.00).toFixed(2);
					var pass_sample_5 = randomNumberFromRange(26.00,35.00).toFixed(2);
					var pass_sample_6 = randomNumberFromRange(20.00,25.00).toFixed(2);
					var pass_sample_7 = randomNumberFromRange(11.00,14.00).toFixed(2);
					var pass_sample_8 = randomNumberFromRange(1.00,4.00).toFixed(2);
					...
					$('#ret_wt_gm_2').val(ret_wt_gm_2.toFixed(1));
					$('#ret_wt_gm_3').val(ret_wt_gm_3.toFixed(1));
					$('#ret_wt_gm_4').val(ret_wt_gm_4.toFixed(1));
					$('#ret_wt_gm_5').val(ret_wt_gm_5.toFixed(1));
					$('#ret_wt_gm_6').val(ret_wt_gm_6.toFixed(1));
					$('#ret_wt_gm_7').val(ret_wt_gm_7.toFixed(1));
					$('#ret_wt_gm_8').val(ret_wt_gm_8.toFixed(1));
					...
					//(SUM OF CUM. WAIGHT)
					var blank_extra = (+cum_wt_gm1)+(+cum_wt_gm2)+(+cum_wt_gm3)+(+cum_wt_gm4)+(+cum_wt_gm5)+(+cum_wt_gm6)+(+cum_wt_gm7)+(+cum_wt_gm8);
	...
	$('#sample_taken,#pass_sample_1,#pass_sample_2,#pass_sample_3,#pass_sample_4,#pass_sample_5,#pass_sample_6,#pass_sample_7,#pass_sample_8').change(function(){			
		$('#txtgrd').css("background-color","var(--primary)");
	...
	$('#cum_wt_gm_1,#cum_wt_gm_2,#cum_wt_gm_3,#cum_wt_gm_4,#cum_wt_gm_5,#cum_wt_gm_6,#cum_wt_gm_7,#cum_wt_gm_8').change(function(){
	  weight_cum_gm();
	});
...
function getGlazedTiles(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo $base_url; ?>saveg2_mix.php',
