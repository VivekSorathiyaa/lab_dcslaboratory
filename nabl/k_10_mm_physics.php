			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">10 MM</h2>
					</div>
        ...
        <div class="panel-body"><div class="row">									
								...
								<div class="row">
									...
									<div class="col-lg-1">
										<div class="form-group">
											<div class="col-sm-12">
												<label for="inputEmail3" class="col-sm-2 control-label">12.5</label>
											</div>
										</div>
									</div>
									<div class="col-lg-2">
      ...
      <div id="collapse7" class="panel-collapse collapse">
		...
		<!--Impact VALUE Start-->
								...
								<div class="row">
									...
									<div class="form-group">
									  <div class="col-sm-12">
										<input type="hidden" class="form-control" id="fine_6" name="fine_6">
									  </div>
									</div>
									</div>
									<div class="col-lg-2">
								...
								<div class="row">
									...
									<div class="col-lg-2">
									<div class="form-group">
									  <input type="hidden" class="form-control" id="avg_f_d" name="avg_f_d" >
									</div>
									</div>
									<div class="col-lg-2">
									<div class="form-group">
									  <input type="hidden" class="form-control" id="avg_f_c" name="avg_f_c" >
									</div>
									</div>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-sm-1">
												...
												<?php   
													$querys_job1 = "SELECT * FROM rcc_10_mm WHERE `is_deleted`='0' and lab_no='$lab_no'";
											...
											?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_kapchi_10_mm.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&ulr=<?php echo $_GET['ulr'];?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
 
											</div><!--
											<div class="col-sm-2">
 													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report_blank/print_kapchi_10_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&ulr=<?php echo $ulr; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Calculation Blank</b></a>

 												</div>-->
											<?php //} ?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&tbl_name=rcc_10_mm" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
					...
					<div class="col-lg-12">
						<table border="1px solid black" align="center" width="100%" id="aaaa">
							<tr>
								...
								<?php
							 $query = "select * from rcc_10_mm WHERE lab_no='$aa'  and `is_deleted`='0'";
...
//SOUNDNESS	
	...
	function general_flk_elo1()
	{
		...
		var a5 = 0;//randomNumberFromRange(3100.0,3500.0).toFixed(2);
		var a6 = 0;//randomNumberFromRange(1910.0,2080.0).toFixed(2);
		var a7 = 0;//randomNumberFromRange(1000.0,1200.0).toFixed(2);
		var a8 = randomNumberFromRange(1000.0,1200.0).toFixed(2);
		var a9 = randomNumberFromRange(300.0,800.0).toFixed(2);
		...
		var sum_a = $('#total_a').val();
		 ...
		 var b5 = 0;//randomNumberFromRange(1000.0,1200.0).toFixed(2);		
		 var b6 = 0;//randomNumberFromRange(1000.0,1200.0).toFixed(2);		
		 var b7 = 0;//randomNumberFromRange(1000.0,1200.0).toFixed(2);		
		 var b8 = randomNumberFromRange(100.0,150.0);		
		 var b9 = randomNumberFromRange(170.0,190.0);
		...
		var flk_x6 = 0;//((+b_6) / (+a_6)) * (+100);
		var flk_x7 = 0;//((+b_7) / (+a_7)) * (+100);
		...
		var flkxy6 = 0;//((+flkx6) * (+flky6)) / (+100);
		var flkxy7 = 0;//((+flkx7) * (+flky7)) / (+100);
		...
		var sum_aa = $('#total_aa').val();
		 ...
		 var dd5 = 0;//randomNumberFromRange(1000.0,1200.0).toFixed(2);			
		 var dd6 = 0;//randomNumberFromRange(1000.0,1200.0).toFixed(2);			
		 var dd7 = 0;//randomNumberFromRange(1000.0,1200.0).toFixed(2);			
		 var dd8 = randomNumberFromRange(300.0,350.0);				
		 var dd9 = randomNumberFromRange(70.0,120.0);
		...
		$('#total_dd').val(total_dd.toFixed(2));
		...
		var elo_x5 = 0;//((+dd_5) / (+aa_5)) * (+100);
		var elo_x6 = 0;//((+dd_6) / (+aa_6)) * (+100);
		var elo_x7 = 0;//((+dd_7) / (+aa_7)) * (+100);
		...
		$('#total_elo_x').val(total_elo_x.toFixed(2));
		...
		var eloxy6 = 0;//((+elox6) * (+eloy6)) / (+100);
		var eloxy7 = 0;//((+elox7) * (+eloy7)) / (+100);
		...
		$('#total_elo_xy').val(total_elo_xy.toFixed(2));
		var total_elo_xy = $('#total_elo_xy').val();
		
		var ei_index = (+total_elo_xy) / (+5);
	...
	function fine_auto()
	{
		$('#txtfin').css("background-color","var(--success)");	
			var fines_value = randomNumberFromRange(35.0,40.8).toFixed(1); 
			$('#fines_value').val(fines_value);			
			var finevalue = $('#fines_value').val();			
			var f_a_1 = randomNumberFromRange(1300.0, 1500.0);            			
			var f_a_2 = randomNumberFromRange(1300.0, 1500.0);			
			var f_c_1 = randomNumberFromRange(100.0, 253.0);            			
			var f_c_2 = randomNumberFromRange(100.0, 253.0);			
			...
			var values = [15.0, 20.0, 24.0];
			var fine_1 = values[Math.floor(Math.random() * values.length)]; 
			var fine_4 = values[Math.floor(Math.random() * values.length)]; 
			
			$('#fine_1').val(fine_1.toFixed(0));			
			$('#fine_4').val(fine_4.toFixed(0));	
			var fine1=$('#fine_1').val();			
			var fine4=$('#fine_4').val();
			
			var rrr = randomNumberFromRange(-0.3,0.3).toFixed(1);			
			var f_b_1 = (+finevalue) + (+rrr);			
			$('#f_b_1').val(f_b_1.toFixed(1));			
			var f_b1 = $('#f_b_1').val();			
			var tems1 = ((+finevalue) * 2);			
			var f_b_2 = ((+tems1)-(+f_b1));			
			$('#f_b_2').val(f_b_2.toFixed(1));
			var f_b2 = $('#f_b_2').val();	
			
			var f_d_1 = ((+f_c1)/(+f_a1)) * (+100);	
			$('#f_d_1').val(f_d_1.toFixed(2));
			var f_d1 = $('#f_d_1').val();
			var f_d_2 = ((+f_c2)/(+f_a2)) * (+100);	
			$('#f_d_2').val(f_d_2.toFixed(2));
			var f_d2 = $('#f_d_2').val();
			
			var fine_3 = ((+f_d1)+(+f_d2)) / (+2);	
			$('#fine_3').val(fine_3.toFixed(2));
			var fine3 = $('#fine_3').val();
			
			var fine_2 =  (((+fine3) + (+4)) * (+f_b1)) / (+14);	           			
			var fine_5 =  (((+fine3) + (+4)) * (+f_b2)) / (+14);		
			$('#fine_2').val(fine_2.toFixed(0));			
			$('#fine_5').val(fine_5.toFixed(0));	
			var fine2=$('#fine_2').val();			
			var fine5=$('#fine_5').val();
			...
			var f_b_1 = ((+14)*(+fine2)) / ((+4)+(+fine3));	
			$('#f_b_1').val(f_b_1.toFixed(2));
			var f_b1 = $('#f_b_1').val();
			
			var f_b_2 = ((+14)*(+fine5)) / ((+4)+(+fine3));	
			$('#f_b_2').val(f_b_2.toFixed(2));
			var f_b2 = $('#f_b_2').val();
			
			var fines_value = ((+f_b1)+(+f_b2)) / (+2);	
			$('#fines_value').val(fines_value.toFixed(2));
			
			/* var fine_3 = randomNumberFromRange(40, 41);
			$('#fine_3').val(fine_3.toFixed(0));	
			var fine_3=$('#fine_3').val();	
			
			var fine_2 =  (((+fine2)*(+14)) / (+fine2)) - (+4);	           			
			var fine_5 =  (((+fine2)*(+14)) / (+fine2)) - (+4);		
			$('#fine_2').val(fine_2.toFixed(0));			
			$('#fine_5').val(fine_5.toFixed(0));	
			var fine2=$('#fine_2').val();			
			var fine5=$('#fine_5').val(); */
