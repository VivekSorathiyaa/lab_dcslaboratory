...
<body>
	...
	<page size="A4">
			...
			<tbody>
				...
				<tr>
					...
					<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
						<center><b>OBSERVATION &amp; CALCULATION SHEET FOR POZZOLANA (FLYASH)</b></center>
					</td>
				</tr>
			</tbody>
		</table>
		...
		<table align="center" width="100%" class="test" height="100px;" style="border: 1px solid black; font-family:arial; margin-top:-1px;">
			<tr>
				<td colspan="4" style="border: 1px solid black; font-size:12px;padding:5px 0px;">&nbsp; <b>1. INITIAL AND FINAL SETTING TIME</b></td>
			</tr>
			<tr>
		...
		<table align="center" width="100%" class="test" height="150px;" style="border: 1px solid black; font-family:arial; margin-top:-1px;">
			<tr>
				<td colspan="4" style="border: 1px solid black; font-size:12px;padding:5px 0px;">&nbsp; <b>2. FINENESS BY DRY SIEVEING</b></td>
			</tr>
			<tr>
		...
		<table align="center" width="100%" class="test" style="border: 1px solid black; font-family:arial; margin-top:-1px;">
			<tr>
				<td colspan="5" style="border: 1px solid black; font-size:12px;padding:5px 0px;">&nbsp; <b>3. FINENESS BY BLAIN AIR PERMEABILITY</b></td>
			</tr>
			<tr>
		...
		<table align="center" width="100%" class="test" style="border: 1px solid black; font-family:arial; margin-top:-1px;">
			<tr>
				<td colspan="4" style="border: 1px solid black; font-size:12px;padding:5px 0px;">&nbsp; <b>4. SOUNDNESS</b></td>
			</tr>
			<tr>
		...
		<table align="center" width="100%" class="test1" height="Auto" style="border-top:2px solid;">
			<tbody>
				<tr style="padding-top:2px;">
					...
					<td style="width:16.67%;padding-top:2px;">
		...
		<table align="center" width="100%" class="test1" style="" height="15%">
			<tbody>
		...
		<table align="center" width="92%" style="font-family:arial;">
				<tr>
					<td >
						<div style="margin-top:20px;">
							<b style="font-size:10px;font-weight:100;">F/FASH/01/TR, Issue No.01</b><br>
							<font style="font-size:10px;font-weight:100;">W.e.f. 01.12.2011</font><br>
						</div>
					</td>
					<td>
						<div style="float:right;margin-top:20px;">
							<b style="font-size:10px;font-weight:100;">Page: 1 of 3<br>
						</div>
					</td>
				</tr>
			</table>
			...
			<table align="center" width="92%" style="font-family:arial;">
				<tr>
					...
					<td>
						<div style="float:right;margin-top:20px;">
							<b style="font-size:10px;font-weight:100;">Page: 2 of 3<br>
						</div>
					</td>
				</tr>
			</table>
				...
				<tr>
					...
					<td>
						<div style="float:right;margin-top:200px;">
							<b style="font-size:10px;font-weight:100;">Page: 3 of 3<br>
						</div>
					</td>
				</tr>
			</table>
