	...
	<page size="A4">
		<table align="center" width="94%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				...
				<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR  CLC BLOCK</b></center>
				</td>
			</tr>
		</table>
		<br>
		...
		<table align="center" width="94%" class="test1" height="15%">
			...
			<tr style="border: 1px solid black;">
				...
				<td style="border-left:1px solid;text-align:left;padding: 3px;"><b>&nbsp;Date of Starting</b></td>
				<td style="border-left:1px solid;text-align:left;padding: 3px;">&nbsp; <?php echo date('d - m - Y', strtotime($start_date)); ?></td>
			</tr>
			<tr style="border: 1px solid black;">
				<td style="text-align:center;"><b>3</b></td>
				<td style="border-left:1px solid;text-align:left;padding: 3px;"><b>&nbsp; Date of Complete</b></td>
				<td style="border-left:1px solid;text-align:left;padding: 3px;">&nbsp; <?php echo date('d - m - Y', strtotime($end_date)); ?></td>
			</tr>
		</table>
		<br>
		...
		<table align="center" width="94%" class="test1" style="border: 1px solid black;" height="Auto">
			<tr style="border: 0px solid black;">
				<td colspan="2" style="border: 0px solid black;padding:10px 5px;"><b>TEST-1 Dimension</b></td>
		...
		<table align="center" width="94%" class="test1" style="border: 1px solid black;" height="Auto">
			<tr style="border: 1px solid black;">
				<td colspan="4" style="border: 0px solid black;padding:10px 5px;"><b>TEST-2 Compressive Strength</b></td>
		...
		<table align="center" width="94%" class="test1" style="border: 1px solid black;" height="Auto">
			<tr style="border: 1px solid black;">
				<td colspan="5" style="border: 0px solid black;padding:10px 5px;"><b>TEST-3 Bulk Density &amp; Moisture Content</b></td>
		...
		<table align="center" width="94%" class="test1" style="border: 1px solid black;" height="Auto">
			<tr style="border: 1px solid black;">
				<td colspan="3" style="border: 0px solid black;padding:10px 5px;"><b>TEST-4 Drying Shrinkage</b></td>
		...
		<table align="center" width="94%" class="test1" style="margin-top:10px;">
