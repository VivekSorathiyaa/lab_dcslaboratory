	...
	<page size="A4">
				...
				<tbody>
					...
					<tr>
						<td style="font-size:11px;border: 1px solid black;">
							<center><b>FMT-OBS-058</b></center>
						</td>
						<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
							<center><b>Rapid Chloride Penetration Test</b></center>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table align="center" width="94%" class="test1" height="9%">
				<tbody>
					...
					<tr style="border: 1px solid black;">
						...
						<td style="border-left:1px solid;width:70%;text-align:left;padding:5px 0px;" colspan=3><b>&nbsp; <?php echo $lab_no."_01"?></b></td>
					</tr>
					<tr style="border: 1px solid black;">
						<td style="border-left:1px solid;text-align:left;padding:5px 0px;"><b>&nbsp; ID Mark</b></td>
		...
		<!-- Rapid Chloride penetration Test -->
			...
			<table align="center" width="94%" class="test1" height="10%">
				<tr>
					<td style="padding-bottom:7px;font-size:12px;"><b>ASTM C 1202-2019</b></td>
				</tr>
				<tr style="border: 1px solid black;">
			...
			<table align="center" width="94%" class="test1" style="" height="12%">
				<tbody>
