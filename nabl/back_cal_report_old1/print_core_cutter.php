	...
	<page size="A4">
		...
		<table align="center" width="100%" class="test1" height="9%">
			<tr style="border: 1px solid black;">
				<td colspan="3" style="border-left:1px solid;width:25%;text-align:left;padding:4px 4px;"><b>&nbsp; Details of samples &nbsp; &nbsp; : &nbsp; &nbsp; &nbsp;<?php echo $detail_sample;?></b></td>
			</tr>
			<tr style="border: 1px solid black;">
				<td style="border-left:1px solid;width:25%;text-align:left;padding:4px 4px;"><b>&nbsp; Sample ID No.</b></td>
				<td style="border-left:1px solid;width:70%;text-align:left;padding:4px 4px;" colspan=4><b>&nbsp; <?php echo $lab_no."_01"?></b></td>
			</tr>
			<tr style="border: 1px solid black;">
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;"><b>&nbsp; Type of Material</b></td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;">&nbsp;<?php echo $soil_location; ?></td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;"><b>&nbsp; Type of Compaction</b></td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;">&nbsp;Light</td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;">&nbsp;Heavy</td>
			</tr>
			<tr style="border: 1px solid black;">
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;"><b>&nbsp; Date of receipt of Specimen</b></td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;">&nbsp; <?php echo date("d - m - y",strtotime($rec_sample_date)); ?></td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;"><b>&nbsp; Weight of Rammer</b></td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;">&nbsp;2.6 Kg</td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;">&nbsp;4.9 Kg</td>
			</tr>
			<tr style="border: 1px solid black;">
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;"><b>&nbsp; Date of Starting</b></td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;">&nbsp; <?php echo date('d - m - Y', strtotime($start_date)); ?></td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;"><b>&nbsp; Fall of Rammer</b></td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;">&nbsp;310 mm</td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;">&nbsp;450 mm</td>
			</tr>
			<tr style="border: 1px solid black;">
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;"><b>&nbsp; Date of Completion</b></td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;">&nbsp; <?php echo date('d - m - Y', strtotime($end_date)); ?></td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;"><b>&nbsp; volume of Mould</b></td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;">&nbsp;   cc</td>
				<td style="border-left:1px solid;text-align:left;padding:4px 4px;">&nbsp;   cc</td>
			</tr>
		</table>
	<br>
		...
		<table align="center" width="100%" class="test">
			...
			<tr>
				<td colspan="8" style="border: 1px solid black;text-align:center;padding:4px 0;;padding:4px 0;"><b>MOISTURE CONTENT</b></td>
			</tr>
			<tr>
			    <td style="border: 1px solid black;width:1%;padding:4px 4px;"><b>Sr.No.</b></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;;padding:4px 0;"><b>Particulars</b></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;;width:9%;padding:4px 0;"><b>1</b></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;;width:9%;padding:4px 0;"><b>2</b></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;;width:9%;padding:4px 0;"><b>3</b></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;;width:9%;padding:4px 0;"><b>4</b></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;;width:9%;padding:4px 0;"><b>5</b></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;;width:9%;padding:4px 0;	"><b>6</b></td>
			</tr>
			<tr>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;;padding:4px 0;">1</td>
			    <td style="border: 1px solid black;padding:4px 0;">&nbsp; Container No.</td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
			</tr>
			<tr>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;">2</td>
				<td style="border: 1px solid black;">&nbsp; Wt. of  container + Wt. of wet soil in gm </td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
			...
			<tr>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;">3</td>
				<td style="border: 1px solid black;"> &nbsp; Wt. of container + Wt. of dry soil in gm</td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
			...
			<tr>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;">4</td>
				<td style="border: 1px solid black;">&nbsp; Wt. of water in gm = (2) - (3)</td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
			...
			<tr>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;">5</td>
				<td style="border: 1px solid black;">&nbsp;Wt. of container in gm </td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
			...
			<tr>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;">6</td>
				<td style="border: 1px solid black;">&nbsp; Wt.of oven dry soil in gm = (3) - (5)</td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
            ...
            <tr>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;">7</td>
				<td style="border: 1px solid black;">&nbsp; Moisture Content (M) in%</td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
				<td style="border: 1px solid black;text-align:center;padding:4px 0;"></td>
			...
			<br><br><br>
			<table align="center" width="100%" class="test1" style="margin-bottom: 20px;" Height="5%">
