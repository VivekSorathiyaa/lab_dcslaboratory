...
<body>
		...
		<page size="A4">
				...
				<tbody>
					...
					<tr>
						...
						<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
							<center><b>OBSERVATION & CALCULATION SHEET FOR TEST ON WATER FOR CONSTRUCTION PURPOSE</b></center>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table align="center" width="100%" class="test1" height="9%">
				...
				<tbody>
					...
					<tr style="border: 1px solid black;">
						<td style="border-left:1px solid;width:25%;text-align:left;"><b>&nbsp; Water Source</b></td>
						<td style="border-left:1px solid;width:70%;text-align:left;"><b>&nbsp; <?php echo $water_source;?></b></td>
					</tr>
			...
			<table align="center" width="100%" class="test" style="border: 1px solid black; font-family:arial;">
				<tr>
					<td width="100%" colspan="2" style="border: 1px solid black; font:size:14px;">&nbsp;&nbsp; <b>1. PH Value as per IS 3025:1983 (RA 2017) Part 11 (pH meter)</b></td>
			...
			<table align="center" width="100%" class="test" height="10%" style="border: 1px solid black; font-family:arial;">
				<tr>
					<td width="100%" colspan="6" style="border: 1px solid black; font:size:14px;">&nbsp;&nbsp; <b>4. Determination of total solids. As per IS 3025:1984 (RA 2018) Part 15</b></td>
	...
	if (($row_select_pipe['avghr'] != "" && $row_select_pipe['avghr'] != null && $row_select_pipe['avghr'] != "0") ||
		...
		?>
			...
			<table align="center" width="100%" class="test" height="8%" style="border: 1px solid black;">
				<tbody>
					...
					<tr>
						...
						<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
							<center><b>OBSERVATION & CALCULATION SHEET FOR TEST ON WATER FOR CONSTRUCTION PURPOS</b></center>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<table align="center" width="100%" class="test" height="10%" style="border: 1px solid black; font-family:arial;">
				<tr>
					<td width="100%" colspan="6" style="border: 1px solid black; font:size:14px; padding: 5px; ">&nbsp;&nbsp; <b>5. Determination of dissolved solids. As per IS 3025:1984 (RA 2018) Part 16</b></td>
			...
			<table align="center" width="100%" class="test" height="10%" style="border: 1px solid black; font-family:arial;">
				<tr>
					<td width="100%" colspan="6" style="border: 1px solid black; font:size:14px; padding: 5px;">&nbsp;&nbsp; <b>6. Determination of suspended matter. As per IS 3025:1984 (RA 2017) Part 17</b></td>
			...
			<table align="center" width="100%" class="test" height="10%" style="border: 1px solid black; font-family:arial;">
				<tr>
					<td width="100%" colspan="6" style="border: 1px solid black; font:size:14px; padding: 5px;">&nbsp;&nbsp; <b>7. Determination of organic matter. As per IS 3025:1984 (RA 2017) Part 18</b></td>
			...
			<table align="center" width="100%" class="test" height="10%" style="border: 1px solid black; font-family:arial;">
				<tr>
					<td width="100%" colspan="6" style="border: 1px solid black; font:size:14px; padding: 5px;">&nbsp;&nbsp; <b>8. Determination of inorganic matter. As per IS 3025:1984 (RA 2017) Part 18</b></td>
		...
		<table align="center" width="100%" class="test1" height="Auto" style="border-top:2px solid;">
			   <tbody>
				...
				<tr style="font-size:10px;">
					<td style="text-align:center;">Page 2 of 3</td>
				</tr>
			   </tbody>
		</table>
			...
			<table align="center" width="100%" class="test" height="10%" style="border: 1px solid black; font-family:arial;">
				<tr>
					<td width="100%" colspan="6" style="border: 1px solid black; font:size:14px; padding: 5px;">&nbsp;&nbsp; <b>9. Determination of chloride as per IS 3025:1988 (RA 2019) Part 32</b></td>
			...
			<table align="center" width="100%" class="test" height="10%" style="border: 1px solid black; font-family:arial;">
				<tr>
					<td width="100%" colspan="6" style="border: 1px solid black; font:size:14px; padding: 5px;">&nbsp;&nbsp; <b>10. Sulphites as per IS 3025:1986 (RA 2019) Part 24</b></td>
			...
			<table align="center" width="100%" class="test" height="10%" style="border: 1px solid black; font-family:arial;">
				<tr>
					<td width="100%" colspan="6" style="border: 1px solid black; font:size:14px; padding: 5px;">&nbsp;&nbsp; <b>11. Total Hardness as per IS 3025:2009 (RA 2019) Part 21</b></td>
			...
			<table align="center" width="100%" class="test1" height="Auto" style="border-top:2px solid;">
			   <tbody>
				...
				<tr style="font-size:10px;">
					<td style="text-align:center;">Page 3 of 3</td>
				</tr>
			   </tbody>
		</table>
		</page>
		...
		<!-- <page size="A4">
			<table align="center" width="100%" class="test" style="border: 1px solid black;border-bottom:0;">
				<tr style="">
					...
					<td style="width:20%;font-weight:bold;">Page : 1/ 1 </td>
				</tr>
			</table>
			<table align="center" width="100%" class="test" style="border: 1px solid black;border-bottom:0;">
				<tr style="">
			...
			<table align="center" width="100%" class="test" height="10%" style="border: 1px solid black; font-family:arial;">
				<tr>
					<td width="100%" colspan="6" style="border: 1px solid black; font:size:14px;">&nbsp;&nbsp; <b>5. Determination of dissolved solids. As per IS 3025:1984 (RA 2018) Part 16</b></td>
	...
	if (($row_select_pipe['avghr'] != "" && $row_select_pipe['avghr'] != null && $row_select_pipe['avghr'] != "0") ||
		...
		?>
			...
			<table align="center" width="100%" class="test" height="10%" style="border: 1px solid black; font-family:arial;">
				<tr>
					<td width="100%" colspan="6" style="border: 1px solid black; font:size:14px;">&nbsp;&nbsp; <b>10. Sulphites as per IS 3025:1986 (RA 2019) Part 24</b></td>
