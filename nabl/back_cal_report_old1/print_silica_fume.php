...
<body>
    ...
    <page size="A4">
        <table align="center" width="94%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				...
				<td style="font-size:12px;border: 1px solid black;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR TEST ON KOTA STONE</b></center>
				</td>
			</tr>
		</table>
		<br>
        ...
        <table align="center" width="94%" class="test" style="border: 1px solid black;">
            <tr>
        ...
        <table align="center" width="94%" class="test1" style="margin-bottom:0px;" Height="12%">
