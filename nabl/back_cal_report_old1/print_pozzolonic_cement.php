	...
	<page size="A4">
		...
		<table align="center" width="94%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				<td style="font-size:11px;border: 1px solid black;">
					<center><b>FMT-OBS-020</b></center>
				</td>
				<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR TEST ON POZZOLONIC MATERIAL</b></center>
				</td>
			</tr>
		</table>
		<br>
		...
		<table align="center" width="94%" class="test1" height="9%">
			...
			<tr style="border: 1px solid black;">
				...
				<td style="border-left:1px solid;text-align:left;"><b>&nbsp; Type of Pozzolona</b></td>
		...
		<table align="center" width="94%" class="test1" style="margin-top:-1px;">
		    <tr style="border: 1px solid black;">
				<td></td>
		...
		<table align="center" width="94%" class="test1" height="Auto" style="margin-top:-2px;border:1px solid;border-top:0px;">
						<tr>
