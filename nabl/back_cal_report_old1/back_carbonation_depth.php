...
<br>
	<page size="A4">
		<table align="center" width="94%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				...
				<td style="font-size:12px;border: 1px solid black;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR TEST ON CARBONATION TEST <br> (BS-1881 Part - 201: CL-2.22)</b></center>
				</td>
			</tr>
		</table>
		<br>
		...
		<?php $cnt = 1; ?>
		<table align="center" width="94%" cellspacing="0" cellpadding="0" style="font-size:14px;border:1px solid;margin-bottom:15px;font-family:Arial;">
