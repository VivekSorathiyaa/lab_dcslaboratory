	...
	<page size="A4">
		<table align="center" width="100%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				...
				<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR FIELD DRY DENSITY  <br>(by Sand Replacement Method)</b></center>
				</td>
			</tr>
		</table>
		<br>
		...
		<table align="center" width="100%" class="test1" height="9%">
			...
			<tr style="border: 1px solid black;">
				...
				<td style="border-left:1px solid;width:30%;text-align:left;padding: 3px;"><b>&nbsp; Sample ID No.</b></td>
			...
			<tr style="border: 1px solid black;">
				...
				<td style="border-left:1px solid;text-align:left;padding: 3px;"><b>&nbsp; Location</b></td>
				<td style="border-left:1px solid;text-align:left;padding: 3px;">&nbsp;<?php if ($material_location == 1) {																																	echo "In Laboratory";																																			} else {																																				echo "In Field";																																				} ?></td>
			</tr>
			<tr style="border: 1px solid black;">
				<td style="text-align:center;"><b>3</b></td>
				<td style="border-left:1px solid;text-align:left;padding: 3px;"><b>&nbsp; Unit Wt of Standard Sand (ys)</b></td>
				<td style="border-left:1px solid;text-align:left;padding: 3px;">&nbsp; <?php echo $row_select_pipe['c1']; ?> </td>
			</tr>
			<tr style="border: 1px solid black;">
				<td style="text-align:center;"><b>4</b></td>
				<td style="border-left:1px solid;text-align:left;padding: 3px;"><b>&nbsp; Description of Material</b></td>
				<td style="border-left:1px solid;text-align:left;padding: 3px;">&nbsp; <?php echo $row_select_pipe['mt_desc']; ?> </td>
			</tr>
			<tr style="border: 1px solid black;">
		...
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Cambria;">
		     <tr>
			...
			<?php $cnt = 1; ?>
				<tr>
					<td style="text-align:center;font-size:14px; ">
						...
						<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px;font-family: Cambria;border:1px solid black;">
				...
				<tr> 	
					<td style="text-align:center;font-size:14px; ">
						<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px;font-family: Cambria;border:1px solid;margin-bottom:10px;">
