...
<body>
	...
	<page size="A4">
			...
			<table align="center" width="100%" class="test1" height="Auto" style="border-top:2px solid;">
				<tbody>
					...
					<tr style="font-size:10px;">
						<td style="text-align:center;"><b>Page 1 of 4</b></td>
					</tr>
				</tbody>
			</table>
			...
			<br>
			<p style="font-size:16px; font-weight:700; ">&bull; Dimention and Surface Quality(IS 13630, P-1)</p>
			<table align="center" width="100%" class="test" style="border: 1px solid black;" cellpadding="5px">
				<tr>
			...
			<br>
			<p style="font-size:16px; font-weight:700; ">&bull; Water Absorption:(IS 13630, P-2)</p>
			<table align="center" width="100%" class="test" style="border: 1px solid black;" cellpadding="5px">
				<tr>
					<td style="border: 1px solid black; text-align:center;"><b>SR No.</b></td>
					...
					<tr style="font-size:15px;">
						<td>
							<div style="float:left;">
								...
								<b style="font-size:15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbspChecked By:</b><br><br>
			...
			<table align="center" width="100%" class="test1" height="Auto" style="border-top:2px solid;">
				<tbody>
					...
					<tr style="font-size:10px;">
						<td style="text-align:center;"><b>Page 4 of 4</b></td>
					</tr>
				</tbody>
			</table>
		</page>
