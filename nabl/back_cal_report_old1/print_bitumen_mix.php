    ...
    <page size="A4">
        <table align="center" width="100%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				<td style="font-size:11px;border: 1px solid black;">
					<center><b>FMT-OBS-9A</b></center>
				</td>
				<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
					<center><b>OBSERVATION OF MARSHALL STABILITY, FLOW & MAX. <br>SPECIFIC GRAVITY OF BITUMINOUS MIX </b></center>
				</td>
			</tr>
		</table>
		<br>
		...
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Arial;">
				<tr>
					...
					<table width="100%" class="test1" style="border: 0;font-family: Arial;margin-bottom: 0;" height="Auto">
						<tr>
							<td style="padding: 7px 0;font-size: 13px;"><b>1)	Stability & Flow (ASTM D-6927-15)</b></td>
						</tr>
					</table>
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family: Arial;" height="Auto">
						<tr>
							<td style="border: 1px solid black;width:5%;padding: 4px 3px;"><center><b>Sr. No.</b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 4px 3px;"><center><b>Sample No.</b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 4px 3px;"><center><b>Stability (kg)</b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 4px 3px;"><center><b>Flow (mm)</b></center></td>		
						</tr>
						<tr>
							<td style="border: 1px solid black;width:5%;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['ms_11']; ?></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['ms_21']; ?></center></td>		
                            <td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['ms_31']; ?></center></td>	
						</tr>
						<tr>
							<td style="border: 1px solid black;width:5%;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['ms_12']; ?></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['ms_22']; ?></center></td>
                            <td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['ms_32']; ?></center></td>		
						</tr>
						<tr>
							<td style="border: 1px solid black;width:5%;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['ms_13']; ?></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['ms_23']; ?></center></td>
                            <td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['ms_33']; ?></center></td>			
						</tr>
						<tr>
							<td style="border: 1px solid black;width:5%;padding: 5px 5px;" colspan=2><b>Average Of Stability & Flow</b></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['avg_stabilty']; ?></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['avg_flow']; ?></center></td>			
						</tr>
						<tr>
							<td style="border: 1px solid black;width:5%;padding: 5px 5px;" colspan=2><b>Average Stability in KN</b></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['avg_stabilty']; ?></center></td>
		...
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Arial;">
				<tr>
					...
					<table width="100%" class="test1" style="border: 0;font-family: Arial;margin-bottom: 0;" height="Auto">
						<tr>
							<td style="padding:7px 0;font-size: 13px;"><b>2)	Density (CDM) Test Observation Sheet (ASTM D-2726-21)</b></td>
						</tr>
					</table>
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family: Arial;" height="Auto">
						<tr>
							<td style="border: 1px solid black;width:7%;padding: 4px 3px;"><center><b>Sr. No.</b></center></td>
							<td style="border: 1px solid black;padding: 4px 3px;"><center><b>Sample No.</b></center></td>
							<td style="border: 1px solid black;padding: 4px 3px;"><center><b>Wt. in Air (g)</b></center></td>
							<td style="border: 1px solid black;padding: 4px 3px;"><center><b>Wt. in Water (g)</b></center></td>
                            <td style="border: 1px solid black;padding: 4px 3px;"><center><b>S.S.D. Wt. (g)</b></center></td>		
                            <td style="border: 1px solid black;padding: 4px 3px;"><center><b>Volume in cc</b></center></td>
                            <td style="border: 1px solid black;padding: 4px 3px;"><center><b>Density in g/cc</b></center></td>
						</tr>
						<tr>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['s1']; ?></center></td>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['a1']; ?></center></td>		
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['b1']; ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['c1']; ?></center></td>	
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['d1']; ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['e1']; ?></center></td>
						</tr>
						<tr>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['s2']; ?></center></td>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['a2']; ?></center></td>		
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['b2']; ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['c2']; ?></center></td>	
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['d2']; ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['e2']; ?></center></td>
						</tr>
                        <tr>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['s3']; ?></center></td>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['a3']; ?></center></td>		
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['b3']; ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['c3']; ?></center></td>	
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['d3']; ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['e3']; ?></center></td>
						</tr>
						<tr>
							<td style="border: 1px solid black;padding: 5px 5px;text-align:right;" colspan=6><b>Average</b></td>
							<td style="border: 1px solid blackpadding: 2px 3px;"><center><?php echo $row_select_pipe['avg_density']; ?></center></td>			
						</tr>
					</table>
					</td>
				</tr>																					
		...
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Arial;">
				<tr>
					...
					<table width="100%" class="test1" style="border: 0;font-family: Arial;margin-bottom: 0;" height="Auto">
						<tr>
							<td style="padding:7px 0;font-size: 13px;"><b>3)	Maximum Specific Gravity (ASTM D-2041:2019)</b></td>
                            <td style="padding:7px 0;font-size: 13px;text-align:end;"><b>Temperature :- </b></td>
						</tr>
					</table>
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family: Arial;" height="Auto">
						<tr>
							<td style="border: 1px solid black;width:7%;padding: 4px 3px;"><center><b>Sr. No.</b></center></td>
							<td style="border: 1px solid black;padding: 4px 3px;"><center><b>Empty wt. of flask (g)</b></center></td>
							<td style="border: 1px solid black;padding: 4px 3px;"><center><b>Wt. of flask + water (g) </b></center></td>
							<td style="border: 1px solid black;padding: 4px 3px;"><center><b>Wt. of sample in air (g) </b></center></td>
                            <td style="border: 1px solid black;padding: 4px 3px;"><center><b>Wt. of flask + sample + water (g) </b></center></td>		
                            <td style="border: 1px solid black;padding: 4px 3px;"><center><b>Vacuum Pressure</b></center></td>
                            <td style="border: 1px solid black;padding: 4px 3px;"><center><b>Maximum Specific Gravity</b></center></td>
						</tr>
						<tr>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_a_1']; ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_b_1']; ?></center></td>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_c_1']; ?></center></td>		
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo ($row_select_pipe['sp_a_1'] + $row_select_pipe['sp_c_1']); ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_vp']; ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_1']; ?></center></td>
						</tr>
						<tr>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_a_2']; ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_b_2']; ?></center></td>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_c_2']; ?></center></td>		
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo ($row_select_pipe['sp_a_2'] + $row_select_pipe['sp_c_2']); ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_vp']; ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_2']; ?></center></td>
						</tr>
						<tr>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_a_3']; ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_b_3']; ?></center></td>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_c_3']; ?></center></td>		
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo ($row_select_pipe['sp_a_3'] + $row_select_pipe['sp_c_3']); ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_vp']; ?></center></td>
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['sp_3']; ?></center></td>
						</tr>
						
						<tr>
							<td style="border: 1px solid black;padding: 5px 5px;text-align:right;" colspan=6><b>Average</b></td>
							<td style="border: 1px solid blackpadding: 2px 3px;"><center><?php echo $row_select_pipe['avg_sp']; ?></center></td>			
						</tr>
					</table>
					</td>
				</tr>																					
		...
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Arial;">
				<tr>
					...
					<table width="100%" class="test1" style="border: 0;font-family: Arial;margin-bottom: 0;" height="Auto">
						<tr>
							<td style="padding: 7px;font-size: 13px;"><b>4) Indirect Tensile Strength of Bituminous Mix (ASTM D6931-17) </b></td>
							<td style="padding: 7px;font-size: 13px;text-align:end;"><b>Date :- &nbsp;&nbsp;<?php echo date("d - m - y",strtotime($end_date)); ?></b></td>
						</tr>
					</table>
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family: Arial;" height="Auto">
						<tr>
							<td style="border: 1px solid black;width:7%;padding: 4px 3px;"><center><b>Sr. No.</b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 4px 3px;"><center><b>Sample ID </b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 4px 3px;"><center><b>Diameter (mm)</b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 4px 3px;"><center><b>Height (mm)</b></center></td>	
							<td style="border: 1px solid black;width:20%;padding: 4px 3px;"><center><b>Max Load (N)</b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 4px 3px;"><center><b>Indirect Tensile Strength (kP<sub>a</sub>)</b></center></td>		
						</tr>
						<tr>
							<td style="border: 1px solid black;width:5%;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['avg_dia1']; ?></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['avg_len1']; ?></center></td>						
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['spl_load1']; ?></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['spl_str1']; ?></center></td>		
						</tr>
						<tr>
							<td style="border: 1px solid black;width:5%;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['avg_dia2']; ?></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['avg_len2']; ?></center></td>						
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['spl_load2']; ?></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['spl_str2']; ?></center></td>		
						</tr>
						<tr>
							<td style="border: 1px solid black;width:5%;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['avg_dia3']; ?></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['avg_len3']; ?></center></td>						
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['spl_load3']; ?></center></td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['average']; ?></center></td>		
						</tr>
                        <tr>
							<td colspan=5 style="border: 1px solid black;width:5%;padding: 2px 3px;text-align:right;"><b>Average</td>
							<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><?php echo $row_select_pipe['spl_avg1']; ?></center></td>	
						</tr>
					</table>
					</td>
				</tr>																					
        ...
        <table align="center" width="100%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				<td style="font-size:11px;border: 1px solid black;">
					<center><b>FMT-OBS-9B</b></center>
				</td>
				<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
					<center><b>BINDER CONTENT</b></center>
				</td>
			</tr>
		</table>
        <br><br>
        ...
        <table align="center" width="100%" class="test">
			<tr>
				<td style="font-size: 16px;font-weight: bold;padding-bottom:13px;" colspan="3">Binder Content (IRC SP-112 2017)</td>
			</tr>
            <tr>
				<td style="font-size: 16px;padding-bottom: 10px;" colspan="3">Percentage Binder on the total mix</td>
			</tr>
            
			<tr>
               <td>=&nbsp;&nbsp;<span style="border-bottom:1px solid;padding-bottom: 3px;">W1 - (W2 + W3) + W4</span><br><p style="text-align:center;width: 125px; margin-top: 6px;">W1</p></td>
                 <td>=&nbsp;&nbsp; <span style="border-bottom:1px solid;padding-bottom: 3px;"><?php if ($row_select_pipe['b31'] != "" && $row_select_pipe['b31'] != null && $row_select_pipe['b51'] != "" && $row_select_pipe['b51'] != null && $row_select_pipe['b61'] != "" && $row_select_pipe['b61'] != null && $row_select_pipe['b71'] != "" && $row_select_pipe['b71'] != null) {echo substr(($row_select_pipe['b31'] - ($row_select_pipe['b51'] + $row_select_pipe['b61']) + $row_select_pipe['b71']) / ($row_select_pipe['b31']),0,5);} else { echo " <br>";} ?> W &nbsp;&nbsp;</span><br>&nbsp;</td>
                <td style="width:25%">=&nbsp;&nbsp; <span style="border-bottom:1px solid;padding-bottom: 3px;width: 50%;"><?php if ($row_select_pipe['b31'] != "" && $row_select_pipe['b31'] != null && $row_select_pipe['b51'] != "" && $row_select_pipe['b51'] != null && $row_select_pipe['b61'] != "" && $row_select_pipe['b61'] != null && $row_select_pipe['b71'] != "" && $row_select_pipe['b71'] != null) {echo substr(($row_select_pipe['b31'] - ($row_select_pipe['b51'] + $row_select_pipe['b61']) + $row_select_pipe['b71']) / ($row_select_pipe['b31']),0,5);} else { echo " <br>";} ?>&nbsp; W &nbsp;&nbsp;</span><br>&nbsp;</td>
            </tr>
		</table>
        <br><br>
        ...
        <table align="center" width="100%" class="test1" height="9%">
			...
			<tr style="border: 1px solid black;">
				<td colspan="3" style="border-left:1px solid;width:25%;text-align:left;padding:7px; 4px"><b>&nbsp; Where,</b></td>
			</tr>
			<tr style="border: 1px solid black;">
				<td style="border-left:1px solid;width:50%;text-align:left;padding:7px; 4px;"><b>&nbsp; W1 = Weight of sample</b></td>
				<td style="border-left:1px solid;width:50%;text-align:left;padding:7px; 4px;">&nbsp; <?php if ($row_select_pipe['b31'] != "" && $row_select_pipe['b31'] != "0" && $row_select_pipe['b31'] != null) {
			...
			<tr style="border: 1px solid black;">
				<td style="border-left:1px solid;text-align:left;padding:7px; 4px;"><b>&nbsp; W2 = Weight of the sample after extraction </b></td>
				<td style="border-left:1px solid;text-align:left;padding:7px; 4px;">&nbsp; <?php if ($row_select_pipe['b51'] != "" && $row_select_pipe['b51'] != "0" && $row_select_pipe['b51'] != null) {
            ...
            <tr style="border: 1px solid black;">
				<td style="border-left:1px solid;text-align:left;padding:7px; 4px;"><b>&nbsp; W3 = Weight of fine material, recovered from the extract</b></td>
				<td style="border-left:1px solid;text-align:left;padding:7px; 4px;">&nbsp; <?php if ($row_select_pipe['b61'] != "" && $row_select_pipe['b61'] != "0" && $row_select_pipe['b61'] != null) {
			...
			<tr style="border: 1px solid black;">
				<td style="border-left:1px solid;text-align:left;padding:7px; 4px;"><b>&nbsp; W4 = increase in weight of the filter ring</b></td>
				<td style="border-left:1px solid;text-align:left;padding:7px; 4px;">&nbsp; <?php if ($row_select_pipe['b71'] != "" && $row_select_pipe['b71'] != "0" && $row_select_pipe['b71'] != null) {
		...
		<table align="center" width="100%" class="test1" style="margin-bottom: 20px;" Height="20%">
