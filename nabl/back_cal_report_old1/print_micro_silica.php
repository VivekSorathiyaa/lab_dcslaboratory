	...
	<body>
		...
		<table align="center" width="94%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				...
				<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR Microsilica</b></center>
				</td>
			</tr>
		</table>
		<br><br>
		...
		<table align="center" width="94%" class="test1" height="9%">
			<tr style="border: 1px solid black;">
				<td colspan="3" style="border-left:1px solid;width:25%;text-align:left;padding:6px 3px;"><b>&nbsp; Details of samples &nbsp; &nbsp; : &nbsp; &nbsp; &nbsp;<?php echo $detail_sample;?></b></td>
			</tr>
			<tr style="border: 1px solid black;">
			...
			<tr style="border: 1px solid black;">
				...
				<td style="border-left:1px solid;text-align:left;padding:6px 3px;"><b>&nbsp; Sample Receive Date</b></td>
			...
			<tr style="border: 1px solid black;">
				...
				<td style="border-left:1px solid;text-align:left;padding:6px 3px;"><b>&nbsp; Starting Date</b></td>
				<td style="border-left:1px solid;text-align:left;padding:6px 3px;">&nbsp; <?php echo date("d - m - y",strtotime($start_date)); ?></td>
			</tr>
			<tr style="border: 1px solid black;">
				<td style="text-align:center;padding:6px 3px;"><b>4</b></td>
				<td style="border-left:1px solid;text-align:left;padding:6px 3px;"><b>&nbsp; Completion Date</b></td>
				<td style="border-left:1px solid;text-align:left;padding:6px 3px;">&nbsp; <?php echo date("d - m - y",strtotime($end_date)); ?></td>
			</tr>
		</table>
		<br><br>
		...
		<table align="center" width="94%" class="test1" height="Auto" style="border-top:2px solid;">
			<tbody>
				<tr style="">
					<td style="width:25%;padding-top:3px;">
						<center>Amendment No.: 01</center>
					</td>
					<td style="width:25%;padding-top:3px;">
						<center>Amendment Date: 01.04.2023</center>
					</td>
					<td style="width:16.67%;padding-top:3px;">
				...
				<tr style="font-size:15px;">
					<td>
						<div style="float:left;">
							<b style="font-size:15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tested By: </b><br><br><br><br>
							<b style="font-size:15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Checked By:</b><br><br><br><br>
