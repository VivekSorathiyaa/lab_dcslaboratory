...
<body>
	...
	<page size="A4">
		<table align="center" width="94%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				...
				<td style="font-size:12px;border: 1px solid black;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR TEST ON HALF CELL POTENTIAL (ASTM C876)</b></center>
				</td>
			</tr>
		</table>
		<br>
		...
		<table align="center" width="94%" cellspacing="0" cellpadding="0" style="font-size:13px;font-family: Arial;border:1px solid;">
				<?php $cnt = 1; ?>
						<tr style="">
