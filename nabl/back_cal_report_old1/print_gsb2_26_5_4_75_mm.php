...
<body>
	...
	$select_query = "select * from job,city WHERE city.id = job.client_city AND `trf_no`='$trf_no' AND `jobisdeleted`='0'";
	...
	<page size="A4">
		<table align="center" width="95%" cellspacing="0" cellpadding="0" style="height:60%;font-size:13px;font-family: Book Antiqua;border:2px solid black;">
			...
			<tr>
				...
				<td>
					<table align="left" width="100%" border="0px" cellspacing="0" cellpadding="0" class="test" style="">
						...
						<tr>
							...
							<td colspan="2" style="width:49%;vertical-align:top">
								<table align="top" width="100%" class="test" style="height:100%;width:100%;">
									...
									<tr>
										<td colspan="3" style="text-align:center;border:1px solid black;border-left:0px solid black;"><b>IS 2386-1963-RA 2011: P-1</b></td>
									</tr>
									<tr>
							...
							<td colspan="3" style="width:49%;vertical-align:top">
								<table align="top" width="100%" class="test" style="height:100%;width:100%;">
									...
									<?php
									if ($row_select_pipe['combined_index'] != "") {
									?>
										<tr>
									...
									if ($row_select_pipe['fines_value'] != "") {
									?>
										<tr>
									...
									if ($row_select_pipe['liquide_limit'] != "") {
									?>
										<tr>
						...
						<tr>
							<?php
							if ($row_select_pipe['alk_10'] != "") {
							?>
								<td colspan="6" style="width:100%">
									<table align="center" width="100%" class="test" style="height:100%;width:100%;">
										<tr>
											<td colspan="3" style="text-align:left;border:1px solid black;border-right:0px solid black;"><b></b></td>
			...
			<tr>
				...
				<td style="text-align:center;border-top:1px solid black;"><b>&#8226;&#8226; End of the Report &#8226;&#8226;</b></td>
			</tr>
			<tr>
				<td>
