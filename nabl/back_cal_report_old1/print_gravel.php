...
<body>
	...
	<page size="A4">
		<table align="center" width="94%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				...
				<td style="font-size:12px;border: 1px solid black;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR TEST ON GRAVEL</b></center>
				</td>
			</tr>
		</table>
		<br>
		...
		<table align="center" width="94%" class="test1" style="border: 1px solid black;" height="Auto">
		...
		<table align="center" width="94%" class="test1" style="border: 1px solid black;border-top:0px;" height="Auto">
			<tr style="border: 0px solid black;">
		...
		<table align="center" width="94%" class="test1" style="border: 0px solid black;" height="18.5%">
		...
		<table align="center" width="94%" class="test1" height="Auto" style="border-top:2px solid;">
			...
			<tr>
				<td style=""><center>Page 1 of 6</center></td>
		...
		<table align="center" width="94%" class="test1" style="" height="18.5%">
			<tr style="border: 1px solid black;height:20px;">
		...
		<table align="center" width="94%" class="test1" height="Auto" style="border-top:2px solid;">
			...
			<tr>
				<td style=""><center>Page 2 of 6</center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
		...
		<table align="center" width="94%" class="test1" style="" height="50%">
				<tr style="border: 1px solid black;">
		...
		<table align="center" width="94%" class="test1" height="Auto" style="border-top:2px solid;">
			...
			<tr>
				<td style=""><center>Page 3 of 6</center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
...
<br>
		...
		<table align="center" width="94%" class="test1" style="" height="40%">
			<tr style="border: 1px solid black;">
				<td style="border: 0px solid black;border-right: 1px solid black;padding:7px 7px;"><b>Test - 9</b></td>
				<td colspan="3" style="border: 0px solid black;padding:7px 7px;"><b>Soundness</b></td>
				<td colspan="2" style="text-align:right;border: 0px solid black;padding-right:20px;padding:7px 7px;"><b>IS 2386 Part-5</b></td>
			</tr>
		...
		<table align="center" width="94%" class="test1" style="border: 1px solid black;border-top: 0px solid black;" height="Auto">
			<tr>
				<td colspan="8" style="border: 0px solid black;text-align:left;font-size:10px;padding:7px 7px;"><b>Note :- A repeat test shall be run if the load does not produce % of fines within tha range 7.5 to 12.5.</b></td>
		...
		<table align="center" width="94%" class="test1" height="Auto" style="border-top:2px solid;">
			...
			<tr>
				<td style=""><center>Page 4 of 6</center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
		...
		<table align="center" width="94%" class="test1" style="" height="Auto">
			<tr>
		...
		<table align="center" width="94%" class="test1" height="Auto" style="border-top:2px solid;">
			...
			<tr>
				<td style=""><center>Page 5 of 6</center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
		...
		<table align="center" width="94%" class="test1" height="Auto" style="border-top:2px solid;">
			...
			<tr>
				<td style=""><center>Page 6 of 6</center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
				<td style=""><center></center></td>
