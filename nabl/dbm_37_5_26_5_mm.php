			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">37.5 - 26.5 MM</h2>
					</div>
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM dbm_37_5_26_5_mm WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_dbm_37_5_26_5_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>

												<?php } ?>
												<div class="col-sm-2">
													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=dbm_37_5_26_5_mm" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from dbm_37_5_26_5_mm WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		function sou_auto() {
			...
			var soundness = randomNumberFromRange(0.50, 1.50);
			...
			var s_temp1 = (+s_65) * 100;
			var s_temp2 = (+s_66) * 100;

			var s_35 = $('#s35').val();
			var s_36 = $('#s36').val();
			var s55 = (+s_temp1) / (+s_35);
			var s56 = (+s_temp2) / (+s_36);

			$('#s55').val(s55.toFixed(1));
			$('#s56').val(s56.toFixed(1));
			var s_55 = $('#s55').val();
			var s_56 = $('#s56').val();
			...
			var stemp1 = (+s_35) * (+s_55);
			var stemp2 = (+s_36) * (+s_56);
			var s6_5 = (+stemp1) / 100;
			var s6_6 = (+stemp2) / 100;

			$('#s65').val(s6_5.toFixed(2));
			$('#s66').val(s6_6.toFixed(2));
			var s_6_5 = $('#s65').val();
			var s_6_6 = $('#s66').val();
			var s6total_1 = (+s_6_5) + (+s_6_6);
		...
		$('#s55,#s35,#s56,#s36').change(function() {
			$('#txtsou').css("background-color", "var(--success)");
			var s_35 = $('#s35').val();
			var s_36 = $('#s36').val();
			var s_55 = $('#s55').val();
			var s_56 = $('#s56').val();
			var s_temp1 = (+s_35) * (+s_55);
			var s_temp2 = (+s_36) * (+s_56);
			var s65 = (+s_temp1) / 100;
			var s66 = (+s_temp2) / 100;
			$('#s65').val(s65.toFixed(2));
			$('#s66').val(s66.toFixed(2));
		...
		function imp_auto() {
			...
			var imp_value4 = randomNumberFromRange(12.00, 16.00);
		...
		function crush_auto() {
			...
			var cru_value = randomNumberFromRange(19.0, 24.0).toFixed(1);
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_dbm_37_5_26_5_mm.php',
