...
if (isset($_POST['action_type']) && !empty($_POST['action_type'])) {
	if ($_POST['action_type'] == 'data') {
		$get_query = "select * from span_brick_fly WHERE id='$_POST[id]' AND `is_deleted`='0'";
		...
		$insert = "INSERT INTO `span_brick_fly`(`report_no`,`ulr`, `job_no`, `lab_no`, `status`, `created_by`, `created_date`, `modified_by`, `modified_date`, `is_deleted`, `deleted_by`, `checked_by`, `chk_dim`, `no_of_brick`, `id_mark`, `temp1`, `dim_length`, `dim_width`, `dim_height`,`dim_length1`, `dim_width1`, `dim_height1`,`avg_length`, `avg_width`, `avg_height`, `chk_wtr`,`avg_wtr`, `wtr_lab_1`, `wtr_lab_2`, `wtr_lab_3`, `wtr_lab_4`, `wtr_lab_5`, `wtr_w1_1`, `wtr_w1_2`, `wtr_w1_3`, `wtr_w1_4`, `wtr_w1_5`, `wtr_w2_1`, `wtr_w2_2`, `wtr_w2_3`, `wtr_w2_4`, `wtr_w2_5`, `wtr_1`, `wtr_2`, `wtr_3`, `wtr_4`, `wtr_5`, `chk_com`, `avg_com`, `con_grade`, `com_lab_1`, `com_lab_2`, `com_lab_3`, `com_lab_4`, `com_lab_5`, `com_l_1`, `com_l_2`, `com_l_3`, `com_l_4`, `com_l_5`, `com_b_1`, `com_b_2`, `com_b_3`, `com_b_4`, `com_b_5`, `com_h_1`, `com_h_2`, `com_h_3`, `com_h_4`, `com_h_5`, `com_area_1`, `com_area_2`, `com_area_3`, `com_area_4`, `com_area_5`, `com_load_1`, `com_load_2`, `com_load_3`, `com_load_4`, `com_load_5`, `com_1`, `com_2`, `com_3`, `com_4`, `com_5`, `chk_efflo`, `rbt_efflo1`, `rbt_efflo2`, `rbt_efflo3`, `rbt_efflo4`, `rbt_efflo5`, `remarks`,`amend_date`,`s_des`,`r_sam`,`s_ret`)  VALUES ('$report_no','$ulr','$job_no','$lab_no','0','$_SESSION[name]','$curr_date','','0000-00-00','0','','','$chk_dim','$no_of_brick','$id_mark','$temp1','$dim_length','$dim_width','$dim_height','$dim_length1','$dim_width1','$dim_height1','$avg_length','$avg_width','$avg_height','$chk_wtr','$avg_wtr','$wtr_lab_1','$wtr_lab_2','$wtr_lab_3','$wtr_lab_4','$wtr_lab_5','$wtr_w1_1','$wtr_w1_2','$wtr_w1_3','$wtr_w1_4','$wtr_w1_5','$wtr_w2_1','$wtr_w2_2','$wtr_w2_3','$wtr_w2_4','$wtr_w2_5','$wtr_1','$wtr_2','$wtr_3','$wtr_4','$wtr_5','$chk_com','$avg_com','$con_grade','$com_lab_1','$com_lab_2','$com_lab_3','$com_lab_4','$com_lab_5','$com_l_1', '$com_l_2','$com_l_3','$com_l_4','$com_l_5','$com_b_1','$com_b_2','$com_b_3','$com_b_4','$com_b_5','$com_h_1','$com_h_2','$com_h_3','$com_h_4','$com_h_5','$com_area_1','$com_area_2','$com_area_3','$com_area_4','$com_area_5','$com_load_1','$com_load_2','$com_load_3','$com_load_4','$com_load_5','$com_1','$com_2','$com_3','$com_4','$com_5','$chk_efflo','$rbt_efflo1','$rbt_efflo2','$rbt_efflo3','$rbt_efflo4','$rbt_efflo5','$remarks','$amend_date','$s_des','$r_sam','$s_ret')";
			...
			<div class="row">
				<div class="col-lg-12">
					<table border="1px solid black" align="center" width="100%" id="aaaa">
						...
						<?php
						$query = "select * from `span_brick_fly` WHERE lab_no='$lab_no' and `is_deleted`='0'";
...
<?php
		...
		$update = "update span_brick_fly SET `job_no`='$_POST[job_no]',`ulr`='$_POST[ulr]',`lab_no`='$_POST[lab_no]',`report_no`='$_POST[report_no]',
		...
		$delete = "update span_brick_fly SET `is_deleted`='1',`deleted_by`='$_SESSION[name]' WHERE `report_no`='$_POST[report_no]' and `lab_no`='$_POST[lab_no]' and `job_no`='$_POST[job_no]'";
		...
		$qry = "SELECT * FROM span_brick_fly WHERE `id`='$_POST[id]'";
		$arr = mysqli_query($conn, $qry);
		$rows1 = mysqli_num_rows($arr);
		while ($r2 = mysqli_fetch_array($arr)) {
			if ($r2['checked_by'] != "") {
				$c1c = "update span_brick_fly SET `checked_by`='' WHERE `id`='$_POST[id]'";
				$result_of_delete1 = mysqli_query($conn, $c1c);
			} else {
				$cc = "update span_brick_fly SET `checked_by`='$_SESSION[name]' WHERE `id`='$_POST[id]'";
