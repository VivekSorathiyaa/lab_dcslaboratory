			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">Pozzolonic Cement</h2>
					</div>
					<div class="box-default">
						<form class="form" id="Glazed" method="post">
							...
							<div class="row m-0">
								...
								<div class="col-lg-6">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-2 control-label">Type Of Pozzolonic :</label>
										<div class="col-sm-2">
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<div class="col-sm-2">
											...
											<?php
											$querys_job1 = "SELECT * FROM pozzolonic_cement WHERE `is_deleted`='0' and lab_no='$lab_no'";
										...
										?>
											<div class="col-sm-3">
												<a target='_blank' href="<?php echo $base_url; ?>print_report/print_pozzolonic_cement.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info" id="btn_report" name="btn_report"><b>Report</b></a>
										...
										<?php } ?>
										<div class="col-sm-3">
											<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_pozzolonic_cement.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
											<!--<a target = '_blank' href="<? php // echo $base_url; 
														...
														<div class="panel-body">
															...
															<div class="row">
																...
																<div class="col-lg-3">
																	<div class="form-group">
																		<div class="col-sm-12">
																			<label for="inputEmail3" class="col-sm-2 control-label">Weight of water (gm/ml)</label>
																		</div>
																	</div>
																</div>
																<div class="col-lg-3">
														...
														<div class="panel-body">
															...
															<div class="row">
																...
																<div class="col-lg-4">
																	<div class="form-group">
																		<div class="col-sm-12">
																			<label for="inputEmail3" class="control-label">SPECIFIC GRAVITY (P ) = --------------------------- =</label>
																		</div>
																	</div>
																</div>
																<div class="col-lg-2">
												...
												<div class="row">
													<div class="col-lg-12">
														<table border="1px solid black" align="center" width="100%" id="aaaa">
															...
															<?php
															$query = "select * from pozzolonic_cement WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_pozzolonic_cement.php',
