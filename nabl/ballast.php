                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h2 style="text-align:center;">BALLAST</h2>
                        </div>
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="col-sm-2 control-label">53 mm</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="col-sm-2 control-label">45 mm</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="col-sm-2 control-label">22.4 mm</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="col-sm-2 control-label">11.2 mm</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="col-sm-2 control-label">0.600 mm</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="col-sm-2 control-label">0.075 mm</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-2">
                                                        ...
                                                        <?php
                                                        $querys_job1 = "SELECT * FROM ballast WHERE `is_deleted`='0' and lab_no='$lab_no'";
                                                    ...
                                                    ?>
                                                        <div class="col-sm-2">
                                                            <a target='_blank' href="<?php echo $base_url; ?>print_report/print_ballast.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

                                                        </div>

                                                    <?php// } ?>
                                                    <div class="col-sm-2">
                                                        <a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_ballast.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=ballast" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <table border="1px solid black" align="center" width="100%" id="aaaa">
                                                        ...
                                                        <?php
                                                        $query = "select * from ballast WHERE lab_no='$aa'  and `is_deleted`='0'";
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function mdd_auto() {
                var mdd = randomNumberFromRange(2.31, 2.34).toFixed(2);
                $('#mdd').val(mdd);
            ...
            function omc_auto() {
                var omc = randomNumberFromRange(5.50, 5.70).toFixed(2);
                $('#omc').val(omc);
            ...
            function cbr_auto() {
                var cbr = randomNumberFromRange(28.0, 33.0).toFixed(1);
                $('#cbr').val(cbr);
            ...
            function sp_auto() {
                ...
                var sp_specific_gravity = randomNumberFromRange(2.810, 2.860).toFixed(3); //(sp_specific_gravity)
                ...
                var sp_water_abr = randomNumberFromRange(0.80, 1.00).toFixed(2); // (sp_water_abr)_1
            ...
            function general_flk_elo1() {
                $('#txtflk').css("background-color", "var(--success)");
                var combined_index = randomNumberFromRange(15.0, 24.0).toFixed(1);
                ...
                var suma = randomNumberFromRange(62000, 68000).toFixed();
                $('#suma').val(suma);
                var sum_a = $('#suma').val();
                ...
                $('#dd5').val(dd5.toFixed());
                var dd_5 = $('#dd5').val();
                var dd6 = (+sum_dd) - ((+dd_2) + (+dd_3) + (+dd_4) + (+dd_5));
                $('#dd6').val(dd6.toFixed());
                var dd_6 = $('#dd6').val();
                //var dd7 = (+sum_dd) * 0.21;
                //$('#dd7').val(dd7.toFixed());
            ...
            function grd_auto() {
                ...
                var pass_sample_2 = randomNumberFromRange(95.00, 99.50).toFixed(2);
                var pass_sample_3 = randomNumberFromRange(65.00, 79.98).toFixed(2);
                ...
                var cum_ret_1 = randomNumberFromRange(2, 5);
                var cum_ret_2 = 100 - (+pass_sample_2);
                //var cum_ret_3 = 100-(+pass_sample_3);
                var cum_ret_3 = (+pass_sample_3);
                ...
                alert(100 - cum_ret_1);
                $('#pass_sample_1').val(100 - cum_ret_1);
                $('#pass_sample_2').val(100 - cum_ret_2);
                $('#pass_sample_3').val(100 - cum_ret_3);
        ...
        function saveMetal(type, id) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo $base_url; ?>save_ballast.php',
                data: billData,
                dataType: 'JSON',
