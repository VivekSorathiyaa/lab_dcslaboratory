            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h2 style="text-align:center;">CONCRETE CORE</h2>
                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                        ...
                                        <?php
                                        $querys_job1 = "SELECT * FROM concrete_core WHERE `is_deleted`='0' and lab_no='$lab_no'";
                                    ...
                                    ?>
                                    <div class="col-sm-2">
                                        <a target='_blank' href="<?php echo $base_url; ?>print_report/print_concrete_core.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
                                    </div>
	<!--								<div class="col-sm-2">
 													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report_blank/print_concrete_core.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&ulr=<?php echo $ulr; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Calculation Blank</b></a>
...
-->
                                    ...
                                    ?>
                                    <div class="col-sm-2">
                                        <a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_concrete_core.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
                                            ...
                                            <div id="collapse_com" class="panel-collapse collapse">
                                                <div class="panel-body">
													...
													<div class="row">
                                                        <div class="col-md-0">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" id='road_no' name='road_no'>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-0">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" id='Chainage' name='Chainage'>
                                                            </div>
                                                        </div>
														...
														<div class="col-md-0">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" id='bic_1' name='bic_1'>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-1">
                                                            <div class="form-group">
                                                                <label for="inputEmail3" class="control-label text-center">Length of core after capping/grinding (mm)	</label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
														...
														<div class="col-md-0">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" id='length1' name='length1'>
                                                            </div>
                                                        </div>
                                                        
														<div class="col-md-0">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" id='width1' name='width1'> 
                                                            </div>
                                                        </div>
                                                    ...
                                                    <br>
                                                     <div class="row">
                                                        ...
                                                        <div class="col-md-1">
                                                            <div class="form-group">
                                                                <label for="inputEmail3" class="control-label text-center">Max Load (kN)</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-1">
                                                            <div class="form-group">
                                                                <label for="inputEmail3" class="control-label text-center">CF for Dia 75±5 = 1.03 <70 = 1.06</label>
                                                            </div>
                                                        </div>
                                                        <!--<div class="col-md-1">
                                                            <div class="form-group">
                                                    ...
                                                    <br>
                                                     <div class="row">
														<div class="col-md-0">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" id='vol1' name='vol1'disabled>
                                                            </div>
                                                        </div>
														<div class="col-md-0">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" id='den1' name='den1'>
                                                            </div>
                                                        </div>
														<div class="col-md-0">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" id='den2' name='den2'disabled>
                                                            </div>
                                                        </div>
														<div class="col-md-1">
                                                            <div class="form-group">
                                                        ...
                                                        <div class="col-md-1">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" id='hd_corr1' name='hd_corr1'>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label for="inputEmail3" class="control-label text-center">CF F=0.11N+0.78</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label for="inputEmail3" class="control-label text-center">Equiv. Cube Strength (N/mm2) = (CF x 1.25)</label>
                                                            </div>
                                                        </div>
                                                        <!--<div class="col-md-2">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control startdate_class" id='casting_date' name='casting_date'>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <input type="hidden" class="form-control" id='age1' name='age1'>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-lg-12">
                                            <table border="1px solid black" align="center" width="100%" id="aaaa">
                                                <tr>
                                                    ...
                                                    <th style="text-align:center;width:10%;"><label>Job No.</label></th>
                                                ...
                                                <?php
                                                $query = "select * from concrete_core WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
    ...
    // Volume (in m³) = Area × Height / 1,000,000,000
    var vol1 = (area1 * height1) / 1000000000;
    $('#vol1').val(vol1.toFixed(5));

    // Density (in g/cm³) = (Weight in kg) / (Volume in m³)
    var den1 = (weight1 / 1000) / vol1;
    $('#den1').val(den1.toFixed(1));

    // Compressive Strength = (Load × 1000) / Area
    var com1 = (load1 * 1000) / area1;
    $('#com1').val(com1.toFixed(2));

    // hd_corr1 = 0.11 × hd_ratio1 + 0.78
    var hd_corr1 = (0.11 * hd_ratio1) + 0.78;
    $('#hd_corr1').val(hd_corr1.toFixed(3));
    ...
    function getGlazedTiles() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo $base_url; ?>save_concrete_core.php',
