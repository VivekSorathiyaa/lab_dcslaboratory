...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper job-invert-register-box" style="margin-left: 0px !important;">
					...
					<div class="tab-content">
						...
						<form class="" method="post" >
							<div class="row">
										...
										<div class="col-md-3">	
											<button type="button" class="btn btn-info"  onclick="search_data('search_data')" name="btn_add_data1" id="btn_add_data1" style="width:100%" ><i class="fa fa-search" aria-hidden="true" style="margin-right:3px;"></i>&nbsp;Search</button>
										</div>
										<div class="col-md-3">	
											<button type="button" class="btn btn-info"  onclick="search_data('all_data')" name="btn_add_data" id="btn_add_data" style="width:100%" ><i class="fa fa-database" aria-hidden="true" style="margin-right:4px;"></i>&nbsp;View All</button>
										</div>		
							</div>
							</form>
						</div>
...
function search_data(type,id){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php $base_url; ?>search_inward_register_for_rec.php',
        data: billData,
		beforeSend: function(){
		document.getElementById("overlay_div").style.display="block";
		},		
