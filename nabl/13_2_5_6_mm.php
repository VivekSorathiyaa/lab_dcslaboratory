			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">13.20 - 5.6 MM</h2>
					</div>
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM mss_13_2_5_6_mm WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_mss_13_2_5_6_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>

												<?php// } ?>
												<div class="col-sm-2">
													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=mss_13_2_5_6_mm" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from mss_13_2_5_6_mm WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save13_2_5_6_mm.php',
