						...
						<div id="display_data_report">
								...
								<tbody>
									...
									?>
											...
											<a href="delete_work.php?trf_no=<?php echo $row['trf_no'];?>&&job_no=<?php echo $row['job_number'];?>&&temporary_trf_no=<?php echo $row['temporary_trf_no'];?>" class="btn btn-danger">
...
$(".search_job_by_qm").click(function()
{
	...
	if(search_trf_no =="" && search_sam_date =="")
	{
		...
		$.ajax({
			url : "<?php echo $base_url; ?>search_list_of_completed_job_report_for_deleter.php",
			type: "POST",
			data : postData,
			beforeSend: function(){
