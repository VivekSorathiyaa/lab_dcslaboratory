...
<section class="content" style="padding: 0px;
     ...
     padding-right: 0px; ">
			...
			<div class="col-md-4">
			<h1 style="">
			<a  class="btn btn-info" href="add_purchage.php" title="ADD PURCHASE" style="margin-left:10px;">ADD PURCHASE IN</a>
			</h1>
			</div>
			<div class="col-md-3">
			<h1 style="text-align:center;">Purchase In List</h1>
			</div>
			</div>
...
function search_data(type,id){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php $base_url; ?>search_purchage.php',
        data: billData,
		beforeSend: function(){
							...
							success: function(data,status,  xhr)
							 {
								...
								window.location.href="purchage_list.php";
