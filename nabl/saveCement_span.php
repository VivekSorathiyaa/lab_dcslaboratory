...
if (isset($_POST['action_type']) && !empty($_POST['action_type'])) {
	if ($_POST['action_type'] == 'data') {
		$get_query = "select * from span_cement WHERE id='$_POST[id]' AND `is_deleted`='0'";
		...
		$fill = array(
			...
			'final_wtr' => $result['final_wtr'],
			'com_humidity_2' => $result['com_humidity_2'],
			'set_con' => $result['set_con'],
			'set_humidity2' => $result['set_humidity2'],
			'initial_s' => $result['initial_s'],
			'initial_f' => $result['initial_f'],
			...
			'fin_8' => $result['fin_8'],
			'fin_9' => $result['fin_9'],
			'fin_10' => $result['fin_10'],
			'fin_11' => $result['fin_11'],
			'fin_12' => $result['fin_12'],
			'fin_13' => $result['fin_13'],
			'fin_14' => $result['fin_14'],
			'fin_15' => $result['fin_15'],
			'fin_16' => $result['fin_16'],
			'fin_17' => $result['fin_17'],
			'fin_18' => $result['fin_18'],
			'fin_19' => $result['fin_19'],
			'fin_20' => $result['fin_20'],
			'fin_21' => $result['fin_21'],
			'fin_22' => $result['fin_22'],
			'fin_23' => $result['fin_23'],
		...
		$final_wtr = $_POST['final_wtr'];
		$com_humidity_2 = $_POST['com_humidity_2'];
		$set_con = $_POST['set_con'];
		$set_humidity2 = $_POST['set_humidity2'];

		$initial_s = $_POST['initial_s'];
		$initial_f = $_POST['initial_f'];
		$final_s = $_POST['final_s'];
		$final_f = $_POST['final_f'];
			...
			<div class="row">
				<div class="col-lg-12">
					<table border="1px solid black" align="center" width="100%" id="aaaa">
						...
						<?php
						$query = "select * from `span_cement` WHERE lab_no='$lab_no' and `is_deleted`='0'";
...
<?php
		...
		$update = "update span_cement SET `job_no`='$_POST[job_no]',`lab_no`='$_POST[lab_no]',`report_no`='$_POST[report_no]',
		...
		$delete = "update span_cement SET `is_deleted`='1',`deleted_by`='$_SESSION[name]'WHERE `report_no`='$_POST[report_no]' and `lab_no`='$_POST[lab_no]' and `job_no`='$_POST[job_no]'";
		...
		$qry = "SELECT * FROM span_cement WHERE `id`='$_POST[id]'";
		$arr = mysqli_query($conn, $qry);
		$rows1 = mysqli_num_rows($arr);
		while ($r2 = mysqli_fetch_array($arr)) {
			if ($r2['checked_by'] != "") {
				$c1c = "update span_cement SET `checked_by`='' WHERE `id`='$_POST[id]'";
				$result_of_delete1 = mysqli_query($conn, $c1c);
			} else {
				$cc = "update span_cement SET `checked_by`='$_SESSION[name]' WHERE `id`='$_POST[id]'";
