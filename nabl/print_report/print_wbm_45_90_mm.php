...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from wbm_90_45_mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
...
<?php } ?>
      ...
      <table align="center" width="95%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;">
        ...
        <tr>
            ...
            <td style="border-right: 1px solid;border-bottom: 1px solid;padding: 2px 5px;">WATER BOUND MACADAM</td>
        ...
        <tr>
            ...
            <td style="border-bottom: 1px solid;padding: 2px 5px;">WBM GRADING - 1 </td>
		</tr>
        <tr>
