	...
	<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:60px;border: 1px solid;border: bottom: 0;">
		<tr>
			<td>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;">
					<tr>
						<td style="text-transform: uppercase;font-weight: bold;text-decoration: underline;text-align: center;font-size: 13px;padding: 2px 0;border-bottom: 1px solid;"  colspan="4">Test Report - COMPRESSIVE STRENGTH OF ACCELERATED CONCRETE CUBES</td>
					</tr>
					<tr>
		...
		<tr>
			...
			<tr>
				...
				<tr style="">
					<td>
						<table cellpadding="0" cellpadding="0" align="center" width="100%" style="" class="test">
							<tr>
								<td style="font-size:12px;font-weight:bold;text-align:left;border-left:2px solid; border-right:2px solid;font-family:Times New Roman;">A) Concrete Cube Test Result...</td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td>
						<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-bottom:0px solid;border-right:1px solid;border-left:1px solid;">
							...
							<tr>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:right;font-weight:bold;padding:5px 4px; border-bottom: 0px solid black; " colspan="8">Average=</td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px; border-bottom: 0px solid black; "><?php echo $row_select_pipe['acc_avg1']; ?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px; border-bottom: 0px solid black;"><?php echo $row_select_pipe['acc_r28'];?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px; border-right:1px solid black; border-bottom: 0px solid black;"><?php echo substr(((((($row_select_pipe['fwet1']) / (($row_select_pipe['dl1'] * $row_select_pipe['dw1']) / 1000000))) + (($row_select_pipe['fwet2']) / (($row_select_pipe['dl2'] * $row_select_pipe['dw2']) / 1000000)) + (($row_select_pipe['fwet3']) / (($row_select_pipe['dl3'] * $row_select_pipe['dw3']) / 1000000))) / 3),0,7); ?></td>
							</tr>
