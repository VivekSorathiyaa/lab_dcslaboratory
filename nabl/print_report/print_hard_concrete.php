		...
		<tr>
			<td>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;">
					<tr>
						<td style="text-transform: uppercase;font-weight: bold;text-decoration: underline;text-align: center;font-size: 13px;padding: 2px 0;border-bottom: 1px solid;"  colspan="4">Test Report - HARD CONCRETE</td>
					</tr>
					<tr>
				...
				<tr style="">
					<td>
						<table cellpadding="0" cellpadding="0" align="center" width="100%" style="" class="test">
							<tr>
								<td style="font-size:13px;font-weight:bold;text-align:left;font-family:Times New Roman; border-right:2px solid; border-left:2px solid;">1. Compressive strength of concrete cubes</td>
							</tr>
						</table>
					</td>
				</tr>
					...
					<td>
						<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri; border-bottom:0px solid;border-right:1px solid;border-left:1px solid;">
							...
							<tr style="">
								...
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Age Of Test <br> (days)</td>
								...
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Weight <br> Spee. <br> (kg)</td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Max.Load <br> at Failure. <br> (kN)</td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Comp <br> Strength <br> R <sub>a</sub> <br> (N/mm<sup>2</sup>)</td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Estimated <br> Compressive <br> strength R <sub>29</sub> <br> (N/mm<sup>2</sup>)</td>
								<td style="border-right:1px solid;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Sample <br> Density <br> (Kg/m<sup>2</sup>)</td>
							</tr>

							<tr>
								<td style="border-right:0px solid;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">1</td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Sample-1</td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;" rowspan="3"><?php echo date('d/m/Y', strtotime($casting_date)); ?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"rowspan="3"></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;" rowspan="3">Accelerated <br> Curing as per <br> IS 9013- <br> 1978 </td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;" rowspan="3"></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"><?php echo $row_select_pipe['acc_w1']; ?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"><?php echo $row_select_pipe['acc_load1']; ?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"><?php echo $row_select_pipe['acc_com1']; ?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px; border-right:1px solid black;"></td>
							</tr>

							<tr>
								<td style="border-right:0px solid;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">2</td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Sample-2</td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"><?php echo $row_select_pipe['acc_w2']; ?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"><?php echo $row_select_pipe['acc_load2']; ?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"><?php echo $row_select_pipe['acc_com2']; ?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px; border-right:1px solid black;"></td>
							</tr>

							<tr>
								<td style="border-right:0px solid;border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">3</td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Sample-3</td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"><?php echo $row_select_pipe['acc_w3']; ?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"><?php echo $row_select_pipe['acc_load3']; ?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"><?php echo $row_select_pipe['acc_com3']; ?></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px; border-right:1px solid black;"></td>
							</tr>
							...
							<tr>
								...
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px; border-bottom: 0px solid black;"></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px; border-bottom: 0px solid black;"></td>
								<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px; border-right:1px solid black; border-bottom: 0px solid black;"></td>
							</tr>
							...
							?>
								...
								<tr style="">
									<td style="border-bottom:0px solid black;border-left: 1px solid black;border-top: 1px solid black;text-align:right;padding:5px 4px;font-weight:bold;" colspan=11>Average</td>
									<td style="border-bottom:0px solid black;border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['avg_com_s_1']; ?></td>
									<td style="border-right:1px solid;border-bottom:0px solid black;border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"></td>
								</tr>

								<tr>
									<td style="font-size:11px;text-align:left;padding-top:4px;border-bottom:0px;" colspan=13>&raquo; &nbsp; <span style="font-weight:bold;font-size:11px;">Remark</span> :- The Average of Three Sample Values Shall be taken as the Representative of the Batch provided the individual variation is not more than &plusmn; 15% of the Average. Otherwise repeat tests shall be made per IS 516-Clause-5.6</td>
								</tr>
