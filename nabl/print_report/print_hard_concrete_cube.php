...
*/
    ...
    <page size="A4">
        <table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:60px;border: 1px solid;">
            <tr>
                <td>
                    <table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;">
                        <tr>
                            <td style="text-transform: uppercase;font-weight: bold;text-decoration: underline;text-align: center;font-size: 13px;padding: 2px 0;border-bottom: 1px solid;" colspan="4">Test Report - COMPRESSIVE STRENGTH OF HARDENED CONCRETE CUBES</td>
                        </tr>
                        <tr>
                ...
                <td>
                    <table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;border-top: 0;border-bottom: 0;">
                        ...
                        <tr>
                            ...
                            <td style="border-bottom: 1px solid;padding: 0 2px;border-left: 1px solid;text-align: left;" colspan="3">&nbsp;<?php echo $ans['grade1']; ?></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="padding: 1px 0;" colspan="4"></td>
                        </tr>
                    </table>
        ...
        <tr style="">
            <td>
                <table cellpadding="0" cellpadding="0" align="center" width="100%" style="" class="test">
                    <tr>
                        <td style="font-size:13px;font-weight:bold;text-align:left;font-family:Times New Roman;border-right:2px solid; border-left:2px solid black;">1. Compressive strength of concrete cubes</td>
                    </tr>
                </table>
            </td>
        </tr>
            ...
            <td>
                <table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;border-right:1px solid; border-left:1px solid black;">
                    ...
                    <tr style="">
                        ...
                        <td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Length (mm)</td>
                        <td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Width (mm)</td>
                        <td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">Height (mm)</td>
                    ...
                    <?php
                    $select_tilesy = "select * from hard_concrete_cube WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
                    ...
                    ?>
                        ...
                        <tr style="">
                            ...
                            <td rowspan=3 style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['grade1']; ?></td>
                            ...
                            <td style="border-right:1px solid;border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php if ($ans['mass_1'] != '' && $ans['mass_1'] != 0 && $ans['mass_1'] != null) {
                        ...
                        <tr style="">
                            ...
                            <td style="border-right:1px solid;border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php if ($ans['mass_2'] != '' && $ans['mass_2'] != 0 && $ans['mass_2'] != null) {
                        ...
                        <tr style="">
                            ...
                            <td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select_pipe['comp_3']; ?><?php echo $row_select_pipe['mass_3']; ?></td>
                            <td style="border-right:1px solid;border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php if ($ans['mass_3'] != '' && $ans['mass_3'] != 0 && $ans['mass_3'] != null) {
                        ...
                        <tr>
                            <td style="font-size:11px;text-align:left;padding-top:4px;border-left:1px solid black; border-right: 1px solid black;" colspan=13>&raquo; &nbsp; <span style="font-weight:bold;font-size:11px; ">Remark</span> :- The Average of Three Sample Values Shall be taken as the Representative of the Batch provided the individual variation is not more than &plusmn; 15% of the Average. Otherwise repeat tests shall be made per IS 516-Clause-5.6</td>
                        </tr>
        ...
        <tr>
            <td>
                <table cellpadding="0" cellpadding="0" align="center" width="100%" style="" class="test">
                    <tr>
                        <td style="font-size:11px;text-align:left;font-weight:bold;padding:5px 0 5px;font-family:Times New Roman;border-right:2px solid; border-left:2px solid black;"> Requirement as per IS 456 : 2000 Table No.2 (Clause 6.1 , 9.2.2, 15.1.1 , and 36.1)</td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="width:100%;vertical-align:top">
                <table align="top" width="100%" class="test" style="font-family : Calibri;font-size:11px; border-right:2px solid; border-left:2px solid black;">
                    ...
                    <tr>
                        <td style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:5px 0;">Accepted Strength on 28 days of curing for Nominal Mix, N/mm<sup>2</sup></td>
        ...
        <tr>
            <td>
                <table cellpadding="0" cellpadding="0" align="center" width="100%" style="" class="test">
                    <tr>
                        <td style="font-size:11px;text-align:left;font-weight:bold;font-family:Times New Roman;border-right:2px solid; border-left:2px solid black;">M-10 is a Nominal Mix Concrete</td>
                    </tr>
                </table>
            </td>
        </tr>
