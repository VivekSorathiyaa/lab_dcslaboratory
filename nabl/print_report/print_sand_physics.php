...
<page size="A4">
    ...
    <table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:12.7px;font-family : Calibri;margin-top:80px;border-bottom:0px solid black;">
			<tr>
			...
			<tr>
				<table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;">
					<tr style="">
			...
			<tr>
				<td>
					<table align="center" width="92%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;">
			...
			<tr>
				<td>
					<table align="center" width="92%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;padding: 14px 0;">
						<tr>
					...
					<td style="text-align:center;font-size:11px; ">
						<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;border-top:1px solid;border-right:1px solid;">
							...
							<tr style="">
								...
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:70%;text-align:left; ">&nbsp;&nbsp; IS-2386:1963   (Part-I,Part-II,Part-IV)</td>
							</tr>
		...
		<?php $cnt = 1; ?>
			<!-- <tr>
				<td style="text-align:center;font-size:12px; ">
					<table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:12px;font-family : Calibri;border-bottom:1px solid;border-right:1px solid;border-top:1px solid;">
			...
			<?php if ($row_select_pipe['pass_sample_1'] != "" && $row_select_pipe['pass_sample_1'] != "0") { ?>
				<tr>
					<td>
						<table align="center" width="92%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;margin-top:20px;margin-bottom:4px;font-weight:bold;">
							<tr>
								<td>A) Sieves Analysis (IS:2386-1-1963)</td>
							</tr>
						</table>
					</td>
					<!--<td style="font-size:11px;padding-top:3px;"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sample Taken&nbsp;&nbsp;&nbsp;</b><? php // echo $row_select_pipe['sample_taken'];																											?><b>&nbsp;&nbsp;gm</b></td>-->
				</tr>
				...
				<tr>
					<!--OTHER START-->
					<td>
						<table align="center" width="92%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;margin-bottom:20px;max-width:540px;margin-left:35px;border:1px solid;">
				...
				<tr>
					<td>
						<table align="center" width="92%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;">
							<tr>
			...
			?>
				...
				<tr>
					<td>
						<table align="center" width="92%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;border-bottom:1px solid; margin-bottom:20px;max-width:450px;margin-left:31px;">
							<tr style="text-align:center;">
