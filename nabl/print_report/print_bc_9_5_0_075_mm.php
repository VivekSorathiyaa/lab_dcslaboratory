...
<?php } ?>
 ...
 <table  style="width: 95%;font-family: 'Calibri';font-size:12px;border: 1px solid;border-bottom:0px solid;text-align: left;" cellspacing="0" cellpadding="0" align="center">
	   ...
	   <?php } ?>	
				...
				<table align="center" width="95%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri; padding-top:20px;border-bottom: 1px solid;">
	...
	<br>
            ...
            <tr>
                <td style="padding: 0 10px;border-top: 1px solid;" colspan="5"><i><b> Remarks: - </b>The Sample Confirms to IS 516 (Part 4) 2018: w.r.t above test only</i></td>
            </tr>
            <tr>
