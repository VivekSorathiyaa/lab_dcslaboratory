...
<br>
	...
	<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border: 1px solid;border-top: 0;">
			<tr>
				<td  colspan="5"  style="border: 1px solid black; font-weight:bold; text-align:left;">TEST RESULT</td>	
			...
			<tr>
				<td style="border: 1px solid black;text-align:center;"></td>	
				<td style="border: 1px solid black;">&nbsp;&nbsp; 12.5 mm </td>	
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"> (18% when tested with MgSo<sub>4</sub>)</td>
				<?php }else {?>
				<td style="border: 1px solid black;text-align:center;"> (12% when tested with Na<sub>2</sub>So<sub>4</sub>)</td>
				<?php }?>
			</tr>
			<?php }if($row_select_pipe['combined_index'] != "" && $row_select_pipe['combined_index'] != "0" && $row_select_pipe['combined_index'] != null){?>
			<tr>
				<td style="border: 1px solid black;text-align:center;"><?php $cnt++; echo $cnt;?></td>	
				...
				<td style="border: 1px solid black;text-align:center;"> Maximum 40% (Combine) </td>	
			</tr>
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center; font-weight:bold;"> <?php if($row_select_pipe['dele_2_3']!="" && $row_select_pipe['dele_2_3']!=null && $row_select_pipe['dele_2_3']!="0"){
			...
			<tr>
				...
				<td  colspan="2" style="text-align:center;border:1px solid black; font-weight:bold;"><?php if($row_select_pipe['alk_1']!="" && $row_select_pipe['alk_1']!=null && $row_select_pipe['alk_1']!="0"){?>
					
					<select style="font-weight:bold;border:0px;font-size:11px;" onchange="put_details()" id="abc">
			...
			<tr>
				...
				<td style="border: 1px solid black;text-align:center;"> IS 2386: 1963 <br> Part-7 <br> </td>	
				<td style="border: 1px solid black;text-align:center; font-weight:bold;"> <?php if($row_select_pipe['avg_clr'] != "" && $row_select_pipe['avg_clr'] != "0" && $row_select_pipe['avg_clr'] != null){ echo $row_select_pipe['avg_clr']; } else{ echo "-";}?></td>	
				<td style="border: 1px solid black;text-align:center;"> - </td>	
			</tr>
			<?php }if($row_select_pipe['avg_sul'] != "" && $row_select_pipe['avg_sul'] != "0" && $row_select_pipe['avg_sul'] != null){?>
			<tr>
				<td style="border: 1px solid black;text-align:center;"><?php $cnt++; echo $cnt;?></td>	
				<td style="border: 1px solid black;">&nbsp;&nbsp; Sulphate Content (%)</td>	
				<td style="border: 1px solid black;text-align:center;"> IS 2386: 1963 <br> Part-7 <br> </td>	
			...
			<tr>
				<td style="border: 1px solid black;text-align:center;"><?php $cnt++; echo $cnt;?></td>	
				<td style="border: 1px solid black;">&nbsp;&nbsp; Stripping Value (%)</td>	
				<td style="border: 1px solid black;text-align:center;"> IS 6241 -1971 </td>	
				<td style="border: 1px solid black;text-align:center; font-weight:bold;"> <?php if($row_select_pipe['strip_per'] != "" && $row_select_pipe['strip_per'] != "0" && $row_select_pipe['strip_per'] != null){ echo $row_select_pipe['strip_per']; } else{ echo "-";}?></td>	
				<td style="border: 1px solid black;text-align:center;"> - </td>	
			</tr>
			<?php }?>
		</table>
