...
<body>
	...
	<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:60px;border: 1px solid;border: bottom: 0;">
		<tr>
			<td>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;">
					<tr>
						<td style="text-transform: uppercase;font-weight: bold;text-decoration: underline;text-align: center;font-size: 13px;padding: 2px 0;border-bottom: 1px solid;"  colspan="4">Test Report - MECHANICAL PROPERTIES OF COARSE AGGREGATE (METAL)</td>
					</tr>
					<tr>
		...
		<tr>
			...
			<tr>
				<td>
					<table align="left" width="100%" border="0px" cellspacing="0" cellpadding="0" class="test" style="border-left:2px solid; border-right:2px solid;">
						<tr>
						...
						<tr>
							...
							<td colspan="2" style="width:100%;display:flex;">
								<table align="top"  class="test" style="width:82%;max-width:450px;font-family : Calibri; ">
									...
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:5px 0;">80 mm</td>
							...
							<td colspan="4" style="width:100%;">
									<table align="center" width="100%" class="test" style="height:80%;font-size:11px;font-family : Calibri;border-bottom:1px solid;">
									<tr>
											<td>
										...
										?>
											<tr>
												...
												<td style="font-size:11px;border-left: 1px solid black;border-top:1px solid black;border-right:0px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Test Results</td>
											</tr>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['combined_index']; ?></td>
												</tr>
									   ...
									   <td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center; ">I.S 2386-4</td>
													<td style="border-left: 1px solid black;border-right: 0px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;"><?php echo $row_select_pipe['imp_value']; ?></td>
												</tr>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;font-weight:bold;"><?php echo $row_select_pipe['sp_specific_gravity']; ?></td>
												</tr>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">IS 2386-3</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;font-weight:bold;"><?php echo $row_select_pipe['sp_water_abr']; ?></td>
												</tr>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">--</td>
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">IS 2386-3</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;font-weight:bold;"><?php echo $row_select_pipe['bdl']; ?></td>
												</tr>
									   ...
									   <table style="border-collapse: collapse;width:100%;">
										 ...
										 <tr>
											<td style="border-right: 1px solid black;font-size:11px;text-align:center;width:50%;padding:5px 4px;">For other than <br> Wearing Surface</td>
													...
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;font-weight:bold;"><?php echo $row_select_pipe['cru_value']; ?></td>
												</tr>
									   ...
									   <table style="border-collapse: collapse;width:100%;">
										 ...
										 <tr>
											...
											<td style="font-size:11px;text-align:center;width:50%;padding:5px 0;">Max 50%</td>
													...
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">IS 2386-4</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;font-weight:bold;"><?php echo $row_select_pipe['abr_index']; ?></td>
												</tr>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">--</td>
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">IS 2386-4</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;font-weight:bold;"><?php echo $row_select_pipe['fines_value']; ?></td>
												</tr>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;font-weight:bold;"><?php echo $row_select_pipe['soundness']; ?></td>
												</tr>
										<?php
											}
										}
							...
							?>
								<td colspan="6" style="width:100%">
									<table align="center" width="100%" class="test" style="height:100%;width:100%;">
										<tr>
											<td colspan="3" style="text-align:center;border:1px solid black;border-right:0px solid black;font-weight:bold;padding:10px 4px; border-left:0px;"><b>Test Name</b></td>
											...
											<td style="text-align:center;border:1px solid black;border-right:1px solid black;font-weight:bold;padding:10px 4px;border-right:0px solid black;"><b>Test Results</b></td>
										</tr>

										<tr>
											<td colspan="3" style="text-align:center;border:1px solid black;border-right:0px solid black;padding:5px 4px; border-left:0px; border-bottom:0px;"><b>III) Alkali Reactivity Test (Gravimetric Method)</b></td>
											<td style="text-align:center;border:1px solid black;border-right:0px solid black;border-bottom:0px;">--</td>
											<td style="text-align:center;border:1px solid black;border-right:0px solid black;border-bottom:0px;">IS 2386-7</td>
											<td style="text-align:center;border:1px solid black;border-right:1px solid black;fonr-weight:bold;border-right:0px solid black;border-bottom:0px;"><?php echo $row_select_pipe['alk_10']; ?></td>
										</tr>
									</table>
								</td>
							<?php
