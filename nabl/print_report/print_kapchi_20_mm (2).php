...
<body>
	...
	<page size="A4">
		...
		<table align="center" width="100%" class="test" style="font-size:11px;font-family : Calibri;">
			<tr>
				<?php if (($row_select_pipe['pass_sample_1'] != "") && ($row_select_pipe['pass_sample_1'] != null) && ($row_select_pipe['pass_sample_1'] != "0")) { ?>
					<td width="50%" style="vertical-align:top;">
						<table align="top" width="95%" class="test" style="font-size:11px;font-family : Calibri;">
							<tr>
							...
							<tr>
								<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">40 mm</td>
							...
							<tr>
								<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">20 mm</td>
								...
								<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">85-100</td>
							</tr>
							<tr>
								<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">10 mm</td>
								...
								<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">0-20</td>
							</tr>
							<tr>
								...
								<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">0-5</td>
							</tr>
						</table>
					</td>
				<?php } ?>
				...
				?>
					<td width="50%" style="vertical-align:top;">
						<table align="top" width="100%" class="test" style="font-size:11px;font-family : Calibri;">
							<tr>
							...
							?>
								<tr>
									...
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Max. 40%</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">IS 2386-1</td>
							...
							?>
								<tr>
									...
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">Max. 30%</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-4</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['imp_value']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-3</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['sp_specific_gravity']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">Max. 2%</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-3</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['sp_water_abr']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">Max. 30%</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-4</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['cru_value']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									<td style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Abrasion Value %</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">Max. 30%</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-4</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['abr_index']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">--</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-3</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['bdl']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">--</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-4</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['fines_value']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								...
								<tr>
									<td style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Liquid Limit %</td>
									<td rowspan="3" style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">Max 25%</td>
									<td rowspan="3" style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2720-5</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['liquide_limit']; ?></td>
								</tr>
								<tr>

									<td style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Plastic Limit %</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['plastic_limit']; ?></td>
								</tr>
								<tr>

									<td style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Plasticity Index %</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['pi_value']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">Max. 12%</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-5</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['soundness']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									<td style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Deleterius Material</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">Max. 2%</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-2</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['avg_dtm']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									<td style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Organic Impurities</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">-</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-2</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['avg_org']; ?></td>
								</tr>
							<?php
							}
							?>
			...
			?>
				<tr>
					<td colspan="2">
						<table align="center" width="100%" class="test" style="font-size:11px;font-family : Calibri;padding-top:5px;">
							<tr>
							...
							?>
								<tr>
									<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Alkali Reactivity Test (Gravimetric Method)</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">--</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-7</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['alk_10']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Total of percentages of all deleterious Materials<br>(except mica), %</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">Max. 2%</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-1,2</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php
							...
							?>
								<tr>
									...
									<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Coal &amp; Lignite, %</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">Max. 1%</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-2</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php
							...
							?>
								<tr>
									...
									<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Clay &amp; Lumps, %</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">Max. 1%</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-2</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['dele_2_3']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Soft Particles, %</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">-</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-2</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['dele_4_3']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Material Finer than 75&mu;, %</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">Max. 1%</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-1</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['dele_1_4']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Organic Impurities</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">-</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2386-2</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php
							...
							?>
								<tr>
									...
									<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">pH</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">-</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2720-26</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['avg_ph']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Sulphate, %</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">-</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">IS 2720-27</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['avg_sul']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Cloride Content, %</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">-</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">BS EN 1744-1</td>
									<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['avg_clr']; ?></td>
								</tr>
							<?php } ?>
						</table>
					</td>
