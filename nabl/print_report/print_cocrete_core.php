...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from cocrete_core WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id`";
...
*/
	...
	<page size="A4">
		...
		<table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:80px;">
		    <tr>
			...
			<tr>
				<td style="text-align:center; font-size:15px;padding-bottom:15px; text-decoration: underline; text-underline-offset: 3px;"><b>Equivalent Cube Strength of Concrete Core</b></td>
			</tr>


			<tr>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;padding-bottom:6px;">
					<tr style="">
					...
					<tr style="">
						...
						<td style="width:6%;padding-bottom: 4px;text-align: center;"> &raquo;</td>
						<td style="width:40%;text-align:left;padding-bottom: 4px;"><?php echo $sample_id;?></td>
			...
			<tr>
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;border-collapse: inherit;padding-top:14px;padding-bottom:14px;">
			...
			<tr>
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;border-collapse: inherit;padding:4px 0;margin-bottom:6px;">
					    <tr>
							...
							<td style="width:21%;padding-bottom: 4px;text-align:right;">Date of Latter</td>
							<td style="width:6%;padding-bottom: 4px;text-align: center;"> &raquo;</td>
							<td style="width:40%;padding-bottom: 4px;"><?php if ($row_select["date"] != "" && $row_select["date"] != "null" && $row_select["date"] != "0000-00-00") {echo date('d/m/Y', strtotime($row_select["date"]));}?></td>
						</tr>
						...
						<tr>
							...
							<td style="width:6%;text-align: center;padding-bottom: 4px;">&raquo;</td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;"><?php echo date('d/m/Y', strtotime($end_date)); ?></td>
						...
						<tr>
							...
							<td style="width:6%;text-align: center;">&raquo;</td>
							<td style="width:40%;font-size: 10px;text-align:left;"><?php echo $row_select_pipe['cc_grade']; ?></td>
			...
			<tr>
				<td style="text-align:center;font-size:11px; ">
					...
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;border-top:1px solid;">
						...
						<?php
						$select_tilesy = "select * from cocrete_core WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id` LIMIT " . $down . "," . $up;
		...
		<?php $cnt = 1; ?>
			<tr>
				<td style="text-align:center;font-size:11px;">
				    <table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;border-right:1px solid;margin-top:20px;">
						...
						?>
							<tr style="">
								...
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%; text-align:center;"><?php if ($row_select_pipe['dia_1'] != "" && $row_select_pipe['dia_1'] != null && $row_select_pipe['dia_1'] != "0") {
																														echo $row_select_pipe['dia_1'];
																													} else {
																														echo "-";
																													} ?> </td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%;text-align:center; "><?php echo $row_select_pipe['len_1']; ?></td>
								...
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:4.33%;text-align:center;"><?php if ($row_select_pipe['load_1'] != "" && $row_select_pipe['load_1'] != null && $row_select_pipe['load_1'] != "0") {
																														echo $row_select_pipe['load_1'];
																													} else {
																														echo "-";
																													} ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:4.33%;text-align:center"><?php if ($row_select_pipe['com_1'] != "" && $row_select_pipe['com_1'] != null && $row_select_pipe['com_1'] != "0") {
																														echo $row_select_pipe['com_1'];
																													} else {
																														echo "-";
																													} ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%;text-align:center;"><?php if ($row_select_pipe['ccc_1'] != "" && $row_select_pipe['ccc_1'] != null && $row_select_pipe['ccc_1'] != "0") {
																														echo $row_select_pipe['ccc_1'];
																													} else {
																														echo "-";
																													} ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%;text-align:center;"><?php if ($row_select_pipe['ecs_1'] != "" && $row_select_pipe['ecs_1'] != null && $row_select_pipe['ecs_1'] != "0") {
							...
							<tr style="">
								...
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%; text-align:center;"><?php if ($row_select_pipe['dia_2'] != "" && $row_select_pipe['dia_2'] != null && $row_select_pipe['dia_2'] != "0") {
																														echo $row_select_pipe['dia_2'];
																													} else {
																														echo "-";
																													} ?> </td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%;text-align:center; "><?php echo $row_select_pipe['len_2']; ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8%;text-align:center; "></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:4.33%;text-align:center;"></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:4.33%;text-align:center;"><?php if ($row_select_pipe['load_2'] != "" && $row_select_pipe['load_2'] != null && $row_select_pipe['load_2'] != "0") {
																														echo $row_select_pipe['load_2'];
																													} else {
																														echo "-";
																													} ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:4.33%;text-align:center"><?php if ($row_select_pipe['com_2'] != "" && $row_select_pipe['com_2'] != null && $row_select_pipe['com_2'] != "0") {
																														echo $row_select_pipe['com_2'];
																													} else {
																														echo "-";
																													} ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%;text-align:center;"><?php if ($row_select_pipe['ccc_2'] != "" && $row_select_pipe['ccc_2'] != null && $row_select_pipe['ccc_2'] != "0") {
																														echo $row_select_pipe['ccc_2'];
																													} else {
																														echo "-";
																													} ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%;text-align:center;"><?php if ($row_select_pipe['ecs_2'] != "" && $row_select_pipe['ecs_2'] != null && $row_select_pipe['ecs_2'] != "0") {
							...
							<tr style="">         
								...
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%; text-align:center;"><?php if ($row_select_pipe['dia_3'] != "" && $row_select_pipe['dia_3'] != null && $row_select_pipe['dia_3'] != "0") {
																														echo $row_select_pipe['dia_3'];
																													} else {
																														echo "-";
																													} ?> </td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%;text-align:center; "><?php echo $row_select_pipe['len_3']; ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8%;text-align:center; "></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:4.33%;text-align:center;"></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:4.33%;text-align:center;"><?php if ($row_select_pipe['load_3'] != "" && $row_select_pipe['load_3'] != null && $row_select_pipe['load_3'] != "0") {
																														echo $row_select_pipe['load_3'];
																													} else {
																														echo "-";
																													} ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:4.33%;text-align:center"><?php if ($row_select_pipe['com_3'] != "" && $row_select_pipe['com_3'] != null && $row_select_pipe['com_3'] != "0") {
																														echo $row_select_pipe['com_3'];
																													} else {
																														echo "-";
																													} ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%;text-align:center;"><?php if ($row_select_pipe['ccc_3'] != "" && $row_select_pipe['ccc_3'] != null && $row_select_pipe['ccc_3'] != "0") {
																														echo $row_select_pipe['ccc_3'];
																													} else {
																														echo "-";
																													} ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%;text-align:center;"><?php if ($row_select_pipe['ecs_3'] != "" && $row_select_pipe['ecs_1'] != null && $row_select_pipe['ecs_3'] != "0") {
							...
							<tr>
								<td style="font-size:11px;text-align:right;border-top:1px solid black;padding:5px 4px;border-left:1px solid black;border-right:1px solid black;" colspan=9>Average :</td>
								<td style="font-size:11px;text-align:center;border-top:1px solid black;padding:5px 4px;"><?php echo $row_select_pipe['avg_com_s_1']; ?></td>
                            </tr>
					...
					<!-- <table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;border-top:1px solid;margin-top:20px;">
			...
			<tr>
				<table cellpadding="0" cellpadding="0" align="center" width="92%" style="font-size:11px;font-family : Calibri;" class="test">
					<tr>
            ...
            <tr>
				...
				<td style="text-align:center;font-size:11px;">
					<table align="center" width="100%" class="test" style="height:auto;font-family : Calibri;border-top:1px solid black;border-bottom:1px solid black;">
						...
						<tr>
							<td style="font-size:11px;padding:3px 0;"> 1. &nbsp; Correction Factor foe Equivalent Cylinder Strength of is considered as per IS : 516 (Part-4) 2018.</td>
						</tr>
						<tr>
							<td style="font-size:11px;padding:3px 0;"> 2. &nbsp; Core Strength Shall Be Considered acceptable if the average equivalent cubical strength of the cores is equal to at least 85% of the equivalent cube strength of the grade of concrete and no individual core has a less than 75% strength as per IS : 456.</td>
						</tr>
						<tr>
							<td style="font-size:11px;padding:3px 0;"> 3. &nbsp; Results are issued with specific understanding that Manglam Consultancy Service will not be in any case involed in action following the interpretation of the results.</td>
						</tr>
						<tr>
							<td style="font-size:11px;padding:3px 0;"> 4. &nbsp; The Results are not supposed to be used for publicity & Legal Purpose.</td>
						</tr>
						<tr>
							<td style="font-size:11px;width:50%;padding:3px 0;"> 5. &nbsp;The results are given for the sample submitted by the Customer/Agency</td>
							<td style="text-align:center;width:15%;font-style:italic;font-size:11px;"><b>Reviewed & Authorized By</b></td>
						</tr>
						<tr>
							<td style="font-size:11px;padding:3px 0;"> 6. &nbsp;The results are given on sample submitted in Lab by Customer/Agency only.</td>
							<td></td>
						</tr>
						<tr>
							<td style="font-size:11px;padding:3px 0;">7. &nbsp;*As informed by Customer/Agency.</td>
							<td></td>
						</tr>
						<tr>
            ...
            <table width="95%" align="center" style="font-family:Times New Roman;font-size:11px;">
						<tr>
