                        ...
                        <tr style="display:flex; ">
							...
							<table align="top" width="100%" class="test" style="max-width:400px;font-size:11px;font-family : Calibri;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right: 2px solid black;">100</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right: 2px solid black;">40-75</td>
                                    </tr>
									<tr>
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:2px 4px;">5.6 mm</td>
                                        ...
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right: 2px solid black;">0-20</td>
                                    </tr>
									<tr>
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:2px 4px;">2.8 mm</td>
                                        ...
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right: 2px solid black;">0-5</td>
                                    </tr>
                                    <tr>
