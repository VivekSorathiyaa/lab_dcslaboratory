                        ...
                        <tr style="display:flex; ">
							...
							<table align="top" width="100%" class="test" style="max-width:400px;font-size:11px;font-family : Calibri;">
										...
										<tr>
											<td style="text-align:center;border:1px solid black;border-left:0px solid black;padding:5px 4px;"> Sieve Size</td>
												...
												<td style="border-right:2px solid black;">
													<table style="width:100%;border-collapse: collapse;">
														<tr>
															<td style="font-size:11px;text-align:center;border-bottom:0px solid black;padding:5px 4px;">% of Passing</td>
														</tr>
													</table>
											    </td>
										</tr>
                                    <tr>
                                        ...
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:2px solid black;"><?php echo $row_select_pipe['cum_ret_1']; ?></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:2px solid black;"><?php echo $row_select_pipe['cum_ret_2']; ?></td>
                                    </tr>
									<tr>
                                        ...
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:2px solid black;"><?php echo $row_select_pipe['cum_ret_3']; ?></td>
                                    </tr>
									<tr>
                                        ...
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:2px solid black;"><?php echo $row_select_pipe['cum_ret_4']; ?></td>
                                    </tr>
									<tr>
                                        ...
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:2px solid black;"><?php echo $row_select_pipe['cum_ret_5']; ?></td>
                                    </tr>
                                    <tr>
											...
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;border-right:2px solid black;">--</td>
										</tr>
                                </table>
                            </td>
