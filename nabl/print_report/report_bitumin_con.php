...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from bitumin_con WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id`";
    ...
    <tr>
        ...
        <td style="padding:2px;text-align: left;" colspan="4"><b>&nbsp; : &nbsp;</b><?php echo $row_select_pipe['eq_cube1']?></td>
			...
			<?php
						// $select_tilesy = "select * from bitumin_con WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id`";
			...
			<tr>
				...
				<td>
					<table align="center" width="100%" class="test" style="border: 1px solid black;font-size:11px;" cellpadding="3px">
						...
						<?php
						$total_data = 0;
						$select_tiles_query = "select * from bitumin_con WHERE `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
						$result_tiles_select = mysqli_query($conn, $select_tiles_query);
