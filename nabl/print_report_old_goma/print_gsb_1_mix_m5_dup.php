								...
								<td colspan="2" style="width:49%;vertical-align:top">
									<table align="top" width="100%" class="test" style="height:100%;width:100%;">
										...
										<tr>
											...
											<td style="text-align:center;border:1px solid black;border-left:0px solid black;">80-100</td>
										</tr>
										<tr>
											...
											<td style="text-align:center;border:1px solid black;border-left:0px solid black;">55-90</td>
										</tr>
										<tr>
											...
											<td style="text-align:center;border:1px solid black;border-left:0px solid black;">35-65</td>
										</tr>
										<tr>
											...
											<td style="text-align:center;border:1px solid black;border-left:0px solid black;">25-55</td>
										</tr>
										<tr>
											...
											<td style="text-align:center;border:1px solid black;border-left:0px solid black;">20-40</td>
										</tr>
										<tr>
											...
											<td style="text-align:center;border:1px solid black;border-left:0px solid black;">10-55</td>
										</tr>
										<tr>
											...
											<td style="text-align:center;border:1px solid black;border-left:0px solid black;">&lt; 5</td>
										</tr>
					...
					<td>
						<table align="left" width="100%" border="0px" cellspacing="0" cellpadding="0" class="test" style="">
							<tr>
								...
								<td colspan="6" style="width:49%"><b>(II) Other Tests</b></td>
							...
							<tr>
								...
								<td colspan="3" style="width:49%;vertical-align:top">
									<table align="top" width="100%" class="test" style="height:100%;width:100%;">
										...
										?>
											<tr>
												<td colspan="2" style="text-align:center;border:1px solid black;border-right:0px solid black;"><b>Test Name</b></td>
											...
											?>
												<tr>
													...
													<td colspan="2" style="text-align:left;border:1px solid black;border-right:0px solid black;">Maximum Dry Density gm/cc</td>
											...
											?>
												<tr>
													...
													<td colspan="2" style="text-align:left;border:1px solid black;border-right:0px solid black;">Optimum Moisture Content %</td>
											...
											?>
												<tr>
													...
													<td colspan="2" style="text-align:left;border:1px solid black;border-right:0px solid black;">California Bearing Ratio %</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Min. 30</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2720-16</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['cbr']; ?></td>
												</tr>
