					...
					<table align="left" width="100%" border="0px" cellspacing="0" cellpadding="0" class="test" style="">
						...
						<tr>
							...
							<td colspan="4" style="width:100%;">
									<table align="center" width="92%" class="test" style="height:100%;font-size:10px;font-family: Cambria;border-bottom:1px solid;margin-right:30px;margin-bottom:20px;margin-top:20px;">
									<tr>
											<td>
										...
										?>
											...
											?>
									            ...
									            <table style="width:100%;border-collapse: collapse;">
													...
													<td style="text-align:center;border:1px solid black;border-right:1px solid black;">
															<table style="width:100%;border-collapse: collapse;">
															<tr>
																<td style="font-size:10px;font-weight:bold;text-align:center;border-bottom:1px solid black;padding:5px 4px;"><?php echo $row_select_pipe['combined_index']; ?></td>
															</tr>
															<tr style="">
																<td style="font-size:10px;font-weight:bold;text-align:center;padding:5px 4px;"></td>
															</tr>
														</table>
												</td>
												</tr>
								...
								<td colspan="6" style="width:100%">
									<table align="center" width="100%" class="test" style="height:100%;width:100%;">
										<tr>
											...
											<td style="text-align:center;border:1px solid black;border-right:0px solid black;font-weight:bold;padding:10px 4px;"><b>Test Results</b></td>
										</tr>
										...
										<tr>
											...
											<td style="text-align:center;border:1px solid black;border-right:0px solid black;fonr-weight:bold;"><?php echo $row_select_pipe['alk_10']; ?></td>
										</tr>
									</table>
								</td>
							<?php
