							...
							<td colspan="2" style="width:49%;vertical-align:top">
								<table align="top" width="100%" class="test" style="height:100%;width:100%;">
									...
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">10-30</td>
									...
									?>
										...
										?>
											...
											<tr>
												...
												<td style="text-align:Left;border:1px solid black;border-right:0px solid black;">--</td>
