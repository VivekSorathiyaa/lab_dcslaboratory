...
<body>
	...
	<page size="A4">
		...
		<table align="center" width="92%" class="test" style="font-size:12.7px;font-family: Arial;margin-left:45px;margin-top:-1px;margin-right:15px;border:1px solid black;">
			<tr>
				<?php if (($row_select_pipe['pass_sample_1'] != "") && ($row_select_pipe['pass_sample_1'] != null) && ($row_select_pipe['pass_sample_1'] != "0")) { ?>
					<td width="50%" style="vertical-align:top;">
						<table align="top" width="95%" class="test" style="">
							<tr>
								<td style="" colspan="3"><b>&nbsp;&nbsp;Sieves Analysis</b></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="text-align:center;border:1px solid black;border-left:0px solid black;">10 mm</td>
				...
				?>
					...
					<td width="50%" style="vertical-align:top;">
						<table align="top" width="100%" class="test" style="height:100%;width:100%;">
							<tr>
								<td style="" colspan="4"><b>&nbsp;&nbsp; Other Tests</b></td>
							</tr>
							<tr>
							...
							?>
								<tr>
									<td style="text-align:left;border:1px solid black;border-right:0px solid black;">Deleterius Material</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Max. 2%</td>
							...
							?>
								<tr>
									<td style="text-align:left;border:1px solid black;border-right:0px solid black;">Organic Impurities</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">-</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2386-2</td>
			...
			?>
				<tr>
					<td colspan="2">
						<table align="center" width="100%" class="test" style="">
							<tr>
								<td colspan="6" style="">&nbsp; <b>Chemical Test</b></td>
							</tr>
							<tr>
								<td colspan="3" style="text-align:center;border:1px solid black;border-right:0px solid black; border-left:0px solid black;"><b>Test Name</b></td>
							...
							?>
								<tr>
									<td colspan="3" style="text-align:left;border:1px solid black;border-right:0px solid black; border-left:0px solid black;">Alkali Reactivity Test (Gravimetric Method)</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">--</td>
							...
							?>
								<tr>
									...
									<td colspan="3" style="text-align:left;border:1px solid black;border-right:0px solid black; border-left:0px solid black;">Total of percentages of all deleterious Materials<br>(except mica), %</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Max. 2%</td>
							...
							?>
								<tr>
									...
									<td colspan="3" style="text-align:left;border:1px solid black;border-right:0px solid black; border-left:0px solid black;">Coal &amp; Lignite, %</td>
							...
							?>
								<tr>
									...
									<td colspan="3" style="text-align:left;border:1px solid black;border-right:0px solid black; border-left:0px solid black;">Clay &amp; Lumps, %</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Max. 1%</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2386-2</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['dele_2_3']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td colspan="3" style="text-align:left;border:1px solid black;border-right:0px solid black; border-left:0px solid black;">Soft Particles, %</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">-</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2386-2</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['dele_4_3']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td colspan="3" style="text-align:left;border:1px solid black;border-right:0px solid black; border-left:0px solid black;">Material Finer than 75&mu;, %</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Max. 1%</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2386-1</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['dele_1_4']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td colspan="3" style="text-align:left;border:1px solid black;border-right:0px solid black; border-left:0px solid black;">Organic Impurities</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">-</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2386-2</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;"><?php
							...
							?>
								<tr>
									...
									<td colspan="3" style="text-align:left;border:1px solid black;border-right:0px solid black; border-left:0px solid black;">pH</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">-</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2720-26</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['avg_ph']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td colspan="3" style="text-align:left;border:1px solid black;border-right:0px solid black; border-left:0px solid black;">Sulphate, %</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">-</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2720-27</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['avg_sul']; ?></td>
								</tr>
							<?php
							}
							...
							?>
								<tr>
									...
									<td colspan="3" style="text-align:left;border:1px solid black;border-right:0px solid black; border-left:0px solid black;">Cloride Content, %</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">-</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">BS EN 1744-1</td>
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['avg_clr']; ?></td>
								</tr>
							<?php } ?>
						</table>
					</td>
