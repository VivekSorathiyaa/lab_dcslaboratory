	...
	<body>
		...
		<tr>
				...
				<table align="center" width="100%"  class="test" style="height:auto;font-family: Cambria;font-weight:bold; " >
						<tr>
							<td style="font-size:16px;padding-bottom:10px;"><b>Note :-</b></td>
						</tr>
						<tr>
							<td ><b> > &nbsp;</b>Test  rcsults are related  to samples submitted  by customers only.</td>
						</tr>
						<tr>
							<td ><b> > &nbsp;</b> Test results are issued  wilh specifïc understanding that GEC will not in any case be involved  in action  Following  the information  of <span style="padding-left:17px;">the  test results.</span></td>
