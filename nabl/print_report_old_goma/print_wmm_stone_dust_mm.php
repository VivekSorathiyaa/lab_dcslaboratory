							...
							<td colspan="2" style="width:100%;vertical-align:top">
								<table align="top" width="100%" class="test" style="max-width:300px;font-size:10px;font-family: Cambria;">
									...
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;font-weight:bold;"><?php echo $row_select_pipe['cum_ret_1']; ?></td>
									...
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['cum_ret_2']; ?></td>
									...
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['cum_ret_5']; ?></td>
										<!-- <td style="text-align:center;border:1px solid black;border-left:1px solid black;"><?php echo $row_select_pipe['pass_sample_2']; ?></td> -->
									</tr>

									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">600 mic</td>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['cum_ret_3']; ?></td>
									...
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['cum_ret_6']; ?></td>
										<!-- <td style="text-align:center;border:1px solid black;border-left:1px solid black;"><?php echo $row_select_pipe['pass_sample_3']; ?></td> -->
									</tr>

									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">150 mic</td>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['cum_ret_7']; ?></td>
										<!-- <td style="text-align:center;border:1px solid black;border-left:1px solid black;"><?php echo $row_select_pipe['pass_sample_3']; ?></td> -->
									</tr>

									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">75 mic</td>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['cum_ret_4']; ?></td>
						...
						<?php
							...
							<tr>
								...
								<table align="top" width="100%" class="test" style="height:100%;font-family: Cambria;">
									...
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;"><?php //echo $row_select_pipe['sp_water_abr'];
																														?></td>
									</tr>-->
										<?php
										}
