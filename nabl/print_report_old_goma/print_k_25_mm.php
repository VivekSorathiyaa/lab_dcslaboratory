...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from k_25_mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
						...
						<tr>
							...
							<td colspan="2" style="width:49%;vertical-align:top">
								<table align="top" width="100%" class="test" style="height:100%;width:100%;">
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">25 mm</td>
