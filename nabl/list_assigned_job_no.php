        ...
        <div class="col-xs-12">
			<div class="box box-info">
				<div class="box-header with-border">
					<h3 class="box-title">Job No Assigned List</h3>
				</div>
				<!-- /.box-header -->
...
$(".send_to_second").click(function(){
	...
	$.ajax({
        ...
        data: 'action_type=send_job_to_second&clicked_id='+clicked_id,
