...
if($_POST['pay_types']!="")
{
	$pays=" AND payment_type='" .$_POST['pay_types'] . "'";
}else{
	$pays="";
}
?>								
									...
									<input type="hidden" name="chk_job_card" value="<?php echo $base_url; ?>set_receipt_print.php?u_types=<?php echo $_POST["user_type"];?>&&start_date=<?php echo $start_date;?>&&end_date=<?php echo $end_date;?>&&user_id=<?php echo $user_id;?>&&pays=<?php echo $pays;?>">
								...
								<tbody>
									...
									?>
											...
											<td>
											<a href="javascript:void(0)" class="btn btn-danger delete_receipt" title="Delete" data-id="<?php echo $row['receipt_id'];?>">
											Delete
											</a>
										</tr>
									<?php
