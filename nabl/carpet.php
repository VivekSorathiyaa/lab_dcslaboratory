			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">Carpet</h2>
					</div>
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">3.6</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM carpet WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_carpet.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>

												<?php// } ?>
												<div class="col-sm-2">
													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=carpet" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from carpet WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		function abr_auto() {
			...
			if (abr_grading == "A") {
				...
				var abr_index = randomNumberFromRange(19.0, 22.0);
				$('#abr_index').val(abr_index.toFixed(1));
				var abrindex = $('#abr_index').val();
				var tt = randomNumberFromRange(-0.99, 0.99).toFixed(2);
				var r = randomNumberFromRange(0, 9).toFixed();
		...
		function sp_auto() {
			...
			var sp_specificgravity = randomNumberFromRange(2.801, 2.832).toFixed(3); //(sp_specific_gravity)
			...
			var sp_waterabr = randomNumberFromRange(1.10, 1.18).toFixed(2); // (sp_water_abr)_1
		...
		function general_flk_elo1() {
			$('#txtflk').css("background-color", "var(--success)");
			var combined_index = randomNumberFromRange(18.0, 25.0).toFixed(1);
		...
		function imp_auto() {
			...
			var imp_value4 = randomNumberFromRange(15.00, 17.00);
		...
		function grd_auto() {
			...
			var pass_sample_3 = randomNumberFromRange(25.00, 35.00).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(0.00, 0.00).toFixed(2);
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_carpet.php',
