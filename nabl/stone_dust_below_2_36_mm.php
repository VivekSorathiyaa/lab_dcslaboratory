			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">GSB MORD</h2>
					</div>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-sm-1">
												...
												<?php   
													$querys_job1 = "SELECT * FROM gsb_stone_dust WHERE `is_deleted`='0' and lab_no='$lab_no'";
											...
											?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_gsb_1_mix_m5.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&ulr=<?php echo $_GET['ulr'];?>&&tbl_name=gsb_stone_dust" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
 
											</div>
											<div class="col-sm-2">
 													<!--<a target='_blank' href="<?php echo $base_url; ?>back_cal_report_blank/print_gsb_1_mix_m5.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=gsb_stone_dust" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Calculation Blank</b></a>-->

 												</div>
											
											<?php //} ?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_gsb_1_mix_m5.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&tbl_name=gsb_stone_dust" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
					...
					<div class="col-lg-12">
						<table border="1px solid black" align="center" width="100%" id="aaaa">
							<tr>
								...
								<?php
							 $query = "select * from gsb_stone_dust WHERE lab_no='$aa'  and `is_deleted`='0'";
...
//SOUNDNESS	
	...
	function grd_auto() {
			...
			$('#pass_range_2').val("55-75");
			$('#pass_range_3').val("10-30");
			$('#pass_range_4').val("0-10");

			var sample_taken = 5000;
			//PASSING RANGE
			var pass_sample_1 = randomNumberFromRange(100, 100).toFixed(2);
			var pass_sample_2 = randomNumberFromRange(57.00, 73.00).toFixed(2);
			var pass_sample_3 = randomNumberFromRange(12.00, 28.00).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(2.00, 8.00).toFixed(2);
...
function getGlazedTiles(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo $base_url; ?>savestone_dust_below_2_36_mm.php',
