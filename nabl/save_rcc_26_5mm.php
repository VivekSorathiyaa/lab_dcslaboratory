...
if(isset($_POST['action_type']) && !empty($_POST['action_type']))
	{
		...
		{
			$get_query = "select * from rcc_26_5mm WHERE id='$_POST[id]' AND `is_deleted`='0'"; 
		...
		else if($_POST['action_type'] == 'add')
		{
			...
			$curr_date=date("Y-m-d");
			 ...
			 $insert="INSERT INTO `rcc_26_5mm`(`report_no`,`ulr`, `job_no`, `lab_no`, `status`, `created_by`, `created_date`, `modified_by`, `modified_date`, `is_deleted`, `deleted_by`, `checked_by`, `chk_grd`, `sieve_1`, `sieve_2`, `sieve_3`, `sieve_4`, `sieve_5`, `sieve_6`, `sieve_7`, `cum_wt_gm_1`, `cum_wt_gm_2`, `cum_wt_gm_3`, `cum_wt_gm_4`, `cum_wt_gm_5`,  `cum_wt_gm_6`,  `cum_wt_gm_7`, `ret_wt_gm_1`, `ret_wt_gm_2`, `ret_wt_gm_3`, `ret_wt_gm_4`, `ret_wt_gm_5`, `ret_wt_gm_6`, `ret_wt_gm_7`, `cum_ret_1`, `cum_ret_2`, `cum_ret_3`, `cum_ret_4`, `cum_ret_5`, `cum_ret_6`, `cum_ret_7`, `pass_sample_1`, `pass_sample_2`, `pass_sample_3`, `pass_sample_4`, `pass_sample_5`, `pass_sample_6`, `pass_sample_7`, `pass_range_1`, `pass_range_2`, `pass_range_3`, `pass_range_4`, `pass_range_5`, `pass_range_6`, `pass_range_7`, `blank_extra`, `sample_taken`, `chk_sp`, `sp_wt_st_1`, `sp_wt_st_2`, `sp_w_sur_1`, `sp_w_sur_2`, `sp_w_s_1`, `sp_w_s_2`, `sp_specific_gravity_1`, `sp_specific_gravity_2`, `sp_specific_gravity`, `sp_water_abr_1`, `sp_water_abr_2`, `sp_water_abr`, `chk_den`, `m11`, `m12`, `m13`, `m21`, `m22`, `m23`, `m31`, `m32`, `m33`, `avg_wom`, `vol`, `bdl`, `chk_impact`, `imp_w_m_a_1`, `imp_w_m_a_2`, `imp_w_m_a_3`, `imp_w_m_b_1`, `imp_w_m_b_2`, `imp_w_m_b_3`, `imp_w_m_c_1`, `imp_w_m_c_2`, `imp_w_m_c_3`, `imp_value_1`, `imp_value_2`, `imp_value_3`, `imp_value`, `chk_abr`, `abr_wt_t_a_1`, `abr_wt_t_a_2`, `abr_wt_t_b_1`, `abr_wt_t_b_2`, `abr_wt_t_c_1`, `abr_wt_t_c_2`, `abr_1`, `abr_2`, `abr_index`, `abr_grading`, `abr_weight_charge`, `abr_num_revo`, `abr_sphere`, `chk_crushing`, `cr_a_1`, `cr_a_2`, `cr_b_1`, `cr_b_2`, `cru_value_1`, `cru_value_2`, `cru_value`, `chk_flk`, `s11`, `s12`, `s13`, `s14`, `s15`, `s16`, `s17`, `s18`, `s19`, `a1`, `a2`, `a3`, `a4`, `a5`, `a6`, `a7`, `a8`, `a9`, `suma`, `b1`, `b2`, `b3`, `b4`, `b5`, `b6`, `b7`, `b8`, `b9`, `sumb`, `aa1`, `aa2`, `aa3`, `aa4`, `aa5`, `aa6`, `aa7`, `aa8`, `aa9`, `sumaa`, `dd1`, `dd2`, `dd3`, `dd4`, `dd5`, `dd6`, `dd7`, `dd8`, `dd9`, `sumdd`, `fi_index`, `ei_index`, `combined_index`, `chk_sou`, `s31`, `s32`, `s33`, `s34`, `s35`, `s36`, `s37`, `s38`, `s39`, `s30`, `s41`, `s42`, `s43`, `s44`, `s45`, `s46`, `s47`, `s48`, `s49`, `s40`, `s51`, `s52`, `s53`, `s54`, `s55`, `s56`, `s57`, `s58`, `s59`, `s50`, `s61`, `s62`, `s63`, `s64`, `s65`, `s66`, `s67`, `s68`, `s69`, `s60`, `s6total`, `soundness`, `chk_fines`, `f_a_1`, `f_a_2`, `f_c_1`, `f_c_2`, `f_d_1`, `f_d_2`, `f_b_1`, `f_b_2`, `avg_f_d`, `avg_f_c`, `fines_value`, `chk_alkali`, `alk_1`, `alk_2`, `alk_3`, `alk_4`, `alk_5`, `alk_6`, `alk_7`, `alk_8`, `alk_9`, `alk_10`, `alk_11`, `chk_ll`, `pen1`, `pen2`, `pen3`, `pen4`, `cont1`, `cont2`, `cont3`, `cont4`, `wc1`, `wc2`, `wc3`, `wc4`, `od1`, `od2`, `od3`, `od4`, `ww1`, `ww2`, `ww3`, `ww4`, `wf1`, `wf2`, `wf3`, `wf4`, `ds1`, `ds2`, `ds3`, `ds4`, `mo1`, `mo2`, `mo3`, `mo4`, `ln1`, `ln2`, `ln3`, `ln4`, `avg_ll`, `avg_pl`, `liquide_limit`, `plastic_limit`, `pi_value`, `chk_dtm`, `dele_1_1`, `dele_1_2`, `dele_1_3`, `dele_1_4`, `dele_2_1`, `dele_2_2`, `dele_2_3`, `dele_2_4`, `dele_3_1`, `dele_3_2`, `dele_3_3`,`sp_bask_water`,`sp_wt_bas1`,`sp_wt_bas2`,`sp_apr1`,`sp_apr2`,`sp_avg_apr`,`den_mo_vol1`,`den_mo_vol2`,`den_liter`,`den_kg_lit`,`den_voids`,`flk_x1`,`flk_x2`,`flk_x3`,`flk_x4`,`flk_x5`,`flk_x6`,`flk_x7`,`flk_x8`,`flk_x9`,`flk_y1`,`flk_y2`,`flk_y3`,`flk_y4`,`flk_y5`,`flk_y6`,`flk_y7`,`flk_y8`,`flk_y9`,`flk_xy1`,`flk_xy2`,`flk_xy3`,`flk_xy4`,`flk_xy5`,`flk_xy6`,`flk_xy7`,`flk_xy8`,`flk_xy9`,`elo_x1`,`elo_x2`,`elo_x3`,`elo_x4`,`elo_x5`,`elo_x6`,`elo_x7`,`elo_x8`,`elo_x9`,`elo_y1`,`elo_y2`,`elo_y3`,`elo_y4`,`elo_y5`,`elo_y6`,`elo_y7`,`elo_y8`,`elo_y9`,`elo_xy1`,`elo_xy2`,`elo_xy3`,`elo_xy4`,`elo_xy5`,`elo_xy6`,`elo_xy7`,`elo_xy8`,`elo_xy9`,`total_a`,`total_aa`,`amend_date`) VALUES ('$report_no','$ulr','$job_no','$lab_no','0','$_SESSION[name]','$curr_date','','0000-00-00','0','','','$chk_grd','$sieve_1','$sieve_2','$sieve_3','$sieve_4','$sieve_5','$sieve_6','$sieve_7','$cum_wt_gm_1','$cum_wt_gm_2','$cum_wt_gm_3','$cum_wt_gm_4','$cum_wt_gm_5','$cum_wt_gm_6','$cum_wt_gm_7','$ret_wt_gm_1','$ret_wt_gm_2','$ret_wt_gm_3','$ret_wt_gm_4','$ret_wt_gm_5','$ret_wt_gm_6','$ret_wt_gm_7','$cum_ret_1','$cum_ret_2','$cum_ret_3','$cum_ret_4','$cum_ret_5','$cum_ret_6','$cum_ret_7','$pass_sample_1','$pass_sample_2','$pass_sample_3','$pass_sample_4','$pass_sample_5','$pass_sample_6','$pass_sample_7','$pass_range_1','$pass_range_2','$pass_range_3','$pass_range_4','$pass_range_5','$pass_range_6','$pass_range_7','$blank_extra','$sample_taken','$chk_sp','$sp_wt_st_1','$sp_wt_st_2','$sp_w_sur_1','$sp_w_sur_2','$sp_w_s_1','$sp_w_s_2','$sp_specific_gravity_1','$sp_specific_gravity_2','$sp_specific_gravity','$sp_water_abr_1','$sp_water_abr_2','$sp_water_abr','$chk_den','$m11','$m12','$m13','$m21','$m22','$m23','$m31','$m32','$m33','$avg_wom','$vol','$bdl','$chk_impact','$imp_w_m_a_1','$imp_w_m_a_2', '$imp_w_m_a_3','$imp_w_m_b_1','$imp_w_m_b_2', '$imp_w_m_b_3','$imp_w_m_c_1','$imp_w_m_c_2', '$imp_w_m_c_3','$imp_value_1','$imp_value_2','$imp_value_3','$imp_value','$chk_abr','$abr_wt_t_a_1','$abr_wt_t_a_2','$abr_wt_t_b_1','$abr_wt_t_b_2','$abr_wt_t_c_1','$abr_wt_t_c_2','$abr_1','$abr_2','$abr_index','$abr_grading','$abr_weight_charge','$abr_num_revo','$abr_sphere','$chk_crushing','$cr_a_1','$cr_a_2','$cr_b_1','$cr_b_2','$cru_value_1','$cru_value_2','$cru_value','$chk_flk','$s11','$s12','$s13','$s14','$s15','$s16','$s17','$s18','$s19','$a1','$a2','$a3','$a4','$a5','$a6','$a7','$a8','$a9','$suma','$b1','$b2','$b3','$b4','$b5','$b6','$b7','$b8','$b9','$sumb','$aa1','$aa2','$aa3','$aa4','$aa5','$aa6','$aa7','$aa8','$aa9','$sumaa','$dd1','$dd2','$dd3','$dd4','$dd5','$dd6','$dd7','$dd8','$dd9','$sumdd','$fi_index','$ei_index','$combined_index','$chk_sou','$s31','$s32','$s33','$s34','$s35','$s36','$s37','$s38','$s39','$s30','$s41','$s42','$s43','$s44','$s45','$s46','$s47','$s48','$s49','$s40','$s51','$s52','$s53','$s54','$s55','$s56','$s57','$s58','$s59','$s50','$s61','$s62','$s63','$s64','$s65','$s66','$s67','$s68','$s69','$s60','$s6total','$soundness','$chk_fines','$f_a_1','$f_a_2','$f_c_1','$f_c_2','$f_d_1','$f_d_2','$f_b_1','$f_b_2','$avg_f_d','$avg_f_c','$fines_value','$chk_alkali','$alk_1','$alk_2','$alk_3','$alk_4','$alk_5','$alk_6','$alk_7','$alk_8','$alk_9','$alk_10','$alk_11','$chk_ll','$pen1','$pen2','$pen3','$pen4','$cont1','$cont2','$cont3','$cont4','$wc1','$wc2','$wc3','$wc4','$od1','$od2','$od3','$od4','$ww1','$ww2','$ww3','$ww4','$wf1','$wf2','$wf3','$wf4','$ds1','$ds2','$ds3','$ds4','$mo1','$mo2','$mo3','$mo4','$ln1','$ln2','$ln3','$ln4','$avg_ll','$avg_pl','$liquide_limit','$plastic_limit','$pi_value','$chk_dtm', '$dele_1_1', '$dele_1_2', '$dele_1_3', '$dele_1_4', '$dele_2_1', '$dele_2_2', '$dele_2_3', '$dele_2_4', '$dele_3_1', '$dele_3_2', '$dele_3_3', '$sp_bask_water', '$sp_wt_bas1', '$sp_wt_bas2', '$sp_apr1', '$sp_apr2', '$sp_avg_apr', '$den_mo_vol1', '$den_mo_vol2', '$den_liter', '$den_kg_lit', '$den_voids','$flk_x1','$flk_x2','$flk_x3','$flk_x4','$flk_x5','$flk_x6','$flk_x7','$flk_x8','$flk_x9','$flk_y1','$flk_y2','$flk_y3','$flk_y4','$flk_y5','$flk_y6','$flk_y7','$flk_y8','$flk_y9','$flk_xy1','$flk_xy2','$flk_xy3','$flk_xy4','$flk_xy5','$flk_xy6','$flk_xy7','$flk_xy8','$flk_xy9','$elo_x1','$elo_x2','$elo_x3','$elo_x4','$elo_x5','$elo_x6','$elo_x7','$elo_x8','$elo_x9','$elo_y1','$elo_y2','$elo_y3','$elo_y4','$elo_y5','$elo_y6','$elo_y7','$elo_y8','$elo_y9','$elo_xy1','$elo_xy2','$elo_xy3','$elo_xy4','$elo_xy5','$elo_xy6','$elo_xy7','$elo_xy8','$elo_xy9','$total_a','$total_aa','$amend_date')";
											...
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													<tr>
														...
														<?php
													 $query = "select * from rcc_26_5mm WHERE lab_no='$lab_no' and `is_deleted`='0'";
		...
		$update= "update `rcc_26_5mm` SET `job_no`='$_POST[job_no]',`lab_no`='$_POST[lab_no]',`report_no`='$_POST[report_no]',
		`ulr`='$_POST[ulr]',
		`chk_grd`='$_POST[chk_grd]',
      `sieve_1`='$_POST[sieve_1]',
      `sieve_2`='$_POST[sieve_2]',
	...
	elseif($_POST['action_type'] == 'delete'){
		 ...
		 $delete="update rcc_26_5mm SET `is_deleted`='1',`deleted_by`='$_SESSION[name]' WHERE `report_no`='$_POST[report_no]' and `lab_no`='$_POST[lab_no]' and `job_no`='$_POST[job_no]'";
	...
	elseif($_POST['action_type'] == 'chk'){
		...
		$qry = "SELECT * FROM rcc_26_5mm WHERE `id`='$_POST[id]'";
		$arr = mysqli_query($conn,$qry);
		$rows1=mysqli_num_rows($arr);
		while($r2 = mysqli_fetch_array($arr)){
				if($r2['checked_by']!="")
				{
					$c1c="update rcc_26_5mm SET `checked_by`='' WHERE `id`='$_POST[id]'";			
					$result_of_delete1=mysqli_query($conn,$cc);	
				}
				else
				{
					$cc="update rcc_26_5mm SET `checked_by`='$_SESSION[name]' WHERE `id`='$_POST[id]'";			
