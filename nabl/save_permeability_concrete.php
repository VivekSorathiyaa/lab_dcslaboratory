...
if(isset($_POST['action_type']) && !empty($_POST['action_type']))
	{
		...
		{
			$get_query = "select * from permeability_concrete WHERE id='$_POST[id]' AND `is_deleted`='0'"; 
		...
		else if($_POST['action_type'] == 'add')
		{
		 ...
		 $insert="INSERT INTO `permeability_concrete`( `report_no`,`ulr`, `job_no`, `lab_no`, `cc_grade`, `casting_date`, `cc_day`, `day_remark`, `cc_set_of_cube`, `cc_no_of_cube`, `status`, `created_by`, `created_date`, `modified_by`, `modified_date`, `is_deleted`, `deleted_by`, `checked_by`, `chk_com`, `grade1`, `caste_date1`, `test_date1`, `day1`, `l1`, `l2`, `l3`, `b1`, `b2`, `b3`, `h1`, `h2`, `h3`, `cross_1`, `cross_2`, `cross_3`, `mass_1`, `mass_2`, `mass_3`, `load_1`, `load_2`, `load_3`, `comp_1`, `comp_2`, `comp_3`, `avg_com_s_1`, `fail_pat_1`, `fail_pat_2`, `fail_pat_3`, `cc_qty`, `cc_identification_mark`,`remarks`, `pen_1`, `pen_2`, `pen_3`, `avg_pen`, `amend_date`)  VALUES ('$report_no','$ulr','$job_no','$lab_no','$top_grade','$top_casting_date','$top_days','$top_remark','$top_set','$top_no_of_cube','0','$_SESSION[name]','$curr_date','','0000-00-00','0','','','$chk_com','$grade1','$caste_date1','$test_date1','$day1','$l1','$l2','$l3','$b1','$b2','$b3','$h1','$h2','$h3','$cross_1','$cross_2','$cross_3','$mass_1','$mass_2','$mass_3','$load_1','$load_2','$load_3','$comp_1','$comp_2','$comp_3','$avg_com_s_1','$fail_pat_1','$fail_pat_2','$fail_pat_3','$cc_qty','$cc_identification_mark','$remarks', '$pen_1', '$pen_2', '$pen_3', '$avg_pen', '$amend_date')"; 
											...
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													<tr>
														...
														<?php
													 $query = "select * from `permeability_concrete` WHERE lab_no='$lab_no' and `is_deleted`='0' ORDER BY `id`";
	  ...
	  $update="update permeability_concrete SET `job_no`='$_POST[job_no]',`lab_no`='$_POST[lab_no]',`ulr`='$_POST[ulr]',`report_no`='$_POST[report_no]',
	...
	elseif($_POST['action_type'] == 'delete'){
		 ...
		 $delete="update `permeability_concrete` SET `is_deleted`='1' WHERE `id`='$_POST[id]'";
	...
	elseif($_POST['action_type'] == 'chk'){
		$lab_no =$_POST['lab_no']; 		
		$qry = "select * from `permeability_concrete` WHERE lab_no='$lab_no' and `is_deleted`='0'";
