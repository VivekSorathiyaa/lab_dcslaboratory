			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">CONCRETE COVER TEST</h2>
					</div>
							...
							<div class="col-lg-12">
								<div class="form-group">
									...
									<div class="col-sm-2">
										...
										<?php
										$querys_job1 = "SELECT * FROM concrete_cover WHERE `is_deleted`='0' and lab_no='$lab_no'";
									...
									?>
										<div class="col-sm-2">
											<a target='_blank' href="<?php echo $base_url; ?>print_report/report_concrete_cover.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
										</div>

									<?php } ?>
									<div class="col-sm-2">
										<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/back_concrete_cover.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
							...
							if (mysqli_num_rows($result_upload) > 0) { ?>
								...
								while ($r1 = mysqli_fetch_array($result_select1)) {
									...
									if ($r1['test_code'] == "147") {
										...
										$test_check .= "147,";
								?>
										<div class="panel panel-default" id="ccc">
											<div class="panel-heading" id="txtccc">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion" href="#collapse5">
														<h4 class="panel-title">
															<b>CONCRETE COVER TEST</b>
														</h4>
													</a>
												</h4>
											</div>
												...
												<div class="panel-body">
													...
													<div class="row">
														...
														<div class="col-lg-6">
															<div class="form-group">
																<div class="col-sm-1">
																	<label for="chk_ccc">1.</label>
																	<input type="checkbox" class="visually-hidden" name="chk_ccc" id="chk_ccc" value="chk_ccc"><br>
																</div>
																<label for="inputEmail3" class="col-sm-11 control-label label-right">CONCRETE COVER TEST</label>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control" id="test_date1" name="test_date1" >
													...
													<div class="col-md-12">
														...
														<div class="col-md-2">
															<div class="form-group">
																<label for="inputEmail3" class="control-label" style="text-align:center;">Concrete Element location</label>
															</div>
														</div>
														<div class="col-md-2">
															<div class="form-group">
																<label for="inputEmail3" class="control-label" style="text-align:center;">Concrete Cover (mm) Min - Max</label>
															</div>
														</div>
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label" style="text-align:center;">3.</label>
																</div>
															</div>
															<div class="col-md-2">
																<div class="form-group">
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label" style="text-align:center;">Concrete Elements</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="ele_1" name="ele_1">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="ele_2" name="ele_2">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="ele_3" name="ele_3">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="ele_4" name="ele_4">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="ele_5" name="ele_5">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="ele_6" name="ele_6">
																</div>
															</div>
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label" style="text-align:center;">Cover to Element (mm)</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cov_1" name="cov_1">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cov_2" name="cov_2">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cov_3" name="cov_3">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cov_4" name="cov_4">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cov_5" name="cov_5">
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
																	<input type="text" class="form-control" id="cov_6" name="cov_6">
																</div>
															</div>
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label" style="text-align:center;">Remarks</label>
																</div>
															</div>
															<div class="col-md-1">
																<div class="form-group">
									...
									<div class="row">
										<div class="col-lg-12">
											<table border="1px solid black" align="center" width="100%" id="aaaa">
												...
												<?php
												$query = "select * from concrete_cover WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	 ...
	 */
		...
		$('#chk_ccc').change(function() {
			if (this.checked) {
				$('#txtccc').css("background-color", "var(--success)");
			} else {
				$('#txtccc').css("background-color", "white");
			}
	 ...
	 */
		...
		function ccc_auto() {
			...
			$('#loc_1').val("Column (Third floor)");
			$('#loc_2').val("Beam (Third floor)");
			$('#loc_3').val("Column (Second floor)");
			$('#loc_4').val("Beam (Second floor)");
			$('#loc_5').val("Column (First floor)");
			$('#loc_6').val("Beam (First floor)");
			$('#con_1').val("40-65");
			$('#con_2').val("25-40");
			$('#con_3').val("35-60");
			$('#con_4').val("30-55");
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_concrete_cover.php',
	...
	function saveMetal(type, id) {
		...
		if (type == 'add') {
			...
			for (var i = 0; i < aa.length; i++) {
				if (aa[i] == "147") {
					if (document.getElementById('chk_ccc').checked) {
						var chk_ccc = "1";
					} else {
						var chk_ccc = "0";
					}
			...
			billData = '&action_type=' + type + '&report_no=' + report_no + '&job_no=' + job_no + '&lab_no=' + lab_no + '&chk_ccc=' + chk_ccc + '&loc_1=' + loc_1 + '&loc_2=' + loc_2 + '&loc_3=' + loc_3 + '&loc_4=' + loc_4 + '&loc_5=' + loc_5 + '&loc_6=' + loc_6 + '&con_1=' + con_1 + '&con_2=' + con_2 + '&con_3=' + con_3 + '&con_4=' + con_4 + '&con_5=' + con_5 + '&con_6=' + con_6 + '&rem_1=' + rem_1 + '&rem_2=' + rem_2 + '&rem_3=' + rem_3 + '&rem_4=' + rem_4 + '&rem_5=' + rem_5 + '&rem_6=' + rem_6 + '&cov_1=' + cov_1 + '&cov_2=' + cov_2 + '&cov_3=' + cov_3 + '&cov_4=' + cov_4 + '&cov_5=' + cov_5 + '&cov_6=' + cov_6 + '&ele_1=' + ele_1 + '&ele_2=' + ele_2 + '&ele_3=' + ele_3 + '&ele_4=' + ele_4 + '&ele_5=' + ele_5 + '&ele_6=' + ele_6 + '&temp=' + temp + '&ulr=' + ulr+ '&amend_date=' + amend_date;
			...
			billData = $("#Glazed").find('.form').serialize() + '&action_type=' + type + '&idEdit=' + idEdit + '&report_no=' + report_no + '&job_no=' + job_no + '&lab_no=' + lab_no + '&loc_1=' + loc_1 + '&loc_2=' + loc_2 + '&loc_3=' + loc_3 + '&loc_4=' + loc_4 + '&loc_5=' + loc_5 + '&loc_6=' + loc_6 + '&con_1=' + con_1 + '&con_2=' + con_2 + '&con_3=' + con_3 + '&con_4=' + con_4 + '&con_5=' + con_5 + '&con_6=' + con_6 + '&rem_1=' + rem_1 + '&rem_2=' + rem_2 + '&rem_3=' + rem_3 + '&rem_4=' + rem_4 + '&rem_5=' + rem_5 + '&rem_6=' + rem_6 + '&cov_1=' + cov_1 + '&cov_2=' + cov_2 + '&cov_3=' + cov_3 + '&cov_4=' + cov_4 + '&cov_5=' + cov_5 + '&cov_6=' + cov_6 + '&ele_1=' + ele_1 + '&ele_2=' + ele_2 + '&ele_3=' + ele_3 + '&ele_4=' + ele_4 + '&ele_5=' + ele_5 + '&ele_6=' + ele_6 + '&temp=' + temp + '&ulr=' + ulr+ '&amend_date=' + amend_date;
		} else {
			var report_no = $('#report_no').val();
			var job_no = $('#job_no').val();
			var lab_no = $('#lab_no').val();
			...
			success: function(data) {
				...
				for (var i = 0; i < aa.length; i++) {
					if (aa[i] == "147") {
						...
						$('#cov_1').val(data.cov_1);
						$('#cov_2').val(data.cov_2);
						$('#cov_3').val(data.cov_3);
						$('#cov_4').val(data.cov_4);
						$('#cov_5').val(data.cov_5);
						$('#cov_6').val(data.cov_6);
						$('#ele_1').val(data.ele_1);
						$('#ele_2').val(data.ele_2);
						$('#ele_3').val(data.ele_3);
						$('#ele_4').val(data.ele_4);
						$('#ele_5').val(data.ele_5);
						$('#ele_6').val(data.ele_6);
						$('#rem_1').val(data.ele_1);
						$('#rem_2').val(data.ele_2);
						$('#rem_3').val(data.ele_3);
						$('#rem_4').val(data.ele_4);
						$('#rem_5').val(data.ele_5);
						$('#rem_6').val(data.ele_6);
						$('#temp').val(data.temp);
