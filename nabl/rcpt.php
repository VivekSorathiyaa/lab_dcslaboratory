...
if (mysqli_num_rows($res_final_table) > 0) {
    ...
    $cc_sample_qty = $row_final_table['cc_sample_qty'];
}
            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h2 style="text-align:center;">R.C.P.T</h2>
                    </div>
                    ...
                    <form class="form" id="Glazed" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="cc_sample_qty" value="<?php echo $cc_sample_qty; ?>" onchange="set_sample_qty()" name="cc_sample_qty">
						...
						<div class="row">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <div class="col-sm-4">
                                        <label for="chk_auto">ID Mark</label>
                                    </div>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control inputs" tabindex="4" id="identification_mark" name="identification_mark">
                                    </div>
                                </div>
                            </div>
							<div class="col-lg-8">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <?php
                                        $querys_job1 = "SELECT * FROM rcpt WHERE `is_deleted`='0' and lab_no='$lab_no'";
                                    ...
                                    ?>
                                    <div class="col-sm-2">
                                        <a target='_blank' href="<?php echo $base_url; ?>print_report/print_rcpt.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
                                    </div>

                                    <? php // } 
                                    ?>
                                    <div class="col-sm-2">
                                        <a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_rcpt.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
                                            ...
                                            <div id="collapse_com" class="panel-collapse collapse">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label for="inputEmail3" class="control-label text-center">Location of Core</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                                <label for="inputEmail3" class="control-label text-center">Density (Kg/m3)</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-2">
                                                            <div class="form-group">
                                                    ...
                                                    <div class="row">
														...
														<div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="inputEmail3" class="control-label text-center">Chloride Ion Penetrability<br>(Charged Passed) coulombs <br>(Qx)</label>
                                                            </div>
                                                        </div>
														<div class="col-md-3">
                                                            <div class="form-group">
                                                                <label for="inputEmail3" class="control-label text-center">Corrected Penetrability<br>(Charged Passed) As per Clause<br>11.2 ASTM C1202-12* <br>(Qs)</label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
														...
														<div class="col-md-3">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" id='cip_1' name='cip_1'>
                                                            </div>
                                                        </div>
														<div class="col-md-3">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" id='cip_2' name='cip_2'>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <table border="1px solid black" align="center" width="100%" id="aaaa">
                                                ...
                                                <?php
                                                $query = "select * from rcpt WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
    ...
    $(document).ready(function() {
        ...
        function com_auto() {
			...
			var cip_1 = randomNumberFromRange(150.00, 4100.00);
            $('#cip_1').val((+cip_1).toFixed(2));
			
			var cip_2 = randomNumberFromRange(150.00, 4100.00);
            $('#cip_2').val((+cip_2).toFixed(2));
        ...
        $('#weight1,#dia1,#height1,#load1,#dia_corr1').change(function() {
            $('#txtcom').css("background-color", "var(--success)");
            var weight1 = $('#weight1').val();
            ...
            var area1 = ((+3.141592653589793238) / 4 * (+dia1) * (+dia1));
            // var area2 = ((+3.141592653589793238) / 4 * (+dia2) * (+dia2));
            // var area3 = ((+3.141592653589793238) / 4 * (+dia3) * (+dia3));
            // var area4 = ((+3.141592653589793238) / 4 * (+dia4) * (+dia4));
            $('#area1').val((+area1).toFixed(2));
            ...
            var hd_ratio1 = (+height1) / (+dia1);
            // var hd_ratio2 = (+height2) / (+dia2);
            // var hd_ratio3 = (+height3) / (+dia3);
            // var hd_ratio4 = (+height4) / (+dia4);
            $('#hd_ratio1').val((+hd_ratio1).toFixed(2));
            // $('#hd_ratio2').val((+hd_ratio2).toFixed(2));
            // $('#hd_ratio3').val((+hd_ratio3).toFixed(2));
            // $('#hd_ratio4').val((+hd_ratio4).toFixed(2));
            ...
            var vol1 = ((+area1) * (+height1)) / 1000000000;
            // var vol2 = ((+area2) * (+height2)) / 1000000000;
            // var vol3 = ((+area3) * (+height3)) / 1000000000;
            // var vol4 = ((+area4) * (+height4)) / 1000000000;
            $('#vol1').val((+vol1).toFixed(5));
            // $('#vol2').val((+vol2).toFixed(5));
            // $('#vol3').val((+vol3).toFixed(5));
            // $('#vol4').val((+vol4).toFixed(5));
            ...
            var den1 = ((+weight1) / (+1000)) / (+vol1);
            // var den2 = ((+weight2) / (+1000)) / (+vol2);
            // var den3 = ((+weight3) / (+1000)) / (+vol3);
            // var den4 = ((+weight4) / (+1000)) / (+vol4);
            $('#den1').val((+den1).toFixed(1));
            // $('#den2').val((+den2).toFixed(1));
            // $('#den3').val((+den3).toFixed(1));
            // $('#den4').val((+den4).toFixed(1));
            ...
            // var com2 = ((+load2) * (+1000)) / (+area2);
            // var com3 = ((+load3) * (+1000)) / (+area3);
            // var com4 = ((+load4) * (+1000)) / (+area4);
            $('#com1').val((+com1).toFixed(2));
            ...
            var hd_corr1 = (+0.11) * (+hd_ratio1) + (+0.78);
            // var hd_corr2 = (+0.11) * (+hd_ratio2) + (+0.78);
            // var hd_corr3 = (+0.11) * (+hd_ratio3) + (+0.78);
            // var hd_corr4 = (+0.11) * (+hd_ratio4) + (+0.78);
            $('#hd_corr1').val((+hd_corr1).toFixed(3));
            // $('#hd_corr2').val((+hd_corr2).toFixed(3));
            // $('#hd_corr3').val((+hd_corr3).toFixed(3));
            // $('#hd_corr4').val((+hd_corr4).toFixed(3));
            ...
            var corr_com1 = (+dia_corr1) * (+com1) * (+hd_corr1);
            // var corr_com2 = (+dia_corr2) * (+com2) * (+hd_corr2);
            // var corr_com3 = (+dia_corr3) * (+com3) * (+hd_corr3);
            // var corr_com4 = (+dia_corr4) * (+com4) * (+hd_corr4);
            $('#corr_com1').val((+corr_com1).toFixed(2));
            // $('#corr_com2').val((+corr_com2).toFixed(2));
            // $('#corr_com3').val((+corr_com3).toFixed(2));
            // $('#corr_com4').val((+corr_com4).toFixed(2));
            ...
            var eq_cube1 = (+1.25) * (+corr_com1);
            // var eq_cube2 = (+1.25) * (+corr_com2);
            // var eq_cube3 = (+1.25) * (+corr_com3);
            // var eq_cube4 = (+1.25) * (+corr_com4);

            $('#eq_cube1').val((+eq_cube1).toFixed(2));
            // $('#eq_cube2').val((+eq_cube2).toFixed(2));
            // $('#eq_cube3').val((+eq_cube3).toFixed(2));
            // $('#eq_cube4').val((+eq_cube4).toFixed(2));
        })
    ...
    function getGlazedTiles() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo $base_url; ?>save_rcpt.php',
    ...
    function saveMetal(type, id) {
        ...
        if (type == 'add') {
            ...
            billData = '&action_type=' + type + '&report_no=' + report_no + '&job_no=' + job_no + '&lab_no=' + lab_no + '&ulr=' + ulr + '&chk_com=' + chk_com + '&location1=' + location1 + '&location2=' + location2 + '&location3=' + location3 + '&location4=' + location4 + '&weight1=' + weight1 + '&weight2=' + weight2 + '&weight3=' + weight3 + '&weight4=' + weight4 + '&dia1=' + dia1 + '&dia2=' + dia2 + '&dia3=' + dia3 + '&dia4=' + dia4 + '&height1=' + height1 + '&height2=' + height2 + '&height3=' + height3 + '&height4=' + height4 + '&area1=' + area1 + '&area2=' + area2 + '&area3=' + area3 + '&area4=' + area4 + '&hd_ratio1=' + hd_ratio1 + '&hd_ratio2=' + hd_ratio2 + '&hd_ratio3=' + hd_ratio3 + '&hd_ratio4=' + hd_ratio4 + '&vol1=' + vol1 + '&vol2=' + vol2 + '&vol3=' + vol3 + '&vol4=' + vol4 + '&den1=' + den1 + '&den2=' + den2 + '&den3=' + den3 + '&den4=' + den4 + '&load1=' + load1 + '&load2=' + load2 + '&load3=' + load3 + '&load4=' + load4 + '&com1=' + com1 + '&com2=' + com2 + '&com3=' + com3 + '&com4=' + com4 + '&dia_corr1=' + dia_corr1 + '&dia_corr2=' + dia_corr2 + '&dia_corr3=' + dia_corr3 + '&dia_corr4=' + dia_corr4 + '&hd_corr1=' + hd_corr1 + '&hd_corr2=' + hd_corr2 + '&hd_corr3=' + hd_corr3 + '&hd_corr4=' + hd_corr4 + '&corr_com1=' + corr_com1 + '&corr_com2=' + corr_com2 + '&corr_com3=' + corr_com3 + '&corr_com4=' + corr_com4 + '&eq_cube1=' + eq_cube1 + '&eq_cube2=' + eq_cube2 + '&eq_cube3=' + eq_cube3 + '&eq_cube4=' + eq_cube4 + '&cip_1=' + cip_1 + '&cip_2=' + cip_2+ '&identification_mark=' + identification_mark+ '&cube_grade=' + cube_grade+ '&casting_date=' + casting_date+ '&amend_date=' + amend_date;
            ...
            success: function(data) {
                ...
                for (var i = 0; i < aa.length; i++) {
                    if (aa[i] == "com") {
                        ...
                        $('#cip_1').val(data.cip_1);
                        $('#cip_2').val(data.cip_2);
                        break;
                    }
                }
