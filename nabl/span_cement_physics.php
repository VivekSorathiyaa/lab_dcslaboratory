            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h2 style="text-align:center;">CEMENT</h2>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control inputs" tabindex="4" id="type_of_cement" value="<?php echo $type_of_cement; ?>" name="type_of_cement" ReadOnly>
                                        </div>

                                        <label for="inputEmail3" class="col-sm-2 control-label">Grade :</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control inputs" tabindex="4" id="cement_grade" value="<?php echo $cement_grade; ?>" name="cement_grade" ReadOnly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control inputs" tabindex="4" id="remark_id" name="remark_id">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <?php
                                            $querys_job1 = "SELECT * FROM span_cement WHERE `is_deleted`='0' and lab_no='$lab_no'";
                                        ...
                                        ?>
                                        <div class="col-sm-3">
                                            <a target='_blank' href="<?php echo $base_url; ?>print_report/print_span_cement_physics.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info" id="btn_report" name="btn_report"><b>Report</b></a>
                                        ...
                                        <div class="col-sm-3">
                                            <a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_cement.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
                                            <!--<a target = '_blank' href="<?php // echo $base_url; 
                            ...
                            <div class="panel-group" id="accordion" style="">
                                ...
                                if (mysqli_num_rows($result_upload) > 0) { ?>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-group" id="accordion" style="padding:0px;margin-top:5px;">
                                            <?php
                                            $test_check;
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Room Temperature(&#8451;) :</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-8">
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="control-label">Amount of Sample :</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-4">
                                                                            <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Room Humidity (%) :</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Amount of Water in gm</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Consistency (P) in %</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Reading on Vicat (mm)</label>
                                                                        </div>
                                                                    </div>
                                                                </div> -->
                                                                    <!-- <div class="col-lg-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Trial-4</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Trial-5</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Final Value </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="final_wtr" name="final_wtr">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                            ...
                                                            <div class="panel-body">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-8">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <label for="inputEmail3" class="col-sm-4 control-label label-right">SOUNDNESS BY LE-CHATELIER METHOD</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-8">
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="control-label">Amount of Sample (gm) :</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-8">
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="control-label">Standard Consistency (P) :</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <input type="text" class="form-control" id="sou_con" name="sou_con">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-8">
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="control-label">Amount of Water to be Taken (gm) =</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Initial Reading</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <label for="inputEmail3" class="control-label">A1</label>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputs" tabindex="4" id="dis_1_1" name="dis_1_1">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                    ...
                                                                    <div class="col-lg-1">
                                                                        <label for="inputEmail3" class="control-label">A2</label>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputs" tabindex="4" id="dis_1_2" name="dis_1_2">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <label for="inputEmail3" class="control-label">mm</label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Final Reading</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <label for="inputEmail3" class="control-label">B1</label>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputs" tabindex="4" id="dis_2_1" name="dis_2_1">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <label for="inputEmail3" class="control-label">mm</label>
                                                                    ...
                                                                    <div class="col-lg-1">
                                                                        <label for="inputEmail3" class="control-label">B2</label>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputs" tabindex="4" id="dis_2_2" name="dis_2_2">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <label for="inputEmail3" class="control-label">mm</label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">soundness</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <label for="inputEmail3" class="control-label">(B<sub>1</sub>-A<sub>1</sub>)</label>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputs" tabindex="4" id="diff_1" name="diff_1">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <label for="inputEmail3" class="control-label">mm</label>
                                                                    ...
                                                                    <div class="col-lg-1">
                                                                        <label for="inputEmail3" class="control-label">(B<sub>2</sub>-A<sub>2</sub>)</label>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputs" tabindex="4" id="diff_2" name="diff_2">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <label for="inputEmail3" class="control-label">mm</label>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">soundness Mean Value</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <label for="inputEmail3" class="control-label">((B<sub>1</sub>-A<sub>1</sub>) + (B<sub>2</sub>-A<sub>2</sub>)) / 2 =</label>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control inputs" tabindex="4" id="soundness" name="soundness" disabled>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <label for="inputEmail3" class="control-label">mm</label>
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="col-sm-2 control-label">soundness</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="col-sm-2 control-label">soundness Mean Value</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="panel-heading" id="sett">
                                                            <h4 class="panel-title">
                                                                <a data-toggle="collapse" data-parent="#accordion" href="#collapse4">
                                                                    <h4 class="panel-title">
                                                                        <b>INITITAL AND FINAL SETTING TIME</b>
                                                                    </h4>
                                                                </a>
                                                            </h4>
                                                        </div>
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="set_con" name="set_con">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Amount of Water to be Taken :</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Humidity in Closet :</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="set_humidity2" name="set_humidity2">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Initial Setting Time Test</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Start Time :</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="initial_s" name="initial_s">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Finish Time</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="initial_f" name="initial_f">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Final Setting Time Test</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="final_s" name="final_s">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="final_f" name="final_f">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                        ...
                                                        <div id="collapse5" class="panel-collapse collapse">
                                                            <div class="panel-body">
                                                                <div class="row">
                                                                    <div class="col-lg-8">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <label for="inputEmail3" class="col-sm-4 control-label label-right">Density by Lechatelier flask</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="den_weight" name="den_weight">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Initial Reading of kerosene =</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <div class="form-group">
                                                                            <label for="inputEmail3" class="control-label">A<sub>1</sub></label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-1">
                                                                        <div class="form-group">
                                                                            <label for="inputEmail3" class="control-label">cm<sup>3</sup></label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <div class="form-group">
                                                                            <label for="inputEmail3" class="control-label">A<sub>2</sub></label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-1">
                                                                        <div class="form-group">
                                                                            <label for="inputEmail3" class="col-sm-2 control-label">cm<sup>3</sup></label>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Final Reading of kerosene with Cement =</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <div class="form-group">
                                                                            <label for="inputEmail3" class="control-label">B<sub>1</sub></label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-1">
                                                                        <div class="form-group">
                                                                            <label for="inputEmail3" class="control-label">B<sub>2</sub></label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label"> Volume of Liquid</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <div class="form-group">
                                                                            <label for="inputEmail3" class="control-label">(A<sub>1</sub> - B<sub>1</sub>)</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="den_displaced" name="den_displaced" disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                    ...
                                                                    <div class="col-lg-1">
                                                                        <div class="form-group">
                                                                            <label for="inputEmail3" class="control-label">(A<sub>2</sub> - B<sub>2</sub>)</label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="den_displaced1" name="den_displaced1" disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Mass of Cement in (gm)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Density (D) = ------------------------------------ = <br> <span style="margin-left:40%;">Displaced Volume in (cm<sup>3</sup>)</span></label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-1">
                                                                        <div class="form-group">
                                                                            <label for="inputEmail3" class="control-label">D<sub>1</sub></label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-1">
                                                                        <div class="form-group">
                                                                            <label for="inputEmail3" class="control-label">D<sub>2</sub></label>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Density Mean Value (D) :- (D<sup>1</sup> + D<sup>2</sup>) / 2 =</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="avg_density" name="avg_density" disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label"><b>Volume of Cement</b></label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">m2 = m3 = Weight of Mercury (With Cement) in gm = </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Volume of Cement (V) = ----------------------- cm 3 =</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Weight of Cement = 0.5 x (p) x (V) =</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Amount of sample m (gm)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_1" name="fin_1">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Volume of cement bed V (cm³)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_2" name="fin_2">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Density p<sub>o</sub>, (g/cc)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_3" name="fin_3">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Density p, (g/cc)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_4" name="fin_4">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Porosity, e<sub>o</sub></label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_5" name="fin_5">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Porosity, e</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_6" name="fin_6">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Air Viscosity at the mean of three temperature, √0.1ή0</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_7" name="fin_7">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Air Viscosity at test temprature taken, √0.1ή0</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_8" name="fin_8">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Time in Second - t<sub>1</sub></label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_9" name="fin_9">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Time in Second-t<sub>1</sub> (Bed-1)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-6">
                                                                                <input type="text" class="form-control" id="fin_10" name="fin_10">
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <input type="text" class="form-control" id="fin_11" name="fin_11">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Time in Second-t<sub>2</sub></label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_12" name="fin_12">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Time in S, t<sub>1</sub> (Average of Bed-1)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_13" name="fin_13" disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Time in Second-t<sub>3</sub></label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_14" name="fin_14">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Time in Second-t<sub>2</sub> (Bed -2)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-6">
                                                                                <input type="text" class="form-control" id="fin_15" name="fin_15">
                                                                            </div>
                                                                            <div class="col-sm-6">
                                                                                <input type="text" class="form-control" id="fin_16" name="fin_16">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Time in Second t<sub>0</sub> (Average of t₁, t₂ & t₃)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_17" name="fin_17">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Time in S, t2 (Average of Bed-2)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_18" name="fin_18" disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Specific Surface S<sub>0,</sub> (cm²/g)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_19" name="fin_19">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Specific Surface S, (cm²/g)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_20" name="fin_20">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">For m = (1-e) p V</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="fin_21" name="fin_21">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Specific Surface for Bed-1</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Specific Surface for Bed-2</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Average of Specific Surface, Bed-1 and Bed-2 </label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-1">
                                                                        <label for="inputEmail3" class="control-label">cm<sup>2</sup>/g</label>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="d_t_3" name="d_t_3" disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-1">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-1">
                                                                        <label for="inputEmail3" class="control-label">m<sup>2</sup>/Kg</label>
                                                                    </div>
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                    ...
                                                                    <div class="col-lg-3">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <input type="text" class="form-control" id="w_t_3" name="w_t_3" disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-sm-1">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="col-lg-8">
                                                                                <div class="form-group">
                                                                                    <div class="col-sm-12">
                                                                                        <label for="inputEmail3" class="control-label">Dry weight of Cement(g)</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>																		
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="col-lg-8">
                                                                                <div class="form-group">
                                                                                    <div class="col-sm-12">
                                                                                        <label for="inputEmail3" class="control-label">weight of Cement residue on 90 mic. Sieve (g)</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>																		
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <div class="col-lg-8">
                                                                                <div class="form-group">
                                                                                    <div class="col-sm-12">
                                                                                        <label for="inputEmail3" class="control-label">Cement residue on the 90 mic. Sieve(%)</label>
                                                                                    </div>
                                                                                </div>
                                                                            </div>																		
                                                                        </div>
                                                            ...
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-8">
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <label for="inputEmail3" class="control-label">Cube Size :</label>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                                            <div class="form-group">
                                                                    ...
                                                                    <div class="col-lg-2">
                                                                        <div class="form-group">
                                                                            <input type="text" class="form-control" id="com_humidity_2" name="com_humidity_2">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <br><br>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <label for="inputEmail3" class="control-label">L</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="col-lg-2">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <label for="inputEmail3" class="control-label">H</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <label for="inputEmail3" class="control-label">Cross Sectional Area(mm <sup>2</sup> )</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <label for="inputEmail3" class="control-label">Compressive Strength<br>(N/mm <sup>2</sup> )</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <label for="inputEmail3" class="control-label">Average
                                                                                        Compressive Strength<br>(N/mm <sup>2</sup> )</label>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" id="area_1" name="area_1" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" id="avg_com_1" name="avg_com_1" disabled>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" id="area_2" name="area_2" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" id="area_3" name="area_3" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" id="area_4" name="area_4" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" id="avg_com_2" name="avg_com_2" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" id="area_5" name="area_5" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" id="area_6" name="area_6" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" id="area_7" name="area_7" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" id="avg_com_3" name="avg_com_3" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" id="area_8" name="area_8" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                            <div class="form-group">
                                                                                <div class="col-sm-12">
                                                                                    <input type="text" class="form-control" id="area_9" name="area_9" disabled>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-2">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <table border="1px solid black" align="center" width="100%" id="aaaa">
                                                                ...
                                                                <?php
                                                                $query = "select * from span_cement WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
    ...
    $(document).ready(function() {
        ...
        function consistency_auto() {
           ...
           /*  $('#vol_5').val(randomNumberFromRange(20.00, 60.00).toFixed(0));
            $('#wtr_5').val(randomNumberFromRange(20.00, 60.00).toFixed(2));
            $('#final_wtr').val(randomNumberFromRange(20.00, 60.00).toFixed(0)); */
        ...
        function set_auto() {
            ...
            $('#set_con').val(randomNumberFromRange(20.00, 60.00).toFixed(0));
            $('#set_humidity2').val(randomNumberFromRange(20.00, 60.00).toFixed(0));
            $('#initial_s').val(randomNumberFromRange(20.00, 60.00).toFixed(0));
            $('#initial_f').val(randomNumberFromRange(20.00, 60.00).toFixed(0));
            $('#initial_time').val(randomNumberFromRange(20.00, 60.00).toFixed(0));
            $('#final_s').val(randomNumberFromRange(20.00, 60.00).toFixed(0));
            $('#final_f').val(randomNumberFromRange(20.00, 60.00).toFixed(0));
            $('#final_time').val(randomNumberFromRange(20.00, 60.00).toFixed(0));
            ...
            var a_time_hr = randomNumberFromRange(9, 15).toFixed();
		...
		$('#fin_10,#fin_11,#fin_15,#fin_16').change(function(){
					var fin_10 = $('#fin_10').val();
                    var fin_11 = $('#fin_11').val();
					var fin_13 = $('#fin_13').val();
                    var fin_15 = $('#fin_15').val();
                    var fin_16 = $('#fin_16').val();
                    var fin_18 = $('#fin_18').val();
					
					var  fin_13 = ((+fin_11) + (+fin_11))/2;
					$('#fin_13').val(fin_13.toFixed(2));
					
					var  fin_18 = ((+fin_15) + (+fin_16))/2;
					$('#fin_18').val(fin_18.toFixed(2));
		});
		$('#w_t_1,#w_t_2,#d_t_1,#d_t_2').change(function(){
					var w_t_1 = $('#w_t_1').val();
					var w_t_2 = $('#w_t_2').val();
					var w_t_3 = $('#w_t_3').val();
					var d_t_1 = $('#d_t_1').val();
					...
					var w_t_3 = ((+w_t_1)+ (+w_t_2))/2;
					$('#w_t_3').val(w_t_3.toFixed(2));
					
					var d_t_3 = ((+d_t_1)+ (+d_t_2))/2;
					$('#d_t_3').val(d_t_3.toFixed(2));
		});
		$('#dis_1_1,#dis_1_2,#dis_2_1,#dis_2_2').change(function(){
					var dis_1_1 = $('#dis_1_1').val();
					var dis_1_2 = $('#dis_1_2').val();
					var dis_2_1 = $('#dis_2_1').val();
					var dis_2_2 = $('#dis_2_2').val();
					
					var diff_1= (dis_2_1) - (dis_1_1);
					$('#diff_1').val(diff_1.toFixed(2));
					
					var diff_2= (dis_2_2) - (dis_1_2);
					$('#diff_2').val(diff_2.toFixed(2));
					
					var soundness = ((+diff_1) + (+diff_2))/2;
					$('#soundness').val(soundness.toFixed(2));
		});
		
		 $('#l1,#l2,#l3,#l4,#l5,#l6,#l7,#l8,#l9,#b1,#b2,#b3,#b4,#b5,#b6,#b7,#b8,#b9,#h1,#h2,#h3,#h4,#h5,#h6,#h7,#h8,#h9,#load_1,#load_2,#load_3,#load_4,#load_5,#load_6,#load_7,#load_8,#load_9').change(function() {
					...
					var area_1 = (+l1) * (+b1);
					$('#area_1').val(area_1.toFixed(2));
					var com_1 = ( (+load_1)*100)/ (+area_1);
					$('#com_1').val(com_1.toFixed(2));
					
					var area_2 = (+l2) * (+b2); 
					$('#area_2').val(area_2.toFixed(2));
					var com_2 = ( (+load_2)*100)/ (+area_2);
					$('#com_2').val(com_2.toFixed(2));
					
					var area_3 = (+l3) * (+b3);
					$('#area_3').val(area_3.toFixed(2));
					var com_3 = ( (+load_3)*100)/ (+area_2);
					$('#com_3').val(com_3.toFixed(2));
					
					var avg_com_1 = ((+com_1) + (+com_2) + (+com_3))/3;
					$('#avg_com_1').val(avg_com_1.toFixed(2));
					
					
					var area_4 = (+l4) * (+b4);
					$('#area_4').val(area_4.toFixed(2));
					var com_4 = ( (+load_4)*100)/ (+area_5);
					$('#com_4').val(com_4.toFixed(2));
					
					var area_5 = (+l5) * (+b5); 
					$('#area_5').val(area_5.toFixed(2));
					var com_5 = ( (+load_5)*100)/ (+area_5);
					$('#com_5').val(com_5.toFixed(2));
					
					var area_6 = (+l6) * (+b6);
					$('#area_6').val(area_6.toFixed(2));
					var com_6 = ( (+load_6)*100)/ (+area_6);
					$('#com_6').val(com_6.toFixed(2));
					
					var avg_com_2 = ((+com_4) + (+com_5) + (+com_6))/3;
					$('#avg_com_2').val(avg_com_2.toFixed(2));
					
					
					var area_7 = (+l7) * (+b7);
					$('#area_7').val(area_7.toFixed(2));
					var com_7 = ( (+load_7)*100)/ (+area_7);
					$('#com_7').val(com_7.toFixed(2));
					
					var area_8 = (+l8) * (+b8); 
					$('#area_8').val(area_8.toFixed(2));
					var com_8 = ( (+load_8)*100)/ (+area_8);
					$('#com_8').val(com_8.toFixed(2));
					
					var area_9 = (+l9) * (+b9);
					$('#area_9').val(area_9.toFixed(2));
					var com_9 = ( (+load_9)*100)/ (+area_9);
					$('#com_9').val(com_9.toFixed(2));
					
					var avg_com_3 = ((+com_7) + (+com_8) + (+com_9))/3;
					$('#avg_com_3').val(avg_com_3.toFixed(2));
									  				
			 
			 
		});
		$('#den_intial,#den_intial1,#den_final,#den_final1,#density,#density1').change(function(){
			...
			var den_displaced = (+den_intial) - (+den_final);
			$('#den_displaced').val(den_displaced.toFixed(2));
			
			var den_displaced1 = (+den_intial1) - (+den_final1);
			$('#den_displaced1').val(den_displaced1.toFixed(2));
			
			var avg_density = ((+density) + (+density1))/2
			$('#avg_density').val(avg_density.toFixed(2));
    ...
    function getGlazedTiles() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo $base_url; ?>saveCement_span.php',
        ...
        if (type == 'add') {
            ...
            for (var i = 0; i < aa.length; i++) {
                if (aa[i] == "set") {
                    ...
                    var set_con = $('#set_con').val();
                    var set_humidity2 = $('#set_humidity2').val();
                    var initial_s = $('#initial_s').val();
                    var initial_f = $('#initial_f').val();
                    var final_s = $('#final_s').val();
                    var final_f = $('#final_f').val();
                    break;
                } else {
                    var chk_set = "0";
            ...
            for (var i = 0; i < aa.length; i++) {
                if (aa[i] == "fin") {
                    ...
                    var fin_10 = $('#fin_10').val();
                    var fin_11 = $('#fin_11').val();
                    var fin_12 = $('#fin_12').val();
                    var fin_13 = $('#fin_13').val();
                    var fin_14 = $('#fin_14').val();
                    var fin_15 = $('#fin_15').val();
                    var fin_16 = $('#fin_16').val();
                    var fin_17 = $('#fin_17').val();
                    var fin_18 = $('#fin_18').val();
                    var fin_19 = $('#fin_19').val();
                    var fin_20 = $('#fin_20').val();
                    var fin_21 = $('#fin_21').val();
                    var fin_22 = $('#fin_22').val();
                    var fin_23 = $('#fin_23').val();
            ...
            for (var i = 0; i < aa.length; i++) {
                if (aa[i] == "com") {
                    ...
                    var com_8 = $('#com_8').val();
                    var com_9 = $('#com_9').val();
                    var com_humidity_2 = $('#com_humidity_2').val();
            ...
            success: function(data) {
                ...
                for (var i = 0; i < aa.length; i++) {
                    if (aa[i] == "set") {
                        ...
                        $('#set_con').val(data.set_con);
                        $('#set_humidity2').val(data.set_humidity2);
                        $('#initial_s').val(data.initial_s);
                        $('#initial_f').val(data.initial_f);
                        $('#final_s').val(data.final_s);
                        $('#final_f').val(data.final_f);
                ...
                for (var i = 0; i < aa.length; i++) {
                    if (aa[i] == "fin") {
                        ...
                        $('#fin_1').val(data.fin_1);
                        $('#fin_2').val(data.fin_2);
                        $('#fin_3').val(data.fin_3);
                        $('#fin_4').val(data.fin_4);
                        $('#fin_5').val(data.fin_5);
                        $('#fin_6').val(data.fin_6);
                        $('#fin_7').val(data.fin_7);
                        $('#fin_8').val(data.fin_8);
                        $('#fin_9').val(data.fin_9);
                        $('#fin_10').val(data.fin_10);
                        $('#fin_11').val(data.fin_11);
                        $('#fin_12').val(data.fin_12);
                        $('#fin_13').val(data.fin_13);
                        $('#fin_14').val(data.fin_14);
                        $('#fin_15').val(data.fin_15);
                        $('#fin_16').val(data.fin_16);
                        $('#fin_17').val(data.fin_17);
                        $('#fin_18').val(data.fin_18);
                        $('#fin_19').val(data.fin_19);
                        $('#fin_20').val(data.fin_20);
                        $('#fin_21').val(data.fin_21);
                        $('#fin_22').val(data.fin_22);
                        $('#fin_23').val(data.fin_23);
                ...
                for (var i = 0; i < aa.length; i++) {
                    if (aa[i] == "com") {
                        ...
                        $('#com_humidity_2').val(data.com_humidity_2);
