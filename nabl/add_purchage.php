				...
				<div class="tab-content">
					...
					<form class="" method="post" >
							...
							<div class="col-sm-4" style="text-align: center;">
											<button type="button" class="btn btn-primary btn-lg btn3d " id="btn_save_client" name="sub_client" tabindex="25" onclick="saveclient('add_purchase')" style="margin-bottom:25px;    border-radius: 20px;"><span class="glyphicon glyphicon-cloud"></span> Add Purchase</button>
    ...
    $.ajax({
        ...
        success:function(data){
			...
			if(data.status=="0")
			{
				...
				alert("Purchage Bill Is Successfully Saved");
