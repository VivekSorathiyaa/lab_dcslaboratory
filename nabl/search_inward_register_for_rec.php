...
?>
									<a href="<?php echo $base_url; ?>set_inward_print.php?where=<?php echo $is_available;?>&&start_date=<?php echo $start_date;?>&&end_date=<?php echo $end_date;?>" target="_blank" class="btn btn-primary">PRINT</a>
