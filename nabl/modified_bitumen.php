			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">POLYMER MODIFIED BITUMEN</h2>
					</div>
						...
						<div class="row">
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control inputs" tabindex="4" id="room_temp" value="" name="room_temp">
									</div>
								</div>
							</div>
						</div><br>
							...
							<div class="col-lg-12">
								<div class="form-group">
									...
									<div class="col-sm-2">
										...
										<?php
										$querys_job1 = "SELECT * FROM modified_bitumen WHERE `is_deleted`='0' and lab_no='$lab_no'";
									...
									?>
										<div class="col-sm-2">
											<a target='_blank' href="<?php echo $base_url; ?>print_report/print_modified_bitumen.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
										</div>

									<?php } ?>
									<div class="col-sm-2">
										<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/modified_bitumen_back.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
						...
						<div class="panel-group" id="accordion">
							...
							if (mysqli_num_rows($result_upload) > 0) { ?>
								...
								?>
												...
												<div class="panel-body">
													...
													<div class="row">
														...
														<div class="col-lg-4">
															<div class="form-group">
																...
																<div class="col-sm-8">
																	<input type="text" class="form-control" id="pen_temp" name="pen_temp">
																</div>
															</div>
														</div>
														<div class="col-lg-3">
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">PENETRATION (in 1/10 mm)</label>
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
													...
													<div class="row">
														<div class="col-md-12">
															...
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="pint_1" name="pint_1">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="pint_2" name="pint_2">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="pint_3" name="pint_3">
																</div>
															</div>
													...
													<div class="row">
														<div class="col-md-12">
															...
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="pfin_1" name="pfin_1">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="pfin_2" name="pfin_2">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="pfin_3" name="pfin_3">
																</div>
															</div>
												...
												<div class="panel-body">
													...
													<div class="row">
														...
														<div class="col-lg-4">
															<div class="form-group">
																<label for="inputEmail3" class="col-sm-4 control-label label-right">Temperature :</label>
																<div class="col-sm-8">
																	<input type="text" class="form-control" id="sof_temp" name="sof_temp">
																</div>
															</div>
														</div>
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">SOFTENING POINT</label>
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="sof_0" name="sof_0">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="sof_1" name="sof_1">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="hidden" class="form-control" id="sof_2" name="sof_2">
																</div>
															</div>
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">AVERAGE SOFTENING POINT</label>
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
									...
									<?php } else if ($r1['test_code'] == "ela") {
										$test_check .= "ela,"; ?>

										<div class="panel panel-default" id="ela">
											<div class="panel-heading" id="txtela">
												<h4 class="panel-title">
													<a data-toggle="collapse" data-parent="#accordion" href="#collapse_ela">
														<h4 class="panel-title">
															<b>ELASTIC RECOVERY</b>
														</h4>
													</a>
												</h4>
											</div>
											<div id="collapse_ela" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="row">
													<br>
														<div class="col-lg-5">
															<div class="form-group">
																<div class="col-sm-1">
																	<label for="chk_ela">1.</label>
																	<input type="checkbox" class="visually-hidden" name="chk_ela" id="chk_ela" value="chk_ela"><br>
																</div>
																<label for="inputEmail3" class="col-sm-11 control-label label-right">ELASTIC RECOVERY</label>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
																<label for="inputEmail3" class="col-sm-4 control-label label-right">Temperature :</label>
																<div class="col-sm-8">
																	<input type="text" class="form-control" id="ela_temp" name="ela_temp">
																</div>
															</div>
														</div>
													<br>
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">ELASTIC RECOVERY</label>
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="ela_0" name="ela_0">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="ela_1" name="ela_1">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="hidden" class="form-control" id="ela_2" name="ela_2">
																</div>
															</div>
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">AVERAGE ELASTIC RECOVERY</label>
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="avg_ela" name="avg_ela">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
												...
												<div class="panel-body">
													...
													<div class="row">
														...
														<div class="col-lg-2">
															<div class="form-group">
																...
																<label for="inputEmail3" class="col-sm-4 control-label label-right">DUCTILITY</label>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">DUCTILITY (lENGTH OF BITUMEN THREAD IN CM)</label>
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">INITIAL lENGTH (CM) IL</label>
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="dint_1" name="dint_1">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="dint_2" name="dint_2">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="dint_3" name="dint_3">
																</div>
															</div>
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">FINAL lENGTH (CM) FL</label>
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="dfin_1" name="dfin_1">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="dfin_2" name="dfin_2">
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="dfin_3" name="dfin_3">
																</div>
															</div>
													...
													<div class="row">
														<div class="col-md-12">
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">AVERAGE DUCTILITY (LENGHT IN CM)</label>
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
															...
															<div class="col-md-3">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">DUCTILITY OF BITUMEN:</label>
																</div>
															</div>
															<div class="col-md-3">
																<div class="form-group">
																	<input type="text" class="form-control" id="duc_bit" name="duc_bit">
																</div>
															</div>
											...
											<div id="collapse31" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="row">
														...
														<div class="col-lg-6">
															<div class="form-group">
																...
																<label for="inputEmail3" class="col-sm-4 control-label label-right">SPECIFIC GRAVITY TEST</label>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
													...
													<div class="row">
														<div class="col-lg-2">
															<div class="form-group">
																<label for="inputEmail3" class="control-label">Weight of Bottle (A)</label>
															</div>
														</div>

														<div class="col-lg-2">
															<div class="form-group">
																<label for="inputEmail3" class="control-label">Weight of Bottle Filled in Distilled Water (B)</label>
															</div>
														</div>
														...
														<div class="col-lg-2">
															<div class="form-group">
																<label for="inputEmail3" class="control-label">Weight if about Half Filled Bitumen (C)</label>
															</div>
														</div>

														<div class="col-lg-2">
															<div class="form-group">
																<label for="inputEmail3" class="control-label">Weight of about Half Filled With Bitumen and the rest with Distilled Water (D)</label>
															</div>
														</div>

														<div class="col-lg-2">
															<div class="form-group">
																<label for="inputEmail3" class="control-label">Specific Gravity G = (c - a) / (b - a)-(d - c)</label>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-2">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="sp_1" name="sp_1" readonly>
																</div>
															</div>
														</div>
														<div class="col-lg-2">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="avg_sp" name="avg_sp">
																</div>
															</div>
														</div>
											...
											<div id="collapse321" class="panel-collapse collapse">
												<div class="panel-body">
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																...
																<label for="inputEmail3" class="col-sm-8 control-label label-right">ABSOLUTE VISCOSITY</label>
															</div>
														</div>
														<div class="col-lg-5">
															<div class="form-group">
																<label for="inputEmail3" class="col-sm-4 control-label label-right">VACCUM PRESSURE :</label>
																<div class="col-sm-8">
																	<input type="text" class="form-control" id="abs_vac" name="abs_vac"><br>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
																<label for="inputEmail3" class="col-sm-4 control-label label-right">Temperature :</label>
																<div class="col-sm-8">
																	<input type="text" class="form-control" id="abs_temp" name="abs_temp"><br>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<label for="inputEmail3" class="control-label">Sample 1</label>
															</div>
														</div>
														...
														<div class="col-lg-3">
															<div class="form-group">
																<label for="inputEmail3" class="control-label">Sample 2</label>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Time Req by Bitumen to Cross The Bulb B(T1)</label>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Bulb B Factor (K1)</label>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Flow Time In Sec (tB = K1 * T1)</label>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Time Req. By Bitumen to Cross the bulb-C (T2)</label>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Bulb -C Factor (K2)</label>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Flow Time In Sec (Tc = K2 * T2)</label>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Viscosity in Poises KT = (K1 * T1 + K2 * T2)/2</label>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Average Viscosity in Poises</label>
																</div>
															</div>
														</div>
												...
												<div class="panel-body">
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																...
																<label for="inputEmail3" class="col-sm-8 control-label label-right">KINEMATIC VISCOSITY</label>
															</div>
														</div>
														<div class="col-lg-5">
															<div class="form-group">
																<label for="inputEmail3" class="col-sm-4 control-label label-right">VACCUM PRESSURE :</label>
																<div class="col-sm-8">
																	<input type="text" class="form-control" id="kin_vac" name="kin_vac"><br>
																</div>
															</div>
														</div>
														<div class="col-lg-4">
															<div class="form-group">
																<label for="inputEmail3" class="col-sm-4 control-label label-right">Temperature</label>
																<div class="col-sm-8">
																	<input type="text" class="form-control" id="kin_temp" name="kin_temp"><br>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Time Req. By Bitumen to Cross the bulb -B (t)</label>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Bulb-B Factor (C) </label>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Kinematic Viscosity cSt,=C * t</label>
																</div>
															</div>
														</div>
												...
												<div id="collapse36" class="panel-collapse collapse">
													<div class="panel-body">
														...
														<div class="row">
															<div class="col-lg-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Weight of sample before heating w1 (gm)</label>
																</div>
															</div>

															<div class="col-lg-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Weight of sample after heating w2 (gm)</label>
																</div>
															</div>
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Loss in wt. w1 - w2 (gm)</label>
																</div>
															</div>

															<div class="col-lg-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Loss in wt. (%) = (w1 -w2)/w1 * 100</label>
																</div>
															</div>
												...
												<div class="panel-body">
													<div class="row">
														...
														<div class="col-lg-3">
															<div class="form-group">
																<div class="col-sm-1">
																	<label for="chk_fla">7.</label>
																	<input type="checkbox" class="visually-hidden" name="chk_fla" id="chk_fla" value="chk_fla"><br>
																</div>
																<label for="inputEmail3" class="col-sm-8 control-label label-right">FLASH POINT</label>
															</div>
														</div>
													</div>
													<div class="row">
													...
													<div class="row">
														...
														<div class="col-lg-2">
															<div class="form-group">
																<div class="col-sm-12">
																	<label for="inputEmail3" class="control-label">Flash Point</label>
																</div>
															</div>
														</div>
														...
														<div class="col-lg-2">
															<div class="form-group">
																<div class="col-sm-12">
																	<input type="text" class="form-control" id="fla_1" name="fla_1">
																</div>
															</div>
														</div>
													</div>
									...
									<div class="row">
										<div class="col-lg-12">
											<table border="1px solid black" align="center" width="100%" id="aaaa">
												...
												<?php
												$query = "select * from modified_bitumen WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		$('#chk_ela').change(function() {
			if (this.checked) {
				$('#txtela').css("background-color", "var(--success)");
			} else {
				$('#txtela').css("background-color", "white");
			}
		...
		function sp_auto() {
			...
			var avg_sp = randomNumberFromRange(0.99, 1.01).toFixed(2);
			$('#avg_sp').val(avg_sp);
			avg_sp = $('#avg_sp').val();
			//var av = randomNumberFromRange(-0.02,0.01).toFixed(2);
			var sp_1 = $('#avg_sp').val();
			//var sp_2  = parseInt(avg_sp) + parseFloat(av);
		...
		function one() {
			...
			var ca1 = (+sp_c_1) - (+sp_a_1);
			var ba1 = (+sp_b_1) - (+sp_a_1);
			var dc1 = (+sp_d_1) - (+sp_c_1);
			var eq1_1 = (+ba1) - (+dc1);
			var sp_1 = (+ca1) / (+eq1_1);
			var avg_sp = sp_1;
		...
		function sof_auto() {
			...
			if (tt % 2 == 0) {
				...
				var sof_0 = (+avgsof) - (+rnf);
				var sof_1 = (+avgsof) + (+rnf);
			...
			$('#sof_0').val(sof_0.toFixed(1));
			$('#sof_1').val(sof_1.toFixed(1));
			$('#sof_2').val("");
		}
		...
		$('#sof_0').change(function() {
			sof_1_2_3();
		});
		$('#sof_1').change(function() {
			sof_1_2_3();
		});
		...
		function ela_auto() {
			...
			if (grades == "vg-10") {
				...
				var items2 = Array(1,2,3,4);
				var avg_ela = jQuery.rand(items2);
			} else if (grades == "vg-20") {
				var items2 = Array(1,2,3,4);
				var avg_ela = jQuery.rand(items2);
			} else if (grades == "vg-30") {
			...
			$('#avg_ela').val(avg_ela.toFixed(1));
			var avgela = $('#avg_ela').val();
			var tt = randomNumberFromRange(0, 9).toFixed();
			if (tt % 2 == 0) {
				var rnf = randomNumberFromRange(-0.4, 0.4).toFixed(1);
				var ela_0 = (+avgela) - (+rnf);
				var ela_1 = (+avgela) + (+rnf);
			...
			$('#ela_0').val(ela_0.toFixed(1));
			$('#ela_1').val(ela_1.toFixed(1));
			$('#ela_2').val("");
		}
		...
		$('#avg_ela').change(function() {
			if ($("#chk_ela").is(':checked')) {
				...
				if(grades=="vg-10")
				{
					...
					var items1 = Array(41.0,41.5,42.0,42.5,43.0,43.5,44.0,44.5,45.0,45.5,46.0,46.5,47.0);
					var avg_ela = jQuery.rand(items1);
				}
				else if(grades=="vg-20")
				{
					var items1 = Array(46.0,46.5,47.0,47.5,48.0,48.5,49.0,49.5,50.0,50.5);
		...
		$('#ela_0').change(function() {
			ela_1_2_3();
		});
		$('#ela_1').change(function() {
			ela_1_2_3();
		});
		$('#ela_2').change(function() {
			ela_1_2_3();
		});
		...
		function ela_1_2_3() {
			...
			var avg_ela = ((+ela_0) + (+ela_1)) / 2;

			var as = (+avg_ela) / 0.5;
			var temp = as.toFixed();
			var ans = (+temp) * 0.5;
			$('#avg_ela').val(ans.toFixed(1));
		}
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_modified_bitumen.php',
		...
		if (type == 'add') {
			...
			for (var i = 0; i < aa.length; i++) {
				if (aa[i] == "pen") {
					...
					var pen_2 = $('#pen_2').val();
					var pen_3 = $('#pen_3').val();
					var pint_1 = $('#pint_1').val();
					var pint_2 = $('#pint_2').val();
					var pint_3 = $('#pint_3').val();
					var pfin_1 = $('#pfin_1').val();
					var pfin_2 = $('#pfin_2').val();
					var pfin_3 = $('#pfin_3').val();
			...
			for (var i = 0; i < aa.length; i++) {
				if (aa[i] == "duc") {
					...
					var duc_2 = $('#duc_2').val();
					var duc_3 = $('#duc_3').val();
					var dint_1 = $('#dint_1').val();
					var dint_2 = $('#dint_2').val();
					var dint_3 = $('#dint_3').val();
					var dfin_1 = $('#dfin_1').val();
					var dfin_2 = $('#dfin_2').val();
					var dfin_3 = $('#dfin_3').val();
					var caste_date3 = $('#caste_date3').val();
					var test_date3 = $('#test_date3').val();

					var avg_duc = $('#avg_duc').val();
					var duc_bit = $('#duc_bit').val();
			...
			for (var i = 0; i < aa.length; i++) {
				if (aa[i] == "ela") {
					...
					if (document.getElementById('chk_ela').checked) {
						var chk_ela = "1";
					} else {
						var chk_ela = "0";
					}
					...
					var ela_1 = $('#ela_1').val();
					var ela_2 = $('#ela_2').val();
					var ela_temp = $('#ela_temp').val();
					var avg_ela = $('#avg_ela').val();
			...
			for (var i = 0; i < aa.length; i++) {
				if (aa[i] == "fla") {
					...
					if (document.getElementById('chk_fla').checked) {
						var chk_fla = "1";
					} else {
						var chk_fla = "0";
					}
			...
			for (var i = 0; i < aa.length; i++) {
				if (aa[i] == "abs") {
					...
					var avg_abs = $('#avg_abs').val();
					var abs_temp = $('#abs_temp').val();
					var abs_vac = $('#abs_vac').val();
			...
			for (var i = 0; i < aa.length; i++) {
				if (aa[i] == "kin") {
					...
					var kin_temp = $('#kin_temp').val();
					var kin_vac = $('#kin_vac').val();
					var avg_kin = $('#avg_kin').val();
			...
			billData = '&action_type=' + type + '&report_no=' + report_no + '&job_no=' + job_no + '&lab_no=' + lab_no + '&tank_no=' + tank_no + '&lot_no=' + lot_no + '&bitumin_grade=' + bitumin_grade + '&bitumin_make=' + bitumin_make + '&chk_pen=' + chk_pen + '&pen_temp=' + pen_temp + '&pen_1=' + pen_1 + '&pen_2=' + pen_2 + '&pen_3=' + pen_3 + '&pint_1=' + pint_1 + '&pint_2=' + pint_2 + '&pint_3=' + pint_3 + '&pfin_1=' + pfin_1 + '&pfin_2=' + pfin_2 + '&pfin_3=' + pfin_3 + '&avg_pen=' + avg_pen + '&chk_sof=' + chk_sof + '&sof_0=' + sof_0 + '&sof_1=' + sof_1 + '&sof_2=' + sof_2 + '&sof_temp=' + sof_temp +'&ela_temp=' + ela_temp + '&avg_sof=' + avg_sof + '&chk_ela=' + chk_ela + '&ela_0=' + ela_0 + '&ela_1=' + ela_1 + '&ela_2=' + ela_2 + '&avg_ela=' + avg_ela + '&chk_duc=' + chk_duc + '&duc_temp=' + duc_temp + '&duc_1=' + duc_1 + '&duc_2=' + duc_2 + '&duc_3=' + duc_3 + '&dint_1=' + dint_1 + '&dint_2=' + dint_2 + '&dint_3=' + dint_3 + '&dfin_1=' + dfin_1 + '&dfin_2=' + dfin_2 + '&dfin_3=' + dfin_3 + '&avg_duc=' + avg_duc + '&duc_bit=' + duc_bit + '&chk_sp=' + chk_sp + '&sp_temp=' + sp_temp + '&sp_a_1=' + sp_a_1 + '&sp_a_2=' + sp_a_2 + '&sp_b_1=' + sp_b_1 + '&sp_b_2=' + sp_b_2 + '&sp_c_1=' + sp_c_1 + '&sp_c_2=' + sp_c_2 + '&sp_d_1=' + sp_d_1 + '&sp_d_2=' + sp_d_2 + '&sp_1=' + sp_1 + '&sp_2=' + sp_2 + '&avg_sp=' + avg_sp + '&chk_abs=' + chk_abs + '&abs_1_1=' + abs_1_1 + '&abs_1_2=' + abs_1_2 + '&abs_2_1=' + abs_2_1 + '&abs_2_2=' + abs_2_2 + '&abs_3_1=' + abs_3_1 + '&abs_3_2=' + abs_3_2 + '&abs_4_1=' + abs_4_1 + '&abs_4_2=' + abs_4_2 + '&abs_5_1=' + abs_5_1 + '&abs_5_2=' + abs_5_2 + '&abs_6_1=' + abs_6_1 + '&abs_6_2=' + abs_6_2 + '&abs_7_1=' + abs_7_1 + '&abs_7_2=' + abs_7_2 + '&abs_8_1=' + abs_8_1 + '&abs_8_2=' + abs_8_2 + '&abs_9_1=' + abs_9_1 + '&abs_9_2=' + abs_9_2 + '&avg_abs=' + avg_abs + '&chk_kin=' + chk_kin + '&kin_1_1=' + kin_1_1 + '&kin_1_2=' + kin_1_2 + '&kin_2_1=' + kin_2_1 + '&kin_2_2=' + kin_2_2 + '&kin_3_1=' + kin_3_1 + '&kin_3_2=' + kin_3_2 + '&kin_4_1=' + kin_4_1 + '&kin_4_2=' + kin_4_2 + '&kin_5_1=' + kin_5_1 + '&kin_5_2=' + kin_5_2 + '&kin_6_1=' + kin_6_1 + '&kin_6_2=' + kin_6_2 + '&avg_kin=' + avg_kin + '&chk_los=' + chk_los + '&los_temp=' + los_temp + '&los_w1_1=' + los_w1_1 + '&los_w1_2=' + los_w1_2 + '&los_w2_1=' + los_w2_1 + '&los_w2_2=' + los_w2_2 + '&los_wt_1=' + los_wt_1 + '&los_wt_2=' + los_wt_2 + '&los_1=' + los_1 + '&los_2=' + los_2 + '&avg_los=' + avg_los + '&caste_date1=' + caste_date1 + '&caste_date2=' + caste_date2 + '&caste_date3=' + caste_date3 + '&test_date1=' + test_date1 + '&test_date2=' + test_date2 + '&test_date3=' + test_date3 + '&kin_temp=' + kin_temp + '&kin_vac=' + kin_vac + '&abs_temp=' + abs_temp + '&abs_vac=' + abs_vac + '&room_temp=' + room_temp + '&chk_fla=' + chk_fla + '&fla_1=' + fla_1+'&ulr=' + ulr+'&amend_date=' + amend_date;
			...
			billData = $("#Glazed").find('.form').serialize() + '&action_type=' + type + '&idEdit=' + idEdit + '&report_no=' + report_no + '&job_no=' + job_no + '&lab_no=' + lab_no + '&tank_no=' + tank_no + '&lot_no=' + lot_no + '&bitumin_grade=' + bitumin_grade + '&bitumin_make=' + bitumin_make + '&chk_pen=' + chk_pen + '&pen_temp=' + pen_temp + '&pen_1=' + pen_1 + '&pen_2=' + pen_2 + '&pen_3=' + pen_3 + '&pint_1=' + pint_1 + '&pint_2=' + pint_2 + '&pint_3=' + pint_3 + '&pfin_1=' + pfin_1 + '&pfin_2=' + pfin_2 + '&pfin_3=' + pfin_3 + '&avg_pen=' + avg_pen + '&chk_sof=' + chk_sof + '&sof_0=' + sof_0 + '&sof_1=' + sof_1 + '&sof_temp=' + sof_temp +'&ela_temp=' + ela_temp + '&sof_2=' + sof_2 + '&avg_sof=' + avg_sof + '&chk_ela=' + chk_ela + '&ela_0=' + ela_0 + '&ela_1=' + ela_1 + '&ela_2=' + ela_2 + '&avg_ela=' + avg_ela + '&chk_duc=' + chk_duc + '&duc_temp=' + duc_temp + '&duc_1=' + duc_1 + '&duc_2=' + duc_2 + '&duc_3=' + duc_3 + '&dint_1=' + dint_1 + '&dint_2=' + dint_2 + '&dint_3=' + dint_3 + '&dfin_1=' + dfin_1 + '&dfin_2=' + dfin_2 + '&dfin_3=' + dfin_3 + '&avg_duc=' + avg_duc + '&duc_bit=' + duc_bit + '&chk_sp=' + chk_sp + '&sp_temp=' + sp_temp + '&sp_a_1=' + sp_a_1 + '&sp_a_2=' + sp_a_2 + '&sp_b_1=' + sp_b_1 + '&sp_b_2=' + sp_b_2 + '&sp_c_1=' + sp_c_1 + '&sp_c_2=' + sp_c_2 + '&sp_d_1=' + sp_d_1 + '&sp_d_2=' + sp_d_2 + '&sp_1=' + sp_1 + '&sp_2=' + sp_2 + '&avg_sp=' + avg_sp + '&chk_abs=' + chk_abs + '&abs_1_1=' + abs_1_1 + '&abs_1_2=' + abs_1_2 + '&abs_2_1=' + abs_2_1 + '&abs_2_2=' + abs_2_2 + '&abs_3_1=' + abs_3_1 + '&abs_3_2=' + abs_3_2 + '&abs_4_1=' + abs_4_1 + '&abs_4_2=' + abs_4_2 + '&abs_5_1=' + abs_5_1 + '&abs_5_2=' + abs_5_2 + '&abs_6_1=' + abs_6_1 + '&abs_6_2=' + abs_6_2 + '&abs_7_1=' + abs_7_1 + '&abs_7_2=' + abs_7_2 + '&abs_8_1=' + abs_8_1 + '&abs_8_2=' + abs_8_2 + '&abs_9_1=' + abs_9_1 + '&abs_9_2=' + abs_9_2 + '&avg_abs=' + avg_abs + '&chk_kin=' + chk_kin + '&kin_1_1=' + kin_1_1 + '&kin_1_2=' + kin_1_2 + '&kin_2_1=' + kin_2_1 + '&kin_2_2=' + kin_2_2 + '&kin_3_1=' + kin_3_1 + '&kin_3_2=' + kin_3_2 + '&kin_4_1=' + kin_4_1 + '&kin_4_2=' + kin_4_2 + '&kin_5_1=' + kin_5_1 + '&kin_5_2=' + kin_5_2 + '&kin_6_1=' + kin_6_1 + '&kin_6_2=' + kin_6_2 + '&avg_kin=' + avg_kin + '&chk_los=' + chk_los + '&los_temp=' + los_temp + '&los_w1_1=' + los_w1_1 + '&los_w1_2=' + los_w1_2 + '&los_w2_1=' + los_w2_1 + '&los_w2_2=' + los_w2_2 + '&los_wt_1=' + los_wt_1 + '&los_wt_2=' + los_wt_2 + '&los_1=' + los_1 + '&los_2=' + los_2 + '&avg_los=' + avg_los + '&caste_date1=' + caste_date1 + '&caste_date2=' + caste_date2 + '&caste_date3=' + caste_date3 + '&test_date1=' + test_date1 + '&test_date2=' + test_date2 + '&test_date3=' + test_date3 + '&kin_temp=' + kin_temp + '&kin_vac=' + kin_vac + '&abs_temp=' + abs_temp + '&abs_vac=' + abs_vac + '&room_temp=' + room_temp + '&chk_fla=' + chk_fla + '&fla_1=' + fla_1+ '&ulr=' + ulr+ '&amend_date=' + amend_date;
		} else {
			var report_no = $('#report_no').val();
			var job_no = $('#job_no').val();
			var lab_no = $('#lab_no').val();
			...
			success: function(data) {
				...
				for (var i = 0; i < aa.length; i++) {
					if (aa[i] == "pen") {
						...
						$('#pint_1').val(data.pint_1);
						$('#pint_2').val(data.pint_2);
						$('#pint_3').val(data.pint_3);
						$('#pfin_1').val(data.pfin_1);
						$('#pfin_2').val(data.pfin_2);
						$('#pfin_3').val(data.pfin_3);
				...
				for (var i = 0; i < aa.length; i++) {
					if (aa[i] == "duc") {
						...
						$('#dint_1').val(data.dint_1);
						$('#dint_2').val(data.dint_2);
						$('#dint_3').val(data.dint_3);
						$('#dfin_1').val(data.dfin_1);
						$('#dfin_2').val(data.dfin_2);
						$('#dfin_3').val(data.dfin_3);
						$('#caste_date3').val(data.caste_date3);
						$('#test_date3').val(data.test_date3);

						$('#avg_duc').val(data.avg_duc);
						$('#duc_bit').val(data.duc_bit);
				...
				for (var i = 0; i < aa.length; i++) {
					if (aa[i] == "ela") {
						...
						$('#ela_0').val(data.ela_0);
						$('#ela_1').val(data.ela_1);
						$('#ela_2').val(data.ela_2);
						$('#ela_temp').val(data.ela_temp);
						$('#avg_ela').val(data.avg_ela);


						var chk_ela = data.chk_ela;
						if (chk_ela == "1") {
							$('#txtela').css("background-color", "var(--success)");
							$("#chk_ela").prop("checked", true);
						} else {
							$('#txtela').css("background-color", "white");
							$("#chk_ela").prop("checked", false);
						}
						break;
					} else {
				...
				for (var i = 0; i < aa.length; i++) {
					if (aa[i] == "abs") {
						...
						$('#abs_temp').val(data.abs_temp);
						$('#abs_vac').val(data.abs_vac);
				...
				for (var i = 0; i < aa.length; i++) {
					if (aa[i] == "kin") {
						...
						$('#kin_temp').val(data.kin_temp);
						$('#kin_vac').val(data.kin_vac);
				...
				for (var i = 0; i < aa.length; i++) {
					if (aa[i] == "fla") {
						...
						$('#fla_1').val(data.fla_1);



						var chk_fla = data.chk_fla;
						if (chk_fla == "1") {
							$('#txtfla').css("background-color", "var(--success)");
							$("#chk_fla").prop("checked", true);
						} else {
							$('#txtfla').css("background-color", "white");
							$("#chk_fla").prop("checked", false);
						}
						break;
					} else {
