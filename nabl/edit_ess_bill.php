...
if($_SESSION['isadmin']=="2")
{
	...
	echo $select_query = "select * from estimate_bill_total_master WHERE `est_sr_no`='$_GET[est_sr_no]'";
	...
	if (mysqli_num_rows($result_select) > 0) {
		...
		$bt_isbill1= $row_select['bt_isbill'];
		...
		$select_query1 = "select * from billmaster WHERE `sr_no`='$ess_serial_no1'";
		...
		if(isset($_POST['btn_update'])){
				...
				$tax_query = "select * from billmaster WHERE sr_no='$sr_no'";
				...
				if (mysqli_num_rows($result_tax) > 0) {
					...
					if (!isset($_POST['options']))  {
						...
						$sel_pay_type="select * from cash_bill where cash_est_id='$_GET[est_sr_no]'";
						$result_pay_type = mysqli_query($conn, $sel_pay_type);
						if (mysqli_num_rows($result_pay_type) == 0) {
							
							$querys_cashl = "SELECT * FROM cash_bill ORDER BY cash_id ASC";
							$get_cash = mysqli_query($conn,$querys_cashl);
							$cah_rows=mysqli_num_rows($get_cash);
							
							while($r1 = mysqli_fetch_array($get_cash)){
								$cah_sr=$r1['cash_sr_no'];
								}
							if($cah_rows<1){
								$cash_sr_no_set=1;
								$cash_sr_no="CASH-BILL-".$cash_sr_no_set;
					
							}
							else{
				
					
								$cash_sr_no_set=substr($cah_sr,10);
								$cash_sr_no="CASH-BILL-".($cash_sr_no_set+1);
					
				
							}
							
						 $insert_cash = "insert into cash_bill(`cash_est_id`,`cash_sr_no`) values('$_GET[est_sr_no]','$cash_sr_no')"; 
							 //exit;
							$cash_qrys = mysqli_query($conn,$insert_cash);
			...
			$update="update estimate_bill_total_master SET `fy_id`='$fyear',`job_no`='$job_no_merge',`agency_id`='$_POST[select_agency]',`agency_name`='$agency_name',`auth_name`='$_POST[select_auth]',`auth_address`='$_POST[auth_address]',`auth_state`='$state_explode[0]',`auth_statecode`='$_POST[txt_statecode]',`auth_gstno`='$_POST[txt_gstno]',`ref_date`='$new_ref_date',`rec_date`='$new_rec_date',`inv_date`='$new_inv_date',`today_date`='$new_today_date',`total_taxableamt`='$tax_amt',`cgsttotal`='$cgst1',`sgsttotal`='$sgst1',`igsttotal`='$igst1',`subtotal`='$gst1',`grandtotal`='$net',`paymenttype`='$pay_option',`remarks`='$_POST[txt_remark]',`totalgst_inword`='$_POST[txt_gstinword]',`billamt_inword`='$_POST[txt_billinword]',`bt_isstatus`=0,`bt_modifiedby`='$_SESSION[name]',`bt_modifieddate`='$curr_date',`bill_sr_manualy`='$_POST[txt_manualy]',`ag_or_auth_status`='$_POST[rdo_button_ag_or_auth]' WHERE `est_sr_no`='$_GET[est_sr_no]'"; 
				...
				if($bt_isbill1=="1"){
					...
					$update1="update bill_totalmaster SET `fy_id`='$fyear',`job_no`='$job_no_merge',`agency_id`='$_POST[select_agency]',`agency_name`='$agency_name',`auth_name`='$_POST[select_auth]',`auth_address`='$_POST[auth_address]',`auth_state`='$state_explode[0]',`auth_statecode`='$_POST[txt_statecode]',`auth_gstno`='$_POST[txt_gstno]',`ref_date`='$new_ref_date',`rec_date`='$new_rec_date',`inv_date`='$new_inv_date',`today_date`='$new_today_date',`total_taxableamt`='$tax_amt',`cgsttotal`='$cgst1',`sgsttotal`='$sgst1',`igsttotal`='$igst1',`subtotal`='$gst1',`grandtotal`='$net',`paymenttype`='$pay_option',`dateofpay`='$pay_date',`check_no`='$check_no',`bank_name`='$bank_name',`remarks`='$_POST[txt_remark]',`totalgst_inword`='$_POST[txt_gstinword]',`billamt_inword`='$_POST[txt_billinword]',`bt_isstatus`=0,`bt_modifiedby`='$_SESSION[name]',`bt_modifieddate`='$curr_date',`bill_sr_manualy`='$_POST[txt_manualy]',`ag_or_auth_status`='$_POST[rdo_button_ag_or_auth]' WHERE `sr_no`='$serial_no1'";
				
				$result_of_bill_update=mysqli_query($conn,$update1);
			
				}
				
				?>
					<script>alert("Esstimate Bill Updated Successfully");</script>
				<script>window.location.href="<?php echo $base_url; ?>view_est_bill.php";</script>
			<?php
...
//------------------------------------save as bill-------------------------
			...
			if(isset($_POST['btn_save_bill'])){
				...
				$sr_no=$sr_no1.$sr_no2;
							...
							$sr_no_bill=1;
							$final_sr_no;
							$querys_serno = "SELECT * FROM bill_totalmaster WHERE `fy_id`='$year'";
							...
							//echo "<pre>rr";
								...
								//exit;
							if($rows<1){
								$final_sr_no=$sr_no_bill;
								$get_srno=$comp_name."/".$srno."-".$final_sr_no;
								//exit();
								...
								//echo "<pre>";
								//print_r($serial_no);
								$explode_serial=explode("-",$serial_no);
								$final_serialno=$explode_serial[1];
								//exit();

							$final_sr_no = intval($final_serialno) + 1;
							
							$get_srno=$comp_name."/".$srno."-".$final_sr_no;

							}	
							$for_bill_to_master_sr_no= $sr_no1.$final_sr_no;
				...
				//--------------------------------------------------
							...
							$insert="insert into bill_totalmaster (`branch_id`,`fy_id`,`sr_no`,`est_sr_no`,`job_no`,`agency_id`,`agency_name`,`auth_name`,`auth_address`,`auth_state`,`auth_statecode`,`auth_gstno`,`ref_date`,`rec_date`,`inv_date`,`today_date`,`total_taxableamt`,`cgsttotal`,`sgsttotal`,`igsttotal`,`subtotal`,`grandtotal`,`paymenttype`,`dateofpay`,`check_no`,`bank_name`,`remarks`,`totalgst_inword`,`billamt_inword`,`bt_isstatus`,`bt_createdby`,`bt_createddate`,`bt_modifiedby`,`bt_modifieddate`,`bt_isdeleted`,`bill_sr_manualy`,`ag_or_auth_status`) 
							values(
							'$branch_session',
							'$fyear',
							'$for_bill_to_master_sr_no',
							'$_GET[est_sr_no]',
							'$job_no_merge',
							'$_POST[select_agency]',
							'$agency_name',
					  ...
					  mysqli_query($conn,$insert);
						...
						$update="update billmaster SET `bill_status`='1',`bill_isinsert`='1',`ag_or_auth_status`='$_POST[rdo_button_ag_or_auth]' WHERE `sr_no`='$_GET[est_sr_no]'";
					
						$result_of_update=mysqli_query($conn,$update);	
						
						$update="update estimate_bill_total_master SET `bt_isstatus`='1',`sr_no`='$for_bill_to_master_sr_no',`bt_isbill`='1',`ag_or_auth_status`='$_POST[rdo_button_ag_or_auth]' WHERE `est_sr_no`='$_GET[est_sr_no]'";
					
						$result_of_update=mysqli_query($conn,$update);	
						?>
								<script>alert("Save as bill Successfully");</script>
								<script>window.location.href="<?php echo $base_url; ?>edit_ess_bill.php?=`est_sr_no`"<?php echo $ess_serial_no1;?>;</script>
						<?php
				//}
		}
					...
					<div class="box box-info">
						...
						<form class="form" id="billing" method="post">
							<div class="box-body"  style="border:1px groove #ddd;">
								...
								<hr style="border-top: 1px solid;">
								<?php
									$query = "select * from billmaster WHERE sr_no='$ess_serial_no1'";
								...
								<div class="row">
									<div class="col-lg-3">
										<div class="form-group">
											...
											<div class="col-sm-12">
												<select class="form-control select2" name="select_material" id="select_material" tabindex="16">
									...
									<div class="col-lg-4">
										<div class="form-group">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control" style="text-align:center;" name="txt_qty" tabindex="17" id="txt_qty">
											</div>
									...
									<div class="col-lg-5">
										<div class="form-group">
											...
											<div class="col-sm-2">
												...
												<button type="button" class="btn btn-info pull-right" id="btn_add_data" onclick="addData('add')" name="btn_add_data" id="btn_add_data" tabindex="18" >Add</button>
											...
											<div class="col-sm-2">
												...
												<button type="button" class="btn btn-info pull-right" onclick="addData('edit')"  id="btn_edit_data" name="btn_edit_data" tabindex="19">Update</button>
												...
												<tr>
													...
													if (mysqli_num_rows($result) > 0) {
														while($r = mysqli_fetch_array($result)){
															...
															$query_sum = "select SUM(taxable_amt) as sum_taxable,SUM(cgstamt) as sum_cgstamt,SUM(igstamt) as sum_igstamt ,SUM(sgstamt) as sum_sgstamt,SUM(netamt) as sum_netamt from billmaster WHERE sr_no='$serial_no1' AND bill_isdeleted='0' ";
								...
								<div class="row">	
									<div class="col-lg-6">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="txt_gstinword" name="txt_gstinword" value="<?php echo $totalgst_inword;?>">											
											</div>
										</div>
									</div>
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="txt_billinword" name="txt_billinword" value="<?php echo $billamt_inword;?>">											
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">	
									<div class="col-lg-3">
										<div class="form-group">
											<div class="radio col-sm-4" style="margin-top: -3px;">
												<label>
												<input type="radio" name="options" id="opt_cash" value="cash" tabindex="15">Cash

												</label>
											</div>
											<div class="radio col-sm-4">
												<label>
												<input type="radio" name="options" id="opt_cheque" value="cheque" tabindex="16">Cheque
												</label>
											</div>
											<div class="radio col-sm-4">
												<label>
													<input type="radio" name="options" id="opt_rtgs" value="rtgs" tabindex="17">RTGS
											...
											<div class="input-group date col-sm-9">
												<div id="pay_date">
													<div class="input-group date">
														...
														<input type="text" class="form-control pull-right" id="dateofpay" name="dateofpay" value="<?php echo date("d/m/Y");?>">
													</div>
												</div>
											</div>
										</div>
									...
									<div class="col-lg-3">
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control"name="txt_chck" id="txt_chck">											
											</div>
										</div>
									</div>
									...
									<div class="col-lg-3">
										<div class="form-group">
											...
											<div class="col-sm-8">
												<input type="text" class="form-control"name="txt_info" id="txt_info">											
											</div>
										</div>
									</div>
								</div>
								<div class="row">	
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-sm-11">
												<textarea rows="3" style="width:100%;" name="txt_remark" tabindex="18" id="txt_remark"><?php echo $remarks;?></textarea>	
											</div>
										</div>
									</div>
								</div><br>
								<div class="row">	
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-sm-4">
												<?php
												$srno2manual=substr($ess_serial_no1,4);
												$srno1manual=substr($ess_serial_no1,0,3);
												?>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-sm-12">
												...
												<?php
												$select_of_query1 = "select * from estimate_bill_total_master WHERE `est_sr_no`='$_GET[est_sr_no]'";
												$result_of_select1 = mysqli_query($conn, $select_of_query1);


												if (mysqli_num_rows($result_of_select1) > 0) {
													$row_of_select1 = mysqli_fetch_assoc($result_of_select1);
													$bt_isbill=$row_of_select1['bt_isbill'];
													$sr_of_no=$row_of_select1['sr_no'];
													
														if($row_of_select1['bt_isbill']=="0"){
															
															?>
														
														<div class="col-xs-2">	
															<button type="submit" class="btn btn-info pull-right" id="btn_save_bill" tabindex="20" name="btn_save_bill" style="width:120px">Save as Bill</button>
														</div>
														...
														if($row_of_select1['bt_isbill']=="1"){
															?>
															
												
												<div class="col-xs-2">
													<a target = '_blank' href="<?php echo $base_url; ?>bill_print.php?sr_no=<?php echo $ess_serial_no1;?>&f_year=<?php echo $year;?>" class="btn btn-info pull-right" tabindex="21" id="btn_gst_bill" name="btn_gst_bill" style="width:120px">Print Bill</a>
												</div>
												<div class="col-xs-2">
													<a target = '_blank' href="<?php echo $base_url; ?>bill_print_withoutgst.php?sr_no=<?php echo $ess_serial_no1;?>&f_year=<?php echo $year;?>" class="btn btn-info pull-right" tabindex="22" id="btn_print_bill" name="btn_print_bill" target="_blank">Print BillWithout GST</a>
												</div>
