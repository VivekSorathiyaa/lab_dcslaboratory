			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">SDBC - 1 (MIX MATERIAL)</h2>
					</div>
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM sdbc_mix_1 WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_sdbc_10_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=sdbc_mix_1" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from sdbc_mix_1 WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		function sp_auto() {
			...
			var sp_specificgravity = randomNumberFromRange(2.650, 2.750).toFixed(3); //(sp_specific_gravity)
			...
			var sp_waterabr = randomNumberFromRange(1.20, 1.40).toFixed(2); // (sp_water_abr)_1
		...
		function general_flk_elo1() {
			$('#txtflk').css("background-color", "var(--success)");
			var combined_index = randomNumberFromRange(15.0, 25.0).toFixed(1);
			...
			var suma = randomNumberFromRange(1500, 1900).toFixed();
			$('#suma').val(suma);
			var sum_a = $('#suma').val();
		...
		function grd_auto() {
			...
			var pass_sample_2 = randomNumberFromRange(92.00, 97.00).toFixed(2);
			var pass_sample_3 = randomNumberFromRange(78.00, 89.00).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(40.00, 50.00).toFixed(2);
			var pass_sample_5 = randomNumberFromRange(26.00, 36.00).toFixed(2);
			var pass_sample_6 = randomNumberFromRange(16.00, 28.00).toFixed(2);
			var pass_sample_7 = randomNumberFromRange(10.00, 18.00).toFixed(2);
			var pass_sample_8 = randomNumberFromRange(4.00, 7.00).toFixed(2);
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_sdbc_10_mm.php',
	...
	function saveMetal(type, id) {
		...
		if (type == 'add') {
			...
			billData = $("#Glazed").find('.form').serialize() + '&action_type=' + type + '&idEdit=' + idEdit + '&report_no=' + report_no + '&job_no=' + job_no + '&lab_no=' + lab_no + '&chk_sou=' + chk_sou + '&s6total=' + s6total + '&soundness=' + soundness + '&s31=' + s31 + '&s32=' + s32 + '&s33=' + s33 + '&s34=' + s34 + '&s35=' + s35 + '&s36=' + s36 + '&s37=' + s37 + '&s38=' + s38 + '&s39=' + s39 + '&s30=' + s30 + '&s41=' + s41 + '&s42=' + s42 + '&s43=' + s43 + '&s44=' + s44 + '&s45=' + s45 + '&s46=' + s46 + '&s47=' + s47 + '&s48=' + s48 + '&s49=' + s49 + '&s40=' + s40 + '&s51=' + s51 + '&s52=' + s52 + '&s53=' + s53 + '&s54=' + s54 + '&s55=' + s55 + '&s56=' + s56 + '&s57=' + s57 + '&s58=' + s58 + '&s59=' + s59 + '&s50=' + s50 + '&s61=' + s61 + '&s62=' + s62 + '&s63=' + s63 + '&s64=' + s64 + '&s65=' + s65 + '&s66=' + s66 + '&s67=' + s67 + '&s68=' + s68 + '&s69=' + s69 + '&s60=' + s60 + '&chk_sp=' + chk_sp + '&sp_w_sur_1=' + sp_w_sur_1 + '&sp_w_sur_2=' + sp_w_sur_2 + '&sp_w_s_1=' + sp_w_s_1 + '&sp_w_s_2=' + sp_w_s_2 + '&sp_wt_st_1=' + sp_wt_st_1 + '&sp_wt_st_2=' + sp_wt_st_2 + '&sp_specific_gravity=' + sp_specific_gravity + '&sp_specific_gravity_1=' + sp_specific_gravity_1 + '&sp_specific_gravity_2=' + sp_specific_gravity_2 + '&sp_water_abr=' + sp_water_abr + '&sp_water_abr_1=' + sp_water_abr_1 + '&sp_water_abr_2=' + sp_water_abr_2 + '&chk_abr=' + chk_abr + '&abr_index=' + abr_index + '&abr_wt_t_a_1=' + abr_wt_t_a_1 + '&abr_wt_t_a_2=' + abr_wt_t_a_2 + '&abr_wt_t_b_1=' + abr_wt_t_b_1 + '&abr_wt_t_b_2=' + abr_wt_t_b_2 + '&abr_wt_t_c_1=' + abr_wt_t_c_1 + '&abr_wt_t_c_2=' + abr_wt_t_c_2 + '&abr_1=' + abr_1 + '&abr_2=' + abr_2 + '&abr_grading=' + abr_grading + '&abr_weight_charge=' + abr_weight_charge + '&abr_sphere=' + abr_sphere + '&abr_num_revo=' + abr_num_revo + '&chk_alkali=' + chk_alkali + '&alk_1=' + alk_1 + '&alk_2=' + alk_2 + '&alk_3=' + alk_3 + '&alk_4=' + alk_4 + '&alk_5=' + alk_5 + '&alk_6=' + alk_6 + '&alk_7=' + alk_7 + '&alk_8=' + alk_8 + '&alk_9=' + alk_9 + '&alk_10=' + alk_10 + '&alk_11=' + alk_11 + '&chk_den=' + chk_den + '&m11=' + m11 + '&m12=' + m12 + '&m13=' + m13 + '&m21=' + m21 + '&m22=' + m22 + '&m23=' + m23 + '&m31=' + m31 + '&m32=' + m32 + '&m33=' + m33 + '&avg_wom=' + avg_wom + '&vol=' + vol + '&bdl=' + bdl + '&chk_crushing=' + chk_crushing + '&cru_value=' + cru_value + '&cr_a_1=' + cr_a_1 + '&cr_a_2=' + cr_a_2 + '&cr_b_1=' + cr_b_1 + '&cr_b_2=' + cr_b_2 + '&cru_value_1=' + cru_value_1 + '&cru_value_2=' + cru_value_2 + '&chk_fines=' + chk_fines + '&fines_value=' + fines_value + '&f_a_1=' + f_a_1 + '&f_a_2=' + f_a_2 + '&f_b_1=' + f_b_1 + '&f_b_2=' + f_b_2 + '&f_c_1=' + f_c_1 + '&f_c_2=' + f_c_2 + '&f_d_1=' + f_d_1 + '&f_d_2=' + f_d_2 + '&avg_f_d=' + avg_f_d + '&avg_f_c=' + avg_f_c + '&chk_flk=' + chk_flk + '&fi_index=' + fi_index + '&a1=' + a1 + '&a2=' + a2 + '&a3=' + a3 + '&a4=' + a4 + '&a5=' + a5 + '&a6=' + a6 + '&a7=' + a7 + '&a8=' + a8 + '&a9=' + a9 + '&suma=' + suma + '&b1=' + b1 + '&b2=' + b2 + '&b3=' + b3 + '&b4=' + b4 + '&b5=' + b5 + '&b6=' + b6 + '&b7=' + b7 + '&b8=' + b8 + '&b9=' + b9 + '&s11=' + s11 + '&s12=' + s12 + '&s13=' + s13 + '&s14=' + s14 + '&s15=' + s15 + '&s16=' + s16 + '&s17=' + s17 + '&s18=' + s18 + '&s19=' + s19 + '&ei_index=' + ei_index + '&aa1=' + aa1 + '&aa2=' + aa2 + '&aa3=' + aa3 + '&aa4=' + aa4 + '&aa5=' + aa5 + '&aa6=' + aa6 + '&aa7=' + aa7 + '&aa8=' + aa8 + '&aa9=' + aa9 + '&dd1=' + dd1 + '&dd2=' + dd2 + '&dd3=' + dd3 + '&dd4=' + dd4 + '&dd5=' + dd5 + '&dd6=' + dd6 + '&dd7=' + dd7 + '&dd8=' + dd8 + '&dd9=' + dd9 + '&combined_index=' + combined_index + '&sumb=' + sumb + '&sumaa=' + sumaa + '&sumdd=' + sumdd + '&chk_impact=' + chk_impact + '&imp_w_m_a_1=' + imp_w_m_a_1 + '&imp_w_m_a_2=' + imp_w_m_a_2 + '&imp_w_m_b_1=' + imp_w_m_b_1 + '&imp_w_m_b_2=' + imp_w_m_b_2 + '&imp_w_m_c_1=' + imp_w_m_c_1 + '&imp_w_m_c_2=' + imp_w_m_c_2 + '&imp_value_1=' + imp_value_1 + '&imp_value_2=' + imp_value_2 + '&imp_value=' + imp_value + '&chk_ll=' + chk_ll + '&pen1=' + pen1 + '&pen2=' + pen2 + '&pen3=' + pen3 + '&pen4=' + pen4 + '&cont1=' + cont1 + '&cont2=' + cont2 + '&cont3=' + cont3 + '&cont4=' + cont4 + '&wc1=' + wc1 + '&wc2=' + wc2 + '&wc3=' + wc3 + '&wc4=' + wc4 + '&od1=' + od1 + '&od2=' + od2 + '&od3=' + od3 + '&od4=' + od4 + '&ww1=' + ww1 + '&ww2=' + ww2 + '&ww3=' + ww3 + '&ww4=' + ww4 + '&wf1=' + wf1 + '&wf2=' + wf2 + '&wf3=' + wf3 + '&wf4=' + wf4 + '&ds1=' + ds1 + '&ds2=' + ds2 + '&ds3=' + ds3 + '&ds4=' + ds4 + '&mo1=' + mo1 + '&mo2=' + mo2 + '&mo3=' + mo3 + '&mo4=' + mo4 + '&ln1=' + ln1 + '&ln2=' + ln2 + '&ln3=' + ln3 + '&ln4=' + ln4 + '&avg_ll=' + avg_ll + '&avg_pl=' + avg_pl + '&plastic_limit=' + plastic_limit + '&pi_value=' + pi_value + '&liquide_limit=' + liquide_limit + chk_grd + '&sieve_1=' + sieve_1 + '&sieve_2=' + sieve_2 + '&sieve_3=' + sieve_3 + '&sieve_4=' + sieve_4 + '&sieve_5=' + sieve_5 + '&sieve_6=' + sieve_6 + '&sieve_7=' + sieve_7 + '&sieve_8=' + sieve_8 + '&cum_wt_gm_1=' + cum_wt_gm_1 + '&cum_wt_gm_2=' + cum_wt_gm_2 + '&cum_wt_gm_3=' + cum_wt_gm_3 + '&cum_wt_gm_4=' + cum_wt_gm_4 + '&cum_wt_gm_5=' + cum_wt_gm_5 + '&cum_wt_gm_6=' + cum_wt_gm_6 + '&cum_wt_gm_7=' + cum_wt_gm_7 + '&cum_wt_gm_8=' + cum_wt_gm_8 + '&ret_wt_gm_1=' + ret_wt_gm_1 + '&ret_wt_gm_2=' + ret_wt_gm_2 + '&ret_wt_gm_3=' + ret_wt_gm_3 + '&ret_wt_gm_4=' + ret_wt_gm_4 + '&ret_wt_gm_5=' + ret_wt_gm_5 + '&ret_wt_gm_6=' + ret_wt_gm_6 + '&ret_wt_gm_7=' + ret_wt_gm_7 + '&ret_wt_gm_8=' + ret_wt_gm_8 + '&cum_ret_1=' + cum_ret_1 + '&cum_ret_2=' + cum_ret_2 + '&cum_ret_3=' + cum_ret_3 + '&cum_ret_4=' + cum_ret_4 + '&cum_ret_5=' + cum_ret_5 + '&cum_ret_6=' + cum_ret_6 + '&cum_ret_7=' + cum_ret_7 + '&cum_ret_8=' + cum_ret_8 + '&pass_sample_1=' + pass_sample_1 + '&pass_sample_2=' + pass_sample_2 + '&pass_sample_3=' + pass_sample_3 + '&pass_sample_4=' + pass_sample_4 + '&pass_sample_5=' + pass_sample_5 + '&pass_sample_6=' + pass_sample_6 + '&pass_sample_7=' + pass_sample_7 + '&pass_sample_8=' + pass_sample_8 + '&blank_extra=' + blank_extra + '&sample_taken=' + sample_taken + '&ulr=' + ulr;
		} else {
			var report_no = $('#report_no').val();
			var job_no = $('#job_no').val();
			var lab_no = $('#lab_no').val();
