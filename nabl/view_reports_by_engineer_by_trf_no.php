									  ...
									  <div class="table-responsive" id="display_data">
										<table class="table table-bordered no-margin">
										  ...
										  <?php
											...
											$sel_span_materials="select * from span_material_assign where `trf_no`='$_GET[trf_no]' AND `job_number`='$_GET[job_no]' AND `temporary_trf_no`='$_GET[temporary_trf_no]' AND `tested_by`='$_SESSION[u_id]'";
