...
<section class="content" style="padding: 0px;
     ...
     padding-right: 0px; ">
			...
			<div class="col-md-4">
			<h1 style="">
			<a  class="btn btn-info" href="add_purchage_out.php" title="ADD Payment OUT" style="margin-left:10px;">ADD Payment OUT</a>
			</h1>
			</div>
			<div class="col-md-3">
			<h1 style="text-align:center;">Payment Out List</h1>
			</div>
			</div>
...
function search_data(type,id){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php $base_url; ?>search_purchage_out.php',
        data: billData,
		beforeSend: function(){
...
$(document).on("click",".delete_vouch",function(){
					...
					if(confirm("Are You Sure To Delete..?"))
					{
						...
						$.ajax({
							url : "save_purchase_out.php",
							type: "POST",
							data : postData,
							success: function(data,status,  xhr)
							 {
								alert("Purchase Is Successfully Deleted");
								window.location.href="purchage_list_out.php";
