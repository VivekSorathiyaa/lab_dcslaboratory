                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                ?>
                                                                    ...
                                                                    ?>
                                                                        <a href="javascript:void(0);" class="btn btn-light-primary btn-lg btn3d report_send_to_eng" data-id="<?php echo $row['lab_no'] . "|" . $tested_by ?>" title="Report Send To Accept"><span class="glyphicon glyphicon-question-list"></span> Reward</a>
                                                                ...
                                                                <?php } else {
                                                                            echo '<span style="color:green;font-size: 18px;">Report Accepted</span>';
                                                                        }
                                                                    }
                                                                } else {
...
<!--<div class="row">
                                                                        <div class="col-md-3">
                                                                            <label for="reported_by_<?php echo $material_count; ?>">Reported By<span class="mede_class">*</span>:</label>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                            <a href="javascript:void(0);" class="btn btn-success job_send_to_accept <?php echo $disabling; ?>" data-id="<?php echo $get_trf_no . "|" . $get_job_no . "|" . $temporary_trf_no; ?>" title="Material Assign">ACCEPT JOB</a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            </tbody>
            ...
            buttons: {
                confirm: function() {
                    $.ajax({
                        ...
                        success: function(html) {
                            alert("Job No " + splitings[1] + " Is Accepted..");
