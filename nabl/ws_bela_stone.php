			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">BELLA STONE</h2>
					</div>
								...
								<br>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											if($val == 0 || $val == 5 || $val == 6 || $_SESSION['nabl_type']=="direct_nabl" || $_SESSION['nabl_type']=="direct_non_nabl") {*/$val1 =  $_SESSION['isadmin'];
										 // $val2 =  $_SESSION['is_special'];
										// if($val1 =="0" || $val1 =="5" || $val1 =="44" || $val2 =="1"){
											?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_ws_bela_stone.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&ulr=<?php echo $_GET['ulr'];?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
 
											</div>
											
											<?php //} ?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_natural_stone.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
					...
					<div id="collapse_spg" class="panel-collapse collapse">
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">Perticulars</label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">Observation</label>
									</div>
								</div>
								<div class="col-md-1">
									<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">Weight of the bottle with stopper and powder in gm - W<sub>2</sub></label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="col-md-4">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="avg_w2" name="avg_w2">
									</div>
								</div>									
							</div>
							<br>
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">Weight of the empty specific gravity bottle with stopper in gm - W<sub>1</sub></label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="col-md-4">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="avg_w1" name="avg_w1">
									</div>
								</div>									
							</div>
							<br>
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">Weight of the bottle with stopper filled with distilled water at room temperature in gm - W<sub>4</sub></label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="col-md-4">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="avg_w4" name="avg_w4">
									</div>
								</div>									
							</div>
							<br>
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">Weight of the bottle with stopper powder and distilled water to fill rest opf the bottle at room temperature in gm - W<sub>3</sub></label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="col-md-4">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="avg_w3" name="avg_w3">
									</div>
								</div>									
							</div>
							<br>
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">True Specific Gravity = </label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="col-md-4">
					...
					<div id="collapse_por" class="panel-collapse collapse">
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">Weight of Oven Dry Test Piece in gm = A</label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="col-md-4">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="avg_a" name="avg_a">
									</div>
								</div>									
							</div>
							<br>
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">Quantity of Water added in 1000ml jar containing the test piece in gm =C</label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="col-md-4">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="avg_c" name="avg_c">
									</div>
								</div>									
							</div>
							<br>
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">Weight of saturated surface dry test piece in gm = B</label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="col-md-4">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="avg_b" name="avg_b">
									</div>
								</div>									
							</div>
							<br>
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">Apparent specific gravity = A / 100 - C</label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="col-md-4">
										<div class="form-group">
											<input type="text" class="form-control" id="asg1" name="asg1">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<input type="text" class="form-control" id="asg2" name="asg2">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<input type="text" class="form-control" id="asg3" name="asg3">
										</div>
									</div>
								</div>
								<div class="col-md-1">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">Water Absorption % = (B - A) / A X 100</label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="col-md-4">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">Apparent Porosity % = (B - A) / (100 - C) X 100</label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="col-md-4">
							...
							<div class="row">
								...
								<div class="col-md-4">
									<div class="col-md-4">
										<div class="form-group">
											<input type="text" class="form-control" id="tspg1" name="tspg1">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<input type="text" class="form-control" id="tspg2" name="tspg2">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<input type="text" class="form-control" id="tspg3" name="tspg3">
										</div>
									</div>
								</div>
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="avg_tspg" name="avg_tspg">
									</div>
								</div>									
							</div>
							<br>
							<div class="row">
								...
								<div class="col-md-4">
									<div class="form-group">
										<label for="inputEmail3" class="col-sm-12 control-label text-center">True Porosity  = </label>
									</div>
								</div>
								<div class="col-md-4">
									<div class="col-md-4">
										<div class="form-group">
											<input type="text" class="form-control" id="tpor1" name="tpor1">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<input type="text" class="form-control" id="tpor2" name="tpor2">
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<input type="text" class="form-control" id="tpor3" name="tpor3">
										</div>
									</div>
								</div>
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="avg_tpor" name="avg_tpor">
									</div>
								</div>									
							</div>
					...
					<div id="collapse_com" class="panel-collapse collapse">
						<div class="panel-body">
							...
							<div class="row">
									...
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Lab ID No</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Condition Dry/Wet</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Length (B) or Diameter (D)</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Height (H) mm</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Length (Diameter) / Height Ratio</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Cross Sectional Area (cm<sup>2</sup>)</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Maximum Load (kN)</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Compressive Strength Cc (N/mm<sup>2</sup>)</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Average Compressive Strength (kg/cm<sup>2</sup>)</label>
										</div>
									</div>
							</div>	
							<br>
							...
							<div class="row">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="con5" name="con5">
									</div>
								</div>
								<div class="col-md-1">
									<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="con6" name="con6">
									</div>
								</div>
								<div class="col-md-1">
									<div class="form-group">
					...
					<div id="collapse_tra" class="panel-collapse collapse">
						<div class="panel-body">
							...
							<div class="row">
									...
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Length (L) (cm)</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Width (b) cm</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Depth (D)cm</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Central Breaking Load (W) (kN)</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Transverse strength (R)  (Nkg/cm<sup>2</sup>)</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="tcon1" name="tcon1">
									</div>
								</div>
								<div class="col-md-1">
									<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="tcon2" name="tcon2">
									</div>
								</div>
								<div class="col-md-1">
									<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="tcon3" name="tcon3">
									</div>
								</div>
								<div class="col-md-1">
									<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="tcon4" name="tcon4">
									</div>
								</div>
								<div class="col-md-1">
									<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="tcon5" name="tcon5">
									</div>
								</div>
								<div class="col-md-1">
									<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-md-1">
									<div class="form-group">
										<input type="text" class="form-control" id="tcon6" name="tcon6">
									</div>
								</div>
								<div class="col-md-1">
									<div class="form-group">
					...
					<div id="collapse_ten" class="panel-collapse collapse">
						<div class="panel-body">
							...
							<div class="row">
									...
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Diameter (d) (cm)</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Lengths (I) cm</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Spliting Load (W) (KN)</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
											<label for="inputEmail3" class="col-sm-12 control-label text-center">Split tensile strength S (N/mm<sup>2</sup>)</label>
										</div>
									</div>
									<div class="col-md-1">
										<div class="form-group">
...
$(document).ready(function(){ 
	...
	$('#avg_spg').change(function(){
		...
		var w2_2 = $('#w2_2').val();
		var w2_3 = $('#w2_3').val();
		var avg_w2 = $('#avg_w2').val();
		
		//W1
		var w1_1 = $('#w1_1').val();
		var w1_2 = $('#w1_2').val();
		var w1_3 = $('#w1_3').val();
		var avg_w3 = $('#avg_w3').val();
		
		//W4
		var w4_1 = $('#w4_1').val();
		var w4_2 = $('#w4_2').val();
		var w4_3 = $('#w4_3').val();
		var avg_w4 = $('#avg_w4').val();
	...
	function por_auto()
	{
		$('#txtpor').css("background-color","var(--primary)"); 
		...
		var avgwtr = randomNumberFromRange(0.22, 0.45).toFixed(2);
		$('#avg_wtr').val(avgwtr);
		...
		var avg_a = ((+a1) + (+a2) + (+a3))/3; 
		
		$('#a1').val((+a1).toFixed(1));
		$('#a2').val((+a2).toFixed(1));
		$('#a3').val((+a3).toFixed(1));
		$('#avg_a').val((+avg_a).toFixed(1));
		...
		var avg_b = ((+b1) + (+b2) + (+b3))/3; 
		
		$('#b1').val((+b1).toFixed(1));
		$('#b2').val((+b2).toFixed(1));
		$('#b3').val((+b3).toFixed(1));
		$('#avg_b').val((+avg_b).toFixed(1));
		...
		var avg_c = ((+c1) + (+c2) + (+c3))/3; 
		
		$('#c1').val((+c1).toFixed(1));
		$('#c2').val((+c2).toFixed(1));
		$('#c3').val((+c3).toFixed(1));
		$('#avg_c').val((+avg_c).toFixed(1));
	...
	function por_auto()
	{
		...
		var avgasg = randomNumberFromRange(2.80, 2.84).toFixed(2);
		$('#avg_asg').val(avgasg);
		var avg_asg = $('#avg_asg').val();
		if((+randomNumberFromRange(0,50))%2==0)
		{
		...
		var avgwtr = randomNumberFromRange(0.23, 0.35).toFixed(2);
		$('#avg_wtr').val(avgwtr);
		var avg_wtr = $('#avg_wtr').val();
		if((+randomNumberFromRange(0,50))%2==0)
		{
	...
	function com_auto()
	{
		...
		var area8 = (+len_8)*(+h_8);
		var area9 = (+len_9)*(+h_9);
		var area10 = (+len_10)*(+h_10);
		var area11 = (+len_11)*(+h_11);
		var area12 = (+len_12)*(+h_12);
		var area13 = (+len_13)*(+h_13);
		var area14 = (+len_14)*(+h_14);
		var area15 = (+len_15)*(+h_15);
		var area16 = (+len_16)*(+h_16);
		var area17 = (+len_17)*(+h_17);
		var area18 = (+len_18)*(+h_18);
		var area19 = (+len_19)*(+h_19);
		var area20 = (+len_20)*(+h_20);
		...
		var avg_com1 = randomNumberFromRange(80.00,220.00);
		var avg_com2 = randomNumberFromRange(80.00,220.00);
		var avg_com3 = randomNumberFromRange(80.00,220.00);
		var avg_com4 = randomNumberFromRange(80.00,220.00);
		...
		var avg_com_2 = $('#avg_com2').val();
		var avg_com_3 = $('#avg_com3').val();
		var avg_com_4 = $('#avg_com4').val();
		...
		if(diff%2==0)
		{
			var com1 = (+avg_com_1) + 6.55;
			var com2 = (+avg_com_1) + 2.68;
			var com3 = (+avg_com_1) + 1.54;
			var com4 = (+avg_com_1) - 8.68;
			var com5 = (+avg_com_1) - 2.09;
			
			var com6 = (+avg_com_2) + 5.68;
			var com7 = (+avg_com_2) + 4.21;
			var com8 = (+avg_com_2) - 7.68;
			var com9 = (+avg_com_2) - 1.47;
			var com10 = (+avg_com_2) - 0.74;
			
			var com11 = (+avg_com_3) - 4.11;
			var com12 = (+avg_com_3) + 6.25;
			var com13 = (+avg_com_3) - 2.68;
			var com14 = (+avg_com_3) + 3.79;
			var com15 = (+avg_com_3) - 3.25;
			
			var com16 = (+avg_com_4) - 4.62;
			var com17 = (+avg_com_4) + 6.14;
			var com18 = (+avg_com_4) - 3.69;
			var com19 = (+avg_com_4) + 3.69;
			var com20 = (+avg_com_4) - 1.52;
	...
	$("#len1,#len2,#len3,#len4,#len5,#len6,#len7,#len8,#len9,#len10,#h1,#h2,#h3,#h4,#h5,#h6,#h7,#h8,#h9,#h10,#w1,#w2,#w3,#w4,#w5,#w6,#w7,#w8,#w9,#w10,#load1,#load2,#load3,#load4,#load5,#load6,#load7,#load8,#load9,#load10").change(function(){
	...
	function tra_auto()
	{
		$('#txttra').css("background-color","var(--primary)"); 
		$('#tcon1').val("dry");
		$('#tcon2').val("dry");
		$('#tcon3').val("dry");
		$('#tcon4').val("wet");
		...
		var avg_tra1 = ((+tra1) + (+tra2) + (+tra3))/3;
		var avg_tra2 = ((+tra4) + (+tra5) + (+tra6))/3;
	...
	$('#avg_tra2').change(function(){
		...
		var tra_diff = randomNumberFromRange(1, 9).toFixed();
		if(tra_diff % 2 == 0){
			var tra4 = (+avg_tra2) + 0.07;
			var tra5 = (+avg_tra2) - 0.38;
			var tra6 = (+avg_tra2) + 0.32;
	...
	function ten_auto()
	{
		$('#txtten').css("background-color","var(--primary)"); 
    ...
    if (type == 'add') {
				...
				for(var i=0;i<aa.length;i++)
				{
					...
					else
					{
						...
						billData = '&action_type='+type+'&report_no='+report_no+'&job_no='+job_no+'&lab_no='+lab_no+'&chk_spg='+chk_spg+'&w1_1='+w1_1+'&w1_2='+w1_2+'&w1_3='+w1_3+'&avg_w1='+avg_w1+'&w2_1='+w2_1+'&w2_2='+w2_2+'&w2_3='+w2_3+'&avg_w2='+avg_w2+'&w3_1='+w3_1+'&w3_2='+w3_2+'&w3_3='+w3_3+'&avg_w3='+avg_w3+'&w4_1='+w4_1+'&w4_2='+w4_2+'&w4_3='+w4_3+'&avg_w4='+avg_w4+'&spg_1='+spg_1+'&spg_2='+spg_2+'&spg_3='+spg_3+'&avg_spg='+avg_spg+'&chk_por='+chk_por+'&a1='+a1+'&a2='+a2+'&a3='+a3+'&avg_a='+avg_a+'&b1='+b1+'&b2='+b2+'&b3='+b3+'&avg_b='+avg_b+'&c1='+c1+'&c2='+c2+'&c3='+c3+'&avg_c='+avg_c+'&asg1='+asg1+'&asg2='+asg2+'&asg3='+asg3+'&avg_asg='+avg_asg+'&wtr1='+wtr1+'&wtr2='+wtr2+'&wtr3='+wtr3+'&avg_wtr='+avg_wtr+'&por1='+por1+'&por2='+por2+'&por3='+por3+'&avg_por='+avg_por+'&tspg1='+tspg1+'&tspg2='+tspg2+'&tspg3='+tspg3+'&avg_tspg='+avg_tspg+'&tpor1='+tpor1+'&tpor2='+tpor2+'&tpor3='+tpor3+'&avg_tpor='+avg_tpor+'&chk_com='+chk_com+'&con1='+con1+'&con2='+con2+'&con3='+con3+'&con4='+con4+'&con5='+con5+'&con6='+con6+'&len1='+len1+'&len2='+len2+'&len3='+len3+'&len4='+len4+'&len5='+len5+'&len6='+len6+'&h1='+h1+'&h2='+h2+'&h3='+h3+'&h4='+h4+'&h5='+h5+'&h6='+h6+'&ratio1='+ratio1+'&ratio2='+ratio2+'&ratio3='+ratio3+'&ratio4='+ratio4+'&ratio5='+ratio5+'&ratio6='+ratio6+'&area1='+area1+'&area2='+area2+'&area3='+area3+'&area4='+area4+'&area5='+area5+'&area6='+area6+'&load1='+load1+'&load2='+load2+'&load3='+load3+'&load4='+load4+'&load5='+load5+'&load6='+load6+'&com1='+com1+'&com2='+com2+'&com3='+com3+'&com4='+com4+'&com5='+com5+'&com6='+com6+'&avg_com1='+avg_com1+'&avg_com2='+avg_com2+'&chk_tra='+chk_tra+'&tcon1='+tcon1+'&tcon2='+tcon2+'&tcon3='+tcon3+'&tcon4='+tcon4+'&tcon5='+tcon5+'&tcon6='+tcon6+'&tl1='+tl1+'&tl2='+tl2+'&tl3='+tl3+'&tl4='+tl4+'&tl5='+tl5+'&tl6='+tl6+'&tb1='+tb1+'&tb2='+tb2+'&tb3='+tb3+'&tb4='+tb4+'&tb5='+tb5+'&tb6='+tb6+'&ta1='+ta1+'&ta2='+ta2+'&ta3='+ta3+'&ta4='+ta4+'&ta5='+ta5+'&ta6='+ta6+'&cb1='+cb1+'&cb2='+cb2+'&cb3='+cb3+'&cb4='+cb4+'&cb5='+cb5+'&cb6='+cb6+'&tra1='+tra1+'&tra2='+tra2+'&tra3='+tra3+'&tra4='+tra4+'&tra5='+tra5+'&tra6='+tra6+'&avg_tra1='+avg_tra1+'&avg_tra2='+avg_tra2+'&chk_ten='+chk_ten+'&scon1='+scon1+'&scon2='+scon2+'&scon3='+scon3+'&scon4='+scon4+'&scon5='+scon5+'&scon6='+scon6+'&scon7='+scon7+'&scon8='+scon8+'&scon9='+scon9+'&scon10='+scon10+'&sd1='+sd1+'&sd2='+sd2+'&sd3='+sd3+'&sd4='+sd4+'&sd5='+sd5+'&sd6='+sd6+'&sd7='+sd7+'&sd8='+sd8+'&sd9='+sd9+'&sd10='+sd10+'&sl1='+sl1+'&sl2='+sl2+'&sl3='+sl3+'&sl4='+sl4+'&sl5='+sl5+'&sl6='+sl6+'&sl7='+sl7+'&sl8='+sl8+'&sl9='+sl9+'&sl10='+sl10+'&sload1='+sload1+'&sload2='+sload2+'&sload3='+sload3+'&sload4='+sload4+'&sload5='+sload5+'&sload6='+sload6+'&sload7='+sload7+'&sload8='+sload8+'&sload9='+sload9+'&sload10='+sload10+'&ten1='+ten1+'&ten2='+ten2+'&ten3='+ten3+'&ten4='+ten4+'&ten5='+ten5+'&ten6='+ten6+'&ten7='+ten7+'&ten8='+ten8+'&ten9='+ten9+'&ten10='+ten10+'&avg_ten1='+avg_ten1+'&avg_ten2='+avg_ten2;
				...
				billData = $("#Glazed").find('.form').serialize()+'&action_type='+type+'&idEdit='+idEdit+'&report_no='+report_no+'&job_no='+job_no+'&lab_no='+lab_no+'&chk_spg='+chk_spg+'&w1_1='+w1_1+'&w1_2='+w1_2+'&w1_3='+w1_3+'&avg_w1='+avg_w1+'&w2_1='+w2_1+'&w2_2='+w2_2+'&w2_3='+w2_3+'&avg_w2='+avg_w2+'&w3_1='+w3_1+'&w3_2='+w3_2+'&w3_3='+w3_3+'&avg_w3='+avg_w3+'&w4_1='+w4_1+'&w4_2='+w4_2+'&w4_3='+w4_3+'&avg_w4='+avg_w4+'&spg_1='+spg_1+'&spg_2='+spg_2+'&spg_3='+spg_3+'&avg_spg='+avg_spg+'&chk_por='+chk_por+'&a1='+a1+'&a2='+a2+'&a3='+a3+'&avg_a='+avg_a+'&b1='+b1+'&b2='+b2+'&b3='+b3+'&avg_b='+avg_b+'&c1='+c1+'&c2='+c2+'&c3='+c3+'&avg_c='+avg_c+'&asg1='+asg1+'&asg2='+asg2+'&asg3='+asg3+'&avg_asg='+avg_asg+'&wtr1='+wtr1+'&wtr2='+wtr2+'&wtr3='+wtr3+'&avg_wtr='+avg_wtr+'&por1='+por1+'&por2='+por2+'&por3='+por3+'&avg_por='+avg_por+'&tspg1='+tspg1+'&tspg2='+tspg2+'&tspg3='+tspg3+'&avg_tspg='+avg_tspg+'&tpor1='+tpor1+'&tpor2='+tpor2+'&tpor3='+tpor3+'&avg_tpor='+avg_tpor+'&chk_com='+chk_com+'&con1='+con1+'&con2='+con2+'&con3='+con3+'&con4='+con4+'&con5='+con5+'&con6='+con6+'&len1='+len1+'&len2='+len2+'&len3='+len3+'&len4='+len4+'&len5='+len5+'&len6='+len6+'&h1='+h1+'&h2='+h2+'&h3='+h3+'&h4='+h4+'&h5='+h5+'&h6='+h6+'&ratio1='+ratio1+'&ratio2='+ratio2+'&ratio3='+ratio3+'&ratio4='+ratio4+'&ratio5='+ratio5+'&ratio6='+ratio6+'&area1='+area1+'&area2='+area2+'&area3='+area3+'&area4='+area4+'&area5='+area5+'&area6='+area6+'&load1='+load1+'&load2='+load2+'&load3='+load3+'&load4='+load4+'&load5='+load5+'&load6='+load6+'&com1='+com1+'&com2='+com2+'&com3='+com3+'&com4='+com4+'&com5='+com5+'&com6='+com6+'&avg_com1='+avg_com1+'&avg_com2='+avg_com2+'&chk_tra='+chk_tra+'&tcon1='+tcon1+'&tcon2='+tcon2+'&tcon3='+tcon3+'&tcon4='+tcon4+'&tcon5='+tcon5+'&tcon6='+tcon6+'&tl1='+tl1+'&tl2='+tl2+'&tl3='+tl3+'&tl4='+tl4+'&tl5='+tl5+'&tl6='+tl6+'&tb1='+tb1+'&tb2='+tb2+'&tb3='+tb3+'&tb4='+tb4+'&tb5='+tb5+'&tb6='+tb6+'&ta1='+ta1+'&ta2='+ta2+'&ta3='+ta3+'&ta4='+ta4+'&ta5='+ta5+'&ta6='+ta6+'&cb1='+cb1+'&cb2='+cb2+'&cb3='+cb3+'&cb4='+cb4+'&cb5='+cb5+'&cb6='+cb6+'&tra1='+tra1+'&tra2='+tra2+'&tra3='+tra3+'&tra4='+tra4+'&tra5='+tra5+'&tra6='+tra6+'&avg_tra1='+avg_tra1+'&avg_tra2='+avg_tra2+'&chk_ten='+chk_ten+'&scon1='+scon1+'&scon2='+scon2+'&scon3='+scon3+'&scon4='+scon4+'&scon5='+scon5+'&scon6='+scon6+'&scon7='+scon7+'&scon8='+scon8+'&scon9='+scon9+'&scon10='+scon10+'&sd1='+sd1+'&sd2='+sd2+'&sd3='+sd3+'&sd4='+sd4+'&sd5='+sd5+'&sd6='+sd6+'&sd7='+sd7+'&sd8='+sd8+'&sd9='+sd9+'&sd10='+sd10+'&sl1='+sl1+'&sl2='+sl2+'&sl3='+sl3+'&sl4='+sl4+'&sl5='+sl5+'&sl6='+sl6+'&sl7='+sl7+'&sl8='+sl8+'&sl9='+sl9+'&sl10='+sl10+'&sload1='+sload1+'&sload2='+sload2+'&sload3='+sload3+'&sload4='+sload4+'&sload5='+sload5+'&sload6='+sload6+'&sload7='+sload7+'&sload8='+sload8+'&sload9='+sload9+'&sload10='+sload10+'&ten1='+ten1+'&ten2='+ten2+'&ten3='+ten3+'&ten4='+ten4+'&ten5='+ten5+'&ten6='+ten6+'&ten7='+ten7+'&ten8='+ten8+'&ten9='+ten9+'&ten10='+ten10+'&avg_ten1='+avg_ten1+'&avg_ten2='+avg_ten2;
			...
			//SPECIFIC GRAVITY
				for(var i=0;i<aa.length;i++)
				{
					if(aa[i]=="SPG")
					{
						...
						$('#w1_2').val(data.w1_2);
						$('#w1_3').val(data.w1_3);
						$('#avg_w1').val(data.avg_w1);
						$('#w2_1').val(data.w2_1);
						$('#w2_2').val(data.w2_2);
						$('#w2_3').val(data.w2_3);
						$('#avg_w2').val(data.avg_w2);
						$('#w3_1').val(data.w3_1);
						$('#w3_2').val(data.w3_2);
						$('#w3_3').val(data.w3_3);
						$('#avg_w3').val(data.avg_w3);
						$('#w4_1').val(data.w4_1);
						$('#w4_2').val(data.w4_2);
						$('#w4_3').val(data.w4_3);
						$('#avg_w4').val(data.avg_w4);
				...
				for(var i=0;i<aa.length;i++)
				{
					if(aa[i]=="POR")
					{
						...
						$('#a2').val(data.a2);
						$('#a3').val(data.a3);
						$('#avg_a').val(data.avg_a);
						$('#b1').val(data.b1);
						$('#b2').val(data.b2);
						$('#b3').val(data.b3);
						$('#avg_b').val(data.avg_b);
						$('#c1').val(data.c1);
						$('#c2').val(data.c2);
						$('#c3').val(data.c3);
