			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">2.36 - 0.075 MM</h2>
					</div>
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">0.6</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">0.3</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">0.15</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM bc_2_36_0_075_mm WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_bc_2_36_0_075_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>

												<?php// } ?>
												<div class="col-sm-2">
													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=bc_2_36_0_075_mm" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from bc_2_36_0_075_mm WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		function sp_auto() {
			...
			var sp_specificgravity = randomNumberFromRange(2.500, 2.600).toFixed(3); //(sp_specific_gravity)
			...
			var sp_waterabr = randomNumberFromRange(0.90, 1.10).toFixed(2); // (sp_water_abr)_1
		...
		function imp_auto() {
			...
			var imp_w_m_a_1 = randomNumberFromRange(310.0, 325.0);
			var imp_w_m_a_2 = randomNumberFromRange(310.0, 325.0);
		...
		function grd_auto() {
			...
			var sample_taken = 2000;
			//PASSING RANGE
			var pass_sample_1 = randomNumberFromRange(100, 100).toFixed(2);
			var pass_sample_2 = randomNumberFromRange(89.00, 93.00).toFixed(2);
			var pass_sample_3 = randomNumberFromRange(73.00, 77.00).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(58.00, 62.00).toFixed(2);
			var pass_sample_5 = randomNumberFromRange(43.00, 47.00).toFixed(2);
			var pass_sample_6 = randomNumberFromRange(33.00, 37.00).toFixed(2);
			var pass_sample_7 = randomNumberFromRange(23.00, 27.00).toFixed(2);
			var pass_sample_8 = randomNumberFromRange(8.00, 12.00).toFixed(2);
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_bc_2_36_0_075_mm.php',
