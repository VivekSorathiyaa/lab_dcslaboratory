...
$extra_id=$explodings[0];
$auto_id=$explodings[1];
$unique_id=$explodings[2];

$sel_extra="select * from extra_calibration where `extra_id`=".$extra_id;
$result_extra = mysqli_query($conn,$sel_extra);
$extras =mysqli_fetch_array($result_extra);
...
<div class="content-wrapper" style="margin-left: 0px !important;">
	...
	<div class="row main_breadcrumb">
		<h1>
		EXTRA CALIBRATION LIST FOR (<?php echo $auto_id;?>)
		</h1>
	</div>
		<div class="row">
			<div class="col-md-12">
					...
					<br>
						<div class="row">
										...
										<label>Calibration Date<span style="color:red;">*</span></label>
											<input type="text" class="form-control select2 col-sm-12" id="cali_date" value="<?php echo date("d-m-Y",strtotime($extras['calibration_date']))?>" placeholder="Enter Calibration Date">
										</div>
										
										<div class="col-md-3">
										<label>Calibration Interval Year<span style="color:red;">*</span></label>
											<input type="text" class="form-control select2 col-sm-12" id="cali_inter_year" value="<?php echo $extras['calibration_interval_year'];?>" placeholder="Enter Calibration Interval Year">
										</div>
										
										<div class="col-md-2">
										<label>Due Date<span style="color:red;">*</span></label>
											<input type="text" class="form-control select2 col-sm-12" id="due_date" value="<?php echo date("d-m-Y",strtotime($extras['due_date']))?>" placeholder="Enter Due Date">
										</div>
										
										<div class="col-md-3">
										<label>Calibrated By<span style="color:red;">*</span></label>
											<input type="text" class="form-control select2 col-sm-12" id="calibrated_by" value="<?php echo $extras['calibrated_by'];?>" placeholder="Enter Calibrated By">
										</div>
							</div>
							<br>
							<div class="row">
										...
										<label>Reported UOM</label>
											<input type="text" class="form-control select2 col-sm-12" id="reported_uom" value="<?php echo $extras['reported_uom'];?>">
										</div>
										...
										<label>Date of Equipment Sent</label>
											<input type="text" class="form-control select2 col-sm-12" id="equip_sent_date" value="<?php echo $extras['date_of_equipment_sent'];?>" placeholder="Enter Date of Equipment Sent">
										</div>
										
										<div class="col-md-3">
										<label>Date of Equipment Received</label>
											<input type="text" class="form-control select2 col-sm-12" id="equip_rec_date" value="<?php echo $extras['date_of_equipment_record'];?>" placeholder="Enter Date of Equipment Received">
										</div>
							...
							<div class="row">
										...
										<label>Date of Certificate Received</label>
											<input type="text" class="form-control select2 col-sm-12" id="certi_rec_date" value="<?php echo $extras['date_of_certificate_record'];?>" placeholder="Enter Date of Certificate Received">
										</div>
										
										<div class="col-md-4">
										<label>Master Equipment Used</label>
											<input type="text" class="form-control select2 col-sm-12" id="master_equip" value="<?php echo $extras['master_equipment_used'];?>" placeholder="Enter Master Equipment Used">
										</div>
										
										<div class="col-md-2">
										<label>Due Date of Master Equipment Used</label>
											<input type="text" class="form-control select2 col-sm-12" id="master_equip_date" value="<?php echo $extras['due_date_of_master_equipment'];?>" placeholder="Enter Due  Date of Master Equipment Used">
										</div>
										...
										<input type="hidden" value="<?php echo $extras['auto_id'];?>" id="auto_ids">
										<input type="hidden" value="<?php echo $extras['unique_id'];?>" id="unique_ids">
										<input type="hidden" value="<?php echo $extras['extra_id'];?>" id="extra_id">
							...
							<div class="row">
										...
										<div class="col-md-4">	
										<label>&nbsp;</label>									
											<button type="button" class="btn btn-info"  onclick="add_more('edit_more_calibration')" name="btn_add_data" id="btn_add_data" style="width:50%" ><i class="fa fa-search" aria-hidden="true"></i>&nbsp;Edit Extra Calibration</button>
										</div>
									<div class="col-md-3">
...
function add_more(type,id){
    ...
    if (type == 'edit_more_calibration') 
	{
				...
				var auto_ids = $('#auto_ids').val(); 
				var unique_ids = $('#unique_ids').val(); 
	...
	$.ajax({
        ...
        success:function(data){
		    ...
		    window.location.href="<?php echo $base_url; ?>view_more_calibration_list.php?id="+unique_ids+"|"+auto_ids;
			}
