...
array($_POST["bill_no"]," AND `estimate_numbers` LIKE '%".$_POST['bill_no']."%'")
);
...
?>
	...
	<table id="example2" class="table table-bordered table-striped" style="width:100%;">
								...
								$count=0;
								 $sel_test_table="select * from estimate_total_span WHERE `est_isdeleted`=0  AND `perfoma_completed_by_biller`='0' AND `which_made`='1'".$where;
								...
								while($row =mysqli_fetch_array($result_test_table))
								{
									...
									?>
											...
											?>
											</td><td style="white-space:nowrap;text-align:center;"><?php echo $row["estimate_numbers"];?></td>
