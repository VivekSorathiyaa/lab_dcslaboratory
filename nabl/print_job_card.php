		...
		<table align="center"
			...
			<tr>
				<td>
					...
					<table align="center"
						style="width: 100%;text-align: center;font-family: 'calibri';font-size: 12px;border-left:1px solid;border-right:1px solid;border-bottom:1px solid;"
						cellspacing="0" cellpadding="2px">
						<tr>
							<td style="text-align: right;font-size: 11px;font-family: 'calibri';font-size: 14px;"
								colspan="4">QSF-0601</td>
						</tr>
						<tr>
					...
					<br><br>
					<table align="center" style="width: 90%;text-align: center;font-family: 'calibri';font-size: 12px;"
						cellspacing="0" cellpadding="2px">
						<tr>
							<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 17px;font-weight:bold;padding-top:20px;"
								colspan="2">SAMPLE JOB CARD</td>
						</tr>
					</table>
					<table align="center"
						style="width: 90%;text-align: center;border:1px solid black;font-family: 'calibri';font-size: 12px;"
						cellspacing="0" cellpadding="2px" bordercolor="black">
						...
						<tr>
							<td style="text-align: left;border-top: 1px solid;" colspan="">&nbsp;Date of booking:&nbsp;</td>
						...
						<tr>
							<td style="text-align: left;border-top: 1px solid;" colspan="">&nbsp;Sample Description:&nbsp;
							</td>
							<td style="text-align: left;border-left: 1px solid;border-top: 1px solid;">
								<?php echo $matreials_name_one; ?></td>
							<!--<td style="text-align: left;border-left: 1px solid;" colspan="">&nbsp;</td>-->
						</tr>
						<tr>
							<td style="text-align: left;border-top: 1px solid;" colspan="">&nbsp;quantity:&nbsp;</td>
							<td style="text-align: left;border-left: 1px solid;border-top: 1px solid;">
					...
					<table align="center" style="width: 90%;text-align: center;font-family: 'calibri';font-size: 12px;"
						cellspacing="0" cellpadding="2px">
						<tr>
							<td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 17px;font-weight:bold;"
								colspan="">DETAILS OF TESTS TO BE CARRIED OUT</td>
						</tr>
					</table>
					...
					<table align="center"
						...
						<tr style="font-weight:bold;text-align:center">
							...
							<td style="width:35%;border-right:1px solid;text-align:left;" colspan="">&nbsp;Test Parameter
							</td>
					...
					<table align="center" style="width: 90%;text-align: center;font-family: 'calibri';font-size: 12px;"
						cellspacing="0" cellpadding="2px">
						<tr>
							<td style="font-family: 'Calibri';text-align:left;">Expected Date of Reporting:
								<?php echo $set_desire_date; ?></td>
						</tr>
						<tr>
							<td style="font-family: 'Calibri';text-align:left;">Specific Instructions, if any</td>
						</tr>
						<tr>
							<td style="font-family: 'Calibri';text-align:left;">Dated: <?php echo $put_sample_rec_date; ?>
							</td>
						</tr>
						<tr>
