					...
					<table id="example1" class="table table-bordered table-striped" style="width:100%">
								...
								<tbody>
									<?php
										...
										$count=0;
										$query="select * from job WHERE `jobisdeleted`=0 AND `assign_status`=1 AND `send_to_second_reception`=1 AND `material_assign`= 1 AND `morr`= 'm' AND `job_lab_assign`='1' AND `job_lab_progress`= '1' AND `job_sent_to_qm`=0 AND `tested_by`='$user_id' AND `job_owner`='2'  ".$where." ORDER BY job_id DESC";
