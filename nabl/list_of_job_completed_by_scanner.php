						...
						<div id="display_data_report">
								...
								<tbody>
									...
									?>
											...
											<a href="upload_file_for_trf_by_scanner.php?trf_no=<?php echo $row['trf_no'];?>" class="btn btn-primary btn-lg btn3d" title="View Job"><span class="glyphicon glyphicon-question-list"></span> View</a>&nbsp;
