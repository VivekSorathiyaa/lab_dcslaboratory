...
$sel_job="select * from job where `trf_no`='$txt_trf'";
...
$select_test_wise="select * from test_wise_material_rate where `trf_no`='$txt_trf' AND `job_no`='$txt_jobs'";
 $select_test_wise_query=mysqli_query($conn,$select_test_wise);
 
 // get_estimate if available
 $sel_estiamte="select * from estimate_total_span where `trf_no`='$txt_trf' AND `job_no`='$txt_jobs'";
					...
					<div class="box box-info">
							...
							<br>
								...
								<div class="row">
										  ...
										  <div class="col-sm-3">
											<input type="text" class="form-control" value="<?php echo $_GET['trf_no'];?>" id="txt_trf_no" name="txt_trf_no" >
										  </div>
											...
											<div class="col-sm-3">
													...
													<input type="text" class="form-control" value="<?php echo $_GET['trf_no'];?>" id="txt_invoice_no" name="txt_invoice_no" >
											</div>
...
function addData(type,id){
    ...
    if (type == 'add_estimate') {
				...
				billData = '&action_type='+type+'&id='+id+'&txt_trf_no='+txt_trf_no+'&txt_job_no='+txt_job_no+'&txt_invoice_no='+txt_invoice_no+'&invoice_date='+invoice_date+'&select_rate='+select_rate+'&hidden_gst_type='+hidden_gst_type+'&txt_cgst='+txt_cgst+'&txt_sgst='+txt_sgst+'&txt_grand='+txt_grand+'&txt_amt_in_word='+txt_amt_in_word+'&total_amt='+total_amt+'&hidden_agency='+hidden_agency+'&gst_no='+gst_no;
