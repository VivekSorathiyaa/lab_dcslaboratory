	...
	if($_SESSION['name']=="")
{
	...
	<?php
		...
		if(isset($_POST['btn_estimate'])){
						...
						{
							$direct_path= $_POST["directpath"];
						}else{
							$direct_path= 0;
						}
						
						$insert_ess="insert into material_assign_total (`gst_type`,`report_number`,`date`,`direct_path`,`mate_rate`,`createdby`,`createddate`,`modifiedby`,`modifieddate`,`assign_status`,`isdeleted`) 
						values(
						'$gst_types',
						'$txt_report_no',
						'$to_insert_date',
							...
							<div class="box-body"  style="border:1px groove #ddd;">
										  ...
										  <label for="inputEmail3" class="col-sm-2 control-label">Date:</label>
											<div class="col-sm-3">
												<div class="input-group date">
													...
													<input type="text" class="form-control pull-right" id="date" name="date" value="<?php echo date('d/m/Y')?>" required   >
												</div>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
												<div class="input-group">
													...
													<input type="checkbox" class="" id="directpath" name="directpath" value="1"><b>Direct Path</b>
												</div>
											</div>
										</div>
									</div>
								...
								<div class="row">
									...
									<div id="gst_status" class="mystyle">
										<input type="radio" value="with_gst" name="rdo_button" id="rdo_button" tabindex="16"><span style="padding:10px;">With Gst</span>
										<input type="radio" value="without_gst" name="rdo_button" id="rdo_button" tabindex="17"><span style="padding:10px;">Without Gst
										</span>
									</div>
									</div>
								</div>
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											<div class="col-sm-2">
												...
												<button type="button" class="btn btn-info pull-right" id="btn_add_data" onclick="addData('add_material_assinging')" name="btn_add_data"  tabindex="25" >Add</button>
									...
									<div class="row">	
										<div class="col-lg-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="total_gst" name="total_gst" value="0">											
												</div>
											</div>
										</div>
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="total_bill" name="total_bill" value="0">											
												</div>
											</div>
										</div>
									</div>
...
$("input[name='rdo_button']").change(
    function(e)
    {
        ...
        buttons: {
			...
			if(gst_value=="without_gst"){ var set_value="Without Gst";}else{ var set_value="With Gst";}
			document.getElementById("gst_status").innerHTML = '<h3>GST TYPE: '+set_value+'</h3>';
...
function getbills(){
    ...
    $.ajax({
        ...
        data: 'action_type=view&txt_report_no='+txt_report_no,
