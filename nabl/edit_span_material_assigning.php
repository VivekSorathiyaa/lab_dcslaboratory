					...
					<div class="box box-info">
							...
							<div class="panel-group">
							  ...
							  ?>
								...
								<button type="button" class="btn btn-info delete_materials" data-id="<?php echo $one_final['final_material_id'];?>"  id="#" name="btn_add_data" style="width:100px;font-size:20px;margin-top: 2%;" >
							...
							<hr>
							<a data-toggle="collapse" href="#collapse_for_test" class="btn btn-success" style="width:10%;margin-top: 2%;font-size: 20px;" id="add_material_button">ADD TEST</a>
							<div id="collapse_for_test" class="panel-collapse collapse">
							<br>
							
							<input type="hidden" name="txt_lab_no" id="labno_for_test" value=""> 
							<input type="hidden" name="txt_finalmatno" id="finalmatno_for_test" value=""> 
							...
							<div class="row">
								  <div class="col-md-4">
									<select class="form-control select2" name="select_material_category_for_test" id="select_material_category_for_test" >
										<option value="">Select Category</option>
										<?php
									
										$sel_final_mat="select * from final_material_assign_master where `trf_no`='$_GET[trf_no]'";
										$query_final_mat=mysqli_query($conn,$sel_final_mat);
										while($one_mat_of_final=mysqli_fetch_array($query_final_mat))
										{
										if($one_mat_of_final['material_category'] !="")
										{
										$sql = "select * from material_category where `material_cat_status`='1' AND `material_cat_isdelete`='0' AND `material_cat_id`=".$one_mat_of_final['material_category'];
										$result = mysqli_query($conn, $sql);
										$one_mat_name=mysqli_fetch_array($result)
										?>
										<option value="<?php echo $one_mat_of_final['material_category']."|".$one_mat_of_final['final_material_id']."|".$one_mat_of_final['lab_no'];?>"><?php echo $one_mat_name['material_cat_name'];?></option>	
										<?php 
										}
										}
										?>
								...
								<div class="col-md-4">
										<div class="form-group">
											...
											<div class="col-sm-12">
											<select class="form-control select2" name="select_material_for_test" id="select_material_for_test">
								...
								<div class="col-md-4">
										<div class="form-group">
											...
											<div class="col-sm-12">
												<div class="col-sm-12">
												<input type="text"  style="height:30px;" name="ex_date_submission_for_test" id="ex_date_submission_for_test" value="<?php echo date('d/m/Y')?>">
											</div>
											</div>
										</div>
								</div>
							...
							<br>
								...
								<div class="row">
									...
									<div class="form-group">
											...
											<div class="col-sm-12">
									<select class="form-control select2" name="select_samp_condition_for_test" id="select_samp_condition_for_test">
									...
									<div class="form-group">
											...
											<div class="col-sm-12">
									<select class="form-control select2" name="select_location_for_test" id="select_location_for_test">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="box box-info">
											<form class="form" id="fortest_billing" method="post">
												<div class="panel-group">
													<div class="panel panel-default">
														<br>
														<div class="panel-heading">
															<h4 class="panel-title" style="text-align:center;">
																<a data-toggle="collapse" href="#fortest_collapsings" class="btn btn-primary" style="color:white;width:20%;"><b>Type Of Sample</b></a>
															</h4>
														</div><br>
														<div id="fortest_collapsings" class="panel-collapse collapse">
															<div class="panel-body">
																<div class="row material_class" id="fortest_CM">
																	<div class="col-md-12">
																	...
																	<hr style="border: 1px solid #ddd;">
																		<div class="col-md-3">
																			<div class="box-body">
																				<div class="form-group">
																					...
																					<select class="form-control" id="fortest_type_of_cement" name="type_of_cement">
																		...
																		<div class="col-md-3">
																			<div class="box-body">
																				<div class="form-group">
																					<label>Grade</label>
																					<select class="form-control" id="fortest_cement_grade" name="cement_grade">
																		...
																		<div class="col-md-3">
																			<div class="box-body">
																				<div class="form-group">
																				  ...
																				  <input type="text" class="form-control" id="fortest_cement_brand" name="cement_brand" placeholder="Brand">
																				</div>
																			</div>
																		</div>
																		<div class="col-md-3">
																			<div class="box-body">
																				<div class="form-group">
																				  ...
																				  <input type="text" class="form-control" id="fortest_week_no" name="week_no" placeholder="Week No.">
																				</div>
																			</div>
																		</div>
																	</div>
																		
																	<div class="row material_class" id="fortest_CA">
																	<div class="col-md-12">
																		...
																		<div class="col-md-3">
																				<div class="box-body">
																					<div class="form-group">
																					  ...
																					  <input type="text" class="form-control" id="fortest_brick_source" name="brick_source" placeholder="Source">
																					</div>
																				</div>
																	</div>
																	<div class="col-md-3">
															<div class="box-body">
																<div class="form-group">
																  ...
																  <input type="text" class="form-control" id="fortest_sample_de" name="fortest_sample_de" placeholder="Sample Description">
																</div>
															</div>
												</div>
																	</div>
																	
																	<div class="row material_class" id="fortest_BR">
																		<div class="col-md-12">
																			...
																			<div class="col-md-6">
																				<div class="box-body">
																					<div class="form-group">
																					  ...
																					  <input type="text" class="form-control" id="fortest_mark" name="mark" style="text-transform:uppercase;" placeholder="Mark">
																					</div>
																				</div>
																			</div>
																			<div class="col-md-6">
																				<div class="box-body">
																					<div class="form-group">
																						...
																						<select class="form-control" id="fortest_brick_specification" name="brick_specification">
																	...
																	<div class="row material_class" id="fortest_BT">
																	<div class="col-md-12">
																		...
																		<div class="col-md-3">
																			<div class="box-body">
																				<div class="form-group">
																				  ...
																				  <input type="text" class="form-control" id="fortest_tanker_no" name="tanker_no" placeholder="Tanker No">
																				</div>
																			</div>
																		</div>
																		<div class="col-md-3">
																			<div class="box-body">
																				<div class="form-group">
																				  ...
																				  <input type="text" class="form-control" id="fortest_lot_no" name="lot_no" placeholder="Lot No.">
																				</div>
																			</div>
																		</div>
																		<div class="col-md-3">
																			<div class="box-body">
																				<div class="form-group">
																					<label>Grade</label>
																					<select class="form-control" id="fortest_bitumin_grade" name="bitumin_grade">
																		...
																		<div class="col-md-3">
																			<div class="box-body">
																				<div class="form-group">
																				  ...
																				  <input type="text" class="form-control" id="fortest_make" name="make" placeholder="Make">
																				</div>
																			</div>
																		</div>
																	</div>
																	...
																	<div class="row material_class" id="fortest_CC">
																	<div class="col-md-12">
																	...
																	<hr style="border: 1px solid #ddd;">
																		<div class="col-md-4">
																			<div class="box-body col-sm-6">
																				<div class="form-group">
																					<label>Grade</label>
																					<select class="form-control" id="fortest_cube_grade" name="cube_grade">
																			...
																			<input type="text" class="form-control" id="fortest_casting_date" name="casting_date" placeholder="Casting Date" value="">
																				</div>
																			</div>
																		...
																		<div class="col-md-4">
																			...
																			<div class="box-body col-sm-4">
																				<div class="form-group">
																					<label>Day</label>
																				<select class="form-control" id="fortest_day" name="day">
																			...
																			<div class="box-body col-sm-6 only_remark">
																				<div class="form-group">
																				  ...
																				  <input type="text" class="form-control" id="fortest_day_remark" name="day_remark" placeholder="Remarks">
																				</div>
																			</div>
																		...
																		<div class="col-md-2">
																			<div class="box-body">
																				<div class="form-group">
																				  ...
																				  <input type="text" class="form-control" id="fortest_cc_identification" name="cc_identification" placeholder="Identification Mark" Value="">
																				</div>
																			</div>
																		</div>
																		
																		<input type="hidden" class="form-control" id="fortest_set_of_cube" name="set_of_cube"  Value="1">
																				
																		
																		<input type="hidden" class="form-control" id="fortest_no_of_cube" name="no_of_cube" value="3" disabled>
																				
																	</div>
																	
																	
																	<div class="row material_class" id="fortest_PB">
																		<div class="col-md-12">
																		...
																		<div class="col-md-5">
																			<div class="box-body col-sm-6">
																				<div class="form-group">
																				  ...
																				  <select class="form-control" id="fortest_shape" name="shape">
																			...
																			<div class="box-body col-sm-6">
																				<div class="form-group">
																				  ...
																				  <input type="text" class="form-control" id="fortest_age" name="age" placeholder="Age">
																				</div>
																			</div>
																		</div>
																		<div class="col-md-5">
																			<div class="box-body col-sm-6">
																				<div class="form-group">
																				  ...
																				  <input type="text" class="form-control" id="fortest_color" name="color" placeholder="Color">
																				</div>
																			</div>
																			...
																			<div class="box-body col-sm-6">
																				<div class="form-group">
																				  ...
																				  <select class="form-control" id="fortest_thickness" name="thickness">
																		...
																		<div class="col-md-2">
																			<div class="box-body">
																				<div class="form-group">
																				  ...
																				  <select class="form-control" id="fortest_paver_grade" name="paver_grade">
																	...
																	<div class="row material_class" id="fortest_SO">
																	<div class="col-md-12">
																	...
																	<div class="col-md-2">
																				<div class="box-body">
																					<div class="form-group">
																					  ...
																					  <input type="text" class="form-control" id="fortest_sample_type" name="sample_type" placeholder="Sample Type">
																					</div>
																				</div>
																			</div>
																	<div class="col-md-2">
																			<div class="box-body">
																				<div class="form-group">
																				  <label for="exampleInputEmail1">Source</label>
																				  <input type="text" class="form-control" id="fortest_soil_source" name="fortest_soil_source" placeholder="Soil Source" value="<?php echo $get_span_table['soil_location']; ?>">
																				</div>
																			</div>
																	</div>
																	</div>
																	
																	<div class="row  material_class" id="fortest_ST">
																		...
																		<hr style="border: 1px solid #ddd;">
																				<div class="box-body col-md-4" >
																					<div class="form-group">
																						<label>Dia (mm)</label>
																						<input type="text" class="form-control" id="fortest_dia" name="dia" placeholder="Dia">
																				...
																				<div class="box-body col-md-4" >
																					<div class="form-group">
																						<label>Grade</label>
																						<select class="form-control" id="fortest_steel_grade" name="steel_grade">
																				...
																				<div class="box-body col-md-4">
																					<div class="form-group">
																					  <label for="exampleInputEmail1">Brand</label>
																					  <input type="text" class="form-control" id="fortest_steel_brand" name="steel_brand" placeholder="Brand">
																					</div>
																				</div>
																	...
																	<div class="row  material_class" id="fortest_WA">
																	<div class="col-md-12">
																	...
																	<div class="box-body col-md-3">
																					<div class="form-group">
																					  <label for="exampleInputEmail1">Source</label>
																					  <input type="text" class="form-control" id="fortest_tile_source" name="tile_source" placeholder="Source">
																					</div>
																				</div>
																	
																	</div>
																											
																	<div class="row  material_class" id="fortest_TI">
																		...
																		<hr style="border: 1px solid #ddd;">	
																			...
																			<div class="col-md-6">
																				<div class="box-body">
																					<div class="form-group">
																						<label>Specification</label>
																						<input type="text" class="form-control" id="fortest_tiles_specification" name="tiles_specification" placeholder="Specification">
																					</div>
																				</div>
																			</div>
																			<div class="col-md-6">
																				...
																				<div class="box-body">
																					<div class="form-group">
																					  <label for="exampleInputEmail1">Brand</label>
																					  <input type="text" class="form-control" id="fortest_brand" name="brand" placeholder="Brand">
																					</div>
																				</div>
																			</div>
																	...
																	<div class="row  material_class" id="fortest_FA">
																			...
																			<div class="col-md-6">
																				...
																				<div class="box-body">
																					<div class="form-group">
																					  ...
																					  <input type="text" class="form-control" id="fortest_fine_agg_source" name="fine_agg_source" placeholder="Fine Aggregate Source">
																					</div>
																				</div>
																			</div>
																			<div class="col-md-6">
																				...
																				<div class="box-body">
																					<div class="form-group">
																					  ...
																					  <input type="text" class="form-control" id="fortest_fine_agg_type" name="fine_agg_type" placeholder="Fine Aggregate Type">
																					</div>
																				</div>
																			</div>
																	...
																	<div class="row  material_class" id="fortest_QU">
																			...
																			<div class="col-md-6">
																				...
																				<div class="box-body">
																					<div class="form-group">
																					  ...
																					  <input type="text" class="form-control" id="fortest_qa_spall_source" name="qa_spall_source" placeholder="Quarry Spall Source">
																					</div>
																				</div>
																			</div>
																	...
																	<div class="row  material_class" id="fortest_FT">
																			...
																			<div class="col-md-6">
																				...
																				<div class="box-body">
																					<div class="form-group">
																					  ...
																					  <input type="text" class="form-control" id="fortest_chainage_no" name="chainage_no" placeholder="Enter Chainage No.">
																					</div>
																				</div>
																				...
																				<div class="box-body">
																					<div class="form-group">
																					  <label for="exampleInputEmail1">Sample Description.</label>
																					  <input type="text" class="form-control" id="fortest_fdd_desc_sample" name="fdd_desc_sample" placeholder="Enter Sample Description." Value="GSB">
																					</div>
																				</div>
																			</div>
																	...
																	<div class="row  material_class" id="fortest_BM">
																			...
																			<div class="col-md-6">
																				...
																				<div class="box-body">
																					<div class="form-group">
																					  ...
																					  <select class="form-control" id="fortest_bitumin_mix" name="bitumin_mix">
									...
									<div class="col-md-2">
										<div class="form-group">
											...
											<div class="col-sm-3">
												<select class="form-control" name="select_test_for_test" id="select_test_for_test" multiple="multiple">
								...
								<div class="col-md-2">
								<input type="hidden" name="radio_for_test" value="r">
										<div class="form-group">
											
											<div class="col-sm-12">
												
												<select class="form-control " name="sel_tested_by_for_test" id="sel_tested_by_for_test" >
								...
								<div class="col-md-3">
										<div class="form-group">
											...
											<div class="col-sm-12">
											<select class="form-control " name="reported_by_for_test" id="reported_by_for_test" style="height:50px;">
													<?php 
								...
								<div class="col-md-4">
										<div class="form-group">
											...
											<div class="col-sm-12">
												<input type="radio" style="width:33px;height:25px;" name="exel_radio_for_test" value="y"><span style="font-size:35px;" ><b>YES</b></span>
												<input type="radio" style="width:33px;height:25px;"name="exel_radio_for_test" value="n" checked><span style="font-size:35px;"><b>No<b></span>
											</div>
										</div>
								</div>
								</div>
								...
								<div class="col-md-3">
										<div class="form-group">
											...
											<div class="col-sm-12">
												<button type="button" class="btn btn-info"  onclick="addData_for_test('add_material_assinging_for_test')" name="btn_add_data" id="btn_add_data" style="width:100%;font-size:20px;margin-left:160%;" >Add Test</button>
											</div>
										</div>
								</div>
								</div>
...
function addData_for_test(type,id){
    id = (typeof id == "undefined")?'':id;
    var statusArr = {add:"added",edit:"updated",delete:"deleted"};
    var billData = '';
    if (type == 'add_material_assinging_for_test') {
				
				var labno = $('#labno_for_test').val(); 
				var finalmatno = $('#finalmatno_for_test').val(); 
				var txt_trf_no = $('#txt_trf_no').val(); 
				var txt_job_no = $('#txt_job_no').val(); 
				var get_concates = $('#select_material_category_for_test').val(); 
				var splited = get_concates.split("|");
				var select_material_category= splited[0];
				var select_material = $('#select_material_for_test').val(); 
				var type_of_cement = $('#fortest_type_of_cement').val(); 
				var cement_grade = $('#fortest_cement_grade').val(); 
				var cement_brand = $('#fortest_cement_brand').val(); 
				var week_no = $('#fortest_week_no').val(); 
				var brick_source = $('#fortest_brick_source').val(); 
				var sample_de = $('#fortest_sample_de').val(); 
				var mark = $('#fortest_mark').val();
				var brick_specification = $('#fortest_brick_specification').val();
				var tanker_no = $('#fortest_tanker_no').val();
				var lot_no = $('#fortest_lot_no').val();
				var bitumin_grade = $('#fortest_bitumin_grade').val();
				var make = $('#fortest_make').val();
				var cube_grade = $('#fortest_cube_grade').val();
				var day_remark = $('#fortest_day_remark').val();
				var casting_date = $('#fortest_casting_date').val();
				var day = $('#fortest_day').val();
				var set_of_cube = $('#fortest_set_of_cube').val();
				var no_of_cube = $('#fortest_no_of_cube').val();
				var cc_identification = $('#fortest_cc_identification').val();
				var chainage_no = $('#fortest_chainage_no').val();
				var fdd_desc_sample = $('#fortest_fdd_desc_sample').val();
				var shape = $('#fortest_shape').val();
				var age = $('#fortest_age').val();
				var color = $('#fortest_color').val();
				var thickness = $('#fortest_thickness').val();
				var paver_grade = $('#fortest_paver_grade').val();
				var sample_type = $('#fortest_sample_type').val();
				var soil_source = $('#fortest_soil_source').val();
				var dia = $('#fortest_dia').val();
				var steel_grade = $('#fortest_steel_grade').val();
				var steel_brand = $('#fortest_steel_brand').val();
				var tile_source = $('#fortest_tile_source').val();
				var tiles_specification = $('#fortest_tiles_specification').val();
				var fine_agg_source = $('#fortest_fine_agg_source').val();
				var fine_agg_type = $('#fortest_fine_agg_type').val();
				var qa_spall_source = $('#fortest_qa_spall_source').val();
				var bitumin_mix = $('#fortest_bitumin_mix').val();
				var tiles_specification = $('#fortest_tiles_specification').val();
				var brand = $('#fortest_brand').val();
				var select_test = $('#select_test_for_test').val();
				var select_samp_condition = $('#select_samp_condition_for_test').val();
				var select_location = $('#select_location_for_test').val();
				var txt_is_sample ="0";
				
				
				var tested_by = $('#sel_tested_by_for_test').val();
				var reported_by = $('#reported_by_for_test').val();
				var ex_date_submission = $('#ex_date_submission_for_test').val();
				var chkmorr = $("input[name='radio_for_test']:checked").val();
				var exel_radio = $("input[name='exel_radio_for_test']:checked").val();
				...
				billData = '&action_type='+type+'&id='+id+'&txt_trf_no='+txt_trf_no+'&txt_job_no='+txt_job_no+'&select_material_category='+select_material_category+'&select_material='+select_material+'&type_of_cement='+type_of_cement+'&cement_grade='+cement_grade+'&cement_brand='+cement_brand+'&week_no='+week_no+'&brick_source='+brick_source+'&mark='+mark+'&brick_specification='+brick_specification+'&tanker_no='+tanker_no+'&lot_no='+lot_no+'&bitumin_grade='+bitumin_grade+'&make='+make+'&cube_grade='+cube_grade+'&day_remark='+day_remark+'&casting_date='+casting_date+'&day='+day+'&set_of_cube='+set_of_cube+'&no_of_cube='+no_of_cube+'&shape='+shape+'&age='+age+'&color='+color+'&thickness='+thickness+'&paver_grade='+paver_grade+'&sample_type='+sample_type+'&dia='+dia+'&steel_grade='+steel_grade+'&steel_brand='+steel_brand+'&tile_source'+tile_source+'&tiles_specification='+tiles_specification+'&brand='+brand+'&select_test='+select_test+'&tested_by='+tested_by+'&reported_by='+reported_by+'&ex_date_submission='+ex_date_submission+'&chkmorr='+chkmorr+'&exel_radio='+exel_radio+'&fine_agg_source='+fine_agg_source+'&qa_spall_source='+qa_spall_source+'&select_samp_condition='+select_samp_condition+'&select_location='+select_location+'&bitumin_mix='+bitumin_mix+'&txt_is_sample='+txt_is_sample+'&cc_identification='+cc_identification+'&chainage_no='+chainage_no+'&fine_agg_type='+fine_agg_type+'&fdd_desc_sample='+fdd_desc_sample+'&labno='+labno+'&finalmatno='+finalmatno+'&sample_de='+sample_de+'&soil_source='+soil_source;
				}else{
					alert(" All Filled Required");
					return false;
				}
...
var clicked_id= $(this).attr('data-id');	
	var postData = 'action_type=delete_one_materials&clicked_id='+clicked_id;
