						...
						<div class="box box-info">
							...
							<div class="row">
								...
								<div class="col-md-3">
									...
									<a href="matt_estimate_print.php?chk_array=<?php echo $chk_array; ?>" class="btn btn-info" title="" target="_blank" style="width:150px;font-size:20px;"><span class="glyphicon glyphicon-question-list"></span> Print</a>
									<br>
								</div>
								<div class="col-md-3">&nbsp;</div>
...
<script>
	...
	function get_table_after_update(id) {
		...
		$.ajax({
			type: 'POST',
			url: '<?php $base_url; ?>save_span_set_rate_for_estimate_merging.php',
			data: billData,
			dataType: 'JSON',
	...
	function addData(type, id) {
		...
		$.ajax({
			...
			success: function(msg) {
				...
				window.location.href = "<?php echo $base_url; ?>span_set_rate_only_for_estimate_merging.php?chk_array=" + txt_trf_no;
