...
<body>
	...
	if (mysqli_num_rows($result_select2) > 0) {
		...
		$date_of_latter = $row_select2['expected_date'];
				...
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 14px 0;margin-bottom:4px;">
						...
						<td style="width:12%;padding-bottom: 4px;">Date of letter</td>
						    <td style="width:6%;padding-bottom: 4px;text-align: center;"> &raquo;</td>
						    <td style="width:40%;text-align:left;padding-bottom: 4px;"><?php echo date('d - m - Y', strtotime($date_of_latter));?></td>
					...
					<table align="left" width="100%" border="0px" cellspacing="0" cellpadding="0" class="test" style="font-family: Cambria;">
							...
							<td colspan="2" style="width:100%;vertical-align:top">
								<table align="top" width="100%" class="test" style="max-width:400px;font-size:10px;font-family: Cambria;">
									...
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">25-50</td>
									</tr>
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">2.36 mic</td>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">10-20</td>
									</tr>
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">0.85 mic</td>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">2-10</td>
									</tr>
									<tr>
											<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">0.425</td>
						...
						<tr>
							<td colspan="3" style="width:100%;vertical-align:top">
									<table align="top" width="80%" class="test" style="font-size:10px;font-family: Cambria;border-right:1px solid;	">
										<?php
										if (($row_select_pipe['combined_index'] != "" && $row_select_pipe['combined_index'] != "0") || ($row_select_pipe['imp_value'] != "" && $row_select_pipe['imp_value'] != "0") || ($row_select_pipe['imp_value'] != "" && $row_select_pipe['imp_value'] != "0") || ($row_select_pipe['sp_specific_gravity'] != "" && $row_select_pipe['sp_specific_gravity'] != "0") || ($row_select_pipe['sp_water_abr'] != "" && $row_select_pipe['sp_water_abr'] != "0") || ($row_select_pipe['cru_value'] != "" && $row_select_pipe['cru_value'] != "0") || ($row_select_pipe['abr_index'] != "" && $row_select_pipe['abr_index'] != "0") || ($row_select_pipe['bdl'] != "" && $row_select_pipe['bdl'] != "0") || ($row_select_pipe['fines_value'] != "" && $row_select_pipe['fines_value'] != "0") || ($row_select_pipe['liquide_limit'] != "" && $row_select_pipe['liquide_limit'] != "0") || ($row_select_pipe['soundness'] != "" && $row_select_pipe['soundness'] != "0") || ($row_select_pipe['cbr'] != "" && $row_select_pipe['cbr'] != "0") || ($row_select_pipe['mdd'] != "" && $row_select_pipe['mdd'] != "0") || ($row_select_pipe['omc'] != "" && $row_select_pipe['omc'] != "0")) {
										...
										?>
											...
											?>
												<tr>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Flakiness %</td>
											...
											?>
												<tr>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Impact Value %</td>
											...
											?>
												<tr>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Specific Gravity</td>
											...
											?>
												<tr>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Crushing Value %</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2386-4</td>
											...
											?>
												<tr>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Abrasion Value %</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2386-4</td>
											...
											?>
												<tr>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Bulk Density kg/Lit.</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2386-3</td>
											...
											?>
												<tr>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">10% Fine Value KN</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2386-4</td>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Liquid Limit %</td>
												...
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Plastic Limit %</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['plastic_limit']; ?></td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">--</td>
												</tr>
												<tr>

													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Plasticity Index %</td>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Maximum Dry Density gm/cc</td>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Optimum Moisture Content %</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2720-8</td>
											...
											?>
												<tr>
													...
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">California Bearing Ratio %</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2720-16</td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;"><?php echo $row_select_pipe['cbr']; ?></td>
													<td style="text-align:center;border:1px solid black;border-right:0px solid black;">Min. 30</td>
												</tr>
										<?php
											}
										}
