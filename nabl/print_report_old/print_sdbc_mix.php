...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from sdbc_mix_1 WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
							...
							<td colspan="2" style="width:49%;vertical-align:top">
								<table align="top" width="100%" class="test" style="height:100%;width:100%;">
									...
									<tr>
										...
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;">70-90</td>
									</tr>
									<tr>
