			...
			<tr>
				<td>
					<table align="center" width="92%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;">
						...
						?>
							<tr>
							    <td style="width:14%;font-size: 11px;padding-bottom: 4px;padding-top: 14px;">Customer</td>
						...
						?>
							<tr>
							<td style="width:14%;font-size: 11px;padding-bottom: 4px;">Name of Work</td>
							<td style="width:6%;padding-bottom: 4px;text-align: center;"> &raquo;</td>
						...
						?>
							<tr>
								<td style="width:14%;font-size: 11px;padding-bottom: 4px;">Agency</td>
								<td style="width:6%;padding-bottom: 4px;text-align: center;"> &raquo; </td>
						...
						?>
							<tr>
								<td style="width:14%;font-size: 11px;padding-bottom:14px;">Agg No.</td>
