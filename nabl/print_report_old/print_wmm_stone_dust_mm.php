...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from wmm_stone_dust WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
			...
			<tr>
				<td>
					<table align="center" width="92%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 14px 0;">
						...
						<tr>
						    <td style="width:12%;font-size: 11px;padding-bottom: 4px;">Material Received</td>
							<td style="width:6%;text-align: center;padding-bottom: 4px;"> &raquo; </td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">Stone Dust</td>
							...
							<td style="width:6%;text-align: left;padding-bottom: 4px;"> &raquo;</td>
							<td style="width:40%;padding-bottom: 4px;"><?php echo date('d - m - Y', strtotime($end_date)); ?></td>
						</tr>

						<tr>
						    <td style="width:12%;font-size: 11px;padding-bottom: 14px;">Method of Test</td>
							<td style="width:6%;padding-bottom:14px;text-align: center;"> &raquo; </td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 14px;">IS 2386</td>
							<td style="width:21%;padding-bottom: 4px;padding-bottom: 14px;">Specification Requirement</td>
							<td style="width:6%;padding-bottom: 4px;text-align: left;padding-bottom: 14px;"> &raquo;</td>
							<td style="width:40%;padding-bottom: 4px;padding-bottom: 14px;">as per <span>MORTH</span></td>
						</tr>
...
<!-- 
			...
			<tr>
				<td>
					<table align="left" width="92%" border="0px" cellspacing="0" cellpadding="0" class="test" style="font-family: Cambria;margin-left:30px;margin-top:20px;">
						<tr style="">
							<td colspan="2" style="width:45%;padding-bottom:4px;font-weight:bold;font-size:11px;"><b>A) Sieves Analysis</b></td>
						</tr>

						<tr>
							<td colspan="2" style="width:100%;vertical-align:top">
								<table align="top" width="100%" class="test" style="max-width:300px;font-size:10px;font-family: Cambria;">
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left: 1px solid black;font-weight:bold;padding:7px 4px;" colspan="3"><b>Particle Size Distribution Test</b></td>
									</tr>
									<tr>
										<td colspan="3" style="font-size:11px;text-align:center;border:1px solid black;border-left: 1px solid black;font-weight:bold;padding:7px 4px;"><b>IS 2386 Part-1</b></td>
										<!-- <td colspan="3" style="text-align:center;border:1px solid black;border-left:1px solid black;"><b>IS 2386-1963-RA 2016: P-1</b></td> -->
									</tr>

									
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 4px;font-weight:bold;">Sieve Size</b></td>
										<!--<td style="text-align:center;border:1px solid black;border-left:0px solid black;"><b>Acceptance<br>Criteria</b></td>-->
										...
										<!-- <td style="text-align:center;border:1px solid black;border-left:1px solid black;"><b>% of Retained</b></td> -->
									</tr>
									

									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">4.75 mm</td>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;font-weight:bold;"><?php echo $row_select_pipe['pass_sample_1']; ?></td>
										<!-- <td style="text-align:center;border:1px solid black;border-left:1px solid black;"><?php echo $row_select_pipe['pass_sample_1']; ?></td> -->
									</tr>

									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">2.36 mm</td>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['pass_sample_2']; ?></td>
										<!-- <td style="text-align:center;border:1px solid black;border-left:1px solid black;"><?php echo $row_select_pipe['pass_sample_2']; ?></td> -->
									</tr>

									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">1.18 mm</td>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['pass_sample_3']; ?></td>
										<!-- <td style="text-align:center;border:1px solid black;border-left:1px solid black;"><?php echo $row_select_pipe['pass_sample_2']; ?></td> -->
									</tr>

									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">600 mic</td>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['pass_sample_4']; ?></td>
										<!-- <td style="text-align:center;border:1px solid black;border-left:1px solid black;"><?php echo $row_select_pipe['pass_sample_3']; ?></td> -->
									</tr>
									
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">300 mic</td>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['pass_sample_5']; ?></td>
										<!-- <td style="text-align:center;border:1px solid black;border-left:1px solid black;"><?php echo $row_select_pipe['pass_sample_3']; ?></td> -->
									</tr>

									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">150 mic</td>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['pass_sample_6']; ?></td>
										<!-- <td style="text-align:center;border:1px solid black;border-left:1px solid black;"><?php echo $row_select_pipe['pass_sample_3']; ?></td> -->
									</tr>

									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">75 mic</td>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;font-weight:bold;"><?php echo $row_select_pipe['pass_sample_7']; ?></td>
										<!-- <td style="text-align:center;border:1px solid black;border-left:1px solid black;"><?php echo $row_select_pipe['pass_sample_4']; ?></td> -->
									</tr>
								</table>
							</td>
							...
							<td colspan="2" style="width:45%">
									<table align="center" width="100%" class="test" style="height:100%;width:100%;margin-right:30px;font-size:10px;font-family: Cambria;">
										<tr>
											<td colspan="3" style="font-size:11px;text-align:center;border:1px solid black;border-left: 1px solid black;font-weight:bold;padding:7px 4px;"><b>Test Name</b></td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left: 1px solid black;font-weight:bold;padding:7px 4px;"><b>Acceptance Critaria</b></td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left: 1px solid black;font-weight:bold;padding:7px 4px;"><b>Test Method</b></td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left: 1px solid black;font-weight:bold;padding:7px 4px;"><b>Test Results</b></td>
										</tr>

										<tr>
											<td colspan="3" style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;"><b>c) Alkali Reactivity Test (Gravimetric Method)</b></td>
											<td style="text-align:center;border:1px solid black;border-right:1px solid black;">--</td>
											<td style="text-align:center;border:1px solid black;border-right:1px solid black;">IS 2386-7</td>
											<td style="text-align:center;border:1px solid black;border-right:1px solid black;"><?php echo $row_select_pipe['alk_10']; ?></td>
										</tr>
									</table>
								</td>
								<?php
						...
						<?php
							...
							?>
								<td colspan="3" style="width:80%;padding-bottom:4px;font-weight:bold;font-size:11px;font-family: Cambria;"><b>B) Other Tests</b></td>
							<?php } else { ?>
								<td colspan="3" style="width:80%"><b>&nbsp;</b></td>
							<?php
							}
							?>
							...
							<tr>
								...
								<table align="top" width="100%" class="test" style="height:100%;font-family: Cambria;">
									<?php
									if (($row_select_pipe['combined_index'] != "" && $row_select_pipe['combined_index'] != "0") || ($row_select_pipe['imp_value'] != "" && $row_select_pipe['imp_value'] != "0") || ($row_select_pipe['imp_value'] != "" && $row_select_pipe['imp_value'] != "0") || ($row_select_pipe['sp_specific_gravity'] != "" && $row_select_pipe['sp_specific_gravity'] != "0") || ($row_select_pipe['sp_water_abr'] != "" && $row_select_pipe['sp_water_abr'] != "0") || ($row_select_pipe['cru_value'] != "" && $row_select_pipe['cru_value'] != "0") || ($row_select_pipe['abr_index'] != "" && $row_select_pipe['abr_index'] != "0") || ($row_select_pipe['bdl'] != "" && $row_select_pipe['bdl'] != "0") || ($row_select_pipe['fines_value'] != "" && $row_select_pipe['fines_value'] != "0") || ($row_select_pipe['liquide_limit'] != "" && $row_select_pipe['liquide_limit'] != "0") || ($row_select_pipe['soundness'] != "" && $row_select_pipe['soundness'] != "0") || ($row_select_pipe['cbr'] != "" && $row_select_pipe['cbr'] != "0") || ($row_select_pipe['mdd'] != "" && $row_select_pipe['mdd'] != "0") || ($row_select_pipe['omc'] != "" && $row_select_pipe['omc'] != "0")) {

									?>
										<tr>
											<td style="font-size:11px;text-align:center;border-top:1px solid black;border-left:1px solid black;font-weight:bold;padding:5px 4px;">Test Name</td>
											<td style="font-size:11px;text-align:center;border-top:1px solid black;border-left:1px solid black;font-weight:bold;padding:5px 4px;">Test Method</td>
											<td style="font-size:11px;text-align:center;border-top:1px solid black;border-left:1px solid black;font-weight:bold;padding:5px 4px;">Test Results</td>
											<td style="font-size:11px;text-align:center;border-top:1px solid black;border-right:1px solid black;border-left:1px solid black;font-weight:bold;padding:5px 4px;">Acceptance Critaria as per MoRTH</td>
											<!-- <td style="text-align:center;border:1px solid black;border-right:1px solid black;"><b>Req. as per<br>IS 383-2016</b></td> -->
										</tr>
										<?php
										if ($row_select_pipe['combined_index'] != "" && $row_select_pipe['combined_index'] != "0") {
										?>
											<tr>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Flakiness %</td>
												<td rowspan="2" style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">IS 2386-1</td>
												<td rowspan="2" style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;"><?php echo $row_select_pipe['combined_index']; ?></td>
												<td rowspan="2" style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Max. 35%</td>
											</tr>
											<tr>
												<td style="text-align:left;border:1px solid black;border-right:1px solid black;">Elongation %</td>
											</tr>
										...
										?>
											<tr>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Impact Value %</td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">IS 2386-4</td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;"><?php echo $row_select_pipe['imp_value']; ?></td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Max. 30%</td>
											</tr>
										...
										?>
											<tr>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Specific Gravity</td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">IS 2386-3</td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;"><?php echo $row_select_pipe['sp_specific_gravity']; ?></td>
										...
										?>
											<tr >
									<td style="text-align:Center;border:1px solid black;border-right:0px solid black;">Water Absorption %</td>
									...
									<td style="text-align:center;border:1px solid black;border-right:0px solid black;">IS 2386-3</td>
										...
										?>
											<tr>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Crushing Value %</td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">IS 2386-4</td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;"><?php echo $row_select_pipe['cru_value']; ?></td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Max. 30%</td>
											</tr>
										<?php
										}
										...
										?>
											<tr>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Abrasion Value %</td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">IS 2386-4</td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;"><?php echo $row_select_pipe['abr_index']; ?></td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Max. 40%</td>
											</tr>
										<?php
										}
										...
										?>
											<tr>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Bulk Density kg/Lit.</td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">IS 2386-3</td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;"><?php echo $row_select_pipe['bdl']; ?></td>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">--</td>
											</tr>
										<?php
										}
										...
										?>
											<tr>
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">10% Fine Value KN</td>
										...
										?>
											<tr>
												...
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Liquid Limit %</td>
											...
											<tr>
												...
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Plastic Limit %</td>
												<td style="text-align:center;border:1px solid black;border-right:1px solid black;"><?php echo $row_select_pipe['plastic_limit']; ?></td>
												<td style="text-align:center;border:1px solid black;border-right:0px solid black;">--</td>
											</tr>
											<tr>

												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Plasticity Index %</td>
												<td style="text-align:center;border:1px solid black;border-right:1px solid black;"><?php echo $row_select_pipe['pi_value']; ?></td>
										...
										?>
											<tr>
												...
												<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">Soundness Na<sub>2</sub>SO<sub>4</sub> %</td>
