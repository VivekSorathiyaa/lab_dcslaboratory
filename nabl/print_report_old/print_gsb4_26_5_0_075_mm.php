...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from gsb_mix_4_m5 WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
	...
	<page size="A4">
		...
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family:Cambria;margin-top:80px;border-bottom:0px solid black;">
			...
			<tr>
				<td style="text-align:center; font-size:15px;padding-bottom:15px; text-decoration: underline; text-underline-offset: 3px;"><b>Properties of GSB Material</b></td>
			</tr>
			...
			<tr>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;">
					<tr style="">
						...
						<td style="width:21%;padding-bottom: 4px;text-align:right;">
					...
					<tr style="">
						...
						<td style="width:0%;padding-bottom: 4px;text-align:right;"> Date of Report</td>
						<td style="width:6%;padding-bottom: 4px;text-align: center;"> &raquo;</td>
			...
			<tr>
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;">
						...
						?>
							<tr>
								<td style="width:12%;font-size: 11px;padding-bottom:14px;">Reference No.</td>
								<td style="width:6%;text-align: center;"> &raquo; </td>
								<td style="width:82%;font-size: 11px;text-align:left;padding-bottom: 14px;"><?php echo $r_name; ?></td>
							</tr>
			...
			<tr>
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 14px 0;margin-bottom:4px;">
					    <tr>
							<td style="width:12%;padding-bottom: 4px;padding-top:14px;">Letter No.</td>
							<td style="width:6%;padding-bottom: 4px;text-align: center;padding-top:14px;"> &raquo;</td>
							<td style="width:40%;text-align:left;padding-bottom: 4px;padding-top:14px;"><?php echo $letter_no;?></td>
							<td style="width:21%;padding-bottom: 4px;padding-top:14px;text-align:right;">Sample Source</td>
							<td style="width:6%;padding-bottom: 4px;text-align: center;padding-top:14px;"> &raquo;</td>
						...
						<tr>
							...
							<td style="width:6%;text-align: center;padding-bottom: 4px;"> &raquo; </td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">Natural / Crushed GSB-IV</td>
						...
						<tr>
							...
							<td style="width:6%;padding-bottom:4px;text-align: center;"> &raquo; </td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">IS 2386 & IS 2720</td>
							<td style="width:21%;padding-bottom: 4px;padding-bottom: 4px;text-align:right;">Specification Requirement</td>
							<td style="width:6%;padding-bottom: 4px;text-align: center;padding-bottom: 4px;"> &raquo;</td>
							<td style="width:40%;padding-bottom: 4px;padding-bottom: 4px;">as per <span>MORTH</span></td>
						</tr>
			...
			<tr>
				<td>
					<table align="left" width="100%" border="0px" cellspacing="0" cellpadding="0" class="test" style="font-family: Cambria;">
					    <tr>
						...
						<tr style="display:flex;">
				  			<td colspan="2" style="width:100%;vertical-align:top">
								...
								<tr>
												...
												<td style="text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 4px;"> Sieve Size</td>
													...
													<td style="border-right:1px solid black;">
														<table style="width:100%;border-collapse: collapse;">
															<tr>
																<td style="font-size:10px;text-align:center;border-bottom:0px solid black;padding:5px 4px;">Test Results</td>
															</tr>
															<tr style="">
																<td style="font-size:10px;text-align:center;border-top:1px solid black;padding:5px 4px;">% of Passing</td>
															</tr>
														</table>
													</td>
													<td style="border-right:1px solid black;">
														<table style="width:100%;border-collapse: collapse;">
															<tr>
																<td style="font-size:10px;text-align:center;border-bottom:0px solid black;padding:5px 4px;">% Passing as Per MORTH <br> 5th Rev. Table 400-1</td>
															</tr>
															<tr style="">
																<td style="font-size:10px;text-align:center;border-top:1px solid black;padding:5px 4px;">GSB Gr-IV</td>
															</tr>
														</table>
													</td>
											</tr>
									...
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">53 mm</td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['pass_sample_1']; ?></td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">100</td>
										<!--<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><? php // echo $row_select_pipe['cum_ret_1'];
																																?></td>-->
									</tr>
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">26.5 mm</td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['pass_sample_2']; ?></td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">50-80</td>
										<!--<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><? php // echo $row_select_pipe['cum_ret_2'];
																																?></td>-->
									</tr>
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">4.75 mm</td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['pass_sample_3']; ?></td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">15-35</td>
										<!--<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><? php // echo $row_select_pipe['cum_ret_3'];
																																?></td>-->
									</tr>
									<tr>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">75 mic</td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $row_select_pipe['pass_sample_4']; ?></td>
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">&lt; 5</td>
										<!--<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"><? php // echo $row_select_pipe['cum_ret_4'];
																																?></td>-->
									</tr>

									<tr>
											<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">Pan</td>
											<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;"></td>
											<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">-</td>
									</tr>
								</table>
							</td>
							...
							?>
								<td colspan="2" style="width:100%">
									<table width="100%" class="test" style="margin-left:15px;max-width:350px;font-size:10px;font-family: Cambria;">
											<tr>
												<td colspan="3" style="font-size:11px;text-align:center;border:1px solid black;border-left: 1px solid black;font-weight:bold;padding:5px 4px;">Test Name</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left: 1px solid black;font-weight:bold;padding:5px 4px;">Acceptance Critaria</td>
											...
											<tr>
												<td colspan="3" style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">III) Alkali Reactivity Test (Gravimetric Method)</td>
						...
						<tr>
							...
							?>
								<td colspan="3" style="padding-bottom:7px;font-weight:bold;font-size:11px;padding-top:7px;">B) Other Test :</td>
							<?php } else { ?>
						...
						<tr>
							<td colspan="3" style="width:100%;vertical-align:top">
									<table align="top" width="80%" class="test" style="font-size:10px;font-family: Cambria;">
										<?php
										if (($row_select_pipe['combined_index'] != "" && $row_select_pipe['combined_index'] != "0") || ($row_select_pipe['imp_value'] != "" && $row_select_pipe['imp_value'] != "0") || ($row_select_pipe['imp_value'] != "" && $row_select_pipe['imp_value'] != "0") || ($row_select_pipe['sp_specific_gravity'] != "" && $row_select_pipe['sp_specific_gravity'] != "0") || ($row_select_pipe['sp_water_abr'] != "" && $row_select_pipe['sp_water_abr'] != "0") || ($row_select_pipe['cru_value'] != "" && $row_select_pipe['cru_value'] != "0") || ($row_select_pipe['abr_index'] != "" && $row_select_pipe['abr_index'] != "0") || ($row_select_pipe['bdl'] != "" && $row_select_pipe['bdl'] != "0") || ($row_select_pipe['fines_value'] != "" && $row_select_pipe['fines_value'] != "0") || ($row_select_pipe['liquide_limit'] != "" && $row_select_pipe['liquide_limit'] != "0") || ($row_select_pipe['soundness'] != "" && $row_select_pipe['soundness'] != "0") || ($row_select_pipe['cbr'] != "" && $row_select_pipe['cbr'] != "0") || ($row_select_pipe['mdd'] != "" && $row_select_pipe['mdd'] != "0") || ($row_select_pipe['omc'] != "" && $row_select_pipe['omc'] != "0")) {
										...
										?>
											...
											<tr>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">RD g/cc</td>
													<td rowspan=3 style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">IS 2720 Part 8</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">--</td>
											</tr>
											...
											?>
												<tr>
													...
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"> MDD (gm/cc)</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['mdd']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">--</td>
												</tr>
											...
											?>
												<tr>
													...
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"> OMC %</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['omc']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">--</td>
												</tr>
											...
											?>
												<tr>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Flakiness %</td>
													<td rowspan="2" style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">IS 2386-1</td>
													<td rowspan="2" style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['combined_index']; ?></td>
													<td rowspan="2" style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Max. 40%</td>
												</tr>
												<tr>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Elongation %</td>
											...
											?>
												<tr>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Impact Value %</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">IS 2386 Part 4</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['imp_value']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Max. 40 %</td>
												</tr>
											...
											?>
												<tr>
													...
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"> CBR %</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">IS 2720 Part 16</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['cbr']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Min. 30 %</td>
												</tr>
											...
											?>
												<tr>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Specific Gravity</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">IS 2386 Part 3</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['sp_specific_gravity']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">--</td>
												</tr>
											<?php
											}
											...
											?>
												<tr>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Water Absorption %</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">IS 2386 Part 3</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['sp_water_abr']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Max. 2 %</td>
												</tr>
											<?php
											}
											...
											?>
												<tr>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Crushing Value %</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">IS 2386 Part 4</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['cru_value']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Max. 30 %</td>
												</tr>
											<?php
											}
											...
											?>
												<tr>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Abrasion Value %</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">IS 2386 Part 4</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['abr_index']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Max. 30 %</td>
												</tr>
											<?php
											}
											...
											?>
												<tr>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Bulk Density kg/Lit.</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">IS 2386 Part 3</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['bdl']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">--</td>
												</tr>
											<?php
											}
											...
											?>
												<tr>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">10% Fine Value KN</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">IS 2386 Part 4</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['fines_value']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">--</td>
												</tr>
											<?php
											}
											...
											?>
												<tr>
													...
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Liquid Limit (LL)</td>
													<td rowspan="3" style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">IS 2720 Part 5</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['liquide_limit']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Max 25 %</td>
												</tr>
												<tr>

													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Plastic Limit  (PL)</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['plastic_limit']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">--</td>
												</tr>
												<tr>

													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Plasticity Index (PI)</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['pi_value']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Max 6 %</td>
												</tr>
											<?php
											}
											...
											?>
												<tr>
													...
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Soundness Na<sub>2</sub>SO<sub>4</sub> %</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">IS 2386 Part 5</td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;"><?php echo $row_select_pipe['soundness']; ?></td>
													<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 4px;">Max. 12%</td>
												</tr>
