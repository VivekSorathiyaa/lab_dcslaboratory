	...
	<page size="A4">
				...
				<td>
					<table align="center" width="92%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 14px 0;">
						...
						<tr>
							...
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">Kapchi - Coarse Aggregates</td>
						...
						<tr>
						    <td style="width:12%;font-size: 11px;padding-bottom: 14px;">Size of Sample</td>
							<td style="width:6%;padding-bottom:14px;text-align: center;"> &raquo; </td>
		...
		<!-- <tr>
			<td style="text-align:center;font-size:14px; ">
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px;font-family: Cambria;border-bottom:1px solid;border-right:1px solid;border-top:1px solid;">
				...
				<td>
					...
					<?php if (($row_select_pipe['pass_sample_1'] != "") && ($row_select_pipe['pass_sample_1'] != null) && ($row_select_pipe['pass_sample_1'] != "0")) { ?>
								<td width="100%" style="vertical-align:top;">
									<table align="left" width="92%" class="test" style="max-width:500px;margin-left:30px;margin-bottom:20px;font-family: Cambria;">
										<tr>
										...
										<tr>
											<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">40.0 mm</td>
										...
										<tr>
											<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">20.0 mm</td>
										...
										<tr>
											<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">10.0 mm</td>
							...
							<table align="center" width="85%" cellspacing="0" cellpadding="0" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;border-right:1px solid;border-top:1px solid;margin-right:29px;margin-bottom:20px;">
								...
								<tr style="">
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;">
									            <table style="width:100%;border-collapse: collapse;">
													<tr>
														<td style="font-size:10px;text-align:center;border-bottom:0px solid black;padding:5px 4px;">Flakiness (%)</td>
													</tr>
													<tr style="">
														<td style="font-size:10px;text-align:center;border-top:1px solid black;padding:5px 4px;">Elongation (%)</td>
													</tr>
												</table>
											</td>
								...
								<tr style="">
									...
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;">
									   <table style="border-collapse: collapse;width:100%;">
										 <tr>
											<td style="border-right: 1px solid black;border-bottom: 1px solid black;font-size:10px;text-align:center;width:50%;padding:5px 4px;">For Wearing Surface</td>
											<td style="border-bottom: 1px solid black;font-size:10px;text-align:center;width:50%;padding:5px 0;">Max 30%</td>
										 </tr>
										 <tr>
											<td style="border-right: 1px solid black;font-size:10px;text-align:center;width:50%;padding:5px 0;">For other than <br> Wearing Surface</td>
											<td style="font-size:10px;text-align:center;width:50%;padding:5px 4px;">Max 45%</td>
										</tr>
									   </table>
								    </td>
								...
								<tr style="">
									...
									<td style="border-left: 1px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;padding:5px 0;" colspan=2><?php echo $row_select_pipe['sp_specific_gravity']; ?></td>
								</tr>
								...
								<tr style="">
									...
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 0;">I.S 2386-3</td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;padding:5px 0;" colspan=2><?php echo $row_select_pipe['sp_water_abr']; ?>1</td>
								</tr>
								...
								<tr style="">
									...
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;">
									   <table style="border-collapse: collapse;width:100%;">
										 <tr>
											<td style="border-right: 1px solid black;border-bottom: 1px solid black;font-size:10px;text-align:center;width:50%;padding:5px 4px;">For Wearing Surface</td>
											<td rowspan="2" style="font-size:10px;text-align:center;width:50%;padding:5px 4px;">Max 30%</td>
										 </tr>
										 <tr>
											<td style="border-right: 1px solid black;font-size:10px;text-align:center;width:50%;padding:5px 4px;">For other than <br> Wearing Surface</td>
										</tr>
									   </table>
								    </td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center; ">I.S 2386-4</td>
								...
								<tr style="">
									...
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;">
									   <table style="border-collapse: collapse;width:100%;">
										 ...
										 <tr>
											<td style="border-right: 1px solid black;font-size:10px;text-align:center;width:50%;padding:5px 4px;">For other than <br> Wearing Surface</td>
											<td style="font-size:10px;text-align:center;width:50%;padding:5px 0;">Max 50%</td>
										</tr>
									   </table>
								    </td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center; ">I.S 2386-4</td>
