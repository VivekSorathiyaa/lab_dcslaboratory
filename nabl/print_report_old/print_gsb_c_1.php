...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from gsb_c_1 WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
	...
	if (mysqli_num_rows($result_select2) > 0) {
		...
		if (mysqli_num_rows($result_select3) > 0) {
			...
			if (
				...
				strpos($row_select3["mt_name"], "GSB - I MIX (COARSE GRADED)") !== false
			) {
