...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from gsb_mix_6_m5 WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
				...
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:10px;font-family: Cambria;border-bottom:1px solid;padding: 14px 0;margin-bottom:4px;">
						...
						<tr>
							...
							<td style="width:6%;text-align: center;padding-bottom: 4px;"> &raquo; </td>
							<td style="width:40%;font-size: 10px;text-align:left;padding-bottom: 4px;">Natural / Crushed GSB-VI</td>
							...
							<td colspan="2" style="width:100%;vertical-align:top">
								<table align="top" width="100%" class="test" style="max-width:400px;font-size:10px;font-family: Cambria;">
												...
												<td style="text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 4px;"> Sieve Size</td>
													...
													<td style="border-right:1px solid black;">
														<table style="width:100%;border-collapse: collapse;">
															...
															<tr style="">
																<td style="font-size:10px;text-align:center;border-top:1px solid black;padding:5px 4px;">GSB Gr-VI</td>
															</tr>
														</table>
													</td>
											</tr>
									...
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">75-100</td>
									</tr>
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">55-75</td>
									</tr>
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">30-55</td>
									</tr>
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">10-25</td>
									</tr>
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">0-8</td>
									</tr>
									<tr>
										...
										<td style="font-size:10px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">0-3</td>
									</tr>
									<tr>
