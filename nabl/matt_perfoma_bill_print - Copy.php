...
<body>
	...
	$sel_estiamte = "select * from estimate_total_span where `trf_no`='$chk_array' AND `job_no`='$chk_array'";
	...
	$nabl_type = $row_estiamte["nabl_type"];
	...
	<page size="A4">
		...
		<table align="center" width="90%" class="test" border="1px" id="table_1" style="font-family: Book Antiqua;">
			...
			<tbody>
				...
				//print_r($set_unique_mat_id_array);
