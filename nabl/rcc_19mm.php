			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">Coarse Aggregate 19 MM</h2>
					</div>
        ...
        <div class="panel-body">
			<div class="row">									
							...
							<div class="row">									
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="grd_e_d" name="grd_e_d" value="<?php echo date('d/m/Y', strtotime($end_date)); ?>">
									</div>
								</div>
							</div>
							<br>
								...
								<div class="row">
									...
									<div class="col-lg-1">
										<div class="form-group">
											<div class="col-sm-12">
												<label for="inputEmail3" class="control-label">19 mm</label>
											</div>
										</div>
									</div>
									<div class="col-lg-2">
								...
								<div class="row">
										...
										<div class="col-lg-1">
											<div class="form-group">
												<div class="col-sm-12">
													<label for="inputEmail3" class="control-label">13.2 mm</label>
												</div>
											</div>
										</div>
										<div class="col-lg-2">
								...
								<div class="row">
										...
										<div class="col-lg-1">
											<div class="form-group">
												<div class="col-sm-12">
													<label for="inputEmail3" class="control-label">11.2 mm</label>
												</div>
											</div>
										</div>
										<div class="col-lg-2">
								...
								<div class="row">
										...
										<div class="col-lg-1">
											<div class="form-group">
												<div class="col-sm-12">
													<label for="inputEmail3" class="control-label">9.5 mm</label>
												</div>
											</div>
										</div>
										<div class="col-lg-2">
								...
								<div class="row">
										...
										<div class="col-lg-1">
											<div class="form-group">
												<div class="col-sm-12">
													<label for="inputEmail3" class="control-label">5.6 mm</label>
												</div>
											</div>
										</div>
										<div class="col-lg-2">
								...
								<div class="row">
										...
										<div class="col-lg-1">
											<div class="form-group">
												<div class="col-sm-12">
													<label for="inputEmail3" class="control-label">PAN</label>
												</div>
											</div>
										</div>
										<div class="col-lg-2">
					...
					<div id="collapse2" class="panel-collapse collapse">
						<div class="panel-body">
							...
							<div class="row">									
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="flk_e_d" name="flk_e_d" value="<?php echo date('d/m/Y', strtotime($end_date)); ?>">
									</div>
								</div>
							</div>
							<br>
							...
							<div class="row">
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="total_b" name="total_a" >
									</div>
								</div>
								<div class="col-lg-2">
									<div class="form-group">
		...
		<div id="collapse3" class="panel-collapse collapse">
						<div class="panel-body">
							...
							<div class="row">									
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="wtr_e_d" name="wtr_e_d" value="<?php echo date('d/m/Y', strtotime($end_date)); ?>">
									</div>
								</div>
							</div>
							<br>
				  ...
				  <div id="collapse4" class="panel-collapse collapse">
						...
						<!--ABRASION VALUE START-->
							...
							<div class="row">									
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="abr_e_d" name="abr_e_d" value="<?php echo date('d/m/Y', strtotime($end_date)); ?>">
									</div>
								</div>
							</div>
							<br>
					  ...
					  <div id="collapse5" class="panel-collapse collapse">
						<div class="panel-body">
							...
							<div class="row">									
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="cru_e_d" name="cru_e_d" value="<?php echo date('d/m/Y', strtotime($end_date)); ?>">
									</div>
								</div>
							</div>
							<br>
					  ...
					  <div id="collapse6" class="panel-collapse collapse">
						...
						<div class="row">									
							...
							<div class="row">									
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="sou_e_d" name="sou_e_d" value="<?php echo date('d/m/Y', strtotime($end_date)); ?>">
									</div>
								</div>
							</div>
							<br>
			...
			{ $test_check.="den,";?>
				...
				<div id="collapse15" class="panel-collapse collapse">
							...
							<div class="row">									
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="den_e_d" name="den_e_d" value="<?php echo date('d/m/Y', strtotime($end_date)); ?>">
									</div>
								</div>
							</div>
							<br>
      ...
      <div id="collapse7" class="panel-collapse collapse">
		...
		<!--Impact VALUE Start-->
							...
							<div class="row">									
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="fin_e_d" name="fin_e_d" value="<?php echo date('d/m/Y', strtotime($end_date)); ?>">
									</div>
								</div>
							</div>
							<br>
					  ...
					  <div id="collapse8" class="panel-collapse collapse">
						<div class="panel-body">
							...
							<div class="row">									
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="alk_e_d" name="alk_e_d" value="<?php echo date('d/m/Y', strtotime($end_date)); ?>">
									</div>
								</div>
							</div>
							<br>
				  ...
				  <div id="collapse11" class="panel-collapse collapse">
						<div class="panel-body">
							...
							<div class="row">									
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="lll_e_d" name="lll_e_d" value="<?php echo date('d/m/Y', strtotime($end_date)); ?>">
									</div>
								</div>
							</div>
							<br>
			...
			<!--Impact VALUE Start-->
				...
				<br>
							<div class="row">									
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="imp_e_d" name="imp_e_d" value="<?php echo date('d/m/Y', strtotime($end_date)); ?>">
									</div>
								</div>
							</div>
							<br>
				...
				<div class="row">
					...
					<div class="col-lg-3">
						<div class="form-group">
							<div class="col-sm-12">
								<input type="text" class="form-control" id="imp_value_3" name="imp_value_3" >
							</div>
						</div>
					</div>									
				</div>
			...
			<!--Impact VALUE Start-->
				...
				<br>
							<div class="row">									
								...
								<div class="col-lg-2">
									<div class="form-group">
										<input type="text" class="form-control" id="dtm_e_d" name="dtm_e_d" value="<?php echo date('d/m/Y', strtotime($end_date)); ?>">
									</div>
								</div>
							</div>
							<br>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-sm-2">
												...
												<?php   
													$querys_job1 = "SELECT * FROM rcc_19mm WHERE `is_deleted`='0' and lab_no='$lab_no'";
											...
											?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_rcc_19mm.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
 
											</div>
											
											<?php //} ?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&tbl_name=rcc_19mm" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
					...
					<div class="col-lg-12">
						<table border="1px solid black" align="center" width="100%" id="aaaa">
							<tr>
								...
								<?php
							 $query = "select * from rcc_19mm WHERE lab_no='$aa'  and `is_deleted`='0'";
...
$(document).ready(function(){ 
	...
	function abr_auto()
	{
		$('#txtabr').css("background-color","var(--success)");
			...
			if(abr_grading=="A")
			{
				...
				var abr_index = randomNumberFromRange(15.0,20.0);	
			...
			else if(abr_grading=="B")
			{
				...
				var abr_index = randomNumberFromRange(17.0,20.0);	
				$('#abr_index').val(abr_index.toFixed(1));
				var abrindex = $('#abr_index').val();							
				 var tt = randomNumberFromRange(-0.99,0.99).toFixed(2);
				 var r = randomNumberFromRange(0,9).toFixed();
				 ...
				 var abr_wt_t_a_1 = 10000;
				 var abr_wt_t_a_2 = 10000;
				 $('#abr_wt_t_a_1').val(abr_wt_t_a_1);
				 $('#abr_wt_t_a_2').val(abr_wt_t_a_2);
				 $('#abr_1').val(abr_1.toFixed(2));
				 $('#abr_2').val(abr_2.toFixed(2));
	...
	$("#abr_index").change(function(){
		...
		function sp_auto()
		{
			...
			var sp_specificgravity = randomNumberFromRange(2.800,2.950).toFixed(3);  //(sp_specific_gravity)
			var sp_waterabr = randomNumberFromRange(0.75,1.25).toFixed(2);
...
//SOUNDNESS	
	...
	function imp_auto()
	{
		$('#txtimp').css("background-color","var(--success)");
			var imp_value4 = randomNumberFromRange(11.00,16.00);
	...
	function crush_auto()
	{
		$('#txtcru').css("background-color","var(--success)");	
			var cru_value = randomNumberFromRange(18.0,23.0).toFixed(1);			
	...
	function grd_auto()
	{
		...
		var pass_sample_2 = randomNumberFromRange(75.00,89.00).toFixed(2);
		var pass_sample_3 = randomNumberFromRange(35.00,55.00).toFixed(2);
		var pass_sample_4 = randomNumberFromRange(20.00,34.00).toFixed(2);
		var pass_sample_5 = randomNumberFromRange(11.00,19.00).toFixed(2);
		var pass_sample_6 = randomNumberFromRange(0.00,10.00).toFixed(2);
...
function getGlazedTiles(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo $base_url; ?>save_rcc_19mm.php',
...
function saveMetal(type,id){
    ...
    if (type == 'add') {
				...
				billData = $("#Glazed").find('.form').serialize()+'&action_type='+type+'&idEdit='+idEdit+'&report_no='+report_no+'&job_no='+job_no+'&lab_no='+lab_no+'&chk_omc='+chk_omc+'&omc_1='+omc_1+'&omc_2='+omc_2+'&omc_3='+omc_3+'&chk_sou='+chk_sou+'&s6total='+s6total+'&soundness='+soundness+'&s31='+s31+'&s32='+s32+'&s33='+s33+'&s34='+s34+'&s35='+s35+'&s36='+s36+'&s37='+s37+'&s38='+s38+'&s39='+s39+'&s30='+s30+'&s41='+s41+'&s42='+s42+'&s43='+s43+'&s44='+s44+'&s45='+s45+'&s46='+s46+'&s47='+s47+'&s48='+s48+'&s49='+s49+'&s40='+s40+'&s51='+s51+'&s52='+s52+'&s53='+s53+'&s54='+s54+'&s55='+s55+'&s56='+s56+'&s57='+s57+'&s58='+s58+'&s59='+s59+'&s50='+s50+'&s61='+s61+'&s62='+s62+'&s63='+s63+'&s64='+s64+'&s65='+s65+'&s66='+s66+'&s67='+s67+'&s68='+s68+'&s69='+s69+'&s60='+s60+'&chk_sp='+chk_sp+'&sp_w_sur_1='+sp_w_sur_1+'&sp_w_sur_2='+sp_w_sur_2+'&sp_w_s_1='+sp_w_s_1+'&sp_w_s_2='+sp_w_s_2+'&sp_wt_st_1='+sp_wt_st_1+'&sp_wt_st_2='+sp_wt_st_2+'&sp_specific_gravity='+sp_specific_gravity+'&sp_specific_gravity_1='+sp_specific_gravity_1+'&sp_specific_gravity_2='+sp_specific_gravity_2+'&sp_water_abr='+sp_water_abr+'&sp_water_abr_1='+sp_water_abr_1+'&sp_water_abr_2='+sp_water_abr_2+'&chk_abr='+chk_abr+'&abr_index='+abr_index+'&abr_wt_t_a_1='+abr_wt_t_a_1+'&abr_wt_t_a_2='+abr_wt_t_a_2+'&abr_wt_t_b_1='+abr_wt_t_b_1+'&abr_wt_t_b_2='+abr_wt_t_b_2+'&abr_wt_t_c_1='+abr_wt_t_c_1+'&abr_wt_t_c_2='+abr_wt_t_c_2+'&abr_1='+abr_1+'&abr_2='+abr_2+'&abr_grading='+abr_grading+'&abr_weight_charge='+abr_weight_charge+'&abr_sphere='+abr_sphere+'&abr_num_revo='+abr_num_revo+'&chk_alkali='+chk_alkali+'&alk_1='+alk_1+'&alk_2='+alk_2+'&alk_3='+alk_3+'&alk_4='+alk_4+'&alk_5='+alk_5+'&alk_6='+alk_6+'&alk_7='+alk_7+'&alk_8='+alk_8+'&alk_9='+alk_9+'&alk_10='+alk_10+'&alk_11='+alk_11+'&chk_den='+chk_den+'&m11='+m11+'&m12='+m12+'&m13='+m13+'&m21='+m21+'&m22='+m22+'&m23='+m23+'&m31='+m31+'&m32='+m32+'&m33='+m33+'&avg_wom='+avg_wom+'&vol='+vol+'&bdl='+bdl+'&chk_crushing='+chk_crushing+'&cru_value='+cru_value+'&cr_a_1='+cr_a_1+'&cr_a_2='+cr_a_2+'&cr_b_1='+cr_b_1+'&cr_b_2='+cr_b_2+'&cru_value_1='+cru_value_1+'&cru_value_2='+cru_value_2+'&chk_fines='+chk_fines+'&fines_value='+fines_value+'&f_a_1='+f_a_1+'&f_a_2='+f_a_2+'&f_b_1='+f_b_1+'&f_b_2='+f_b_2+'&f_c_1='+f_c_1+'&f_c_2='+f_c_2+'&f_d_1='+f_d_1+'&f_d_2='+f_d_2+'&avg_f_d='+avg_f_d+'&avg_f_c='+avg_f_c+'&chk_flk='+chk_flk+'&s11='+s11+'&s12='+s12+'&s13='+s13+'&s14='+s14+'&s15='+s15+'&s16='+s16+'&s17='+s17+'&s18='+s18+'&s19='+s19+'&a1='+a1+'&a2='+a2+'&a3='+a3+'&a4='+a4+'&a5='+a5+'&a6='+a6+'&a7='+a7+'&a8='+a8+'&a9='+a9+'&suma='+suma+'&b1='+b1+'&b2='+b2+'&b3='+b3+'&b4='+b4+'&b5='+b5+'&b6='+b6+'&b7='+b7+'&b8='+b8+'&b9='+b9+'&sumb='+sumb+'&aa1='+aa1+'&aa2='+aa2+'&aa3='+aa3+'&aa4='+aa4+'&aa5='+aa5+'&aa6='+aa6+'&aa7='+aa7+'&aa8='+aa8+'&aa9='+aa9+'&sumaa='+sumaa+'&dd1='+dd1+'&dd2='+dd2+'&dd3='+dd3+'&dd4='+dd4+'&dd5='+dd5+'&dd6='+dd6+'&dd7='+dd7+'&dd8='+dd8+'&dd9='+dd9+'&sumdd='+sumdd+'&flk_x1='+flk_x1+'&flk_x2='+flk_x2+'&flk_x3='+flk_x3+'&flk_x4='+flk_x4+'&flk_x5='+flk_x5+'&flk_x6='+flk_x6+'&flk_x7='+flk_x7+'&flk_x8='+flk_x8+'&flk_x9='+flk_x9+'&flk_y1='+flk_y1+'&flk_y2='+flk_y2+'&flk_y3='+flk_y3+'&flk_y4='+flk_y4+'&flk_y5='+flk_y5+'&flk_y6='+flk_y6+'&flk_y7='+flk_y7+'&flk_y8='+flk_y8+'&flk_y9='+flk_y9+'&flk_xy1='+flk_xy1+'&flk_xy2='+flk_xy2+'&flk_xy3='+flk_xy3+'&flk_xy4='+flk_xy4+'&flk_xy5='+flk_xy5+'&flk_xy6='+flk_xy6+'&flk_xy7='+flk_xy7+'&flk_xy8='+flk_xy8+'&flk_xy9='+flk_xy9+'&elo_x1='+elo_x1+'&elo_x2='+elo_x2+'&elo_x3='+elo_x3+'&elo_x4='+elo_x4+'&elo_x5='+elo_x5+'&elo_x6='+elo_x6+'&elo_x7='+elo_x7+'&elo_x8='+elo_x8+'&elo_x9='+elo_x9+'&elo_y1='+elo_y1+'&elo_y2='+elo_y2+'&elo_y3='+elo_y3+'&elo_y4='+elo_y4+'&elo_y5='+elo_y5+'&elo_y6='+elo_y6+'&elo_y7='+elo_y7+'&elo_y8='+elo_y8+'&elo_y9='+elo_y9+'&elo_xy1='+elo_xy1+'&elo_xy2='+elo_xy2+'&elo_xy3='+elo_xy3+'&elo_xy4='+elo_xy4+'&elo_xy5='+elo_xy5+'&elo_xy6='+elo_xy6+'&elo_xy7='+elo_xy7+'&elo_xy8='+elo_xy8+'&elo_xy9='+elo_xy9+'&total_a='+total_a+'&total_b='+total_b+'&total_flk_x='+total_flk_x+'&total_flk_y='+total_flk_y+'&total_flk_xy='+total_flk_xy+'&total_aa='+total_aa+'&total_dd='+total_dd+'&total_elo_x='+total_elo_x+'&total_elo_y='+total_elo_y+'&total_elo_xy='+total_elo_xy+'&fi_index='+fi_index+'&ei_index='+ei_index+'&combined_index='+combined_index+'&chk_impact='+chk_impact+'&imp_w_m_a_1='+imp_w_m_a_1+'&imp_w_m_a_2='+imp_w_m_a_2+'&imp_w_m_b_1='+imp_w_m_b_1+'&imp_w_m_b_2='+imp_w_m_b_2+'&imp_w_m_c_1='+imp_w_m_c_1+'&imp_w_m_c_2='+imp_w_m_c_2+'&imp_value_1='+imp_value_1+'&imp_value_2='+imp_value_2+'&imp_value='+imp_value+'&chk_ll='+chk_ll+'&pen1='+pen1+'&pen2='+pen2+'&pen3='+pen3+'&pen4='+pen4+'&cont1='+cont1+'&cont2='+cont2+'&cont3='+cont3+'&cont4='+cont4+'&wc1='+wc1+'&wc2='+wc2+'&wc3='+wc3+'&wc4='+wc4+'&od1='+od1+'&od2='+od2+'&od3='+od3+'&od4='+od4+'&ww1='+ww1+'&ww2='+ww2+'&ww3='+ww3+'&ww4='+ww4+'&wf1='+wf1+'&wf2='+wf2+'&wf3='+wf3+'&wf4='+wf4+'&ds1='+ds1+'&ds2='+ds2+'&ds3='+ds3+'&ds4='+ds4+'&mo1='+mo1+'&mo2='+mo2+'&mo3='+mo3+'&mo4='+mo4+'&ln1='+ln1+'&ln2='+ln2+'&ln3='+ln3+'&ln4='+ln4+'&avg_ll='+avg_ll+'&avg_pl='+avg_pl+'&plastic_limit='+plastic_limit+'&pi_value='+pi_value+'&liquide_limit='+liquide_limit+'&chk_grd='+chk_grd+'&sieve_1='+sieve_1+'&sieve_2='+sieve_2+'&sieve_3='+sieve_3+'&sieve_4='+sieve_4+'&sieve_5='+sieve_5+'&sieve_6='+sieve_6+'&sieve_7='+sieve_7+'&cum_wt_gm_1='+cum_wt_gm_1+'&cum_wt_gm_2='+cum_wt_gm_2+'&cum_wt_gm_3='+cum_wt_gm_3+'&cum_wt_gm_4='+cum_wt_gm_4+'&cum_wt_gm_5='+cum_wt_gm_5+'&cum_wt_gm_6='+cum_wt_gm_6+'&cum_wt_gm_7='+cum_wt_gm_7+'&ret_wt_gm_1='+ret_wt_gm_1+'&ret_wt_gm_2='+ret_wt_gm_2+'&ret_wt_gm_3='+ret_wt_gm_3+'&ret_wt_gm_4='+ret_wt_gm_4+'&ret_wt_gm_5='+ret_wt_gm_5+'&ret_wt_gm_6='+ret_wt_gm_6+'&ret_wt_gm_7='+ret_wt_gm_7+'&cum_ret_1='+cum_ret_1+'&cum_ret_2='+cum_ret_2+'&cum_ret_3='+cum_ret_3+'&cum_ret_4='+cum_ret_4+'&cum_ret_5='+cum_ret_5+'&cum_ret_6='+cum_ret_6+'&cum_ret_7='+cum_ret_7+'&pass_sample_1='+pass_sample_1+'&pass_sample_2='+pass_sample_2+'&pass_sample_3='+pass_sample_3+'&pass_sample_4='+pass_sample_4+'&pass_sample_5='+pass_sample_5+'&pass_sample_6='+pass_sample_6+'&pass_sample_7='+pass_sample_7+'&blank_extra='+blank_extra+'&sample_taken='+sample_taken+'&ulr='+ulr+'&chk_dtm='+chk_dtm+'&dele_1_1='+dele_1_1+'&dele_1_2='+dele_1_2+'&dele_1_3='+dele_1_3+'&dele_1_4='+dele_1_4+'&dele_2_1='+dele_2_1+'&dele_2_2='+dele_2_2+'&dele_2_3='+dele_2_3+'&dele_2_4='+dele_2_4+'&dele_3_1='+dele_3_1+'&dele_3_2='+dele_3_2+'&dele_3_3='+dele_3_3+'&sp_bask_water='+sp_bask_water+'&sp_wt_bas1='+sp_wt_bas1+'&sp_wt_bas2='+sp_wt_bas2+'&sp_apr1='+sp_apr1+'&sp_apr2='+sp_apr2+'&sp_avg_apr='+sp_avg_apr+'&den_mo_vol1='+den_mo_vol1+'&den_mo_vol2='+den_mo_vol2+'&den_liter='+den_liter+'&den_kg_lit='+den_kg_lit+'&den_voids='+den_voids+'&pass_range_1='+pass_range_1+'&pass_range_2='+pass_range_2+'&pass_range_3='+pass_range_3+'&pass_range_4='+pass_range_4+'&pass_range_5='+pass_range_5+'&pass_range_6='+pass_range_6+'&pass_range_7='+pass_range_7+'&imp_w_m_a_3='+imp_w_m_a_3+'&imp_w_m_b_3='+imp_w_m_b_3+'&imp_w_m_c_3='+imp_w_m_c_3+'&imp_value_3='+imp_value_3+'&grd_s_d='+grd_s_d+'&grd_e_d='+grd_e_d+'&flk_s_d='+flk_s_d+'&flk_e_d='+flk_e_d+'&wtr_s_d='+wtr_s_d+'&wtr_e_d='+wtr_e_d+'&abr_s_d='+abr_s_d+'&abr_e_d='+abr_e_d+'&cru_s_d='+cru_s_d+'&cru_e_d='+cru_e_d+'&sou_s_d='+sou_s_d+'&sou_e_d='+sou_e_d+'&den_s_d='+den_s_d+'&den_e_d='+den_e_d+'&fin_s_d='+fin_s_d+'&fin_e_d='+fin_e_d+'&alk_s_d='+alk_s_d+'&alk_e_d='+alk_e_d+'&lll_s_d='+lll_s_d+'&lll_e_d='+lll_e_d+'&imp_s_d='+imp_s_d+'&imp_e_d='+imp_e_d+'&dtm_s_d='+dtm_s_d+'&dtm_e_d='+dtm_e_d+'&amend_date='+amend_date;
    }
	else{
				var report_no = $('#report_no').val(); 
				var job_no = $('#job_no').val(); 
