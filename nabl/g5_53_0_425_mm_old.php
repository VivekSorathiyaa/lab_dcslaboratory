        ...
        <div class="panel-body"><div class="row">									
								...
								<div class="row">
										...
										<div class="col-lg-2">
											<div class="form-group">
												<div class="col-sm-12">
													<label for="inputEmail3" class="col-sm-2 control-label">0.85</label>
												</div>
											</div>
										</div>
										<div class="col-lg-2">
	...
	<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_gsb5_53_0_425__mm.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&ulr=<?php echo $_GET['ulr'];?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
 
											</div>
											
											<?php// } ?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&ulr=<?php echo $_GET['ulr'];?>&&tbl_name=gsb_mix_5_m5" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
...
$(document).ready(function(){ 
	...
	function mdd_auto()
	{
		var mdd = randomNumberFromRange(2.24,2.29).toFixed(2);
			$('#mdd').val(mdd);
	...
	function omc_auto()
	{
		var omc = randomNumberFromRange(5.70,5.85).toFixed(2);
			$('#omc').val(omc);
	...
	function cbr_auto()
	{
		var cbr = randomNumberFromRange(32.0,35.0).toFixed(1);
			$('#cbr').val(cbr);
	...
	function grd_auto()
	{
		$('#txtgrd').css("background-color","var(--success)");	
					...
					var pass_sample_3 = randomNumberFromRange(60.00,89.00).toFixed(2);
					...
					var pass_sample_6 = randomNumberFromRange(11.00,18.00).toFixed(2);
