				...
				<td  style="text-align:center;font-size:20px; ">
					...
					<table align="center" width="100%"  cellspacing="0" cellpadding="0" style="font-size:20px;font-family : Calibri;">
						...
						<tr style=""> 
							...
							<td  style="width:100%;padding-bottom:10px;padding-top:10px; text-align:center;font-weight:bold; " colspan="3"><span style=""> OBSERVATION AND CALCULATION SHEET FOR TEST ON BITUMINOUS CONCRETE</td>
						</tr>
						<?php 
		...
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;">
				...
				<tr>
					...
					<table width="100%" class="test1" style="border: 0;font-family : Calibri;margin-bottom: 0;" height="Auto">
						<tr>
							<td style="padding:7px 0;font-size: 13px;"><b></b></td>
						</tr>
						<tr>
							<td style="text-align:center;padding: 1px;border-left: 1px solid;border-right: 1px solid;border-top: 1px solid;font-weight:bold;" colspan="2">&nbsp; Density (CDM) Test Observation Sheet (ASTM D-2726-21)</td>
						</tr>
					</table>
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family : Calibri;" height="Auto">
						<tr>
							...
							<td style="border: 1px solid black;padding: 4px 3px;"><center><b>location / Chainage</b></center></td>
						...
						<tr>
                            ...
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['den_1']; ?></center></td>
						</tr>
						<tr>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
                            ...
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['den_2']; ?></center></td>
						</tr>
                        <tr>
							<td style="border: 1px solid black;padding: 2px 3px;"><center><b><?php echo $cnt++; ?></b></center></td>
                            ...
                            <td style="border: 1px solid black;padding: 2px 3px;"><center><?php echo $row_select_pipe['den_3']; ?></center></td>
						</tr>
						<tr>
							<td style="border: 1px solid black;padding: 5px 5px;text-align:right;" colspan=6><b>Average</b></td>
							<td style="border: 1px solid blackpadding: 2px 3px;"><center><?php $avg = ($row_select_pipe['den_1'] + $row_select_pipe['den_2'] + $row_select_pipe['den_3'])/3; echo number_format($avg,2) ?></center></td>			
						</tr>
					</table>
					</td>
				</tr>																					
        ...
        <!-- <table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-left:35px;border:1px solid;">
            ...
            <tr>
                <td style="text-align:center;font-size:15px; ">
                    ...
                    <table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:15px;font-family : Calibri;border-bottom:1px solid;border-top:1px solid;">
            ...
            <tr>
                <td style="text-align:center;font-size:13px; ">
                    ...
                    <table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:13px;font-family : Calibri;border-bottom:1px solid;border-top:1px solid;">
             ...
             <tr>
                <td style="text-align:center;font-size:14px; ">
                    ...
                    <table align="center" width="80%" cellspacing="0" cellpadding="0" style="font-size:14px;font-family : Calibri;">
