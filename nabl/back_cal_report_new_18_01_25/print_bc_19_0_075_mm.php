				...
				<page size="A4" layout="landscape">
					...
					?>
						<table align="center" width="90%" class="test" border="1px" height="30%">
							...
							<tr>
								<td colspan="4">
									<center><?php echo $row_select_pipe['sieve_10']; ?></center>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['cum_wt_gm_10']; ?></center>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['ret_wt_gm_10']; ?></center>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['cum_ret_10']; ?>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['pass_sample_10']; ?>
								</td>
							</tr>
							<tr>
								<td colspan="4">
									<center><?php echo $row_select_pipe['sieve_11']; ?></center>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['cum_wt_gm_11']; ?></center>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['ret_wt_gm_11']; ?></center>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['cum_ret_11']; ?>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['pass_sample_11']; ?>
								</td>
							</tr>
							<tr>
								<td colspan="4">
									<center><?php echo $row_select_pipe['sieve_12']; ?></center>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['cum_wt_gm_12']; ?></center>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['ret_wt_gm_12']; ?></center>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['cum_ret_12']; ?>
								</td>
								<td colspan="2">
									<center><?php echo $row_select_pipe['pass_sample_12']; ?>
								</td>
							</tr>
							<tr>
								<td colspan="4">
