...
<body>
	...
	<?php if ($row_select_pipe['l1'] != "" && $row_select_pipe['l1'] != "0" && $row_select_pipe['l1'] != null) { ?>
		...
		<br><br>
		<?php  } if ($row_select_pipe['h1'] != "" && $row_select_pipe['h1'] != "0" && $row_select_pipe['h1'] != null) { ?>
		<!-- heavy Compaction -->
		...
		<?php } if ($row_select_pipe['corre67'] != "" && $row_select_pipe['corre67'] != "0" && $row_select_pipe['corre67'] != null) { ?>
		<table align="center" width="100%" cellpadding="0" style="font-size:11px;height:auto;font-family : Calibri;border: 1px solid;padding: 0;border-collapse: collapse;">
			<!-- header design -->
			<tr>
				<td  style="text-align:center;font-size:16px; ">
		...
		<div class="pagebreak"></div><br><br>
		<?php } if ($row_select_pipe['fdry1'] != "" && $row_select_pipe['fdry1'] != "0" && $row_select_pipe['fdry1'] != null) { ?>
		<table align="center" width="100%" cellpadding="0" style="font-size:11px;height:auto;font-family : Calibri;border: 1px solid;padding: 0;border-collapse: collapse;">
			<!-- header design -->
			<tr>
				<td  style="text-align:center;font-size:16px; ">
		...
		<?php } if ($row_select_pipe['avg_shr1'] != "" && $row_select_pipe['avg_shr1'] != "0" && $row_select_pipe['avg_shr1'] != null) { ?>
		<table align="center" width="100%" cellpadding="0" style="font-size:11px;height:auto;font-family : Calibri;border: 1px solid;padding: 0;border-collapse: collapse;">
			<!-- header design -->
			<tr>
				<td  style="text-align:center;font-size:16px; ">
		...
		<?php } if ($row_select_pipe['sol1'] != "" && $row_select_pipe['sol1'] != "0" && $row_select_pipe['sol1'] != null) { ?>
		<table align="center" width="100%" cellpadding="0" style="font-size:11px;height:auto;font-family : Calibri;border: 1px solid;padding: 0;border-collapse: collapse;">
			<!-- header design -->
			<tr>
				<td  style="text-align:center;font-size:16px; ">
		...
		<div class="pagebreak"></div>
		<br><br>
		<?php } if ($row_select_pipe['tri1'] != "" && $row_select_pipe['tri1'] != "0" && $row_select_pipe['tri1'] != null) { ?>
		...
		<div class="pagebreak"></div>
		<br>
		<?php } if ($row_select_pipe['shear1'] != "" && $row_select_pipe['shear1'] != "0" && $row_select_pipe['shear1'] != null) { ?>
		...
		<div class="pagebreak"></div>
		<br>
		<?php } if ($row_select_pipe['loadpt3'] != "" && $row_select_pipe['loadpt3'] != "0" && $row_select_pipe['loadpt3'] != null) { ?>
		<table align="center" width="100%" cellpadding="0" style="font-size:11px;height:auto;font-family : Calibri;border: 1px solid;padding: 0;border-collapse: collapse;">
			<!-- header design -->
			 <tr>
				<td  style="text-align:center;font-size:16px; ">
