				...
				<tr>
					<td>
						<table align="center" width="100%"  style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse; ">
							<tr>
								<td style="font-size: 15px;font-weight: bold;text-align: center;padding: 5px;border: 1px solid;">Ballast All Test</td>
							</tr>
							<tr>
					...
					<td>
						<table align="center" width="100%"  style="font-size:11px;height:auto;font-family : Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
							<tr>
								...
								<td style="font-weight: bold;padding: 10px 5px 5px;width:30%;">FMT-OBS-006</td>
							...
							<tr>
								...
								<td style="font-weight: bold;text-align: left;padding: 5px 5px;border: 0;"> Identification Mark :-</td>
								<td style="font-weight: bold;padding: 5px 5px;"><?php echo $row_select_pipe['brick_source']; ?></td>
							</tr>
							<tr>
