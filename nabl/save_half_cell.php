...
if (isset($_POST['action_type']) && !empty($_POST['action_type'])) {
	if ($_POST['action_type'] == 'data') {
		$get_query = "select * from half_cell WHERE id='$_POST[id]' AND `is_deleted`='0'";
		...
		$insert = "insert into half_cell (`report_no`, `ulr`, `job_no`, `lab_no`, `status`, `created_by`, `created_date`, `modified_by`, `modified_date`, `is_deleted`, `deleted_by`, `checked_by`,`loc_1`,`loc_2`,`loc_3`,`loc_4`,`loc_5`,`loc_6`,`loc_7`,`loc_8`,`val_1`,`val_2`,`val_3`,`val_4`,`val_5`,`val_6`,`val_7`,`val_8`,`corr_1`,`corr_2`,`corr_3`,`corr_4`,`corr_5`,`corr_6`,`corr_7`,`corr_8`,`con_1`,`con_2`,`con_3`,`con_4`,`con_5`,`con_6`,`con_7`,`con_8`,`volt_1`,`volt_2`,`volt_3`,`volt_4`,`volt_5`,`volt_6`,`volt_7`,`volt_8`,`rem_1`,`rem_2`,`rem_3`,`rem_4`,`rem_5`,`rem_6`,`rem_7`,`rem_8`,`temp`,`amend_date`) values('$report_no','$ulr','$job_no','$lab_no','0','$_SESSION[name]','$curr_date','','0000-00-00','0','','', '$loc_1', '$loc_2', '$loc_3', '$loc_4', '$loc_5', '$loc_6', '$loc_7', '$loc_8', '$val_1', '$val_2', '$val_3', '$val_4', '$val_5', '$val_6', '$val_7', '$val_8', '$corr_1', '$corr_2', '$corr_3', '$corr_4', '$corr_5', '$corr_6', '$corr_7', '$corr_8', '$con_1', '$con_2', '$con_3', '$con_4', '$con_5', '$con_6', '$con_7', '$con_8', '$volt_1', '$volt_2', '$volt_3', '$volt_4', '$volt_5', '$volt_6', '$volt_7', '$volt_8', '$rem_1', '$rem_2', '$rem_3', '$rem_4', '$rem_5', '$rem_6', '$rem_7', '$rem_8', '$temp', '$amend_date')";
			...
			<div class="row">
				<div class="col-lg-12">
					<table border="1px solid black" align="center" width="100%" id="aaaa">
						...
						<?php
						$query = "select * from half_cell WHERE lab_no='$lab_no' and `is_deleted`='0'";
...
<?php
		...
		$update = "update half_cell SET 
		 `job_no`='$_POST[job_no]',`lab_no`='$_POST[lab_no]',`ulr`='$_POST[ulr]',`report_no`='$_POST[report_no]',`loc_1`='$_POST[loc_1]',`loc_2`='$_POST[loc_2]',`loc_3`='$_POST[loc_3]',`loc_4`='$_POST[loc_4]',`loc_5`='$_POST[loc_5]',`loc_6`='$_POST[loc_6]',`loc_7`='$_POST[loc_7]',`loc_8`='$_POST[loc_8]',`val_1`='$_POST[val_1]',`val_2`='$_POST[val_2]',`val_3`='$_POST[val_3]',`val_4`='$_POST[val_4]',`val_5`='$_POST[val_5]',`val_6`='$_POST[val_6]',`val_7`='$_POST[val_7]',`val_8`='$_POST[val_8]',`corr_1`='$_POST[corr_1]',`corr_2`='$_POST[corr_2]',`corr_3`='$_POST[corr_3]',`corr_4`='$_POST[corr_4]',`corr_5`='$_POST[corr_5]',`corr_6`='$_POST[corr_6]',`corr_7`='$_POST[corr_7]',`corr_8`='$_POST[corr_8]',`volt_1`='$_POST[volt_1]',`volt_2`='$_POST[volt_2]',`volt_3`='$_POST[volt_3]',`volt_4`='$_POST[volt_4]',`volt_5`='$_POST[volt_5]',`volt_6`='$_POST[volt_6]',`volt_7`='$_POST[volt_7]',`volt_8`='$_POST[volt_8]',`con_1`='$_POST[con_1]',`con_2`='$_POST[con_2]',`con_3`='$_POST[con_3]',`con_4`='$_POST[con_4]',`con_5`='$_POST[con_5]',`con_6`='$_POST[con_6]',`con_7`='$_POST[con_7]',`con_8`='$_POST[con_8]',`rem_1`='$_POST[rem_1]',`rem_2`='$_POST[rem_2]',`rem_3`='$_POST[rem_3]',`rem_4`='$_POST[rem_4]',`rem_5`='$_POST[rem_5]',`rem_6`='$_POST[rem_6]',`rem_7`='$_POST[rem_7]',`rem_8`='$_POST[rem_8]',`temp`='$_POST[temp]',`amend_date`='$_POST[amend_date]',`checked_by`=NULL WHERE `id`='$_POST[idEdit]'";
		...
		$delete = "update half_cell SET `is_deleted`='1',`deleted_by`='$_SESSION[name]' WHERE `report_no`='$_POST[report_no]' and `lab_no`='$_POST[lab_no]' and `job_no`='$_POST[job_no]'";
		...
		$qry = "SELECT * FROM half_cell WHERE `id`='$_POST[id]'";
		$arr = mysqli_query($conn, $qry);
		$rows1 = mysqli_num_rows($arr);
		while ($r2 = mysqli_fetch_array($arr)) {
			if ($r2['checked_by'] != "") {
				$c1c = "update half_cell SET `checked_by`='' WHERE `id`='$_POST[id]'";
				$result_of_delete1 = mysqli_query($conn, $c1c);
			} else {
				$cc = "update half_cell SET `checked_by`='$_SESSION[name]' WHERE `id`='$_POST[id]'";
