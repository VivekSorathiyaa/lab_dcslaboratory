    ...
    if($_POST['action_type'] == 'data'){
        ...
        if(!empty($mts)){
            ...
            foreach($mts as $mt): $count++;
                ...
                echo '<td>'.$status.'</td>';
                echo '<td><a href="javascript:void(0);" class="glyphicon glyphicon-edit" onclick="editmt(\''.$mt['id'].'\')"></a><a href="javascript:void(0);" class="glyphicon glyphicon-trash" onclick="return confirm(\'Are you sure to delete data?\')?catAction(\'delete\',\''.$mt['id'].'\'):false;"></a></td>';
                echo '</tr>';
				}		
			endforeach;
