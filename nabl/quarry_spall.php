			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;" for="chk_auto">Quarry Spall</h2>
					</div>
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM quarry_spall WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_quarry_spall.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>

												<?php// } ?>
												<div class="col-sm-2">
													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=quarry_spall" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from quarry_spall WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		function mdd_auto() {
			var mdd = randomNumberFromRange(2.11, 2.15).toFixed(2);
			$('#mdd').val(mdd);
		...
		function omc_auto() {
			var omc = randomNumberFromRange(5.60, 6.50).toFixed(2);
			$('#omc').val(omc);
		...
		function cbr_auto() {
			var cbr = randomNumberFromRange(20.0, 25.0).toFixed(1);
			$('#cbr').val(cbr);
		...
		function imp_auto() {
			...
			var imp_value4 = randomNumberFromRange(17.00, 25.00);
		...
		function lll_auto() {
			...
			var avg_ll = randomNumberFromRange(24.00, 25.00).toFixed(2);
			$('#avg_ll').val(avg_ll);
		...
		function grd_auto() {
			...
			var pass_sample_2 = randomNumberFromRange(95.00, 98.00).toFixed(2);
			var pass_sample_3 = randomNumberFromRange(71.00, 81.00).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(49.00, 59.00).toFixed(2);
			var pass_sample_5 = randomNumberFromRange(39.00, 44.00).toFixed(2);
			var pass_sample_6 = randomNumberFromRange(24.00, 31.00).toFixed(2);
			var pass_sample_7 = randomNumberFromRange(12.00, 18.00).toFixed(2);
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_quarry_spall.php',
