    ...
    <section class="content" style="padding: 0px;margin-right: auto;margin-left: auto; padding-left: 0px; padding-right: 0px; ">
        ...
        <div class="row m-0">
            ...
            <div class="row m-0">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;<a href="sent_mail_list.php" class="btn btn-success btn-lg" title="Completed"><span class="glyphicon glyphicon-question-ok"></span> Completed Email</a>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" class="btn btn-danger btn-lg marking" title="Merge"><span class="glyphicon glyphicon-question-ok"></span> Mark As A Send</a>
            </div>
            <div class="row m-0" style="margin-top:30px;">
                <div class="col-xs-12 scanned-list-box">
                                ...
                                <table id="example2" class="table table-bordered table-striped" style="width:100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align:center;width:1%;">Agency Email (a@b.c;x@y.z)</th>
                                    ...
                                    <tbody>
                                        <?php
                                        $count = 1;
                                        $sel_scaned = "select * from scanned_trf_document where `is_deleted`=0 AND `mail_status`='0'";
...
<script>
    ...
    $(document).on("click", ".merging_perfoma", function() {
        ...
        $.confirm({
            title: "Confirmation",
            content: "Are You Sure To Send Mail ?",
            buttons: {
                confirm: function() {
                    $.ajax({
                        type: 'POST',
    ...
    $(document).on("click", ".marking", function() {
        ...
        $.confirm({
            title: "Confirmation",
            content: "Are You Sure To Mark As Sent  ?",
            buttons: {
                confirm: function() {
                    $.ajax({
                        type: 'POST',
                        url: '<?php $base_url; ?>save_scanners.php',
                        data: 'action_type=marking&chk_array=' + chk_array,
                        beforeSend: function() {
                            document.getElementById("overlay_div").style.display = "block";
                        },
                        success: function(html) {
