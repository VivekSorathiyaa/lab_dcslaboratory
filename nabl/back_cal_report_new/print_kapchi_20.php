			...
			<tr>
				<td style="text-align:center;font-size:16px;">
					...
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family: Cambria;" height="Auto">
						...
						<td colspan="3" style="border: 1px solid black;padding: 5px;"><center><?php if ($row_select_pipe['avg_wom'] != "" && $row_select_pipe['avg_wom'] != "0" && $row_select_pipe['avg_wom'] != null) {		echo $row_select_pipe['avg_wom'];		} else {		echo "&nbsp;";		} ?></center></td>
				...
				<td style="text-align:center;font-size:16px;">
					...
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family: Cambria;" height="Auto">
						...
						<tr>
							...
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['imp_w_m_b_2'] != "" && $row_select_pipe['imp_w_m_b_2'] != "0" && $row_select_pipe['imp_w_m_b_2'] != null) {echo $row_select_pipe['imp_w_m_b_2'];} else {echo " <br>";} ?></center></td>	
						...
						<tr>
							...
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['imp_value_2'] != "" && $row_select_pipe['imp_value_2'] != "0" && $row_select_pipe['imp_value_2'] != null) {				echo $row_select_pipe['imp_value_2'];} else {echo " <br>";} ?></center></td>	
						</tr>
						<tr>
				...
				<td style="text-align:center;font-size:16px;">
					...
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family: Cambria;" height="Auto">
						<tr>
							...
							<td style="border: 1px solid black;width:15%;"><center><?php if ($row_select_pipe['abr_wt_t_a_1'] != "" && $row_select_pipe['abr_wt_t_a_1'] != "0" && $row_select_pipe['abr_wt_t_a_1'] != null) {echo $row_select_pipe['abr_wt_t_a_1'];} else {echo " <br>";} ?></center></td>
							<td style="border: 1px solid black;width:15%;"><center><?php if ($row_select_pipe['abr_wt_t_a_2'] != "" && $row_select_pipe['abr_wt_t_a_2'] != "0" && $row_select_pipe['abr_wt_t_a_2'] != null) {echo $row_select_pipe['abr_wt_t_a_2'];} else {echo " <br>";} ?></center></td>	
							
						</tr>
						<tr>
							<td style="border: 1px solid black;padding: 5px;">&nbsp;&nbsp; B</td>
							<td style="border: 1px solid black;padding: 5px;">&nbsp;&nbsp; Weight of material retained on IS sieve in g   =  B </td>
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['abr_wt_t_b_1'] != "" && $row_select_pipe['abr_wt_t_b_1'] != "0" && $row_select_pipe['abr_wt_t_b_1'] != null) {echo $row_select_pipe['abr_wt_t_b_1'];} else {echo " <br>";} ?></center></td>
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['abr_wt_t_b_2'] != "" && $row_select_pipe['abr_wt_t_b_2'] != "0" && $row_select_pipe['abr_wt_t_b_2'] != null) {echo $row_select_pipe['abr_wt_t_b_2'];} else {echo " <br>";} ?></center></td>
						...
						<tr>
						    ...
						    <td style="border: 1px solid black;"><center><?php if ($row_select_pipe['abr_wt_t_c_1'] != "" && $row_select_pipe['abr_wt_t_c_1'] != "0" && $row_select_pipe['abr_wt_t_c_1'] != null) {echo $row_select_pipe['abr_wt_t_c_1'];} else {echo " <br>";} ?></center></td>
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['abr_wt_t_c_2'] != "" && $row_select_pipe['abr_wt_t_c_2'] != "0" && $row_select_pipe['abr_wt_t_c_2'] != null) {echo $row_select_pipe['abr_wt_t_c_2'];} else {echo " <br>";} ?></center></td>	
						</tr>
						<tr>
							<td style="border: 1px solid black;padding: 5px;">&nbsp;&nbsp; D</td>
							...
							<td style="border: 1px solid black;"><center><?php if ($row_select_pipe['abr_2'] != "" && $row_select_pipe['abr_2'] != "0" && $row_select_pipe['abr_2'] != null) {echo $row_select_pipe['abr_2'];} else {echo " <br>";} ?></center></td>	
						</tr>
						<tr>
		...
		<br><br>
			...
			<table align="center" width="90%" Height="90px;" class="test1" style="border: 1px solid black;">
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_1'] != "" && $row_select_pipe['dele_1_1'] != "0" && $row_select_pipe['dele_1_1'] != null) {echo $row_select_pipe['dele_1_1'];} else {echo " <br>";} ?></b></td>
				</tr>
				<tr>
					<td style="border: 1px solid black;">&nbsp; After washing through water, then oven dry weight</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_2'] != "" && $row_select_pipe['dele_1_2'] != "0" && $row_select_pipe['dele_1_2'] != null) {echo $row_select_pipe['dele_1_2'];} else {echo " <br>";} ?></b></td>
				</tr>
				<tr>
					<td style="border: 1px solid black;">&nbsp; Weight of Sample, gm (C)</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_3'] != "" && $row_select_pipe['dele_1_3'] != "0" && $row_select_pipe['dele_1_3'] != null) {echo $row_select_pipe['dele_1_3'];} else {echo " <br>";} ?></b></td>
				</tr>
				<tr>
					<td style="border: 1px solid black;">&nbsp; % finer than 75u (A) = (B-C)/B * 100</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_4'] != "" && $row_select_pipe['dele_1_4'] != "0" && $row_select_pipe['dele_1_4'] != null) {echo $row_select_pipe['dele_1_4'];} else {echo " <br>";} ?></b></td>
				</tr>
			</table>
			...
			<table align="center" width="90%" Height="90px;" class="test1" style="border: 1px solid black;">
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_1'] != "" && $row_select_pipe['dele_2_1'] != "0" && $row_select_pipe['dele_2_1'] != null) {echo $row_select_pipe['dele_2_1'];} else {echo " <br>";} ?></b></td>
				</tr>
				<tr>
					<td style="border: 1px solid black;">&nbsp; After broken with fingre then paassing 2.36mm IS Sieve gm (R)</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_2_2'] != "" && $row_select_pipe['dele_2_2'] != "0" && $row_select_pipe['dele_2_2'] != null) {echo $row_select_pipe['dele_2_2'];} else {echo " <br>";} ?></b></td>
				</tr>
				<tr>
					<td style="border: 1px solid black;">&nbsp; % Clay Lumps = (W-R)/B * 100</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_2_3'] != "" && $row_select_pipe['dele_2_3'] != "0" && $row_select_pipe['dele_2_3'] != null) {echo $row_select_pipe['dele_2_3'];} else {echo " <br>";} ?></b></td>
				</tr>
			</table>
			...
			<table align="center" width="90%" Height="90px;" class="test1" style="border: 1px solid black;">
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_1'] != "" && $row_select_pipe['dele_3_1'] != "0" && $row_select_pipe['dele_3_1'] != null) {echo $row_select_pipe['dele_3_1'];} else {echo " <br>";} ?></b></td>
				</tr>
				<tr>
					<td style="border: 1px solid black;">&nbsp; Introduce in to heavy liquid then wt gm (W2)</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_3_2'] != "" && $row_select_pipe['dele_3_2'] != "0" && $row_select_pipe['dele_3_2'] != null) {echo $row_select_pipe['dele_3_2'];} else {echo " <br>";} ?></b></td>
				</tr>
				<tr>
					<td style="border: 1px solid black;">&nbsp; % Coal & Ligntie = (W1 - W2)/W1 * 100</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_3_3'] != "") {echo $row_select_pipe['dele_3_3'];} else {echo " <br>";} ?></b></td>
				</tr>
			</table>
			...
			<table align="center" width="90%" Height="90px;" class="test1" style="border: 1px solid black;">
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_1_1'] != "" && $row_select_pipe['dele_4_1'] != "0" && $row_select_pipe['dele_4_1'] != null) {echo $row_select_pipe['dele_4_1'];} else {echo " <br>";} ?></b></td>
				</tr>
				<tr>
					<td style="border: 1px solid black;">&nbsp; Weight of Soft Particle broken from surface after brass rod rubbing, gms (B)</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_4_2'] != "" && $row_select_pipe['dele_4_2'] != "0" && $row_select_pipe['dele_4_2'] != null) {echo $row_select_pipe['dele_4_2'];} else {echo " <br>";} ?></b></td>
				</tr>
				<tr>
					<td style="border: 1px solid black;">&nbsp; % Soft Particle :- B/A * 100</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['dele_4_3'] != "" && $row_select_pipe['dele_4_3'] != "0" && $row_select_pipe['dele_4_3'] != null) {echo $row_select_pipe['dele_4_3'];} else {echo " <br>";} ?></b></td>
				</tr>
			</table>
		...
		<p style="margin-left:30px;font-weight:bold;"><b><?php echo $count++;?>. ORGANIC IMPURITIES (IS 2686 - 2) - 1963</b></p>
			<table align="center" width="90%" Height="100px;" class="test1" style="border: 1px solid black;">
				<tr>
					...
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['aoi_1'] != "" && $row_select_pipe['aoi_1'] != "0" && $row_select_pipe['aoi_1'] != null) {echo $row_select_pipe['aoi_1'];} else {echo " <br>";} ?></b></td>
				</tr>
				<tr>
					<td style="border: 1px solid black;">&nbsp; Fill Sand upto mark</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['aoi_2'] != "" && $row_select_pipe['aoi_2'] != "0" && $row_select_pipe['aoi_2'] != null) {echo $row_select_pipe['aoi_2'];} else {echo " <br>";} ?></b></td>
				</tr>
				<tr>
					<td style="border: 1px solid black;">&nbsp; Further fill solution upto mark</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['aoi_3'] != "" && $row_select_pipe['aoi_3'] != "0" && $row_select_pipe['aoi_3'] != null) {echo $row_select_pipe['aoi_3'];} else {echo " <br>";} ?></b></td>
				</tr>
				<tr>
					<td style="border: 1px solid black;">&nbsp; Observation</b></td>
					<td style="border: 1px solid black;">&nbsp; <?php if ($row_select_pipe['aoi_4'] != "" && $row_select_pipe['aoi_4'] != "0" && $row_select_pipe['aoi_4'] != null) {echo $row_select_pipe['aoi_4'];} else {echo " <br>";} ?></b></td>
				</tr>
			</table>
