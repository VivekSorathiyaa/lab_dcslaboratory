...
<html>
	...
	<page size="A4" >
		<table align="center" width="90%" class="test"  style="border: 1px solid black;" cellpadding="5px">
			...
			<tr>
				<td style="font-size:14px;border: 1px solid black;"><center><b>Worksheet for Compressive Strength of Hollow and Solid Concrete Blocks (IS 2185 Part I)</b></center></td>					
				<td colspan="2" style="font-size:14px;border: 1px solid black;"><center><b>F-HSB-01, Issue No.01, Page No 1 of 1</b></center></td>					
			</tr>
			<tr>
				<td  style="border: 1px solid black; width:60%"><b>Laboratory Ref No: <?php echo $job_no;?></b></td>					
				<td style="border: 1px solid black;"><b>Sample Receive Date: <?php echo date('d/m/Y', strtotime($rec_sample_date));?></b></td>					
			</tr>
			<tr>
				<td rowspan="2" style="border: 1px solid black; width:20%; padding-top:0;"><b>Any Other Information:</b></td>
				<td style="border: 1px solid black;"><b>Start Date:  <?php echo date('d/m/Y', strtotime($start_date));?></b></td>
			</tr>
			<tr>
				<td style="border: 1px solid black;"><b>Competion Date:  <?php echo date('d/m/Y', strtotime($end_date));?></b></td>	
			</tr>
		</table>
		<table align="center" width="90%" class="test"  style="border: 1px solid black;" cellpadding="5px">
			<tr>
		...
		<table align="center" width="90%" class="test"  style="border: 1px solid black;" cellpadding="5px">
			...
			<tr>
				<td style="font-size:14px;border: 1px solid black;"><center><b>Worksheet for Drying Shrinkage and Moiture Movement  of Hollow and Solid Concrete Blocks (IS 2185 Part I)</b></center></td>					
				<td colspan="2" style="font-size:14px;border: 1px solid black;"><center><b>F-HSB-02, Issue No.01, Page No 1 of 1</b></center></td>					
			</tr>
			<tr>
				<td  style="border: 1px solid black; width:60%"><b>Laboratory Ref No: <?php echo $job_no;?></b></td>					
				<td style="border: 1px solid black;"><b>Sample Receive Date: <?php echo date('d/m/Y', strtotime($rec_sample_date));?></b></td>					
		...
		<table align="center" width="90%" class="test"  style="border: 1px solid black;" cellpadding="5px">
			<tr>
				<td rowspan="2" colspan="2" style="border: 1px solid black; text-align:center"><b>SR No</b></td>	
				...
				<td rowspan="2" style="border: 1px solid black; text-align:center"><b>Average of two face</b></td>	
				<td rowspan="2" style="border: 1px solid black; text-align:center"><b>Average Drying Shrinkage %</b></td>	
				<td style="border: 1px solid black; text-align:center"><b>Date</b></td>	
				<td rowspan="2"style="border: 1px solid black; text-align:center"><b>Average of two face</b></td>	
				<td rowspan="2"style="border: 1px solid black; text-align:center"><b>Average Moiture Movement %</b></td>	
			</tr>
			<tr>
			...
			<tr>
				<td rowspan="2" style="border: 1px solid black; text-align:center"><b>Sample 1</b></td>	
				...
				<td rowspan="6" style="border: 1px solid black; text-align:center"><b><?php if($row_select_pipe['avg_dry']!="" && $row_select_pipe['avg_dry']!="0" && $row_select_pipe['avg_dry']!=null){echo $row_select_pipe['avg_dry']; }else{echo " <br>";}?></b></td>	
				...
				<td rowspan="6" style="border: 1px solid black; text-align:center"><b><?php if($row_select_pipe['avg_mo']!="" && $row_select_pipe['avg_mo']!="0" && $row_select_pipe['avg_mo']!=null){echo $row_select_pipe['avg_mo']; }else{echo " <br>";}?></b></td>	
			</tr>
			<tr>
		...
		<table align="center" width="90%" class="test"  style="border: 1px solid black;" cellpadding="5px">
			...
			<tr>
				<td style="font-size:14px;border: 1px solid black;"><center><b>Worksheet for Dimention of Hollow and Solid Concrete Blocks (IS 2185 Part I)</b></center></td>					
				<td colspan="2" style="font-size:14px;border: 1px solid black;"><center><b>F-HSB-03, Issue No.01, Page No 1 of 1</b></center></td>					
			</tr>
			<tr>
				<td  style="border: 1px solid black; width:60%"><b>Laboratory Ref No: <?php echo $job_no;?></b></td>					
				<td style="border: 1px solid black;"><b>Sample Receive Date: <?php echo date('d/m/Y', strtotime($rec_sample_date));?></b></td>					
		...
		<table align="center" width="90%" class="test"  style="border: 1px solid black;" cellpadding="5px">
			...
			<tr>
				<td style="font-size:14px;border: 1px solid black;"><center><b>Worksheet for Water Absorption of Hollow and Solid Concrete Blocks (IS 2185 Part I)</b></center></td>					
				<td colspan="2" style="font-size:14px;border: 1px solid black;"><center><b>F-HSB-04, Issue No.01, Page No 1 of 1</b></center></td>					
			</tr>
			<tr>
				<td  style="border: 1px solid black; width:60%"><b>Laboratory Ref No: <?php echo $job_no;?></b></td>					
				<td style="border: 1px solid black;"><b>Sample Receive Date: <?php echo date('d/m/Y', strtotime($rec_sample_date));?></b></td>					
		...
		<table align="center" width="90%" class="test"  style="border: 1px solid black;" cellpadding="5px">
			...
			<tr>
				<td style="font-size:14px;border: 1px solid black;"><center><b>Worksheet for Dry Density of Hollow and Solid Concrete Blocks (IS 2185 Part I)</b></center></td>					
				<td colspan="2" style="font-size:14px;border: 1px solid black;"><center><b>F-HSB-05, Issue No.01, Page No 1 of 1</b></center></td>					
			</tr>
			<tr>
				<td  style="border: 1px solid black; width:60%"><b>Laboratory Ref No: <?php echo $job_no;?></b></td>					
				<td style="border: 1px solid black;"><b>Sample Receive Date: <?php echo date('d/m/Y', strtotime($rec_sample_date));?></b></td>					
