...
<html>
	<body>
		...
		<page size="A4" >
			...
			<table align="center" width="100%" class="test1" height="9%">
					...
					<tr style="border: 1px solid black;">
						...
						<td style="border-left:1px solid;text-align:left;padding:5px 0px;">&nbsp;<input type="text" style="border:0;"></td>
					</tr>
					<tr style="border: 1px solid black;">
			...
			<tr>
				...
				<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family: Cambria;" height="200px">
					<tr>
						...
						<td style="border: 1px solid black;width:20%;padding: 2px 3px;"><center><b>Drying Shrinkage </center></td>		
					</tr>
					<tr>
					...
					<tr>
						<td colspan=4 style="border: 1px solid black;width:5%;padding: 2px 3px;text-align:right;"><b>Avrage</td>
		...
		<table align="center" width="100%" class="test1" style="" Height="20%">
			...
			<table align="center" width="83%" style="" Height="10%">
				<tr style="font-size:15px;" >
