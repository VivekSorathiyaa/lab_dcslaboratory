...
<body>
	...
	<page size="A4" layout="landscape">
		...
		<table align="center" width="90%" class="test">
			<tr>
				<td colspan="12"><b>Determination of Penetration (IS : 1203)(RA : 2014)</b></td>
		...
		<table align="center" width="90%" class="test">
			<tr>
				<td colspan="12"><b>Determination of Softening Point (IS : 1205) (RA : 2014)</b></td>
		...
		<table align="center" width="90%" class="test">
			<tr>
				<td colspan="12"><b>Determination of Specific gravity (IS 1202) (RA : 2014)</b></td>
			</tr>
			<tr>
		...
		<table align="center" width="90%" class="test">
			<tr>
				<td colspan="12"><b>Determination of Ductility (IS 1208) (RA : 2014)</b></td>
			</tr>
			<tr>
		...
		<table align="center" width="90%" class="test">
			<tr>
				<td colspan="12"><b>Absolute Viscosity (IS : 1206 Part -2)(RA : 2014)</b></td>
			</tr>
		</table>
		<br>
		<table align="center" border="1px" height="13%" width="90%" class="test">
		...
		<table align="center" width="90%" class="test">
			<tr>
				<td colspan="12"><b>Kinematic Viscosity (IS : 1206 Part -3)(RA : 2014)</b></td>
			</tr>
		</table>
		<br>
		<table align="center" border="1px" height="13%" width="90%" class="test">
