		...
		<table align="center" width="94%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				...
				<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR COMPRESSIVE<br>FLY ASH BRICKS</b></center>
				</td>
			</tr>
		</table>
		<br><br>
				...
				<td style="text-align:center;">
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-family: Cambria;">
						...
						<tr style="">
							...
							<td style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;border-right:1px solid;"><?php echo $cnt++; ?> </td>
							<td style="border-top:1px solid;border-right:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"> </td>
							...
							<td style="border-top:1px solid;border-right:1px solid;width:20%;text-align:center; "><?php if ($row_select_pipe['wtr_w2_1'] != "" && $row_select_pipe['wtr_w2_1'] != "0" && $row_select_pipe['wtr_w2_1'] != null) {
						...
						<tr style="">
							...
							<td style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;border-right:1px solid;"><?php echo $cnt++; ?> </td>
							<td style="border-top:1px solid;width:10%;border-right:1px solid; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"> </td>
						...
						<tr style="">
							...
							<td style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;border-right:1px solid;"><?php echo $cnt++; ?> </td>
							<td style="border-top:1px solid;width:10%;border-right:1px solid; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"> </td>
							<td style="border-top:1px solid;border-right:1px solid;width:20%;text-align:center; "><?php if ($row_select_pipe['wtr_w1_3'] != "" && $row_select_pipe['wtr_w1_3'] != "0" && $row_select_pipe['wtr_w1_3'] != null) {
																														echo $row_select_pipe['wtr_w1_3'];
																													} else {
																														echo " <br>";
																													} ?></td>
							<td style="border-top:1px solid;border-right:1px solid;width:20%;text-align:center; "><?php if ($row_select_pipe['wtr_w2_3'] != "" && $row_select_pipe['wtr_w2_3'] != "0" && $row_select_pipe['wtr_w2_3'] != null) {
							...
							<td style="border-top:1px solid;width:30%;text-align:center; "><?php if ($row_select_pipe['wtr_3'] != "" && $row_select_pipe['wtr_3'] != "0" && $row_select_pipe['wtr_3'] != null) {
						...
						<tr style="">
							...
							<td style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;border-right:1px solid;"><?php echo $cnt++; ?> </td>
							<td style="border-top:1px solid;width:10%;border-right:1px solid; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"> </td>
							<td style="border-top:1px solid;border-right:1px solid;width:20%;text-align:center; "><?php if ($row_select_pipe['wtr_w1_4'] != "" && $row_select_pipe['wtr_w1_4'] != "0" && $row_select_pipe['wtr_w1_4'] != null) {
																														echo $row_select_pipe['wtr_w1_4'];
																													} else {
																														echo " <br>";
																													} ?></td>
							<td style="border-top:1px solid;border-right:1px solid;width:20%;text-align:center; "><?php if ($row_select_pipe['wtr_w2_4'] != "" && $row_select_pipe['wtr_w2_4'] != "0" && $row_select_pipe['wtr_w2_4'] != null) {
						...
						<tr style="">
							...
							<td style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;border-right:1px solid;"><?php echo $cnt++; ?> </td>
							<td style="border-top:1px solid;border-right:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"> </td>
							<td style="border-top:1px solid;border-right:1px solid;width:20%;text-align:center; "><?php if ($row_select_pipe['wtr_w1_5'] != "" && $row_select_pipe['wtr_w1_5'] != "0" && $row_select_pipe['wtr_w1_5'] != null) {
																														echo $row_select_pipe['wtr_w1_5'];
																													} else {
																														echo " <br>";
																													} ?></td>
							<td style="border-top:1px solid;border-right:1px solid;width:20%;text-align:center; "><?php if ($row_select_pipe['wtr_w2_5'] != "" && $row_select_pipe['wtr_w2_5'] != "0" && $row_select_pipe['wtr_w2_5'] != null) {
							...
							<td style="border-top:1px solid;width:30%;text-align:center; "><?php if ($row_select_pipe['wtr_5'] != "" && $row_select_pipe['wtr_5'] != "0" && $row_select_pipe['wtr_5'] != null) {
