	...
	<page size="A4" >
	    <table align="center" width="100%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				<td style="font-size:11px;border: 1px solid black;">
					<center><b>FMT-OBS-047</b></center>
				</td>
				<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR TEST ON GGBS </b></center>
				</td>
			</tr>
		</table>
		<br><br>
		...
		<table align="center" width="100%" class="test1" height="9%">
			<tr style="border: 1px solid black;">
				<td colspan="3" style="border-left:1px solid;width:25%;text-align:left;padding:5px 0px;"><b>&nbsp; Details of GGBS Sample  &nbsp; &nbsp; : &nbsp; &nbsp; &nbsp;<?php echo $detail_sample;?></b></td>
			</tr>
			<tr style="border: 1px solid black;">
				...
				<tr>
					...
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family: Arial;" height="Auto">
						...
						<tr>
							...
							<td style="padding: 2px 3px;text-align:right;">Consistency &nbsp; </td>
		...
		<table align="center" width="83%" style="" Height="2%">
				<tr style="font-size:12px;" >
					<td style="text-align:left;">Page 1 of 3</td>
				</tr>		
		</table>
		...
		<table align="center" width="100%" class="test" height="6%" style="border: 1px solid black;margin-bottom:20px;">
			<tr>
				<td rowspan="2" style="height:70px;width:120px;border: 1px solid black;"><img src="../images/mttest.jpg" style="height:95%;width:90%;padding-left:7px;"></td>
				<td colspan="2" style="font-size:13px;border: 1px solid black;">
					<center><b>Laboratory Quality System Format – Manglam Consultancy Services, Vadodara</b></center>
		...
		<?php $cnt = 1; ?>
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Arial; margin-bottom: 20px;">
				<tr>
					<td>
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family: Arial;" height="Auto">
						<tr>
					...
					<table cellspacing="0" cellpadding="0" align="center" width="100%" style="border: 1px solid black;border-top:0;font-family: Arial;font-size:12px;" height="Auto">
					    <tr>
		...
		<?php $cnt = 1; ?>
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Arial; margin-bottom: 25px;">
				<tr>
					<td>
					<table align="center" width="100%" class="test1" style="border: 1px solid black;font-family: Arial;" height="Auto">
					    <tr>
					...
					<table align="center" width="100%" class="test1" style="border-left: 1px solid black;border-right: 1px solid black;font-family: Arial;" height="Auto">
					    <tr>
					...
					<table align="center" width="100%" class="test1" style="border-left: 1px solid black;border-right: 1px solid black;border-bottom: 1px solid black;font-family: Arial;" height="Auto">
						<tr>
		...
		<table align="center" width="83%" style="" Height="2%">
				<tr style="font-size:12px;" >
					<td style="text-align:left;">Page 2 of 3</td>
				</tr>		
		</table>
		...
		<table align="center" width="100%" class="test" height="6%" style="border: 1px solid black;">
			<tr>
				<td rowspan="2" style="height:70px;width:120px;border: 1px solid black;"><img src="../images/mttest.jpg" style="height:95%;width:90%;padding-left:7px;"></td>
				<td colspan="2" style="font-size:13px;border: 1px solid black;">
					<center><b>Laboratory Quality System Format – Manglam Consultancy Services, Vadodara</b></center>
		...
		<table align="center" width="83%" style="" Height="2%">
				<tr style="font-size:12px;" >
					<td style="text-align:left;">Page 3 of 3</td>
				</tr>		
		</table>
	</page>
	...
	<!-- <page size="A4" >
			...
			<table align="center" width="100%"  class="test"  style="border: 1px solid black; margin-top:20px;" >
				<tr>
					...
					<td style="border: 1px solid black; width:10%; text-align:center;"><b>IS 2720 (Part 2) (RA 2015)</b></td>
