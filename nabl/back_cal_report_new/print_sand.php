...
<br>
	<page size="A4">
		...
		<table align="center" width="94%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				...
				<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR COMPRESSIVE<br>STRENGHT TEST ON <?php echo $detail_sample;?></b></center>
				</td>
			</tr>
		</table>
		<br>	
		...
		<table align="center" width="94%" class="test1" style="font-size:15px;" height="4%">
			...
			<tr style="">
				<td style="text-align:center;"><br><br>iii</td>
				<td style=""><b><br><br>Material finer than 75 micron sieve </b></td>
			</tr>
			<tr style="">
				<td style=""></td>
		...
		<table align="center" width="94%" class="test1" style="border: 1px solid black;" height="4%">
			<tr style="border: 0px solid black;">
				...
				<td width="23%" style="text-align:right;border-left: 1px solid black;padding-right:20px;"><b></b></td>
			</tr>
			<tr style="border: 0px solid black;">
