		...
		<page size="A4" >
			...
			<table align="center" width="90%" class="test" style="border: 1px solid black;" cellpadding="10px">
				<tr>
					...
					<td width="30%" style="border: 1px solid black;"><b><?php if($row_select_pipe['acc1']!="" && $row_select_pipe['acc1']!="0" && $row_select_pipe['acc1']!=null){echo $row_select_pipe['acc1']." ".$row_select_pipe['acc1_2']; }else{echo " <br>";}?></b></td>
				</tr>
				<tr>
