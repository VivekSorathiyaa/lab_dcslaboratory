...
<html>
	<body>
		...
		<table align="center" width="94%" class="test" height="8%" style="border: 1px solid black;">
			...
			<tr>
				...
				<td style="font-size:12px;border: 1px solid black;text-transform:uppercase;">
					<center><b>OBSERVATION & CALCULATION SHEET FOR COMPRESSIVE<br>BURNT CLY BRICKS</b></center>
				</td>
			</tr>
		</table>
		<br><br>
		...
		<table align="center" width="94%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Cambria;border:1px solid;">
			<tr>
				<td style="text-align:center;">
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-family: Cambria;font-size: 12px;">
						...
						<tr style="">
							...
							<td style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;border-right:1px solid;"><?php echo $cnt++; ?></td>
							<td style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"></td>
				...
				<td  style="text-align:center;font-size:20px; ">
					...
					<table align="center" width="100%"  cellspacing="0" cellpadding="0" style="font-size:20px;font-family: Cambria;">
						...
						<tr style=""> 
							...
							<td  style="width:100%;padding-bottom:10px;padding-top:10px; text-align:center;font-weight:bold; "><span style=""> OBSERVATION AND CALCULATION SHEET FOR TEST ON BRICK</td>
						</tr>
				...
				<td  style="text-align:center;font-size:14px; ">
					...
					<table align="center" width="100%"  cellspacing="0" cellpadding="0" style="font-size:14px;font-family: Cambria;border-bottom:1px solid;border-top:1px solid;">
						...
						<tr style=""> 
							...
							<td  style="border-top:1px solid;border-left:1px solid;width:50%; ">&nbsp;&nbsp; <?php if($sample_sent_by==1){echo 'Agency';} else if($sample_sent_by==0){echo 'Client';}?></td>
						</tr>
						<tr style=""> 
							...
							<td  style="border-top:1px solid;border-left:1px solid;width:50%; ">&nbsp;&nbsp; <?php if($row_select_pipe['no_of_brick']!="" && $row_select_pipe['no_of_brick']!="0" && $row_select_pipe['no_of_brick']!=null){echo $row_select_pipe['no_of_brick']; }else{echo " <br>";}?> NOS</td>
						</tr>
						<tr style=""> 
						...
						<tr style=""> 
							...
							<td  style="border-top:1px solid;border-left:1px solid;width:50%; ">&nbsp;&nbsp; <?php echo $mt_name;?><?php echo $type_of_material;?>BURNT CLY BRICKS</td>
						</tr>
						<tr style=""> 
		...
		<tr>
				<td  style="text-align:center;font-size:16px; ">
					...
					<table align="center" width="100%"  cellspacing="0" cellpadding="0" style="font-size:16px;font-family: Cambria;border-bottom:1px solid;border-top:1px solid;margin-bottom:20px;margin-top:4px;">
				...
				<td  style="text-align:center;font-size:14px; ">
					...
					<table align="left" width="100%"  cellspacing="0" cellpadding="0" style="font-size:14px;font-family: Cambria;border:1px solid;border-width:1px 0px 1px 0px;margin-bottom:15px;">
						...
						<tr style=""> 
								...
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center;font-weight:bold; "><?php if($row_select_pipe['dim_length']!="" && $row_select_pipe['dim_length']!="0" && $row_select_pipe['dim_length']!=null){echo $row_select_pipe['dim_length']; }else{echo " <br>";}?></td>
						...
						<tr style=""> 
								...
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center;font-weight:bold; "><?php if($row_select_pipe['dim_width']!="" && $row_select_pipe['dim_width']!="0" && $row_select_pipe['dim_width']!=null){echo $row_select_pipe['dim_width']; }else{echo " <br>";}?></td>
						...
						<tr style=""> 
								...
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center;font-weight:bold; "><?php if($row_select_pipe['dim_height']!="" && $row_select_pipe['dim_height']!="0" && $row_select_pipe['dim_height']!=null){echo $row_select_pipe['dim_height']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px; ">1800 ± 40 mm/<br> 800 ± 80 mm</td>
		...
		<tr>
				<td  style="text-align:center;font-size:16px; ">
					...
					<table align="center" width="100%"  cellspacing="0" cellpadding="0" style="font-size:16px;font-family: Cambria;border-bottom:1px solid;border-top:1px solid;margin-bottom:20px;margin-top:5px;">
			
						<tr style=""> 
							
								<td  style="width:10%;border-right:1px solid; text-align:center;font-weight:bold; ">[2]</td>
								<td  style="width:90%; text-align:left;font-weight:bold;padding-bottom:3px;padding-top:3px; ">&nbsp;&nbsp; Compressive Strength [ IS : 3495-1992 PART -1 ]</td>
				...
				<td  style="text-align:center;font-size:14px; ">
					...
					<table align="left" width="100%"  cellspacing="0" cellpadding="0" style="font-size:14px;font-family: Cambria;border:1px solid;margin-bottom:15px;border-width:1px 0px 1px 0px;">
						...
						<tr style=""> 
								...
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "> <?php if($row_select_pipe['com_l_1']!="" && $row_select_pipe['com_l_1']!="0" && $row_select_pipe['com_l_1']!=null){echo $row_select_pipe['com_l_1']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_b_1']!="" && $row_select_pipe['com_b_1']!="0" && $row_select_pipe['com_b_1']!=null){echo $row_select_pipe['com_b_1']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_h_1']!="" && $row_select_pipe['com_h_1']!="0" && $row_select_pipe['com_h_1']!=null){echo $row_select_pipe['com_h_1']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_load_1']!="" && $row_select_pipe['com_load_1']!="0" && $row_select_pipe['com_load_1']!=null){echo $row_select_pipe['com_load_1']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_load_1']!="" && $row_select_pipe['com_load_1']!="0" && $row_select_pipe['com_load_1']!=null){echo ($row_select_pipe['com_load_1'] * 1000); }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['com_area_1']!="" && $row_select_pipe['com_area_1']!="0" && $row_select_pipe['com_area_1']!=null){echo $row_select_pipe['com_area_1']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['com_1']!="" && $row_select_pipe['com_1']!="0" && $row_select_pipe['com_1']!=null){echo $row_select_pipe['com_1']; }else{echo " <br>";}?></td>
						</tr>
						<tr style=""> 
							
								<td  style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"><?php echo $cnt++;?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "> <?php if($row_select_pipe['com_l_2']!="" && $row_select_pipe['com_l_2']!="0" && $row_select_pipe['com_l_2']!=null){echo $row_select_pipe['com_l_2']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_b_2']!="" && $row_select_pipe['com_b_2']!="0" && $row_select_pipe['com_b_2']!=null){echo $row_select_pipe['com_b_2']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_h_2']!="" && $row_select_pipe['com_h_2']!="0" && $row_select_pipe['com_h_2']!=null){echo $row_select_pipe['com_h_2']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_load_2']!="" && $row_select_pipe['com_load_2']!="0" && $row_select_pipe['com_load_2']!=null){echo $row_select_pipe['com_load_2']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_load_2']!="" && $row_select_pipe['com_load_2']!="0" && $row_select_pipe['com_load_2']!=null){echo ($row_select_pipe['com_load_2'] * 1000); }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['com_area_2']!="" && $row_select_pipe['com_area_2']!="0" && $row_select_pipe['com_area_2']!=null){echo $row_select_pipe['com_area_2']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['com_2']!="" && $row_select_pipe['com_2']!="0" && $row_select_pipe['com_2']!=null){echo $row_select_pipe['com_2']; }else{echo " <br>";}?></td>
						</tr>
						<tr style=""> 
							
								<td  style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"><?php echo $cnt++;?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "> <?php if($row_select_pipe['com_l_3']!="" && $row_select_pipe['com_l_3']!="0" && $row_select_pipe['com_l_3']!=null){echo $row_select_pipe['com_l_3']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_b_3']!="" && $row_select_pipe['com_b_3']!="0" && $row_select_pipe['com_b_3']!=null){echo $row_select_pipe['com_b_3']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_h_3']!="" && $row_select_pipe['com_h_3']!="0" && $row_select_pipe['com_h_3']!=null){echo $row_select_pipe['com_h_3']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_load_3']!="" && $row_select_pipe['com_load_3']!="0" && $row_select_pipe['com_load_3']!=null){echo $row_select_pipe['com_load_3']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_load_2']!="" && $row_select_pipe['com_load_2']!="0" && $row_select_pipe['com_load_2']!=null){echo ($row_select_pipe['com_load_2'] * 1000); }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['com_load_3']!="" && $row_select_pipe['com_load_3']!="0" && $row_select_pipe['com_load_3']!=null){echo $row_select_pipe['com_load_3']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['com_3']!="" && $row_select_pipe['com_3']!="0" && $row_select_pipe['com_3']!=null){echo $row_select_pipe['com_3']; }else{echo " <br>";}?></td>
						</tr>
						<tr style=""> 
							
								<td  style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"><?php echo $cnt++;?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "> <?php if($row_select_pipe['com_l_4']!="" && $row_select_pipe['com_l_4']!="0" && $row_select_pipe['com_l_4']!=null){echo $row_select_pipe['com_l_4']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_b_4']!="" && $row_select_pipe['com_b_4']!="0" && $row_select_pipe['com_b_4']!=null){echo $row_select_pipe['com_b_4']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_h_4']!="" && $row_select_pipe['com_h_4']!="0" && $row_select_pipe['com_h_4']!=null){echo $row_select_pipe['com_h_4']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_load_4']!="" && $row_select_pipe['com_load_4']!="0" && $row_select_pipe['com_load_4']!=null){echo $row_select_pipe['com_load_4']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_load_4']!="" && $row_select_pipe['com_load_4']!="0" && $row_select_pipe['com_load_4']!=null){echo ($row_select_pipe['com_load_4'] * 1000); }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['com_area_4']!="" && $row_select_pipe['com_area_4']!="0" && $row_select_pipe['com_area_4']!=null){echo $row_select_pipe['com_area_4']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['com_4']!="" && $row_select_pipe['com_4']!="0" && $row_select_pipe['com_4']!=null){echo $row_select_pipe['com_4']; }else{echo " <br>";}?></td>
						</tr>
						<tr style=""> 
							
								<td  style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"><?php echo $cnt++;?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "> <?php if($row_select_pipe['com_l_5']!="" && $row_select_pipe['']!="0" && $row_select_pipe['com_l_5']!=null){echo $row_select_pipe['com_l_5']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_b_5']!="" && $row_select_pipe['com_b_5']!="0" && $row_select_pipe['com_b_5']!=null){echo $row_select_pipe['com_b_5']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_h_5']!="" && $row_select_pipe['com_h_5']!="0" && $row_select_pipe['com_h_5']!=null){echo $row_select_pipe['com_h_5']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_load_5']!="" && $row_select_pipe['com_load_5']!="0" && $row_select_pipe['com_load_5']!=null){echo $row_select_pipe['com_load_5']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:10%;text-align:center; "><?php if($row_select_pipe['com_load_5']!="" && $row_select_pipe['com_load_5']!="0" && $row_select_pipe['com_load_5']!=null){echo ($row_select_pipe['com_load_5'] * 1000); }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['com_area_5']!="" && $row_select_pipe['com_area_5']!="0" && $row_select_pipe['com_area_5']!=null){echo $row_select_pipe['com_area_5']; }else{echo " <br>";}?></td>
								<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['com_5']!="" && $row_select_pipe['com_5']!="0" && $row_select_pipe['com_5']!=null){echo $row_select_pipe['com_5']; }else{echo " <br>";}?></td>
						</tr>
				...
				<td  style="text-align:center;font-size:16px; ">
					...
					<table align="center" width="100%"  cellspacing="0" cellpadding="0" style="font-size:16px;font-family: Cambria;margin-right:80px;">
						...
						<tr style=""> 
							...
							<td  style="width:30%; text-align:center;font-weight:bold;border:1px solid;padding-bottom:2px;padding-top:2px;"><?php if($row_select_pipe['avg_com']!="" && $row_select_pipe['avg_com']!="0" && $row_select_pipe['avg_com']!=null){echo $row_select_pipe['avg_com']; }else{echo " <br>";}?><span style="">  </td>
				...
				<td  style="text-align:right;font-size:11px; ">
					...
					<table align="right" width="15%"  cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Cambria;">
						...
						<tr style=""> 
							...
							<td  style="width:80%;font-weight:bold;border-top:1px solid;border-left:1px solid;text-align:center;padding-bottom:5px;padding-top:5px; ">Page:1/2</td>
						</tr>
		...
		<!-- <table align="center" width="92%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Cambria;margin-left:35px;border:1px solid;">
			...
			<tr>
					<td  style="text-align:center;font-size:16px; ">
						...
						<table align="center" width="100%"  cellspacing="0" cellpadding="0" style="font-size:16px;font-family: Cambria;border-bottom:1px solid;border-top:1px solid;margin-bottom:10px;margin-top:10px;">
				
							<tr style=""> 
								
									<td  style="width:10%;border-right:1px solid; text-align:center;font-weight:bold; ">[3]</td>
									<td  style="width:90%; text-align:left;font-weight:bold;padding-bottom:2px;padding-top:2px; ">&nbsp;&nbsp; Water Absorption [ IS : 3495-1992 PART -2 ]</td>
					...
					<td  style="text-align:center;font-size:14px; ">
						...
						<table align="left" width="100%"  cellspacing="0" cellpadding="0" style="font-size:14px;font-family: Cambria;border:1px solid;border-width:1px 0px 1px 0px;">
							...
							<tr style=""> 
									...
									<td  style="border-left:1px solid;width:30%; text-align:center;font-weight:bold;padding-bottom:3px;padding-top:3px; ">Water Absorption in<br>percent<br><span style="border-bottom:1px solid;">(𝑊2 − 𝑊1)</span> 𝑋100<br>𝑊1</td>
							</tr>
							<tr style=""> 
								
									<td  style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"><?php echo $cnt++;?> </td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w1_1']!="" && $row_select_pipe['wtr_w1_1']!="0" && $row_select_pipe['wtr_w1_1']!=null){echo $row_select_pipe['wtr_w1_1']; }else{echo " <br>";}?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w2_1']!="" && $row_select_pipe['wtr_w2_1']!="0" && $row_select_pipe['wtr_w2_1']!=null){echo $row_select_pipe['wtr_w2_1']; }else{echo " <br>";}?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w2_1']!="" && $row_select_pipe['wtr_w2_1']!="0" && $row_select_pipe['wtr_w2_1']!=null){echo (($row_select_pipe['wtr_w2_1'])-($row_select_pipe['wtr_w1_1'])); }else{echo " <br>";} ?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:30%;text-align:center; "><?php if($row_select_pipe['wtr_1']!="" && $row_select_pipe['wtr_1']!="0" && $row_select_pipe['wtr_1']!=null){echo $row_select_pipe['wtr_1']; }else{echo " <br>";}?></td>
							</tr>
							<tr style=""> 
								
									<td  style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"> <?php echo $cnt++;?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w1_2']!="" && $row_select_pipe['wtr_w1_2']!="0" && $row_select_pipe['wtr_w1_2']!=null){echo $row_select_pipe['wtr_w1_2']; }else{echo " <br>";}?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w2_2']!="" && $row_select_pipe['wtr_w2_2']!="0" && $row_select_pipe['wtr_w2_2']!=null){echo $row_select_pipe['wtr_w2_2']; }else{echo " <br>";}?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w2_2']!="" && $row_select_pipe['wtr_w2_2']!="0" && $row_select_pipe['wtr_w2_2']!=null){echo (($row_select_pipe['wtr_w2_2'])-($row_select_pipe['wtr_w1_2'])); }else{echo " <br>";} ?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:30%;text-align:center; "><?php if($row_select_pipe['wtr_2']!="" && $row_select_pipe['wtr_2']!="0" && $row_select_pipe['wtr_2']!=null){echo $row_select_pipe['wtr_2']; }else{echo " <br>";}?></td>
							</tr>
							<tr style=""> 
								
									<td  style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"><?php echo $cnt++;?> </td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w1_3']!="" && $row_select_pipe['wtr_w1_3']!="0" && $row_select_pipe['wtr_w1_3']!=null){echo $row_select_pipe['wtr_w1_3']; }else{echo " <br>";}?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w2_3']!="" && $row_select_pipe['wtr_w2_3']!="0" && $row_select_pipe['wtr_w2_3']!=null){echo $row_select_pipe['wtr_w2_3']; }else{echo " <br>";}?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w2_3']!="" && $row_select_pipe['wtr_w2_3']!="0" && $row_select_pipe['wtr_w2_3']!=null){echo (($row_select_pipe['wtr_w2_3'])-($row_select_pipe['wtr_w1_3'])); }else{echo " <br>";} ?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:30%;text-align:center; "><?php if($row_select_pipe['wtr_3']!="" && $row_select_pipe['wtr_3']!="0" && $row_select_pipe['wtr_3']!=null){echo $row_select_pipe['wtr_3']; }else{echo " <br>";}?></td>
							</tr>
							<tr style=""> 
								
									<td  style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"> <?php echo $cnt++;?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w1_4']!="" && $row_select_pipe['wtr_w1_4']!="0" && $row_select_pipe['wtr_w1_4']!=null){echo $row_select_pipe['wtr_w1_4']; }else{echo " <br>";}?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w2_4']!="" && $row_select_pipe['wtr_w2_4']!="0" && $row_select_pipe['wtr_w2_4']!=null){echo $row_select_pipe['wtr_w2_4']; }else{echo " <br>";}?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w2_4']!="" && $row_select_pipe['wtr_w2_4']!="0" && $row_select_pipe['wtr_w2_4']!=null){echo (($row_select_pipe['wtr_w2_4'])-($row_select_pipe['wtr_w1_4'])); }else{echo " <br>";} ?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:30%;text-align:center; "><?php if($row_select_pipe['wtr_4']!="" && $row_select_pipe['wtr_4']!="0" && $row_select_pipe['wtr_4']!=null){echo $row_select_pipe['wtr_4']; }else{echo " <br>";}?></td>
							</tr>
							<tr style=""> 
								
									<td  style="border-top:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;"> <?php echo $cnt++;?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w1_5']!="" && $row_select_pipe['wtr_w1_5']!="0" && $row_select_pipe['wtr_w1_5']!=null){echo $row_select_pipe['wtr_w1_5']; }else{echo " <br>";}?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w2_5']!="" && $row_select_pipe['wtr_w2_5']!="0" && $row_select_pipe['wtr_w2_5']!=null){echo $row_select_pipe['wtr_w2_5']; }else{echo " <br>";}?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:20%;text-align:center; "><?php if($row_select_pipe['wtr_w2_5']!="" && $row_select_pipe['wtr_w2_5']!="0" && $row_select_pipe['wtr_w2_5']!=null){echo (($row_select_pipe['wtr_w2_5'])-($row_select_pipe['wtr_w1_5'])); }else{echo " <br>";} ?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:30%;text-align:center; "><?php if($row_select_pipe['wtr_5']!="" && $row_select_pipe['wtr_5']!="0" && $row_select_pipe['wtr_5']!=null){echo $row_select_pipe['wtr_5']; }else{echo " <br>";}?></td>
							</tr>
						</table>
					...
					<td  style="text-align:center;font-size:16px; ">
						...
						<table align="center" width="100%"  cellspacing="0" cellpadding="0" style="font-size:16px;font-family: Cambria;margin-right:80px;">
							...
							<tr style=""> 
								...
								<td  style="width:22%; text-align:center;font-weight:bold;border:1px solid;border-top:0px solid;border-right:0px solid;padding-bottom:5px;padding-top:5px;	"><span style=""><?php if($row_select_pipe['avg_wtr']!="" && $row_select_pipe['avg_wtr']!="0" && $row_select_pipe['avg_wtr']!=null){echo $row_select_pipe['avg_wtr']; }else{echo " <br>";}?></td>
							</tr>
				...
				<td  style="text-align:center;font-size:16px; ">
					...
					<table align="center" width="100%"  cellspacing="0" cellpadding="0" style="font-size:16px;font-family: Cambria;border-bottom:1px solid;border-top:1px solid;">
						...
						<tr style=""> 
								...
								<td  style="width:90%; text-align:left;font-weight:bold;padding-bottom:3px;padding-top:3px; ">&nbsp;&nbsp; Efflorescence Visual observation After two cycle [ IS : 3495-1992 PART -3 ]</td>
					...
					<td  style="text-align:center;font-size:14px; ">
						...
						<table align="left" width="75%"  cellspacing="0" cellpadding="0" style="font-size:14px;font-family: Cambria;border:1px solid;margin-bottom:20px;margin-left:10%;">
							...
							<tr style=""> 
									...
									<td  style="width:10%;text-align:center;font-weight:bold;padding-bottom:5px;padding-top:5px;  ">MEASURE</td>
									<td  style="border-left:1px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:3px;padding-top:3px; "colspan=5>Mark in appropriate (√)</td>
							</tr>
							<tr style=""> 
									<td  style="border-top:1px solid;width:30%; text-align:center;font-weight:bold;padding-bottom:1px;padding-top:1px;padding-bottom:5px;padding-top:5px;">SAMPLE ID</td>
									<td  style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center;font-weight:bold; "><?php echo $cnt++;?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center;font-weight:bold; "><?php echo $cnt++;?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center;font-weight:bold; "><?php echo $cnt++;?></td>
									<td  style="border-top:1px solid;border-left:1px solid;width:14%;text-align:center;font-weight:bold; "><?php echo $cnt++;?></td>
					...
					<td  style="text-align:right;font-size:11px; ">
						...
						<table align="right" width="15%"  cellspacing="0" cellpadding="0" style="font-size:11px;font-family: Cambria;">
							...
							<tr style=""> 
								...
								<td  style="width:80%;font-weight:bold;border-top:1px solid;border-left:1px solid;text-align:center;padding-bottom:5px;padding-top:5px; ">Page:2/2</td>
							</tr>
