...
<body>
	...
	<page size="A4">
        ...
        <table align="center" width="94%" class="test1">
			<tr style="border: 0;">
				<td colspan="3" style="width:25%;text-align:left;font-size: 16px; font-weight: bold;padding-bottom: 15px;"><b>IS 516 (P-4): 2018</b></td>
			</tr>
			<tr style="border: 1px solid black;">
			...
			<tr style="border: 1px solid black;">
				...
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['mar_1'] != "" && $row_select_pipe['mar_1'] != null && $row_select_pipe['mar_1'] != "0") {
																														echo $row_select_pipe['mar_1'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php echo date('d - m - Y', strtotime($start_date)); ?></b></td>
				<td style="width: 14%;border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp;</b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['weight1'] != "" && $row_select_pipe['weight1'] != null && $row_select_pipe['weight1'] != "0") {
																														echo $row_select_pipe['weight1'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['dia_1'] != "" && $row_select_pipe['dia_1'] != null && $row_select_pipe['dia_1'] != "0") {
																														echo $row_select_pipe['dia_1'];
																													} else {
																														echo "-";
																													} ?> </b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['len_1'] != "" && $row_select_pipe['len_1'] != null && $row_select_pipe['len_1'] != "0") {
																														echo $row_select_pipe['len_1'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['load_1'] != "" && $row_select_pipe['load_1'] != null && $row_select_pipe['load_1'] != "0") {
																														echo $row_select_pipe['load_1'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['com_1'] != "" && $row_select_pipe['com_1'] != null && $row_select_pipe['com_1'] != "0") {
																														echo $row_select_pipe['com_1'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['ccc_1'] != "" && $row_select_pipe['ccc_1'] != null && $row_select_pipe['ccc_1'] != "0") {
																														echo $row_select_pipe['ccc_1'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['ecs_1'] != "" && $row_select_pipe['ecs_1'] != null && $row_select_pipe['ecs_1'] != "0") {
																														echo $row_select_pipe['ecs_1'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['den_1'] != "" && $row_select_pipe['den_1'] != null && $row_select_pipe['den_1'] != "0") {
			...
			<tr style="border: 1px solid black;">
				<td style="border-top:1px solid;text-align:center;font-weight:bold; ">&nbsp;&nbsp;&nbsp;<?php echo $cnt++; ?></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['mar_1'] != "" && $row_select_pipe['mar_2'] != null && $row_select_pipe['weight2'] != "0") {
																														echo $row_select_pipe['mar_2'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php echo date('d - m - Y', strtotime($start_date)); ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['weight2'] != "" && $row_select_pipe['weight2'] != null && $row_select_pipe['mar_2'] != "0") {
																														echo $row_select_pipe['weight2'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['dia_2'] != "" && $row_select_pipe['dia_2'] != null && $row_select_pipe['dia_2'] != "0") {
																														echo $row_select_pipe['dia_2'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['len_2'] != "" && $row_select_pipe['len_2'] != null && $row_select_pipe['len_2'] != "0") {
																														echo $row_select_pipe['len_2'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['load_2'] != "" && $row_select_pipe['load_2'] != null && $row_select_pipe['load_2'] != "0") {
																														echo $row_select_pipe['load_2'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['com_2'] != "" && $row_select_pipe['com_2'] != null && $row_select_pipe['com_2'] != "0") {
																														echo $row_select_pipe['com_2'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['ccc_2'] != "" && $row_select_pipe['ccc_2'] != null && $row_select_pipe['ccc_2'] != "0") {
																														echo $row_select_pipe['ccc_2'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['ecs_2'] != "" && $row_select_pipe['ecs_2'] != null && $row_select_pipe['ecs_2'] != "0") {
																														echo $row_select_pipe['ecs_2'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['den_2'] != "" && $row_select_pipe['den_2'] != null && $row_select_pipe['den_2'] != "0") {
			...
			<tr style="border: 1px solid black;">
				<td style="border-top:1px solid;text-align:center;font-weight:bold; ">&nbsp;&nbsp;&nbsp;<?php echo $cnt++; ?></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['mar_3'] != "" && $row_select_pipe['mar_3'] != null && $row_select_pipe['mar_3'] != "0") {
																														echo $row_select_pipe['mar_3'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php echo date('d - m - Y', strtotime($start_date)); ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['weight3'] != "" && $row_select_pipe['weight3'] != null && $row_select_pipe['weight3'] != "0") {
																														echo $row_select_pipe['weight3'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['dia_3'] != "" && $row_select_pipe['dia_3'] != null && $row_select_pipe['dia_3'] != "0") {
																														echo $row_select_pipe['dia_3'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['len_3'] != "" && $row_select_pipe['len_3'] != null && $row_select_pipe['len_3'] != "0") {
																														echo $row_select_pipe['len_3'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['load_3'] != "" && $row_select_pipe['load_3'] != null && $row_select_pipe['load_3'] != "0") {
																														echo $row_select_pipe['load_3'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['com_3'] != "" && $row_select_pipe['com_3'] != null && $row_select_pipe['com_3'] != "0") {
																														echo $row_select_pipe['com_3'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['ccc_3'] != "" && $row_select_pipe['ccc_3'] != null && $row_select_pipe['ccc_3'] != "0") {
																														echo $row_select_pipe['ccc_3'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['ecs_3'] != "" && $row_select_pipe['ecs_3'] != null && $row_select_pipe['ecs_3'] != "0") {
																														echo $row_select_pipe['ecs_3'];
																													} else {
																														echo "-";
																													} ?></b></td>
				<td style="border-left:1px solid;text-align:center;padding: 4px;"><b>&nbsp; <?php if ($row_select_pipe['den_3'] != "" && $row_select_pipe['den_3'] != null && $row_select_pipe['den_3'] != "0") {
			...
			<tr>
				...
				<td style="border:1px solid;text-align:left;padding: 4px;"><b>&nbsp; </b></td>
			</tr>
		</table>
		<br><br>
