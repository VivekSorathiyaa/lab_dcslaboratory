	...
	?>
		...
		<table align="center" width="94%" class="test1" style="" Height="35%">
			...
			<tr style="border-top:1px solid;" >
				...
				<td rowspan="3" style="border-left:1px solid;text-align:center;transform:rotate(330deg);"><?php if($casting_date !='' && $casting_date!=0 && $casting_date!=null){echo date('d-m-Y',strtotime($casting_date));}else{echo '-';}?></td>
				...
				<td style="border-left:1px solid;text-align:center;"><?php if($ans['load_1']!='' && $ans['load_1']!=0 && $ans['load_1']!=null){echo $ans['load_1'];}else{echo '-';}?></td>
				<td style="border-left:1px solid;text-align:center;"><?php if($ans['comp_1']!='' && $ans['comp_1']!=0 && $ans['comp_1']!=null){echo $ans['comp_1'];}else{echo '-';}?></td>
			...
			<tr style="border-top:1px solid;" >
				...
				<td style="border-left:1px solid;text-align:center;"><?php if($ans['load_2']!='' && $ans['load_2']!=0 && $ans['load_2']!=null){echo $ans['load_2'];}else{echo '-';}?></td>
				<td style="border-left:1px solid;text-align:center;"><?php if($ans['comp_2']!='' && $ans['comp_2']!=0 && $ans['comp_2']!=null){echo $ans['comp_2'];}else{echo '-';}?></td>
			...
			<tr style="border-top:1px solid;" >
				...
				<td style="border-left:1px solid;text-align:center;"><?php if($ans['load_3']!='' && $ans['load_3']!=0 && $ans['load_3']!=null){echo $ans['load_3'];}else{echo '-';}?></td>
				<td style="border-left:1px solid;text-align:center;"><?php if($ans['comp_3']!='' && $ans['comp_3']!=0 && $ans['comp_3']!=null){echo $ans['comp_3'];}else{echo '-';}?></td>
			...
			<tr style="border-top:1px solid;font-size:15px;">
				...
				<td style="border-left:1px solid;text-align:center;"><?php if($ans['avg_com_s_1']!='' && $ans['avg_com_s_1']!=0 && $ans['avg_com_s_1']!=null){echo $ans['avg_com_s_1'];}else{echo '-';}?></td>
