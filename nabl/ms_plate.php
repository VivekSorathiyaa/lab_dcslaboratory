				...
				<div class="col-md-12">
					<div class="box box-info">
						<div class="box-header with-border">
							<h2  style="text-align:center;">STRUCTURAL STEEL</h2>
						</div>
						...
						<form class="form" id="Glazed" method="post">
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
									 <div class="col-sm-2">
													<label >Tensile 2 Time:</label>
													<input type="checkbox"  name="chk_two"  id="chk_two" value="chk_two">
												</div>
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<div class="col-sm-2">
											...
											<?php   
												$querys_job1 = "SELECT * FROM ms_plate WHERE `is_deleted`='0' and lab_no='$lab_no'";
										...
										?>
										<div class="col-sm-2">
											<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_ms_plate.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
										</div>
										
										
										<div class="col-sm-2">
											<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_ms_plate.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
						...
						<div class="panel-body">
							...
							<div class="row">									
								...
								<div class="col-lg-5">
									<div class="form-group">
											<div class="col-sm-8">
												<label for="inputEmail3" class="col-sm-12 control-label label-right">Actual Thickness / Diameter</label>
												<input type="text" class="form-control" id="tube_temp2" name="tube_temp2" >
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="out12" name="out12" >
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="weight12" name="weight12" >
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="mass12" name="mass12" readonly>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="dia12" name="dia12" >
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="width12" name="width12" >
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="thk12" name="thk12" >
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="area12" name="area12" readonly>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="str12" name="str12" >
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="ult12" name="ult12" >
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="ten12" name="ten12" >
										</div>
									</div>	
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="initial12" name="initial12" readonly>
										</div>
									</div>									
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="final12" name="final12" >
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="elo12" name="elo12" >
										</div>
									</div>
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="location12" name="location12" >
										</div>
									</div>									
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="col-md-5">
										<div class="form-group">
											<input type="text" class="form-control" id="bend12" name="bend12" >
										</div>
									</div>
					...
					<div class="col-lg-12">
						<table border="1px solid black" align="center" width="100%" id="aaaa">
							<tr>
								...
								<?php
							 $query = "select * from ms_plate WHERE lab_no='$aa'  and `is_deleted`='0'";
...
$(document).ready(function(){ 
	...
	function phy_auto(){
		...
		var l1 = $('#l1').val(randomNumberFromRange(275,310).toFixed());
		var w1 = $('#w1').val(randomNumberFromRange(275,310).toFixed());
		var t1 = $('#t1').val(randomNumberFromRange(275,310).toFixed());
		var out1 = $('#out1').val(randomNumberFromRange(275,310).toFixed());
		var weight1 = $('#weight1').val(randomNumberFromRange(275,310).toFixed());
		var len1 = $('#len1').val(randomNumberFromRange(275,310).toFixed());
		
		var mas_1 = (+weight1) / (+len1);
		$('#mass1').val(mas_1.toFixed(3));
		var mass1 = $('#mass1').val(randomNumberFromRange(275,310).toFixed());
		
		var dia1 = $('#dia1').val(randomNumberFromRange(275,310).toFixed());
		var width1 = $('#width1').val(randomNumberFromRange(275,310).toFixed());
		var thk1 = $('#thk1').val(randomNumberFromRange(275,310).toFixed());
		var ar1 = (+3.14)/(+4);
		var area_1 = (+ar1) * (+dia1) * (+dia1); 
		
		$('#area1').val(area_1.toFixed(2));
		var area1 = $('#area1').val(randomNumberFromRange(275,310).toFixed());	
		var ms_grade = $('#ms_grade').val(randomNumberFromRange(275,310).toFixed());
		var tube_temp = $('#tube_temp').val(randomNumberFromRange(275,310).toFixed());
		var str1 = randomNumberFromRange(275,310).toFixed();
		
		$('#str1').val(str1);
		var str_1 = $('#str1').val(randomNumberFromRange(275,310).toFixed());
		...
		$('#ten1').val(ten1);
		$('#elo1').val(elo1);
		var ten_1 = $('#ten1').val(randomNumberFromRange(275,310).toFixed());
		var elo_1 = $('#elo1').val(randomNumberFromRange(275,310).toFixed());
		
		var load_1 = ($('#str1').val() * $('#area1').val()) / 1000;
		$('#load1').val(load_1.toFixed(2));
		
		var ult_1 = ($('#ten1').val() * $('#area1').val()) / 1000;
		$('#ult1').val(ult_1.toFixed(2));
		
		 var initial_1 = ((+5.65) * Math.sqrt(area1));;	
		 $('#initial1').val(initial_1.toFixed());
		 var initial_1=$('#initial1').val(randomNumberFromRange(275,310).toFixed());						 
		
		
		var final1 = (((+initial_1)*(+elo_1))/100)+(+initial_1);
		 $('#final1').val(final1.toFixed(2));	
		var final_1 = $('#final1').val(randomNumberFromRange(275,310).toFixed());	
		...
		$('#bend1').val("Satisfactory");
			...
			if(document.getElementById('chk_two').checked) {
				var l12 = $('#l12').val(randomNumberFromRange(275,310).toFixed());
		        var w12 = $('#w12').val(randomNumberFromRange(275,310).toFixed());
		        var t12 = $('#t12').val(randomNumberFromRange(275,310).toFixed());
		        var out12 = $('#out12').val(randomNumberFromRange(275,310).toFixed());
		        var weight12 = $('#weight12').val(randomNumberFromRange(275,310).toFixed());
		        var len12 = $('#len12').val(randomNumberFromRange(275,310).toFixed());
		        
		        var mas_12 = (+weight12) / (+len12);
		        $('#mass12').val(mas_12.toFixed(3));
		        var mass12 = $('#mass12').val(randomNumberFromRange(275,310).toFixed());
		        
		        var dia12 = $('#dia12').val(randomNumberFromRange(275,310).toFixed());
		        var width12 = $('#width12').val(randomNumberFromRange(275,310).toFixed());
		        var thk12 = $('#thk12').val(randomNumberFromRange(275,310).toFixed());
		        var ar12 = (+3.14)/(+4);
		        var area_12 = (+ar12) * (+dia12) * (+dia12); 
		        
		        $('#area12').val(area_12.toFixed(2));
		        var area12 = $('#area12').val(randomNumberFromRange(275,310).toFixed());	
		        var ms_grade = $('#ms_grade').val(randomNumberFromRange(275,310).toFixed());
		        var tube_temp2 = $('#tube_temp2').val(randomNumberFromRange(275,310).toFixed());
		        var str12 = randomNumberFromRange(275,310).toFixed();
		        
		        $('#str12').val(str12);
		        var str_12 = $('#str12').val(randomNumberFromRange(275,310).toFixed());
		        
		        var ten12 = randomNumberFromRange(425,460).toFixed();
		        var elo12 = randomNumberFromRange(24,32).toFixed();
		        
		        $('#ten12').val(ten12);
		        $('#elo12').val(elo12);
		        var ten_12 = $('#ten12').val(randomNumberFromRange(275,310).toFixed());
		        var elo_12 = $('#elo12').val(randomNumberFromRange(275,310).toFixed());
		        
		        var load_12 = ($('#str12').val() * $('#area12').val()) / 1000;
		        $('#load12').val(load_12.toFixed(2));
		        
		        var ult_12 = ($('#ten12').val() * $('#area12').val()) / 1000;
		        $('#ult12').val(ult_12.toFixed(2));
		        
		         var initial_12 = ((+5.65) * Math.sqrt(area1));;	
		         $('#initial12').val(initial_12.toFixed());
		         var initial_12=$('#initial12').val(randomNumberFromRange(275,310).toFixed());						 
		        
		        
		        var final12 = (((+initial_12)*(+elo_12))/100)+(+initial_12);
		         $('#final12').val(final12.toFixed(2));	
		        var final_12 = $('#final12').val(randomNumberFromRange(275,310).toFixed());	
		        	
		        $('#location12').val("WGL");
		        $('#bend12').val("Satisfactory");
	...
	$('#elo12').change(function(){
		$('#txtdia').css("background-color","var(--success)");
		var elo_12 = $('#elo12').val();
		var initial_12=$('#initial12').val();
		var final12 = (((+initial_12)*(+elo_12))/100)+(+initial_12);
		 $('#final12').val(final12.toFixed(2));	
		var final_12 = $('#final12').val();
	});
	...
	$('#weight12,#len12').change(function(){
		$('#txtdia').css("background-color","var(--success)");
		var weight12 = $('#weight12').val();
		var len12 = $('#len12').val();
		var mas_12 = (+weight12) / (+len12);
		$('#mass12').val(mas_12.toFixed(3));
		var mass12 = $('#mass12').val();
	});
	...
	$('#load12').change(function(){
		$('#txtdia').css("background-color","var(--success)");
		var load_12 = $('#load12').val();
		var area_12 = $('#area12').val();
		var yeld_s12 = ((+load_12)*1000) / (+area_12);
		$('#str12').val(yeld_s12.toFixed());
	...
	$('#str12').change(function(){
		$('#txtdia').css("background-color","var(--success)");
		var str_12 = $('#str12').val();
		var area_12 = $('#area12').val();
		var load_12 = ((+str_12) * (+area_12)) / 1000;
		$('#load12').val(load_12.toFixed(2));
	...
	$('#ult12').change(function(){
		$('#txtdia').css("background-color","var(--success)");
		var ult_12 = $('#ult12').val();
		var area_12 = $('#area12').val();
		var yeld_s112 = ((+ult_12)*1000) / (+area_12);
		$('#ten12').val(yeld_s112.toFixed());
	...
	$('#ten12').change(function(){
		$('#txtdia').css("background-color","var(--success)");
		var ten_12 = $('#ten12').val();
		var area_12 = $('#area12').val();
		var ult_12 = ((+ten_12) * (+area_12)) / 1000;
		$('#ult12').val(ult_12.toFixed(2));
	...
	$('#final12').change(function(){
		$('#txtdia').css("background-color","var(--success)");
		var final_12 = $('#final12').val();
		var initial_12=$('#initial12').val();
		 var eq12 = (+final_12) - (+initial_12);
		 var eq22 = (+eq12) * 100;
		 var elong_12 = (+eq22) / (+initial_12);
		 $('#elo12').val(elong_12.toFixed());
	});
	...
	$('#width12,#thk12').change(function(){
		$('#txtdia').css("background-color","var(--success)");
		var thk_12 = $('#thk12').val();
		var width_12=$('#width12').val();
		
		
		var area_12 = (+width_12) * (+thk_12) ;		
		$('#area12').val(area_12.toFixed(2));
		...
		var load_12 = ((+str_12) * (+area12)) / 1000;
		$('#load12').val(load_12.toFixed(2));
		
		var ult_12 = ((+ten_12) * (+area12)) / 1000;
		$('#ult12').val(ult_12.toFixed(2));
		
		 var initial_12 = ((+5.65) * Math.sqrt(area12));	
		 $('#initial12').val(initial_12.toFixed());
		 var initial_12=$('#initial12').val();						 
   ...
   $('#tube_temp2').change(function(){
		...
		var area12 = $('#area12').val();	
		var ms_grade = $('#ms_grade').val();
		var tube_temp2 = $('#tube_temp2').val();
		
		if(ms_grade=="E 250 A" || ms_grade=="E 250 BR" || ms_grade=="E 250 B0" || ms_grade=="E 250 C")
		{
			if(tube_temp2>=0 && tube_temp2<20)
			{
				var str12 = randomNumberFromRange(275,310).toFixed();
			}
			else if(tube_temp>=20 && tube_temp<=40)
		...
		else if(ms_grade=="E 275 A" || ms_grade=="E 275 BR" || ms_grade=="E 275 B0" || ms_grade=="E 275 C")
		{
			if(tube_temp2>=0 && tube_temp2<20)
			{
				var str12 = randomNumberFromRange(295,330).toFixed();
			}
			else if(tube_temp2>=20 && tube_temp2<=40)
			{
				var str12 = randomNumberFromRange(295,330).toFixed();
			}
			else if(tube_temp>40)
		...
		else if(ms_grade=="E 300 A" || ms_grade=="E 300 BR" || ms_grade=="E 300 B0" || ms_grade=="E 300 C")
		{
			if(tube_temp2>=0 && tube_temp2<20)
			{
				var str12 = randomNumberFromRange(317,350).toFixed();
			}
			else if(tube_temp2>=20 && tube_temp2<=40)
			{
				var str12 = randomNumberFromRange(317,350).toFixed();
			}
			else if(tube_temp2>40)
			{
				var str12 = randomNumberFromRange(317,350).toFixed();
			}
		}
		else if(ms_grade=="E 350 A" || ms_grade=="E 350 BR" || ms_grade=="E 350 B0" || ms_grade=="E 350 C")
		{
			if(tube_temp2>=0 && tube_temp2<20)
			{
				var str12 = randomNumberFromRange(370,405).toFixed();
			}
			else if(tube_temp2>=20 && tube_temp2<=40)
			{
				var str12 = randomNumberFromRange(370,405).toFixed();
		...
		else if(ms_grade=="E 410 A" || ms_grade=="E 410 BR" || ms_grade=="E 410 B0" || ms_grade=="E 410 C")
		{
			if(tube_temp2>=0 && tube_temp2<20)
			{
				var str12 = randomNumberFromRange(417,440).toFixed();
			}
			else if(tube_temp2>=20 && tube_temp2<=40)
			{
				var str12 = randomNumberFromRange(417,440).toFixed();
		...
		else if(ms_grade=="E 450 A" || ms_grade=="E 450 BR")
		{
			if(tube_temp2>=0 && tube_temp2<20)
			{
				var str12 = randomNumberFromRange(460,490).toFixed();
			}
			else if(tube_temp2>=20 && tube_temp2<=40)
			{
				var str12 = randomNumberFromRange(460,490).toFixed();
		...
		else if(ms_grade=="E 550 A" || ms_grade=="E 550 BR")
		{
			if(tube_temp2>=0 && tube_temp2<20)
			{
				var str12 = randomNumberFromRange(565,600).toFixed();
			}
			else if(tube_temp2>=20 && tube_temp2<=40)
			{
				var str12 = randomNumberFromRange(565,600).toFixed();
		...
		else if(ms_grade=="E 600 A" || ms_grade=="E 600 BR")
		{
			if(tube_temp>=0 && tube_temp<20)
			{
				var str12 = randomNumberFromRange(612,635).toFixed();
			}
			else if(tube_temp2>=20 && tube_temp2<=40)
			{
				var str12 = randomNumberFromRange(612,635).toFixed();
		...
		else if(ms_grade=="E 650 A" || ms_grade=="E 650 BR")
		{
			if(tube_temp2>=0 && tube_temp2<20)
			{
				var str12 = randomNumberFromRange(655,687).toFixed();
			}
			else if(tube_temp2>=20 && tube_temp2<=40)
			{
				var str12 = randomNumberFromRange(655,687).toFixed();
		...
		{
			var ten12 = randomNumberFromRange(450,485).toFixed();
			var elo12 = randomNumberFromRange(24,32).toFixed();
		}		
		else if(ms_grade=="E 300 A" || ms_grade=="E 300 BR" || ms_grade=="E 300 B0" || ms_grade=="E 300 C")
		{
			var ten12 = randomNumberFromRange(453,485).toFixed();
			var elo12 = randomNumberFromRange(24,28).toFixed();
		}
		else if(ms_grade=="E 350 A" || ms_grade=="E 350 BR" || ms_grade=="E 350 B0" || ms_grade=="E 350 C")
		{
			var ten12 = randomNumberFromRange(503,535).toFixed();
			var elo12 = randomNumberFromRange(23,27).toFixed();
		}
		else if(ms_grade=="E 410 A" || ms_grade=="E 410 BR" || ms_grade=="E 410 B0" || ms_grade=="E 410 C")
		{
			var ten12 = randomNumberFromRange(550,590).toFixed();
			var elo12 = randomNumberFromRange(21,24).toFixed();
		}
		else if(ms_grade=="E 450 A" || ms_grade=="E 450 BR")
		{
			var ten12 = randomNumberFromRange(582,605).toFixed();
			var elo12 = randomNumberFromRange(21,23).toFixed();
		}
		else if(ms_grade=="E 550 A" || ms_grade=="E 550 BR")
		{
			var ten12 = randomNumberFromRange(665,700).toFixed();
			var elo12 = randomNumberFromRange(13,15).toFixed();
		}
		else if(ms_grade=="E 600 A" || ms_grade=="E 600 BR")
		{
			var ten12 = randomNumberFromRange(742,775).toFixed();
			var elo12 = randomNumberFromRange(13,15).toFixed();
		}
		else if(ms_grade=="E 650 A" || ms_grade=="E 650 BR")
		{
			var ten12 = randomNumberFromRange(800,845).toFixed();
			var elo12 = randomNumberFromRange(13,15).toFixed();
		}
...
function getGlazedTiles(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo $base_url; ?>save_ms_plate.php',
    ...
    if (type == 'add') {
				...
				for(var i=0;i<aa.length;i++)
				{
					if(aa[i]=="yld")
					{
						...
						if(document.getElementById('chk_two').checked) {
							...
							var ult12 = $('#ult12').val();							
							var initial12 = $('#initial12').val();
							var final12 = $('#final12').val();							
							var location12 = $('#location12').val();
							var thk1 = $('#thk1').val();
						    var thk12 = $('#thk12').val();
							var elo1 = $('#elo1').val();
						    var elo12 = $('#elo12').val();
				...
				for(var i=0;i<aa.length;i++)
				{
					...
					else
					{
						...
						billData = '&action_type='+type+'&report_no='+report_no+'&job_no='+job_no+'&lab_no='+lab_no+'&tube_temp='+tube_temp+'&tube_humidity='+tube_humidity+'&chk_dia='+chk_dia+'&chk_elo='+chk_elo+'&chk_ten='+chk_ten+'&chk_yled='+chk_yled+'&chk_thk='+chk_thk+'&chk_mass='+chk_mass+'&ms_grade='+ms_grade+'&l1='+l1+'&w1='+w1+'&t1='+t1+'&out1='+out1+'&weight1='+weight1+'&len1='+len1+'&mass1='+mass1+'&dia1='+dia1+'&width1='+width1+'&thk1='+thk1+'&area1='+area1+'&load1='+load1+'&str1='+str1+'&ult1='+ult1+'&ten1='+ten1+'&initial1='+initial1+'&final1='+final1+'&elo1='+elo1+'&location1='+location1+'&chk_bend='+chk_bend+'&bend1='+bend1+'&ulr='+ulr+'&chk_chem='+chk_chem+'&c1='+c1+'&c2='+c2+'&c3='+c3+'&c4='+c4+'&c5='+c5+'&c6='+c6+'&c7='+c7+'&c8='+c8+'&c9='+c9+'&c10='+c10+'&c11='+c11+'&c12='+c12+'&c13='+c13+'&c14='+c14+'&tube_temp2='+tube_temp2+'&l12='+l12+'&w12='+w12+'&t12='+t12+'&out12='+out12+'&weight12='+weight12+'&len12='+len12+'&mass12='+mass12+'&dia12='+dia12+'&width12='+width12+'&thk12='+thk12+'&area12='+area12+'&load12='+load12+'&str12='+str12+'&ult12='+ult12+'&ten12='+ten12+'&initial12='+initial12+'&final12='+final12+'&elo12='+elo12+'&location12='+location12+'&bend12='+bend12+'&chk_two='+chk_two+'&amend_date='+amend_date;
				...
				for(var i=0;i<aa.length;i++)
				{
					if(aa[i]=="yld")
					{
						...
						if(chk_two=="1")
						{
						   ...
						   $("#chk_two").prop("checked", true); 
						 
						}else{
							
							$("#chk_two").prop("checked", false);
						...
						$('#tube_temp2').val(data.tube_temp2);
						$('#l12').val(data.l12);
						$('#w12').val(data.w12);
						$('#t12').val(data.t12);						
						$('#out12').val(data.out12);
						$('#weight12').val(data.weight12);
						$('#len12').val(data.len12);
						$('#mass12').val(data.mass12);
						$('#dia12').val(data.dia12);
						$('#width12').val(data.width12);
						$('#thk12').val(data.thk12);
						$('#area12').val(data.area12);
						$('#load12').val(data.load12);
						$('#str12').val(data.str12);
						$('#ult12').val(data.ult12);
						$('#ten12').val(data.ten12);
						$('#initial12').val(data.initial12);
						$('#final12').val(data.final12);
						$('#elo12').val(data.elo12);
						$('#location12').val(data.location12);
						$('#bend12').val(data.bend12);
