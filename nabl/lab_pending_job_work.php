     ...
     padding-right: 0px; ">
			...
			<!-- left column -->
				...
				<div class="box-header with-border">
					<h3 class="box-title">PENDING JOB WORK</h3>
				</div>
				<!-- /.box-header -->
								...
								<tbody>
									...
									?>
											...
											<td style="white-space:nowrap;">
												...
												<!--<input type="button" class="btn btn-warning btn-lg btn3d submit_reward_to_rec2" data-id="<?php //echo $row['report_no']."|".$row['job_number'];?>" title="Send To Reward" Value="Reward">-->
	...
	// for first portion
		...
		$(document).on('click','.submit_data_to_second_screen',function(){
			...
			({
				...
				success:function(html){
					window.location.href="<?php echo $base_url; ?>lab_pending_job_work.php";
				 }
			 });
			 },
           cancel: function () {
return;
		...
		$(document).on('click','.submit_reward_to_rec2',function(){
			var abc = $(this).attr('data-id');
			alert(abc);
			var ss=abc.split("|");
			var r_no = ss[0];
			...
			({
				type: 'POST',
				url: '<?php $base_url; ?>span_save_data_lab_screen.php',
				data: 'action_type=submit_reward_to_rec2&abc='+abc,
				success:function(html){
