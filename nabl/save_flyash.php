...
if (isset($_POST['action_type']) && !empty($_POST['action_type'])) {
	if ($_POST['action_type'] == 'data') {
		...
		$fill = array(
			...
			'consistency_of_cement' => $result['consistency_of_cement'],
			...
			'ss_sample' => $result['ss_sample'],
			'gs_sample' => $result['gs_sample'],
			'ps_bed' => $result['ps_bed'],
			'fs_e3' => $result['fs_e3'],
			'tts_sample' => $result['tts_sample'],
			'por_sample_bed' => $result['por_sample_bed'],
			'sample_e3' => $result['sample_e3'],
			'tt1' => $result['tt1'],
			...
			'caste_time1' => $result['caste_time1'],
			'caste_time2' => $result['caste_time2'],
			'caste_time3' => $result['caste_time3'],
			'caste_time4' => $result['caste_time4'],
			'test_date1' => $result['test_date1'],
			'test_date2' => $result['test_date2'],
			'test_date3' => $result['test_date3'],
			'test_date4' => $result['test_date4'],
			'test_time1' => $result['test_time1'],
			'test_time2' => $result['test_time2'],
			'test_time3' => $result['test_time3'],
			'test_time4' => $result['test_time4'],
			'day_1' => $result['day_1'],
			'day_2' => $result['day_2'],
			'day_3' => $result['day_3'],
			'day_4' => $result['day_4'],
		...
		$consistency_of_cement = $_POST['consistency_of_cement'];
		...
		$ss_sample = $_POST['ss_sample'];
		$gs_sample = $_POST['gs_sample'];
		$ps_bed = $_POST['ps_bed'];
		$fs_e3 = $_POST['fs_e3'];
		$tts_sample = $_POST['tts_sample'];
		$por_sample_bed = $_POST['por_sample_bed'];
		$sample_e3 = $_POST['sample_e3'];
		$tt1 = $_POST['tt1'];
		...
		$caste_time1 = $_POST['caste_time1'];
		$caste_time2 = $_POST['caste_time2'];
		$caste_time3 = $_POST['caste_time3'];
		$caste_time4 = $_POST['caste_time4'];

		$test_time1 = $_POST['test_time1'];
		$test_time2 = $_POST['test_time2'];
		$test_time3 = $_POST['test_time3'];
		$test_time4 = $_POST['test_time4'];
		...
		$set_test_method =  $_POST['set_test_method'];
		$set_test_req =  $_POST['set_test_req'];
		$set_test_limit_1 =  $_POST['set_test_limit_1'];
		$set_test_limit_2 =  $_POST['set_test_limit_2'];
		$sou_test_method =  $_POST['sou_test_method'];
		$sou_test_req =  $_POST['sou_test_req'];
		$sou_test_limit_1 =  $_POST['sou_test_limit_1'];
	...
	$insert = "insert into `fly_ash`(`report_no`, `ulr`, `job_no`, `lab_no`, `status`, `created_by`, `created_date`, `modified_by`, `modified_date`, `is_deleted`, `deleted_by`, `checked_by`, `chk_con`, `con_date_test`, `con_temp`, `con_humidity`, `con_weight`, `vol_1`, `vol_2`, `vol_3`, `vol_4`, `vol_5`, `vol_6`, `vol_7`, `wtr_1`, `wtr_2`, `wtr_3`, `wtr_4`, `wtr_5`, `wtr_6`, `wtr_7`, `reading_1`, `reading_2`, `reading_3`, `reading_4`, `reading_5`, `reading_6`, `reading_7`, `remark_1`, `remark_2`, `remark_3`, `remark_4`, `remark_5`, `remark_6`, `remark_7`, `final_consistency`, `consistency_of_cement`, `chk_fines`, `den_date_test`, `den_cement`, `fine_temp`, `fine_humidity`,`fbs_w1`, `fbs_w2`, `fbs_m1`, `fbs_m2`, `fbs_p1`, `fbs_p2`, `avg_fbs`, `den_intial`, `den_final`, `density`, `mass`, `x`, `v`, `p`, `constant_k`, `fines_t_1`, `fines_t_2`, `fines_t_3`, `fines_t_4`, `avg_fines_time`, `ss_area`, `ss_sample`, `gs_sample`, `ps_bed`, `fs_e3`, `tts_sample`, `por_sample_bed`, `sample_e3`, `tt1`, `chk_com`, `com_date_test`, `weight_of_cement`, `weight_of_sand`, `weight_of_water`, `com_temp`, `com_temp1`, `com_temp2`, `com_temp3`, `com_humidity`, `com_humidity1`, `com_humidity2`, `com_humidity3`, `sp_1`, `sp_2`, `sp_3`, `sp_4`, `caste_date1`, `caste_date2`, `caste_date3`, `caste_date4`,`caste_time1`, `caste_time2`, `caste_time3`, `caste_time4`, `test_date1`, `test_date2`, `test_date3`, `test_date4`,`test_time1`, `test_time2`, `test_time3`, `test_time4`, `day_1`, `day_2`, `day_3`, `day_4`, `woc_1`,`woc_2`,`woc_3`,`woc_4`, `area_1`, `area_2`, `area_3`, `area_4`, `area_5`, `area_6`, `area_7`, `area_8`, `area_9`, `area_10`, `area_11`, `area_12`, `load_1`, `load_2`, `load_3`, `load_4`, `load_5`, `load_6`, `load_7`, `load_8`, `load_9`, `load_10`, `load_11`, `load_12`, `com_1`, `com_2`, `com_3`, `com_4`, `com_5`, `com_6`, `com_7`, `com_8`, `com_9`, `com_10`, `com_11`, `com_12`, `avg_com_1`, `avg_com_2`, `avg_com_3`, `avg_com_4`, `l1`, `l2`, `l3`, `l4`, `l5`, `l6`, `l7`, `l8`, `l9`, `l10`, `l11`, `l12`, `b1`, `b2`, `b3`, `b4`, `b5`, `b6`, `b7`, `b8`, `b9`, `b10`, `b11`, `b12`, `report_date`, `chk_mou`, `in_w1`, `in_w2`, `fn_w1`, `fn_w2`, `mo1`, `mo2`, `avg_mo`, `makes`, `brand`, `type_of_cement`, `cement_grade`, `chk_sou`, `sou_date_test`, `sou_temp`, `sou_humidity`, `sou_weight`, `sou_water`, `dis_1_1`, `dis_1_2`, `dis_2_1`, `dis_2_2`, `diff_1`, `diff_2`, `soundness`, `chk_set`, `set_date_test`, `set_wtr`, `set_temp`, `set_humidity`, `hr_a`, `hr_b`, `hr_c`, `initial_time`, `final_time`)  values ('$report_no','$ulr','$job_no','$lab_no','0','$_SESSION[name]','$curr_date','','0000-00-00','0','','', '$chk_con', '$con_date_test', '$con_temp', '$con_humidity', '$con_weight', '$vol_1', '$vol_2', '$vol_3', '$vol_4', '$vol_5', '$vol_6', '$vol_7', '$wtr_1', '$wtr_2', '$wtr_3', '$wtr_4', '$wtr_5', '$wtr_6', '$wtr_7', '$reading_1', '$reading_2', '$reading_3', '$reading_4', '$reading_5', '$reading_6', '$reading_7', '$remark_1', '$remark_2', '$remark_3', '$remark_4', '$remark_5', '$remark_6', '$remark_7', '$final_consistency', '$consistency_of_cement', '$chk_fines', '$den_date_test', '$den_cement', '$fine_temp', '$fine_humidity','$fbs_w1', '$fbs_w2', '$fbs_m1', '$fbs_m2', '$fbs_p1', '$fbs_p2', '$avg_fbs', '$den_intial', '$den_final', '$density', '$mass', '$x', '$v', '$p', '$constant_k', '$fines_t_1', '$fines_t_2', '$fines_t_3', '$fines_t_4', '$avg_fines_time', '$ss_area', '$ss_sample', '$gs_sample', '$ps_bed', '$fs_e3', '$tts_sample', '$por_sample_bed', '$sample_e3', '$tt1', '$chk_com', '$com_date_test', '$weight_of_cement', '$weight_of_sand', '$weight_of_water', '$com_temp', '$com_temp1', '$com_temp2', '$com_temp3', '$com_humidity', '$com_humidity1', '$com_humidity2', '$com_humidity3', '$sp_1', '$sp_2', '$sp_3', '$sp_4', '$caste_date1', '$caste_date2', '$caste_date3', '$caste_date4', '$caste_time1', '$caste_time2', '$caste_time3', '$caste_time4', '$test_date1', '$test_date2', '$test_date3', '$test_date4', '$test_time1', '$test_time2', '$test_time3', '$test_time4', '$day_1', '$day_2', '$day_3', '$day_4', '$woc_1', '$woc_2', '$woc_3', '$woc_4', '$area_1', '$area_2', '$area_3', '$area_4', '$area_5', '$area_6', '$area_7', '$area_8', '$area_9', '$area_10', '$area_11', '$area_12', '$load_1', '$load_2', '$load_3', '$load_4', '$load_5', '$load_6', '$load_7', '$load_8', '$load_9', '$load_10', '$load_11', '$load_12', '$com_1', '$com_2', '$com_3', '$com_4', '$com_5', '$com_6', '$com_7', '$com_8', '$com_9', '$com_10', '$com_11', '$com_12', '$avg_com_1', '$avg_com_2', '$avg_com_3', '$avg_com_4', '$l1', '$l2', '$l3', '$l4', '$l5', '$l6', '$l7', '$l8', '$l9', '$l10', '$l11', '$l12', '$b1', '$b2', '$b3', '$b4', '$b5', '$b6', '$b7', '$b8', '$b9', '$b10', '$b11', '$b12', '$report_date','$chk_mou', '$in_w1', '$in_w2', '$fn_w1', '$fn_w2', '$mo1', '$mo2', '$avg_mo' , '$makes' , '$brand' , '$type_of_cement' , '$cement_grade', '$chk_sou', '$sou_date_test', '$sou_temp', '$sou_humidity', '$sou_weight', '$sou_water', '$dis_1_1', '$dis_1_2', '$dis_2_1', '$dis_2_2', '$diff_1', '$diff_2', '$soundness', '$chk_set', '$set_date_test', '$set_wtr', '$set_temp', '$set_humidity', '$hr_a', '$hr_b', '$hr_c', '$initial_time', '$final_time')";
...
<?php
		...
		$update = "update fly_ash SET `job_no`='$_POST[job_no]',`lab_no`='$_POST[lab_no]',`report_no`='$_POST[report_no]',
					...
					`tt1` = '$_POST[tt1]',
					`chk_com`= '$_POST[chk_com]',
					`com_date_test`= '$_POST[com_date_test]',
					`weight_of_cement`= '$_POST[weight_of_cement]',
					`weight_of_sand`= '$_POST[weight_of_sand]',
					`weight_of_water`= '$_POST[weight_of_water]',
					`com_temp`= '$_POST[com_temp]',
