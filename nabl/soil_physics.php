				...
				<div class="col-md-12">
					<div class="box box-info">
						<div class="box-header with-border">
							<h2  style="text-align:center;">SOIL</h2>
						</div>
								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<div class="col-sm-2">
											...
											<?php   
												$querys_job1 = "SELECT * FROM soil WHERE `is_deleted`='0' and lab_no='$lab_no'";
										...
										?>
										<div class="col-sm-2">
											<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_soil_physics.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&ulr=<?php echo $_GET['ulr'];?>&&ulr=<?php echo $_GET['ulr'];?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
										</div>
							...
							$test_check;
							 $select_query1 = "select * from span_material_assign,test_master WHERE span_material_assign.test = test_master.test_id and  span_material_assign.trf_no='$_GET[trf_no]' AND span_material_assign.job_number='$_GET[job_no]' AND span_material_assign.lab_no='$_GET[lab_no]' and span_material_assign.isdeleted='0'"; 
								...
								<div class="panel panel-default" id="grn">
										...
										<div class="panel-body">
											...
											<div class="row">
												<div class="col-md-12">  
													...
													<div class="form-group">											
														<div class="col-md-6">
														<label for="inputEmail3" class="control-label" >Silt, 0.002 to 0.075 MM % + Clay, &lt; 0.002 MM % </label>	
														</div>
														<div class="col-md-6"> 
											...
											<div class="row">
												<div class="col-md-12">  
													...
													<div class="form-group">											
														...
														<div class="col-md-6"> 
															<input type="text" style="text-align:center;" class="form-control inputs" tabindex="4" id="grain_grad_1" name="grain_grad_1">
														</div>
											...
											<div class="row">
												<div class="col-md-12">  
													...
													<div class="form-group">											
														...
														<div class="col-md-6"> 
															<input type="text" style="text-align:center;" class="form-control inputs" tabindex="4" id="grain_grad_2" name="grain_grad_2">
														</div>
											...
											<div class="row">
												<div class="col-md-12">  
													...
													<div class="form-group">											
														...
														<div class="col-md-6"> 
															<input type="text" style="text-align:center;" class="form-control inputs" tabindex="4" id="grain_grad_3" name="grain_grad_3">
														</div>
											...
											<div class="row">
												<div class="col-md-12">  
													...
													<div class="form-group">											
														...
														<div class="col-md-6"> 
															<input type="text" style="text-align:center;" class="form-control inputs" tabindex="4" id="grain_grad_4" name="grain_grad_4">
														</div>
											...
											<div class="row">
												<div class="col-md-12">  
													...
													<div class="form-group">											
														...
														<div class="col-md-6"> 
															<input type="text" style="text-align:center;" class="form-control inputs" tabindex="4" id="grain_grad_5" name="grain_grad_5">
														</div>
											...
											<div class="row">
												<div class="col-md-12">  
													...
													<div class="form-group">											
														...
														<div class="col-md-6"> 
															<input type="text" style="text-align:center;" class="form-control inputs" tabindex="4" id="grain_grad_6" name="grain_grad_6">
														</div>
									...
									<?php }
									else if($r1['test_code']=="hyd")
									{
										$test_check.="hyd,";
									?>
								
								<div class="panel panel-default" id="hyd">
									<div class="panel-heading" id="txthyd">
										<h4 class="panel-title">
											<a data-toggle="collapse" data-parent="#accordion" href="#collapse2232">
												<h4 class="panel-title">
												<b>HYDROMETER ANALYSIS</b>
												</h4>
											</a>
										</h4>
									</div>
									<div id="collapse2232" class="panel-collapse collapse">
										<div class="panel-body">
											<br>
												<div class="row">									
													<div class="col-lg-12">
														<div class="form-group">
																<div class="col-sm-1">
																	<label for="chk_hyd">1.</label>
																	<input type="checkbox" class="visually-hidden" name="chk_hyd"  id="chk_hyd" value="chk_hyd"><br>
																</div>
															<label for="inputEmail3" class="col-sm-4 control-label label-right">HYDROMETER ANALYSIS</label>
														</div>
													</div>
												</div>
			...
			322										</div>
											...
											<div class="row">
												<div class="col-md-12">  
													...
													<div class="form-group">											
														<div class="col-md-6">
														<label for="inputEmail3" class="control-label" >Silt, 0.002 to 0.075 MM %</label>	
														</div>
														<div class="col-md-6"> 
											...
											<div class="row">
												<div class="col-md-12">  
													...
													<div class="form-group">											
														...
														<div class="col-md-6"> 
															<input type="text" style="text-align:center;" class="form-control inputs" tabindex="4" id="g4" name="g4">
														</div>
											...
											<br>
												<div class="row">									
													<div class="col-lg-12">
														<div class="form-group">
																<div class="col-sm-1">
																	<label for="chk_CONSOLIDATION">11.</label>
					...
					<div class="col-lg-12">
						<table border="1px solid black" align="center" width="100%" id="aaaa">
							<tr>
								...
								<?php
							 $query = "select * from soil WHERE lab_no='$aa'  and `is_deleted`='0'";
...
$(document).ready(function(){ 
	...
	$('#chk_attr').change(function(){
		...
		{ 
			...
			if($('#grain3').val()!="" && $('#grain3').val()!=undefined) {
				var g_3 = $('#grain3').val();
				var temp = (+g_3);
			}
			else
			...
			if(temp >= 71 && temp <= 73)
			{
				var a1 = randomNumberFromRange(37,39).toFixed();
				var a3 = randomNumberFromRange(15,16).toFixed();
			}
			else if(temp >= 74 && temp <= 77)
			{
				var a1 = randomNumberFromRange(38,40).toFixed();
				var a3 = randomNumberFromRange(16,17).toFixed();
			}
			else if(temp >= 78 && temp <= 80)
			{
				var a1 = randomNumberFromRange(39,41).toFixed();
				var a3 = randomNumberFromRange(17,18).toFixed();
			}
			else if(temp >= 81 && temp <= 83)
			{
				var a1 = randomNumberFromRange(40,42).toFixed();
				var a3 = randomNumberFromRange(18,19).toFixed();
			}
			else if(temp >= 84 && temp <= 86)
			{
				var a1 = randomNumberFromRange(41,43).toFixed();
				var a3 = randomNumberFromRange(19,20).toFixed();
			}
			else if(temp >= 87 && temp <= 88)
			{
				var a1 = randomNumberFromRange(42,44).toFixed();
				var a3 = randomNumberFromRange(20,21).toFixed();
			}
			else if(temp >= 89 && temp <= 90)
			{
				var a1 = randomNumberFromRange(43,45).toFixed();
				var a3 = randomNumberFromRange(21,23).toFixed();
			}
			else 
			{
				var a1 = randomNumberFromRange(40,45).toFixed();
				var a3 = randomNumberFromRange(21,23).toFixed();
			}
			$('#a1').val(a1);
			$('#a3').val(a3);
	...
	$('#chk_cbr2').change(function(){
		...
		{ 
			...
			if(temp >= 71 && temp <= 73)
			{
				var cbr2 = randomNumberFromRange(2.9,3.1).toFixed(1);
				
			}
			else if(temp >= 74 && temp <= 77)
			{
				var cbr2 = randomNumberFromRange(2.8,3.0).toFixed(1);
			}
			else if(temp >= 78 && temp <= 80)
			{
				var cbr2 = randomNumberFromRange(2.7,2.9).toFixed(1);
			}
			else if(temp >= 81 && temp <= 83)
			{
				var cbr2 = randomNumberFromRange(2.6,2.8).toFixed(1);
			}
			else if(temp >= 84 && temp <= 86)
			{
				var cbr2 = randomNumberFromRange(2.5,2.7).toFixed(1);
			}
			else if(temp >= 87 && temp <= 88)
			{
				var cbr2 = randomNumberFromRange(2.4,2.8).toFixed(1);
			}
			else if(temp >= 89 && temp <= 90)
			{
				var cbr2 = randomNumberFromRange(2.4,2.6).toFixed(1);				
			}
			else
			{
				var cbr2 = randomNumberFromRange(2.6,3.0).toFixed(1);	
			}
	...
	$('#chk_hyd').change(function(){
        if(this.checked)
		{ $('#txthyd').css("background-color","var(--success)"); 
		  var g1 = randomNumberFromRange(0,3).toFixed();
		  $('#g1').val(g1);
		  var g_1 = $('#g1').val();
			if(g_1 == "0")
			{
				var g2 = randomNumberFromRange(10,15).toFixed();
			}
			else if(g_1 == "1")
			{
				var g2 = randomNumberFromRange(15,20).toFixed();
			}
			else if(g_1 == "2")
			{
				var g2 = randomNumberFromRange(16,24).toFixed();
			}
			else if(g_1 == "3")
			{
				var g2 = randomNumberFromRange(16,24).toFixed();
			...
			var temp = randomNumberFromRange(3,5).toFixed();
			var g3 = (+g_2) + (+temp);
			$('#g3').val(g3);
		    var g_3 = $('#g3').val();
			
			var g4 = (+100) - ((+g_1) + (+g_2) + (+g_3));
			$('#g4').val(g4);
		    var g_4 = $('#g4').val();
		...
		{
			 $('#txthyd').css("background-color","White"); 
			 $('#g1').val(null);
			 $('#g2').val(null);
			 $('#g3').val(null);
			 $('#g4').val(null);
	...
	$('#chk_grn').change(function(){
		...
		{ $('#txtgrn').css("background-color","var(--success)"); 
		  var grain1 = randomNumberFromRange(0,3).toFixed();
		  $('#grain1').val(grain1);
		  var grain_1 = $('#grain1').val();
			if(grain_1 == "0")
			{
				var grain2 = randomNumberFromRange(10,15).toFixed();
			}
			else if(grain_1 == "1")
			{
				var grain2 = randomNumberFromRange(15,20).toFixed();
			}
			else if(grain_1 == "2")
			{
				var grain2 = randomNumberFromRange(16,24).toFixed();
			}
			else if(grain_1 == "3")
			{
				var grain2 = randomNumberFromRange(16,24).toFixed();
			...
			$('#grain2').val(grain2);
		    var grain_2 = $('#grain2').val();
			
			
			
			var grain3 = (+100) - ((+grain_1) + (+grain_2));
			$('#grain3').val(grain3);
		    var grain_3 = $('#grain3').val();
		...
		else
		{
			 ...
			 $('#grain2').val(null);
			 $('#grain3').val(null);			 
			 $('#grain_grad_1').val(null);
			 $('#grain_grad_2').val(null);
			 $('#grain_grad_3').val(null);
			 $('#grain_grad_4').val(null);
			 $('#grain_grad_5').val(null);
			 $('#grain_grad_6').val(null);
	...
	$('#chk_heavy').change(function(){
		...
		{ 
			...
			if(temp >= 71 && temp <= 73)
			{
				var h1 = randomNumberFromRange(1.790,1.800).toFixed(3);
				var h2 = randomNumberFromRange(14.0,14.3).toFixed(1);
		
			}
			else if(temp >= 74 && temp <= 77)
			{
				var h1 = randomNumberFromRange(1.790,1.800).toFixed(3);
				var h2 = randomNumberFromRange(14.4,15.0).toFixed(1);
			}
			else if(temp >= 78 && temp <= 80)
			{
				var h1 = randomNumberFromRange(1.770,1.790).toFixed(3);
				var h2 = randomNumberFromRange(15.0,15.3).toFixed(1);
			}
			else if(temp >= 81 && temp <= 83)
			{
				var h1 = randomNumberFromRange(1.760,1.790).toFixed(3);
				var h2 = randomNumberFromRange(15.4,15.6).toFixed(1);
			}
			else if(temp >= 84 && temp <= 86)
			{
				var h1 = randomNumberFromRange(1.750,1.770).toFixed(3);
				var h2 = randomNumberFromRange(15.7,15.9).toFixed(1);
			}
			else if(temp >= 87 && temp <= 88)
			{
				var h1 = randomNumberFromRange(1.740,1.760).toFixed(3);
				var h2 = randomNumberFromRange(16.0,16.2).toFixed(1);
			}
			else if(temp >= 89 && temp <= 90)
			{
				var h1 = randomNumberFromRange(1.740,1.760).toFixed(3);
				var h2 = randomNumberFromRange(16.0,16.3).toFixed(1);
			}
			else
			{
				var h1 = randomNumberFromRange(1.740,1.790).toFixed(3);
				var h2 = randomNumberFromRange(14.5,17.5).toFixed(1);
			}
			$('#h1').val(h1);
			$('#h2').val(h2);
		}
...
function getGlazedTiles(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo $base_url; ?>save_soil.php',
...
function saveMetal(type,id){
    ...
    if (type == 'add') {
				...
				for(var i=0;i<aa.length;i++)
				{
					if(aa[i]=="hyd")
					{
						if(document.getElementById('chk_hyd').checked) {
							var chk_hyd = "1";
						}
						else{
							var chk_hyd = "0";
				...
				for(var i=0;i<aa.length;i++)
				{
					if(aa[i]=="grn")
					{
						...
						var grain1 = $('#grain1').val();
						var grain2 = $('#grain2').val();
						var grain3 = $('#grain3').val();						
						var grain_grad_1 = $('#grain_grad_1').val();
						var grain_grad_2 = $('#grain_grad_2').val();
						var grain_grad_3 = $('#grain_grad_3').val();
						var grain_grad_4 = $('#grain_grad_4').val();
						var grain_grad_5 = $('#grain_grad_5').val();
						var grain_grad_6 = $('#grain_grad_6').val();
				...
				billData = $("#Glazed").find('.form').serialize()+'&action_type='+type+'&idEdit='+idEdit+'&report_no='+report_no+'&job_no='+job_no+'&lab_no='+lab_no+'&chk_grn='+chk_grn+'&g1='+g1+'&g2='+g2+'&g3='+g3+'&g4='+g4+'&chk_attr='+chk_attr+'&a1='+a1+'&a2='+a2+'&a3='+a3+'&chk_shrink='+chk_shrink+'&s1='+s1+'&chk_swell='+chk_swell+'&f1='+f1+'&chk_class='+chk_class+'&so1='+so1+'&chk_light='+chk_light+'&l1='+l1+'&l2='+l2+'&chk_heavy='+chk_heavy+'&h1='+h1+'&h2='+h2+'&chk_sp='+chk_sp+'&sp1='+sp1+'&chk_duu='+chk_duu+'&d1='+d1+'&d2='+d2+'&chk_con='+chk_con+'&c1='+c1+'&c2='+c2+'&chk_cbr1='+chk_cbr1+'&cbr1='+cbr1+'&chk_cbr2='+chk_cbr2+'&cbr2='+cbr2+'&chk_uu='+chk_uu+'&t1='+t1+'&t2='+t2+'&chk_den='+chk_den+'&r1='+r1+'&chk_ucs='+chk_ucs+'&u1='+u1+'&chk_press='+chk_press+'&sw1='+sw1+'&ulr='+ulr+'&grd_1='+grd_1+'&grd_2='+grd_2+'&grd_3='+grd_3+'&grd_4='+grd_4+'&grd_5='+grd_5+'&grd_6='+grd_6+'&chk_hyd='+chk_hyd+'&grain1='+grain1+'&grain2='+grain2+'&grain3='+grain3+'&grain_grad_1='+grain_grad_1+'&grain_grad_2='+grain_grad_2+'&grain_grad_3='+grain_grad_3+'&grain_grad_4='+grain_grad_4+'&grain_grad_5='+grain_grad_5+'&grain_grad_6='+grain_grad_6+'&tag_heading='+tag_heading+'&tag_data='+tag_data;
    }
	else{
				var report_no = $('#report_no').val(); 
				var job_no = $('#job_no').val(); 
            ...
            $('#tag_data').val(data.tag_data);
			 ...
			 var temp = $('#test_list').val();
				...
				for(var i=0;i<aa.length;i++)
				{
					if(aa[i]=="hyd")
					{
						var chk_hyd = data.chk_hyd;
						if(chk_hyd=="1")
						{
						   $('#txthyd').css("background-color","var(--success)");			
						   $("#chk_hyd").prop("checked", true); 
				...
				for(var i=0;i<aa.length;i++)
				{
					if(aa[i]=="grn")
					{
						...
						else
						{
							...
							$('#grain1').val(data.grain1);
							$('#grain2').val(data.grain2);
							$('#grain3').val(data.grain3);							
							$('#grain_grad_1').val(data.grain_grad_1);
							$('#grain_grad_2').val(data.grain_grad_2);
							$('#grain_grad_3').val(data.grain_grad_3);
							$('#grain_grad_4').val(data.grain_grad_4);
							$('#grain_grad_5').val(data.grain_grad_5);
							$('#grain_grad_6').val(data.grain_grad_6);
						break;
					}					
					else
					{
