...
if($_SESSION['name']=="")
{
	...
	<?php
		...
		if($agency != 0 && $from_date!= "" && $to_date!= "" && $clientname!=0){
			$where="where `date` >= '$new_from_date' AND `date` <='$new_to_date' AND `agency`='$agency' AND `client_code`='$clientname' and send_to_second_reception ='0'";
		}
		else if($from_date !== "" && $to_date !== "" && $agency != 0){
			$where="where `date` >= '$new_from_date' AND `date` <='$new_to_date' AND `agency`='$agency' and send_to_second_reception ='0'";
		}
		else if($from_date!= "" && $to_date!= "" && $clientname!=0){
			$where="where `date` >= '$new_from_date' AND `date` <='$new_to_date' AND `client_code`='$clientname' and send_to_second_reception ='0'";
		}
		else if($agency != 0  && $to_date!= "" && $clientname!=0){
			$where="where  `date` <='$new_to_date' AND `agency`='$agency' AND `client_code`='$clientname' and send_to_second_reception ='0'";
		}
		else if($agency != 0 && $to_date!= "" && $clientname!=0){
			$where=" `date` >= '$new_from_date'  AND `agency`='$agency' AND `client_code`='$clientname' and send_to_second_reception ='0'";
		}
		else if($from_date !== "" && $to_date !== "" ){
			$where="where `date` >= '$new_from_date' AND `date` <='$new_to_date' and send_to_second_reception ='0'";
		}
		else if($from_date !== "" && $to_date !== "" && $agency != 0){
			$where="where `date` >= '$new_from_date'  AND `agency`='$agency' and send_to_second_reception ='0'";
		}
		else if($from_date!= "" && $clientname!=0){
			$where="where `date` >= '$new_from_date' AND `client_code`='$clientname' and send_to_second_reception ='0'";
		}
		else if($to_date !== "" && $agency != 0){
			$where="where `date` <='$new_to_date' AND `agency`='$agency' and send_to_second_reception ='0'";
		}
		else if($to_date!= "" && $clientname!=0){
			$where="where `date` <='$new_to_date' AND `client_code`='$clientname' and send_to_second_reception ='0'";
		}
		else if($agency != 0 && $clientname!=0){
			$where="where `agency`='$agency' AND `client_code`='$clientname' and send_to_second_reception ='0'";
		}
		else if($from_date !== "" ){
			$where="where `date` >= '$new_from_date' and send_to_second_reception ='0'";
		}
		else if($to_date !== "" ){
			$where="where `date` <='$new_to_date' and send_to_second_reception ='0'";
		}
		else if($agency != 0){
			$where="where `agency`='$agency' and send_to_second_reception ='0'";
		}
		else if($clientname!=0){
			$where="where `client_code`='$clientname' and send_to_second_reception ='0'";
		}
		else{
			$where="where send_to_second_reception ='0'";
		}
