			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">SDBC - 2 (MIX MATERIAL)</h2>
					</div>
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM sdbc_2_mix_material WHERE `is_deleted`='0' and lab_no='$lab_no'";
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from sdbc_2_mix_material WHERE lab_no='$aa'  and `is_deleted`='0'";
...
$('.amend_date').datepicker({
	...
	$(document).ready(function() {
		...
		function grd_auto() {
			...
			var pass_sample_3 = randomNumberFromRange(36.00, 50.00).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(25.00, 35.00).toFixed(2);
			var pass_sample_5 = randomNumberFromRange(16.00, 24.00).toFixed(2);
			var pass_sample_6 = randomNumberFromRange(10.00, 15.00).toFixed(2);
			var pass_sample_7 = randomNumberFromRange(4.00, 7.00).toFixed(2);
