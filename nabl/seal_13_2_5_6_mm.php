			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">13.2 - 5.6 MM</h2>
					</div>
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">2.8</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM seal_13_2_5_6_mm WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_seal_13_2_5_6_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=seal_13_2_5_6_mm" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from seal_13_2_5_6_mm WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		function abr_auto() {
			...
			if (abr_grading == "A") {
				...
				var abr_index = randomNumberFromRange(18.5, 23.1);
				$('#abr_index').val(abr_index.toFixed(1));
				var abrindex = $('#abr_index').val();
				var tt = randomNumberFromRange(-0.99, 0.99).toFixed(2);
				var r = randomNumberFromRange(0, 9).toFixed();
		...
		function sou_auto() {
			...
			$('#s60').val(s6total.toFixed(2));
			var s_60 = $('#s60').val();




			var s_temp1 = (+s_60) * 100;
			var s_30 = $('#s30').val();
			var s50 = (+s_temp1) / (+s_30);
			$('#s50').val(s50.toFixed(1));
			var s_50 = $('#s50').val();

			var stemp1 = (+s_30) * (+s_50);

			var s6_0 = (+stemp1) / 100;

			$('#s60').val(s6_0.toFixed(2));
			$('#s6total').val(s6_0.toFixed(2));
			$('#soundness').val(s6_0.toFixed(1));
		}
		//SOUNDNESS	
		...
		$('#s60').change(function() {
			...
			if ($("#chk_sou").is(':checked')) {
				...
				var s_60 = $('#s60').val();
				var ans = (+s_60);
				$('#s6total').val(ans.toFixed(2));
				$('#soundness').val(ans.toFixed(1));
				/* $('#s61').val(soundness); */
				...
				var s58 = (+s_temp1) / (+s_30);

				$('#s50').val(s58.toFixed(1));
		...
		$('#s50,#s30').change(function() {
			$('#txtsou').css("background-color", "var(--success)");
			var s_30 = $('#s30').val();
			var s_50 = $('#s50').val();
			var s_temp1 = (+s_30) * (+s_50);

			var s60 = (+s_temp1) / 100;
			$('#s60').val(s60.toFixed(2));
			$('#s6total').val(s60.toFixed(2));
			$('#soundness').val(s60.toFixed(1));
		...
		function general_flk_elo1() {
			...
			var suma = randomNumberFromRange(3700, 4500).toFixed();
			$('#suma').val(suma);
			var sum_a = $('#suma').val();
		...
		function grd_auto() {
			...
			var pass_sample_2 = randomNumberFromRange(89.10, 92.00).toFixed(2);
			var pass_sample_3 = randomNumberFromRange(73.01, 77.00).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(63.25, 66.50).toFixed(2);
			var pass_sample_5 = randomNumberFromRange(47.25, 52.00).toFixed(2);
			var pass_sample_6 = randomNumberFromRange(36.00, 42.00).toFixed(2);
			var pass_sample_7 = randomNumberFromRange(26.25, 34.00).toFixed(2);
			var pass_sample_8 = randomNumberFromRange(17.00, 24.00).toFixed(2);
			var pass_sample_9 = randomNumberFromRange(8.00, 13.00).toFixed(2);
			var pass_sample_10 = randomNumberFromRange(3.00, 7.00).toFixed(2);
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_seal_13_2_5_6_mm.php',
