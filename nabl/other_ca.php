			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">COARSE AGGREGATE</h2>
					</div>
						...
						<form class="form" id="Glazed" method="post">
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										<div class="col-sm-2">
											<label for="inputEmail3" class="col-sm-2 control-label">SAMPLE DESCRIPTION :</label>

										</div>

										<div class="col-sm-10">
											<input type="text" class="form-control inputs" tabindex="4" id="sample_de" value="<?php echo $sample_de; ?>" name="sample_de">
										</div>
									</div>
								</div>
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="sieve_1" name="sieve_1">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="sieve_2" name="sieve_2">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="sieve_3" name="sieve_3">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="sieve_4" name="sieve_4">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="sieve_5" name="sieve_5">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="sieve_6" name="sieve_6">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="sieve_7" name="sieve_7">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="sieve_8" name="sieve_8">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="sieve_9" name="sieve_9">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="sieve_10" name="sieve_10">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="sieve_11" name="sieve_11">
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM general_ca WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/other_print.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_general.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=general_ca" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from general_ca WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		function abr_auto() {
			...
			if (abr_grading == "A") {
				...
				var abr_index = randomNumberFromRange(17.0, 22.0);
		...
		function sp_auto() {
			...
			var sp_specificgravity = randomNumberFromRange(2.750, 2.810).toFixed(3); //(sp_specific_gravity)
			...
			var sp_waterabr = randomNumberFromRange(1.10, 1.20).toFixed(2); // (sp_water_abr)_1
		...
		$("#sp_w_sur_1").change(function() {
			...
			var sp_specific_gravity1 = (+sp_w_s_1) / ((+sp_wt_st_1) - (+sp_w_sur_1));
			$('#sp_specific_gravity_1').val(sp_specific_gravity1.toFixed(3));
			var sp_specific_gravity_1 = $('#sp_specific_gravity_1').val();
			var sp_specific_gravity_2 = $('#sp_specific_gravity_2').val();
			...
			var sp_water_abr1 = (100 * ((+sp_wt_st_1) - (+sp_w_s_1))) / (+sp_w_s_1);
			$('#sp_water_abr_1').val(sp_water_abr1.toFixed(2));
			var sp_water_abr_1 = $('#sp_water_abr_1').val();
			var sp_water_abr_2 = $('#sp_water_abr_2').val();
		...
		function imp_auto() {
			...
			var imp_value4 = randomNumberFromRange(12.00, 18.00);
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_other.php',
		...
		if (type == 'add') {
			...
			for (var i = 0; i < aa.length; i++) {
				if (aa[i] == "grd") {
					...
					var sieve_1 = $('#sieve_1').val();
					var sieve_2 = $('#sieve_2').val();
					var sieve_3 = $('#sieve_3').val();
					var sieve_4 = $('#sieve_4').val();
					var sieve_5 = $('#sieve_5').val();
					var sieve_6 = $('#sieve_6').val();
					var sieve_7 = $('#sieve_7').val();
					var sieve_8 = $('#sieve_8').val();
					var sieve_9 = $('#sieve_9').val();
					var sieve_10 = $('#sieve_10').val();
					var sieve_11 = $('#sieve_11').val();
			...
			success: function(data) {
				...
				for (var i = 0; i < aa.length; i++) {
					if (aa[i] == "grd") {
						...
						$('#sieve_1').val(data.sieve_1);
						$('#sieve_2').val(data.sieve_2);
						$('#sieve_3').val(data.sieve_3);
						$('#sieve_4').val(data.sieve_4);
						$('#sieve_5').val(data.sieve_5);
						$('#sieve_6').val(data.sieve_6);
						$('#sieve_7').val(data.sieve_7);
						$('#sieve_8').val(data.sieve_8);
						$('#sieve_9').val(data.sieve_9);
						$('#sieve_10').val(data.sieve_10);
						$('#sieve_11').val(data.sieve_11);
