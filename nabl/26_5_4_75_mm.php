			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">GSB-2 (26.5 - 4.75 MM)</h2>
					</div>
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">9.50</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="bb1" name="bb1" readOnly>
																	</div>
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="bb2" name="bb2" readOnly>
																	</div>
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="bb3" name="bb3" readOnly>
																	</div>
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="bb4" name="bb4" readOnly>
																	</div>
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="bb5" name="bb5" readOnly>
																	</div>
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="c6" name="c6" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="d6" name="d6" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="e6" name="e6" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="bb6" name="bb6" readOnly>
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="dd6" name="dd6" readOnly>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="c7" name="c7" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="d7" name="d7" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="e7" name="e7" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="bb7" name="bb7" readOnly>
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="dd7" name="dd7" readOnly>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="c8" name="c8" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="d8" name="d8" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="e8" name="e8" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="bb8" name="bb8" readOnly>
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="dd8" name="dd8" readOnly>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="c9" name="c9" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="d9" name="d9" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="e9" name="e9" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="bb9" name="bb9" readOnly>
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="dd9" name="dd9" readOnly>
																	</div>
																</div>
															</div>
														</div>
												...
												<div id="collapse6" class="panel-collapse collapse">
													<div class="panel-body">
														...
														<div class="row">
															<div class="col-lg-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">SAMPLE</label>
																</div>
															</div>

															<div class="col-lg-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">SIZE OF AGG.</label>
																</div>
															</div>
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<label for="inputEmail3" class="col-sm-8 control-label">Wt. of Sample Taken, g</label>
																	<input type="checkbox" name="chk_wp" id="chk_wp" value="chk_wp">
																</div>
															</div>

															<div class="col-lg-5">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">WEIGHT OF SAMPLE</label>
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<label for="inputEmail3" class="col-sm-8 control-label">After 1<sup>st</sup> cycle, g</label>
																	<input type="checkbox" name="chk_a" id="chk_a" value="chk_a">
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<label for="inputEmail3" class="col-sm-8 control-label">After 2<sup>nd</sup> cycle, g</label>
																	<input type="checkbox" name="chk_b" id="chk_b" value="chk_b">
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<label for="inputEmail3" class="col-sm-8 control-label">After 3<sup>rd</sup> cycle, g</label>
																	<input type="checkbox" name="chk_c" id="chk_c" value="chk_c">
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<label for="inputEmail3" class="col-sm-8 control-label">After 4<sup>th</sup> cycle, g</label>
																	<input type="checkbox" name="chk_d" id="chk_d" value="chk_d">
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<label for="inputEmail3" class="col-sm-8 control-label">After 5<sup>th</sup> cycle, g</label>
																	<input type="checkbox" name="chk_e" id="chk_e" value="chk_e">
																</div>
															</div>
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="gd1" name="gd1">
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="ge1" name="ge1">
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="gd2" name="gd2">
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="ge2" name="ge2">
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="gdsum" name="gdsum" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="gesum" name="gesum" readOnly>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<b>Weight of mould with soil after compaction </b>
																	</div>
																</div>
															</div>
															<div class="col-lg-1">
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM gsb_26_5_4_75_mm WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_gsb2_26_5_4_75_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_gsb2_26_5_4_75_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from gsb_26_5_4_75_mm WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		$('#chk_abr').change(function() {
			if (this.checked) {
				...
				if (abr_grading == "A") {
					...
					$('#abr_sample_abr').val('26.5 - 4.75 MM');
		...
		$("#abr_wt_t_a_2").change(function() {
			...
			$('#abr_sample_abr').val('26.5 - 4.75 MM MM');
		...
		$('#chk_sp').change(function() {
			if (this.checked) {
				...
				$('#sp_temp').val(sp_temp.toString().substring(0, sp_temp.toString().indexOf(".") + 3));
				...
				//1     	
				var sp_w_b_a2_1 = randomNumberFromRange(822.00, 828.00);
				var sp_w_s_1 = randomNumberFromRange(1850.00, 1950.00);
				...
				//2nd TRAIL
				var sp_w_b_a2_2 = randomNumberFromRange(822.00, 828.00);
				var sp_w_s_2 = randomNumberFromRange(1850.00, 1950.00);
		...
		function sound() {
			sound_sample = "26.5 - 4.75 MM";
			sample_id = "26.5 - 4.75 MM";
			...
			ga1 = randomNumberFromRange(326.00, 328.00);
			ga2 = randomNumberFromRange(661.00, 664.00);
			gasum = parseFloat(ga1) + parseFloat(ga2);
			gb1 = randomNumberFromRange(321.00, 326.00);
			gb2 = randomNumberFromRange(656.00, 659.00);
			gbsum = parseFloat(gb1) + parseFloat(gb2);
			gc1 = randomNumberFromRange(316.00, 329.00);
			gc2 = randomNumberFromRange(649.00, 651.00);
			gcsum = parseFloat(gc1) + parseFloat(gc2);
			gd1 = randomNumberFromRange(313.00, 320.00);
			gd2 = randomNumberFromRange(642.00, 648.00);
			gdsum = parseFloat(gd1) + parseFloat(gd2);
			ge1 = randomNumberFromRange(311.00, 313.00);
			ge2 = randomNumberFromRange(634.00, 640.00);
			gesum = parseFloat(ge1) + parseFloat(ge2);
			s1 = (((parseFloat(w1) - parseFloat(ge1)) * 100) / parseFloat(w1));
			s2 = (((parseFloat(w2) - parseFloat(ge2)) * 100) / parseFloat(w2));

			var soundness = (((parseFloat(wsum) - parseFloat(gesum)) * 100) / parseFloat(wsum));
			...
			$('#ga1').val(ga1.toString().substring(0, ga1.toString().indexOf(".") + 3));
			$('#ga2').val(ga2.toString().substring(0, ga2.toString().indexOf(".") + 3));
			$('#gasum').val(gasum.toString().substring(0, gasum.toString().indexOf(".") + 3));

			$('#gb1').val(gb1.toString().substring(0, gb1.toString().indexOf(".") + 3));
			$('#gb2').val(gb2.toString().substring(0, gb2.toString().indexOf(".") + 3));
			$('#gbsum').val(gbsum.toString().substring(0, gbsum.toString().indexOf(".") + 3));

			$('#gc1').val(gc1.toString().substring(0, gc1.toString().indexOf(".") + 3));
			$('#gc2').val(gc2.toString().substring(0, gc2.toString().indexOf(".") + 3));
			$('#gcsum').val(gcsum.toString().substring(0, gcsum.toString().indexOf(".") + 3));


			$('#gd1').val(gd1.toString().substring(0, gd1.toString().indexOf(".") + 3));
			$('#gd2').val(gd2.toString().substring(0, gd2.toString().indexOf(".") + 3));
			$('#gdsum').val(gdsum.toString().substring(0, gdsum.toString().indexOf(".") + 3));

			$('#ge1').val(ge1.toString().substring(0, ge1.toString().indexOf(".") + 3));
			$('#ge2').val(ge2.toString().substring(0, ge2.toString().indexOf(".") + 3));
			$('#gesum').val(gesum.toString().substring(0, gesum.toString().indexOf(".") + 3));

			$('#s1').val(s1.toString().substring(0, s1.toString().indexOf(".") + 3));
			$('#s2').val(s2.toString().substring(0, s2.toString().indexOf(".") + 3));
		}
		...
		function chk_a_func() {
			...
			ga2 = randomNumberFromRange(661.00, 664.00);
			gasum = parseFloat(ga1) + parseFloat(ga2);
			gb1 = 0; //randomNumberFromRange(321.00, 326.00);
			gb2 = 0; //randomNumberFromRange(656.00, 659.00);
			gbsum = 0; //parseFloat(gb1)+parseFloat(gb2);
			gc1 = 0; //randomNumberFromRange(316.00, 329.00);
			gc2 = 0; //randomNumberFromRange(649.00, 651.00);
			gcsum = 0; //parseFloat(gc1)+parseFloat(gc2);
			gd1 = 0; //randomNumberFromRange(313.00, 320.00);
			gd2 = 0; //randomNumberFromRange(642.00, 648.00);
			gdsum = 0; //parseFloat(gd1)+parseFloat(gd2);
			ge1 = 0; //randomNumberFromRange(311.00, 313.00);
			ge2 = 0; //randomNumberFromRange(634.00, 640.00);
			gesum = 0; //parseFloat(ge1)+parseFloat(ge2);
			s1 = (((parseFloat(w1) - parseFloat(ga1)) * 100) / parseFloat(w1));
			s2 = (((parseFloat(w2) - parseFloat(ga2)) * 100) / parseFloat(w2));

			var soundness = (((parseFloat(wsum) - parseFloat(gasum)) * 100) / parseFloat(wsum));
		...
		function chk_b_func() {
			...
			ge2 = 0; //randomNumberFromRange(634.00, 640.00);
			gesum = 0; //parseFloat(ge1)+parseFloat(ge2);
			s1 = (((parseFloat(w1) - parseFloat(gb1)) * 100) / parseFloat(w1));
			s2 = (((parseFloat(w2) - parseFloat(gb2)) * 100) / parseFloat(w2));

			var soundness = (((parseFloat(wsum) - parseFloat(gbsum)) * 100) / parseFloat(wsum));
			$('#soundness').val(soundness.toString().substring(0, soundness.toString().indexOf(".") + 3));
			$('#w1').val(w1);
			$('#w2').val(w2);
			$('#wsum').val(wsum);
		...
		function chk_c_func() {
			...
			ge2 = 0; //randomNumberFromRange(634.00, 640.00);
			gesum = 0; //parseFloat(ge1)+parseFloat(ge2);
			s1 = (((parseFloat(w1) - parseFloat(gc1)) * 100) / parseFloat(w1));
			s2 = (((parseFloat(w2) - parseFloat(gc2)) * 100) / parseFloat(w2));

			var soundness = (((parseFloat(wsum) - parseFloat(gcsum)) * 100) / parseFloat(wsum));
			$('#soundness').val(soundness.toString().substring(0, soundness.toString().indexOf(".") + 3));
			$('#w1').val(w1);
			$('#w2').val(w2);
			$('#wsum').val(wsum);
		...
		function chk_d_func() {
			...
			ge2 = 0; //randomNumberFromRange(634.00, 640.00);
			gesum = 0; //parseFloat(ge1)+parseFloat(ge2);
			s1 = (((parseFloat(w1) - parseFloat(gd1)) * 100) / parseFloat(w1));
			s2 = (((parseFloat(w2) - parseFloat(gd2)) * 100) / parseFloat(w2));

			var soundness = (((parseFloat(wsum) - parseFloat(gdsum)) * 100) / parseFloat(wsum));
		...
		function soundness_data() {
			...
			if ($("#chk_e").is(':checked')) {
				...
				var temp1 = ((parseFloat(wsum) * parseFloat(soundness)) / 100);
				gesum = parseFloat(wsum) - parseFloat(temp1);
				ge1 = randomNumberFromRange(311.00, 313.00);
				ge2 = parseFloat(gesum) - parseFloat(ge1);
				...
				var soundness = $('#soundness').val();
				var temp1 = ((parseFloat(wsum) * parseFloat(soundness)) / 100);
				gdsum = parseFloat(wsum) - parseFloat(temp1);
				gd1 = randomNumberFromRange(313.00, 320.00);
				gd2 = parseFloat(gdsum) - parseFloat(gd1);
				gdsum = parseFloat(gd1) + parseFloat(gd2);
				...
				var soundness = $('#soundness').val();
				var temp1 = ((parseFloat(wsum) * parseFloat(soundness)) / 100);
				gcsum = parseFloat(wsum) - parseFloat(temp1);
				gc1 = randomNumberFromRange(316.00, 329.00);
				gc2 = parseFloat(gcsum) - parseFloat(gc1);
				gcsum = parseFloat(gc1) + parseFloat(gc2);
				...
				var soundness = $('#soundness').val();
				var temp1 = ((parseFloat(wsum) * parseFloat(soundness)) / 100);
				gbsum = parseFloat(wsum) - parseFloat(temp1);
				gb1 = randomNumberFromRange(321.00, 326.00);
				gb2 = parseFloat(gbsum) - parseFloat(gb1);
				gbsum = parseFloat(gb1) + parseFloat(gb2);
				...
				var soundness = $('#soundness').val();
				var temp1 = ((parseFloat(wsum) * parseFloat(soundness)) / 100);
				gasum = parseFloat(wsum) - parseFloat(temp1);
				ga1 = randomNumberFromRange(326.00, 328.00);
				ga2 = parseFloat(gasum) - parseFloat(ga1);
				gasum = parseFloat(ga1) + parseFloat(ga2);
		...
		$('#chk_flk').change(function() {
			if (this.checked) {
				...
				$("#a6").attr("disabled", false);
				$("#a7").attr("disabled", false);
				$("#a8").attr("disabled", false);
				...
				$('#d6').attr("disabled", false);
				$('#d7').attr("disabled", false);
				$('#d8').attr("disabled", false);
				...
				$('#e5').attr("disabled", false);
				$('#e6').attr("disabled", false);
				$('#e7').attr("disabled", false);
				$('#e8').attr("disabled", false);
				...
				$('#aa8').val(null);
				$('#aa9').val(null);
				$('#aa1').attr("disabled", false);
				$('#aa2').attr("disabled", false);
				$('#aa3').attr("disabled", false);
				$('#aa4').attr("disabled", false);
				$('#aa5').attr("disabled", false);
				$('#aa6').attr("disabled", false);
				$('#aa7').attr("disabled", false);
				$('#aa8').attr("disabled", false);
				...
				$('#bb5').attr("disabled", false);
				$('#bb6').attr("disabled", false);
				$('#bb7').attr("disabled", false);
				$('#bb8').attr("disabled", false);
				...
				$('#dd8').val(null);
				$('#dd9').val(null);
				$('#dd1').attr("disabled", false);
				$('#dd2').attr("disabled", false);
				$('#dd3').attr("disabled", false);
				$('#dd4').attr("disabled", false);
				$('#dd5').attr("disabled", false);
				$('#dd6').attr("disabled", false);
				$('#dd7').attr("disabled", false);
				$('#dd8').attr("disabled", false);
			}
		...
		function a_b() {
			...
			e9 = 0; //(parseFloat(c9)*parseFloat(d9))/100;
			...
			dd9 = 0; //(parseFloat(bb9)*parseFloat(d9))/100;
		...
		$('#chk_impact').change(function() {
			if (this.checked) {
				...
				var imp_value = randomNumberFromRange(10.0, 20.0);
				...
				var imp_w_m_a_1 = randomNumberFromRange(347.0, 350.0);
				...
				/*var imp_value1 = randomNumberFromRange(10.0,20.0);*/
				/*var sp = imp_value1.toString().split('.');
				var mdata =parseInt(sp[1].substr(0,1));
				var impvalue = sp[0]+"."+mdata;
				var imp_value = parseFloat(impvalue);*/
				//alert("imp_value="+imp_value);
				/*	var r =  parseFloat(randomNumberFromRange(-0.3,0.3)).toFixed(1);
					//alert("r="+r);
					var imp_value_1 = parseFloat(imp_value +  parseFloat(r)).toFixed(1);
					//alert("imp_value_1="+imp_value_1);
					//var tems = parseFloat(imp_value * 2);
					//alert("temp="+tems);
					var imp_value_2 = parseFloat(imp_value - parseFloat(r)).toFixed(1);
					$('#imp_value').val(imp_value);
					$('#imp_value_1').val(imp_value_1);
					$('#imp_value_2').val(imp_value_2);
					
					var imp_w_m_a_1 = parseFloat(randomNumberFromRange(347.0,350.0)).toFixed(1);
					var imp_w_m_a_2 = imp_w_m_a_1;
					
					var imp_w_m_d_1 = parseFloat(randomNumberFromRange(0.3,0.8)).toFixed(1);
					var imp_w_m_d_2 = parseFloat(randomNumberFromRange(0.3,0.8)).toFixed(1);

					//alert("i=>"+parseFloat(imp_value_1));
					//alert("a=>"+parseFloat(imp_w_m_a_1));
					var cc1 = (imp_value_1 *  imp_w_m_a_1)/100;
					var cc2 = (imp_value_2 *  imp_w_m_a_2)/100;
					var cc_1 = cc1.toString().split('.');
					var cc_2 = cc2.toString().split('.');
					var cc11 =parseInt(cc_1[1].substr(0,1));
					var cc22 =parseInt(cc_2[1].substr(0,1));
					var imp_w_m_c_1 = cc_1[0]+"."+cc11;
					var imp_w_m_c_2 = cc_2[0]+"."+cc22;
				...
				/*$('#imp_w_m_a_1').val(imp_w_m_a_1);
				$('#imp_w_m_a_2').val(imp_w_m_a_2);
				$('#imp_w_m_b_1').val(imp_w_m_b_1.toFixed(1));
				$('#imp_w_m_b_2').val(imp_w_m_b_2.toFixed(1));
				$('#imp_w_m_c_1').val(imp_w_m_c_1);
				$('#imp_w_m_c_2').val(imp_w_m_c_2);			
				$('#imp_w_m_d_1').val(imp_w_m_d_1);
				$('#imp_w_m_d_2').val(imp_w_m_d_2);	*/

				//alert("imp_value_2="+imp_value_2);

				/*var imp_value = parseFloat(randomNumberFromRange(10.0,20.0)).toFixed(2);
			var r =  parseFloat(randomNumberFromRange(-0.3,0.3)).toFixed(2);
			var imp_value_1 = (parseFloat(imp_value) +  parseFloat(r)).toFixed(2);//G1
			var tems = parseFloat(parseFloat(imp_value) * 2).toFixed(2);
			var imp_value_2 = (parseFloat(tems)-parseFloat(imp_value_1)).toFixed(2);	
			...
			var imp_w_m_a_1 = parseFloat(randomNumberFromRange(347.0,350.0)).toFixed(2);
			var imp_w_m_a_2 = imp_w_m_a_1;
			
	//		alert(imp_w_m_a_1);
//			alert(imp_w_m_a_2);
			
			var imp_w_m_d_1 = parseFloat(randomNumberFromRange(0.3,0.8)).toFixed(2);
			var imp_w_m_d_2 = parseFloat(randomNumberFromRange(0.3,0.8)).toFixed(2);
			
			
			//alert(imp_w_m_d_1);
			//alert(imp_w_m_d_1);

			var imp_w_m_c_1 = parseFloat((parseFloat(imp_value_1) *  parseFloat(imp_w_m_a_1))/100).toFixed(2);
			var imp_w_m_c_2 = parseFloat((parseFloat(imp_value_2) *  parseFloat(imp_w_m_a_2))/100).toFixed(2);
		...
		$('#chk_crushing').change(function() {
			if (this.checked) {
				...
				//CRUSHING VALUE
				cr_sample_crush = "26.5 - 4.75 MM";
				cru_value = randomNumberFromRange(15.00, 20.00);
				...
				cr_a_1 = parseFloat(randomNumberFromRange(2880, 2885));
		...
		$('#chk_den').change(function() {
			if (this.checked) {
				...
				var bdl = randomNumberFromRange(1.47, 1.56);
				var bdc = randomNumberFromRange(1.59, 1.65);
		...
		$('#chk_grd').change(function() {
			if (this.checked) {
				...
				var pass_sample_3 = randomNumberFromRange(81.00, 89.00);
				var pass_sample_4 = randomNumberFromRange(71.00, 79.00);
				var pass_sample_5 = randomNumberFromRange(51.00, 59.00);
				var pass_sample_6 = randomNumberFromRange(0.00, 0.00);
				...
				var cum_wt_gm_6 = parseFloat(ret_wt_gm_6) - parseFloat(ret_wt_gm_5);


				//(SUM OF CUM. WAIGHT)
				var blank_extra = parseFloat(cum_wt_gm_1) + parseFloat(cum_wt_gm_2) + parseFloat(cum_wt_gm_3) + parseFloat(cum_wt_gm_4) + parseFloat(cum_wt_gm_5) + parseFloat(cum_wt_gm_6);
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save26_5_4_75.php',
	...
	function editData(id) {
		...
		$.ajax({
			...
			success: function(data) {
				...
				//LIQUIDE LIMIT AND PLASTICITY VALUE
				for (var i = 0; i < aa.length; i++) {
					if (aa[i] == "lll") { //LIQUIDE LIMIT AND PLASTICITY VALUE
						for (var i = 0; i < aa.length; i++) {
							if (aa[i] == "lll") { //ll and pl
