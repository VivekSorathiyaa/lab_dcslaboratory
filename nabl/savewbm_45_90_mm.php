...
if(isset($_POST['action_type']) && !empty($_POST['action_type']))
	{
		...
		{
			$get_query = "select * from wbm_90_45_mm WHERE id='$_POST[id]' AND `is_deleted`='0'"; 
...
$den_voids1 = $_POST['den_voids1'];
											...
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													<tr>
														...
														<?php
													 $query = "select * from wbm_90_45_mm WHERE lab_no='$lab_no' and `is_deleted`='0'";
		...
		$update= "update `wbm_90_45_mm` SET `job_no`='$_POST[job_no]',`lab_no`='$_POST[lab_no]',`report_no`='$_POST[report_no]',
		`ulr`='$_POST[ulr]',
		`chk_grd`='$_POST[chk_grd]',
      `sieve_1`='$_POST[sieve_1]',
      `sieve_2`='$_POST[sieve_2]',
...
`den_voids1`='$_POST[den_voids1]',
	...
	elseif($_POST['action_type'] == 'delete'){
		 ...
		 $delete="update wbm_90_45_mm SET `is_deleted`='1',`deleted_by`='$_SESSION[name]' WHERE `report_no`='$_POST[report_no]' and `lab_no`='$_POST[lab_no]' and `job_no`='$_POST[job_no]'";
	...
	elseif($_POST['action_type'] == 'chk'){
		...
		$qry = "SELECT * FROM wbm_90_45_mm WHERE `id`='$_POST[id]'";
		$arr = mysqli_query($conn,$qry);
		$rows1=mysqli_num_rows($arr);
		while($r2 = mysqli_fetch_array($arr)){
				if($r2['checked_by']!="")
				{
					$c1c="update wbm_90_45_mm SET `checked_by`='' WHERE `id`='$_POST[id]'";			
					$result_of_delete1=mysqli_query($conn,$cc);	
				}
				else
				{
					$cc="update wbm_90_45_mm SET `checked_by`='$_SESSION[name]' WHERE `id`='$_POST[id]'";			
