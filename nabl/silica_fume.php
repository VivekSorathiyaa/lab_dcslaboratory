            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h2 style="text-align:center;">SILICA FUME</h2>
                    </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-2">
                                            ...
                                            <?php
                                            $querys_job1 = "SELECT * FROM silica_fume WHERE `is_deleted`='0' and lab_no='$lab_no'";
                                        ...
                                        ?>
                                        <div class="col-sm-3">
                                            <a target='_blank' href="<?php echo $base_url; ?>print_report/print_silica_fume.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>" class="btn btn-info" id="btn_report" name="btn_report"><b>Report</b></a>
                                            <!--<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_silica_fume.php.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>"class="btn btn-info" id="btn_report" name="btn_report"><b>Chemical Report</b></a> -->
                                        ...
                                        ?>
                                        <div class="col-sm-3">
                                            <a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_silica_fume.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>" class="btn btn-info" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3 col-sm-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <b>Particle Ret. On 150&#xb5; / 300&#xb5; Sieve(%)</b>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-sm-3">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3 col-sm-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <b>Particle Ret. On 45&#xb5; / 75&#xb5; Sieve(%)</b>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-sm-3">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-2 col-sm-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">0.2 N:0.8</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2 col-sm-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Bar No.</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2 col-sm-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Distance between two point after 24 hours in water (mm)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2 col-sm-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Distance between two point after three hours boiling in water (mm)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2 col-sm-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Average (mm)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Weight of Flyash (A), gm </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Time for Bed 1 (sec)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Initial Vol. of Le-Chat. Flask (B), ml </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Final Vol. of Le-Chat. Flask (C), ml </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Time for Bed 2 (sec)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Sp. Gravity of Flyash [A/(C - B)]</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Mass of Flyash Req. for Flyash Bed (0.500*1.89*S.G of Flyash)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Avg. Time for (t) (sec)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Fineness = cm<sup>2</sup>/g</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">(Ss x P<sub>s</sub> x &#x221A;T)/(P x &#x221A;T<sub>s</sub>)=</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Pozzolana,gm = 60xN</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Flow between 100 & 115 percent = </label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-2">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-4">
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Test Age</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Test Date</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Ref Bar (mm)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Length of specimen after 7 Days (mm)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Length of specimen after 35 Days (mm)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <div class="col-sm-12">
                                                                                <label for="inputEmail3" class="control-label">Difference (mm)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-lg-4">
						...
						<div class="col-md-9">
								<input type="text" class="form-control" id="no_of_brick" name="no_of_brick">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    <label for="inputEmail3" class="control-label label-right">Initial weight in (gm) (W1)</label>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <label for="inputEmail3" class="control-label label-right">Oven dry weight in (gm) (W2)</label>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <label for="inputEmail3" class="control-label label-right">Moisture Content (%) = (W1 - W2/W1) x 100</label>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <label for="inputEmail3" class="control-label label-right">Average Moisture Content (%) </label>
                                                                </div>
                                                            </div>
								...
								<div class="row">
									...
									<div class="col-lg-3">
										<div class="form-group">
											<div class="col-sm-12">
												<label for="inputEmail3" class="control-label">Temp. (&deg;C)</label>
											</div>
										</div>
									</div>
									<div class="col-lg-3">
													...
													<input type="text" class="form-control" id="com_temp2" name="com_temp2" >
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <!--<label for="inputEmail3" class="control-label">Hmdty (%)</label> -->
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Compressive Strength (Lime Rectivity)(N/mm<sup>2</sup>)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Compressive Strength (Cement Mortar)(28 Days)(N/mm<sup>2</sup>)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Compressive Strength (Fyash Cube)(28 Days)(N/mm<sup>2</sup>)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Date & Time of Testing</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Age at the Time of Testing</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <div class="col-sm-12">
                                                                            <label for="inputEmail3" class="control-label">Avg. Compressive Strength (N/mm<sup>2</sup>)</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <table border="1px solid black" align="center" width="100%" id="aaaa">
                                                        ...
                                                        <?php
                                                        $query = "select * from silica_fume WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
    ...
    function getGlazedTiles() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo $base_url; ?>save_silica_fume.php',
