	...
	<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_gsb6_26_5_0_075_mm.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&ulr=<?php echo $_GET['ulr'];?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
...
$(document).ready(function(){ 
	...
	function mdd_auto()
	{
		var mdd = randomNumberFromRange(2.21,2.26).toFixed(2);
			$('#mdd').val(mdd);
	...
	function omc_auto()
	{
		var omc = randomNumberFromRange(5.69,5.85).toFixed(2);
			$('#omc').val(omc);
	...
	function cbr_auto()
	{
		var cbr = randomNumberFromRange(32.0,34.0).toFixed(1);
			$('#cbr').val(cbr);
	...
	function grd_auto()
	{
		$('#txtgrd').css("background-color","var(--success)");	
					...
					var pass_sample_2 = randomNumberFromRange(76.00,95.00).toFixed(2);
					var pass_sample_3 = randomNumberFromRange(56.00,70.00).toFixed(2);
					var pass_sample_4 = randomNumberFromRange(31.00,54.00).toFixed(2);
					var pass_sample_5 = randomNumberFromRange(11.00,24.00).toFixed(2);
					var pass_sample_6 = randomNumberFromRange(5.00,7.00).toFixed(2);
					var pass_sample_7 = randomNumberFromRange(1.00,2.00).toFixed(2);
