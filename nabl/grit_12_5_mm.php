			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">12.5 MM</h2>
					</div>
													...
													<div class="panel-body">
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<div class="col-sm-12">
																		<label for="inputEmail3" class="col-sm-2 control-label">16</label>
																	</div>
																</div>
															</div>
															<div class="col-lg-2">
												...
												<div id="collapse_clr" class="panel-collapse collapse">
													<div class="panel-body">
														...
														<div class="row">
															<div class="col-lg-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Volume of AgNo3.0.1 Solution (ml)</label>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group">
														...
														<div class="row">
															<div class="col-lg-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Chloride = 0.003546*W</label>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group">
												...
												<div id="collapse_slp" class="panel-collapse collapse">
													<div class="panel-body">
														...
														<div class="row">
															<div class="col-lg-2">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">S04 (%) = 41.15*DD/A</label>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group">
												...
												<div id="collapse_dtm" class="panel-collapse collapse">
													<div class="panel-body">
														...
														<div class="row">
															<div class="col-lg-4">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">% finer then 75u (A) = (B-C)/B*100</label>
																</div>
															</div>
															<div class="col-lg-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="dele_1_4" name="dele_1_4">
																</div>
															</div>
														</div>
														<br>
														...
														<div class="row">
															<div class="col-lg-4">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">iii. % Clay nd Lumps</label>
																</div>
															</div>
														</div>
														<br>
														...
														<div class="row">
															...
															<div class="col-lg-2">
																<div class="form-group">
																	<input type="text" class="form-control" id="dele_4_3" name="dele_4_3">
																</div>
															</div>
														</div>
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM rcc_12_5_mm WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_grit_12_5_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>

												<?php// } ?>
												<div class="col-sm-2">
													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=rcc_12_5_mm" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from rcc_12_5_mm WHERE lab_no='$aa'  and `is_deleted`='0'";
...
$('.amend_date').datepicker({
	...
	$(document).ready(function() {
		...
		function sp_auto() {
			...
			var sp_specificgravity = randomNumberFromRange(2.600, 2.700).toFixed(3); //(sp_specific_gravity)
		...
		function grd_auto() {
			...
			var pass_sample_3 = randomNumberFromRange(20.00, 40.00).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(3.00, 8.00).toFixed(2);
		...
		function clr_auto() {
			...
			var av_clr = randomNumberFromRange(0.0010, 0.0014).toFixed(4);
			$('#av_clr').val(av_clr);
			var avclr = $('#av_clr').val();

			var temp = randomNumberFromRange(0, 99).toFixed();
			if (temp % 2 == 0) {
				var clr_s1_7 = (+avclr) - 0.001;
				var clr_s2_7 = (+avclr) + 0.001;
			} else {
				var clr_s1_7 = (+avclr) + 0.001;
				var clr_s2_7 = (+avclr) - 0.001;
			}

			$('#clr_s1_7').val(clr_s1_7.toFixed(4));
			$('#clr_s2_7').val(clr_s2_7.toFixed(4));
			...
			$('#clr_s1_1').val(clr_s1_1.toFixed(1));
			$('#clr_s1_2').val(clr_s1_2.toFixed(1));
			$('#clr_s2_1').val(clr_s2_1.toFixed(1));
			$('#clr_s2_2').val(clr_s2_2.toFixed(1));
			...
			var clr_s1_3 = (+clr_s21) / (+clr_s11);
			var clr_s2_3 = (+clr_s22) / (+clr_s12);

			$('#clr_s1_3').val(clr_s1_3.toFixed(1));
			$('#clr_s2_3').val(clr_s2_3.toFixed(1));
			...
			var W_1 = $('#clr_s1_3').val();
			var W_2 = $('#clr_s1_3').val();
			var V5_1 = $('#clr_s1_4').val();
			var V5_2 = $('#clr_s1_4').val();
			var V6_1 = $('#clr_s1_5').val();
			var V6_2 = $('#clr_s2_5').val();
			var CT_1 = $('#clr_s1_6').val();
			var CT_2 = $('#clr_s2_6').val();

			var calc_1 = 10 * (+CT_1) * (+V6_1);
			var calc_2 = (+V5_1) - calc_1;
			var calc_3 = W_1 * calc_2;

			var clr_1 = (0.003546 * calc_3).toFixed(4);

			var calc_4 = 10 * (+CT_2) * (+V6_2);
			var calc_5 = (+V5_2) - calc_4;
			var calc_6 = W_2 * calc_5;

			var clr_2 = (0.003546 * calc_6).toFixed(4);

			$('#clr_s1_7').val(clr_1);
			$('#clr_s2_7').val(clr_2);

			var avg_clr = clr_1 + clr_2;

			//$('#av_clr').val(avg_clr.toFixed(4));
		}
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_grit_12_5_mm.php',
