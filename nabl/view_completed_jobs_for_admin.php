					...
					<!-- /.box-header -->
							...
							<div class="box-body">
								...
								<div class="row">
									...
									<input type="text" class="form-control" name="agree_nos"  id="agree_nos" placeholder="Enter agreement No" style="">
									</div>
								...
								<div class="col-md-3">
									...
									<a href="view_completed_jobs_for_admin.php?a=rec1" class="btn btn-primary btn3d"><span class="glyphicon glyphicon-question-ok"></span> View All</a>
									</div>
								</div>
								...
								<div id="display_data">
									...
									<?php
										...
										$query_est_bill="select * from estimate_total_span_only_bill where  `est_isdeleted`='0'";
...
<script>
	...
	$(".search_job_by_agency").click(function(){
					...
					var postData = '&type=search_complete_job_by_agency_for_admin&sel_agency_ids='+sel_agency_ids+'&sel_clients_ids='+sel_clients_ids+'&sel_auth_names='+sel_auth_names+'&agree_nos='+agree_nos;

					$.ajax({
						url : "<?php echo $base_url; ?>search_complete_job_by_agency_for_admin.php",
						type: "POST",
						data : postData,
						success: function(data,status,  xhr)
						 {
