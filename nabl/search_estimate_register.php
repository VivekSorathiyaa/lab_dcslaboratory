...
array($_POST["perfoma_id"]," AND `perfoma_no` LIKE '%".$_POST['perfoma_id']."%'"),
...
<table id="example2" class="table table-bordered table-striped" style="width:100%;">
									<thead>
									<tr>
										<th style="text-align:center;">sssssSerial No</th>
								...
								<tbody>
									<?php
										$count=0;
										 $query="select * from estimate_total_span_only_for_estimate WHERE `est_isdeleted`=0".$where." ORDER BY est_id DESC";
