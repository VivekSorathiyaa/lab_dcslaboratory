									...
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group">
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_gsb4_26_5_0_075_mm.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>

												<?php// } ?>
												<div class="col-sm-2">
													<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_kapchi_20.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=gsb_mix_4_m5" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
...
<script>
	...
	$(document).ready(function() {
		...
		function mdd_auto() {
			var mdd = randomNumberFromRange(2.20, 2.25).toFixed(2);
			$('#mdd').val(mdd);
		...
		function omc_auto() {
			var omc = randomNumberFromRange(5.60, 5.75).toFixed(2);
			$('#omc').val(omc);
		...
		function cbr_auto() {
			var cbr = randomNumberFromRange(31.0, 34.0).toFixed(1);
			$('#cbr').val(cbr);
