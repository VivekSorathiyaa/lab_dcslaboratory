...
?>								
									...
									<input type="hidden" name="chk_job_card" value="<?php echo $base_url; ?>set_ledger_print.php?u_types=<?php echo $_POST["user_type"];?>&&start_date=<?php echo $start_date;?>&&end_date=<?php echo $end_date;?>&&user_id=<?php echo $user_id;?>">
