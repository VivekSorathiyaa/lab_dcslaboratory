...
<br>
    ...
    <tr>
        ...
        <td style="padding:2px;text-align: left;"><b>&nbsp; : &nbsp;</b><?php echo $lab_no;?></td>
			...
			<?php }?>
			<tr style="">
                <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 0px;border-right:0px;border-bottom:0px;font-weight:bold;"></td>
			...
			<tr style="">
                ...
                <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 0px;border-right:0px;border-bottom:0px;">Compressive Strength (N/mm<sup>2</sup>)</td>
                ...
                <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 0px;border-right:0px;border-bottom:0px;">Greater Than <?php echo $brick_specification?> N/mm<sup>2</sup></td>
            </tr>
			<?php 
			}
			...
			<tr style="">
                ...
                <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 0px;border-right:0px;border-bottom:0px;">Note More than Moderate up<br> to class <?php echo $brick_specification?> and Slight for<br> Higher Classes</td>
            </tr>
			<?php }?>
	...
	<table align="center" width="98%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;border-right:2px solid;border-left:1px solid;">
						...
						<tr style="">
							...
							<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;" rowspan="4">IS : 13757 : 1993</td>
							...
							<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;font-weight: bold;">Non Modular Size</td>

							<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;font-weight: bold;">Modular Size</td>
						</tr>
						...
						<tr style="">
							...
							<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;font-weight: bold;"rowspan="6"colspan="2">Shall not be &lt; 7.5 N/mm2<br>For Class 7.5</td>
						</tr>
		...
		<!-- footer design ->
					...
					<table align="center" width="98%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border: 2px solid;border-top: 0;">
						...
						<tr>
							...
							<?php if(strlen($row_select_pipe['ulr'])>15){?>
							<img src="../images/logos.png" height="40px" width="40px" style="margin-top:-40px;"/>
							<?php }?>
							</td>
						</tr>
						<tr>
							<td style="padding: 1px 40px;font-weight: bold;text-align: right;" colspan="2">Page no:- 1 of 1</td>
						</tr>
						<tr>
