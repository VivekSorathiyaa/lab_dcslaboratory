...
<body>
	...
	<page size="A4">
	<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:20px;border: 1px solid;border: bottom: 0;">
		<tr>
			<td>
					...
					<?php
                        ...
                        <tr style="display:flex; ">
							...
							<table align="top" width="100%" class="test" style="max-width:300px;font-size:11px;font-family : Calibri;">
									...
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:5px 4px;font-weight:bold;">Sieve Size</b></td>
									...
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:5px 0;">1.18 mm</td>
									...
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:5px 0;">600 mic</td>
									...
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:5px 0;">300 mic</td>
									...
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:5px 0;">150 mic</td>
									...
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:5px 0;">75 mic</td>
		...
		<tr>
			<td>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border: 1px solid; border-top:0px solid">
					<tr>
