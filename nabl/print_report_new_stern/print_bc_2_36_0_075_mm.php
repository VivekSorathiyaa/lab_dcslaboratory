					...
					<?php
                        ...
                        <tr style="display:flex; ">
							...
							<table align="top" width="100%" class="test" style="max-width:400px;font-size:11px;font-family : Calibri;">
									...
									<tr>
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:2px 4px;">0.6 mm</td>
									...
									<tr>
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:2px 4px;">0.15 mm</td>
