...
<page size="A4">
	<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:60px;border: 1px solid;border: bottom: 0;">
		<tr>
			<td>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;">
					<tr>
						<td style="text-transform: uppercase;font-weight: bold;text-decoration: underline;text-align: center;font-size: 13px;padding: 2px 0;border-bottom: 1px solid;"  colspan="4">Test Report - CARBONATION DEPTH TEST</td>
					</tr>
					<tr>
		...
		<!--input type="checkbox" style="width:30px; height:30px" id="header_hide_show" onclick="header()"-->
			...
			<?php $cnt = 1; ?>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:12px;font-family : Calibri;border-left:1px solid;border-right:1px solid;">

						<tr style="">
							<td style="border-left: 1px solid black;border-top:0px solid;width:7%;font-weight:bold; text-align:center;padding:7px 3px; ">SR. NO.</td>
							<td style="border-left: 1px solid black;border-top:0px solid;width:10%;text-align:center;font-weight:bold;padding:7px 3px; ">Concrete Element Location</td>
							<td style="border-left: 1px solid black;border-top:0px solid;width:10%; text-align:center;font-weight:bold;padding:7px 3px;">Carbonation depth (mm)</td>
							<td style="border-left: 1px solid black;border-top:0px solid;width:10%; text-align:center;font-weight:bold;padding-bottom:6px;padding-top:6px;padding:7px 3px;">Approx pH of noncarbonated concrete</td>
							<td style="border-left: 1px solid black;border-top:0px solid;width:10%; text-align:center;font-weight:bold;border-right:1px solid;padding:7px 3px;">Remarks</td>
						</tr>
						<tr>
							<td style="border-left: 1px solid black;text-align:center; border-top:1px solid;"><?php echo $cnt++; ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;padding-bottom:5px;padding-top:5px;  "><?php if ($row_select_pipe['loc_1'] != "" && $row_select_pipe['loc_1'] != null && $row_select_pipe['loc_1'] != "0") {
																																								echo $row_select_pipe['loc_1'];
																																							} else {
																																								echo "-";
																																							} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;"><?php if ($row_select_pipe['corr_1'] != "" && $row_select_pipe['corr_1'] != null && $row_select_pipe['corr_1'] != "0") {
																															echo $row_select_pipe['corr_1'];
																														} else {
																															echo "-";
																														} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;">40-50</td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;border-right:1px solid;"><?php if ($row_select_pipe['rem_1'] != "" && $row_select_pipe['rem_1'] != null && $row_select_pipe['rem_1'] != "0") {
						...
						<tr>
							<td style="border-left: 1px solid black;text-align:center; border-top:1px solid;"><?php echo $cnt++; ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;padding-bottom:5px;padding-top:5px;  "><?php if ($row_select_pipe['loc_2'] != "" && $row_select_pipe['loc_2'] != null && $row_select_pipe['loc_2'] != "0") {
																																								echo $row_select_pipe['loc_2'];
																																							} else {
																																								echo "-";
																																							} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;"><?php if ($row_select_pipe['corr_2'] != "" && $row_select_pipe['corr_2'] != null && $row_select_pipe['corr_2'] != "0") {
																															echo $row_select_pipe['corr_2'];
																														} else {
																															echo "-";
																														} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;">40-50</td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;border-right:1px solid;"><?php if ($row_select_pipe['rem_2'] != "" && $row_select_pipe['rem_2'] != null && $row_select_pipe['rem_2'] != "0") {
						...
						<tr">
							<td style="border-left: 1px solid black;text-align:center; border-top:1px solid;"><?php echo $cnt++; ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;padding-bottom:5px;padding-top:5px;  "><?php if ($row_select_pipe['loc_3'] != "" && $row_select_pipe['loc_3'] != null && $row_select_pipe['loc_3'] != "0") {
																																								echo $row_select_pipe['loc_3'];
																																							} else {
																																								echo "-";
																																							} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;"><?php if ($row_select_pipe['corr_3'] != "" && $row_select_pipe['corr_3'] != null && $row_select_pipe['corr_3'] != "0") {
																															echo $row_select_pipe['corr_3'];
																														} else {
																															echo "-";
																														} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;">40-50</td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;border-right:1px solid;"><?php if ($row_select_pipe['rem_3'] != "" && $row_select_pipe['rem_3'] != null && $row_select_pipe['rem_3'] != "0") {
						...
						<tr>
							<td style="border-left: 1px solid black;text-align:center; border-top:1px solid;"><?php echo $cnt++; ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;padding-bottom:5px;padding-top:5px;  "><?php if ($row_select_pipe['loc_4'] != "" && $row_select_pipe['loc_4'] != null && $row_select_pipe['loc_4'] != "0") {
																																								echo $row_select_pipe['loc_4'];
																																							} else {
																																								echo "-";
																																							} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;"><?php if ($row_select_pipe['corr_4'] != "" && $row_select_pipe['corr_4'] != null && $row_select_pipe['corr_4'] != "0") {
																															echo $row_select_pipe['corr_4'];
																														} else {
																															echo "-";
																														} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;">40-50</td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;border-right:1px solid;"><?php if ($row_select_pipe['rem_4'] != "" && $row_select_pipe['rem_4'] != null && $row_select_pipe['rem_4'] != "0") {
						...
						<tr>
							<td style="border-left: 1px solid black;text-align:center; border-top:1px solid;"><?php echo $cnt++; ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;padding-bottom:5px;padding-top:5px;  "><?php if ($row_select_pipe['loc_5'] != "" && $row_select_pipe['loc_5'] != null && $row_select_pipe['loc_5'] != "0") {
																																								echo $row_select_pipe['loc_5'];
																																							} else {
																																								echo "-";
																																							} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;"><?php if ($row_select_pipe['corr_5'] != "" && $row_select_pipe['corr_5'] != null && $row_select_pipe['corr_5'] != "0") {
																															echo $row_select_pipe['corr_5'];
																														} else {
																															echo "-";
																														} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;">40-50</td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;border-right:1px solid;"><?php if ($row_select_pipe['rem_5'] != "" && $row_select_pipe['rem_5'] != null && $row_select_pipe['rem_5'] != "0") {
						...
						<tr>
							<td style="border-left: 1px solid black;text-align:center; border-top:1px solid;"><?php echo $cnt++; ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;padding-bottom:5px;padding-top:5px;  "><?php if ($row_select_pipe['loc_6'] != "" && $row_select_pipe['loc_6'] != null && $row_select_pipe['loc_6'] != "0") {
																																								echo $row_select_pipe['loc_6'];
																																							} else {
																																								echo "-";
																																							} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;"><?php if ($row_select_pipe['corr_6'] != "" && $row_select_pipe['corr_6'] != null && $row_select_pipe['corr_6'] != "0") {
																															echo $row_select_pipe['corr_6'];
																														} else {
																															echo "-";
																														} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;">40-50</td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;border-right:1px solid;"><?php if ($row_select_pipe['rem_6'] != "" && $row_select_pipe['rem_6'] != null && $row_select_pipe['rem_6'] != "0") {
						...
						<tr>
							<td style="border-left: 1px solid black;text-align:center; border-top:1px solid;"><?php echo $cnt++; ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;padding-bottom:5px;padding-top:5px;  "><?php if ($row_select_pipe['loc_7'] != "" && $row_select_pipe['loc_7'] != null && $row_select_pipe['loc_7'] != "0") {
																																								echo $row_select_pipe['loc_7'];
																																							} else {
																																								echo "-";
																																							} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;"><?php if ($row_select_pipe['corr_7'] != "" && $row_select_pipe['corr_7'] != null && $row_select_pipe['corr_7'] != "0") {
																															echo $row_select_pipe['corr_7'];
																														} else {
																															echo "-";
																														} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;">40-50</td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;border-right:1px solid;"><?php if ($row_select_pipe['rem_7'] != "" && $row_select_pipe['rem_7'] != null && $row_select_pipe['rem_7'] != "0") {
						...
						<tr>
							<td style="border-left: 1px solid black;text-align:center; border-top:1px solid;"><?php echo $cnt++; ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;padding-bottom:5px;padding-top:5px;  "><?php if ($row_select_pipe['loc_8'] != "" && $row_select_pipe['loc_8'] != null && $row_select_pipe['loc_8'] != "0") {
																																								echo $row_select_pipe['loc_8'];
																																							} else {
																																								echo "-";
																																							} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;"><?php if ($row_select_pipe['corr_8'] != "" && $row_select_pipe['corr_8'] != null && $row_select_pipe['corr_8'] != "0") {
																															echo $row_select_pipe['corr_8'];
																														} else {
																															echo "-";
																														} ?></td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;">40-50</td>
							<td style="border-left: 1px solid black;text-align:center;border-top:1px solid;border-right:1px solid;"><?php if ($row_select_pipe['rem_8'] != "" && $row_select_pipe['rem_8'] != null && $row_select_pipe['rem_8'] != "0") {
