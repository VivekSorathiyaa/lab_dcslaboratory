	...
	<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:60px;border: 1px solid;border: bottom: 0;">
		<tr>
			<td>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;">
					<tr>
						<td style="text-transform: uppercase;font-weight: bold;text-decoration: underline;text-align: center;font-size: 13px;padding: 2px 0;border-bottom: 1px solid;"  colspan="4">Test Report - MECHANICAL PROPERTIES OF COARSE AGGREGATE</td>
					</tr>
					<tr>
			...
			<td style="text-align:center;font-size:12px; ">
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:12px;font-family : Calibri;border-bottom:1px solid;border-top:1px solid;border-right:1px solid;">
					...
					<tr style="">
						...
						<td style="border-left: 1px solid black;width:70%;text-align:left; ">&nbsp;&nbsp; 20 mm</td>
		...
		<!-- <tr>
			<td style="text-align:center;font-size:14px; ">
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:14px;font-family : Calibri;border-bottom:1px solid;border-right:1px solid;border-top:1px solid;">

					<tr style="">
						<td style="border-left: 1px solid black;width:7%;font-weight:bold;text-align:center; "> Sr.No</td>
						<td style="border-left: 1px solid black;width:48%;text-align:center;font-weight:bold; ">Test</td>
						<td style="border-left: 1px solid black;width:18%; font-weight:bold;text-align:center;" colspan="2">Result</td>
						<td style="border-left: 1px solid black;width:25%;font-weight:bold;text-align:center;padding-bottom:5px;padding-top:5px; ">Requirement as per IS:383-2016</td>
					</tr>
					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:7%;text-align:center;padding-bottom:4px;padding-top:4px; "><?php echo $cnt++; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:48%;text-align:center; "> specifik grasvity</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['sp_specific_gravity']; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:27%;text-align:center; ">---</td>
					</tr>
					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:7%;text-align:center;padding-bottom:4px;padding-top:4px; "><?php echo $cnt++; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:48%;text-align:center; ">Water absorption(%)</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['sp_water_abr']; ?>1</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:27%;text-align:center; ">Max. 2%</td>
					</tr>
					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:7%;text-align:center;padding-bottom:4px;padding-top:4px; "><?php echo $cnt++; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:48%;text-align:center;font-weight:bold; ">Gradation Percent Passing on IS Sieve</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;" colspan=2>% Passing</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:27%;text-align:center;font-weight:bold; ">Acceptance Criteria</td>
					</tr>
					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:7%;text-align:center;padding-bottom:4px;padding-top:4px; "><?php echo $cnt++; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:48%;text-align:center; ">40 mm</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['pass_sample_1']; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:27%;text-align:center; ">100</td>
					</tr>
					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:7%;text-align:center;padding-bottom:4px;padding-top:4px; "><?php echo $cnt++; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:48%;text-align:center; ">20 mm</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['pass_sample_2']; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:27%;text-align:center; ">85-100</td>
					</tr>
					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:7%;text-align:center;padding-bottom:4px;padding-top:4px; "><?php echo $cnt++; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:48%;text-align:center; ">10 mm</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['pass_sample_3']; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:27%;text-align:center; ">0-20</td>
					</tr>
					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:7%;text-align:center;padding-bottom:4px;padding-top:4px; "><?php echo $cnt++; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:48%;text-align:center; ">4.75 mm</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['pass_sample_4']; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:27%;text-align:center; ">0-5</td>
					</tr>
					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:7%;text-align:center; padding-bottom:4px;padding-top:4px;"><?php echo $cnt++; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:48%;text-align:center; ">Impact Value(%)</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['imp_value']; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:27%;text-align:center; ">Max. 30%</td>
					</tr>
					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:7%;text-align:center;padding-bottom:4px;padding-top:4px; "><?php echo $cnt++; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:48%;text-align:center; ">Crushing Value(%)</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['cru_value']; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:27%;text-align:center; ">Max. 30%</td>
					</tr>
					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:7%;text-align:center; padding-bottom:4px;padding-top:4px;"><?php echo $cnt++; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:48%;text-align:center; ">Abrasion Value(%)</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['abr_index']; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:27%;text-align:center; ">Max. 30%</td>
					</tr>
					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:7%;text-align:center;padding-bottom:4px;padding-top:4px; " rowspan=2><?php echo $cnt++; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:48%;text-align:center; " rowspan=2>Flakiness Index(%) & Elongation Index(%)</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;">F.l</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;"><?php echo $row_select_pipe['combined_index']; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:27%;text-align:center; " rowspan=2>Max. 40%</td>
					</tr>
					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;">E.l</td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;"><?php echo $row_select_pipe['combined_index']; ?></td>
					</tr>

					<tr style="">
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:7%;text-align:center;padding-bottom:4px;padding-top:4px; "><?php echo $cnt++; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:48%;text-align:center; ">Soundness by Na<sub>2</sub>SO<sub>4</sub></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:9%; font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['soundness']; ?></td>
						<td style="border-left: 1px solid black;border-top: 1px solid black;width:27%;text-align:center; ">Max. 12%</td>
					</tr>
		...
		<table width="100%" style="border-left:2px solid; border-right:2px solid;">
		    <tr style="display:flex;">
				<td>
					<table>
					<?php if (($row_select_pipe['pass_sample_1'] != "") && ($row_select_pipe['pass_sample_1'] != null) && ($row_select_pipe['pass_sample_1'] != "0")) { ?>
								<td width="100%" style="vertical-align:top;">
									<table align="left" width="92%" class="test" style="max-width:500px;margin-left:30px;font-family : Calibri;">
										<tr>
										...
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">40.0 mm</td>
										...
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">20.0 mm</td>
										...
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">10.0 mm</td>
										...
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">4.75 mm</td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;"><?php echo $row_select_pipe['pass_sample_5']; ?></td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;">0-5</td>
										</tr>
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">4.75 mm</td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;"><?php echo $row_select_pipe['pass_sample_6']; ?></td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;">0-5</td>
										</tr>
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">4.75 mm</td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;"><?php echo $row_select_pipe['pass_sample_7']; ?></td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;">0-5</td>
										</tr>
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">4.75 mm</td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;"><?php echo $row_select_pipe['pass_sample_8']; ?></td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;">0-5</td>
										</tr>
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">4.75 mm</td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;"><?php echo $row_select_pipe['pass_sample_9']; ?></td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;">0-5</td>
										</tr>
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">4.75 mm</td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;"><?php echo $row_select_pipe['pass_sample_10']; ?></td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;">0-5</td>
										</tr>
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">4.75 mm</td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;"><?php echo $row_select_pipe['pass_sample_11']; ?></td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;">0-5</td>
										</tr>
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">4.75 mm</td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;"><?php echo $row_select_pipe['pass_sample_12']; ?></td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;">0-5</td>
										</tr>
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 0;">4.75 mm</td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;"><?php echo $row_select_pipe['pass_sample_13']; ?></td>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;">0-5</td>
										</tr>
				...
				<td>
					<table>
						...
						<tr>
							...
							<table align="center" width="85%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;border-right:1px solid;border-top:1px solid;margin-right:29px;margin-bottom:20px;">
								...
								<tr>
									...
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;">Combined Shall be Max 40%</td>
								    	<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;">I.S 2386-1</td>

									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;">
										<table style="width:100%;border-collapse: collapse;">
											<tr>
												<td style="font-size:11px;text-align:center;border-bottom:0px solid black;padding:5px 4px;"><?php echo $row_select_pipe['fi_index']; ?></td>
											</tr>
											<tr style="">
												<td style="font-size:11px;text-align:center;border-top:1px solid black;padding:5px 4px;"><?php echo $row_select_pipe['fi_index1']; ?></td>
											</tr>
										</table>
									</td>								</tr>
								...
								<tr style="">
									...
									<td style="border-left: 1px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['imp_value']; ?></td>
								</tr>

								
								<tr style="">
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"> Specific Gravity</td>
									...
									<td style="border-left: 1px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;padding:5px 0;" colspan=2><?php echo $row_select_pipe['sp_specific_gravity_b2']; ?></td>
								</tr>

								
								<tr style="">
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Water Absorption(%)</td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 0;">Max. 2%</td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 0;">I.S 2386-3</td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;padding:5px 0;" colspan=2><?php echo $row_select_pipe['sp_water_abr2']; ?>1</td>
								</tr>
								...
								<tr style="">
									...
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 0;">---</td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 0;">I.S 2386-3</td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;padding:5px 0;" colspan=2><?php echo $row_select_pipe['avg_wom']; ?></td>
								</tr>
								...
								<tr style="">
									...
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center; ">I.S 2386-4</td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['cru_value']; ?></td>
								</tr>
								...
								<tr style="">
									...
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center; ">I.S 2386-4</td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['abr_index']; ?></td>
								</tr>


								<!-- <tr style="">
									<td style="border-left: 1px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;">E.l</td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;"><?php echo $row_select_pipe['combined_index']; ?></td>
								</tr> -->

								<!-- <tr style="">
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 0;">Soundness by Na<sub>2</sub>SO<sub>4</sub></td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center; ">Max. 12%</td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center; ">I.S 2386-1</td>
									<td style="border-left: 1px solid black;border-top: 1px solid black;font-weight:bold;text-align:center;" colspan=2><?php echo $row_select_pipe['soundness']; ?></td>
								</tr> -->
