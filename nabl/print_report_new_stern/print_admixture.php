...
<br>
	...
	<table align="center" width="98%" class="test" style="font-size:11px;font-family : Calibri;border-top:0px solid;border-bottom:1px solid;border-right:2px solid; ">
				...
				<tr>
					...
					<td style="border-top:0px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;">Requirements as per IS: 9103:1999</td>
				</tr>
				<tr>
					<td style="font-size:11px;border: 1px solid black;border-left: 2px solid black;padding:1px;"colspan="7"></td>
				</tr>
				<?php if($row_select_pipe['phv_avg_after'] != "" && $row_select_pipe['phv_avg_after'] != "0" && $row_select_pipe['phv_avg_after'] != null) { ?>
				<tr>
					...
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">IS 9103 : 1999 Annex-E-5</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php  echo $row_select_pipe['phv_avg_after']; ?></td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">--</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">7-8</td>
				</tr>
				<?php }if($row_select_pipe['dmc_content'] != "" && $row_select_pipe['dmc_content'] != "0" && $row_select_pipe['dmc_content'] != null) { ?>
				<tr>
					<td style="border-left: 2px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $cnt++;?></td>
					...
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">IS 9103 : 1999 Annex-E-1</td>
					...
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">%</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Within 3%  of the value stated by the manufacturer</td>
				</tr>
				<?php }if($row_select_pipe['ash_content'] != "" && $row_select_pipe['ash_content'] != "0" && $row_select_pipe['ash_content'] != null) { ?>
				<tr>
					<td style="border-left: 2px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $cnt++;?></td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Total Ash Content</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">IS 9103 : 1999 Annex-E-2</td>
					...
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">%</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Within 1% of the value stated by the manufacturer</td>
				</tr>
				<?php }if($row_select_pipe['avg_rdv'] != "" && $row_select_pipe['avg_rdv'] != "0" && $row_select_pipe['avg_rdv'] != null) { ?>
				<tr>
					<td style="border-left: 2px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $cnt++;?></td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"> Relative Density</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">IS 9103 : 1999 Annex-E-3</td>
					...
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">--</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Within 0.02 of the value stated by the manufacturer</td>
				</tr>
				<?php }if($row_select_pipe['chloride_content'] != "" && $row_select_pipe['chloride_content'] != "0" && $row_select_pipe['chloride_content'] != null) { ?>
				<tr>
					<td style="border-left: 2px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $cnt++;?></td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">Chloride (Cl)</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;">IS 9103 : 1999 Annex-E-4<br>  IS 6925 : 1973</td>
					...
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;;">%</td>
					<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;;">Within 10 % of the value or Within 0.2 % of whichever is greater as the value stated by the manufacturer</td>
				</tr>
				<?php } ?>
				<tr>
					<td style="font-size:11px;border: 1px solid black;border-left: 2px solid black;padding:1px;"colspan="7"></td>
