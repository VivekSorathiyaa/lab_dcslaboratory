...
<html>
	<body>
		...
		<table align="center" width="90%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family:Times New Roman;margin-top:80px;border-bottom:0px solid black;">
		    <tr>
			...
			<tr>
				<table align="center" width="90%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;">
					<tr style="">
			...
			<tr>
				<td>
					<table align="center" width="90%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;">
			...
			<tr>
				<td>
					<table align="center" width="90%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;padding: 4px 0;margin-bottom:4px;    border-collapse: inherit;">
					    <tr>
			...
			<tr>
			    <td>
                    <table align="left" width="90%" border="0px" cellspacing="0" cellpadding="0" class="test" style="font-family : Calibri;margin-left:40px;margin-top:10px;">
                        <tr>
                        ...
                        <tr style="display:flex;">
                            <td colspan="2" style="width:90%;vertical-align:top;margin-bottom:10px;">
                                <table align="top" width="90%" class="test" style="max-width:400px;font-size:11px;font-family : Calibri;">
                                     <tr>
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:1px solid black;padding:5px 4px;"> Size of Sieve in mm</td>
									...
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">22.4 mm</td>
									...
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">19 mm</td>
									...
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">13.2 mm</td>
                            ...
                            ?>
                                <td colspan="6" style="width:90%">
                                    <table align="center" width="90%" class="test" style="margin-left:15px;max-width:350px;font-size:11px;font-family : Calibri;">
                                        <tr>
                                ...
                                <table align="top" width="70%" class="test" style="height:90%;width:70%;">
                                    ...
                                    ?>
                                       <tr>
												...
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left: 1px solid black;font-weight:bold;padding:5px 4px;">Test Result</td>
		...
		<table cellpadding="0" cellpadding="0" align="center" width="90%" style="font-size:11px;font-family : Calibri;" class="test">
						<tr>
	    ...
	    <table align="center" width="95%" class="test">
		        <tr>
					<td style="text-align:center;font-size:11px;">
						<table align="center" width="95%" class="test" style="height:auto;font-family : Calibri;border-top:1px solid black;border-bottom:1px solid black;">
							<tr>
								<td><b>Note :-</b></td>
								<td></td>
							</tr>
		...
		<table width="90%" align="center" style="font-family:Times New Roman;font-size:11px;">
						<tr>
							<td style="width:40%;text-align:right;font-weight:bold;font-style:italic;font-size:11px;">
								Doc ID : FMT-TST-040/ Page 1/1
							</td>
						</tr>
		</table>
	</page>
		...
		<table align="center" width="92%" class="test" style="margin-left:35px; ">
			...
			<tr>
				...
				<td rowspan="6" style="border: 1px solid black;text-align:center;"> IS 2386:1963 <br> Part-1 <br> </td>	
