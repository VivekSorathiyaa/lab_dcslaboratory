                        ...
                        <tr style="display:flex;margin-bottom:10px;">
                            <td colspan="2" style="width:90%;vertical-align:top">
                                <table align="top" width="90%" class="test" style="max-width:400px;font-size:11px;font-family : Calibri;">
									...
									<tr>
										<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">11.2 mm</td>
                            ...
                            ?>
                                <td colspan="6" style="width:90%">
                                    <table align="center" width="90%" class="test" style="margin-left:15px;max-width:300px;font-size:11px;font-family : Calibri;">
                                        <tr>
