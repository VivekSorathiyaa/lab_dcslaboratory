...
<br>
	...
	<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:60px;">
		<tr>
			<td>
				...
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;">
					<tr>
						<td style="text-transform: uppercase;font-weight: bold;text-decoration: underline;text-align: center;font-size: 15px;padding: 2px 0;"  colspan="4">TITLE : TEST REPORT OF FINE AGGREGATE
						</td>
					</tr>
				</table>
				<br>	
    ...
    <tr>
        ...
        <td style="padding:2px;text-align: left;"><b>&nbsp; : &nbsp;</b><?php echo $lab_no;?></td>
				...
				<?php if ($row_select_pipe['pass_sample_1'] != "" && $row_select_pipe['pass_sample_1'] != "0") { ?>
						...
						<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;border-left:1px solid; border-right:1px solid;">
							<tr style="text-align:center;">
								<td style="border:1px solid black;padding:2px 0;font-size:11px;border-top:0px;" rowspan="2"><b>Sr.No.</b></td>
								<td style="border:1px solid black;border-right:1px solid black;border-top:0px;padding:2px 0;font-size:11px;"rowspan="2"><b>Test</b></td>
								<td style="border:1px solid black;border-right:1px solid black;border-top:0px;padding:2px 0;font-size:11px;"><b>Results</b></td>
								<td style="border:1px solid black;border-right:1px solid black;border-top:0px;padding:2px 0;font-size:11px;" rowspan="2"><b>Test Method</b></td>
								<td style="border:1px solid black;border-right:1px solid black;border-top:0px;padding:2px 0;font-size:11px;" rowspan="2" colspan="4"><b>Requirement as per<br>IS 383-2016</b></td>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;padding:2px 0;font-size:11px;border-top:0px;"><br></td>
							</tr>
					...
					$cnt=1;
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;">Specific Gravity</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;font-weight:bold;"><?php echo $row_select_pipe['sp_specific_gravity'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;" rowspan="2">IS 2386 PART-3</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;">Water Absorption</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;font-weight:bold;"><?php echo $row_select_pipe['sp_water_abr'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
							
							<?php } ?>
							<tr style="text-align:center;">
								<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"rowspan="2"><?php echo $cnt++;?></td>
								<td style="border:1px solid black;padding:2px 0;font-size:11px;"rowspan="2"><b>Gradation <br>Passing Percentage</b></td>
								<td style="border:1px solid black;padding:2px 0;font-size:11px;"></td>
								<td style="border:1px solid black;padding:2px 0;font-size:11px;" rowspan="13">IS 2386 PART-1</td>
								<td style="border:1px solid black;padding:2px 0;font-size:11px;"colspan="4"><b>Percentage Passing for Zone</b></td>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;padding:2px 0;font-size:11px;"></td>
								<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;font-size:11px;"><b>I</b></td>
								<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;font-size:11px;"><b>II</b></td>
								<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;font-size:11px;"><b>III</b></td>
								<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;font-size:11px;"><b>IV</b></td>
							</tr>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">10 mm</td>
									...
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">100</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">100</td>
									<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;">100</td>
								</tr>
							<?php
							}
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">4.75 mm</td>
									...
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">90-100</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">90-100</td>
									<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;">95-100</td>
								</tr>
							<?php
							}
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">2.36 mm</td>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">1.18 mm</td>
									...
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">75-100</td>
									<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;">90-100</td>
								</tr>
							<?php
							}
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">600 micron</td>
									...
									<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;">80-100</td>
								</tr>
							<?php
							}
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">300 micron</td>
									...
									<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;">15-50</td>
								</tr>
							<?php
							}
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">150 micron</td>
									...
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">0-10</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">0-10</td>
									<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;">0-15</td>
								</tr>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">75 micron</td>
									<td style="border:1px solid black;border-left:0px solid black;font-weight:bold;padding:2px 0;font-size:11px;"><?php echo number_format($row_select_pipe['pass_sample_8'], 2); ?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">-</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">-</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">-</td>
									<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;">-</td>
								</tr>
								
								
							<?php
							}
							if ($row_select_pipe['grd_fm'] != "") {
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">FM</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['grd_fm'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
							...
							if ($row_select_pipe['grd_zone'] != "") {
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">Zone</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['grd_zone'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">Silt Content</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['silt_content'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
							...
							if ($row_select_pipe['alk_a5'] != "") {
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">Alkali Ractiviti</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['alk_a5'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
							...
							if ($row_select_pipe['bdl'] != "") {
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">Bulk Density</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['bdl'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
							...
							if ($row_select_pipe['ans_lbd'] != "") {
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">Bulking Sand</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['ans_lbd'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">IS : 2386 (Part-3) : 1963</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
							<?php
							}
							if ($row_select_pipe['av_clr'] != "") {
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">Chloride</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['av_clr'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
							<?php
							}
							if ($row_select_pipe['avg_finer'] != "") {
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">Finer then 75 Micron</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['avg_finer'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">IS : 2386 (Part-1)</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">Max 3%</td>
								</tr>
							<?php
							}
							if ($row_select_pipe['avg_ph'] != "") {
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">PH</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['avg_ph'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
							<?php
							}
							if ($row_select_pipe['avg_sul'] != "") {
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">Sulphate</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['avg_sul'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
							<?php
							}
							if ($row_select_pipe['soundness'] != "") {
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">Soundness</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['soundness'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
							<?php
							}
							if ($row_select_pipe['fmc_7'] != "") {
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">Surface Moisture</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['fmc_7'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">-</td>
								</tr>
	...
	<!--<table align="center" width="90%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:60px;border: 1px solid;border: bottom: 0;">
		<tr>
			<td>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;">
					<tr>
						<td style="text-transform: uppercase;font-weight: bold;text-decoration: underline;text-align: center;font-size: 13px;padding: 2px 0;border-bottom: 1px solid;"  colspan="4">Test Report - FINE AGGREGATE</td>
					</tr>
					<tr>
					...
					<tr>
							...
							<td style="padding: 0 2px;border-left: 1px solid;width:36.7%;">&nbsp;<?php echo $lab_no; ?></td>
			...
			<td>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border: 1px solid;border-top: 0;border-bottom: 0;">
					...
					<tr>
						...
						<td style="border-bottom: 0px solid;padding: 0 2px;border-left: 1px solid;text-align: left;font-weight: bold;" colspan="3">&nbsp;<?php echo $source; ?></td>
					</tr>
					<tr>
						<td style="border-bottom: 0px solid;padding: 0 2px;text-align: left;font-weight:bold;">&nbsp;Zone :-</td>
						<td style="border-bottom: 0px solid;padding: 0 2px;border-left: 1px solid;text-align: left;" colspan="3">&nbsp;<?php echo $row_select_pipe['grd_zone'];?></td>
					</tr>
					<tr>
						<td style="border-bottom: 1px solid;padding: 0 2px;text-align: left;font-weight:bold;">&nbsp;Fine Aggregate Type :-</td>
						<td style="border-bottom: 1px solid;padding: 0 2px;border-left: 1px solid;text-align: left;" colspan="3">&nbsp;<?php echo $row_select4['fine_agg_type'];?></td>
					</tr>
					<!--<tr>
	...
	<table align="center" width="90%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-left:2px solid; border-right:2px solid;border-top: 0;">
			<tr>
				<td  colspan="5"  style="border: 0px solid black; font-weight:bold; text-align:left;border-bottom: 0px solid black;">TEST RESULT</td>	
				
			</tr>
			<tr>
						<td style="padding: 1px 0;border: 1px solid;" colspan="5"></td>
					</tr>
	</table>
	<?php if ($row_select_pipe['pass_sample_1'] != "" && $row_select_pipe['pass_sample_1'] != "0") { ?>
						...
						<table align="center" width="90%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;border-left:2px solid; border-right:2px solid;">
							<tr style="text-align:center;">
								<td style="border:1px solid black;padding:2px 0;font-size:11px;border-top:0px;"><b>Sr.No.</b></td>
								<td style="border:1px solid black;border-right:1px solid black;border-top:0px;padding:2px 0;font-size:11px;"colspan="2"><b>Test Name</b></td>
								<td style="border:1px solid black;border-right:1px solid black;border-top:0px;padding:2px 0;font-size:11px;"><b>Test Method</b></td>
								<td style="border:1px solid black;border-right:1px solid black;border-top:0px;padding:2px 0;font-size:11px;"><b>Results</b></td>
								<td style="border:1px solid black;border-right:1px solid black;border-top:0px;padding:2px 0;font-size:11px;"><b>Unit</b></td>
								<td style="border:1px solid black;border-right:1px solid black;border-top:0px;padding:2px 0;font-size:11px;"colspan="4"><b>Requirement Specification as per IS : 383 : 2016</b></td>
							</tr>
							<tr style="text-align:center;">
								<td style="border:1px solid black;border-left:1px solid black;padding:1px;"colspan="10"></td>
							</tr>
							<?php $cnt=1;?>
							<tr style="text-align:center;">
								<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"rowspan="9"><?php echo $cnt++;?></td>
								<td style="border:1px solid black;padding:2px 0;font-size:11px;"rowspan="9"><b>Sieve Analysis</b></td>
								<td style="border:1px solid black;padding:2px 0;font-size:11px;"><b>Sieve Size</b></td>
								<td style="border:1px solid black;padding:2px 0;font-size:11px;"rowspan="9"><b>IS : 2386 (Part-1) : 1963</b></td>
								<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;font-size:11px;"><b>Passing</b></td>
								<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;font-size:11px;"><b>%</b></td>
								<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;font-size:11px;"><b>Zone I</b></td>
								<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;font-size:11px;"><b>Zone II</b></td>
								<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;font-size:11px;"><b>Zone III</b></td>
								<td style="border:1px solid black;border-right:1px solid black;padding:2px 0;font-size:11px;"><b>Zone IV</b></td>
							</tr>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">10.0 mm</td>
									<td style="border:1px solid black;border-left:0px solid black;font-weight:bold;padding:2px 0;font-size:11px;"><?php echo number_format($row_select_pipe['pass_sample_1'], 2); ?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">%</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">100</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">100</td>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">0.600 mm</td>
									<td style="border:1px solid black;border-left:0px solid black;font-weight:bold;padding:2px 0;font-size:11px;"><?php echo number_format($row_select_pipe['pass_sample_5'], 2); ?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">%</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">15-34</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">35-59</td>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">0.300 mm</td>
									<td style="border:1px solid black;border-left:0px solid black;font-weight:bold;padding:2px 0;font-size:11px;"><?php echo number_format($row_select_pipe['pass_sample_6'], 2); ?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">%</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">5-20</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">8-30</td>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">0.150 mm</td>
									<td style="border:1px solid black;border-left:0px solid black;font-weight:bold;padding:2px 0;font-size:11px;"><?php echo number_format($row_select_pipe['pass_sample_7'], 2); ?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">%</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">0-10</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">0-10</td>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;">0.075 mm</td>
									<td style="border:1px solid black;border-left:0px solid black;font-weight:bold;padding:2px 0;font-size:11px;"><?php echo number_format($row_select_pipe['pass_sample_8'], 2); ?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">%</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">--</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">--</td>
							...
							?>
								<tr style="text-align:center;">
									<td rowspan="2" style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"rowspan="2">Bulk Density</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;">Loose</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"rowspan="4">IS : 2386 (Part-3) : 1963</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe['bdl'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">Kg/litre</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">--</td>
								</tr>
							...
							?>
								<tr style="text-align:center;">
									...
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;">Compacted</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-weight:bold;"><?php echo $row_select_pipe[''];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">Kg/litre</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">--</td>
								</tr>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;"colspan="2">Specific Gravity</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;font-weight:bold;"><?php echo $row_select_pipe['sp_specific_gravity'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">--</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">--</td>
								</tr>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;"colspan="2">Water Absorption</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;font-weight:bold;"><?php echo $row_select_pipe['sp_water_abr'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">%</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4">--</td>
								</tr>
							...
							if ($row_select_pipe['dele_1_4'] != "") {
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;"><?php echo $cnt++;?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;"colspan="3">Deleterious Materials</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;font-weight:bold;"><?php echo $row_select_pipe['dele_1_4'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">%</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4"><b>Max 5%</b></td>
								</tr>
							...
							?>
								<tr style="text-align:center;">
									<td style="border:1px solid black;border-left:1px solid black;padding:2px 0;text-align:right;">a.</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;"colspan="2">Materials Finer than 75 Micron Sieve</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;">IS : 2386 (Part-1)</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;font-size:11px;font-weight:bold;"><?php echo $row_select_pipe['avg_finer'];?></td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;">%</td>
									<td style="border:1px solid black;border-left:0px solid black;padding:2px 0;"colspan="4"><b>Max 3%</b></td>
								</tr>
								
								
								<tr style="text-align:center;">
									<td style="border:1px solid black;padding:1px;text-align:right;"colspan="10"></td>
								</tr>
