...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from con_cylinder WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0' ORDER BY `id`";
	...
	if (mysqli_num_rows($result_select4) > 0) {
		...
		$date_of_testing = $row_select4['test_date1'];
		$age_of_test = $row_select4['day1'];
	}
...
<br>
	...
	<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:60px;border: 1px solid;border: bottom: 0;">
		...
		<tr>
			...
			<tr style="">
                <td>
                    <table cellpadding="0" cellpadding="0" align="center" width="100%" style="" class="test">
                        <tr>
                        	<td style="font-size:11px;font-weight:bold;text-align:left;padding:5px 0 5px;font-family:Times New Roman; border-left:2px solid;border-right:2px solid;">A) Concrete Cylinder Test Result</td>
                        </tr>
                    </table>
                </td>
            </tr>
			...
			<tr>
			    <td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border: 1px solid black;border-left: 2px solid black;border-RIGHT: 2px solid black;">

						<tr style="">
							<td style="width:5%;font-size:11px;text-align:center;font-weight:bold;padding:7px 4px;"> Sr.<br>No.</td>
							<td style="width:10%;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:7px 4px;">Sample Size</td>
							<td style="width:12%;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:7px 4px;">Date Of <br>Casting *</td>
							<td style="width:12%;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:7px 4px;">Date Of  <br>Testing</td>
							<td style="font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:7px 4px;">Age Of Test <br> (days)</td>
							<td style="font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:7px 4px;">Result in mm</td>
							<td style="font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:7px 4px;">Acceptance Criteria</td>
							<td style="font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:7px 4px;">Grade *</td>
							<td style="font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:7px 4px;">ID Mark/Location *</td>
						</tr>

							<tr style="">
								<td style="border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $cnt++; ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $ans['day_remark']; ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%; text-align:center;"><?php echo date('d/m/Y', strtotime($ans['casting_date'])); ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo date('d/m/Y', strtotime($ans['test_date1'])); ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $ans['day1']; ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $ans['avg_com_s_1']; ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:7px 5px;" rowspan=3>Penetration of Water in mm <br> as per IRS Clause 54.2.1. Appendix-G p-112 for At first, a Pressure of 1 bar is applied for 48 hrs, then 3 bar for 24 hrs and 7 bar for 24 hrs. <b>Max. 25 mm</b></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $cc_grade; ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select4['material_location']; ?></td>
							</tr>

							<tr style="">
								<td style="border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $cnt++; ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $ans['day_remark']; ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;width:8.88%; text-align:center;"><?php echo date('d/m/Y', strtotime($row_select4['casting_date'])); ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo date('d/m/Y', strtotime($row_select4['test_date1'])); ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $ans['day1']; ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $ans['avg_com_s_1']; ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $cc_grade; ?></td>
								<td style="border-left: 1px solid black;border-top: 1px solid black;text-align:center;padding:5px 4px;"><?php echo $row_select4['material_location']; ?></td>
