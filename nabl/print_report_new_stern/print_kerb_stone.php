...
<br>
	...
	<page size="A4">
	<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:60px;border: 1px solid;border: bottom: 0; border-bottom:0px;">
		<tr>
			<td>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;">
					<tr>
						<td style="text-transform: uppercase;font-weight: bold;text-decoration: underline;text-align: center;font-size: 13px;padding: 2px 0;border-bottom: 1px solid;"  colspan="4">Test Report - KERB STONE TEST</td>
					</tr>
					<tr>
		...
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:13px;font-family : Calibri;border-right:1px solid black;border-left:1px solid black; border-top:0px solid black;  ">
					...
					<td>
						<table align="left" width="100%" class="test" style="height:Auto;width:100%;">
							<tr style="text-align:center;">
								<td style="border:1px solid black;width:7%;"><b>Sr.<br>No.</b></td>
								<td style="border:1px solid black;width:20%;"><b>Test Parameter</b></td>
								...
								<td style="border:1px solid black;width: 18%;"><b>Requirement as per IS <br>1077:1992</b></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="border:1px solid black; text-align:center;padding:7px 3px;"><b>2</b></td>
							...
							<tr style="text-align:center;">
								...
								<td style="border:1px solid black; text-align:left;padding:7px 3px;">&nbsp; 10 minutes</td>
							...
							<tr style="text-align:center;">
								<td style="border:1px solid black; text-align:left;padding:7px 3px;">&nbsp; 24 hours</td>
								<td style="border:1px solid black; text-align:center;"><?php if ($row_select_pipe1['avg_wtr'] != "" && $row_select_pipe1['avg_wtr'] != "0" && $row_select_pipe1['avg_wtr'] != null) {
																							echo $row_select_pipe1['avg_wtr'];
																						} else {
																							echo " <br>";
							...
							<tr style="text-align:center;">
								<td style="border:1px solid black; text-align:center;padding:7px 3px;"> 3 </td>
							...
							<tr style="text-align:center; height:30px;">
								<td style="border:1px solid black; text-align:center;padding:7px 3px;"> 4 </td>
