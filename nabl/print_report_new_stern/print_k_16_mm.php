					...
					<table align="center" width="100%" border="0px" class="test" style="border-bottom:1px solid black;">
						...
						?>
							<tr>
								...
								<td style="width:22%;padding-top:3px;">&nbsp;&nbsp;<b></b></td>
								<td style="width:3%;font-family : Calibri;font-weight:bold;"></td>
						...
						if ($sample_de != "" && $sample_de != null && $sample_de != "0") {
						?>
							<tr>
								<td style="width:20%;padding-top:3px;padding-bottom:3px;">&nbsp;&nbsp;<b>Description of Material</b></td>
								<td style="width:3%;font-family : Calibri;font-weight:bold;">:</td>
								<td style="width:14%">&nbsp;&nbsp;<?php echo $sample_de; ?></td>
					...
					<table align="left" width="100%" border="0px" cellspacing="0" cellpadding="0" class="test" style="border-left:2px solid black; border-right:2px solid;">
						...
						?>
							<tr>
								...
								?>
									<td colspan="3" style="width:49%;padding-bottom:4px;font-weight:bold;font-size:11px;">B) Physical Tests</td>
								<?php } else { ?>
									...
									<tr>
										<td style="text-align:center;border:1px solid black;border-left:0px solid black;padding:5px 4px;"> Sieve Size</td>
												...
												<td style="border-right:1px solid black;">
													<table style="width:100%;border-collapse: collapse;">
														<tr>
															<td style="font-size:11px;text-align:center;border-bottom:0px solid black;padding:5px 4px;">Acceptance Critaria <br> as per MoRTH</td>
														</tr>
													</table>
										       </td>
									</tr>
										...
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:2px 0;">20 mm</td>
										...
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:2px 0;">16 mm</td>
										...
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:0px solid black;padding:2px 0;">10 mm</td>
											...
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">0-30</td>
								...
								<table align="top" width="100%" class="test" style="font-size:11px;font-family : Calibri;">
									...
									?>
										<tr>
											...
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left: 1px solid black;font-weight:bold;padding:5px 4px;border-right:0px;"><b>Test Results</b></td>
										</tr>
										<?php
										...
										?>
											<tr>
												...
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;"><?php echo $row_select_pipe['combined_index']; ?></td>
											</tr>
										...
										?>
											<tr>
												...
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;;">IS 2386-4</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;"><?php echo $row_select_pipe['imp_value']; ?></td>
											</tr>
										<?php
										}
						...
						<?php
						if (($row_select_pipe['alk_10'] != "" && $row_select_pipe['alk_10'] != "0") || ($row_select_pipe['soundness'] != "" && $row_select_pipe['soundness'] != "0") || ($row_select_pipe['dele_1_4'] != "" && $row_select_pipe['dele_1_4'] != "0") || ($row_select_pipe['dele_2_3'] != "" && $row_select_pipe['dele_2_3'] != "0") || ($row_select_pipe['dele_3_3'] != "" && $row_select_pipe['dele_3_3'] != "0") || ($row_select_pipe['dele_4_3'] != "" && $row_select_pipe['dele_4_3'] != "0") || ($row_select_pipe['avg_clr'] != "" && $row_select_pipe['avg_clr'] != "0") || ($row_select_pipe['avg_ph'] != "" && $row_select_pipe['avg_ph'] != "0") || ($row_select_pipe['avg_sul'] != "" && $row_select_pipe['avg_sul'] != "0") || ($row_select_pipe['avg_clr'] != "" && $row_select_pipe['avg_clr'] != "0") || ($row_select_pipe['aoi_4'] != "" && $row_select_pipe['aoi_4'] != "0")) {
						?>
							<tr>
								<td colspan="5" style="width:98%;padding-bottom:5px;font-weight:bold;font-size:11px;padding-top:7px;"><b>Chemical Tests</b></td>
								<td style="width:2%"><b>&nbsp;</b></td>
							</tr>
							<tr>
								...
								<td colspan="6" style="width:100%">
									<table align="center" width="100%" class="test" style="height:100%;width:100%;">
										<tr>
											<td colspan="3" style="font-size:11px;text-align:center;border:1px solid black;border-left: 0px solid black;font-weight:bold;padding:5px 4px;"><b>Test Name</b></td>
										...
										?>
											<tr>
												<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:0px solid black;padding:2px 4px;">Alkali Reactivity Test (Gravimetric Method)</td>
												...
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;"><?php echo $row_select_pipe['alk_10']; ?></td>
											</tr>
										<?php
										}
										...
										?>
											<tr>
												...
												<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:0px solid black;padding:2px 4px;">Soundness Na<sub>2</sub>SO<sub>4</sub> %</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Max. 12%</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">IS 2386-5</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;"><?php echo $row_select_pipe['soundness']; ?></td>
											</tr>
										<?php
										}
										...
										?>
											<tr>
												...
												<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:0px solid black;padding:2px 4px;">Total of percentages of all deleterious Materials<br>(except mica), %</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Max. 2%</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">IS 2386-1,2</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;"><?php
										...
										if ($row_select_pipe['dele_3_3'] != "") {
										?>
											<tr>

												<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:0px solid black;padding:2px 4px;">Coal &amp; Lignite, %</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Max. 1%</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">IS 2386-2</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;"><?php
										...
										?>
											<tr>
												...
												<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:0px solid black;padding:2px 4px;">Clay &amp; Lumps, %</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Max. 1%</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">IS 2386-2</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;"><?php echo $row_select_pipe['dele_2_3']; ?></td>
											</tr>
										<?php
										}
										...
										?>
											<tr>
												...
												<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:0px solid black;padding:2px 4px;">Soft Particles, %</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">-</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">IS 2386-2</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;"><?php echo $row_select_pipe['dele_4_3']; ?></td>
											</tr>
										<?php
										}
										...
										?>
											<tr>
												...
												<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:0px solid black;padding:2px 4px;">Material Finer than 75&mu;, %</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Max. 1%</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">IS 2386-1</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;"><?php echo $row_select_pipe['dele_1_4']; ?></td>
											</tr>
										<?php
										}
										...
										?>
											<tr>
												...
												<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:0px solid black;padding:2px 4px;">Organic Impurities</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">-</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">IS 2386-2</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;"><?php
										...
										?>
											<tr>
												...
												<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:0px solid black;padding:2px 4px;">pH</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">-</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">IS 2720-26</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;"><?php echo $row_select_pipe['avg_ph']; ?></td>
											</tr>
										<?php
										}
										if ($row_select_pipe['avg_sul'] != "" && $row_select_pipe['avg_sul'] != "0") {
										?>
											<tr>

												<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:0px solid black;padding:2px 4px;">Sulphate, %</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">-</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">IS 2720-27</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;"><?php echo $row_select_pipe['avg_sul']; ?></td>
											</tr>
										<?php
										}
										...
										?>
											<tr>
												...
												<td colspan="3" style="font-size:11px;text-align:left;border:1px solid black;border-left:0px solid black;padding:2px 4px; border-bottom:0px;">Cloride Content, %</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-bottom:0px;">-</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-bottom:0px;">BS EN 1744-1</td>
												<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;border-right:0px;border-bottom:0px;"><?php echo $row_select_pipe['avg_clr']; ?></td>
											</tr>
										<?php } ?>
									</table>
