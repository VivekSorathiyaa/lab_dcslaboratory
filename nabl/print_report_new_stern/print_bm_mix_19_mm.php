...
<body>
	...
	$trf_no = $_GET['trf_no'];
	$select_tiles_query = "select * from bm_mix_19_mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
    ...
    <tr>
        ...
        <td style="padding:2px;text-align: left;"><b>&nbsp; : &nbsp;</b><?php echo $lab_no;?></td>
			...
			<tr style="">
                ...
                <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0px;border-right:0px;border-bottom:0px;" rowspan="8">IS 2386 PART-1</td>
			...
			<tr style="">
                ...
                <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0px;border-right:1px solid;border-bottom:0px;">56-88</td>
            </tr>
			<tr style="">
                <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0px;border-right:0px;border-bottom:0px;"></td>
                ...
                <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0px;border-right:1px solid;border-bottom:0px;">16-36</td>
            </tr>
			<tr style="">
                <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0px;border-right:0px;border-bottom:0px;"></td>
                        ...
                        <tr style="display:flex; ">
							...
							<table align="top" width="100%" class="test" style="max-width:400px;font-size:11px;font-family : Calibri;">
									...
									<tr>
                                        ...
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">56-88</td>
                                    </tr>
									<tr>
                                        ...
                                        <td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">16-36</td>
                                    </tr>
									<tr>
