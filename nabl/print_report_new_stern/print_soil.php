...
<br>
	...
	<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:60px;">
		<tr>
			<td>
				...
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;">
					<tr>
						<td style="text-transform: uppercase;font-weight: bold;text-decoration: underline;text-align: center;font-size: 15px;padding: 2px 0;"  colspan="4">TITLE : TEST REPORT OF &nbsp;<?php echo $mt_name;?>
						</td>
					</tr>
				</table>
				<br>	
    ...
    <tr>
        <td style="border-bottom: 0px solid;padding:2px;text-align: left;font-weight: bold;">&nbsp;Type / Category of Material</td>
        <td style="border-bottom: 0px solid;padding:2px;text-align: left;" colspan="4"><b>&nbsp; : &nbsp;</b><?php echo $soil_location;?></td>
    ...
    <tr>
        ...
        <td style="padding:2px;text-align: left;"><b>&nbsp; : &nbsp;</b>-</td>
    </tr>
</table>
				<!--<table align="left" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;border-top: 1px solid;border-bottom: 0;padding-bottom:20px;">
						
						<tr>
							<td style="border-bottom: 1px solid;padding: 0 2px;text-align: left;font-weight: bold;border-left:1px solid;">&nbsp;Name of Work :-</td>
							<td style="border-bottom: 1px solid;padding: 0 2px;border-left: 1px solid;text-align: left;border-right:1px solid;" colspan="6">&nbsp;<?php echo $name_of_work;?></td>
						</tr>
						<tr>
							<td style="border-bottom: 1px solid;padding: 0 2px;text-align: left;font-weight: bold;border-left:1px solid;">&nbsp;Name of Client :-</td>
							<td style="border-bottom: 1px solid;padding: 0 2px;border-left: 1px solid;text-align: left;border-right:1px solid;" colspan="6">&nbsp;<?php echo $clientname;?></td>
						</tr>
						<tr>
							<td style="border-bottom: 1px solid;padding: 0 2px;text-align: left;font-weight: bold;border-left:1px solid;">&nbsp;Name of Agency :-</td>
							<td style="border-bottom: 1px solid;padding: 0 2px;border-left: 1px solid;text-align: left;" colspan="4">&nbsp;<?php echo $agency_name;?></td>
							<td style="text-align: left;border-left: 1px solid;font-weight: bold;border-bottom:1px solid;" rowspan="2">&nbsp;Sender's Reference</td>
							<td style="padding: 0 2px;text-align: left;border-left: 1px solid;border-right:1px solid;">&nbsp;<?php echo $r_name; ?>&nbsp;&nbsp;<?php
																									if ($row_select["date"] != "" && $row_select["date"] != "null" && $row_select["date"] != "0000-00-00"  && $row_select["date"] != "1970-01-01" ) {
																									?>Date: <?php echo date('d/m/Y', strtotime($row_select["date"]));
																									} else {
																									}
						...
						<tr>
							<td style="border-bottom: 1px solid;padding: 0 2px;text-align: left;font-weight: bold;border-left:1px solid;">&nbsp;Type / Category of Material :-</td>
							<td style="border-bottom: 1px solid;padding: 0 2px;border-left: 1px solid;text-align: left;" colspan="4">&nbsp;<?php echo $soil_location;?></td>
							<td style="border-top: 1px solid;padding: 0 2px;text-align: left;border-left: 1px solid;border-bottom:1px solid;border-right:1px solid;">&nbsp;Date :- <?php echo date('d/m/Y', strtotime($rec_sample_date));?></td>
						</tr>
						
						<tr>
							<td style="border-bottom: 0px solid;padding: 0 2px;text-align: left;font-weight: bold;border-left:1px solid;">&nbsp;Date of Receipt Sample :-</td>
							...
							<td style="text-align: left;border-left: 1px solid;font-weight: bold;">&nbsp;Identification Mark</td>
							<td style="padding: 0 2px;text-align: left;border-left: 1px solid;border-right:1px solid;">&nbsp;-</td>
						</tr>
						
						<tr>
							<td style="border-top: 1px solid;padding: 0 2px;text-align: left;font-weight: bold;border-left:1px solid;">&nbsp;Date of Test Performed :-</td>
							...
							<td style="border-top: 1px solid;padding: 0 2px;text-align: left;border-left: 1px solid;border-right:1px solid;">&nbsp;<?php echo $job_no;?></td>
						</tr>
						<tr>
							<td style="border-top: 1px solid;padding: 0 2px;text-align: left;font-weight: bold;border-left:1px solid;">&nbsp;Enviromental Condition :-</td>
							...
							<td style="border-top: 1px solid;padding: 0 2px;text-align: left;border-left: 1px solid;font-weight: bold;">&nbsp;Lab No. :- </td>
							<td style="border-top: 1px solid;padding: 0 2px;text-align: left;border-left: 1px solid;border-right:1px solid;">&nbsp;<?php echo $lab_no;?></td>
						</tr>
						<tr>
							<td style="border-top: 1px solid;border-bottom: 1px solid;padding: 0 2px;text-align: left;font-weight: bold;border-left:1px solid;">&nbsp;Sampling Method :-</td>
							<td style="border-top: 1px solid;border-bottom: 1px solid;padding: 0 2px;border-left: 1px solid;text-align: left;" colspan="4">&nbsp;Sample Collected by the Supplier</td>
							<td style="border-top: 1px solid;border-bottom: 1px solid;padding: 0 2px;text-align: left;border-left: 1px solid;font-weight: bold;">&nbsp;Quantity from which <br>&nbsp;Sample is Collected :- </td>
							<td style="border-top: 1px solid;border-bottom: 1px solid;padding: 0 2px;text-align: left;border-left: 1px solid;border-right:1px solid;">&nbsp;-</td>
						</tr>
				</table>
				...
				<?php $cnt=1;?>
	<table align="left" width="100%" height="35%"  class="test" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;border-right:1px solid;">
			
					<tr>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;" rowspan="3">Lab No.</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;transform: rotate(-90deg);" rowspan="3">Particulars</td>
						
						<?php //if (($row_select_pipe['grain1'] != "" && $row_select_pipe['grain1'] != "0" && $row_select_pipe['grain1'] != null) || ($row_select_pipe['grain2'] != "" && $row_select_pipe['grain2'] != "0" && $row_select_pipe['grain2'] != null) || ($row_select_pipe['grain3'] != "" && $row_select_pipe['grain3'] != "0" && $row_select_pipe['grain3'] != null)) { ?>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;;" colspan="3">Sieve Analysis</td>
						<?php //} if (($row_select_pipe['a1'] != "" && $row_select_pipe['a1'] != "0" && $row_select_pipe['a1'] != null) || ($row_select_pipe['a2'] != "" && $row_select_pipe['a2'] != "0" && $row_select_pipe['a2'] != null) || ($row_select_pipe['a3'] != "" && $row_select_pipe['a3'] != "0" && $row_select_pipe['a3'] != null)) { ?>
						...
						<?php //} if (($row_select_pipe['so1'] != "" && $row_select_pipe['so1'] != "0" && $row_select_pipe['so1'] != null)) { ?>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="3">I.S. Classifications</td>
						<?php// } if (($row_select_pipe['h1'] != "" && $row_select_pipe['h1'] != "0" && $row_select_pipe['h1'] != null) || ($row_select_pipe['h2'] != "" && $row_select_pipe['h2'] != "0" && $row_select_pipe['h2'] != null)) { ?>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;" colspan=2>Light</td>
						<?php// } if (($row_select_pipe['sp1'] != "" && $row_select_pipe['sp1'] != "0" && $row_select_pipe['sp1'] != null)) { ?>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="3">FDD gm/cc</td>
						<?php //} if (($row_select_pipe['sw1'] != "" && $row_select_pipe['sw1'] != "0" && $row_select_pipe['sw1'] != null) || ($row_select_pipe['f1'] != "" && $row_select_pipe['f1'] != "0" && $row_select_pipe['f1'] != null)) { ?>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;transform: rotate(-90deg);" rowspan="3">FMC %</td>
						<?php// } if (($row_select_pipe['shp_type'] != "" && $row_select_pipe['shp_type'] != "0" && $row_select_pipe['shp_type'] != null) || ($row_select_pipe['shp_c'] != "" && $row_select_pipe['shp_c'] != "0" && $row_select_pipe['shp_c'] != null) || ($row_select_pipe['shp_deg'] != "" && $row_select_pipe['shp_deg'] != "0" && $row_select_pipe['shp_deg'] != null)) { ?>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;" colspan=2>Relative Density</td>
						<?php //} if (($row_select_pipe['s1'] != "" && $row_select_pipe['s1'] != "0" && $row_select_pipe['s1'] != null)) { ?>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;" colspan=3>Remoulded CBR at</td>				
                       <?php //} if (($row_select_pipe['per_1'] != "" && $row_select_pipe['per_1'] != "0" && $row_select_pipe['per_1'] != null)) { ?>						
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:10px 4px;"></td>
						<?php //}  ?>	
					</tr>
			
					<tr>
					<?php //if (($row_select_pipe['grain1'] != "" && $row_select_pipe['grain1'] != "0" && $row_select_pipe['grain1'] != null) || ($row_select_pipe['grain2'] != "" && $row_select_pipe['grain2'] != "0" && $row_select_pipe['grain2'] != null) || ($row_select_pipe['grain3'] != "" && $row_select_pipe['grain3'] != "0" && $row_select_pipe['grain3'] != null)) { ?>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);width:12%;">Gravel %</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);width:12%;">Sand %</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);width:12%;">Silt + Clay %</td>
						
						<?php //} if (($row_select_pipe['a1'] != "" && $row_select_pipe['a1'] != "0" && $row_select_pipe['a1'] != null) || ($row_select_pipe['a2'] != "" && $row_select_pipe['a2'] != "0" && $row_select_pipe['a2'] != null) || ($row_select_pipe['a3'] != "" && $row_select_pipe['a3'] != "0" && $row_select_pipe['a3'] != null)) { ?>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="2">L.L. %</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="2">P.L. %</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="2">P.I.</td>
						<?php //} if (($row_select_pipe['h1'] != "" && $row_select_pipe['h1'] != "0" && $row_select_pipe['h1'] != null) || ($row_select_pipe['h2'] != "" && $row_select_pipe['h2'] != "0" && $row_select_pipe['h2'] != null)) { ?>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="2">MDD gm/cc</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="2">OMC %</td>
						<?php //} if (($row_select_pipe['sw1'] != "" && $row_select_pipe['sw1'] != "0" && $row_select_pipe['sw1'] != null) || ($row_select_pipe['f1'] != "" && $row_select_pipe['f1'] != "0" && $row_select_pipe['f1'] != null)) { ?>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="2">Minimum Density <br>gm/cc</td>									
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="2">Maximum Density <br>gm/cc</td>
						<?php// } if (($row_select_pipe['shp_type'] != "" && $row_select_pipe['shp_type'] != "0" && $row_select_pipe['shp_type'] != null) || ($row_select_pipe['shp_c'] != "" && $row_select_pipe['shp_c'] != "0" && $row_select_pipe['shp_c'] != null) || ($row_select_pipe['shp_deg'] != "" && $row_select_pipe['shp_deg'] != "0" && $row_select_pipe['shp_deg'] != null)) { ?>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="2">Unsoaked %</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="2">Soaked %</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="2">MC% after<br>Saturation</td>
						<?php //} if (($row_select_pipe['loadpt3'] != "" && $row_select_pipe['loadpt3'] != "0" && $row_select_pipe['loadpt3'] != null) || ($row_select_pipe['loadpt6'] != "" && $row_select_pipe['loadpt6'] != "0" && $row_select_pipe['loadpt6'] != null)) { ?>				
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;writing-mode: tb-rl;transform: rotate(-180deg);" rowspan="2">Free Swell Index</td>
						<?php //} ?>
					</tr>	
					<tr>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">4.75mm <br>to Above</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">0.075mm to<br> 4.75mm</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">0.002mm<br>to 0.075mm <br>Below</td>
					</tr>	
					<tr>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"colspan="2">TEST METHOD</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"colspan="3">IS:2720 (Part-4):1985<br> Reaffirmed:2020</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"colspan="3">IS:2720 (Part-5):1985<br> Reaffirmed:2020</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">-</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"colspan="2">IS:2720 (Part-8):<br> 1983 <br>Reaffirmed:2020</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;"colspan="3">IS:2720 (Part-16):1987<br> Reaffirmed:2016</td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;">IS 2720<br> Part-40</td>
					</tr>
<?php $cnt=1?>					
					<tr>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;width:7%;"><?php echo $cnt++;?></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;width:7%;"><?php echo $cnt++;?></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;width:7%;"><?php echo $cnt++;?></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;width:7%;"><?php echo $cnt++;?></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;width:7%;"><?php echo $cnt++;?></td>
						...
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;width:7%;"><?php echo $cnt++;?></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;width:7%;"><?php echo $cnt++;?></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;width:7%;" colspan="2"><?php echo $cnt++;?></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;width:7%;"><?php echo $cnt++;?></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;width:7%;"><?php echo $cnt++;?></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;width:7%;"><?php echo $cnt++;?></td>
						<td style="border-top:1px solid;border-left: 1px solid black;text-align:center;font-weight:bold;padding:5px 4px;width:7%;"><?php echo $cnt++;?></td>
					...
					<tr>
						...
						<?php //if (($row_select_pipe['grain1'] != "" && $row_select_pipe['grain1'] != "0" && $row_select_pipe['grain1'] != null) || ($row_select_pipe['grain2'] != "" && $row_select_pipe['grain2'] != "0" && $row_select_pipe['grain2'] != null) || ($row_select_pipe['grain3'] != "" && $row_select_pipe['grain3'] != "0" && $row_select_pipe['grain3'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['grain7']; ?></td>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['grain8']; ?></td>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;" ><?php echo $row_select_pipe['grain9']; ?></td>
						<?php //} if (($row_select_pipe['a1'] != "" && $row_select_pipe['a1'] != "0" && $row_select_pipe['a1'] != null) || ($row_select_pipe['a2'] != "" && $row_select_pipe['a2'] != "0" && $row_select_pipe['a2'] != null) || ($row_select_pipe['a3'] != "" && $row_select_pipe['a3'] != "0" && $row_select_pipe['a3'] != null)) { ?>
						...
						<?php //} if (($row_select_pipe['h1'] != "" && $row_select_pipe['h1'] != "0" && $row_select_pipe['h1'] != null) || ($row_select_pipe['h2'] != "" && $row_select_pipe['h2'] != "0" && $row_select_pipe['h2'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['l1']; ?></td>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['l2']; ?></td>
						<?php //} if (($row_select_pipe['sp1'] != "" && $row_select_pipe['sp1'] != "0" && $row_select_pipe['sp1'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['fdry12']; ?></td>	<?php //} if (($row_select_pipe['sw1'] != "" && $row_select_pipe['sw1'] != "0" && $row_select_pipe['sw1'] != null) || ($row_select_pipe['f1'] != "" && $row_select_pipe['f1'] != "0" && $row_select_pipe['f1'] != null)) { ?>					
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['moi_12']; ?></td>
						...
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php //echo $row_select_pipe['shp_deg']; ?></td>
						<?php //} if (($row_select_pipe['shp_type'] != "" && $row_select_pipe['shp_type'] != "0" && $row_select_pipe['shp_type'] != null) || ($row_select_pipe['shp_c'] != "" && $row_select_pipe['shp_c'] != "0" && $row_select_pipe['shp_c'] != null) || ($row_select_pipe['shp_deg'] != "" && $row_select_pipe['shp_deg'] != "0" && $row_select_pipe['shp_deg'] != null)) { ?>
						...
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['cbr1']; ?></td>									
					...
					<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;padding-top:20px;">
	...
	<!--<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;margin-top:60px;border: 1px solid;border: bottom: 0;">
		<tr>
			<td>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;">
					<tr>
						<td style="text-transform: uppercase;font-weight: bold;text-decoration: underline;text-align: center;font-size: 13px;padding: 2px 0;border-bottom: 1px solid;"  colspan="4">TEST REPORT - SOIL</td>
					</tr>
					<tr>
				...
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;border-top: 0;border-bottom: 0;">
					...
					<tr>
							...
							<td style="border-bottom: 1px solid;padding: 0 2px;text-align: center;border-left: 1px solid;">&nbsp;Soil &amp; Rock</td>
						</tr>
						<tr>
		...
		<tr>
			...
			<td>
				<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family : Calibri;font-weight: bold;border: 1px solid;border-top: 0;border-bottom: 0;">
					...
					<tr>
						<td style="border-bottom: 1px solid;padding: 0 2px;text-align: right;">&nbsp;Sample Source :-</td>
						<td style="border-bottom: 1px solid;padding: 0 2px;border-left: 1px solid;text-align: left;" colspan="3">&nbsp;<?php echo $source; ?></td>
					</tr>
					
					<tr>
						<td style="border-bottom: 1px solid;padding: 0 2px;text-align: right;">&nbsp;Sample Type:-</td>
	...
	<?php $cnt=1;?>
	<table align="left" width="100%" height="35%"  class="test" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;border-right:2px solid;border-left:2px solid;border-top:0px;">
					...
					<tr>
						...
						<?php } if (($row_select_pipe['sp1'] != "" && $row_select_pipe['sp1'] != "0" && $row_select_pipe['sp1'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['sp1']; ?></td>	<?php } if (($row_select_pipe['sw1'] != "" && $row_select_pipe['sw1'] != "0" && $row_select_pipe['sw1'] != null) || ($row_select_pipe['f1'] != "" && $row_select_pipe['f1'] != "0" && $row_select_pipe['f1'] != null)) { ?>					
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['sw1']; ?></td>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['f1']; ?></td>
						<?php } if (($row_select_pipe['shp_type'] != "" && $row_select_pipe['shp_type'] != "0" && $row_select_pipe['shp_type'] != null) || ($row_select_pipe['shp_c'] != "" && $row_select_pipe['shp_c'] != "0" && $row_select_pipe['shp_c'] != null) || ($row_select_pipe['shp_deg'] != "" && $row_select_pipe['shp_deg'] != "0" && $row_select_pipe['shp_deg'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['shp_type']; ?></td>
						
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['shp_c']; ?></td>									
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['shp_deg']; ?></td>
						<?php } if (($row_select_pipe['s1'] != "" && $row_select_pipe['s1'] != "0" && $row_select_pipe['s1'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['s1']; ?></td>
						 <?php } if (($row_select_pipe['per_1'] != "" && $row_select_pipe['per_1'] != "0" && $row_select_pipe['per_1'] != null)) { ?>		
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo $row_select_pipe['per_1']; ?>	</td>
						<?php } if (($row_select_pipe['loadpt3'] != "" && $row_select_pipe['loadpt3'] != "0" && $row_select_pipe['loadpt3'] != null) || ($row_select_pipe['loadpt6'] != "" && $row_select_pipe['loadpt6'] != "0" && $row_select_pipe['loadpt6'] != null)) { ?>				
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:10px 0;"><?php echo ($row_select_pipe['loadpt3'] + $row_select_pipe['loadpt6']) / 2; ?></td>
						<?php } ?>
					</tr>
					...
					<tr>
						...
						<?php if (($row_select_pipe['grain1'] != "" && $row_select_pipe['grain1'] != "0" && $row_select_pipe['grain1'] != null) || ($row_select_pipe['grain2'] != "" && $row_select_pipe['grain2'] != "0" && $row_select_pipe['grain2'] != null) || ($row_select_pipe['grain3'] != "" && $row_select_pipe['grain3'] != "0" && $row_select_pipe['grain3'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=4>IS 2720 part-4</td>
						  <?php } if (($row_select_pipe['a1'] != "" && $row_select_pipe['a1'] != "0" && $row_select_pipe['a1'] != null) || ($row_select_pipe['a2'] != "" && $row_select_pipe['a2'] != "0" && $row_select_pipe['a2'] != null) || ($row_select_pipe['a3'] != "" && $row_select_pipe['a3'] != "0" && $row_select_pipe['a3'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=3>Is 2720 Part-5</td>
						 <?php } if (($row_select_pipe['so1'] != "" && $row_select_pipe['so1'] != "0" && $row_select_pipe['so1'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=1>IS 1498</td>
						<?php } if (($row_select_pipe['h1'] != "" && $row_select_pipe['h1'] != "0" && $row_select_pipe['h1'] != null) || ($row_select_pipe['h2'] != "" && $row_select_pipe['h2'] != "0" && $row_select_pipe['h2'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=2>IS 2720 Part-8</td>
						<?php } if (($row_select_pipe['sp1'] != "" && $row_select_pipe['sp1'] != "0" && $row_select_pipe['sp1'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=1>IS 2720 Part-3</td>
						<?php } if (($row_select_pipe['sw1'] != "" && $row_select_pipe['sw1'] != "0" && $row_select_pipe['sw1'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=1>IS 2720 Part-41</td>
						<?php } if (($row_select_pipe['f1'] != "" && $row_select_pipe['f1'] != "0" && $row_select_pipe['f1'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=1>IS 2720 Part-40</td>
						<?php } if (($row_select_pipe['shp_type'] != "" && $row_select_pipe['shp_type'] != "0" && $row_select_pipe['shp_type'] != null) || ($row_select_pipe['shp_c'] != "" && $row_select_pipe['shp_c'] != "0" && $row_select_pipe['shp_c'] != null) || ($row_select_pipe['shp_deg'] != "" && $row_select_pipe['shp_deg'] != "0" && $row_select_pipe['shp_deg'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=3>IS 2720 Part-11 & 13</td>
						<?php } if (($row_select_pipe['s1'] != "" && $row_select_pipe['s1'] != "0" && $row_select_pipe['s1'] != null)) { ?>
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=1>IS 2720 Part-6</td> <?php } if (($row_select_pipe['per_1'] != "" && $row_select_pipe['per_1'] != "0" && $row_select_pipe['per_1'] != null)) { ?>											
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=1>IS 2720 Part-17</td>
						<?php } if (($row_select_pipe['loadpt3'] != "" && $row_select_pipe['loadpt3'] != "0" && $row_select_pipe['loadpt3'] != null) || ($row_select_pipe['loadpt6'] != "" && $row_select_pipe['loadpt6'] != "0" && $row_select_pipe['loadpt6'] != null)) { ?>				
						<td style="font-size:11px;text-align:center;border:1px solid black;padding:5px 4px;border-left:1px solid black;padding:5px 0;" colspan=1>IS 2720 Part-16</td>
						<?php } ?>
					</tr>
				</table>
