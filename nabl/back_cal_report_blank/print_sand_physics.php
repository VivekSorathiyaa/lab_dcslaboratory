...
<body>
	...
	<page size="A4">
		...
		<table align="center"
			...
			<tr>
				<td style="width: 20%;text-align: center;font-weight: bolder;border-right: 1px solid;" rowspan="8"><img
			...
			<tr>
				<td style="text-align: center;font-weight: bold;font-size: 11px;font-family: 'calibri';font-size: 14px;"
					colspan="7">(Formerly Known as DC Consultants)</td>
			</tr>
			<tr>
				<td style="text-align: center;font-weight: bold;font-size: 11px;font-family: 'calibri';font-size: 14px;"
					colspan="7">Geo Technical Investigation, Construction Material Testing Facility, Designing
					Structures,</td>
			</tr>
			<tr>
				<td style="text-align: center;font-weight: bold;font-size: 11px;font-family: 'calibri';font-size: 14px;"
					colspan="7">DPR’s and other Civil Engineering Consultancy Services</td>
			</tr>
			<tr>
				<td style="text-align: center;font-weight: bold;font-size: 11px;font-family: 'calibri';font-size: 14px;"
					colspan="7">CIN : U71100HP2024PTC010626, GSTIN : 02AAKCD6125G1ZZ</td>
			</tr>
			<tr>
				<td style="text-align: center;font-weight: bold;font-size: 11px;font-family: 'calibri';font-size: 14px;"
					colspan="7">Regd. Office : VPO Taragarh , Near Taragarh Palace, Tehsil Baijnath, Distt. Kangra (H.P)
					(176081)</td>
			</tr>
			<tr>
				<td style="text-align: center;font-weight: bold;font-size: 11px;font-family: 'calibri';font-size: 14px;"
					colspan="7">Mobile : +91-7018819894, 01894 295-074 E-mail : officialdcspvtltd@gmail.com</td>
			</tr>
			<tr>
				<td
			...
			<tr>
				...
				<td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
					<b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Sieve Analysis)</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="3"><b>&nbsp;Sample
		...
		<table align="center"
			...
			<tr>
				<td style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Job Card
						No:&nbsp;</b><?php echo $_GET['job_no']; ?></td>
				<td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
					<b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Water Absorption)</td>
			</tr>
			<tr>
				<td style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Sample
						Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?></td>
		...
		<table align="center" style="width: 95%;text-align: center;border: 1px solid black;" cellspacing="3px"
			cellpadding="3px">
			<tr>
				<td style="font-family: 'Calibri';font-size: 20px;font-weight: bold;" colspan="7"> Water Absorption of
					Fine Aggregate As Per (IS(2386:Part-3))</td>
			</tr>
		</table>
		<br>
		<table align="center" style="width: 95%;text-align: center;font-family: 'calibri';border: 1px solid;"
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Wt.of saturated surface dry
					aggregate in air (W1)gm</td>
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Wt.of oven dried aggregate
					in air (w2)gm</td>
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Water absorption =
					(W1-W2)*100/W2(%)</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['avg_finer']; ?>
				</td>
		...
		<table align="center"
			...
			<tr>
				<td style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Job Card
						No:&nbsp;</b><?php echo $_GET['job_no']; ?></td>
				<td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
					<b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Bulk Density Compacted)</td>
			</tr>
			<tr>
				<td style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Sample
						Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?></td>
		...
		<table align="center" style="width: 95%;text-align: center;font-family: 'calibri';border: 1px solid;"
			...
			<tr>
				...
				<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">Volume of Container (Ltr)
				</td>
			...
			<tr>
				...
				<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">Wt. of Empty Container (Kg)
				</td>
			...
			<tr>
				...
				<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">Wt.of Empty Container +
					Agg.(kg)</td>
			...
			<tr>
				...
				<td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['den_mo_vol1']; ?>
				</td>
			...
			<tr>
				...
				<td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['den_mo_vol2']; ?>
				</td>
		...
		<table align="center" style="width: 95%;text-align: center;border:1px solid;" cellspacing="5px"
			cellpadding="5px">
			<tr>
				<td style="font-family: 'Calibri';font-size: 20px;font-weight: bold;" colspan="7">Clay and Lumps IS 2386
					Part-2 1963/R2016</td>
			</tr>
		</table>
		<br>
		<table align="center" style="width: 95%;text-align: center;font-family: 'calibri';border: 1px solid;"
			...
			<tr>
				<td style="border-top: 1px solid;border-right: 1px solid;">1</td>
				<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Wt.of Oven dry Sample in gms
					(A)</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['dele_2_1']; ?>
				</td>
				<td style="border-top: 1px solid;"><?php echo $row_select_pipe['dele_4_1']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-right: 1px solid;">2</td>
				<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Wt.of Sample after removal
					of clay lump in gm (b)
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['dele_2_2']; ?>
				</td>
				<td style="border-top: 1px solid;"><?php echo $row_select_pipe['dele_4_2']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-right: 1px solid;">3</td>
				<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">% of Clay & Lump (A-B)/Ax100
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['dele_2_3']; ?>
				</td>
		...
		<table align="center" style="width: 95%;text-align: center;border:1px solid;" cellspacing="5px"
			cellpadding="5px">
			<tr>
				<td style="font-family: 'Calibri';font-size: 20px;font-weight: bold;" colspan="7">Material Finer Than 75
					Micron IS 2386 Part-1 1963/R2016</td>
			</tr>
		</table>
		<br>
		<table align="center" style="width: 95%;text-align: center;font-family: 'calibri';border: 1px solid;"
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['dele_1_1']; ?>
				</td>
				<td style="border-top: 1px solid;"><?php echo $row_select_pipe['dele_3_1']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-right: 1px solid;">2</td>
				<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Wt.of Washed Retained Sample
					on 75 Micron IS Sieve (after the Oven dried) in gms</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['dele_1_2']; ?>
				</td>
				<td style="border-top: 1px solid;"><?php echo $row_select_pipe['dele_3_2']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-right: 1px solid;">3</td>
				<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">% 75 micron IS Sieve
					(A-B)/Ax100</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['dele_1_4']; ?>
				</td>
		...
		<table align="center"
			...
			<tr>
				<td style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Job Card
						No:&nbsp;</b><?php echo $_GET['job_no']; ?></td>
				<td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
					<b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Silt Content)</td>
			</tr>
			<tr>
				<td style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Sample
						Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?></td>
		...
		<br><br><br>
		<table align="center" style="width: 95%;text-align: center;border: 1px solid;" cellspacing="0"
			cellpadding="5px">
			<tr>
		...
		<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="10px">
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;text-align: center;border-right: 1px solid;">1
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Volume of Sample (V1), ml
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['slp_s1_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['slp_s2_1']; ?>
				</td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;text-align: center;border-right: 1px solid;">2
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;">Volume of Silt after three
					hours (V2), ml </td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['slp_s1_2']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['slp_s2_2']; ?>
				</td>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;text-align: center;border-right: 1px solid;">3
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;text-align: left;"> Percentage Silt by Volume
					V2/V1X100 %</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['slp_s1_3']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['slp_s2_3']; ?>
				</td>
			</tr>
			<tr>
				<td
					...
					4</td>
				<td style="border-top: 1px solid;border-bottom: 1px solid; border-right: 1px solid;text-align: left;">
					Average</td>
		...
		<table align="center"
			...
			<tr>
				<td style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Job Card
						No:&nbsp;</b><?php echo $_GET['job_no']; ?></td>
				<td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
					<b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Bulk Density Losse)</td>
			</tr>
			<tr>
				<td style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Sample
						Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?></td>
		...
		<table align="center" style="width: 95%;text-align: center;border: 1px solid;" cellspacing="5px"
			cellpadding="5px" bordercolor="black">
			<tr>
				<td style="font-family: 'Calibri';font-size: 20px;font-weight: bold;" colspan="7">BULK DENSITY (LOOSE)
				</td>
			</tr>
		</table>
		<br><br><br>
		<table align="center" style="width: 95%;text-align: center;font-family: 'calibri';border: 1px solid;"
			...
			<tr>
				...
				<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">Wt.of Empty Container +
					Agg.(kg)</td>
				<td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['weight_1']; ?>
				</td>
			...
			<tr>
				<td style="border-right: 1px solid;border-top: 1px solid;">5</td>
				<td style="border-right: 1px solid;border-top: 1px solid;text-align: left;">Bulk Density (Kg/Ltr)</td>
				<td style="border-right: 1px solid;border-top: 1px solid;"><?php echo $row_select_pipe['den_voids']; ?>
				</td>
		...
		<table align="center"
			...
			<tr>
				<td style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Job Card
						No:&nbsp;</b><?php echo $_GET['job_no']; ?></td>
				<td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
					<b>&nbsp;Test:&nbsp;</b>Fine Aggregate&nbsp;(Specific Gravity & water Absorption)</td>
			</tr>
			<tr>
				<td style="text-align: left;border-top: 1px solid;" colspan="4"><b>&nbsp;Sample
						Description:&nbsp;</b><?php echo $row_select_pipe['s_des']; ?></td>
		...
		<table align="center" style="width: 95%;">
			<tr>
				<td style="font-family: 'calibri';font-size: 16px;font-weight: bold;">Specific Gravity/Water Absorption
					of Coarse Aggregates As Per IS 2386 Part-3</td>
			</tr>
		</table>
		<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="5px">
			<tr>
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['sp_wt_st_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['sp_wt_st_2']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"></td>
			</tr>
			<tr>
				<td
					style="border-top: 1px solid;border-left: 1px solid;text-align: left;width: 50%;border-right: 1px solid;">
					Mass of Pycnometer contaning Aggregate and <br>Filled with Distilled Water </td>
				<td style="border-top: 1px solid;border-right: 1px solid;">B</td>
				<td style="border-top: 1px solid;border-right: 1px solid;">gm</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['sp_wt_bas1']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['sp_wt_bas2']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"></td>
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-right: 1px solid;">gm</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['sp_w_s_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['sp_w_s_2']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"></td>
			</tr>
			<tr>
				...
				<td style="border-top: 1px solid;border-right: 1px solid;">gm</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['sp_w_sur_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['sp_w_sur_2']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-right: 1px solid;"></td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><? php// echo $row_select_pipe['sp_apr1']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php //echo $row_select_pipe['sp_apr2']; ?>
				</td>
				<td style="border-top: 1px solid;border-right: 1px solid;">
			...
			<tr>
				<td
					...
					Water Absorption</td>
				<td style="border-top: 1px solid;border-right: 1px solid;border-bottom: 1px solid;width: 600px;">
					(A-D)/DX100</td>
				<td style="border-top: 1px solid;border-right: 1px solid;border-bottom: 1px solid;"></td>
				<td style="border-top: 1px solid;border-right: 1px solid;border-bottom: 1px solid;width: 200px;">
					<?php //echo $row_select_pipe['sp_water_abr_1']; ?></td>
				<td style="border-top: 1px solid;border-right: 1px solid;border-bottom: 1px solid;width: 200px;">
					<?php //echo $row_select_pipe['sp_water_abr_2']; ?></td>
				<td style="border-top: 1px solid;border-right: 1px solid;border-bottom: 1px solid;width: 100px;">
