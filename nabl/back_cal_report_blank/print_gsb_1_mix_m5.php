    ...
    <page size="A4">
        <?php if ($row_select_pipe['pass_sample_1'] != "" && $row_select_pipe['pass_sample_1'] != null) { ?>
            ...
            <table align="center"
                ...
                <tr>
                    <td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 13px;" colspan="7">
                        Mobile : +91-7018819894, +91-9816755805,e-mail : officialdcspvtltd@gmail.com</td>
                </tr>
                <tr>
                    <td style="text-align: center;font-weight: bold;font-size: 11px;font-family: 'calibri';font-size: 14px;"
                        colspan="7">Regd. Office : VPO Taragarh (Rani Di K) Near Taragarh Palace Tehsil Baijnath</td>
                </tr>
                <tr>
                    <td style="text-align: center;font-weight: bold;font-size: 11px;font-family: 'calibri';font-size: 14px;"
                ...
                <tr>
                    ...
                    <td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
                        &nbsp;Test:&nbsp;GSB&nbsp;(SIEVE ANALYSIS)</td>
                </tr>
                <tr>
                    <td style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample
                        Description:&nbsp;<?php echo $sample_de; ?></td>
                    <td style="text-align: left;border-top: 1px solid;border-left: 1px solid;font-size:12px" colspan="4">
                        &nbsp;Method:&nbsp;As per MORTH
                        specification</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-align: left;border-top: 1px solid;font-size:12px" colspan="3">&nbsp;Sample
                        Qty:&nbsp;<?php echo $row_select_pipe['cc_qty']; ?></td>
            ...
            <table align="center" style="width: 95%;text-align: center;border: 1px solid;" cellspacing="5px"
                ...
                <tr>
                    <td style="font-family: 'Calibri';font-size: 25px;font-weight: bold;" colspan="7">GRANULAR SUB BASE
                        (SIEVE ANALYSIS)</td>
                </tr>
            </table>
            <br>
            <table align="center" style="width: 95%;">
                <tr>
                    <td style="font-family: 'calibri';font-size: 16px;font-weight: bold;">
                        Sieve Analysis GSB GRADE <u>&nbsp;&nbsp;I&nbsp;&nbsp;</u> [As Per MORTH Specification]</td>
                </tr>
            </table>
            <br>
            <table align="center" style="width: 95%;">
            ...
            <table align="center"
                ...
                <tr>
                    <td style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card
                        No:&nbsp;<?php echo $job_no; ?></td>
                    <td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
                        &nbsp;Test:&nbsp;Bulk Density (Compacted)</td>
                </tr>
                <tr>
                    <td style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample
                        Description:&nbsp;<?php echo $sample_de; ?></td>
            ...
            <table align="center"
                ...
                <tr>
                    <td style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card
                        No:&nbsp;<?php echo $job_no; ?></td>
                    <td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
                        &nbsp;Test:&nbsp;Specific Gravity & Water Absorption</td>
                </tr>
                <tr>
                    <td style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample
                        Description:&nbsp;<?php echo $sample_de; ?></td>
