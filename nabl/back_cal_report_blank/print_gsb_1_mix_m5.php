...
<body>
	...
	?>
        ...
        <table align="center" style="width: 95%;text-align: center;border:1px solid black;font-family: 'calibri';font-size: 12px"  cellspacing="0" cellpadding="2px" bordercolor ="black" >
                ...
                <tr>
                    <td style="text-align: center;border-top: 1px solid;font-weight: bold;border-right: 1px solid;font-family: 'calibri';font-size: 20px;">GSB</td>
                ...
                <tr>
                    ...
                    <td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;Test:&nbsp;GSB&nbsp;(SIEVE ANALYSIS)</td>
                </tr>
                <tr>
                    <td style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample Description:&nbsp;<?php echo $sample_de;?></td>
                    <td style="text-align: left;border-top: 1px solid;border-left: 1px solid;font-size:12px" colspan="4">&nbsp;Method:&nbsp;As per MORTH
                specification</td>
                </tr>
                <tr>
			 ...
			 <tr>
                <td style="text-align: left;border-top: 1px solid;font-size:12px" colspan="3">&nbsp;Sample Qty:&nbsp;<?php echo $row_select_pipe['cc_qty'];?></td>
       ...
       <br><br><br>			
        <table align="center" style="width: 95%;text-align: center;border: 1px solid;"  cellspacing="5px" cellpadding="5px" bordercolor ="black">
            <tr>
                <td style="font-family: 'Calibri';font-size: 25px;font-weight: bold;" colspan="7">GRANULAR SUB BASE  (SIEVE ANALYSIS)</td>
            </tr>
        </table>
        <br>
...
<tr>
	...
	<table align="center" style="width: 95%;text-align: center;border:1px solid black;font-family: 'calibri';font-size: 12px"  cellspacing="0" cellpadding="2px" bordercolor ="black" >
			...
			<tr>
                ...
                <td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;Test:&nbsp;(SIEVE ANALYSIS)</td>
            </tr>
			<tr>
                <td style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample Description:&nbsp;<?php echo $sample_de;?></td>
