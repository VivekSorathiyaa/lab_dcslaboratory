...
<body>
<page size="A4">
<table align="center" style="width: 100%;text-align: center;border:0.5px solid;">
<tr>
<td>
<br>
...
<td style="text-align: left;border-top: 1px solid;border-left:1px solid;" colspan="2">&nbsp;DOS:&nbsp;</td>
<td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="2">&nbsp;DOC:&nbsp;</td>
...
<br>
<br>
<!-- Main content tables go here, with all dynamic PHP content replaced by empty cells or placeholders -->
<!-- Example static table row: -->
<table align="center" style="width: 100%;">
<tr>
<td style="font-family: 'calibri';font-size: 18px;font-weight: bold;text-align: center;"><u>______</u>&nbsp;&nbsp;Days Testing Compressive Strength of  Concrete Cubes of Grade/Ratio&nbsp;&nbsp;<u>______</u>&nbsp;&nbsp;</td>
</tr>
</table>
<table align="center" style="width: 95%;">
<tr>
<td style="font-family: 'calibri';font-size: 16px;font-weight: bold;text-align: center;">As Per IS (516:Part1/Sec1: 2021)</td>
</tr>
</table>
<br>
...
<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;">Weight <br>of Cube <br>(grams)</td>
...
<!-- Add static rows as needed -->
<tr>
<td style="border-top: 1px solid;border-left: 1px solid;">1.</td>
<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;" rowspan="3"></td>
<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;" rowspan="3"></td>
<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;"></td>
<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;"></td>
<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;"></td>
<td style="border-top: 1px solid;border-left: 1px solid;font-weight: bold;border-right: 1px solid;"></td>
</tr>
<tr>
...
<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;border-bottom: 1px solid; font-weight: bold;"></td>
</tr>
</table>
<!-- Add more static tables and rows as needed, replacing all PHP code with empty cells or placeholders -->
<br>
<br>
<br>
<br>
