...
<body>
    ...
    <page size="A4">
        ...
        <table align="center" style="width: 95%;">
            <tr>
                <td style="font-family: 'Calibri';"><b>Pouring Temp</b>&nbsp;&nbsp;&nbsp; <u>
                        <?php echo $row_select_pipe['duc_temp']; ?> </u> &nbsp;&nbsp;&nbsp; <b>Period of Cooling in
                        Air</b> &nbsp;&nbsp;&nbsp;<u> <?php echo $row_select_pipe['air_1']; ?> </u> &nbsp;&nbsp;&nbsp;<b>
                        Period of Cooling in Water Bath </b> &nbsp;&nbsp;&nbsp;<u>
                        <?php echo $row_select_pipe['bath_1']; ?></u> </td>
            </tr>
        </table>
        <br><br>
        </table>
        <table align="center" style="width: 95%;" cellspacing="0" cellpadding="10px">
            <tr>
                <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid; text-align: center;font-family: 'calibri';font-size: 20px;font-weight: bold;"
                    colspan="3">DUCTILITY TEST OF BITUMEN <br>(As Per IS: 1208)</td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;text-align: center;font-family: 'calibri';font-size: 17px;font-weight: bold;"
                    colspan="3">OBSERVATION TABLE</td>
            </tr>
            <tr>
                <td
                    style="border-top: 1px solid;border-left: 1px solid;text-align: center;font-family: 'calibri'; font-weight: bold;width: 25%;">
                    Sample</td>
                <td
                    style="border-top: 1px solid;border-left: 1px solid;text-align: center;font-family: 'calibri';font-weight: bold;width: 25%;">
                    Ductility in cm.</td>
                <td
                    style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-weight: bold;text-align: center;">
                    Average</td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left: 1px solid;text-align: center;">1</td>
                <td style="border-top: 1px solid;border-left: 1px solid;text-align: center;">
                    <?php echo $row_select_pipe['duc_1']; ?></td>
                <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;text-align: center;">
                    <?php echo $row_select_pipe['duc_2']; ?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;text-align: center;">3
                </td>
                <td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;text-align: center;">
                    <?php echo $row_select_pipe['duc_3']; ?></td>
        ...
        <table align="center" style="width: 95%;font-family: 'calibri';" cellspacing="0" cellpadding="2px">
            <tr>
                <td
                    style="border-top: 1px solid;border-left: 1px solid;text-align: center;font-weight: bold;width: 15%;">
                    S.NO</td>
                <td
                    style="border-top: 1px solid;border-left: 1px solid;text-align: center;font-weight: bold;width: 50%;">
                    DETERMINATION</td>
                <td
                    style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-weight: bold;text-align: center;">
                </td>
            </tr>
            <tr>
                ...
                <td
                    style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;text-align: center;text-align: center;font-weight: bold;">
                    Average</td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left: 1px solid;text-align: center;">1</td>
                <td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['sp_a_1']; ?></td>
                <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;text-align: center;text-align: center;font-weight: bold;"
                    rowspan="2"><?php echo $row_select_pipe['sp_1']; ?></td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left: 1px solid;text-align: center;">2</td>
            ...
            <tr>
                ...
                <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;text-align: center;text-align: center;border-bottom: 1px solid;font-weight: bold;"
                    rowspan="2"><?php echo $row_select_pipe['avg_sp']; ?></td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left: 1px solid;text-align: center;border-bottom: 1px solid;">2
                </td>
                <td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;">
                    <?php echo $row_select_pipe['sp_c_1']; ?></td>
            </tr>
        </table>
        <br>
        <br>
        ...
        <table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="5px">
            <tr>
                <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 20px;font-weight: bold;"
                    colspan="5">PENETRATION TEST OF BITUMEN <br>(As Per IS :1203)</td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 20px;font-weight: bold;"
                    colspan="5">OBSERVATION TABLE</td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-weight: bold;">SNo.
                </td>
            ...
            <tr>
                ...
                <td style="border-top: 1px solid;border-right: 1px solid;">Penetration <br> (in 1/10 of mm) in 5 seconds
                </td>
            ...
            <tr>
                <td style="border-top: 1px solid;border-bottom: 1px solid;border-left: 1px solid;border-right: 1px solid;font-weight: bold;"
                    colspan="2">Average:</td>
                <td style="border-top: 1px solid;border-bottom: 1px solid;border-right: 1px solid;" colspan="3">
                    <?php echo $row_select_pipe['avg_pen']; ?></td>
            </tr>
        </table>
        <br>
        <br>
        ...
        <table align="center"
            ...
            <tr>
                <td style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Job Card No:&nbsp;
                    <? php// echo $job_no; ?>
                </td>
                <td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;Test:&nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: left;border-top: 1px solid;" colspan="4">&nbsp;Sample Description:&nbsp;
                    <?php //echo $row_select_pipe['s_des']; ?>
                </td>
                <td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">
                    &nbsp;Method:&nbsp;
                </td>
            ...
            <tr>
                <td style="text-align: left;border-top: 1px solid;" colspan="2">&nbsp;DOR:&nbsp;
                    <?php //echo date('d/m/Y', strtotime($row_select['sample_rec_date'])); ?>
                </td>
                <td style="text-align: left;border-top: 1px solid;border-left:1px solid;" colspan="2">&nbsp;DOS:&nbsp;
                    <?php //echo date('d-m-y', strtotime($row_select2['start_date'])); ?>
                </td>
                <td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="2">&nbsp;DOC:&nbsp;
                    <? php// echo date('d-m-y', strtotime($row_select2['end_date'])); ?>
                </td>
                <td style="text-align: left;border-top: 1px solid;border-left:1px solid;" colspan="2">&nbsp;Page
                    No:&nbsp;2</td>
            </tr>
            <tr>
                <td style="text-align: left;border-top: 1px solid;" colspan="3">&nbsp;Sample Qty:&nbsp;
                    <?php //echo $row_select_pipe['qty_1']; ?>
                </td>
                <td style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="2"> &nbsp;Residual
                    Sample:&nbsp;
                    <?php //echo $row_select_pipe['r_sam']; ?>
                </td>
                <td style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="3">&nbsp;Sample
                    Retention:&nbsp;
                    <?php //echo $row_select_pipe['s_ret']; ?>
                </td>
            </tr>
        </table>
        <br><br>
        <table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="2px">
            <tr>
                <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 20px;font-weight: bold;"
                    colspan="5">SOFTENING POINT TEST OF BITUMEN<br>(As Per IS :1205)</td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;font-family: 'calibri';font-size: 20px;font-weight: bold;"
                    colspan="5"><u>OBSERVATION TABLE</u></td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left : 1px solid;font-weight: bold;" colspan="2"><u>Ball-1</u>
                </td>
                <td style="border-top: 1px solid;border-left : 1px solid;font-weight: bold;border-right: 1px solid;"
                    colspan="3"><u>Ball-2</u></td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left : 1px solid;font-size: 15px;">TIME ( MINUTES)</td>
                <td style="border-top: 1px solid;border-left : 1px solid;font-size: 15px;">TEMP. OF WATER <br>BATH
                    &deg;C</td>
                <td style="border-top: 1px solid;border-left : 1px solid;font-size: 15px;" colspan="2">TIME <br>(
                    MINUTES)</td>
                <td style="border-top: 1px solid;border-left : 1px solid;font-size: 15px;border-right: 1px solid;">TEMP.
                    OF WATER <br>BATH &deg;C</td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left : 1px solid;">0</td>
                <td style="border-top: 1px solid;border-left : 1px solid;">
                    <?php echo $row_select_pipe['tw1']; ?>
                </td>
            ...
            <tr>
                ...
                <td style="border-top: 1px solid;border-left : 1px solid;">
                    <?php echo $row_select_pipe['tw19']; ?>
                </td>
                <td style="border-top: 1px solid;border-left : 1px solid;" colspan="2">9</td>
                <td style="border-top: 1px solid;border-left : 1px solid;border-right: 1px solid;">
                    <?php echo $row_select_pipe['tw20']; ?>
                </td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left : 1px solid;">10</td>
                <td style="border-top: 1px solid;border-left : 1px solid;">
                    <?php echo $row_select_pipe['tw21']; ?>
                </td>
                <td style="border-top: 1px solid;border-left : 1px solid;" colspan="2">10</td>
                <td style="border-top: 1px solid;border-left : 1px solid;border-right: 1px solid;">
                    <?php echo $row_select_pipe['tw22']; ?>
                </td>
            </tr>
            <tr>
                <td style="border-top: 1px solid;border-left : 1px solid;font-weight: bold;" colspan="2" rowspan="2">
                    TEST PROPERTY</td>
                <td style="border-top: 1px solid;border-left : 1px solid;font-weight: bold;" colspan="2">SAMPLE NO. 1
                </td>
                <td style="border-top: 1px solid;border-left : 1px solid;font-weight: bold;border-right: 1px solid;">
                    Mean Value</td>
            </tr>
            ...
            <tr>
                <td style="border-top: 1px solid;border-bottom: 1px solid;border-left : 1px solid;" colspan="2">
                    Temperature &deg;C at which sample touches <br>bottom plate</td>
                <td style="border-top: 1px solid;border-bottom: 1px solid;border-left : 1px solid;font-weight: bold;">
                    <?php echo $row_select_pipe['bn_1']; ?>
                </td>
                <td style="border-left: 1px solid;border-bottom: 1px solid;font-weight: bold;border-top:1px solid;">
                    <?php echo $row_select_pipe['bn_2']; ?>
                </td>
                <td style="font-weight: bold;border: 1px solid;">
                    <?php echo $row_select_pipe['avg_sof']; ?>
                </td>
            </tr>
        </table>
        <br>
        ...
        <table align="center" style="width: 92%;">
            <tr>
                <td style="border: 0;text-align: left;font-size: 15px;font-family: 'calibri'"><b>Tested by : <u>
                            <?php echo $u_name; ?>
                        </u></td></b>
                <td style="border: 0;text-align: right;font-size: 15px;font-family: 'calibri'"><b>Checked By: <u>
                            <?php echo $v_name; ?>
                        </u></td></b>
            </tr>
        </table>
