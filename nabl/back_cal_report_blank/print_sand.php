...
<body>
	...
	<page size="A4">
		...
		<table align="center"
			...
			<tr>
				<td style="text-align: center;font-weight: bold;font-size: 25px;" colspan="7">NextGenLIMS Technologies
				</td>
			</tr>
			<tr>
				<td style="text-align: center;font-size: 11px;font-size: 13px;" colspan="7">Mobile : +91-7018819894,
					+91-9816755805,e-mail : officialdcspvtltd@gmail.com</td>
			</tr>
			<tr>
				<td style="text-align: center;font-weight: bold;font-size: 11px;font-size: 14px;" colspan="7">Regd.
					Office : VPO Taragarh (Rani Di K) Near Taragarh Palace Tehsil Baijnath</td>
			</tr>
			<tr>
				<td style="text-align: center;font-weight: bold;font-size: 11px;font-size: 14px;" colspan="7">District
		...
		<table align="center"
			...
			<tr>
				<td style="text-align: left;border-top: 1px solid;" colspan="3"><b>&nbsp;Sample
						Qty:&nbsp;</b><?php // //$row_select_pipe['txt_qty']; ?></td>
				<td style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="2"><b>
						&nbsp;Residual Sample:&nbsp;</b><? php// echo $row_select_pipe['r_sam']; ?></td>
				<td style="text-align: left;border-top: 1px solid;border-left : 1px solid;" colspan="3"><b>&nbsp;Sample
						Retention:&nbsp;</b><?php //echo $row_select_pipe['s_ret']; ?></td>
		...
		<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="5px">
			...
			<tr>
				...
				<td style="border-top: 1px solid;border-right: 1px solid;"><?php echo $row_select_pipe['sp_avg_apr']; ?>
				</td>
			</tr>
			<tr>
				<td
