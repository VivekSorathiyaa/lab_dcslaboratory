...
<body>
	...
	$select_tiles_query = "select * from grit_6_10_mm WHERE `lab_no`='$lab_no' AND `report_no`='$report_no' AND `job_no`='$job_no' and `is_deleted`='0'";
	...
	<page size="A4" layout="landscape">
		...
		?>
			...
			<table align="center" width="90%" class="test" border="1px" height="30%">
				...
				<tr>
					<td colspan="3"><b>Weight of Pycnometer with water and Coarse Aggregate sample A (gms)</b></td>
					<td colspan="3">
