...
<br>
	...
	<br>
		<page size="A4">
            ...
            <tr>
                <td style="text-align: center;border-top: 1px solid;font-weight: bold;border-right: 1px solid;font-size: 20px;">Concrete Core</td>
	...
	<br>
		<table align="center" width="95%" cellpadding="0" style="font-size:11px;height:auto;font-family : Calibri;padding: 0;border-collapse: collapse;border-bottom:1px solid;">						
						<tr style="">
						...
						<td style="border-top:1px solid;font-size:11px;border-left: 1px solid black;text-align:center;font-weight:bold;padding:3px 0px;width:9%">CF for Dia 75±5 = 1.03 &lt;70 = 1.06</td> 
					...
					<tr style="">
						<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:3px 0px;border-right:0px;border-bottom:0px;"><br><?php// echo $cnt++; ?></td>
