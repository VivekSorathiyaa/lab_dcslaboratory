	...
	<page size="A4">
		<table align="center"
			...
			<tr>
				...
				<td style="text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="4">&nbsp;Test:&nbsp;
				</td>
			</tr>
			<tr>
		...
		<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0">
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;text-align: center;font-family: 'calibri';font-size: 17px;font-weight: bold;"
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><br><?php echo $row_select_pipe['com_l_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><br><?php echo $row_select_pipe['com_b_1']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<br><?php echo $row_select_pipe['com_area_1']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;">
					<br><?php echo $row_select_pipe['com_load_1']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					<br><?php echo $row_select_pipe['com_1']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><br><?php echo $row_select_pipe['com_l_2']; ?>
				</td>
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><br><?php echo $row_select_pipe['com_l_3']; ?>
				</td>
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><br><?php echo $row_select_pipe['com_l_4']; ?>
				</td>
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><br><?php echo $row_select_pipe['com_l_5']; ?>
				</td>
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><br><?php echo $row_select_pipe['com_l_6']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_b_6']; ?></td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_area_6']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['com_load_6']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
		...
		<table align="center" style="width: 95%;text-align: center;" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><br><?php echo $row_select_pipe['wtr_w1_2']; ?>
				</td>
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><br><?php echo $row_select_pipe['wtr_w1_3']; ?>
				</td>
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><br><?php echo $row_select_pipe['wtr_w1_4']; ?>
				</td>
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><br><?php echo $row_select_pipe['wtr_w1_5']; ?>
				</td>
			...
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;"><br><?php echo $row_select_pipe['wtr_w1_6']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"><?php echo $row_select_pipe['wtr_w2_6']; ?>
				</td>
				<td style="border-top: 1px solid;border-left: 1px solid;"></td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-right: 1px solid;">
					<?php echo $row_select_pipe['wtr_6']; ?></td>
			</tr>
			<tr>
				<td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;"><br></td>
				<td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;font-weight: bold;">
				...
				<td style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;font-weight: bold;">
					Avg.</td>
				<td
					style="border-top: 1px solid;border-left: 1px solid;border-bottom: 1px solid;border-right: 1px solid;">
