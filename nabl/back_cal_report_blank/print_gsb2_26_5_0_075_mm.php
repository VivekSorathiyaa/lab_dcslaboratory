...
<body>
	...
	<page size="A4">
		<table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:11px;font-family:Cambria;margin-top:80px;border-bottom:0px solid black;">
		    <tr>
					...
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="font-size:11px;font-family : Calibri;border-bottom:1px solid;">
						...
						?>
							<tr>
								...
								<td style="width:82%;font-size: 11px;text-align:left;padding-bottom: 4px;"> <?php echo $agSTCment_no; ?></td>
							</tr>
				...
				<td>
					<table align="center" width="100%" cellspacing="0" cellpadding="0" class="test" style="border-bottom:1px solid black;">
						...
						?>
							...
							<tr>
								<td style="width:20%;padding-top:3px;">&nbsp;&nbsp;<b>AgSTCment No.</b></td>
								<td style="width:3%;font-family : Calibri;font-weight:bold;"><b>:</b></td>
								<td style="width:77%">&nbsp;&nbsp;<?php echo $agSTCment_no; ?>
								</td>
							</tr>
						<?php
						}
						...
						<tr style="display:flex;">
								<td colspan="2" style="width:100%;vertical-align:top">
									<table align="top" width="100%" class="test" style="max-width:400px;font-size:11px;font-family : Calibri;">
										...
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">53 mm</td>
										...
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">26.5 mm</td>
										...
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">425 mic</td>
										...
										<tr>
											<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 0;">75 mic</td>
							...
							?>
								<td colspan="2" style="width:100%">
									<table width="100%" class="test" style="margin-left:15px;max-width:350px;font-size:11px;font-family : Calibri;">
											<tr>
										...
										?>
											...
											?>
												<tr>
													...
													<td style="font-size:11px;text-align:center;border:1px solid black;border-left:1px solid black;padding:2px 4px;">Max. 27%</td>
												</tr>
		...
		<table width="100%" align="center" style="font-family:Cambria;font-size:11px;">
						<tr>
