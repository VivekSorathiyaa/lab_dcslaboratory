        ...
        <tr>
            <td style="text-align:center;font-size:20px;">
                <table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:20px;font-family: Calibri;">
                    <tr>
                        <td style="width:100%;padding-bottom:10px;padding-top:10px;text-align:center;font-weight:bold;border-right:1px solid;border-left:1px solid;" colspan="3">OBSERVATION AND CALCULATION SHEET FOR TEST ON ULTRASONIC PULSE VELOCITY</td>
                    </tr>
        ...
        <tr>
            <td style="text-align:center;font-size:17px;">
                <table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:12px;">
                    <tr>
                        <td style="width:100%;padding-bottom:2px;padding-top:2px;text-align:center;font-weight:bold;"><span>OBSERVATION AND CALCULAITON SHEET FOR ULTRASONIC PULSE VELOCITY (IS 516 : Part-5- Sec-1-AMD No.1)</span></td>
                    </tr>
                </table><br>
            </td>
        </tr>
        <tr>
            <td style="text-align:center;font-size:13px;">
                <table align="center" width="100%" cellspacing="0" cellpadding="0" style="font-size:13px;font-family: Calibri;border:1px solid;margin-bottom:15px;">
                    ...
                    <tr>
                        <td style="border-top:1px solid;width:5%;font-weight:bold;text-align:center;">1</td>
                    ...
                    <tr>
                        <td style="border-top:1px solid;width:5%;font-weight:bold;text-align:center;">2</td>
                    ...
                    <tr>
                        <td style="border-top:1px solid;width:5%;font-weight:bold;text-align:center;">3</td>
                    ...
                    <tr>
                        <td style="border-top:1px solid;width:5%;font-weight:bold;text-align:center;">4</td>
                    ...
                    <tr>
                        <td style="border-top:1px solid;width:5%;font-weight:bold;text-align:center;">5</td>
                        <td style="border-top:1px solid;border-left:1px solid;width:15%;text-align:center;padding-bottom:10px;padding-top:10px;">Beam B - 05</td>
                        <td style="border-top:1px solid;border-left:1px solid;width:15%;text-align:center;"></td>
                        <td style="border-top:1px solid;border-left:1px solid;width:15%;text-align:center;"></td>
                        <td style="border-top:1px solid;border-left:1px solid;width:15%;text-align:center;"></td>
                        <td style="border-top:1px solid;border-left:1px solid;width:15%;text-align:center;"></td>
