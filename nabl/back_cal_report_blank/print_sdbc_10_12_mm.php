...
<html>
	<body>
			<?php
			 $select_tiles_query = "select * from sdbc_10_12_mm WHERE `bill_id`='$_GET[id]'  and `is_deleted`='0'";
		...
		<?php 
			...
			<table align="center" width="90%" class="test" border="1px" height="30%">
				...
				<tr>
					<td colspan="4"><center>Container</center></td>
					<td colspan="2"><center><?php echo $row_select_pipe['blank_extra'];?></center></td>
