...
<body>
	...
	<page size="A4">
		<table align="center" width="100%" style="font-size:11px;height:auto;font-family: Calibri;border-collapse: collapse;">
			<tr>
				<td style="font-size: 14px;font-weight: bold;text-align: center;padding: 5px;text-transform: uppercase;border: 1px solid;">CONCRETE COVER</td>
			</tr>
			<tr>
		...
		<table align="center" width="100%" style="font-size:11px;height:auto;font-family: Calibri;border-collapse: collapse;border-left: 1px solid;border-right: 1px solid;">
			...
			<tr>
				...
				<td style="font-weight: bold;padding: 5px;">CONCRETE COVER</td>
			</tr>
			<tr>
		...
		<table align="center" width="100%" class="test" style="border: 1px solid black;" cellpadding="5px">
			...
			<tr>
				...
				<td style="border-top:1px solid;border-left:1px solid;width:35%;text-align:center;padding-bottom:12px;padding-top:12px;">-</td>
				<td style="border-top:1px solid;border-left:1px solid;width:40%;text-align:center;">-</td>
