			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">GRAVEL</h2>
					</div>
													...
													<div class="panel-body">
														...
														<div class="row">
															<div class="col-md-12">
																<div class="col-lg-4">
																	<div class="form-group">
																		<label for="inputEmail3" class="col-sm-6 control-label">Relative Density</label>
																	</div>
																</div>
																<div class="col-lg-2">
																	<div class="form-group">
																		<input type="text" style="display:none;" class="form-control" id="avg_wom1" name="avg_wom1" readonly>
																	</div>
																</div>
																<div class="col-lg-1">
																	<div class="form-group">
																		<label for="inputEmail3" style="display:none;" class="col-sm-6 control-label">/ </label>
																	</div>
																</div>
																<div class="col-lg-2">
																	<div class="form-group">
																		<input type="text" style="display:none;" class="form-control" id="vol" name="vol">
																	</div>
																</div>
																<div class="col-lg-1">
																	<div class="form-group">
																...
																<div class="col-lg-2">
																	<div class="form-group">
																		<input type="text" class="form-control" id="bdl" name="bdl"> gm/cc.
																	</div>
																</div>
															</div>
										...
										<div class="col-lg-12">
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													<?php
													$querys_job1 = "SELECT * FROM gravel WHERE `is_deleted`='0' and lab_no='$lab_no'";
												...
												?>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>print_report/print_gravel.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>

													</div>
													<div class="col-sm-2">
														<a target='_blank' href="<?php echo $base_url; ?>back_cal_report/print_gravel.php?job_no=<?php echo $_GET['job_no']; ?>&&report_no=<?php echo $_GET['report_no']; ?>&&lab_no=<?php echo $_GET['lab_no']; ?>&&trf_no=<?php echo $_GET['trf_no']; ?>&&ulr=<?php echo $_GET['ulr']; ?>&&tbl_name=gravel" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
										...
										<div class="row">
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													...
													<?php
													$query = "select * from gravel WHERE lab_no='$aa'  and `is_deleted`='0'";
...
<script>
	...
	$(document).ready(function() {
		...
		function sp_auto() {
			...
			var sp_specificgravity = randomNumberFromRange(2.810, 2.860).toFixed(3); //(sp_specific_gravity)
			...
			var sp_waterabr = randomNumberFromRange(1.00, 1.15).toFixed(2); // (sp_water_abr)_1
		...
		function general_flk_elo1() {
			$('#txtflk').css("background-color", "var(--success)");
			var combined_index = randomNumberFromRange(17.0, 25.0).toFixed(1);
			...
			var suma = randomNumberFromRange(39000, 43000).toFixed();
			$('#suma').val(suma);
			var sum_a = $('#suma').val();
		...
		function crush_auto() {
			...
			var cru_value = randomNumberFromRange(18.0, 26.0).toFixed(1);
		...
		function den_auto() {
			...
			var bdl = randomNumberFromRange(2.12, 2.15).toFixed(2);
			var vol = 15.27;
			$('#bdl').val(bdl);
			$('#vol').val(vol);
			var bdl1 = $('#bdl').val();
		...
		function grd_auto() {
			...
			var pass_sample_2 = randomNumberFromRange(94.50, 98.50).toFixed(2);
			var pass_sample_3 = randomNumberFromRange(70.50, 89.50).toFixed(2);
			var pass_sample_4 = randomNumberFromRange(49.00, 61.00).toFixed(2);
			var pass_sample_5 = randomNumberFromRange(38.00, 42.00).toFixed(2);
			var pass_sample_6 = randomNumberFromRange(23.00, 32.00).toFixed(2);
			var pass_sample_7 = randomNumberFromRange(11.00, 18.00).toFixed(2);
			var pass_sample_8 = randomNumberFromRange(0.01, 6.50).toFixed(2);
	...
	function getGlazedTiles() {
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo $base_url; ?>save_gravel.php',
