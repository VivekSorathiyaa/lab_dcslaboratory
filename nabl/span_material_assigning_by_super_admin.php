...
if(isset($_POST["save_next"]))
{
	...
	$get_counts_of_materials=mysqli_num_rows($result_mate_counts);
		...
		if($get_counts_of_materials > 0)
		{
			...
			$update_jobs="update job set `material_assign`=1,`trf_no`='$set_trf_no', `tested_by`='$implode_tested_by',`tested_by_status`='$implode_tested_by_status' where `temporary_trf_no`='$txt_final_trf_no'";
			...
			$txt_final_user_id= $_POST["txt_final_user_id"];
	...
	window.location.href="<?php echo $base_url; ?>pending_proceed_compete_trf.php?userid=<?php echo $txt_final_user_id; ?>";
	</script>
	<?php
}
?>
				...
				<div class="col-md-12">
					<div class="box box-info">
						<form class="form" id="billing" method="post">
							...
							<div class="row">
								<div class="col-lg-12">
									<input type="hidden" value="<?php echo $_GET['userid'];?>" name="txt_final_user_id">
