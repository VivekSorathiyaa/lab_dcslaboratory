			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">GSB - IV MIX (M5)</h2>
					</div>
					...
					<div class="panel panel-default" id="grd">
								...
								<div class="row">
										...
										<div class="col-lg-2">
											<div class="form-group">
												<div class="col-sm-12">
													<input type="hidden" class="form-control" id="cum_wt_gm_5" name="cum_wt_gm_5" >
												</div>
											</div>
										</div>
										<div class="col-lg-2">
											<div class="form-group">
												<div class="col-sm-12">
													<input type="hidden" class="form-control" id="ret_wt_gm_5" name="ret_wt_gm_5" >
												</div>
											</div>
										</div>
										<div class="col-lg-2">
											<div class="form-group">
												<div class="col-sm-12">
													<input type="hidden" class="form-control" id="cum_ret_5" name="cum_ret_5" >
												</div>
											</div>
										</div>
										<div class="col-lg-2">
											<div class="form-group">
												<div class="col-sm-12">
													<input type="hidden" class="form-control" id="pass_sample_5" name="pass_sample_5" >
												</div>
											</div>
										</div>
										<div class="col-lg-2">
										<div class="form-group">
											<div class="col-sm-12">
												<input type="hidden" class="form-control" id="pass_range_5" name="pass_range_5" >
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<div class="col-sm-1">
												...
												<?php   
													$querys_job1 = "SELECT * FROM gsb_mix_4_m5 WHERE `is_deleted`='0' and lab_no='$lab_no'";
										...
										<!--	<div class="col-sm-2">
											...
											<?php //} ?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_gsb_1_mix_m5.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&tbl_name=gsb_mix_4_m5" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
					...
					<div class="col-lg-12">
						<table border="1px solid black" align="center" width="100%" id="aaaa">
							...
							<th style="text-align:center;"><label>Job No.</label></th>
								...
								<?php
							 $query = "select * from gsb_mix_4_m5 WHERE lab_no='$aa'  and `is_deleted`='0'";
...
//SOUNDNESS	
	...
	function grd_auto()
	{
		...
		$('#pass_range_2').val("85-100");
		$('#pass_range_3').val("0-20");
		$('#pass_range_4').val("0-5");
		
		
		var sample_taken=5000;
		//PASSING RANGE
		var pass_sample_1 = randomNumberFromRange(100, 100).toFixed(2);
		var pass_sample_2 = randomNumberFromRange(90.00,98.00).toFixed(2);
		var pass_sample_3 = randomNumberFromRange(10.00,19.00).toFixed(2);
		...
		var cum_ret_1 = ((+ret_wt_gm1)/(+blank_extra))*100;
		var cum_ret_2 = ((+ret_wt_gm2)/(+blank_extra))*100;
		var cum_ret_3 = ((+ret_wt_gm3)/(+blank_extra))*100;
		var cum_ret_4 = ((+ret_wt_gm4)/(+blank_extra))*100;
...
function getGlazedTiles(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo $base_url; ?>saveg4_26_5_0_075.php',
