                ...
                ?>
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $mat_name_array[$one_key]; ?>
                                </td>
                                <td>&nbsp;
        ...
        <table align="center" width="90%" class="test only_fonts " border="1px" id="table_1" style="font-family:arial;">
            <tbody>
                <tr>
                    ...
                    <td width="11%" style="text-align:right;border-left: 0px solid red;">&nbsp;<?php echo number_format($grand_total, 3); ?></td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    $(document).on("click", ".estimate_deletes", function() {
        ...
        $.confirm({
            title: "warning",
            content: "Are You Sure To Delete This Estimate ?",
            buttons: {
                confirm: function() {
                    $.ajax({
                        type: 'POST',
                        ...
                        success: function(html) {
                            window.location.href = "<?php echo $base_url; ?>list_of_estimate_biller.php";
