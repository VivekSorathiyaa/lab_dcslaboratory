			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h2 style="text-align:center;">Permeability Concrete</h2>
					</div>
								...
								<br>
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<?php   
													/*$querys_job1 = "SELECT * FROM permeability_concrete WHERE `is_deleted`='0' and lab_no='$lab_no'";
											...
											?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>print_report/print_permeability_concrete.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&ulr=<?php echo $_GET['ulr'];?>" class="btn btn-info pull-right" id="btn_report" name="btn_report"><b>Report</b></a>
 
											</div>
											
											<?php } ?>
											<div class="col-sm-2">
												<a target = '_blank' href="<?php echo $base_url; ?>back_cal_report/print_permeability_concrete.php?job_no=<?php echo $_GET['job_no'];?>&&report_no=<?php echo $_GET['report_no'];?>&&lab_no=<?php echo $_GET['lab_no'];?>&&trf_no=<?php echo $_GET['trf_no'];?>&&ulr=<?php echo $_GET['ulr'];?>" class="btn btn-info pull-right" id="btn_cal_report" name="btn_cal_report"><b>Calculation Report</b></a>
						...
						<div class="panel-body">
							...
							<div class="row">
								...
								<div class="col-md-5">
									...
									<div class="col-md-2">
										<div class="form-group">
											<label for="inputEmail3" class="control-label">Height MM</label>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
								...
								<div class="col-md-1">
									...
									<div class="col-md-12">
										<div class="form-group">
											<label for="inputEmail3" class="control-label">Depth of Penetration in mm</label>
										</div>
									</div>
								</div>
							...
							<!--Flakiness Index VALUE SR 1-->
								...
								<div class="col-md-5">
									...
									<div class="col-md-2">
										<div class="form-group">
											<input type="hidden" class="form-control" id="mass_1" name="mass_1" >
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<input type="hidden" class="form-control" id="load_1" name="load_1" >
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
							...
							<!--Flakiness Index VALUE SR 2-->
								...
								<div class="col-md-5">
									...
									<div class="col-md-2">
										<div class="form-group">
											<input type="hidden" class="form-control" id="mass_2" name="mass_2" >
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<input type="hidden" class="form-control" id="load_2" name="load_2" >
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
							...
							<!--Flakiness Index VALUE SR 3-->
								...
								<div class="col-md-5">
									...
									<div class="col-md-2">
										<div class="form-group">
											<input type="hidden" class="form-control" id="mass_3" name="mass_3" >
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
											<input type="hidden" class="form-control" id="load_3" name="load_3" >
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
							...
							<div class="row">
									...
									<div class="col-md-2">
										<div class="form-group">
											<label for="inputEmail3" class="control-label">Average depth of penetration in mm : </label>
										</div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
					...
					<div class="col-lg-12">
						<table border="1px solid black" align="center" width="100%" id="aaaa">
							<tr>
								...
								<?php
							 $query = "select * from permeability_concrete WHERE lab_no='$aa'  and `is_deleted`='0' ORDER BY `id`";
...
function getGlazedTiles(){
     ...
     $.ajax({
        type: 'POST',
        url: '<?php echo $base_url; ?>save_permeability_concrete.php',
