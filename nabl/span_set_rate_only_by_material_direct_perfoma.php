...
$sel_estiamte = "select * from estimate_total_span_only_for_material where `perfoma_no`='$perfoma_no' AND `est_isdeleted`=0";
					...
					<div class="box-body" style="border:1px groove #ddd;">
													...
													?>
														<tr>
															...
															<td>
																...
																<input type="text" name="material_names[]" class="form-control class_material_name" id="material_names" value="<?php echo $set_material_name_array[$mat_key]; ?>" disabled>
															</td>
															<td>
						...
						<div class="box box-info">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<button type="button" class="btn btn-info" onclick="addData('add_estimate_only_for_material_direct_perfoma')" name="btn_add_data" id="btn_add_data" style="width:100px;font-size:20px;">Save</button>

									<a href="matt_invoice_bill_by_material_direct_perfoma_print.php?perfoma_no=<?php echo $perfoma_nos; ?>" class="btn btn-info" title="" target="_blank" style="width:150px;font-size:20px;"><span class="glyphicon glyphicon-question-list"></span> Print</a>
									<br>
								</div>
								<div class="col-md-3">&nbsp;</div>
...
<script>
	...
	function get_table_after_update(id) {
		...
		$.ajax({
			type: 'POST',
			url: '<?php $base_url; ?>save_span_set_rate_material_direct_perfoma.php',
			data: billData,
			dataType: 'JSON',
	...
	function addData(type, id) {
		...
		var billData = '';
		if (type == 'add_estimate_only_for_material_direct_perfoma') {
			var txt_trf_no = "";
			var txt_job_no = "";
			var txt_invoice_no = "";
		...
		$.ajax({
			...
			success: function(msg) {
				...
				window.location.href = "<?php echo $base_url; ?>span_set_rate_only_by_material_direct_perfoma.php?perfoma_no=" + hidden_perfoma_nos;
