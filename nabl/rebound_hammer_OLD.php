							...
							<Br>
								...
								<div class="col-lg-4">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="rebound_qty" value="<?php echo $rebound_qty;?>" onchange="set_sample_qty()" name="rebound_qty">
											<input type="hidden" class="form-control" id="cc_sample_qty_old" value="<?php echo $rebound_qty;?>" name="cc_sample_qty_old">
										</div>
									</div>
								</div>
							</div>
				...
				<div id="collapse_rha" class="panel-collapse collapse">
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-2">
								<div class="form-group">											
									<label for="inputEmail3" class="control-label" style="text-align:right;">Grade of Concrete</label>	
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">											
						...
						<div class="row">
							<div class="col-md-2">
								<div class="form-group">											
									<label for="inputEmail3" class="control-label" style="text-align:right;">Vertical up/Down </label>	
								</div>
							</div>
							<div class="col-md-2">
								<div class="form-group">											
...
$('#rh_r1,#rh_r2,#rh_r3,#rh_r4,#rh_r5,#rh_r6,#rh_r7,#rh_r8,#rh_r9,#rh_r10').change(function(){
	...
	var avgr_num  = ((+rhr1) + (+rhr2) + (+rhr3) + (+rhr4) + (+rhr5) + (+rhr6) + (+rhr7) + (+rhr8) + (+rhr9) + (+rhr10) ) / 10;
	$('#avg_r_num').val(avgr_num.toFixed(2));
	
	var avgs = $('#avg_r_num').val();
	
	
	const datas = [rhr1, rhr2, rhr3, rhr4, rhr5, rhr6, rhr7, rhr8, rhr9, rhr10];
	...
	$('#rh_relation').val(relations.toFixed());
...
function getGlazedTiles(){
    ...
    $.ajax({
        type: 'POST',
        url: '<?php echo $base_url; ?>save_rebound_hammer.php',
