...
if(isset($_POST['action_type']) && !empty($_POST['action_type']))
	{
		...
		{
			$get_query = "select * from silica_fume WHERE id='$_POST[id]' AND `is_deleted`='0'"; 
											...
											<div class="col-lg-12">
												<table border="1px solid black" align="center" width="100%" id="aaaa">
													<tr>
														...
														<?php
													 $query = "select * from `silica_fume` WHERE lab_no='$lab_no' and `is_deleted`='0'";
		...
		<?php
			...
			$update="update silica_fume SET `job_no`='$_POST[job_no]',`lab_no`='$_POST[lab_no]',`report_no`='$_POST[report_no]',
	...
	elseif($_POST['action_type'] == 'delete'){
		 ...
		 $delete="update silica_fume SET `is_deleted`='1',`deleted_by`='$_SESSION[name]'WHERE `report_no`='$_POST[report_no]' and `lab_no`='$_POST[lab_no]' and `job_no`='$_POST[job_no]'";
	...
	elseif($_POST['action_type'] == 'chk'){
		...
		$qry = "SELECT * FROM silica_fume WHERE `id`='$_POST[id]'";
		$arr = mysqli_query($conn,$qry);
		$rows1=mysqli_num_rows($arr);
		while($r2 = mysqli_fetch_array($arr)){
				if($r2['checked_by']!="")
				{
					$c1c="update silica_fume SET `checked_by`='' WHERE `id`='$_POST[id]'";			
					$result_of_delete1=mysqli_query($conn,$c1c);	
				}
				else
				{
					$cc="update silica_fume SET `checked_by`='$_SESSION[name]' WHERE `id`='$_POST[id]'";			
