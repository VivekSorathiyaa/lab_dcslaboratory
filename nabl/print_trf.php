...
<body>
    ...
    <table align="center" style="width: 100%;text-align: center;border:1px solid black;font-family: 'calibri';font-size: 12px"  cellspacing="0" cellpadding="2px" bordercolor ="black" >
            ...
            <table align="center" style="width: 100%;text-align: center;font-family: 'calibri';font-size: 12px;border-right:1px solid;border-left:1px solid;"  cellspacing="0" cellpadding="2px" >
            <tr>
            ...
            <br><br>
            <table align="center" style="width: 100%;text-align: center;font-family: 'calibri';font-size: 12px;"  cellspacing="0" cellpadding="2px">
             <tr>
                <td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 17px;font-weight:bold;padding: 2px;"colspan="2"><u>SERVICE REQUEST FORM</u></td>
            </tr>
            </table>
            <table align="center" style="width: 100%;text-align: center;border:1px solid black;font-family: 'calibri';font-size: 12px;"  cellspacing="0" cellpadding="2px" >
           
            <tr>
                <td style="width:65%;text-align: left;" rowspan="2">&nbsp;<b>1. Name and Address of Customer </b><br>&nbsp;<?php echo $agency_name;?> <br>&nbsp;Govt Contractor <br>&nbsp;<?php echo $agency_address;?></td>
                <td style="width:35%;text-align: left;border-left: 1px solid;" colspan="">&nbsp;<b>Date of Booking:</b> <?php echo $put_sample_rec_date;?></td>
            </tr>
             <tr>
                <td style="text-align: left;border-top: 1px solid;border-left:1px solid;" colspan="">&nbsp;<u><b>CONTACT</b></u><br>&nbsp;Person: <?php echo $row_estiamte["person_name"];?><br>&nbsp;Phone/ Mobile: <?php echo $row_estiamte["person_auth_mobile"];?> </td>
            </tr>
            <tr>
                <td style="width:65%;text-align: left;border-top: 1px solid;" rowspan="">&nbsp;<b>2. Name of Work/Project</b></td>
                <td style="width:35%;text-align: left;border-top: 1px solid;border-left: 1px solid;" colspan="">&nbsp;E-mail: <?php echo $row_estiamte["email"];?></td>
            </tr>
            <tr>
                <td style="width:65%;text-align: left;" rowspan="3">&nbsp;<?php echo $name_of_work;?></td>
                <td style="width:35%;text-align: left;border-left: 1px solid;" colspan="">&nbsp;<u><b>Mode of Dispatch of Report</b></u></td>
            </tr>
            <tr>
                <td style="width:35%;text-align: left;border-left: 1px solid;" colspan="">&nbsp;by Post <input type="checkbox"></td>
            </tr>
            <tr>
                <td style="width:35%;text-align: left;border-left: 1px solid;" colspan="">&nbsp;Collect Personally <input type="checkbox"></td>
            </tr>
            </table>
            <table align="center" style="width: 100%;text-align: center;font-family: 'calibri';font-size: 12px;border-right:1px solid;border-left:1px solid;"  cellspacing="0" cellpadding="2px">
            ...
            <tr style="text-align:left;">
                <td style="width:25%;border-top: 1px solid;border-right:1px solid;border-bottom:1px solid;"><b>Name of sample</b> </td>
			...
			?></td>
                <td style="width:25%;border-top: 1px solid;border-right:1px solid;border-bottom:1px solid;"> <b>Source of sample</b></td>
                <td style="width:25%;border-top: 1px solid;border-bottom:1px solid;">-</td>
            </tr>
            </table>
            <table align="center" style="width: 100%;text-align: center;font-family: 'calibri';font-size: 12px;border-left:1px solid;border-right:1px solid;"  cellspacing="0" cellpadding="2px">
             <tr>
                <td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 17px;font-weight:bold;padding-top:20px;"colspan="2"><u>TESTING REQUIREMENT </u></td>
            </tr>
            </table>
		...
		<table align="center" style="width: 100%;text-align: center;font-family: 'calibri';font-size: 12px;border:1px solid;"  cellspacing="0" cellpadding="0px">
			...
			?>
            <tr style="text-align:center;">
                <td style="border-right:1px ;border-right:1px solid;height:10px;" ><?php echo $matreials_qty_array[$keying];?></td>
                <td style="border-right:1px solid;" ><?php echo $matreials_desc_array[$keying];?></td>
                <td  style="border-right:1px solid;text-align:left;">
					<table cellpadding="0" cellspacing="0"  align="center" width="100%" class="test"  style="font-family: Book Antiqua;">
...
<!--			   <td style="border-top: 1px solid;border-right:0px solid;text-align:center;" >
           ...
           <!-- </table>-->
            ...
            <table align="center" style="width: 100%;text-align: center;font-family: 'calibri';font-size: 12px;border-right:1px solid;border-left:1px solid;"  cellspacing="0" cellpadding="2px">
             <tr>
                <td style="text-align:left;font-size: 11px;font-family: 'calibri';font-size: 13px;"colspan="2">Review Remarks</td>
            </tr>
             <tr style="text-align:left">
                <td style="width:40%;border-top: 1px solid;text-align:left;">&nbsp;1. Method of testing, capability and resources acceptable</td>
                <td style="width:10%;border:1px solid;text-align:center"><?php echo $radio_1;?></td>
                <td style="border-top: 1px solid;text-align:center;border-bottom:1px solid;font-weight:bold;vertical-align:bottom" rowspan="4">&nbsp;&nbsp;Signature of <br>CUSTOMER'S REPRESENTATIVE</td>
            </tr>
            <tr style="text-align:left">
                <td style="border-top: 1px solid;text-align:left;">&nbsp;2. Testing services requested may please be carried out. </td>
                <td style="border:1px solid;text-align:center"><?php echo $radio_2;?></td>
            </tr>
            <tr style="text-align:left">
                <td style="border-top: 1px solid;text-align:left;">&nbsp;3. Terms and Conditions of Testing acceptable as per review remarks.</td>
                <td style="border:1px solid;text-align:center"><?php echo $radio_3;?></td>
            </tr>
            <tr style="text-align:left">
                <td style="border-top: 1px solid;text-align:left;border-bottom:1px solid;">&nbsp;4. Statement of Conformity Required/Not Required by the Customer</td>
           ...
           <table align="center" style="width: 100%;text-align: center;font-family: 'calibri';font-size: 12px;"  cellspacing="0" cellpadding="2px">
             <tr>
                <td style="text-align: center;font-size: 11px;font-family: 'calibri';font-size: 17px;font-weight:bold;padding-top:20px;border-left:1px solid;border-right:1px solid;"colspan="2"><u>FOR OFFICE USE ONLY</u></td>
            </tr>
            </table>
            <table align="center" style="width: 100%;text-align: center;font-family: 'calibri';font-size: 12px;border:1px solid;"  cellspacing="0" cellpadding="2px">
             <tr>
                <td style="text-align:left;font-size: 11px;font-family: 'calibri';font-size: 13px;border-right:1px solid;font-weight:bold;"colspan="2"><u>&nbsp;Comments:</u></td>
                <td style="text-align:left;font-size: 11px;font-family: 'calibri';font-size: 13px;font-weight:bold;">&nbsp;JOB CARD No.</td>
                <td style="text-align:left;font-size: 11px;font-family: 'calibri';font-size: 13px;font-weight:bold;">&nbsp;DATE</td>
            </tr>
            <tr>
                <td style="width:40%;text-align:left;font-size: 11px;font-family: 'calibri';font-size: 13px;">&nbsp;1. Requirements defined and understood </td>
            ...
            <tr>
                <td style="text-align:left;font-size: 11px;font-family: 'calibri';font-size: 13px;">&nbsp;2. Capability and Resources available </td>
            ...
            <tr>
                <td style="text-align:left;font-size: 11px;font-family: 'calibri';font-size: 13px;border-right:1px solid;" colspan="2">&nbsp;</td>
                <td style="text-align:left;font-size: 11px;font-family: 'calibri';font-size: 13px;font-weight:bold;"colspan="2">&nbsp;UNIQUE IDENTITY OF SAMPLE</td>
            </tr>
            <tr>
                <td style="text-align:left;font-size: 11px;font-family: 'calibri';font-size: 13px;">&nbsp;3. Condition of Sample Received </td>
                <td style="border:1px solid;"><?php echo $acceptable;?></td>
                <td style="padding-right:3px;border:1px solid;"><?php echo $labs_nos;?></td>
                <td style="text-align:left;font-size: 11px;font-family: 'calibri';font-size: 13px;"></td>
            </tr>
            <tr>
                <td style="text-align:left;font-size: 11px;font-family: 'calibri';font-size: 13px;border-right:1px solid;" colspan="2">&nbsp;4. Discussion with Customer, if any</td>
            </tr>
            <tr>
                <td style="text-align:center;font-size: 11px;font-family: 'calibri';font-size: 13px;border-bottom:1px solid;border-right:1px solid;" colspan="2">&nbsp;<br><br><br><br></td>
                <td style="text-align:center;font-size: 11px;font-family: 'calibri';font-size: 13px;border-bottom:1px solid;" colspan="2">&nbsp;Authorized Signatory <br>&nbsp;Miss Ujjwal Katoch <br>&nbsp;(Customer Service Cell)</td>
