								...
								if (mysqli_num_rows($result_upload) > 0) { ?>
									...
									<div class="form-group">
									 <!-- <label for="inputEmail3" class="control-label">Percentage(%)</label>>
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<label for="inputEmail3" class="control-label">Total mass of whole sample retained on 6.3 mm sieve(y)</label>
																</div>
															</div>
									...
									<div class="form-group">
									  <div class="col-sm-12">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="x3" name="x3">
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="y3" name="y3">
																	</div>
																</div>
															</div>
														</div>
									...
									<div class="form-group">
									  <div class="col-sm-12">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="x4" name="x4">
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="y4" name="y4">
																	</div>
																</div>
															</div>
														</div>
									...
									<div class="form-group">
									  <div class="col-sm-12">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="x5" name="x5">
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="y5" name="y5">
																	</div>
																</div>
															</div>
														</div>
									...
									<div class="form-group">
									  <div class="col-sm-12">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="x6" name="x6">
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="y6" name="y6">
																	</div>
																</div>
															</div>
														</div>
									...
									<div class="form-group">
									  <div class="col-sm-12">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="x7" name="x7">
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="y7" name="y7">
																	</div>
																</div>
															</div>
														</div>
									...
									<div class="form-group">
									  <div class="col-sm-12">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="x8" name="x8">
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="y8" name="y8">
																	</div>
																</div>
															</div>
														</div>
									...
									<div class="form-group">
									  <div class="col-sm-12">
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="x9" name="x9">
																	</div>
																</div>
															</div>
															...
															<div class="col-lg-1">
																<div class="form-group">
																	<div class="col-sm-12">
																		<input type="text" class="form-control" id="y9" name="y9">
																	</div>
																</div>
															</div>
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-12">
															<div class="form-group">
																...
																<div class="col-sm-1">
																	<input type="text" class="form-control" id="sumx" name="sumx">
																</div>
																<div class="col-sm-1">
																	<input type="text" class="form-control" id="sumy" name="sumy">
																</div>
											...
											<div class="panel-body">
												...
												<div class="row">
													...
													<div class="col-lg-1">
														<div class="form-group">
															<div class="col-sm-15">
																<input type="text" class="form-control" id="sp_specific_gravity_a_1" name="sp_specific_gravity_a_1" readonly>
															</div>
														</div>
													</div>
													<div class="col-lg-1">
														<div class="form-group">
															<div class="col-sm-15">
																<input type="text" class="form-control" id="sp_specific_gravity_b_1" name="sp_specific_gravity_b_1" readonly>
															</div>
														</div>
													</div>
													<div class="col-lg-1">
												...
												<div class="row">
													...
													<div class="col-lg-1">
														<div class="form-group">
															<div class="col-sm-15">
																<input type="text" class="form-control" id="sp_specific_gravity_a_2" name="sp_specific_gravity_a_2" readonly>
															</div>
														</div>
													</div>
													<div class="col-lg-1">
														<div class="form-group">
															<div class="col-sm-15">
																<input type="text" class="form-control" id="sp_specific_gravity_b_2" name="sp_specific_gravity_b_2" readonly>
															</div>
														</div>
													</div>
													<div class="col-lg-1">
												...
												<div class="row">
													...
													<div class="col-lg-1">
														<div class="form-group">
															<div class="col-sm-15">
																<input type="text" class="form-control" id="sp_specific_gravity_a_3" name="sp_specific_gravity_a_3" readonly>
															</div>
														</div>
													</div>
													<div class="col-lg-1">
														<div class="form-group">
															<div class="col-sm-15">
																<input type="text" class="form-control" id="sp_specific_gravity_b_3" name="sp_specific_gravity_b_3" readonly>
															</div>
														</div>
													</div>
													<div class="col-lg-1">
												...
												<div class="row">
													...
													<div class="col-sm-1">
														<div class="form-group">
															<div class="col-sm-15">
																<input type="text" class="form-control" id="sp_specific_gravity_a" name="sp_specific_gravity_a" readonly>
															</div>
														</div>
													</div>
													<div class="col-sm-1">
														<div class="form-group">
															<div class="col-sm-15">
																<input type="text" class="form-control" id="sp_specific_gravity_b" name="sp_specific_gravity_b" readonly>
															</div>
														</div>
													</div>
													<div class="col-sm-1">
														<div class="form-group">
															<div class="col-sm-15">
																<input type="text" class="form-control" id="sp_specific_gravity" name="sp_specific_gravity" readonly>
															</div>
														</div>
													</div>
													<div class="col-sm-1">
														<div class="form-group">
															<div class="col-sm-15">
																<input type="text" class="form-control" id="sp_water_abr" name="sp_water_abr" readonly>
															</div>
														</div>
													</div>
												</div>
	...
	$(document).ready(function() {
		...
		$('#sp_specific_gravity').change(function() {
			...
			if ($("#chk_sp").is(':checked')) {
				...
				$('#sp_specific_gravity_2').val(sp_specific_gravity2.toFixed(3));
				var sp_specific_gravity_2 = $('#sp_specific_gravity_2').val();
				var sp_specific_gravity3 = ((+tems1) - (+sp_specific_gravity_2)); //(sp_specific_gravity_3)_2
				$('#sp_specific_gravity_3').val(sp_specific_gravity3.toFixed(3));
				var sp_specific_gravity_3 = $('#sp_specific_gravity_3').val();
				var sp_waterabr = randomNumberFromRange(1.00, 1.25).toFixed(2); // (sp_water_abr)_1
				$('#sp_water_abr').val(sp_waterabr);
		...
		$("#sp_w_sur_1").change(function() {
			...
			var sp_specific_gravity_2 = $('#sp_specific_gravity_2').val();
			var sp_specific_gravity_3 = $('#sp_specific_gravity_3').val();
			var sp_specific_gravity = ((+sp_specific_gravity_1) + (+sp_specific_gravity_2) + (+sp_specific_gravity_3)) / 3;
			...
			var sp_water_abr_2 = $('#sp_water_abr_2').val();
			var sp_water_abr_3 = $('#sp_water_abr_3').val();
			var sp_water_abr = ((+sp_water_abr_1) + (+sp_water_abr_2) + (+sp_water_abr_3)) / 3;
		...
		$("#sp_w_sur_3").change(function() {
			$('#txtwtr').css("background-color", "var(--success)");
			var sp_w_sur_3 = $('#sp_w_sur_3').val();
			var sp_wt_st_3 = $('#sp_wt_st_3').val();
			var sp_w_s_3 = $('#sp_w_s_3').val();

			var sp_specific_gravit_3 = (+sp_w_s_3) / ((+sp_wt_st_3) - (+sp_w_sur_3));
			$('#sp_specific_gravity_3').val(sp_specific_gravit_3.toFixed(3));
			var sp_specific_gravity_3 = $('#sp_specific_gravity_3').val();
			var sp_specific_gravity_2 = $('#sp_specific_gravity_2').val();
			var sp_specific_gravity_1 = $('#sp_specific_gravity_1').val();
			var sp_specific_gravity = ((+sp_specific_gravity_1) + (+sp_specific_gravity_2) + (+sp_specific_gravity_3)) / 3;
			...
			sp_water_abr3 = (100 * ((+sp_wt_st_2) - (+sp_w_s_3))) / (+sp_w_s_3);
			$('#sp_water_abr_3').val(sp_water_abr3.toFixed(2));
			var sp_water_abr_3 = $('#sp_water_abr_3').val();
			var sp_water_abr_2 = $('#sp_water_abr_2').val();
			var sp_water_abr_1 = $('#sp_water_abr_1').val();
		...
		$("#sp_w_s_3").change(function() {
			...
			sp_water_abr3 = (100 * ((+sp_wt_st_3) - (+sp_w_s_3))) / (+sp_w_s_3);
			$('#sp_water_abr_3').val(sp_water_abr3.toFixed(2));
			var sp_water_abr_2 = $('#sp_water_abr_2').val();
			var sp_water_abr_1 = $('#sp_water_abr_1').val();
			var sp_water_abr_3 = $('#sp_water_abr_3').val();
